...
{
    public class OnsMessageDetailRequest : RpcAcsRequest<OnsMessageDetailResponse>
    {
        public OnsMessageDetailRequest()
            : base("Ons", "2019-02-14", "OnsMessageDetail", "ons", "openAPI")
        {
        ...
        public override OnsMessageDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OnsMessageDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
