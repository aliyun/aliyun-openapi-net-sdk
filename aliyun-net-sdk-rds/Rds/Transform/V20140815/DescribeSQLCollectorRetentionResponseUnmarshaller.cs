...
namespace Aliyun.Acs.Rds.Transform.V20140815
{
    public class DescribeSQLCollectorRetentionResponseUnmarshaller
    {
        public static DescribeSQLCollectorRetentionResponse Unmarshall(UnmarshallerContext context)
        {
			...
			describeSQLCollectorRetentionResponse.DBInstanceID = context.IntegerValue("DescribeSQLCollectorRetention.DBInstanceID");
			describeSQLCollectorRetentionResponse.DBInstanceName = context.StringValue("DescribeSQLCollectorRetention.DBInstanceName");
