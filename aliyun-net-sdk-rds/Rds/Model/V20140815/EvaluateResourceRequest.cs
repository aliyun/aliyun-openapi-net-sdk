...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class EvaluateResourceRequest : RpcAcsRequest<EvaluateResourceResponse>
    {
        public EvaluateResourceRequest()
            : base("Rds", "2014-08-15", "EvaluateResource", "rds", "openAPI")
        {
        }
        ...
        public override EvaluateResourceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
