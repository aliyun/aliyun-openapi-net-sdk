...
{
    public class DescribeSqlLogTemplatesListRequest : RpcAcsRequest<DescribeSqlLogTemplatesListResponse>
    {
        public DescribeSqlLogTemplatesListRequest()
            : base("Rds", "2014-08-15", "DescribeSqlLogTemplatesList", "rds", "openAPI")
        {
        }
        ...
        public override DescribeSqlLogTemplatesListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DescribeSqlLogTemplatesListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}