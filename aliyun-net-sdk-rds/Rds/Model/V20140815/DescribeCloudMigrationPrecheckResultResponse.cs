...
{
	public class DescribeCloudMigrationPrecheckResultResponse : AcsResponse
	{
		...
		private List<DescribeCloudMigrationPrecheckResult_MigrateCloudTaskList> items;
		...
		public List<DescribeCloudMigrationPrecheckResult_MigrateCloudTaskList> Items
		{
			get
			{
				return items;
		...
		public class DescribeCloudMigrationPrecheckResult_MigrateCloudTaskList
		{
