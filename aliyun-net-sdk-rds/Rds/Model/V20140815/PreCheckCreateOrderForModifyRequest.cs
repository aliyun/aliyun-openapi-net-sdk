...
{
    public class PreCheckCreateOrderForModifyRequest : RpcAcsRequest<PreCheckCreateOrderForModifyResponse>
    {
        public PreCheckCreateOrderForModifyRequest()
            : base("Rds", "2014-08-15", "PreCheckCreateOrderForModify", "rds", "openAPI")
        {
        ...
        public override PreCheckCreateOrderForModifyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PreCheckCreateOrderForModifyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
