...
{
    public class RestoreDdrTableRequest : RpcAcsRequest<RestoreDdrTableResponse>
    {
        public RestoreDdrTableRequest()
            : base("Rds", "2014-08-15", "RestoreDdrTable", "rds", "openAPI")
        {
        ...
        public override RestoreDdrTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestoreDdrTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
