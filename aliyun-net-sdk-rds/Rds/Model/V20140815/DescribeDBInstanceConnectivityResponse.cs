...
{
	public class DescribeDBInstanceConnectivityResponse : AcsResponse
	{
		...
		[JsonProperty(PropertyName = "ConnCheckResult")]
		public string ConnCheckResult
		{
			...
			set	
			{
				connCheckResult = value;
			}
		}

		[JsonProperty(PropertyName = "ConnCheckErrorCode")]
		public string ConnCheckErrorCode
		{
			...
			set	
			{
				connCheckErrorCode = value;
			}
		}

		[JsonProperty(PropertyName = "ConnCheckErrorMessage")]
