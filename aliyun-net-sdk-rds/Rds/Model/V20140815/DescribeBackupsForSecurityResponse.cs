...
{
	public class DescribeBackupsForSecurityResponse : AcsResponse
	{
		...
		private List<DescribeBackupsForSecurity_Backup> items;
		...
		public List<DescribeBackupsForSecurity_Backup> Items
		{
			get
			{
				return items;
		...
		public class DescribeBackupsForSecurity_Backup
		{
