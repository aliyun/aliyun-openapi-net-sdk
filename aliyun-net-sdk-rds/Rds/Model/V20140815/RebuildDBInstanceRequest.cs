...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class RebuildDBInstanceRequest : RpcAcsRequest<RebuildDBInstanceResponse>
    {
        public RebuildDBInstanceRequest()
            : base("Rds", "2014-08-15", "RebuildDBInstance")
        {
		...
		[JsonProperty(PropertyName = "RebuildNodeType")]
		public string RebuildNodeType
		{
			...
			set	
			{
				rebuildNodeType = value;
				DictionaryUtil.Add(QueryParameters, "RebuildNodeType", value);
			}
		}
