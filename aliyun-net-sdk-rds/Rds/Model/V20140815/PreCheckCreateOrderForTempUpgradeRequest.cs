...
{
    public class PreCheckCreateOrderForTempUpgradeRequest : RpcAcsRequest<PreCheckCreateOrderForTempUpgradeResponse>
    {
        public PreCheckCreateOrderForTempUpgradeRequest()
            : base("Rds", "2014-08-15", "PreCheckCreateOrderForTempUpgrade", "rds", "openAPI")
        {
        }
        ...
        public override PreCheckCreateOrderForTempUpgradeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PreCheckCreateOrderForTempUpgradeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
