...
{
	public class DescribeTemplatesListResponse : AcsResponse
	{
		...
		private List<DescribeTemplatesList_ItemsItem> items;
		...
		public List<DescribeTemplatesList_ItemsItem> Items
		{
			get
			{
				return items;
		...
		public class DescribeTemplatesList_ItemsItem
		{
