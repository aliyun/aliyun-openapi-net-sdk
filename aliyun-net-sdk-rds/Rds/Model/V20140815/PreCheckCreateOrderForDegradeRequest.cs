...
{
    public class PreCheckCreateOrderForDegradeRequest : RpcAcsRequest<PreCheckCreateOrderForDegradeResponse>
    {
        public PreCheckCreateOrderForDegradeRequest()
            : base("Rds", "2014-08-15", "PreCheckCreateOrderForDegrade", "rds", "openAPI")
        {
        ...
        public override PreCheckCreateOrderForDegradeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PreCheckCreateOrderForDegradeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
