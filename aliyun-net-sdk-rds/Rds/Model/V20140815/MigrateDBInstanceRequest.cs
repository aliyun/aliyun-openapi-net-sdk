...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class MigrateDBInstanceRequest : RpcAcsRequest<MigrateDBInstanceResponse>
    {
        public MigrateDBInstanceRequest()
            : base("Rds", "2014-08-15", "MigrateDBInstance")
        {
		...
		[JsonProperty(PropertyName = "SpecifiedTime")]
		...
		[JsonProperty(PropertyName = "ZoneIdForFollower")]
		...
		[JsonProperty(PropertyName = "ZoneIdForLog")]
