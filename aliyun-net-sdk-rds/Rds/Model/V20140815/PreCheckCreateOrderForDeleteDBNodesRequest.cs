...
{
    public class PreCheckCreateOrderForDeleteDBNodesRequest : RpcAcsRequest<PreCheckCreateOrderForDeleteDBNodesResponse>
    {
        public PreCheckCreateOrderForDeleteDBNodesRequest()
            : base("Rds", "2014-08-15", "PreCheckCreateOrderForDeleteDBNodes", "rds", "openAPI")
        {
        ...
        public override PreCheckCreateOrderForDeleteDBNodesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PreCheckCreateOrderForDeleteDBNodesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
