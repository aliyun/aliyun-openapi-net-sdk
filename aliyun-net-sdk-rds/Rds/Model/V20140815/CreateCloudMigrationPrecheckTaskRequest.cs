...
{
    public class CreateCloudMigrationPrecheckTaskRequest : RpcAcsRequest<CreateCloudMigrationPrecheckTaskResponse>
    {
        public CreateCloudMigrationPrecheckTaskRequest()
            : base("Rds", "2014-08-15", "CreateCloudMigrationPrecheckTask", "rds", "openAPI")
        {
        ...
        public override CreateCloudMigrationPrecheckTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCloudMigrationPrecheckTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
