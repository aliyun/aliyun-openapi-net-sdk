...
{
	public class DescribeDBInstanceMetricsResponse : AcsResponse
	{
		...
		public List<DescribeDBInstanceMetrics_Metrics> Items
		{
			get
			{
				return items;
		...
		public class DescribeDBInstanceMetrics_Metrics
		{
