...
{
    public class QueryPriceForBuyRequest : RpcAcsRequest<QueryPriceForBuyResponse>
    {
        public QueryPriceForBuyRequest()
            : base("Rds", "2014-08-15", "QueryPriceForBuy", "rds", "openAPI")
        {
        }
        ...
        public override QueryPriceForBuyResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return QueryPriceForBuyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}