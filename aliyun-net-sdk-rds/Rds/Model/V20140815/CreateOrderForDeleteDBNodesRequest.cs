...
{
    public class CreateOrderForDeleteDBNodesRequest : RpcAcsRequest<CreateOrderForDeleteDBNodesResponse>
    {
        public CreateOrderForDeleteDBNodesRequest()
            : base("Rds", "2014-08-15", "CreateOrderForDeleteDBNodes", "rds", "openAPI")
        {
        ...
        public override CreateOrderForDeleteDBNodesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateOrderForDeleteDBNodesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
