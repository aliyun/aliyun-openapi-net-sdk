    ...
    public class CreatePostgresExtensionsRequest : RpcAcsRequest<CreatePostgresExtensionsResponse>
    {
		...
		public string SourceDatabase
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SourceDatabase", value);
			}
		}
        ...
        public override CreatePostgresExtensionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePostgresExtensionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
