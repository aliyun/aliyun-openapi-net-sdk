...
{
    public class ChangeResourceRecordsRequest : RpcAcsRequest<ChangeResourceRecordsResponse>
    {
        public ChangeResourceRecordsRequest()
            : base("DnsKnocker", "2019-09-10", "ChangeResourceRecords", "dns_knocker", "openAPI")
        {
		...
		public string Types
		{
			...
			{
				types = value;
				DictionaryUtil.Add(BodyParameters, "Types", value);
			}
		}
        ...
        public override ChangeResourceRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeResourceRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
