...
{
    public class GetResourceRecordsRequest : RpcAcsRequest<GetResourceRecordsResponse>
    {
        public GetResourceRecordsRequest()
            : base("DnsKnocker", "2019-09-10", "GetResourceRecords", "dns_knocker", "openAPI")
        {
        ...
        public override GetResourceRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResourceRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
