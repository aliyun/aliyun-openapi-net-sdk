...
{
    public class DeleteResourceRecordsRequest : RpcAcsRequest<DeleteResourceRecordsResponse>
    {
        public DeleteResourceRecordsRequest()
            : base("DnsKnocker", "2019-09-10", "DeleteResourceRecords", "dns_knocker", "openAPI")
        {
		...
		public string TypeList
		{
			...
			{
				typeList = value;
				DictionaryUtil.Add(BodyParameters, "TypeList", value);
			}
		}
        ...
        public override DeleteResourceRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteResourceRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
