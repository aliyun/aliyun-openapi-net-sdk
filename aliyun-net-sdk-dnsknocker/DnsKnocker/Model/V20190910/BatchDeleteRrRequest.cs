...
{
    public class BatchDeleteRrRequest : RpcAcsRequest<BatchDeleteRrResponse>
    {
        public BatchDeleteRrRequest()
            : base("DnsKnocker", "2019-09-10", "BatchDeleteRr", "dns_knocker", "openAPI")
        {
        ...
        public override BatchDeleteRrResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchDeleteRrResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
