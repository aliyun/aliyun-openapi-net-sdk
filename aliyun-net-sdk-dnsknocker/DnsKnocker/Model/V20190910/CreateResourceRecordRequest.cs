...
{
    public class CreateResourceRecordRequest : RpcAcsRequest<CreateResourceRecordResponse>
    {
        public CreateResourceRecordRequest()
            : base("DnsKnocker", "2019-09-10", "CreateResourceRecord", "dns_knocker", "openAPI")
        {
        ...
        public override CreateResourceRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateResourceRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
