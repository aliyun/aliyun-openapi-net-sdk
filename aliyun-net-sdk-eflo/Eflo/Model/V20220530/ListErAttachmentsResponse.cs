...
{
	public class ListErAttachmentsResponse : AcsResponse
	{
		...
		private ListErAttachments_Content content;
		...
		public ListErAttachments_Content Content
		{
			get
			{
				return content;
		...
		public class ListErAttachments_Content
		{

			private long? total;

			private List<ListErAttachments_DataItem> data;
			...
			public List<ListErAttachments_DataItem> Data
			{
				get
				{
					return data;
			...
			public class ListErAttachments_DataItem
			{
