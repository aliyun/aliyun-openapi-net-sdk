...
{
    public class UpdateErAttachmentRequest : RpcAcsRequest<UpdateErAttachmentResponse>
    {
        public UpdateErAttachmentRequest()
            : base("eflo", "2022-05-30", "UpdateErAttachment", "eflo", "openAPI")
        {
        ...
        public override UpdateErAttachmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateErAttachmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
