...
{
    public class GetVpdGrantRuleRequest : RpcAcsRequest<GetVpdGrantRuleResponse>
    {
        public GetVpdGrantRuleRequest()
            : base("eflo", "2022-05-30", "GetVpdGrantRule", "eflo", "openAPI")
        {
        ...
        public override GetVpdGrantRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVpdGrantRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
