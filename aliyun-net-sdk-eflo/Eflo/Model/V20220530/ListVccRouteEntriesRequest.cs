...
{
    public class ListVccRouteEntriesRequest : RpcAcsRequest<ListVccRouteEntriesResponse>
    {
        public ListVccRouteEntriesRequest()
            : base("eflo", "2022-05-30", "ListVccRouteEntries", "eflo", "openAPI")
        {
		...
		public string VpdRouteEntryId
		{
			...
			set	
			{
				vpdRouteEntryId = value;
				DictionaryUtil.Add(BodyParameters, "VpdRouteEntryId", value);
			}
		}
        ...
        public override ListVccRouteEntriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVccRouteEntriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
