...
{
    public class CreateVccGrantRuleRequest : RpcAcsRequest<CreateVccGrantRuleResponse>
    {
        public CreateVccGrantRuleRequest()
            : base("eflo", "2022-05-30", "CreateVccGrantRule", "eflo", "openAPI")
        {
        ...
        public override CreateVccGrantRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateVccGrantRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
