...
{
    public class GetErAttachmentRequest : RpcAcsRequest<GetErAttachmentResponse>
    {
        public GetErAttachmentRequest()
            : base("eflo", "2022-05-30", "GetErAttachment", "eflo", "openAPI")
        {
        ...
        public override GetErAttachmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetErAttachmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
