...
{
    public class UpdateVccRequest : RpcAcsRequest<UpdateVccResponse>
    {
        public UpdateVccRequest()
            : base("eflo", "2022-05-30", "UpdateVcc", "eflo", "openAPI")
        {
        ...
        public override UpdateVccResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateVccResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
