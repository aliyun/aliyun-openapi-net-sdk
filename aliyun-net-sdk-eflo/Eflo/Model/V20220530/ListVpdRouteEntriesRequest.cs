...
{
    public class ListVpdRouteEntriesRequest : RpcAcsRequest<ListVpdRouteEntriesResponse>
    {
        public ListVpdRouteEntriesRequest()
            : base("eflo", "2022-05-30", "ListVpdRouteEntries", "eflo", "openAPI")
        {
        ...
        public override ListVpdRouteEntriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVpdRouteEntriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
