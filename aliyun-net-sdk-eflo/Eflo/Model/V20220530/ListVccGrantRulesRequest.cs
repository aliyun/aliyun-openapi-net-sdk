...
{
    public class ListVccGrantRulesRequest : RpcAcsRequest<ListVccGrantRulesResponse>
    {
        public ListVccGrantRulesRequest()
            : base("eflo", "2022-05-30", "ListVccGrantRules", "eflo", "openAPI")
        {
        ...
        public override ListVccGrantRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVccGrantRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
