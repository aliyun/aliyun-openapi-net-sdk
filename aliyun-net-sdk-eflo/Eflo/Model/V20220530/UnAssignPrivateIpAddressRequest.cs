...
{
    public class UnAssignPrivateIpAddressRequest : RpcAcsRequest<UnAssignPrivateIpAddressResponse>
    {
        public UnAssignPrivateIpAddressRequest()
            : base("eflo", "2022-05-30", "UnAssignPrivateIpAddress", "eflo", "openAPI")
        {
        ...
        public override UnAssignPrivateIpAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnAssignPrivateIpAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
