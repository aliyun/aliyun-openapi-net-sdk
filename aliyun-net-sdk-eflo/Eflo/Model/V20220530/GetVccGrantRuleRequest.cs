...
{
    public class GetVccGrantRuleRequest : RpcAcsRequest<GetVccGrantRuleResponse>
    {
        public GetVccGrantRuleRequest()
            : base("eflo", "2022-05-30", "GetVccGrantRule", "eflo", "openAPI")
        {
        ...
        public override GetVccGrantRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVccGrantRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
