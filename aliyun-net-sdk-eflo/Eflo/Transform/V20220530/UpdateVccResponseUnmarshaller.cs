...
namespace Aliyun.Acs.eflo.Transform.V20220530
{
    ...
    {
        public static UpdateVccResponse Unmarshall(UnmarshallerContext _ctx)
        {
			UpdateVccResponse updateVccResponse = new UpdateVccResponse();

			updateVccResponse.HttpResponse = _ctx.HttpResponse;
			...
			updateVccResponse.Content = content;
