...
namespace Aliyun.Acs.eflo.Transform.V20220530
{
    ...
    {
        public static UnAssignPrivateIpAddressResponse Unmarshall(UnmarshallerContext _ctx)
        {
			UnAssignPrivateIpAddressResponse unAssignPrivateIpAddressResponse = new UnAssignPrivateIpAddressResponse();

			unAssignPrivateIpAddressResponse.HttpResponse = _ctx.HttpResponse;
			...
			content.IpName = _ctx.StringValue("UnAssignPrivateIpAddress.Content.IpName");
			unAssignPrivateIpAddressResponse.Content = content;
