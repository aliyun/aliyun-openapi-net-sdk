...
namespace Aliyun.Acs.eflo.Transform.V20220530
{
    public class GetVpdGrantRuleResponseUnmarshaller
    {
        public static GetVpdGrantRuleResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			getVpdGrantRuleResponse.AccessDeniedDetail = _ctx.StringValue("GetVpdGrantRule.AccessDeniedDetail");
			...
			content.ResourceGroupId = _ctx.StringValue("GetVpdGrantRule.Content.ResourceGroupId");
