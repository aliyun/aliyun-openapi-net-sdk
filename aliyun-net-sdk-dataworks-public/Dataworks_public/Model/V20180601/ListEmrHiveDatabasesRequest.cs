...
{
    public class ListEmrHiveDatabasesRequest : RpcAcsRequest<ListEmrHiveDatabasesResponse>
    {
        public ListEmrHiveDatabasesRequest()
            : base("dataworks-public", "2018-06-01", "ListEmrHiveDatabases")
        {
        ...
        public override ListEmrHiveDatabasesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListEmrHiveDatabasesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
