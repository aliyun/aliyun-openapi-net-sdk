...
{
    public class GetDISyncTaskRequest : RpcAcsRequest<GetDISyncTaskResponse>
    {
        public GetDISyncTaskRequest()
            : base("dataworks-public", "2018-06-01", "GetDISyncTask")
        {
        ...
        public override GetDISyncTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDISyncTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
