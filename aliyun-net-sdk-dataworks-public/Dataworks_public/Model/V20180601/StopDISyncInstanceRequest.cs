...
{
    public class StopDISyncInstanceRequest : RpcAcsRequest<StopDISyncInstanceResponse>
    {
        public StopDISyncInstanceRequest()
            : base("dataworks-public", "2018-06-01", "StopDISyncInstance")
        {
        ...
        public override StopDISyncInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDISyncInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
