...
{
    public class ListHiveTableLineagesRequest : RpcAcsRequest<ListHiveTableLineagesResponse>
    {
        public ListHiveTableLineagesRequest()
            : base("dataworks-public", "2018-06-01", "ListHiveTableLineages")
        {
        ...
        public override ListHiveTableLineagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListHiveTableLineagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
