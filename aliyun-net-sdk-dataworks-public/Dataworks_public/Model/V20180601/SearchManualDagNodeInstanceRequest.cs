...
{
    public class SearchManualDagNodeInstanceRequest : RpcAcsRequest<SearchManualDagNodeInstanceResponse>
    {
        public SearchManualDagNodeInstanceRequest()
            : base("dataworks-public", "2018-06-01", "SearchManualDagNodeInstance")
        {
		...
		public long? DagId
		{
			...
			{
				dagId = value;
				DictionaryUtil.Add(QueryParameters, "DagId", value.ToString());
			}
		}

        public override SearchManualDagNodeInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchManualDagNodeInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
