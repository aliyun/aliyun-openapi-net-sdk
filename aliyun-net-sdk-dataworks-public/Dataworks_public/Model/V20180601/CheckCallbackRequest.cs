...
{
    public class CheckCallbackRequest : RpcAcsRequest<CheckCallbackResponse>
    {
        public CheckCallbackRequest()
            : base("dataworks-public", "2018-06-01", "CheckCallback")
        {
		...
		public string CallbackResultString
		{
			...
			set	
			{
				callbackResultString = value;
				DictionaryUtil.Add(BodyParameters, "CallbackResultString", value);
			}
		}
        ...
        public override CheckCallbackResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckCallbackResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
