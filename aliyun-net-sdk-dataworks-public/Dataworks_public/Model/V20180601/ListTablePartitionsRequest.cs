...
{
    public class ListTablePartitionsRequest : RpcAcsRequest<ListTablePartitionsResponse>
    {
        public ListTablePartitionsRequest()
            : base("dataworks-public", "2018-06-01", "ListTablePartitions")
        {
        ...
        public override ListTablePartitionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTablePartitionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
