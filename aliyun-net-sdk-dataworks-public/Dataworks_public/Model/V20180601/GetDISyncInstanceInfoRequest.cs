...
{
    public class GetDISyncInstanceInfoRequest : RpcAcsRequest<GetDISyncInstanceInfoResponse>
    {
        public GetDISyncInstanceInfoRequest()
            : base("dataworks-public", "2018-06-01", "GetDISyncInstanceInfo")
        {
        ...
        public override GetDISyncInstanceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDISyncInstanceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
