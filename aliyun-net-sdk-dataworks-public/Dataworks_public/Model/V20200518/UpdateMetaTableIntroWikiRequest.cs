...
{
    public class UpdateMetaTableIntroWikiRequest : RpcAcsRequest<UpdateMetaTableIntroWikiResponse>
    {
        public UpdateMetaTableIntroWikiRequest()
            : base("dataworks-public", "2020-05-18", "UpdateMetaTableIntroWiki")
        {
        ...
        public override UpdateMetaTableIntroWikiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateMetaTableIntroWikiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
