...
{
    public class RevokeTablePermissionRequest : RpcAcsRequest<RevokeTablePermissionResponse>
    {
        public RevokeTablePermissionRequest()
            : base("dataworks-public", "2020-05-18", "RevokeTablePermission")
        {
        ...
        public override RevokeTablePermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RevokeTablePermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
