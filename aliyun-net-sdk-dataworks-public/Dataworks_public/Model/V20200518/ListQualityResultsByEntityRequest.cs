...
{
    public class ListQualityResultsByEntityRequest : RpcAcsRequest<ListQualityResultsByEntityResponse>
    {
        public ListQualityResultsByEntityRequest()
            : base("dataworks-public", "2020-05-18", "ListQualityResultsByEntity")
        {
        ...
        public override ListQualityResultsByEntityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListQualityResultsByEntityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
