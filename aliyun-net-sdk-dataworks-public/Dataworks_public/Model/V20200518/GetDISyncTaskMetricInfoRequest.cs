...
{
    public class GetDISyncTaskMetricInfoRequest : RpcAcsRequest<GetDISyncTaskMetricInfoResponse>
    {
        public GetDISyncTaskMetricInfoRequest()
            : base("dataworks-public", "2020-05-18", "GetDISyncTaskMetricInfo")
        {
        ...
        public override GetDISyncTaskMetricInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDISyncTaskMetricInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
