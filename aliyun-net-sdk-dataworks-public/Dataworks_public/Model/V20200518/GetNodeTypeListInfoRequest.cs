...
{
    public class GetNodeTypeListInfoRequest : RpcAcsRequest<GetNodeTypeListInfoResponse>
    {
        public GetNodeTypeListInfoRequest()
            : base("dataworks-public", "2020-05-18", "GetNodeTypeListInfo")
        {
        ...
        public override GetNodeTypeListInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeTypeListInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
