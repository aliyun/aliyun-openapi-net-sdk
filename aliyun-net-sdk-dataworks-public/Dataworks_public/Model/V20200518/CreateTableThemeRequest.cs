...
{
    public class CreateTableThemeRequest : RpcAcsRequest<CreateTableThemeResponse>
    {
        public CreateTableThemeRequest()
            : base("dataworks-public", "2020-05-18", "CreateTableTheme")
        {
        ...
        public override CreateTableThemeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTableThemeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
