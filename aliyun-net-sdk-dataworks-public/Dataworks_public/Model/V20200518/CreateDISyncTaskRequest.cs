...
{
    public class CreateDISyncTaskRequest : RpcAcsRequest<CreateDISyncTaskResponse>
    {
        public CreateDISyncTaskRequest()
            : base("dataworks-public", "2020-05-18", "CreateDISyncTask")
        {
        ...
        public override CreateDISyncTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDISyncTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
