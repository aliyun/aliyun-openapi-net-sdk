...
{
    public class ListDataServicePublishedApisRequest : RpcAcsRequest<ListDataServicePublishedApisResponse>
    {
        public ListDataServicePublishedApisRequest()
            : base("dataworks-public", "2020-05-18", "ListDataServicePublishedApis", "dide", "openAPI")
        {
        ...
        public override ListDataServicePublishedApisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDataServicePublishedApisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
