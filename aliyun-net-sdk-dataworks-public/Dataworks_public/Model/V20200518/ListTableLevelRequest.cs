...
{
    public class ListTableLevelRequest : RpcAcsRequest<ListTableLevelResponse>
    {
        public ListTableLevelRequest()
            : base("dataworks-public", "2020-05-18", "ListTableLevel")
        {
        ...
        public override ListTableLevelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTableLevelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
