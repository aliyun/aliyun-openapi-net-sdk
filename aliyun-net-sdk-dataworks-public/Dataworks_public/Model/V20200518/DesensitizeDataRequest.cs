...
{
    public class DesensitizeDataRequest : RpcAcsRequest<DesensitizeDataResponse>
    {
        public DesensitizeDataRequest()
            : base("dataworks-public", "2020-05-18", "DesensitizeData")
        {
		...
		public string SceneCode
		{
			...
			{
				sceneCode = value;
				DictionaryUtil.Add(BodyParameters, "SceneCode", value);
			}
		}
        ...
        public override DesensitizeDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DesensitizeDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
