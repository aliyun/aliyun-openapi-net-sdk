...
{
    public class DeleteDataServiceApiAuthorityRequest : RpcAcsRequest<DeleteDataServiceApiAuthorityResponse>
    {
        public DeleteDataServiceApiAuthorityRequest()
            : base("dataworks-public", "2020-05-18", "DeleteDataServiceApiAuthority")
        {
        ...
        public override DeleteDataServiceApiAuthorityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDataServiceApiAuthorityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
