...
{
    public class CreateUdfFileRequest : RpcAcsRequest<CreateUdfFileResponse>
    {
        public CreateUdfFileRequest()
            : base("dataworks-public", "2020-05-18", "CreateUdfFile", "dide", "openAPI")
        {
        ...
        public override CreateUdfFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateUdfFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
