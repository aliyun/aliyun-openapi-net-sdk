...
{
    public class ListMetaDBRequest : RpcAcsRequest<ListMetaDBResponse>
    {
        public ListMetaDBRequest()
            : base("dataworks-public", "2020-05-18", "ListMetaDB")
        {
        ...
        public override ListMetaDBResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMetaDBResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
