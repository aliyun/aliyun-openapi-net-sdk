...
{
    public class GetDDLJobStatusRequest : RpcAcsRequest<GetDDLJobStatusResponse>
    {
        public GetDDLJobStatusRequest()
            : base("dataworks-public", "2020-05-18", "GetDDLJobStatus")
        {
        ...
        public override GetDDLJobStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDDLJobStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
