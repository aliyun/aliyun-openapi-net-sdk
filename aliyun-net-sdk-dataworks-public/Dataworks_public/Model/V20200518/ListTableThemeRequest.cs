...
{
    public class ListTableThemeRequest : RpcAcsRequest<ListTableThemeResponse>
    {
        public ListTableThemeRequest()
            : base("dataworks-public", "2020-05-18", "ListTableTheme")
        {
        ...
        public override ListTableThemeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTableThemeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
