...
{
    public class UpdateRemindRequest : RpcAcsRequest<UpdateRemindResponse>
    {
        public UpdateRemindRequest()
            : base("dataworks-public", "2020-05-18", "UpdateRemind", "dide", "openAPI")
        {
        ...
        public override UpdateRemindResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRemindResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
