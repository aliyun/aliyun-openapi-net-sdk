...
{
    public class ListQualityResultsByRuleRequest : RpcAcsRequest<ListQualityResultsByRuleResponse>
    {
        public ListQualityResultsByRuleRequest()
            : base("dataworks-public", "2020-05-18", "ListQualityResultsByRule")
        {
        ...
        public override ListQualityResultsByRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListQualityResultsByRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
