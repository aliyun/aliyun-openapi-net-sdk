...
{
    public class QueryDISyncTaskConfigProcessResultRequest : RpcAcsRequest<QueryDISyncTaskConfigProcessResultResponse>
    {
        public QueryDISyncTaskConfigProcessResultRequest()
            : base("dataworks-public", "2020-05-18", "QueryDISyncTaskConfigProcessResult")
        {
		...
		public long? AsyncProcessId
		{
			...
			set	
			{
				asyncProcessId = value;
				DictionaryUtil.Add(QueryParameters, "AsyncProcessId", value.ToString());
			}
		}
        ...
        public override QueryDISyncTaskConfigProcessResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDISyncTaskConfigProcessResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
