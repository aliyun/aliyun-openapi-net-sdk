...
{
    public class CreateTableLevelRequest : RpcAcsRequest<CreateTableLevelResponse>
    {
        public CreateTableLevelRequest()
            : base("dataworks-public", "2020-05-18", "CreateTableLevel")
        {
        ...
        public override CreateTableLevelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTableLevelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
