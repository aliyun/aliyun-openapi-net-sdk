...
{
    public class DeleteTableThemeRequest : RpcAcsRequest<DeleteTableThemeResponse>
    {
        public DeleteTableThemeRequest()
            : base("dataworks-public", "2020-05-18", "DeleteTableTheme")
        {
        ...
        public override DeleteTableThemeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTableThemeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
