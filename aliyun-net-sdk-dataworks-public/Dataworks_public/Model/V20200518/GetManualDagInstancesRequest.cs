...
{
    public class GetManualDagInstancesRequest : RpcAcsRequest<GetManualDagInstancesResponse>
    {
        public GetManualDagInstancesRequest()
            : base("dataworks-public", "2020-05-18", "GetManualDagInstances")
        {
        ...
        public override GetManualDagInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetManualDagInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
