...
{
    public class UpdateNodeOwnerRequest : RpcAcsRequest<UpdateNodeOwnerResponse>
    {
        public UpdateNodeOwnerRequest()
            : base("dataworks-public", "2020-05-18", "UpdateNodeOwner")
        {
        ...
        public override UpdateNodeOwnerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateNodeOwnerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
