...
{
    public class UpdateTableLevelRequest : RpcAcsRequest<UpdateTableLevelResponse>
    {
        public UpdateTableLevelRequest()
            : base("dataworks-public", "2020-05-18", "UpdateTableLevel")
        {
        ...
        public override UpdateTableLevelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTableLevelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
