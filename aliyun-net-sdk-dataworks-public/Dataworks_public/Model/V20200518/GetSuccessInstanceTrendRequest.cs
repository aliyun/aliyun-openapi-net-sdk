...
{
    public class GetSuccessInstanceTrendRequest : RpcAcsRequest<GetSuccessInstanceTrendResponse>
    {
        public GetSuccessInstanceTrendRequest()
            : base("dataworks-public", "2020-05-18", "GetSuccessInstanceTrend")
        {
        ...
        public override GetSuccessInstanceTrendResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSuccessInstanceTrendResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
