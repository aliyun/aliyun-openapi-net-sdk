...
{
    public class SearchNodesByOutputRequest : RpcAcsRequest<SearchNodesByOutputResponse>
    {
        public SearchNodesByOutputRequest()
            : base("dataworks-public", "2020-05-18", "SearchNodesByOutput")
        {
        ...
        public override SearchNodesByOutputResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchNodesByOutputResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
