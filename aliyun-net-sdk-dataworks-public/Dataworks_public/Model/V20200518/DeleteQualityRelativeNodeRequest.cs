...
{
    public class DeleteQualityRelativeNodeRequest : RpcAcsRequest<DeleteQualityRelativeNodeResponse>
    {
        public DeleteQualityRelativeNodeRequest()
            : base("dataworks-public", "2020-05-18", "DeleteQualityRelativeNode", "dide", "openAPI")
        {
        ...
        public override DeleteQualityRelativeNodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteQualityRelativeNodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
