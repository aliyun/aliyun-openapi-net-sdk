...
{
    public class DeleteTableLevelRequest : RpcAcsRequest<DeleteTableLevelResponse>
    {
        public DeleteTableLevelRequest()
            : base("dataworks-public", "2020-05-18", "DeleteTableLevel")
        {
        ...
        public override DeleteTableLevelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTableLevelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
