...
{
    public class RunCycleDagNodesRequest : RpcAcsRequest<RunCycleDagNodesResponse>
    {
        public RunCycleDagNodesRequest()
            : base("dataworks-public", "2020-05-18", "RunCycleDagNodes")
        {
        ...
        public override RunCycleDagNodesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RunCycleDagNodesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
