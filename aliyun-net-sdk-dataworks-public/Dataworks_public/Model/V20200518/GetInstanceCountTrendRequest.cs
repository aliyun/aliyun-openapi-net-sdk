...
{
    public class GetInstanceCountTrendRequest : RpcAcsRequest<GetInstanceCountTrendResponse>
    {
        public GetInstanceCountTrendRequest()
            : base("dataworks-public", "2020-05-18", "GetInstanceCountTrend")
        {
        ...
        public override GetInstanceCountTrendResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInstanceCountTrendResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
