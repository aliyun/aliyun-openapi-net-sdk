...
{
    public class CreateBusinessRequest : RpcAcsRequest<CreateBusinessResponse>
    {
        public CreateBusinessRequest()
            : base("dataworks-public", "2020-05-18", "CreateBusiness")
        {
        ...
        public override CreateBusinessResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateBusinessResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
