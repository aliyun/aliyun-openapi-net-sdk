...
{
    public class StartMigrationRequest : RpcAcsRequest<StartMigrationResponse>
    {
        public StartMigrationRequest()
            : base("dataworks-public", "2020-05-18", "StartMigration")
        {
        ...
        public override StartMigrationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartMigrationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
