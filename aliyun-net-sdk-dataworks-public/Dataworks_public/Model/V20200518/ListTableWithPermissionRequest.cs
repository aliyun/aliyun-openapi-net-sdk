...
{
    public class ListTableWithPermissionRequest : RpcAcsRequest<ListTableWithPermissionResponse>
    {
        public ListTableWithPermissionRequest()
            : base("dataworks-public", "2020-05-18", "ListTableWithPermission")
        {
        ...
        public override ListTableWithPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTableWithPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
