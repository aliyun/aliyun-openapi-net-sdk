...
{
    public class CheckEngineMetaTableRequest : RpcAcsRequest<CheckEngineMetaTableResponse>
    {
        public CheckEngineMetaTableRequest()
            : base("dataworks-public", "2020-05-18", "CheckEngineMetaTable")
        {
        ...
        public override CheckEngineMetaTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckEngineMetaTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
