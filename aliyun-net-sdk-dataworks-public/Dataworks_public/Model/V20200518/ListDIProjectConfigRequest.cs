...
{
    public class ListDIProjectConfigRequest : RpcAcsRequest<ListDIProjectConfigResponse>
    {
        public ListDIProjectConfigRequest()
            : base("dataworks-public", "2020-05-18", "ListDIProjectConfig")
        {
        ...
        public override ListDIProjectConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDIProjectConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
