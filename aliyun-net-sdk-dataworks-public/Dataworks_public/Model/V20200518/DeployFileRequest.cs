...
{
    public class DeployFileRequest : RpcAcsRequest<DeployFileResponse>
    {
        public DeployFileRequest()
            : base("dataworks-public", "2020-05-18", "DeployFile", "dide", "openAPI")
        {
        ...
        public override DeployFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeployFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
