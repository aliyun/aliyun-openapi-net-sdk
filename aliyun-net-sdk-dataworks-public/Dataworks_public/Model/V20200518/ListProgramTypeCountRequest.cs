...
{
    public class ListProgramTypeCountRequest : RpcAcsRequest<ListProgramTypeCountResponse>
    {
        public ListProgramTypeCountRequest()
            : base("dataworks-public", "2020-05-18", "ListProgramTypeCount")
        {
        ...
        public override ListProgramTypeCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProgramTypeCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
