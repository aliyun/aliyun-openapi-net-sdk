...
{
    public class GetDataSourceMetaRequest : RpcAcsRequest<GetDataSourceMetaResponse>
    {
        public GetDataSourceMetaRequest()
            : base("dataworks-public", "2020-05-18", "GetDataSourceMeta")
        {
        ...
        public override GetDataSourceMetaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataSourceMetaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
