    ...
    public class GetMetaTableLineageRequest : RpcAcsRequest<GetMetaTableLineageResponse>
    {
		...
		public string NextPrimaryKey
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "NextPrimaryKey", value);
			}
		}
        ...
        public override GetMetaTableLineageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMetaTableLineageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
