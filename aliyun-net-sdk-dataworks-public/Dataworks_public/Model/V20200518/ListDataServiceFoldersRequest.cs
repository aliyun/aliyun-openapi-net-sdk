...
{
    public class ListDataServiceFoldersRequest : RpcAcsRequest<ListDataServiceFoldersResponse>
    {
        public ListDataServiceFoldersRequest()
            : base("dataworks-public", "2020-05-18", "ListDataServiceFolders")
        {
		...
		public string FolderNameKeyword
		{
			...
			set	
			{
				folderNameKeyword = value;
				DictionaryUtil.Add(BodyParameters, "FolderNameKeyword", value);
			}
		}
        ...
        public override ListDataServiceFoldersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDataServiceFoldersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
