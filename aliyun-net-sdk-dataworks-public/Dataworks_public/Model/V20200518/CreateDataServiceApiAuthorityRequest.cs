...
{
    public class CreateDataServiceApiAuthorityRequest : RpcAcsRequest<CreateDataServiceApiAuthorityResponse>
    {
        public CreateDataServiceApiAuthorityRequest()
            : base("dataworks-public", "2020-05-18", "CreateDataServiceApiAuthority")
        {
		...
		public long? AuthorizedProjectId
		{
			...
			set	
			{
				authorizedProjectId = value;
				DictionaryUtil.Add(BodyParameters, "AuthorizedProjectId", value.ToString());
			}
		}
        ...
        public override CreateDataServiceApiAuthorityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDataServiceApiAuthorityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
