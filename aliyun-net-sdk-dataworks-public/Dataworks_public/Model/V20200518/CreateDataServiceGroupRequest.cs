...
{
    public class CreateDataServiceGroupRequest : RpcAcsRequest<CreateDataServiceGroupResponse>
    {
        public CreateDataServiceGroupRequest()
            : base("dataworks-public", "2020-05-18", "CreateDataServiceGroup")
        {
		...
		public string ApiGatewayGroupId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "ApiGatewayGroupId", value);
			}
		}
		...
		public string GroupName
		{
			...
			{
				groupName = value;
				DictionaryUtil.Add(BodyParameters, "GroupName", value);
			}
		}
        ...
        public override CreateDataServiceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDataServiceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
