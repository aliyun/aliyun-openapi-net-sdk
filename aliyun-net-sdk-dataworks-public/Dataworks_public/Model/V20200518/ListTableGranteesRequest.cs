...
{
    public class ListTableGranteesRequest : RpcAcsRequest<ListTableGranteesResponse>
    {
        public ListTableGranteesRequest()
            : base("dataworks-public", "2020-05-18", "ListTableGrantees")
        {
        ...
        public override ListTableGranteesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTableGranteesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
