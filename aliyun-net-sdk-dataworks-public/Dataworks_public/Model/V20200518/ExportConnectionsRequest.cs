...
{
    public class ExportConnectionsRequest : RpcAcsRequest<ExportConnectionsResponse>
    {
        public ExportConnectionsRequest()
            : base("dataworks-public", "2020-05-18", "ExportConnections")
        {
        ...
        public override ExportConnectionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExportConnectionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
