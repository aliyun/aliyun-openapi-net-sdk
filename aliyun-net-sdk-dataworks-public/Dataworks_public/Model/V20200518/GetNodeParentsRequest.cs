...
{
    public class GetNodeParentsRequest : RpcAcsRequest<GetNodeParentsResponse>
    {
        public GetNodeParentsRequest()
            : base("dataworks-public", "2020-05-18", "GetNodeParents")
        {
        ...
        public override GetNodeParentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeParentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
