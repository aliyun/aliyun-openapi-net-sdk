...
{
    public class UpdateTableThemeRequest : RpcAcsRequest<UpdateTableThemeResponse>
    {
        public UpdateTableThemeRequest()
            : base("dataworks-public", "2020-05-18", "UpdateTableTheme")
        {
		...
		public long? ThemeId
		{
			...
			{
				themeId = value;
				DictionaryUtil.Add(QueryParameters, "ThemeId", value.ToString());
			}
		}
        ...
        public override UpdateTableThemeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTableThemeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
