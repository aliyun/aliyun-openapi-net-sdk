...
{
    public class GetInstanceConsumeTimeRankRequest : RpcAcsRequest<GetInstanceConsumeTimeRankResponse>
    {
        public GetInstanceConsumeTimeRankRequest()
            : base("dataworks-public", "2020-05-18", "GetInstanceConsumeTimeRank")
        {
        ...
        public override GetInstanceConsumeTimeRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInstanceConsumeTimeRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
