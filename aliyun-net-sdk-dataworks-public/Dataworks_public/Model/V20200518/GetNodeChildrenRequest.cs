...
{
    public class GetNodeChildrenRequest : RpcAcsRequest<GetNodeChildrenResponse>
    {
        public GetNodeChildrenRequest()
            : base("dataworks-public", "2020-05-18", "GetNodeChildren")
        {
        ...
        public override GetNodeChildrenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeChildrenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
