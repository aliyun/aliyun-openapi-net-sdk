...
{
    public class GetDataServiceGroupRequest : RpcAcsRequest<GetDataServiceGroupResponse>
    {
        public GetDataServiceGroupRequest()
            : base("dataworks-public", "2020-05-18", "GetDataServiceGroup")
        {
        ...
        public override GetDataServiceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataServiceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
