...
{
    public class GetInstanceStatusCountRequest : RpcAcsRequest<GetInstanceStatusCountResponse>
    {
        public GetInstanceStatusCountRequest()
            : base("dataworks-public", "2020-05-18", "GetInstanceStatusCount")
        {
        ...
        public override GetInstanceStatusCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInstanceStatusCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
