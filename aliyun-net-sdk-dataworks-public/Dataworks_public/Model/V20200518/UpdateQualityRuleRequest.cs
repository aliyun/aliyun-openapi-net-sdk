...
{
    public class UpdateQualityRuleRequest : RpcAcsRequest<UpdateQualityRuleResponse>
    {
        public UpdateQualityRuleRequest()
            : base("dataworks-public", "2020-05-18", "UpdateQualityRule", "dide", "openAPI")
        {
        ...
        public override UpdateQualityRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateQualityRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
