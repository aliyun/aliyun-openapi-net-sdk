...
{
    public class SetConnectionShareRequest : RpcAcsRequest<SetConnectionShareResponse>
    {
        public SetConnectionShareRequest()
            : base("dataworks-public", "2020-05-18", "SetConnectionShare")
        {
        ...
        public override SetConnectionShareResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetConnectionShareResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
