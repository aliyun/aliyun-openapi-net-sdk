...
{
    public class GetDataServiceFolderRequest : RpcAcsRequest<GetDataServiceFolderResponse>
    {
        public GetDataServiceFolderRequest()
            : base("dataworks-public", "2020-05-18", "GetDataServiceFolder")
        {
        ...
        public override GetDataServiceFolderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataServiceFolderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
