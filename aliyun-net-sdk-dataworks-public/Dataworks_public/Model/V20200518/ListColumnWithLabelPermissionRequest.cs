...
{
    public class ListColumnWithLabelPermissionRequest : RpcAcsRequest<ListColumnWithLabelPermissionResponse>
    {
        public ListColumnWithLabelPermissionRequest()
            : base("dataworks-public", "2020-05-18", "ListColumnWithLabelPermission")
        {
        ...
        public override ListColumnWithLabelPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListColumnWithLabelPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
