...
{
    public class UpdateDIProjectConfigRequest : RpcAcsRequest<UpdateDIProjectConfigResponse>
    {
        public UpdateDIProjectConfigRequest()
            : base("dataworks-public", "2020-05-18", "UpdateDIProjectConfig")
        {
		...
		public string ProjectConfig
		{
			...
			{
				projectConfig = value;
				DictionaryUtil.Add(QueryParameters, "ProjectConfig", value);
			}
		}
        ...
        public override UpdateDIProjectConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDIProjectConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
