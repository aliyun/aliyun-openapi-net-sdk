...
namespace Aliyun.Acs.dataworks_public.Transform.V20180601
{
    ...
    {
        public static DeleteDISyncTaskResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			data.Message = _ctx.StringValue("DeleteDISyncTask.Data.Message");
			deleteDISyncTaskResponse.Data = data;
