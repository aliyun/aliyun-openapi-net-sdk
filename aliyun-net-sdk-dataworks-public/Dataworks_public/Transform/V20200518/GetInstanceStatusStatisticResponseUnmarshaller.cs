...
namespace Aliyun.Acs.dataworks_public.Transform.V20200518
{
    ...
    {
        public static GetInstanceStatusStatisticResponse Unmarshall(UnmarshallerContext _ctx)
        {
			GetInstanceStatusStatisticResponse getInstanceStatusStatisticResponse = new GetInstanceStatusStatisticResponse();

			getInstanceStatusStatisticResponse.HttpResponse = _ctx.HttpResponse;
