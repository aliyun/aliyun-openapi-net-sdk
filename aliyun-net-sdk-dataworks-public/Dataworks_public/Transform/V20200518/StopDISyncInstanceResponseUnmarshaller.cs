...
namespace Aliyun.Acs.dataworks_public.Transform.V20200518
{
    ...
    {
        public static StopDISyncInstanceResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			data.Message = _ctx.StringValue("StopDISyncInstance.Data.Message");
			stopDISyncInstanceResponse.Data = data;
