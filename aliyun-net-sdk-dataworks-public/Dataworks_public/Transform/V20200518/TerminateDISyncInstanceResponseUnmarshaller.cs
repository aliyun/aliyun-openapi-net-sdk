...
namespace Aliyun.Acs.dataworks_public.Transform.V20200518
{
    ...
    {
        public static TerminateDISyncInstanceResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			data.Message = _ctx.StringValue("TerminateDISyncInstance.Data.Message");
			terminateDISyncInstanceResponse.Data = data;
