...
namespace Aliyun.Acs.dataworks_public.Transform.V20200518
{
    ...
    {
        public static UpdateTableAddColumnResponse Unmarshall(UnmarshallerContext _ctx)
        {
			UpdateTableAddColumnResponse updateTableAddColumnResponse = new UpdateTableAddColumnResponse();

			updateTableAddColumnResponse.HttpResponse = _ctx.HttpResponse;
