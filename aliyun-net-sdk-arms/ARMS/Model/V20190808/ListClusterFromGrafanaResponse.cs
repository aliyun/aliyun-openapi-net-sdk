...
{
	public class ListClusterFromGrafanaResponse : AcsResponse
	{

		private string requestId;

		private List<ListClusterFromGrafana_PromCluster> promClusterList;
		...
		public List<ListClusterFromGrafana_PromCluster> PromClusterList
		{
			get
			{
		...
		public class ListClusterFromGrafana_PromCluster
		{
