...
{
    public class SearchEventsRequest : RpcAcsRequest<SearchEventsResponse>
    {
        public SearchEventsRequest()
            : base("ARMS", "2019-08-08", "SearchEvents", "arms", "openAPI")
        {
		...
		public int? IsTrigger
		{
			...
			{
				isTrigger = value;
				DictionaryUtil.Add(QueryParameters, "IsTrigger", value.ToString());
			}
		}
        ...
        public override SearchEventsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchEventsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
