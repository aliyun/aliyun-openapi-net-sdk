    ...
    public class DescribeDomainListResponseUnmarshaller
    {
        public static DescribeDomainListResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			for (int i = 0; i < _ctx.Length("DescribeDomainList.DomainNames.Length"); i++) {
				describeDomainListResponse_domainNames.Add(_ctx.StringValue("DescribeDomainList.DomainNames["+ i +"]"));
			}
			describeDomainListResponse.DomainNames = describeDomainListResponse_domainNames;
