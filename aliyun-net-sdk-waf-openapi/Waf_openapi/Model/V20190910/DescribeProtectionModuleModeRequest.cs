...
{
    public class DescribeProtectionModuleModeRequest : RpcAcsRequest<DescribeProtectionModuleModeResponse>
    {
        public DescribeProtectionModuleModeRequest()
            : base("waf-openapi", "2019-09-10", "DescribeProtectionModuleMode", "waf", "openAPI")
        {
        ...
        public override DescribeProtectionModuleModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProtectionModuleModeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
