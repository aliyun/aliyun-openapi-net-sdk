...
{
    public class ModifyLogServiceStatusRequest : RpcAcsRequest<ModifyLogServiceStatusResponse>
    {
        public ModifyLogServiceStatusRequest()
            : base("waf-openapi", "2019-09-10", "ModifyLogServiceStatus", "waf", "openAPI")
        {
        ...
        public override ModifyLogServiceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyLogServiceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
