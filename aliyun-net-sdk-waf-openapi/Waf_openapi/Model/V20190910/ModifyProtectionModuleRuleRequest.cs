...
{
    public class ModifyProtectionModuleRuleRequest : RpcAcsRequest<ModifyProtectionModuleRuleResponse>
    {
        public ModifyProtectionModuleRuleRequest()
            : base("waf-openapi", "2019-09-10", "ModifyProtectionModuleRule", "waf", "openAPI")
        {
        ...
        public override ModifyProtectionModuleRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyProtectionModuleRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
