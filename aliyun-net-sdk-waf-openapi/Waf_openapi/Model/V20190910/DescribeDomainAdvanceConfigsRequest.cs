...
{
    public class DescribeDomainAdvanceConfigsRequest : RpcAcsRequest<DescribeDomainAdvanceConfigsResponse>
    {
        public DescribeDomainAdvanceConfigsRequest()
            : base("waf-openapi", "2019-09-10", "DescribeDomainAdvanceConfigs", "waf", "openAPI")
        {
        ...
        public override DescribeDomainAdvanceConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainAdvanceConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
