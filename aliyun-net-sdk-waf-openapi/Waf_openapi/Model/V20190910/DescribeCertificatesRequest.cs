...
{
    public class DescribeCertificatesRequest : RpcAcsRequest<DescribeCertificatesResponse>
    {
        public DescribeCertificatesRequest()
            : base("waf-openapi", "2019-09-10", "DescribeCertificates", "waf", "openAPI")
        {
        ...
        public override DescribeCertificatesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCertificatesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
