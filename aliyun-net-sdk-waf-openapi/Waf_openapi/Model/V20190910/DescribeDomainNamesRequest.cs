...
{
    public class DescribeDomainNamesRequest : RpcAcsRequest<DescribeDomainNamesResponse>
    {
        public DescribeDomainNamesRequest()
            : base("waf-openapi", "2019-09-10", "DescribeDomainNames", "waf", "openAPI")
        {
        ...
        public override DescribeDomainNamesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainNamesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
