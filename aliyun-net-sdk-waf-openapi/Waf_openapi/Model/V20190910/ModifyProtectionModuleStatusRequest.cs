...
{
    public class ModifyProtectionModuleStatusRequest : RpcAcsRequest<ModifyProtectionModuleStatusResponse>
    {
        public ModifyProtectionModuleStatusRequest()
            : base("waf-openapi", "2019-09-10", "ModifyProtectionModuleStatus", "waf", "openAPI")
        {
		...
		public int? ModuleStatus
		{
			...
			{
				moduleStatus = value;
				DictionaryUtil.Add(QueryParameters, "ModuleStatus", value.ToString());
			}
		}
        ...
        public override ModifyProtectionModuleStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyProtectionModuleStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
