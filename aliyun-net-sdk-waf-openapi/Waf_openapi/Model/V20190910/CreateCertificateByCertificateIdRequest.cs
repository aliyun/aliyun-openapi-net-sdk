...
{
    public class CreateCertificateByCertificateIdRequest : RpcAcsRequest<CreateCertificateByCertificateIdResponse>
    {
        public CreateCertificateByCertificateIdRequest()
            : base("waf-openapi", "2019-09-10", "CreateCertificateByCertificateId", "waf", "openAPI")
        {
        ...
        public override CreateCertificateByCertificateIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCertificateByCertificateIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
