...
{
    public class DescribeLogServiceStatusRequest : RpcAcsRequest<DescribeLogServiceStatusResponse>
    {
        public DescribeLogServiceStatusRequest()
            : base("waf-openapi", "2019-09-10", "DescribeLogServiceStatus", "waf", "openAPI")
        {
        ...
        public override DescribeLogServiceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLogServiceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
