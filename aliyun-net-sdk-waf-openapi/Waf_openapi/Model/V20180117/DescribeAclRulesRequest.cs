...
{
    public class DescribeAclRulesRequest : RpcAcsRequest<DescribeAclRulesResponse>
    {
        public DescribeAclRulesRequest()
            : base("waf-openapi", "2018-01-17", "DescribeAclRules", "waf", "openAPI")
        {
        ...
        public override DescribeAclRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAclRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
