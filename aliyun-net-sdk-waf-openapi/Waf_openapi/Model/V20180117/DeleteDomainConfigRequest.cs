...
{
    public class DeleteDomainConfigRequest : RpcAcsRequest<DeleteDomainConfigResponse>
    {
        public DeleteDomainConfigRequest()
            : base("waf-openapi", "2018-01-17", "DeleteDomainConfig", "waf", "openAPI")
        {
        ...
        public override DeleteDomainConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDomainConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
