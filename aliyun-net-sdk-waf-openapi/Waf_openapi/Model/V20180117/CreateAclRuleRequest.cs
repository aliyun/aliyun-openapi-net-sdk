...
{
    public class CreateAclRuleRequest : RpcAcsRequest<CreateAclRuleResponse>
    {
        public CreateAclRuleRequest()
            : base("waf-openapi", "2018-01-17", "CreateAclRule", "waf", "openAPI")
        {
        ...
        public override CreateAclRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateAclRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
