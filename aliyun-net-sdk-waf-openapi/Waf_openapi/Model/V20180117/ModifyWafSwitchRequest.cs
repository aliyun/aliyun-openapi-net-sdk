...
{
    public class ModifyWafSwitchRequest : RpcAcsRequest<ModifyWafSwitchResponse>
    {
        public ModifyWafSwitchRequest()
            : base("waf-openapi", "2018-01-17", "ModifyWafSwitch", "waf", "openAPI")
        {
		...
		public int? ServiceOn
		{
			...
			{
				serviceOn = value;
				DictionaryUtil.Add(QueryParameters, "ServiceOn", value.ToString());
			}
		}
        ...
        public override ModifyWafSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWafSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
