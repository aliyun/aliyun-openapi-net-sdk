...
{
    public class DescribePayInfoRequest : RpcAcsRequest<DescribePayInfoResponse>
    {
        public DescribePayInfoRequest()
            : base("waf-openapi", "2018-01-17", "DescribePayInfo", "waf", "openAPI")
        {
        ...
        public override DescribePayInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePayInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
