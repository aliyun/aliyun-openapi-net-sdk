...
{
    public class DescribeDomainConfigRequest : RpcAcsRequest<DescribeDomainConfigResponse>
    {
        public DescribeDomainConfigRequest()
            : base("waf-openapi", "2018-01-17", "DescribeDomainConfig", "waf", "openAPI")
        {
        ...
        public override DescribeDomainConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
