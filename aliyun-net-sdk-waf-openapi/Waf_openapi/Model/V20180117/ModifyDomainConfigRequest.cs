...
{
    public class ModifyDomainConfigRequest : RpcAcsRequest<ModifyDomainConfigResponse>
    {
        public ModifyDomainConfigRequest()
            : base("waf-openapi", "2018-01-17", "ModifyDomainConfig", "waf", "openAPI")
        {
        ...
        public override ModifyDomainConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDomainConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
