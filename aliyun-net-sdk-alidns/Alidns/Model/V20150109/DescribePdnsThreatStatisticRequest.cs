...
{
    public class DescribePdnsThreatStatisticRequest : RpcAcsRequest<DescribePdnsThreatStatisticResponse>
    {
        public DescribePdnsThreatStatisticRequest()
            : base("Alidns", "2015-01-09", "DescribePdnsThreatStatistic", "alidns", "openAPI")
        {
        ...
        public override DescribePdnsThreatStatisticResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePdnsThreatStatisticResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
