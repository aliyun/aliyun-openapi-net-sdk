...
{
    public class DescribePdnsThreatStatisticsRequest : RpcAcsRequest<DescribePdnsThreatStatisticsResponse>
    {
        public DescribePdnsThreatStatisticsRequest()
            : base("Alidns", "2015-01-09", "DescribePdnsThreatStatistics", "alidns", "openAPI")
        {
        ...
        public override DescribePdnsThreatStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePdnsThreatStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
