...
{
    public class UpdateDnsCacheDomainRequest : RpcAcsRequest<UpdateDnsCacheDomainResponse>
    {
        public UpdateDnsCacheDomainRequest()
            : base("Alidns", "2015-01-09", "UpdateDnsCacheDomain", "alidns", "openAPI")
        {
        ...
        public override UpdateDnsCacheDomainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDnsCacheDomainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
