...
{
    public class DescribePdnsOperateLogsRequest : RpcAcsRequest<DescribePdnsOperateLogsResponse>
    {
        public DescribePdnsOperateLogsRequest()
            : base("Alidns", "2015-01-09", "DescribePdnsOperateLogs", "alidns", "openAPI")
        {
        ...
        public override DescribePdnsOperateLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePdnsOperateLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
