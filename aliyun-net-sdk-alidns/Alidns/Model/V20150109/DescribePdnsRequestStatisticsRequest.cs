...
{
    public class DescribePdnsRequestStatisticsRequest : RpcAcsRequest<DescribePdnsRequestStatisticsResponse>
    {
        public DescribePdnsRequestStatisticsRequest()
            : base("Alidns", "2015-01-09", "DescribePdnsRequestStatistics", "alidns", "openAPI")
        {
        ...
        public override DescribePdnsRequestStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePdnsRequestStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
