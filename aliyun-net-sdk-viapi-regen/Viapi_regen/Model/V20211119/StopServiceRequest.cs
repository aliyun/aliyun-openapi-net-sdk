...
{
    public class StopServiceRequest : RpcAcsRequest<StopServiceResponse>
    {
        public StopServiceRequest()
            : base("viapi-regen", "2021-11-19", "StopService", "selflearning", "openAPI")
        {
        ...
        public override StopServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
