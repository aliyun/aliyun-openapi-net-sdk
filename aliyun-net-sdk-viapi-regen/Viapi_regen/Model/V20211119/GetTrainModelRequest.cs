...
{
    public class GetTrainModelRequest : RpcAcsRequest<GetTrainModelResponse>
    {
        public GetTrainModelRequest()
            : base("viapi-regen", "2021-11-19", "GetTrainModel", "selflearning", "openAPI")
        {
        ...
        public override GetTrainModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTrainModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
