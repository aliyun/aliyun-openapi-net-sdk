...
{
    public class DeleteLabelsetDataRequest : RpcAcsRequest<DeleteLabelsetDataResponse>
    {
        public DeleteLabelsetDataRequest()
            : base("viapi-regen", "2021-11-19", "DeleteLabelsetData", "selflearning", "openAPI")
        {
        ...
        public override DeleteLabelsetDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLabelsetDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
