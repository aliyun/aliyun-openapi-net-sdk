...
{
    public class GetWorkspaceRequest : RpcAcsRequest<GetWorkspaceResponse>
    {
        public GetWorkspaceRequest()
            : base("viapi-regen", "2021-11-19", "GetWorkspace", "selflearning", "openAPI")
        {
        ...
        public override GetWorkspaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWorkspaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
