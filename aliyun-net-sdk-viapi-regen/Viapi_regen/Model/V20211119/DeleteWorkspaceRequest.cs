...
{
    public class DeleteWorkspaceRequest : RpcAcsRequest<DeleteWorkspaceResponse>
    {
        public DeleteWorkspaceRequest()
            : base("viapi-regen", "2021-11-19", "DeleteWorkspace", "selflearning", "openAPI")
        {
        ...
        public override DeleteWorkspaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteWorkspaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
