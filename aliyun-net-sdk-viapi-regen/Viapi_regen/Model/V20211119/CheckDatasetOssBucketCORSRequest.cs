...
{
    public class CheckDatasetOssBucketCORSRequest : RpcAcsRequest<CheckDatasetOssBucketCORSResponse>
    {
        public CheckDatasetOssBucketCORSRequest()
            : base("viapi-regen", "2021-11-19", "CheckDatasetOssBucketCORS", "selflearning", "openAPI")
        {
        ...
        public override CheckDatasetOssBucketCORSResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckDatasetOssBucketCORSResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
