...
{
    public class DebugServiceRequest : RpcAcsRequest<DebugServiceResponse>
    {
        public DebugServiceRequest()
            : base("viapi-regen", "2021-11-19", "DebugService", "selflearning", "openAPI")
        {
		...
		public string Param
		{
			...
			{
				param = value;
				DictionaryUtil.Add(BodyParameters, "Param", value);
			}
		}
        ...
        public override DebugServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DebugServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
