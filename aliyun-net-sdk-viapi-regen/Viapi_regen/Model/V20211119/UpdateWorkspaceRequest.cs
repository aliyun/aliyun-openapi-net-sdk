...
{
    public class UpdateWorkspaceRequest : RpcAcsRequest<UpdateWorkspaceResponse>
    {
        public UpdateWorkspaceRequest()
            : base("viapi-regen", "2021-11-19", "UpdateWorkspace", "selflearning", "openAPI")
        {
        ...
        public override UpdateWorkspaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateWorkspaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
