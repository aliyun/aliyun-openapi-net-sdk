...
{
    public class ListTrainTasksRequest : RpcAcsRequest<ListTrainTasksResponse>
    {
        public ListTrainTasksRequest()
            : base("viapi-regen", "2021-11-19", "ListTrainTasks", "selflearning", "openAPI")
        {
        ...
        public override ListTrainTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTrainTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
