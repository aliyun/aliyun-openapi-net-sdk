...
{
    public class GetUploadPolicyRequest : RpcAcsRequest<GetUploadPolicyResponse>
    {
        public GetUploadPolicyRequest()
            : base("viapi-regen", "2021-11-19", "GetUploadPolicy", "selflearning", "openAPI")
        {
        ...
        public override GetUploadPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUploadPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
