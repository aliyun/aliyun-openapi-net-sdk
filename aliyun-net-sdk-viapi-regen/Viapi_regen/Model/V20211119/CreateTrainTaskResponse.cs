...
{
	public class CreateTrainTaskResponse : AcsResponse
	{
		...
		private CreateTrainTask_Data data;
		...
		public CreateTrainTask_Data Data
		{
			get
			{
				return data;
		...
		public class CreateTrainTask_Data
		{
			...
			public string RelyOnTaskName
			{
				get
				{
					return relyOnTaskName;
				}
				set	
				{
					relyOnTaskName = value;
				}
			}
