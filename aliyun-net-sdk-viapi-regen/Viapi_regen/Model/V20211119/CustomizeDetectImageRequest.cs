...
{
    public class CustomizeDetectImageRequest : RpcAcsRequest<CustomizeDetectImageResponse>
    {
        public CustomizeDetectImageRequest()
            : base("viapi-regen", "2021-11-19", "CustomizeDetectImage", "selflearning", "openAPI")
        {
        ...
        public override CustomizeDetectImageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CustomizeDetectImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
