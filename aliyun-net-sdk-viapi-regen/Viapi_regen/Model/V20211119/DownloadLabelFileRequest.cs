...
{
    public class DownloadLabelFileRequest : RpcAcsRequest<DownloadLabelFileResponse>
    {
        public DownloadLabelFileRequest()
            : base("viapi-regen", "2021-11-19", "DownloadLabelFile", "selflearning", "openAPI")
        {
        ...
        public override DownloadLabelFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DownloadLabelFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
