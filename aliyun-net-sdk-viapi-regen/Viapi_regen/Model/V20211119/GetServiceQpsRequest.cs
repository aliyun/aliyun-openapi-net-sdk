...
{
    public class GetServiceQpsRequest : RpcAcsRequest<GetServiceQpsResponse>
    {
        public GetServiceQpsRequest()
            : base("viapi-regen", "2021-11-19", "GetServiceQps", "selflearning", "openAPI")
        {
        ...
        public override GetServiceQpsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceQpsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
