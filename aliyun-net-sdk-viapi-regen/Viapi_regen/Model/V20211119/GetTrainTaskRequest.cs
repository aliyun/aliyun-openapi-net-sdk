...
{
    public class GetTrainTaskRequest : RpcAcsRequest<GetTrainTaskResponse>
    {
        public GetTrainTaskRequest()
            : base("viapi-regen", "2021-11-19", "GetTrainTask", "selflearning", "openAPI")
        {
        ...
        public override GetTrainTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTrainTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
