...
{
    public class DownloadFileNameListRequest : RpcAcsRequest<DownloadFileNameListResponse>
    {
        public DownloadFileNameListRequest()
            : base("viapi-regen", "2021-11-19", "DownloadFileNameList", "selflearning", "openAPI")
        {
        ...
        public override DownloadFileNameListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DownloadFileNameListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
