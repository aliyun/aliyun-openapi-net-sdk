...
{
    public class DeleteLabelsetRequest : RpcAcsRequest<DeleteLabelsetResponse>
    {
        public DeleteLabelsetRequest()
            : base("viapi-regen", "2021-11-19", "DeleteLabelset", "selflearning", "openAPI")
        {
        ...
        public override DeleteLabelsetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLabelsetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
