...
{
	public class EnableDataReflowResponse : AcsResponse
	{
		...
		private EnableDataReflow_Data data;
		...
		public EnableDataReflow_Data Data
		{
			get
			{
				return data;
		...
		public class EnableDataReflow_Data
		{
