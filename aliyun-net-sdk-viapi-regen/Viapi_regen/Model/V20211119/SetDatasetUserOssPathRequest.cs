...
{
    public class SetDatasetUserOssPathRequest : RpcAcsRequest<SetDatasetUserOssPathResponse>
    {
        public SetDatasetUserOssPathRequest()
            : base("viapi-regen", "2021-11-19", "SetDatasetUserOssPath", "selflearning", "openAPI")
        {
        ...
        public override SetDatasetUserOssPathResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetDatasetUserOssPathResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
