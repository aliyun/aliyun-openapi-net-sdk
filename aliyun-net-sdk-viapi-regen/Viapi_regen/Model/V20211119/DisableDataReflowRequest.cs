...
{
    public class DisableDataReflowRequest : RpcAcsRequest<DisableDataReflowResponse>
    {
        public DisableDataReflowRequest()
            : base("viapi-regen", "2021-11-19", "DisableDataReflow", "selflearning", "openAPI")
        {
        ...
        public override DisableDataReflowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableDataReflowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
