...
{
    public class GetLabelsetRequest : RpcAcsRequest<GetLabelsetResponse>
    {
        public GetLabelsetRequest()
            : base("viapi-regen", "2021-11-19", "GetLabelset", "selflearning", "openAPI")
        {
        ...
        public override GetLabelsetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLabelsetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
