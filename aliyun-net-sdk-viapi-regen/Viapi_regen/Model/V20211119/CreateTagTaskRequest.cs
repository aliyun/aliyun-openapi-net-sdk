...
{
    public class CreateTagTaskRequest : RpcAcsRequest<CreateTagTaskResponse>
    {
        public CreateTagTaskRequest()
            : base("viapi-regen", "2021-11-19", "CreateTagTask", "selflearning", "openAPI")
        {
        ...
        public override CreateTagTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTagTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
