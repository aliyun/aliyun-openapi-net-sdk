...
{
    public class ListLabelsetDatasRequest : RpcAcsRequest<ListLabelsetDatasResponse>
    {
        public ListLabelsetDatasRequest()
            : base("viapi-regen", "2021-11-19", "ListLabelsetDatas", "selflearning", "openAPI")
        {
        ...
        public override ListLabelsetDatasResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLabelsetDatasResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
