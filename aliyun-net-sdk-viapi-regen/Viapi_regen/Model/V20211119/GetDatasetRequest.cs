...
{
    public class GetDatasetRequest : RpcAcsRequest<GetDatasetResponse>
    {
        public GetDatasetRequest()
            : base("viapi-regen", "2021-11-19", "GetDataset", "selflearning", "openAPI")
        {
        ...
        public override GetDatasetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDatasetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
