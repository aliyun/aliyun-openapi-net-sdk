...
{
    public class EnableDataReflowRequest : RpcAcsRequest<EnableDataReflowResponse>
    {
        public EnableDataReflowRequest()
            : base("viapi-regen", "2021-11-19", "EnableDataReflow", "selflearning", "openAPI")
        {
		...
		public long? DataReflowRate
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "DataReflowRate", value.ToString());
			}
		}
		...
		public string DataReflowOssPath
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "DataReflowOssPath", value);
			}
		}
        ...
        public override EnableDataReflowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableDataReflowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
