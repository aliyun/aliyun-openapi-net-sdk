...
{
    public class UpdateDatasetRequest : RpcAcsRequest<UpdateDatasetResponse>
    {
        public UpdateDatasetRequest()
            : base("viapi-regen", "2021-11-19", "UpdateDataset", "selflearning", "openAPI")
        {
        ...
        public override UpdateDatasetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDatasetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
