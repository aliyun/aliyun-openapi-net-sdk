...
{
    public class StopTrainTaskRequest : RpcAcsRequest<StopTrainTaskResponse>
    {
        public StopTrainTaskRequest()
            : base("viapi-regen", "2021-11-19", "StopTrainTask", "selflearning", "openAPI")
        {
        ...
        public override StopTrainTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopTrainTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
