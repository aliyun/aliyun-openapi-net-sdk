...
{
    public class DeleteDataReflowDataRequest : RpcAcsRequest<DeleteDataReflowDataResponse>
    {
        public DeleteDataReflowDataRequest()
            : base("viapi-regen", "2021-11-19", "DeleteDataReflowData", "selflearning", "openAPI")
        {
        ...
        public override DeleteDataReflowDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDataReflowDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
