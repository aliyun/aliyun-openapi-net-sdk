...
{
	public class DisableDataReflowResponse : AcsResponse
	{
		...
		private DisableDataReflow_Data data;
		...
		public DisableDataReflow_Data Data
		{
			get
			{
				return data;
		...
		public class DisableDataReflow_Data
		{
