...
{
    public class GetLabelDetailRequest : RpcAcsRequest<GetLabelDetailResponse>
    {
        public GetLabelDetailRequest()
            : base("viapi-regen", "2021-11-19", "GetLabelDetail", "selflearning", "openAPI")
        {
        ...
        public override GetLabelDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLabelDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
