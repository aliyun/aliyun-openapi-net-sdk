...
{
    public class ListDatasetsRequest : RpcAcsRequest<ListDatasetsResponse>
    {
        public ListDatasetsRequest()
            : base("viapi-regen", "2021-11-19", "ListDatasets", "selflearning", "openAPI")
        {
        ...
        public override ListDatasetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDatasetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
