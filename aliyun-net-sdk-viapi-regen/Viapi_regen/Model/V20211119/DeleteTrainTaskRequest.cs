...
{
    public class DeleteTrainTaskRequest : RpcAcsRequest<DeleteTrainTaskResponse>
    {
        public DeleteTrainTaskRequest()
            : base("viapi-regen", "2021-11-19", "DeleteTrainTask", "selflearning", "openAPI")
        {
        ...
        public override DeleteTrainTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTrainTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
