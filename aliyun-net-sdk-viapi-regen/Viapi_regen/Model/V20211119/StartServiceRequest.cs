...
{
    public class StartServiceRequest : RpcAcsRequest<StartServiceResponse>
    {
        public StartServiceRequest()
            : base("viapi-regen", "2021-11-19", "StartService", "selflearning", "openAPI")
        {
        ...
        public override StartServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
