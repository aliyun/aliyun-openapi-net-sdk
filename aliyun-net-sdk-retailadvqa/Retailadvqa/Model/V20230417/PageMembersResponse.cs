...
{
	public class PageMembersResponse : AcsResponse
	{
		...
		private List<PageMembers_DataItem> data;
		...
		public List<PageMembers_DataItem> Data
		{
			get
			{
				return data;
		...
		public class PageMembers_DataItem
		{
