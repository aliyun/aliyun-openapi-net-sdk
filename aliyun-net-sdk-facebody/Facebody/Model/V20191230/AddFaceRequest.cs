...
{
    public class AddFaceRequest : RpcAcsRequest<AddFaceResponse>
    {
        public AddFaceRequest()
            : base("facebody", "2019-12-30", "AddFace", "facebody", "openAPI")
        {
        ...
        public override AddFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
