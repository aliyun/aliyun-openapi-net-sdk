...
{
    public class DeleteFaceEntityRequest : RpcAcsRequest<DeleteFaceEntityResponse>
    {
        public DeleteFaceEntityRequest()
            : base("facebody", "2019-12-30", "DeleteFaceEntity", "facebody", "openAPI")
        {
        ...
        public override DeleteFaceEntityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFaceEntityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
