...
{
	public class ExtractPedestrianFeatureAttributeResponse : AcsResponse
	{

		private string requestId;

		private ExtractPedestrianFeatureAttribute_Data data;
		...
		public ExtractPedestrianFeatureAttribute_Data Data
		{
			get
			{
				return data;
		...
		public class ExtractPedestrianFeatureAttribute_Data
		{
			...
			private List<ExtractPedestrianFeatureAttribute_Element> elements;
			...
			public List<ExtractPedestrianFeatureAttribute_Element> Elements
			{
				get
				{
					return elements;
			...
			public class ExtractPedestrianFeatureAttribute_Element
			{
