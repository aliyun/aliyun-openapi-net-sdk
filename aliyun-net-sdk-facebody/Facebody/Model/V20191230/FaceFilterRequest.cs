...
{
    public class FaceFilterRequest : RpcAcsRequest<FaceFilterResponse>
    {
        public FaceFilterRequest()
            : base("facebody", "2019-12-30", "FaceFilter", "facebody", "openAPI")
        {
        ...
        public override FaceFilterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FaceFilterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
