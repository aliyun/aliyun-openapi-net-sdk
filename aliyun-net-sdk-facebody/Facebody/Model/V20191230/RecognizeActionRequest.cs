...
{
    public class RecognizeActionRequest : RpcAcsRequest<RecognizeActionResponse>
    {
        public RecognizeActionRequest()
            : base("facebody", "2019-12-30", "RecognizeAction", "facebody", "openAPI")
        {
        ...
        public override RecognizeActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
