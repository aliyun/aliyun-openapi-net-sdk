...
{
    public class HandPostureRequest : RpcAcsRequest<HandPostureResponse>
    {
        public HandPostureRequest()
            : base("facebody", "2019-12-30", "HandPosture", "facebody", "openAPI")
        {
        ...
        public override HandPostureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return HandPostureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
