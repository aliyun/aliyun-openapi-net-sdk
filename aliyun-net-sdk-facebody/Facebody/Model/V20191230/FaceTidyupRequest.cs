...
{
    public class FaceTidyupRequest : RpcAcsRequest<FaceTidyupResponse>
    {
        public FaceTidyupRequest()
            : base("facebody", "2019-12-30", "FaceTidyup", "facebody", "openAPI")
        {
		...
		public int? ShapeType
		{
			...
			{
				shapeType = value;
				DictionaryUtil.Add(BodyParameters, "ShapeType", value.ToString());
			}
		}
        ...
        public override FaceTidyupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FaceTidyupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
