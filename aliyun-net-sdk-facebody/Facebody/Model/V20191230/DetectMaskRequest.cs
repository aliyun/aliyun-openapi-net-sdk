...
{
    public class DetectMaskRequest : RpcAcsRequest<DetectMaskResponse>
    {
        public DetectMaskRequest()
            : base("facebody", "2019-12-30", "DetectMask", "facebody", "openAPI")
        {
        ...
        public override DetectMaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectMaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
