...
{
    public class BlurFaceRequest : RpcAcsRequest<BlurFaceResponse>
    {
        public BlurFaceRequest()
            : base("facebody", "2019-12-30", "BlurFace", "facebody", "openAPI")
        {
        ...
        public override BlurFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BlurFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
