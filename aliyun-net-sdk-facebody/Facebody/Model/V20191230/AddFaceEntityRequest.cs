...
{
    public class AddFaceEntityRequest : RpcAcsRequest<AddFaceEntityResponse>
    {
        public AddFaceEntityRequest()
            : base("facebody", "2019-12-30", "AddFaceEntity", "facebody", "openAPI")
        {
        ...
        public override AddFaceEntityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceEntityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
