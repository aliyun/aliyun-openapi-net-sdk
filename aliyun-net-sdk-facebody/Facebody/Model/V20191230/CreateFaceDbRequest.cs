...
{
    public class CreateFaceDbRequest : RpcAcsRequest<CreateFaceDbResponse>
    {
        public CreateFaceDbRequest()
            : base("facebody", "2019-12-30", "CreateFaceDb", "facebody", "openAPI")
        {
        ...
        public override CreateFaceDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFaceDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
