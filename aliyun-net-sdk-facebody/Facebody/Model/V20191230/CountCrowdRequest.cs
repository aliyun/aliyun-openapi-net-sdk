...
{
    public class CountCrowdRequest : RpcAcsRequest<CountCrowdResponse>
    {
        public CountCrowdRequest()
            : base("facebody", "2019-12-30", "CountCrowd", "facebody", "openAPI")
        {
		...
		public bool? IsShow
		{
			...
			{
				isShow = value;
				DictionaryUtil.Add(BodyParameters, "IsShow", value.ToString());
			}
		}
        ...
        public override CountCrowdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountCrowdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
