...
{
    public class GenerateHumanAnimeStyleRequest : RpcAcsRequest<GenerateHumanAnimeStyleResponse>
    {
        public GenerateHumanAnimeStyleRequest()
            : base("facebody", "2019-12-30", "GenerateHumanAnimeStyle", "facebody", "openAPI")
        {
        ...
        public override GenerateHumanAnimeStyleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateHumanAnimeStyleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
