...
{
    public class DetectVideoLivingFaceRequest : RpcAcsRequest<DetectVideoLivingFaceResponse>
    {
        public DetectVideoLivingFaceRequest()
            : base("facebody", "2019-12-30", "DetectVideoLivingFace", "facebody", "openAPI")
        {
        ...
        public override DetectVideoLivingFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectVideoLivingFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
