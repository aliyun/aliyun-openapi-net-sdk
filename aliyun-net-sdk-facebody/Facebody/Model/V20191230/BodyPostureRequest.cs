...
{
    public class BodyPostureRequest : RpcAcsRequest<BodyPostureResponse>
    {
        public BodyPostureRequest()
            : base("facebody", "2019-12-30", "BodyPosture", "facebody", "openAPI")
        {
        ...
        public override BodyPostureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BodyPostureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
