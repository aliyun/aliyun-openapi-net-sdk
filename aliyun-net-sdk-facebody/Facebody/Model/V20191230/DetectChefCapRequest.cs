...
{
    public class DetectChefCapRequest : RpcAcsRequest<DetectChefCapResponse>
    {
        public DetectChefCapRequest()
            : base("facebody", "2019-12-30", "DetectChefCap", "facebody", "openAPI")
        {
        ...
        public override DetectChefCapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectChefCapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
