...
{
    public class DetectBodyCountRequest : RpcAcsRequest<DetectBodyCountResponse>
    {
        public DetectBodyCountRequest()
            : base("facebody", "2019-12-30", "DetectBodyCount", "facebody", "openAPI")
        {
        ...
        public override DetectBodyCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectBodyCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
