...
{
    public class EnhanceFaceRequest : RpcAcsRequest<EnhanceFaceResponse>
    {
        public EnhanceFaceRequest()
            : base("facebody", "2019-12-30", "EnhanceFace", "facebody", "openAPI")
        {
        ...
        public override EnhanceFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnhanceFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
