...
{
    public class ListFaceDbsRequest : RpcAcsRequest<ListFaceDbsResponse>
    {
        public ListFaceDbsRequest()
            : base("facebody", "2019-12-30", "ListFaceDbs", "facebody", "openAPI")
        {
        ...
        public override ListFaceDbsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFaceDbsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
