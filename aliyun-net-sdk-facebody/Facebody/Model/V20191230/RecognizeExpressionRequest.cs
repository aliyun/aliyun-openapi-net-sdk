...
{
    public class RecognizeExpressionRequest : RpcAcsRequest<RecognizeExpressionResponse>
    {
        public RecognizeExpressionRequest()
            : base("facebody", "2019-12-30", "RecognizeExpression", "facebody", "openAPI")
        {
        ...
        public override RecognizeExpressionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeExpressionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
