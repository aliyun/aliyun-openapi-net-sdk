...
{
    public class DetectLivingFaceRequest : RpcAcsRequest<DetectLivingFaceResponse>
    {
        public DetectLivingFaceRequest()
            : base("facebody", "2019-12-30", "DetectLivingFace", "facebody", "openAPI")
        {
        ...
        public override DetectLivingFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectLivingFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
