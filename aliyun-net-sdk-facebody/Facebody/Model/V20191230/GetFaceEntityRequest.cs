...
{
    public class GetFaceEntityRequest : RpcAcsRequest<GetFaceEntityResponse>
    {
        public GetFaceEntityRequest()
            : base("facebody", "2019-12-30", "GetFaceEntity", "facebody", "openAPI")
        {
        ...
        public override GetFaceEntityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFaceEntityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
