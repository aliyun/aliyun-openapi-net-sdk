...
{
    public class DetectPedestrianRequest : RpcAcsRequest<DetectPedestrianResponse>
    {
        public DetectPedestrianRequest()
            : base("facebody", "2019-12-30", "DetectPedestrian", "facebody", "openAPI")
        {
        ...
        public override DetectPedestrianResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectPedestrianResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
