...
{
    public class RecognizeFaceRequest : RpcAcsRequest<RecognizeFaceResponse>
    {
        public RecognizeFaceRequest()
            : base("facebody", "2019-12-30", "RecognizeFace", "facebody", "openAPI")
        {
        ...
        public override RecognizeFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
