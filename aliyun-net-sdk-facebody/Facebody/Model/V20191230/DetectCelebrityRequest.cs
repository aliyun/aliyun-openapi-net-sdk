...
{
    public class DetectCelebrityRequest : RpcAcsRequest<DetectCelebrityResponse>
    {
        public DetectCelebrityRequest()
            : base("facebody", "2019-12-30", "DetectCelebrity", "facebody", "openAPI")
        {
        ...
        public override DetectCelebrityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectCelebrityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
