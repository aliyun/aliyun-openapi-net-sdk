...
{
    public class RecognizePublicFaceRequest : RpcAcsRequest<RecognizePublicFaceResponse>
    {
        public RecognizePublicFaceRequest()
            : base("facebody", "2019-12-30", "RecognizePublicFace", "facebody", "openAPI")
        {
        ...
        public override RecognizePublicFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizePublicFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
