...
{
    public class SwapFacialFeaturesRequest : RpcAcsRequest<SwapFacialFeaturesResponse>
    {
        public SwapFacialFeaturesRequest()
            : base("facebody", "2019-12-30", "SwapFacialFeatures", "facebody", "openAPI")
        {
		...
		public string EditPart
		{
			...
			{
				editPart = value;
				DictionaryUtil.Add(BodyParameters, "EditPart", value);
			}
		}
        ...
        public override SwapFacialFeaturesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwapFacialFeaturesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
