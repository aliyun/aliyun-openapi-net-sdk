...
{
    public class DeleteFaceDbRequest : RpcAcsRequest<DeleteFaceDbResponse>
    {
        public DeleteFaceDbRequest()
            : base("facebody", "2019-12-30", "DeleteFaceDb", "facebody", "openAPI")
        {
        ...
        public override DeleteFaceDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFaceDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
