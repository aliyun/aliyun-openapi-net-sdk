...
{
    public class VerifyFaceMaskRequest : RpcAcsRequest<VerifyFaceMaskResponse>
    {
        public VerifyFaceMaskRequest()
            : base("facebody", "2019-12-30", "VerifyFaceMask", "facebody", "openAPI")
        {
        ...
        public override VerifyFaceMaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyFaceMaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
