...
{
    public class PedestrianDetectAttributeRequest : RpcAcsRequest<PedestrianDetectAttributeResponse>
    {
        public PedestrianDetectAttributeRequest()
            : base("facebody", "2019-12-30", "PedestrianDetectAttribute", "facebody", "openAPI")
        {
        ...
        public override PedestrianDetectAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PedestrianDetectAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
