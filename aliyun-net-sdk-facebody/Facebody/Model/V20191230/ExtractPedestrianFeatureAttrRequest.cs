...
{
    public class ExtractPedestrianFeatureAttrRequest : RpcAcsRequest<ExtractPedestrianFeatureAttrResponse>
    {
        public ExtractPedestrianFeatureAttrRequest()
            : base("facebody", "2019-12-30", "ExtractPedestrianFeatureAttr", "facebody", "openAPI")
        {
        ...
        public override ExtractPedestrianFeatureAttrResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExtractPedestrianFeatureAttrResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
