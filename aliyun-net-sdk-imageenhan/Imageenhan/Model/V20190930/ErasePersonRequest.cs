...
{
    public class ErasePersonRequest : RpcAcsRequest<ErasePersonResponse>
    {
        public ErasePersonRequest()
            : base("imageenhan", "2019-09-30", "ErasePerson", "imageenhan", "openAPI")
        {
        ...
        public override ErasePersonResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ErasePersonResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
