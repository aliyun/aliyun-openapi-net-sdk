...
{
    public class ColorizeImageRequest : RpcAcsRequest<ColorizeImageResponse>
    {
        public ColorizeImageRequest()
            : base("imageenhan", "2019-09-30", "ColorizeImage", "imageenhan", "openAPI")
        {
        ...
        public override ColorizeImageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ColorizeImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
