...
{
    public class IntelligentCompositionRequest : RpcAcsRequest<IntelligentCompositionResponse>
    {
        public IntelligentCompositionRequest()
            : base("imageenhan", "2019-09-30", "IntelligentComposition", "imageenhan", "openAPI")
        {
		...
		public int? NumBoxes
		{
			...
			{
				numBoxes = value;
				DictionaryUtil.Add(BodyParameters, "NumBoxes", value.ToString());
			}
		}
        ...
        public override IntelligentCompositionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return IntelligentCompositionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
