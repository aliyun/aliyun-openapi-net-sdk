...
{
    public class AssessSharpnessRequest : RpcAcsRequest<AssessSharpnessResponse>
    {
        public AssessSharpnessRequest()
            : base("imageenhan", "2019-09-30", "AssessSharpness", "imageenhan", "openAPI")
        {
        ...
        public override AssessSharpnessResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssessSharpnessResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
