...
{
    public class RemoveImageWatermarkRequest : RpcAcsRequest<RemoveImageWatermarkResponse>
    {
        public RemoveImageWatermarkRequest()
            : base("imageenhan", "2019-09-30", "RemoveImageWatermark", "imageenhan", "openAPI")
        {
        ...
        public override RemoveImageWatermarkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveImageWatermarkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
