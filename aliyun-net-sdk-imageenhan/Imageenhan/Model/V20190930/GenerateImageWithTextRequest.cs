...
{
    public class GenerateImageWithTextRequest : RpcAcsRequest<GenerateImageWithTextResponse>
    {
        public GenerateImageWithTextRequest()
            : base("imageenhan", "2019-09-30", "GenerateImageWithText", "imageenhan", "openAPI")
        {
        ...
        public override GenerateImageWithTextResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateImageWithTextResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
