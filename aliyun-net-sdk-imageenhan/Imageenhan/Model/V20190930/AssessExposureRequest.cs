...
{
    public class AssessExposureRequest : RpcAcsRequest<AssessExposureResponse>
    {
        public AssessExposureRequest()
            : base("imageenhan", "2019-09-30", "AssessExposure", "imageenhan", "openAPI")
        {
        ...
        public override AssessExposureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssessExposureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
