...
{
    public class AssessCompositionRequest : RpcAcsRequest<AssessCompositionResponse>
    {
        public AssessCompositionRequest()
            : base("imageenhan", "2019-09-30", "AssessComposition", "imageenhan", "openAPI")
        {
        ...
        public override AssessCompositionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssessCompositionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
