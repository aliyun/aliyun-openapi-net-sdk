...
{
    public class GenerateCartoonizedImageRequest : RpcAcsRequest<GenerateCartoonizedImageResponse>
    {
        public GenerateCartoonizedImageRequest()
            : base("imageenhan", "2019-09-30", "GenerateCartoonizedImage", "imageenhan", "openAPI")
        {
        ...
        public override GenerateCartoonizedImageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateCartoonizedImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
