...
namespace Aliyun.Acs.CloudAPI.Transform.V20160714
{
    public class DescribeCatalogsResponseUnmarshaller
    {
        public static DescribeCatalogsResponse Unmarshall(UnmarshallerContext context)
        {
			...
			List<DescribeCatalogsResponse.DescribeCatalogs_CatalogAttribute> describeCatalogsResponse_catalogAttributes = new List<DescribeCatalogsResponse.DescribeCatalogs_CatalogAttribute>();
			for (int i = 0; i < context.Length("DescribeCatalogs.CatalogAttributes.Length"); i++) {
				DescribeCatalogsResponse.DescribeCatalogs_CatalogAttribute catalogAttribute = new DescribeCatalogsResponse.DescribeCatalogs_CatalogAttribute();
				...
				describeCatalogsResponse_catalogAttributes.Add(catalogAttribute);
			}
			describeCatalogsResponse.CatalogAttributes = describeCatalogsResponse_catalogAttributes;
