...
{
    public class DescribeConfigRuleRequest : RpcAcsRequest<DescribeConfigRuleResponse>
    {
        public DescribeConfigRuleRequest()
            : base("Config", "2019-01-08", "DescribeConfigRule", "Config", "openAPI")
        {
        ...
        public override DescribeConfigRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConfigRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
