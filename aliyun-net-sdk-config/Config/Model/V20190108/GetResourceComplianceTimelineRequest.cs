...
{
    public class GetResourceComplianceTimelineRequest : RpcAcsRequest<GetResourceComplianceTimelineResponse>
    {
        public GetResourceComplianceTimelineRequest()
            : base("Config", "2019-01-08", "GetResourceComplianceTimeline", "Config", "openAPI")
        {
        ...
        public override GetResourceComplianceTimelineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResourceComplianceTimelineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
