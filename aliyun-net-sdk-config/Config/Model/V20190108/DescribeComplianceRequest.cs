...
{
    public class DescribeComplianceRequest : RpcAcsRequest<DescribeComplianceResponse>
    {
        public DescribeComplianceRequest()
            : base("Config", "2019-01-08", "DescribeCompliance", "Config", "openAPI")
        {
        ...
        public override DescribeComplianceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeComplianceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
