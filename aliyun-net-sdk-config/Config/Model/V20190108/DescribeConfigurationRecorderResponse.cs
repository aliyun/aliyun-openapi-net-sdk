...
{
	public class DescribeConfigurationRecorderResponse : AcsResponse
	{

		private string requestId;

		private DescribeConfigurationRecorder_ConfigurationRecorder configurationRecorder;
		...
		public DescribeConfigurationRecorder_ConfigurationRecorder ConfigurationRecorder
		{
			get
			{
		...
		public class DescribeConfigurationRecorder_ConfigurationRecorder
		{
