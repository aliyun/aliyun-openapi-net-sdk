...
{
    public class DeleteConfigRulesRequest : RpcAcsRequest<DeleteConfigRulesResponse>
    {
        public DeleteConfigRulesRequest()
            : base("Config", "2019-01-08", "DeleteConfigRules", "Config", "openAPI")
        {
        ...
        public override DeleteConfigRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteConfigRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
