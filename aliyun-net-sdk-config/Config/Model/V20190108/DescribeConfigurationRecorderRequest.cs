...
{
    public class DescribeConfigurationRecorderRequest : RpcAcsRequest<DescribeConfigurationRecorderResponse>
    {
        public DescribeConfigurationRecorderRequest()
            : base("Config", "2019-01-08", "DescribeConfigurationRecorder", "Config", "openAPI")
        {
        ...
        public override DescribeConfigurationRecorderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConfigurationRecorderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
