...
namespace Aliyun.Acs.Config.Model.V20190108
{
    public class GetDiscoveredResourceCountsRequest : RpcAcsRequest<GetDiscoveredResourceCountsResponse>
    {
        public GetDiscoveredResourceCountsRequest()
            : base("Config", "2019-01-08", "GetDiscoveredResourceCounts")
        {
        ...
        public override GetDiscoveredResourceCountsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDiscoveredResourceCountsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
