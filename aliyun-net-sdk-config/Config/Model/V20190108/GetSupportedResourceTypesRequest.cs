...
{
    public class GetSupportedResourceTypesRequest : RpcAcsRequest<GetSupportedResourceTypesResponse>
    {
        public GetSupportedResourceTypesRequest()
            : base("Config", "2019-01-08", "GetSupportedResourceTypes", "Config", "openAPI")
        {
        ...
        public override GetSupportedResourceTypesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSupportedResourceTypesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
