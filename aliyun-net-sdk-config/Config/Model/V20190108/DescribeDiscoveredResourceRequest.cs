...
{
    public class DescribeDiscoveredResourceRequest : RpcAcsRequest<DescribeDiscoveredResourceResponse>
    {
        public DescribeDiscoveredResourceRequest()
            : base("Config", "2019-01-08", "DescribeDiscoveredResource", "Config", "openAPI")
        {
        ...
        public override DescribeDiscoveredResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDiscoveredResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
