...
{
	public class PutConfigurationRecorderResponse : AcsResponse
	{

		private string requestId;

		private PutConfigurationRecorder_ConfigurationRecorder configurationRecorder;
		...
		public PutConfigurationRecorder_ConfigurationRecorder ConfigurationRecorder
		{
			get
			{
