...
{
    public class StopConfigRulesRequest : RpcAcsRequest<StopConfigRulesResponse>
    {
        public StopConfigRulesRequest()
            : base("Config", "2019-01-08", "StopConfigRules", "Config", "openAPI")
        {
        ...
        public override StopConfigRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopConfigRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
