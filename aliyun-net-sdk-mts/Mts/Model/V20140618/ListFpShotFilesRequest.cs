...
{
    public class ListFpShotFilesRequest : RpcAcsRequest<ListFpShotFilesResponse>
    {
        public ListFpShotFilesRequest()
            : base("Mts", "2014-06-18", "ListFpShotFiles", "mts", "openAPI")
        {
        ...
        public override ListFpShotFilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFpShotFilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
