...
{
    public class AddSmarttagTemplateRequest : RpcAcsRequest<AddSmarttagTemplateResponse>
    {
        public AddSmarttagTemplateRequest()
            : base("Mts", "2014-06-18", "AddSmarttagTemplate", "mts", "openAPI")
        {
        ...
        public override AddSmarttagTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddSmarttagTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
