...
{
    public class CreateCustomEntityRequest : RpcAcsRequest<CreateCustomEntityResponse>
    {
        public CreateCustomEntityRequest()
            : base("Mts", "2014-06-18", "CreateCustomEntity", "mts", "openAPI")
        {
		...
		public string CustomEntityName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CustomEntityName", value);
			}
		}
		...
		public string CustomEntityInfo
		{
			...
			set	
			{
				customEntityInfo = value;
				DictionaryUtil.Add(QueryParameters, "CustomEntityInfo", value);
			}
		}

        public override CreateCustomEntityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCustomEntityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
