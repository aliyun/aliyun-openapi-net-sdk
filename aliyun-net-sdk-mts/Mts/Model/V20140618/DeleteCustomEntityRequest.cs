...
{
    public class DeleteCustomEntityRequest : RpcAcsRequest<DeleteCustomEntityResponse>
    {
        public DeleteCustomEntityRequest()
            : base("Mts", "2014-06-18", "DeleteCustomEntity", "mts", "openAPI")
        {
        ...
        public override DeleteCustomEntityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCustomEntityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
