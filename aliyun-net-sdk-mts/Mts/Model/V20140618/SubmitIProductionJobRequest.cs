...
{
    public class SubmitIProductionJobRequest : RpcAcsRequest<SubmitIProductionJobResponse>
    {
        public SubmitIProductionJobRequest()
            : base("Mts", "2014-06-18", "SubmitIProductionJob", "mts", "openAPI")
        {
		...
		public string ScheduleParams
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ScheduleParams", value);
			}
		}

        public override SubmitIProductionJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitIProductionJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
