...
{
    public class ListCustomViewsRequest : RpcAcsRequest<ListCustomViewsResponse>
    {
        public ListCustomViewsRequest()
            : base("Mts", "2014-06-18", "ListCustomViews", "mts", "openAPI")
        {
        ...
        public override ListCustomViewsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCustomViewsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
