...
{
    public class UnregisterCustomFaceRequest : RpcAcsRequest<UnregisterCustomFaceResponse>
    {
        public UnregisterCustomFaceRequest()
            : base("Mts", "2014-06-18", "UnregisterCustomFace", "mts", "openAPI")
        {
        ...
        public override UnregisterCustomFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnregisterCustomFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
