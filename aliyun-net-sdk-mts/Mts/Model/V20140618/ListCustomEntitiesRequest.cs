...
{
    public class ListCustomEntitiesRequest : RpcAcsRequest<ListCustomEntitiesResponse>
    {
        public ListCustomEntitiesRequest()
            : base("Mts", "2014-06-18", "ListCustomEntities", "mts", "openAPI")
        {
        ...
        public override ListCustomEntitiesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCustomEntitiesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
