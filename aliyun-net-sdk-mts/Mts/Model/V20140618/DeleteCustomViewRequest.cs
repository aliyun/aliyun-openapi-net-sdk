...
{
    public class DeleteCustomViewRequest : RpcAcsRequest<DeleteCustomViewResponse>
    {
        public DeleteCustomViewRequest()
            : base("Mts", "2014-06-18", "DeleteCustomView", "mts", "openAPI")
        {
		...
		public string CustomViewId
		{
			...
			{
				customViewId = value;
				DictionaryUtil.Add(QueryParameters, "CustomViewId", value);
			}
		}
        ...
        public override DeleteCustomViewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCustomViewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
