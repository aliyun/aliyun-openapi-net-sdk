...
{
    public class SubmitCopyrightExtractJobRequest : RpcAcsRequest<SubmitCopyrightExtractJobResponse>
    {
        public SubmitCopyrightExtractJobRequest()
            : base("Mts", "2014-06-18", "SubmitCopyrightExtractJob", "mts", "openAPI")
        {
        ...
        public override SubmitCopyrightExtractJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitCopyrightExtractJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
