...
{
    public class SubmitFpDBDeleteJobRequest : RpcAcsRequest<SubmitFpDBDeleteJobResponse>
    {
        public SubmitFpDBDeleteJobRequest()
            : base("Mts", "2014-06-18", "SubmitFpDBDeleteJob", "mts", "openAPI")
        {
		...
		public string DelType
		{
			...
			{
				delType = value;
				DictionaryUtil.Add(QueryParameters, "DelType", value);
			}
		}

        public override SubmitFpDBDeleteJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitFpDBDeleteJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
