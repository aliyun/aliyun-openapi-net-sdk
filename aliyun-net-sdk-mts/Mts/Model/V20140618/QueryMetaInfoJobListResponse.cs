...
{
	public class QueryMetaInfoJobListResponse : AcsResponse
	{
		...
		public List<MetaInfoJob> MetaInfoJobList
		{
			get
			{
				return metaInfoJobList;
			}
			set	
			{
				metaInfoJobList = value;
			}
		}

		public List<string> NonExistMetaInfoJobIds
		{
			get
			{
				return nonExistMetaInfoJobIds;
			}
			set	
			{
				nonExistMetaInfoJobIds = value;
			}
		}

		public class MetaInfoJob{
