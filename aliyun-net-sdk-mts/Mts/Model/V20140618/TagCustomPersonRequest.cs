...
{
    public class TagCustomPersonRequest : RpcAcsRequest<TagCustomPersonResponse>
    {
        public TagCustomPersonRequest()
            : base("Mts", "2014-06-18", "TagCustomPerson", "mts", "openAPI")
        {
		...
		public string PersonDescription
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "PersonDescription", value);
			}
		}
		...
		public string CategoryDescription
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CategoryDescription", value);
			}
		}
        ...
        public override TagCustomPersonResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TagCustomPersonResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
