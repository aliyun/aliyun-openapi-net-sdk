...
{
    public class DeleteSmarttagTemplateRequest : RpcAcsRequest<DeleteSmarttagTemplateResponse>
    {
        public DeleteSmarttagTemplateRequest()
            : base("Mts", "2014-06-18", "DeleteSmarttagTemplate", "mts", "openAPI")
        {
        ...
        public override DeleteSmarttagTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSmarttagTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
