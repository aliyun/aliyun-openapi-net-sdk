...
{
    public class QueryTraceM3u8JobRequest : RpcAcsRequest<QueryTraceM3u8JobResponse>
    {
        public QueryTraceM3u8JobRequest()
            : base("Mts", "2014-06-18", "QueryTraceM3u8Job", "mts", "openAPI")
        {
        ...
        public override QueryTraceM3u8JobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTraceM3u8JobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
