...
{
    public class ImportFpShotJobRequest : RpcAcsRequest<ImportFpShotJobResponse>
    {
        public ImportFpShotJobRequest()
            : base("Mts", "2014-06-18", "ImportFpShotJob", "mts", "openAPI")
        {
		...
		public string FpImportConfig
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "FpImportConfig", value);
			}
		}
        ...
        public override ImportFpShotJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportFpShotJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
