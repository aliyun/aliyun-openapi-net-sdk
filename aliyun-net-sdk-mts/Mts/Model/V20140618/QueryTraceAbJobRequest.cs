...
{
    public class QueryTraceAbJobRequest : RpcAcsRequest<QueryTraceAbJobResponse>
    {
        public QueryTraceAbJobRequest()
            : base("Mts", "2014-06-18", "QueryTraceAbJob", "mts", "openAPI")
        {
        ...
        public override QueryTraceAbJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTraceAbJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
