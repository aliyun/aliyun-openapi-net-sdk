...
{
    public class ImAuditRequest : RpcAcsRequest<ImAuditResponse>
    {
        public ImAuditRequest()
            : base("Mts", "2014-06-18", "ImAudit", "mts", "openAPI")
        {
		...
		public string Contents
		{
			...
			{
				contents = value;
				DictionaryUtil.Add(QueryParameters, "Contents", value);
			}
		}
        ...
        public override ImAuditResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImAuditResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
