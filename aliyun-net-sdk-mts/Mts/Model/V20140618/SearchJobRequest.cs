...
{
    public class SearchJobRequest : RpcAcsRequest<SearchJobResponse>
    {
        public SearchJobRequest()
            : base("Mts", "2014-06-18", "SearchJob")
        {
        }
        ...
        public override SearchJobResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return SearchJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}