...
{
    public class DeleteCustomGroupRequest : RpcAcsRequest<DeleteCustomGroupResponse>
    {
        public DeleteCustomGroupRequest()
            : base("Mts", "2014-06-18", "DeleteCustomGroup", "mts", "openAPI")
        {
        ...
        public override DeleteCustomGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCustomGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
