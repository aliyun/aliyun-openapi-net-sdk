...
{
    public class ListCustomPersonsRequest : RpcAcsRequest<ListCustomPersonsResponse>
    {
        public ListCustomPersonsRequest()
            : base("Mts", "2014-06-18", "ListCustomPersons", "mts", "openAPI")
        {
        ...
        public override ListCustomPersonsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCustomPersonsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
