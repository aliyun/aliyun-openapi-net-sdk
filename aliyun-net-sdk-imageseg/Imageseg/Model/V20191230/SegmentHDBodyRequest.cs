...
{
    public class SegmentHDBodyRequest : RpcAcsRequest<SegmentHDBodyResponse>
    {
        public SegmentHDBodyRequest()
            : base("imageseg", "2019-12-30", "SegmentHDBody", "imageseg", "openAPI")
        {
        ...
        public override SegmentHDBodyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentHDBodyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
