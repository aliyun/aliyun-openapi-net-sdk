...
{
    public class SegmentHairRequest : RpcAcsRequest<SegmentHairResponse>
    {
        public SegmentHairRequest()
            : base("imageseg", "2019-12-30", "SegmentHair", "imageseg", "openAPI")
        {
        ...
        public override SegmentHairResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentHairResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
