...
{
    public class SegmentSceneRequest : RpcAcsRequest<SegmentSceneResponse>
    {
        public SegmentSceneRequest()
            : base("imageseg", "2019-12-30", "SegmentScene", "imageseg", "openAPI")
        {
        ...
        public override SegmentSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
