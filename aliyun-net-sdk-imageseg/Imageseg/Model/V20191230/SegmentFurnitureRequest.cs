...
{
    public class SegmentFurnitureRequest : RpcAcsRequest<SegmentFurnitureResponse>
    {
        public SegmentFurnitureRequest()
            : base("imageseg", "2019-12-30", "SegmentFurniture", "imageseg", "openAPI")
        {
        ...
        public override SegmentFurnitureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentFurnitureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
