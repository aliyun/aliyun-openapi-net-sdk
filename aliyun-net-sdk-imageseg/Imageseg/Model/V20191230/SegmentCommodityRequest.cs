...
{
    public class SegmentCommodityRequest : RpcAcsRequest<SegmentCommodityResponse>
    {
        public SegmentCommodityRequest()
            : base("imageseg", "2019-12-30", "SegmentCommodity", "imageseg", "openAPI")
        {
        ...
        public override SegmentCommodityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentCommodityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
