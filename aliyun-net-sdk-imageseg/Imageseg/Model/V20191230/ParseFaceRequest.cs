...
{
    public class ParseFaceRequest : RpcAcsRequest<ParseFaceResponse>
    {
        public ParseFaceRequest()
            : base("imageseg", "2019-12-30", "ParseFace", "imageseg", "openAPI")
        {
        ...
        public override ParseFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ParseFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
