...
{
    public class SegmentCommonImageRequest : RpcAcsRequest<SegmentCommonImageResponse>
    {
        public SegmentCommonImageRequest()
            : base("imageseg", "2019-12-30", "SegmentCommonImage", "imageseg", "openAPI")
        {
        ...
        public override SegmentCommonImageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentCommonImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
