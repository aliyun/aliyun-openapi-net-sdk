...
{
    public class SegmentSkyRequest : RpcAcsRequest<SegmentSkyResponse>
    {
        public SegmentSkyRequest()
            : base("imageseg", "2019-12-30", "SegmentSky", "imageseg", "openAPI")
        {
        ...
        public override SegmentSkyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentSkyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
