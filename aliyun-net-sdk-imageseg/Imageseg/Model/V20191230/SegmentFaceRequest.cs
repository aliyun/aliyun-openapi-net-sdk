...
namespace Aliyun.Acs.imageseg.Model.V20191230
{
    public class SegmentFaceRequest : RpcAcsRequest<SegmentFaceResponse>
    {
        ...
        public override SegmentFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
