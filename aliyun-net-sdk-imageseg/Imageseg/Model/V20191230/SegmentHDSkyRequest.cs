...
namespace Aliyun.Acs.imageseg.Model.V20191230
{
    public class SegmentHDSkyRequest : RpcAcsRequest<SegmentHDSkyResponse>
    {
        ...
        public override SegmentHDSkyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentHDSkyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
