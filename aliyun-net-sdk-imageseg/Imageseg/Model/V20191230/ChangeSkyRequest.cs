...
{
    public class ChangeSkyRequest : RpcAcsRequest<ChangeSkyResponse>
    {
        public ChangeSkyRequest()
            : base("imageseg", "2019-12-30", "ChangeSky", "imageseg", "openAPI")
        {
		...
		public string ReplaceImageURL
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ReplaceImageURL", value);
			}
		}
        ...
        public override ChangeSkyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeSkyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
