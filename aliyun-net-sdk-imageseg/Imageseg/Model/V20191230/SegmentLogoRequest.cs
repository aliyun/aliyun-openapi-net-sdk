...
{
    public class SegmentLogoRequest : RpcAcsRequest<SegmentLogoResponse>
    {
        public SegmentLogoRequest()
            : base("imageseg", "2019-12-30", "SegmentLogo", "imageseg", "openAPI")
        {
        ...
        public override SegmentLogoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentLogoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
