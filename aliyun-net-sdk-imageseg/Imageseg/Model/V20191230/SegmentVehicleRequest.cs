...
{
    public class SegmentVehicleRequest : RpcAcsRequest<SegmentVehicleResponse>
    {
        public SegmentVehicleRequest()
            : base("imageseg", "2019-12-30", "SegmentVehicle", "imageseg", "openAPI")
        {
        ...
        public override SegmentVehicleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentVehicleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
