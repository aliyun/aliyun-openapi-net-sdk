...
{
    public class SegmentFoodRequest : RpcAcsRequest<SegmentFoodResponse>
    {
        public SegmentFoodRequest()
            : base("imageseg", "2019-12-30", "SegmentFood", "imageseg", "openAPI")
        {
        ...
        public override SegmentFoodResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentFoodResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
