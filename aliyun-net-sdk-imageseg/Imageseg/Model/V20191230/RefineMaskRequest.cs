...
{
    public class RefineMaskRequest : RpcAcsRequest<RefineMaskResponse>
    {
        public RefineMaskRequest()
            : base("imageseg", "2019-12-30", "RefineMask", "imageseg", "openAPI")
        {
        ...
        public override RefineMaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RefineMaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
