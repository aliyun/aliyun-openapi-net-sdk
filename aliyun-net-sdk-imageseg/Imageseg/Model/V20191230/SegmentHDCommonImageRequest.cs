...
{
    public class SegmentHDCommonImageRequest : RpcAcsRequest<SegmentHDCommonImageResponse>
    {
        public SegmentHDCommonImageRequest()
            : base("imageseg", "2019-12-30", "SegmentHDCommonImage", "imageseg", "openAPI")
        {
        ...
        public override SegmentHDCommonImageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentHDCommonImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
