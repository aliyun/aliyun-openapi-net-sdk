...
{
    public class CreateScheduleRequest : RpcAcsRequest<CreateScheduleResponse>
    {
        public CreateScheduleRequest()
            : base("fnf", "2019-03-15", "CreateSchedule", "fnf", "openAPI")
        {
        ...
        public override CreateScheduleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateScheduleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
