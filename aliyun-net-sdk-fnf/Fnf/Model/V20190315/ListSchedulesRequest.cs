...
{
    public class ListSchedulesRequest : RpcAcsRequest<ListSchedulesResponse>
    {
        public ListSchedulesRequest()
            : base("fnf", "2019-03-15", "ListSchedules", "fnf", "openAPI")
        {
        ...
        public override ListSchedulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSchedulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
