...
{
    public class DescribeScheduleRequest : RpcAcsRequest<DescribeScheduleResponse>
    {
        public DescribeScheduleRequest()
            : base("fnf", "2019-03-15", "DescribeSchedule", "fnf", "openAPI")
        {
        ...
        public override DescribeScheduleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeScheduleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
