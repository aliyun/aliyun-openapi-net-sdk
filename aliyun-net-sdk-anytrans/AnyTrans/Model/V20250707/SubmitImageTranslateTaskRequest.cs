...
{
    public class SubmitImageTranslateTaskRequest : RoaAcsRequest<SubmitImageTranslateTaskResponse>
    {
        public SubmitImageTranslateTaskRequest()
            : base("AnyTrans", "2025-07-07", "SubmitImageTranslateTask")
        {
			Protocol = ProtocolType.HTTPS;
			UriPattern = "/anytrans/translate/image/submit";
		...
		private List<string> targetLanguage = new List<string>(){ };
		...
		public List<string> TargetLanguage
		{
			...
			set
			{
				...
				{
					for (int depth1 = 0; depth1 < targetLanguage.Count; depth1++)
					{
						DictionaryUtil.Add(BodyParameters,"targetLanguage." + (depth1 + 1), targetLanguage[depth1]);
					}
				}
			}
		}
        ...
        public override SubmitImageTranslateTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitImageTranslateTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
