...
{
    public class SubmitLongTextTranslateTaskRequest : RoaAcsRequest<SubmitLongTextTranslateTaskResponse>
    {
        public SubmitLongTextTranslateTaskRequest()
            : base("AnyTrans", "2025-07-07", "SubmitLongTextTranslateTask")
        {
			Protocol = ProtocolType.HTTPS;
			UriPattern = "/anytrans/translate/longText/submit";
        ...
        public override SubmitLongTextTranslateTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitLongTextTranslateTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
