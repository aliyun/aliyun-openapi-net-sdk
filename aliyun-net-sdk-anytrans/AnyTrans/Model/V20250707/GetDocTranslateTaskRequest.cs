...
{
    public class GetDocTranslateTaskRequest : RoaAcsRequest<GetDocTranslateTaskResponse>
    {
        public GetDocTranslateTaskRequest()
            : base("AnyTrans", "2025-07-07", "GetDocTranslateTask")
        {
			Protocol = ProtocolType.HTTPS;
			UriPattern = "/anytrans/translate/doc/get";
