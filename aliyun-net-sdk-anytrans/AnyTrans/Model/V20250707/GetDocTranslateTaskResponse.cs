...
namespace Aliyun.Acs.AnyTrans.Model.V20250707
{
	public class GetDocTranslateTaskResponse : AcsResponse
	{
		...
		private GetDocTranslateTask_Data data;
		...
		public GetDocTranslateTask_Data Data
		{
			get
			{
				return data;
		...
		public class GetDocTranslateTask_Data
		{
			...
			[JsonProperty(PropertyName = "TranslateFileUrl")]
