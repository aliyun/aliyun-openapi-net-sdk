...
{
	public class GetOcFinancingResponse : AcsResponse
	{
		...
		private List<GetOcFinancing_DataItem> data;
		...
		public List<GetOcFinancing_DataItem> Data
		{
			get
			{
				return data;
		...
		public class GetOcFinancing_DataItem
		{
