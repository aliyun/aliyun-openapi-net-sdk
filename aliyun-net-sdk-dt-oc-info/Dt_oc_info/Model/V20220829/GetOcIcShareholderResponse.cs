...
{
	public class GetOcIcShareholderResponse : AcsResponse
	{
		...
		private List<GetOcIcShareholder_DataItem> data;
		...
		public List<GetOcIcShareholder_DataItem> Data
		{
			get
			{
				return data;
		...
		public class GetOcIcShareholder_DataItem
		{
