...
{
    public class GetOcIcCheckupRequest : RpcAcsRequest<GetOcIcCheckupResponse>
    {
        public GetOcIcCheckupRequest()
            : base("dt-oc-info", "2022-08-29", "GetOcIcCheckup")
        {
        ...
        public override GetOcIcCheckupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOcIcCheckupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
