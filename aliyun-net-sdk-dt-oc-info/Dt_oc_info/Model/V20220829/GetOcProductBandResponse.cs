...
{
	public class GetOcProductBandResponse : AcsResponse
	{
		...
		private List<GetOcProductBand_DataItem> data;
		...
		public List<GetOcProductBand_DataItem> Data
		{
			get
			{
				return data;
		...
		public class GetOcProductBand_DataItem
		{
