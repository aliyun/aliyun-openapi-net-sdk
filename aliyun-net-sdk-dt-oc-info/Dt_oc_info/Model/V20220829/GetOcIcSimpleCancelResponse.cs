...
{
	public class GetOcIcSimpleCancelResponse : AcsResponse
	{
		...
		private List<GetOcIcSimpleCancel_DataItem> data;
		...
		public List<GetOcIcSimpleCancel_DataItem> Data
		{
			get
			{
				return data;
		...
		public class GetOcIcSimpleCancel_DataItem
		{
