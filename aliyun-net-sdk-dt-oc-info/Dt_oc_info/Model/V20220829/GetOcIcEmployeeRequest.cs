...
{
    public class GetOcIcEmployeeRequest : RpcAcsRequest<GetOcIcEmployeeResponse>
    {
        public GetOcIcEmployeeRequest()
            : base("dt-oc-info", "2022-08-29", "GetOcIcEmployee")
        {
        ...
        public override GetOcIcEmployeeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOcIcEmployeeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
