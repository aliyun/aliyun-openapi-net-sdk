...
{
	public class GetOcJusticeTerminalCaseResponse : AcsResponse
	{
		...
		private List<GetOcJusticeTerminalCase_DataItem> data;
		...
		public List<GetOcJusticeTerminalCase_DataItem> Data
		{
			get
			{
				return data;
		...
		public class GetOcJusticeTerminalCase_DataItem
		{
