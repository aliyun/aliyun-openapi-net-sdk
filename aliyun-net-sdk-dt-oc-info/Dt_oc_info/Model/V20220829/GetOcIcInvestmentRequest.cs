...
{
    public class GetOcIcInvestmentRequest : RpcAcsRequest<GetOcIcInvestmentResponse>
    {
        public GetOcIcInvestmentRequest()
            : base("dt-oc-info", "2022-08-29", "GetOcIcInvestment")
        {
        ...
        public override GetOcIcInvestmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOcIcInvestmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
