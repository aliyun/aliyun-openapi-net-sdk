...
{
    public class GetWorkflowInstanceRequest : RpcAcsRequest<GetWorkflowInstanceResponse>
    {
        public GetWorkflowInstanceRequest()
            : base("schedulerx2", "2019-04-30", "GetWorkflowInstance", "schedulerx2", "openAPI")
        {
        ...
        public override GetWorkflowInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWorkflowInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
