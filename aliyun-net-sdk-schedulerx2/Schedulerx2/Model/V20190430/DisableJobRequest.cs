...
{
    public class DisableJobRequest : RpcAcsRequest<DisableJobResponse>
    {
        public DisableJobRequest()
            : base("schedulerx2", "2019-04-30", "DisableJob", "schedulerx2", "openAPI")
        {
        ...
        public override DisableJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
