...
{
    public class ExecuteWorkflowRequest : RpcAcsRequest<ExecuteWorkflowResponse>
    {
        public ExecuteWorkflowRequest()
            : base("schedulerx2", "2019-04-30", "ExecuteWorkflow", "schedulerx2", "openAPI")
        {
        ...
        public override ExecuteWorkflowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExecuteWorkflowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
