...
{
    public class DisableWorkflowRequest : RpcAcsRequest<DisableWorkflowResponse>
    {
        public DisableWorkflowRequest()
            : base("schedulerx2", "2019-04-30", "DisableWorkflow", "schedulerx2", "openAPI")
        {
        ...
        public override DisableWorkflowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableWorkflowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
