...
{
    public class GetAppGroupRequest : RpcAcsRequest<GetAppGroupResponse>
    {
        public GetAppGroupRequest()
            : base("schedulerx2", "2019-04-30", "GetAppGroup", "schedulerx2", "openAPI")
        {
        ...
        public override GetAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
