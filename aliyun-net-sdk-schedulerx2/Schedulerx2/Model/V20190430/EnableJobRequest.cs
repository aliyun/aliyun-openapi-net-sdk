...
{
    public class EnableJobRequest : RpcAcsRequest<EnableJobResponse>
    {
        public EnableJobRequest()
            : base("schedulerx2", "2019-04-30", "EnableJob", "schedulerx2", "openAPI")
        {
        ...
        public override EnableJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
