...
{
    public class SetJobInstanceSuccessRequest : RpcAcsRequest<SetJobInstanceSuccessResponse>
    {
        public SetJobInstanceSuccessRequest()
            : base("schedulerx2", "2019-04-30", "SetJobInstanceSuccess", "schedulerx2", "openAPI")
        {
		...
		public long? JobInstanceId
		{
			...
			{
				jobInstanceId = value;
				DictionaryUtil.Add(QueryParameters, "JobInstanceId", value.ToString());
			}
		}
        ...
        public override SetJobInstanceSuccessResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetJobInstanceSuccessResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
