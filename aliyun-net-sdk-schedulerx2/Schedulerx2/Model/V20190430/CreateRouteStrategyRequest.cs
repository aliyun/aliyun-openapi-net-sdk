...
namespace Aliyun.Acs.schedulerx2.Model.V20190430
{
    public class CreateRouteStrategyRequest : RpcAcsRequest<CreateRouteStrategyResponse>
    {
        ...
        public override CreateRouteStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRouteStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
