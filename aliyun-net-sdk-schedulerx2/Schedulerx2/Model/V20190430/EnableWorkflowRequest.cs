...
{
    public class EnableWorkflowRequest : RpcAcsRequest<EnableWorkflowResponse>
    {
        public EnableWorkflowRequest()
            : base("schedulerx2", "2019-04-30", "EnableWorkflow", "schedulerx2", "openAPI")
        {
        ...
        public override EnableWorkflowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableWorkflowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
