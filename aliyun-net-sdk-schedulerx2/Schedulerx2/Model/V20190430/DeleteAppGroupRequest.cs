...
{
    public class DeleteAppGroupRequest : RpcAcsRequest<DeleteAppGroupResponse>
    {
        public DeleteAppGroupRequest()
            : base("schedulerx2", "2019-04-30", "DeleteAppGroup", "schedulerx2", "openAPI")
        {
		...
		public bool? DeleteJobs
		{
			...
			{
				deleteJobs = value;
				DictionaryUtil.Add(QueryParameters, "DeleteJobs", value.ToString());
			}
		}
        ...
        public override DeleteAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
