...
{
    public class BatchDeleteRouteStrategyRequest : RpcAcsRequest<BatchDeleteRouteStrategyResponse>
    {
        public BatchDeleteRouteStrategyRequest()
            : base("schedulerx2", "2019-04-30", "BatchDeleteRouteStrategy", "schedulerx2", "openAPI")
        {
        ...
        public override BatchDeleteRouteStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchDeleteRouteStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
