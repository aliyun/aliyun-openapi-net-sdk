...
{
    public class RevokePermissionRequest : RpcAcsRequest<RevokePermissionResponse>
    {
        public RevokePermissionRequest()
            : base("schedulerx2", "2019-04-30", "RevokePermission", "schedulerx2", "openAPI")
        {
        ...
        public override RevokePermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RevokePermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
