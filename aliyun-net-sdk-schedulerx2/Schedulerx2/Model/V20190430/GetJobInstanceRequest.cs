...
namespace Aliyun.Acs.schedulerx2.Model.V20190430
{
    public class GetJobInstanceRequest : RpcAcsRequest<GetJobInstanceResponse>
    {
        ...
        public override GetJobInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetJobInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
