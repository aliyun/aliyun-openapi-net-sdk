...
{
    public class DeleteRouteStrategyRequest : RpcAcsRequest<DeleteRouteStrategyResponse>
    {
        public DeleteRouteStrategyRequest()
            : base("schedulerx2", "2019-04-30", "DeleteRouteStrategy", "schedulerx2", "openAPI")
        {
        ...
        public override DeleteRouteStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRouteStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
