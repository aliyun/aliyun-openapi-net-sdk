...
namespace Aliyun.Acs.devops_rdc.Model.V20200303
{
    public class GetTaskDetailBaseRequest : RpcAcsRequest<GetTaskDetailBaseResponse>
    {
        ...
        public override GetTaskDetailBaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTaskDetailBaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
