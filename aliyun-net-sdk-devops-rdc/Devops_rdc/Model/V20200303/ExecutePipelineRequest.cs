...
{
    public class ExecutePipelineRequest : RpcAcsRequest<ExecutePipelineResponse>
    {
        public ExecutePipelineRequest()
            : base("devops-rdc", "2020-03-03", "ExecutePipeline", "1.9.6", "openAPI")
        {
        ...
        public override ExecutePipelineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExecutePipelineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
