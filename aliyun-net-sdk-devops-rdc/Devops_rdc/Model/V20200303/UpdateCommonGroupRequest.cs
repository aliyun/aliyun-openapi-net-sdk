...
{
    public class UpdateCommonGroupRequest : RpcAcsRequest<UpdateCommonGroupResponse>
    {
        public UpdateCommonGroupRequest()
            : base("devops-rdc", "2020-03-03", "UpdateCommonGroup", "1.9.6", "openAPI")
        {
        ...
        public override UpdateCommonGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCommonGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
