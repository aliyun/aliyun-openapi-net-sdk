...
{
    public class UpdatePipelineMemberRequest : RpcAcsRequest<UpdatePipelineMemberResponse>
    {
        public UpdatePipelineMemberRequest()
            : base("devops-rdc", "2020-03-03", "UpdatePipelineMember", "1.9.6", "openAPI")
        {
        ...
        public override UpdatePipelineMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdatePipelineMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
