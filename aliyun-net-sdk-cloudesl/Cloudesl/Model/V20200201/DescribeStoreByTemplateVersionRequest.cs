...
{
    public class DescribeStoreByTemplateVersionRequest : RpcAcsRequest<DescribeStoreByTemplateVersionResponse>
    {
        public DescribeStoreByTemplateVersionRequest()
            : base("cloudesl", "2020-02-01", "DescribeStoreByTemplateVersion")
        {
        ...
        public override DescribeStoreByTemplateVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeStoreByTemplateVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
