...
{
    public class VerifyNotificationConfigRequest : RpcAcsRequest<VerifyNotificationConfigResponse>
    {
        public VerifyNotificationConfigRequest()
            : base("cloudesl", "2020-02-01", "VerifyNotificationConfig")
        {
        ...
        public override VerifyNotificationConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyNotificationConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
