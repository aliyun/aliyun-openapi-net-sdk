...
{
    public class GetItemMaterialRequest : RpcAcsRequest<GetItemMaterialResponse>
    {
        public GetItemMaterialRequest()
            : base("cloudesl", "2020-02-01", "GetItemMaterial")
        {
        ...
        public override GetItemMaterialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetItemMaterialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
