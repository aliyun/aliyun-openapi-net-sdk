...
{
    public class DescribeItemMaterialsRequest : RpcAcsRequest<DescribeItemMaterialsResponse>
    {
        public DescribeItemMaterialsRequest()
            : base("cloudesl", "2020-02-01", "DescribeItemMaterials")
        {
        ...
        public override DescribeItemMaterialsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeItemMaterialsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
