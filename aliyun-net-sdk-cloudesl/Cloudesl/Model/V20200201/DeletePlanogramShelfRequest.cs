...
{
    public class DeletePlanogramShelfRequest : RpcAcsRequest<DeletePlanogramShelfResponse>
    {
        public DeletePlanogramShelfRequest()
            : base("cloudesl", "2020-02-01", "DeletePlanogramShelf", "cloudesl", "openAPI")
        {
        ...
        public override DeletePlanogramShelfResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePlanogramShelfResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
