...
{
    public class DescribeCompanyTemplateAttributeRequest : RpcAcsRequest<DescribeCompanyTemplateAttributeResponse>
    {
        public DescribeCompanyTemplateAttributeRequest()
            : base("cloudesl", "2020-02-01", "DescribeCompanyTemplateAttribute")
        {
        ...
        public override DescribeCompanyTemplateAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCompanyTemplateAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
