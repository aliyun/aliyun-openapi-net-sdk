...
{
    public class AddMaterialRequest : RpcAcsRequest<AddMaterialResponse>
    {
        public AddMaterialRequest()
            : base("cloudesl", "2020-02-01", "AddMaterial")
        {
        ...
        public override AddMaterialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddMaterialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
