...
{
    public class DescribeEslModelByTemplateVersionRequest : RpcAcsRequest<DescribeEslModelByTemplateVersionResponse>
    {
        public DescribeEslModelByTemplateVersionRequest()
            : base("cloudesl", "2020-02-01", "DescribeEslModelByTemplateVersion")
        {
        ...
        public override DescribeEslModelByTemplateVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeEslModelByTemplateVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
