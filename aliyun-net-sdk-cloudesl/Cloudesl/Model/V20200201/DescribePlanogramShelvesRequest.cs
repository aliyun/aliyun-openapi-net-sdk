...
{
    public class DescribePlanogramShelvesRequest : RpcAcsRequest<DescribePlanogramShelvesResponse>
    {
        public DescribePlanogramShelvesRequest()
            : base("cloudesl", "2020-02-01", "DescribePlanogramShelves", "cloudesl", "openAPI")
        {
        ...
        public override DescribePlanogramShelvesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePlanogramShelvesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
