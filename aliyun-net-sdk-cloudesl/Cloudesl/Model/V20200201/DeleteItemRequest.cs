...
namespace Aliyun.Acs.cloudesl.Model.V20200201
{
    public class DeleteItemRequest : RpcAcsRequest<DeleteItemResponse>
    {
        public DeleteItemRequest()
            : base("cloudesl", "2020-02-01", "DeleteItem", "cloudesl", "openAPI")
        {
		...
		public bool? UnbindEslDevice
		{
			...
			set	
			{
				unbindEslDevice = value;
				DictionaryUtil.Add(BodyParameters, "UnbindEslDevice", value.ToString());
			}
		}
