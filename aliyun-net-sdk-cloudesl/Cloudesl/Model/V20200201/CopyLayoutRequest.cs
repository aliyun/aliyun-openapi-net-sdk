...
{
    public class CopyLayoutRequest : RpcAcsRequest<CopyLayoutResponse>
    {
        public CopyLayoutRequest()
            : base("cloudesl", "2020-02-01", "CopyLayout")
        {
        ...
        public override CopyLayoutResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CopyLayoutResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
