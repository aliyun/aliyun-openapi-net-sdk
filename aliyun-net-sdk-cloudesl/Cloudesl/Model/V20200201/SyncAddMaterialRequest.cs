...
{
    public class SyncAddMaterialRequest : RpcAcsRequest<SyncAddMaterialResponse>
    {
        public SyncAddMaterialRequest()
            : base("cloudesl", "2020-02-01", "SyncAddMaterial")
        {
        ...
        public override SyncAddMaterialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SyncAddMaterialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
