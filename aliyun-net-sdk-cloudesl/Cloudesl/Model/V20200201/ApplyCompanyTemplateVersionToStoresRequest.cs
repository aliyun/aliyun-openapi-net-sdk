...
{
    public class ApplyCompanyTemplateVersionToStoresRequest : RpcAcsRequest<ApplyCompanyTemplateVersionToStoresResponse>
    {
        public ApplyCompanyTemplateVersionToStoresRequest()
            : base("cloudesl", "2020-02-01", "ApplyCompanyTemplateVersionToStores")
        {
        ...
        public override ApplyCompanyTemplateVersionToStoresResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ApplyCompanyTemplateVersionToStoresResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
