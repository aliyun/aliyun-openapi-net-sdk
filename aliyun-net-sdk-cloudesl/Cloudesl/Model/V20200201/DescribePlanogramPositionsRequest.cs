...
{
    public class DescribePlanogramPositionsRequest : RpcAcsRequest<DescribePlanogramPositionsResponse>
    {
        public DescribePlanogramPositionsRequest()
            : base("cloudesl", "2020-02-01", "DescribePlanogramPositions", "cloudesl", "openAPI")
        {
        ...
        public override DescribePlanogramPositionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePlanogramPositionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
