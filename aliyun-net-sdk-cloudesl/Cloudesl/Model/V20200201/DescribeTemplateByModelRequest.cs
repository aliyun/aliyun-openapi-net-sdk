...
{
    public class DescribeTemplateByModelRequest : RpcAcsRequest<DescribeTemplateByModelResponse>
    {
        public DescribeTemplateByModelRequest()
            : base("cloudesl", "2020-02-01", "DescribeTemplateByModel")
        {
        ...
        public override DescribeTemplateByModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTemplateByModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
