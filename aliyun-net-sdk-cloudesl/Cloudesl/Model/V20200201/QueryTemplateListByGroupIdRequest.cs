...
{
    public class QueryTemplateListByGroupIdRequest : RpcAcsRequest<QueryTemplateListByGroupIdResponse>
    {
        public QueryTemplateListByGroupIdRequest()
            : base("cloudesl", "2020-02-01", "QueryTemplateListByGroupId")
        {
        ...
        public override QueryTemplateListByGroupIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTemplateListByGroupIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
