...
{
    public class GetCompanyTemplatePictureRequest : RpcAcsRequest<GetCompanyTemplatePictureResponse>
    {
        public GetCompanyTemplatePictureRequest()
            : base("cloudesl", "2020-02-01", "GetCompanyTemplatePicture")
        {
        ...
        public override GetCompanyTemplatePictureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCompanyTemplatePictureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
