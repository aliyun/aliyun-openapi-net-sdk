...
{
    public class DescribeStoreConfigRequest : RpcAcsRequest<DescribeStoreConfigResponse>
    {
        public DescribeStoreConfigRequest()
            : base("cloudesl", "2020-02-01", "DescribeStoreConfig", "cloudesl", "openAPI")
        {
        ...
        public override DescribeStoreConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeStoreConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
