...
{
    public class UpdateNotificationConfigRequest : RpcAcsRequest<UpdateNotificationConfigResponse>
    {
        public UpdateNotificationConfigRequest()
            : base("cloudesl", "2020-02-01", "UpdateNotificationConfig")
        {
        ...
        public override UpdateNotificationConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateNotificationConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
