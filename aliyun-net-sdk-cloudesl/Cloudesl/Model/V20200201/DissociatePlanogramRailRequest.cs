...
{
    public class DissociatePlanogramRailRequest : RpcAcsRequest<DissociatePlanogramRailResponse>
    {
        public DissociatePlanogramRailRequest()
            : base("cloudesl", "2020-02-01", "DissociatePlanogramRail", "cloudesl", "openAPI")
        {
        ...
        public override DissociatePlanogramRailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DissociatePlanogramRailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
