...
{
    public class UpdateEslDeviceLightRequest : RpcAcsRequest<UpdateEslDeviceLightResponse>
    {
        public UpdateEslDeviceLightRequest()
            : base("cloudesl", "2020-02-01", "UpdateEslDeviceLight", "cloudesl", "openAPI")
        {
		...
		public int? LightUpTime
		{
			...
			{
				lightUpTime = value;
				DictionaryUtil.Add(BodyParameters, "LightUpTime", value.ToString());
			}
		}
		...
		public string Frequency
		{
			...
			{
				frequency = value;
				DictionaryUtil.Add(BodyParameters, "Frequency", value);
			}
		}
		...
		public string LedColor
		{
			...
			{
				ledColor = value;
				DictionaryUtil.Add(BodyParameters, "LedColor", value);
			}
		}
        ...
        public override UpdateEslDeviceLightResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEslDeviceLightResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
