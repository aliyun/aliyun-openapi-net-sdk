...
{
    public class DeleteCompanyTemplateRequest : RpcAcsRequest<DeleteCompanyTemplateResponse>
    {
        public DeleteCompanyTemplateRequest()
            : base("cloudesl", "2020-02-01", "DeleteCompanyTemplate")
        {
        ...
        public override DeleteCompanyTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCompanyTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
