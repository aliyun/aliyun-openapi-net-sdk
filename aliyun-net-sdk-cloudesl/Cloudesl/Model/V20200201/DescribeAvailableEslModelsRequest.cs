...
{
    public class DescribeAvailableEslModelsRequest : RpcAcsRequest<DescribeAvailableEslModelsResponse>
    {
        public DescribeAvailableEslModelsRequest()
            : base("cloudesl", "2020-02-01", "DescribeAvailableEslModels")
        {
        ...
        public override DescribeAvailableEslModelsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAvailableEslModelsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
