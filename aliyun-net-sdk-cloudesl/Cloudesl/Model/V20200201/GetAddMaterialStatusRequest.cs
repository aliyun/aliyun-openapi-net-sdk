...
{
    public class GetAddMaterialStatusRequest : RpcAcsRequest<GetAddMaterialStatusResponse>
    {
        public GetAddMaterialStatusRequest()
            : base("cloudesl", "2020-02-01", "GetAddMaterialStatus")
        {
        ...
        public override GetAddMaterialStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddMaterialStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
