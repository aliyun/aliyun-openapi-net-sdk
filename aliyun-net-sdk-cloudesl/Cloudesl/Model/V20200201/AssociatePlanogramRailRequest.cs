...
{
    public class AssociatePlanogramRailRequest : RpcAcsRequest<AssociatePlanogramRailResponse>
    {
        public AssociatePlanogramRailRequest()
            : base("cloudesl", "2020-02-01", "AssociatePlanogramRail", "cloudesl", "openAPI")
        {
        ...
        public override AssociatePlanogramRailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssociatePlanogramRailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
