...
{
    public class CopyTemplateGroupRequest : RpcAcsRequest<CopyTemplateGroupResponse>
    {
        public CopyTemplateGroupRequest()
            : base("cloudesl", "2020-02-01", "CopyTemplateGroup")
        {
        ...
        public override CopyTemplateGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CopyTemplateGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
