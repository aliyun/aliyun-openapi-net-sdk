...
{
    public class DeleteTemplateGroupRequest : RpcAcsRequest<DeleteTemplateGroupResponse>
    {
        public DeleteTemplateGroupRequest()
            : base("cloudesl", "2020-02-01", "DeleteTemplateGroup")
        {
        ...
        public override DeleteTemplateGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTemplateGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
