...
{
    public class GetCompanyTemplatePictureNewRequest : RpcAcsRequest<GetCompanyTemplatePictureNewResponse>
    {
        public GetCompanyTemplatePictureNewRequest()
            : base("cloudesl", "2020-02-01", "GetCompanyTemplatePictureNew")
        {
        ...
        public override GetCompanyTemplatePictureNewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCompanyTemplatePictureNewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
