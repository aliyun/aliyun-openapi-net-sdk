...
{
    public class GetCompanyTemplatePictureByJobRequest : RpcAcsRequest<GetCompanyTemplatePictureByJobResponse>
    {
        public GetCompanyTemplatePictureByJobRequest()
            : base("cloudesl", "2020-02-01", "GetCompanyTemplatePictureByJob")
        {
        ...
        public override GetCompanyTemplatePictureByJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCompanyTemplatePictureByJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
