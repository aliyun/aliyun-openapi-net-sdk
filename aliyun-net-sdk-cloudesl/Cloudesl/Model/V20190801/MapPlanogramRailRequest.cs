...
{
    public class MapPlanogramRailRequest : RpcAcsRequest<MapPlanogramRailResponse>
    {
        public MapPlanogramRailRequest()
            : base("cloudesl", "2019-08-01", "MapPlanogramRail", "cloudesl", "openAPI")
        {
        ...
        public override MapPlanogramRailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MapPlanogramRailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
