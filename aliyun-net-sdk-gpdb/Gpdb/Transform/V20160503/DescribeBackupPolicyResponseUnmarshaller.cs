...
namespace Aliyun.Acs.gpdb.Transform.V20160503
{
    public class DescribeBackupPolicyResponseUnmarshaller
    {
        public static DescribeBackupPolicyResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			describeBackupPolicyResponse.RecoveryPointPeriod = _ctx.StringValue("DescribeBackupPolicy.RecoveryPointPeriod");
			describeBackupPolicyResponse.EnableRecoveryPoint = _ctx.BooleanValue("DescribeBackupPolicy.EnableRecoveryPoint");
