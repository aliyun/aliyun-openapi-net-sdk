...
namespace Aliyun.Acs.gpdb.Transform.V20160503
{
    public class CheckServiceLinkedRoleResponseUnmarshaller
    {
        public static CheckServiceLinkedRoleResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			checkServiceLinkedRoleResponse.HasServiceLinkedRole = _ctx.StringValue("CheckServiceLinkedRole.HasServiceLinkedRole");
			checkServiceLinkedRoleResponse.RegionId = _ctx.StringValue("CheckServiceLinkedRole.RegionId");
