...
namespace Aliyun.Acs.gpdb.Transform.V20160503
{
    public class DescribeDBInstanceSSLResponseUnmarshaller
    {
        public static DescribeDBInstanceSSLResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			describeDBInstanceSSLResponse.SSLEnabled = _ctx.BooleanValue("DescribeDBInstanceSSL.SSLEnabled");
			describeDBInstanceSSLResponse.DBInstanceId = _ctx.StringValue("DescribeDBInstanceSSL.DBInstanceId");
			describeDBInstanceSSLResponse.CertCommonName = _ctx.StringValue("DescribeDBInstanceSSL.CertCommonName");
			describeDBInstanceSSLResponse.DBInstanceName = _ctx.StringValue("DescribeDBInstanceSSL.DBInstanceName");
