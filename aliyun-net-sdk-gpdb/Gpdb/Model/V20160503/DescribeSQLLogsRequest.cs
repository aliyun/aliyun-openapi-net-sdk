...
{
    public class DescribeSQLLogsRequest : RpcAcsRequest<DescribeSQLLogsResponse>
    {
        public DescribeSQLLogsRequest()
            : base("gpdb", "2016-05-03", "DescribeSQLLogs")
        {
        ...
        public override DescribeSQLLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
