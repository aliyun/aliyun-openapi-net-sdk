...
{
    public class DescribeDBInstanceOnECSAttributeRequest : RpcAcsRequest<DescribeDBInstanceOnECSAttributeResponse>
    {
        public DescribeDBInstanceOnECSAttributeRequest()
            : base("gpdb", "2016-05-03", "DescribeDBInstanceOnECSAttribute")
        {
        ...
        public override DescribeDBInstanceOnECSAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBInstanceOnECSAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
