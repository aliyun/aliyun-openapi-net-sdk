...
{
    public class DescribeSpecificationRequest : RpcAcsRequest<DescribeSpecificationResponse>
    {
        public DescribeSpecificationRequest()
            : base("gpdb", "2016-05-03", "DescribeSpecification")
        {
		...
		public int? CpuCores
		{
			...
			{
				cpuCores = value;
				DictionaryUtil.Add(QueryParameters, "CpuCores", value.ToString());
			}
		}
		...
		public int? TotalNodeNum
		{
			...
			{
				totalNodeNum = value;
				DictionaryUtil.Add(QueryParameters, "TotalNodeNum", value.ToString());
			}
		}
        ...
        public override DescribeSpecificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSpecificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
