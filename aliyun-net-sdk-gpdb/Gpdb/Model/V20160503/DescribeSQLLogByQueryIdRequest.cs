...
{
    public class DescribeSQLLogByQueryIdRequest : RpcAcsRequest<DescribeSQLLogByQueryIdResponse>
    {
        public DescribeSQLLogByQueryIdRequest()
            : base("gpdb", "2016-05-03", "DescribeSQLLogByQueryId")
        {
        ...
        public override DescribeSQLLogByQueryIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLLogByQueryIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
