...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class ModifyBackupPolicyRequest : RpcAcsRequest<ModifyBackupPolicyResponse>
    {
        public ModifyBackupPolicyRequest()
            : base("gpdb", "2016-05-03", "ModifyBackupPolicy")
        {
		...
		private bool? enableRecoveryPoint;
		...
		public string RecoveryPointPeriod
		{
			...
			set	
			{
				recoveryPointPeriod = value;
				DictionaryUtil.Add(QueryParameters, "RecoveryPointPeriod", value);
			}
		}

		public bool? EnableRecoveryPoint
		{
			get
			{
			...
			set	
			{
				enableRecoveryPoint = value;
				DictionaryUtil.Add(QueryParameters, "EnableRecoveryPoint", value.ToString());
			}
		}
