...
{
    public class UpgradeDBVersionRequest : RpcAcsRequest<UpgradeDBVersionResponse>
    {
        public UpgradeDBVersionRequest()
            : base("gpdb", "2016-05-03", "UpgradeDBVersion")
        {
        ...
        public override UpgradeDBVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpgradeDBVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
