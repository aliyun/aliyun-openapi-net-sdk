...
{
    public class DescribeSlowSQLLogsRequest : RpcAcsRequest<DescribeSlowSQLLogsResponse>
    {
        public DescribeSlowSQLLogsRequest()
            : base("gpdb", "2016-05-03", "DescribeSlowSQLLogs")
        {
        ...
        public override DescribeSlowSQLLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSlowSQLLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
