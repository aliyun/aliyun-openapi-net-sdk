...
{
    public class DescribeLogBackupsRequest : RpcAcsRequest<DescribeLogBackupsResponse>
    {
        public DescribeLogBackupsRequest()
            : base("gpdb", "2016-05-03", "DescribeLogBackups")
        {
        ...
        public override DescribeLogBackupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLogBackupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
