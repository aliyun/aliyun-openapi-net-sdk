...
{
	public class DescribeSlowSQLLogsResponse : AcsResponse
	{
		...
		private List<DescribeSlowSQLLogs_Item> items;
		...
		public List<DescribeSlowSQLLogs_Item> Items
		{
			get
			{
				return items;
		...
		public class DescribeSlowSQLLogs_Item
		{
