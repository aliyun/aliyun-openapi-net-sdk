...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
    public class ModifyParametersRequest : RpcAcsRequest<ModifyParametersResponse>
    {
        public ModifyParametersRequest()
            : base("gpdb", "2016-05-03", "ModifyParameters")
        {
		...
		private bool? forceRestartInstance;

		private string dBInstanceId;

		private string parameters;

		public bool? ForceRestartInstance
		{
			get
			{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ForceRestartInstance", value.ToString());
			}
		}
