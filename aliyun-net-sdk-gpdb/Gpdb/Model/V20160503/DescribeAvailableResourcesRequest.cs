...
{
    public class DescribeAvailableResourcesRequest : RpcAcsRequest<DescribeAvailableResourcesResponse>
    {
        public DescribeAvailableResourcesRequest()
            : base("gpdb", "2016-05-03", "DescribeAvailableResources")
        {
        ...
        public override DescribeAvailableResourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAvailableResourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
