...
namespace Aliyun.Acs.gpdb.Model.V20160503
{
	public class DescribeDBClusterPerformanceResponse : AcsResponse
	{
		...
		private List<DescribeDBClusterPerformance_PerformanceKey> performanceKeys;
		...
		public List<DescribeDBClusterPerformance_PerformanceKey> PerformanceKeys
		{
			get
			{
		...
		public class DescribeDBClusterPerformance_PerformanceKey
		{
