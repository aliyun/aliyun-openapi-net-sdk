...
{
    public class ListBaaSAntChainRequest : RpcAcsRequest<ListBaaSAntChainResponse>
    {
        public ListBaaSAntChainRequest()
            : base("lto", "2021-07-07", "ListBaaSAntChain")
        {
        ...
        public override ListBaaSAntChainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListBaaSAntChainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
