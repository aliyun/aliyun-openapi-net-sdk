...
{
    public class SharePrivacyRuleRequest : RpcAcsRequest<SharePrivacyRuleResponse>
    {
        public SharePrivacyRuleRequest()
            : base("lto", "2021-07-07", "SharePrivacyRule")
        {
		...
		public string MemberIdList
		{
			...
			{
				memberIdList = value;
				DictionaryUtil.Add(QueryParameters, "MemberIdList", value);
			}
		}
        ...
        public override SharePrivacyRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SharePrivacyRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
