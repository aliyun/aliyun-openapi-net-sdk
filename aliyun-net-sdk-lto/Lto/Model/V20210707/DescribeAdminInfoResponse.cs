...
{
	public class DescribeAdminInfoResponse : AcsResponse
	{
		...
		private DescribeAdminInfo_Data data;
		...
		public DescribeAdminInfo_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeAdminInfo_Data
		{
