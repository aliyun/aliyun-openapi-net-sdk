...
{
    public class ListMemberAccessRecordRequest : RpcAcsRequest<ListMemberAccessRecordResponse>
    {
        public ListMemberAccessRecordRequest()
            : base("lto", "2021-07-07", "ListMemberAccessRecord")
        {
        ...
        public override ListMemberAccessRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMemberAccessRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
