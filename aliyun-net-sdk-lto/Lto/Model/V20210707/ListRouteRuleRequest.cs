...
{
    public class ListRouteRuleRequest : RpcAcsRequest<ListRouteRuleResponse>
    {
        public ListRouteRuleRequest()
            : base("lto", "2021-07-07", "ListRouteRule")
        {
		...
		public string BizChainName
		{
			...
			{
				bizChainName = value;
				DictionaryUtil.Add(QueryParameters, "BizChainName", value);
			}
		}
        ...
        public override ListRouteRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRouteRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
