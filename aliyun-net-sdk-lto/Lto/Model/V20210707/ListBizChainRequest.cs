...
{
    public class ListBizChainRequest : RpcAcsRequest<ListBizChainResponse>
    {
        public ListBizChainRequest()
            : base("lto", "2021-07-07", "ListBizChain")
        {
        ...
        public override ListBizChainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListBizChainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
