...
{
    public class UpdateRouteRuleRequest : RpcAcsRequest<UpdateRouteRuleResponse>
    {
        public UpdateRouteRuleRequest()
            : base("lto", "2021-07-07", "UpdateRouteRule")
        {
		...
		public string RouteRuleId
		{
			...
			{
				routeRuleId = value;
				DictionaryUtil.Add(QueryParameters, "RouteRuleId", value);
			}
		}
        ...
        public override UpdateRouteRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRouteRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
