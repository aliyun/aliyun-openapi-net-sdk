...
{
	public class DescribeEdgeStatInfoResponse : AcsResponse
	{
		...
		private DescribeEdgeStatInfo_Data data;
		...
		public DescribeEdgeStatInfo_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeEdgeStatInfo_Data
		{
