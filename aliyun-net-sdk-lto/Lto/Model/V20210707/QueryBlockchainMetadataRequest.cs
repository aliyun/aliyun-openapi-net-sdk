...
{
    public class QueryBlockchainMetadataRequest : RpcAcsRequest<QueryBlockchainMetadataResponse>
    {
        public QueryBlockchainMetadataRequest()
            : base("lto", "2021-07-07", "QueryBlockchainMetadata")
        {
        ...
        public override QueryBlockchainMetadataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryBlockchainMetadataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
