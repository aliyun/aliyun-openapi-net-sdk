...
{
    public class UpdateMemberRequest : RpcAcsRequest<UpdateMemberResponse>
    {
        public UpdateMemberRequest()
            : base("lto", "2021-07-07", "UpdateMember")
        {
        ...
        public override UpdateMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
