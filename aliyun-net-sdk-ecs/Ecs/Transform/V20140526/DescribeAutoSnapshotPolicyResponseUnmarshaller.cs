...
namespace Aliyun.Acs.Ecs.Transform.V20140526
{
    public class DescribeAutoSnapshotPolicyResponseUnmarshaller
    {
        public static DescribeAutoSnapshotPolicyResponse Unmarshall(UnmarshallerContext context)
        {
			...
			autoSnapshotExcutionStatus.SystemDiskExcutionStatus = (DescribeAutoSnapshotPolicyResponse.AutoSnapshotExcutionStatus_.SystemDiskExcutionStatus_)Enum.Parse(typeof(DescribeAutoSnapshotPolicyResponse.AutoSnapshotExcutionStatus_.SystemDiskExcutionStatus_),
				 context.StringValue("DescribeAutoSnapshotPolicy.AutoSnapshotExcutionStatus.SystemDiskExcutionStatus"));
			autoSnapshotExcutionStatus.DataDiskExcutionStatus = (DescribeAutoSnapshotPolicyResponse.AutoSnapshotExcutionStatus_.DataDiskExcutionStatus_)Enum.Parse(typeof(DescribeAutoSnapshotPolicyResponse.AutoSnapshotExcutionStatus_.DataDiskExcutionStatus_),
				 context.StringValue("DescribeAutoSnapshotPolicy.AutoSnapshotExcutionStatus.DataDiskExcutionStatus"));
