    ...
    public class DescribeSnapshotsResponseUnmarshaller
    {
        public static DescribeSnapshotsResponse Unmarshall(UnmarshallerContext context)
        {
			...
			for (int i = 0; i < context.Length("DescribeSnapshots.Snapshots.Length"); i++) {
				...
				snapshot.SourceDiskType = (DescribeSnapshotsResponse.Snapshot.SourceDiskType_)Enum.Parse(typeof(DescribeSnapshotsResponse.Snapshot.SourceDiskType_),
					 context.StringValue("DescribeSnapshots.Snapshots["+ i +"].SourceDiskType"));
