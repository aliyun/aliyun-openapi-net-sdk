...
{
    public class CancelImagePipelineExecutionRequest : RpcAcsRequest<CancelImagePipelineExecutionResponse>
    {
        public CancelImagePipelineExecutionRequest()
            : base("Ecs", "2014-05-26", "CancelImagePipelineExecution", "ecs", "openAPI")
        {
        ...
        public override CancelImagePipelineExecutionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelImagePipelineExecutionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
