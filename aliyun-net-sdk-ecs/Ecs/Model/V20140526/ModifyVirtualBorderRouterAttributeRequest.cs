...
namespace Aliyun.Acs.Ecs.Model.V20140526
{
    public class ModifyVirtualBorderRouterAttributeRequest : RpcAcsRequest<ModifyVirtualBorderRouterAttributeResponse>
    {
		...
		[JsonProperty(PropertyName = "VbrId")]
		public string VbrId
		{
			get
			{
		...
		[JsonProperty(PropertyName = "PeerGatewayIp")]
		...
		[JsonProperty(PropertyName = "PeeringSubnetMask")]
		...
		[JsonProperty(PropertyName = "LocalGatewayIp")]
