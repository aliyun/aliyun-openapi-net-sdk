...
{
    public class DeleteImageComponentRequest : RpcAcsRequest<DeleteImageComponentResponse>
    {
        public DeleteImageComponentRequest()
            : base("Ecs", "2014-05-26", "DeleteImageComponent", "ecs", "openAPI")
        {
		...
		public string ImageComponentId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ImageComponentId", value);
			}
		}
        ...
        public override DeleteImageComponentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteImageComponentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
