...
{
    public class OpsAuthorizeSecurityGroupEgressRequest : RpcAcsRequest<OpsAuthorizeSecurityGroupEgressResponse>
    {
        public OpsAuthorizeSecurityGroupEgressRequest()
            : base("Ecs", "2015-11-01", "OpsAuthorizeSecurityGroupEgress")
        {
        }
        ...
        public override OpsAuthorizeSecurityGroupEgressResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OpsAuthorizeSecurityGroupEgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}