...
{
    public class OpsCreateSnapshotRequest : RpcAcsRequest<OpsCreateSnapshotResponse>
    {
        public OpsCreateSnapshotRequest()
            : base("Ecs", "2015-11-01", "OpsCreateSnapshot")
        {
        }
        ...
        public override OpsCreateSnapshotResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OpsCreateSnapshotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}