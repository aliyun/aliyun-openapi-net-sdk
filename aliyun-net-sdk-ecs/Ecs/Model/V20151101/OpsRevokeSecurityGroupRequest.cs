...
{
    public class OpsRevokeSecurityGroupRequest : RpcAcsRequest<OpsRevokeSecurityGroupResponse>
    {
        public OpsRevokeSecurityGroupRequest()
            : base("Ecs", "2015-11-01", "OpsRevokeSecurityGroup")
        {
        }
        ...
        public override OpsRevokeSecurityGroupResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OpsRevokeSecurityGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}