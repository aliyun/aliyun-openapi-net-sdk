...
{
    public class OpsAttachDiskRequest : RpcAcsRequest<OpsAttachDiskResponse>
    {
        public OpsAttachDiskRequest()
            : base("Ecs", "2015-11-01", "OpsAttachDisk")
        {
        }
        ...
        public override OpsAttachDiskResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OpsAttachDiskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}