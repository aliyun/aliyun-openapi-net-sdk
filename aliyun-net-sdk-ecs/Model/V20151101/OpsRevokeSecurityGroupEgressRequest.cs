...
{
    public class OpsRevokeSecurityGroupEgressRequest : RpcAcsRequest<OpsRevokeSecurityGroupEgressResponse>
    {
        public OpsRevokeSecurityGroupEgressRequest()
            : base("Ecs", "2015-11-01", "OpsRevokeSecurityGroupEgress")
        {
        }
        ...
        public override OpsRevokeSecurityGroupEgressResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OpsRevokeSecurityGroupEgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}