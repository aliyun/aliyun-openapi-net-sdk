...
{
    public class DetailImageRequest : RpcAcsRequest<DetailImageResponse>
    {
        public DetailImageRequest()
            : base("Ecs", "2015-11-01", "DetailImage")
        {
        }
        ...
        public override DetailImageResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DetailImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}