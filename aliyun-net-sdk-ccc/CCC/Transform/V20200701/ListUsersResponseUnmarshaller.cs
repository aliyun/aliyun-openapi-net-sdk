    ...
    public class ListUsersResponseUnmarshaller
    {
        public static ListUsersResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			for (int i = 0; i < _ctx.Length("ListUsers.Data.List.Length"); i++) {
				...
				userDetail.DisplayId = _ctx.StringValue("ListUsers.Data.List["+ i +"].DisplayId");
				...
				userDetail.Extension = _ctx.StringValue("ListUsers.Data.List["+ i +"].Extension");
				userDetail.DeviceId = _ctx.StringValue("ListUsers.Data.List["+ i +"].DeviceId");
				userDetail.DeviceExt = _ctx.StringValue("ListUsers.Data.List["+ i +"].DeviceExt");
				userDetail.DeviceState = _ctx.StringValue("ListUsers.Data.List["+ i +"].DeviceState");
