...
namespace Aliyun.Acs.CCC.Transform.V20200701
{
    public class ResetUserPasswordResponseUnmarshaller
    {
        public static ResetUserPasswordResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			resetUserPasswordResponse.Code = _ctx.StringValue("ResetUserPassword.Code");
			resetUserPasswordResponse.HttpStatusCode = _ctx.IntegerValue("ResetUserPassword.HttpStatusCode");
			resetUserPasswordResponse.Message = _ctx.StringValue("ResetUserPassword.Message");
