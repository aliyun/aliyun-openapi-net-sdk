...
{
    public class GetHistoricalCampaignReportRequest : RpcAcsRequest<GetHistoricalCampaignReportResponse>
    {
        public GetHistoricalCampaignReportRequest()
            : base("CCC", "2020-07-01", "GetHistoricalCampaignReport")
        {
        ...
        public override GetHistoricalCampaignReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetHistoricalCampaignReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
