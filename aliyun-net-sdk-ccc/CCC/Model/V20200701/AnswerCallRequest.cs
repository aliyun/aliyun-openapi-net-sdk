...
{
    public class AnswerCallRequest : RpcAcsRequest<AnswerCallResponse>
    {
        public AnswerCallRequest()
            : base("CCC", "2020-07-01", "AnswerCall", "CCC", "openAPI")
        {
        ...
        public override AnswerCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AnswerCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
