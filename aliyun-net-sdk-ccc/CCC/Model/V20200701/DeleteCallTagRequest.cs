...
{
    public class DeleteCallTagRequest : RpcAcsRequest<DeleteCallTagResponse>
    {
        public DeleteCallTagRequest()
            : base("CCC", "2020-07-01", "DeleteCallTag")
        {
        ...
        public override DeleteCallTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCallTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
