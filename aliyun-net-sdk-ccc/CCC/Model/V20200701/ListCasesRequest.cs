...
{
    public class ListCasesRequest : RpcAcsRequest<ListCasesResponse>
    {
        public ListCasesRequest()
            : base("CCC", "2020-07-01", "ListCases", "CCC", "openAPI")
        {
        ...
        public override ListCasesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCasesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
