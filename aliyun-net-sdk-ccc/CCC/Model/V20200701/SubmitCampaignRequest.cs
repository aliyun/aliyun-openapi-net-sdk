...
{
    public class SubmitCampaignRequest : RpcAcsRequest<SubmitCampaignResponse>
    {
        public SubmitCampaignRequest()
            : base("CCC", "2020-07-01", "SubmitCampaign", "CCC", "openAPI")
        {
        ...
        public override SubmitCampaignResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitCampaignResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
