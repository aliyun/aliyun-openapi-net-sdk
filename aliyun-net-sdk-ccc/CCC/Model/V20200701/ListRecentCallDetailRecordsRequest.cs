...
{
    public class ListRecentCallDetailRecordsRequest : RpcAcsRequest<ListRecentCallDetailRecordsResponse>
    {
        public ListRecentCallDetailRecordsRequest()
            : base("CCC", "2020-07-01", "ListRecentCallDetailRecords", "CCC", "openAPI")
        {
        ...
        public override ListRecentCallDetailRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRecentCallDetailRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
