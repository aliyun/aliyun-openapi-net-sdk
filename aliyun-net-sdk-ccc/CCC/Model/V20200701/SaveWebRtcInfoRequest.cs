...
{
    public class SaveWebRtcInfoRequest : RpcAcsRequest<SaveWebRtcInfoResponse>
    {
        public SaveWebRtcInfoRequest()
            : base("CCC", "2020-07-01", "SaveWebRtcInfo", "CCC", "openAPI")
        {
        ...
        public override SaveWebRtcInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveWebRtcInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
