...
{
	public class ReleaseCallResponse : AcsResponse
	{
		...
		public class ReleaseCall_Data
		{
			...
			public ReleaseCall_UserContext UserContext
			{
				get
				{
					return userContext;
			...
			public class ReleaseCall_CallContext
			{
				...
				public List<ReleaseCall_ChannelContext> ChannelContexts
				{
					get
					{
