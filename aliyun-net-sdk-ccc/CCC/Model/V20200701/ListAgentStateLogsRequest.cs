...
{
    public class ListAgentStateLogsRequest : RpcAcsRequest<ListAgentStateLogsResponse>
    {
        public ListAgentStateLogsRequest()
            : base("CCC", "2020-07-01", "ListAgentStateLogs", "CCC", "openAPI")
        {
        ...
        public override ListAgentStateLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAgentStateLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
