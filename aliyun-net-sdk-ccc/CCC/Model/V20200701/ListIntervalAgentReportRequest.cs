...
{
    public class ListIntervalAgentReportRequest : RpcAcsRequest<ListIntervalAgentReportResponse>
    {
        public ListIntervalAgentReportRequest()
            : base("CCC", "2020-07-01", "ListIntervalAgentReport", "CCC", "openAPI")
        {
        ...
        public override ListIntervalAgentReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListIntervalAgentReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
