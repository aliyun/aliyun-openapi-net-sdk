...
{
    public class GetMultiChannelRecordingRequest : RpcAcsRequest<GetMultiChannelRecordingResponse>
    {
        public GetMultiChannelRecordingRequest()
            : base("CCC", "2020-07-01", "GetMultiChannelRecording", "CCC", "openAPI")
        {
        ...
        public override GetMultiChannelRecordingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMultiChannelRecordingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
