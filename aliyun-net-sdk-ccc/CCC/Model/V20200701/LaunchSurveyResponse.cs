...
{
	public class LaunchSurveyResponse : AcsResponse
	{
		...
		private LaunchSurvey_Data data;
		...
		public class LaunchSurvey_Data
		{
			...
			public LaunchSurvey_UserContext UserContext
			{
				get
				{
					return userContext;
			...
			public class LaunchSurvey_CallContext
			{
				...
				private List<LaunchSurvey_ChannelContext> channelContexts;
				...
				public List<LaunchSurvey_ChannelContext> ChannelContexts
				{
					get
					{
				...
				public class LaunchSurvey_ChannelContext
				{
			...
			public class LaunchSurvey_UserContext
			{
