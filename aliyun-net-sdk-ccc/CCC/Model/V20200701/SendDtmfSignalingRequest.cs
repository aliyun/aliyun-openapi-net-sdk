...
{
    public class SendDtmfSignalingRequest : RpcAcsRequest<SendDtmfSignalingResponse>
    {
        public SendDtmfSignalingRequest()
            : base("CCC", "2020-07-01", "SendDtmfSignaling", "CCC", "openAPI")
        {
		...
		public int? Dtmf
		{
			...
			{
				dtmf = value;
				DictionaryUtil.Add(QueryParameters, "Dtmf", value.ToString());
			}
		}
        ...
        public override SendDtmfSignalingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SendDtmfSignalingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
