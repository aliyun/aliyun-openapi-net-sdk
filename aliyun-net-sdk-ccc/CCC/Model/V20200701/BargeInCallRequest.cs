...
{
    public class BargeInCallRequest : RpcAcsRequest<BargeInCallResponse>
    {
        public BargeInCallRequest()
            : base("CCC", "2020-07-01", "BargeInCall", "CCC", "openAPI")
        {
		...
		public string BargedUserId
		{
			...
			{
				bargedUserId = value;
				DictionaryUtil.Add(QueryParameters, "BargedUserId", value);
			}
		}
        ...
        public override BargeInCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BargeInCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
