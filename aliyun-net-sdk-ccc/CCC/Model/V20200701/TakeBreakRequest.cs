...
{
    public class TakeBreakRequest : RpcAcsRequest<TakeBreakResponse>
    {
        public TakeBreakRequest()
            : base("CCC", "2020-07-01", "TakeBreak", "CCC", "openAPI")
        {
        ...
        public override TakeBreakResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TakeBreakResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
