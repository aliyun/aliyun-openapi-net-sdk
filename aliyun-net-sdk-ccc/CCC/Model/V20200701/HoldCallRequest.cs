...
{
    public class HoldCallRequest : RpcAcsRequest<HoldCallResponse>
    {
        public HoldCallRequest()
            : base("CCC", "2020-07-01", "HoldCall", "CCC", "openAPI")
        {
        ...
        public override HoldCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return HoldCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
