...
{
    public class AddPersonalNumbersToUserRequest : RpcAcsRequest<AddPersonalNumbersToUserResponse>
    {
        public AddPersonalNumbersToUserRequest()
            : base("CCC", "2020-07-01", "AddPersonalNumbersToUser", "CCC", "openAPI")
        {
        ...
        public override AddPersonalNumbersToUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddPersonalNumbersToUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
