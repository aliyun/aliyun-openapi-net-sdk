...
{
    public class MonitorCallRequest : RpcAcsRequest<MonitorCallResponse>
    {
        public MonitorCallRequest()
            : base("CCC", "2020-07-01", "MonitorCall")
        {
		...
		public string MonitoredUserId
		{
			...
			set	
			{
				monitoredUserId = value;
				DictionaryUtil.Add(QueryParameters, "MonitoredUserId", value);
			}
		}
        ...
        public override MonitorCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MonitorCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
