...
{
    public class GetSkillGroupRequest : RpcAcsRequest<GetSkillGroupResponse>
    {
        public GetSkillGroupRequest()
            : base("CCC", "2020-07-01", "GetSkillGroup")
        {
        ...
        public override GetSkillGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSkillGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
