...
{
    public class ListCallTagsRequest : RpcAcsRequest<ListCallTagsResponse>
    {
        public ListCallTagsRequest()
            : base("CCC", "2020-07-01", "ListCallTags")
        {
        ...
        public override ListCallTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCallTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
