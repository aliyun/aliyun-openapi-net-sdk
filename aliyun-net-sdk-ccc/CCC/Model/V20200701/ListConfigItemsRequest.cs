...
{
    public class ListConfigItemsRequest : RpcAcsRequest<ListConfigItemsResponse>
    {
        public ListConfigItemsRequest()
            : base("CCC", "2020-07-01", "ListConfigItems", "CCC", "openAPI")
        {
        ...
        public override ListConfigItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListConfigItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
