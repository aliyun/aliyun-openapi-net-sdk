...
{
    public class InitiateAttendedTransferRequest : RpcAcsRequest<InitiateAttendedTransferResponse>
    {
        public InitiateAttendedTransferRequest()
            : base("CCC", "2020-07-01", "InitiateAttendedTransfer", "CCC", "openAPI")
        {
        ...
        public override InitiateAttendedTransferResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InitiateAttendedTransferResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
