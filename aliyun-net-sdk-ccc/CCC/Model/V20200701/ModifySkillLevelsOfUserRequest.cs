...
{
    public class ModifySkillLevelsOfUserRequest : RpcAcsRequest<ModifySkillLevelsOfUserResponse>
    {
        public ModifySkillLevelsOfUserRequest()
            : base("CCC", "2020-07-01", "ModifySkillLevelsOfUser", "CCC", "openAPI")
        {
        ...
        public override ModifySkillLevelsOfUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySkillLevelsOfUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
