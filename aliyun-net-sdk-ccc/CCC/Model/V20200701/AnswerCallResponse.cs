...
{
	public class AnswerCallResponse : AcsResponse
	{
		...
		public class AnswerCall_Data
		{
			...
			public AnswerCall_UserContext UserContext
			{
				get
				{
					return userContext;
			...
			public class AnswerCall_CallContext
			{
				...
				public class AnswerCall_ChannelContext
				{
			...
			public class AnswerCall_UserContext
			{
