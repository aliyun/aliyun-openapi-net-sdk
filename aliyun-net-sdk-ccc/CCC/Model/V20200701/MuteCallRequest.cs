...
{
    public class MuteCallRequest : RpcAcsRequest<MuteCallResponse>
    {
        public MuteCallRequest()
            : base("CCC", "2020-07-01", "MuteCall", "CCC", "openAPI")
        {
        ...
        public override MuteCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MuteCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
