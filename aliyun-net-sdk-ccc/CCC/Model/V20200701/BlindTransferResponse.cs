...
{
	public class BlindTransferResponse : AcsResponse
	{
		...
		private BlindTransfer_Data data;
		...
		public BlindTransfer_Data Data
		{
			get
			{
				return data;
		...
		public class BlindTransfer_Data
		{
			...
			public BlindTransfer_UserContext UserContext
			{
				get
				{
					return userContext;
			...
			public class BlindTransfer_CallContext
			{
				...
				private List<BlindTransfer_ChannelContext> channelContexts;
				...
				public List<BlindTransfer_ChannelContext> ChannelContexts
				{
					get
					{
				...
				public class BlindTransfer_ChannelContext
				{
			...
			public class BlindTransfer_UserContext
			{
