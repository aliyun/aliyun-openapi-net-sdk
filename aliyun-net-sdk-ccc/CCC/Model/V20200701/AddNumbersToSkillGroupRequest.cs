...
{
    public class AddNumbersToSkillGroupRequest : RpcAcsRequest<AddNumbersToSkillGroupResponse>
    {
        public AddNumbersToSkillGroupRequest()
            : base("CCC", "2020-07-01", "AddNumbersToSkillGroup", "CCC", "openAPI")
        {
        ...
        public override AddNumbersToSkillGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddNumbersToSkillGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
