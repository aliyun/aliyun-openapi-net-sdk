...
{
	public class CompleteAttendedTransferResponse : AcsResponse
	{
		...
		private CompleteAttendedTransfer_Data data;
		...
		public CompleteAttendedTransfer_Data Data
		{
			get
			{
				return data;
		...
		public class CompleteAttendedTransfer_Data
		{
			...
			public CompleteAttendedTransfer_UserContext UserContext
			{
				get
				{
					return userContext;
			...
			public class CompleteAttendedTransfer_CallContext
			{
				...
				private List<CompleteAttendedTransfer_ChannelContext> channelContexts;
				...
				public List<CompleteAttendedTransfer_ChannelContext> ChannelContexts
				{
					get
					{
				...
				public class CompleteAttendedTransfer_ChannelContext
				{
			...
			public class CompleteAttendedTransfer_UserContext
			{
