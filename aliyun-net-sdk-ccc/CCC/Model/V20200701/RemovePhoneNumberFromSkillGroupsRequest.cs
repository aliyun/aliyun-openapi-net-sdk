...
{
    public class RemovePhoneNumberFromSkillGroupsRequest : RpcAcsRequest<RemovePhoneNumberFromSkillGroupsResponse>
    {
        public RemovePhoneNumberFromSkillGroupsRequest()
            : base("CCC", "2020-07-01", "RemovePhoneNumberFromSkillGroups", "CCC", "openAPI")
        {
        ...
        public override RemovePhoneNumberFromSkillGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemovePhoneNumberFromSkillGroupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
