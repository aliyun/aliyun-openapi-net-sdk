...
{
    public class ListBriefSkillGroupsRequest : RpcAcsRequest<ListBriefSkillGroupsResponse>
    {
        public ListBriefSkillGroupsRequest()
            : base("CCC", "2020-07-01", "ListBriefSkillGroups", "CCC", "openAPI")
        {
        ...
        public override ListBriefSkillGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListBriefSkillGroupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
