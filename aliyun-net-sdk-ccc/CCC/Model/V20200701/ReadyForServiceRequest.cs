...
{
    public class ReadyForServiceRequest : RpcAcsRequest<ReadyForServiceResponse>
    {
        public ReadyForServiceRequest()
            : base("CCC", "2020-07-01", "ReadyForService", "CCC", "openAPI")
        {
		...
		public bool? OutboundScenario
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "OutboundScenario", value.ToString());
			}
		}
        ...
        public override ReadyForServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReadyForServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
