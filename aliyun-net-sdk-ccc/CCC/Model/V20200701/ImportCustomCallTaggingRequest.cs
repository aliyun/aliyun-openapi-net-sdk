...
{
    public class ImportCustomCallTaggingRequest : RpcAcsRequest<ImportCustomCallTaggingResponse>
    {
        public ImportCustomCallTaggingRequest()
            : base("CCC", "2020-07-01", "ImportCustomCallTagging")
        {
        ...
        public override ImportCustomCallTaggingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportCustomCallTaggingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
