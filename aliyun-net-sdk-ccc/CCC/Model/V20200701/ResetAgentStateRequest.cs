...
{
    public class ResetAgentStateRequest : RpcAcsRequest<ResetAgentStateResponse>
    {
        public ResetAgentStateRequest()
            : base("CCC", "2020-07-01", "ResetAgentState", "CCC", "openAPI")
        {
        ...
        public override ResetAgentStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetAgentStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
