...
{
    public class CoachCallRequest : RpcAcsRequest<CoachCallResponse>
    {
        public CoachCallRequest()
            : base("CCC", "2020-07-01", "CoachCall", "CCC", "openAPI")
        {
		...
		public string CoachedUserId
		{
			...
			{
				coachedUserId = value;
				DictionaryUtil.Add(QueryParameters, "CoachedUserId", value);
			}
		}
        ...
        public override CoachCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CoachCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
