...
{
    public class AddUsersToSkillGroupRequest : RpcAcsRequest<AddUsersToSkillGroupResponse>
    {
        public AddUsersToSkillGroupRequest()
            : base("CCC", "2020-07-01", "AddUsersToSkillGroup", "CCC", "openAPI")
        {
		...
		public string UserSkillLevelList
		{
			...
			set	
			{
				userSkillLevelList = value;
				DictionaryUtil.Add(QueryParameters, "UserSkillLevelList", value);
			}
		}
        ...
        public override AddUsersToSkillGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddUsersToSkillGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
