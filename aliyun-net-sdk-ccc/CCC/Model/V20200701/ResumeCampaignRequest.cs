...
namespace Aliyun.Acs.CCC.Model.V20200701
{
    public class ResumeCampaignRequest : RpcAcsRequest<ResumeCampaignResponse>
    {
        ...
        public override ResumeCampaignResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResumeCampaignResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
