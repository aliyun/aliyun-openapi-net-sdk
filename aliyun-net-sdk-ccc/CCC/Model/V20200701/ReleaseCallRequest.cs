...
{
    public class ReleaseCallRequest : RpcAcsRequest<ReleaseCallResponse>
    {
        public ReleaseCallRequest()
            : base("CCC", "2020-07-01", "ReleaseCall", "CCC", "openAPI")
        {
        ...
        public override ReleaseCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
