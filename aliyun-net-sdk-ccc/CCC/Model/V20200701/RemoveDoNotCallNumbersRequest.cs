...
{
    public class RemoveDoNotCallNumbersRequest : RpcAcsRequest<RemoveDoNotCallNumbersResponse>
    {
        public RemoveDoNotCallNumbersRequest()
            : base("CCC", "2020-07-01", "RemoveDoNotCallNumbers")
        {
        ...
        public override RemoveDoNotCallNumbersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveDoNotCallNumbersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
