...
{
    public class RetrieveCallRequest : RpcAcsRequest<RetrieveCallResponse>
    {
        public RetrieveCallRequest()
            : base("CCC", "2020-07-01", "RetrieveCall", "CCC", "openAPI")
        {
        ...
        public override RetrieveCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RetrieveCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
