...
{
    public class LaunchAuthenticationRequest : RpcAcsRequest<LaunchAuthenticationResponse>
    {
        public LaunchAuthenticationRequest()
            : base("CCC", "2020-07-01", "LaunchAuthentication")
        {
        ...
        public override LaunchAuthenticationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LaunchAuthenticationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
