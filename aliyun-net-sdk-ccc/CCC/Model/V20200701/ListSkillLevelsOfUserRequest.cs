...
{
    public class ListSkillLevelsOfUserRequest : RpcAcsRequest<ListSkillLevelsOfUserResponse>
    {
        public ListSkillLevelsOfUserRequest()
            : base("CCC", "2020-07-01", "ListSkillLevelsOfUser", "CCC", "openAPI")
        {
        ...
        public override ListSkillLevelsOfUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSkillLevelsOfUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
