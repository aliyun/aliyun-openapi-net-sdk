...
{
    public class ListMonoRecordingsRequest : RpcAcsRequest<ListMonoRecordingsResponse>
    {
        public ListMonoRecordingsRequest()
            : base("CCC", "2020-07-01", "ListMonoRecordings")
        {
        ...
        public override ListMonoRecordingsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMonoRecordingsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
