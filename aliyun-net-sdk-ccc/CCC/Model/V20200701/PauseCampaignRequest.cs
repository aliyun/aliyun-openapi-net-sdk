...
{
    public class PauseCampaignRequest : RpcAcsRequest<PauseCampaignResponse>
    {
        public PauseCampaignRequest()
            : base("CCC", "2020-07-01", "PauseCampaign", "CCC", "openAPI")
        {
        ...
        public override PauseCampaignResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PauseCampaignResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
