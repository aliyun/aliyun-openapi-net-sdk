...
{
    public class ListCustomCallTaggingRequest : RpcAcsRequest<ListCustomCallTaggingResponse>
    {
        public ListCustomCallTaggingRequest()
            : base("CCC", "2020-07-01", "ListCustomCallTagging")
        {
        ...
        public override ListCustomCallTaggingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCustomCallTaggingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
