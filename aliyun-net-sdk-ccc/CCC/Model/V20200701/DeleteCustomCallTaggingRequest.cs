...
{
    public class DeleteCustomCallTaggingRequest : RpcAcsRequest<DeleteCustomCallTaggingResponse>
    {
        public DeleteCustomCallTaggingRequest()
            : base("CCC", "2020-07-01", "DeleteCustomCallTagging")
        {
        ...
        public override DeleteCustomCallTaggingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCustomCallTaggingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
