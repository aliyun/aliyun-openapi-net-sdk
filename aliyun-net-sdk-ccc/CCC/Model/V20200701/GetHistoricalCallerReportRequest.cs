...
{
    public class GetHistoricalCallerReportRequest : RpcAcsRequest<GetHistoricalCallerReportResponse>
    {
        public GetHistoricalCallerReportRequest()
            : base("CCC", "2020-07-01", "GetHistoricalCallerReport", "CCC", "openAPI")
        {
        ...
        public override GetHistoricalCallerReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetHistoricalCallerReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
