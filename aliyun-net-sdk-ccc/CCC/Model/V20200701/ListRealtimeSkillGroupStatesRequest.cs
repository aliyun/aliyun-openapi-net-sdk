...
{
    public class ListRealtimeSkillGroupStatesRequest : RpcAcsRequest<ListRealtimeSkillGroupStatesResponse>
    {
        public ListRealtimeSkillGroupStatesRequest()
            : base("CCC", "2020-07-01", "ListRealtimeSkillGroupStates", "CCC", "openAPI")
        {
        ...
        public override ListRealtimeSkillGroupStatesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRealtimeSkillGroupStatesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
