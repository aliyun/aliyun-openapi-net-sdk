...
{
    public class ExportDoNotCallNumbersRequest : RpcAcsRequest<ExportDoNotCallNumbersResponse>
    {
        public ExportDoNotCallNumbersRequest()
            : base("CCC", "2020-07-01", "ExportDoNotCallNumbers")
        {
        ...
        public override ExportDoNotCallNumbersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExportDoNotCallNumbersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
