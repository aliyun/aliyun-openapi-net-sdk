...
{
    public class ListDoNotCallNumbersRequest : RpcAcsRequest<ListDoNotCallNumbersResponse>
    {
        public ListDoNotCallNumbersRequest()
            : base("CCC", "2020-07-01", "ListDoNotCallNumbers")
        {
        ...
        public override ListDoNotCallNumbersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDoNotCallNumbersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
