...
{
    public class ChangeWorkModeRequest : RpcAcsRequest<ChangeWorkModeResponse>
    {
        public ChangeWorkModeRequest()
            : base("CCC", "2020-07-01", "ChangeWorkMode", "CCC", "openAPI")
        {
        ...
        public override ChangeWorkModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeWorkModeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
