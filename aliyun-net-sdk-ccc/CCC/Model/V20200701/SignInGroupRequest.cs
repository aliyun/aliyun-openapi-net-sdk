...
{
    public class SignInGroupRequest : RpcAcsRequest<SignInGroupResponse>
    {
        public SignInGroupRequest()
            : base("CCC", "2020-07-01", "SignInGroup", "CCC", "openAPI")
        {
		...
		public string SignedSkillGroupIdList
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SignedSkillGroupIdList", value);
			}
		}
        ...
        public override SignInGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SignInGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
