...
{
    public class SignOutGroupRequest : RpcAcsRequest<SignOutGroupResponse>
    {
        public SignOutGroupRequest()
            : base("CCC", "2020-07-01", "SignOutGroup", "CCC", "openAPI")
        {
        ...
        public override SignOutGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SignOutGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
