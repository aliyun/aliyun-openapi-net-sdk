...
{
    public class CompleteAttendedTransferRequest : RpcAcsRequest<CompleteAttendedTransferResponse>
    {
        public CompleteAttendedTransferRequest()
            : base("CCC", "2020-07-01", "CompleteAttendedTransfer", "CCC", "openAPI")
        {
        ...
        public override CompleteAttendedTransferResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CompleteAttendedTransferResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
