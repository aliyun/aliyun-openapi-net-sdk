...
{
    public class GetCampaignRequest : RpcAcsRequest<GetCampaignResponse>
    {
        public GetCampaignRequest()
            : base("CCC", "2020-07-01", "GetCampaign", "CCC", "openAPI")
        {
        ...
        public override GetCampaignResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCampaignResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
