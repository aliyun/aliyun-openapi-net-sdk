...
{
    public class RemovePhoneNumbersFromSkillGroupRequest : RpcAcsRequest<RemovePhoneNumbersFromSkillGroupResponse>
    {
        public RemovePhoneNumbersFromSkillGroupRequest()
            : base("CCC", "2020-07-01", "RemovePhoneNumbersFromSkillGroup", "CCC", "openAPI")
        {
        ...
        public override RemovePhoneNumbersFromSkillGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemovePhoneNumbersFromSkillGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
