...
{
    public class ListUserLevelsOfSkillGroupRequest : RpcAcsRequest<ListUserLevelsOfSkillGroupResponse>
    {
        public ListUserLevelsOfSkillGroupRequest()
            : base("CCC", "2020-07-01", "ListUserLevelsOfSkillGroup", "CCC", "openAPI")
        {
        ...
        public override ListUserLevelsOfSkillGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserLevelsOfSkillGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
