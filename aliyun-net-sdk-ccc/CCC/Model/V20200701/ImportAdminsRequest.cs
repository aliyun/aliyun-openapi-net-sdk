...
{
    public class ImportAdminsRequest : RpcAcsRequest<ImportAdminsResponse>
    {
        public ImportAdminsRequest()
            : base("CCC", "2020-07-01", "ImportAdmins")
        {
        ...
        public override ImportAdminsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportAdminsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
