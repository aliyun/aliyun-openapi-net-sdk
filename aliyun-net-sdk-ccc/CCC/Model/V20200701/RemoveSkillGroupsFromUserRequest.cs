...
{
    public class RemoveSkillGroupsFromUserRequest : RpcAcsRequest<RemoveSkillGroupsFromUserResponse>
    {
        public RemoveSkillGroupsFromUserRequest()
            : base("CCC", "2020-07-01", "RemoveSkillGroupsFromUser", "CCC", "openAPI")
        {
        ...
        public override RemoveSkillGroupsFromUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveSkillGroupsFromUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
