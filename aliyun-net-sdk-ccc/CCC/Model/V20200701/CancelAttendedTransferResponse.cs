...
{
	public class CancelAttendedTransferResponse : AcsResponse
	{
		...
		private CancelAttendedTransfer_Data data;
		...
		public CancelAttendedTransfer_Data Data
		{
			get
			{
				return data;
		...
		public class CancelAttendedTransfer_Data
		{
			...
			public CancelAttendedTransfer_UserContext UserContext
			{
				get
				{
					return userContext;
			...
			public class CancelAttendedTransfer_CallContext
			{
				...
				private List<CancelAttendedTransfer_ChannelContext> channelContexts;
				...
				public List<CancelAttendedTransfer_ChannelContext> ChannelContexts
				{
					get
					{
				...
				public class CancelAttendedTransfer_ChannelContext
				{
			...
			public class CancelAttendedTransfer_UserContext
			{
