...
{
    public class UnmuteCallRequest : RpcAcsRequest<UnmuteCallResponse>
    {
        public UnmuteCallRequest()
            : base("CCC", "2020-07-01", "UnmuteCall", "CCC", "openAPI")
        {
        ...
        public override UnmuteCallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnmuteCallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
