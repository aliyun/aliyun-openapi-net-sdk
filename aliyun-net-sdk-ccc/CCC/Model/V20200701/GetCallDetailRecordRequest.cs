...
{
    public class GetCallDetailRecordRequest : RpcAcsRequest<GetCallDetailRecordResponse>
    {
        public GetCallDetailRecordRequest()
            : base("CCC", "2020-07-01", "GetCallDetailRecord", "CCC", "openAPI")
        {
        ...
        public override GetCallDetailRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCallDetailRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
