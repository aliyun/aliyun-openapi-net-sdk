...
{
    public class GetRealtimeCampaignStatsRequest : RpcAcsRequest<GetRealtimeCampaignStatsResponse>
    {
        public GetRealtimeCampaignStatsRequest()
            : base("CCC", "2020-07-01", "GetRealtimeCampaignStats")
        {
        ...
        public override GetRealtimeCampaignStatsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRealtimeCampaignStatsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
