...
{
    public class ListIvrTrackingDetailsRequest : RpcAcsRequest<ListIvrTrackingDetailsResponse>
    {
        public ListIvrTrackingDetailsRequest()
            : base("CCC", "2020-07-01", "ListIvrTrackingDetails", "CCC", "openAPI")
        {
        ...
        public override ListIvrTrackingDetailsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListIvrTrackingDetailsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
