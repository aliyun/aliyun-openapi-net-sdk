...
{
    public class ModifyCustomCallTaggingRequest : RpcAcsRequest<ModifyCustomCallTaggingResponse>
    {
        public ModifyCustomCallTaggingRequest()
            : base("CCC", "2020-07-01", "ModifyCustomCallTagging")
        {
        ...
        public override ModifyCustomCallTaggingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyCustomCallTaggingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
