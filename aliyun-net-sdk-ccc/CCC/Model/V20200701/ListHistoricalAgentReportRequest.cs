...
{
    public class ListHistoricalAgentReportRequest : RpcAcsRequest<ListHistoricalAgentReportResponse>
    {
        public ListHistoricalAgentReportRequest()
            : base("CCC", "2020-07-01", "ListHistoricalAgentReport")
        {
        ...
        public override ListHistoricalAgentReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListHistoricalAgentReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
