...
{
    public class ListRamUsersRequest : RpcAcsRequest<ListRamUsersResponse>
    {
        public ListRamUsersRequest()
            : base("CCC", "2020-07-01", "ListRamUsers", "CCC", "openAPI")
        {
        ...
        public override ListRamUsersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRamUsersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
