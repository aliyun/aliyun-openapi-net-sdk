...
{
    public class CancelAttendedTransferRequest : RpcAcsRequest<CancelAttendedTransferResponse>
    {
        public CancelAttendedTransferRequest()
            : base("CCC", "2020-07-01", "CancelAttendedTransfer", "CCC", "openAPI")
        {
        ...
        public override CancelAttendedTransferResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelAttendedTransferResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
