...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class SubmitCabRecordingRequest : RpcAcsRequest<SubmitCabRecordingResponse>
    {
        public SubmitCabRecordingRequest()
            : base("CCC", "2017-07-05", "SubmitCabRecording", "CCC", "openAPI")
        {
		...
		public string EarlyMediaRecording
		{
			get
			{
				return earlyMediaRecording;
			}
			set	
			{
				earlyMediaRecording = value;
				DictionaryUtil.Add(QueryParameters, "EarlyMediaRecording", value);
			}
		}
