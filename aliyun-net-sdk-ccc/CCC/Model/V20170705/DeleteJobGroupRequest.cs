...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class DeleteJobGroupRequest : RpcAcsRequest<DeleteJobGroupResponse>
    {
        public DeleteJobGroupRequest()
            : base("CCC", "2017-07-05", "DeleteJobGroup", "ccc", "openAPI")
        {
        }
        ...
        public override DeleteJobGroupResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
