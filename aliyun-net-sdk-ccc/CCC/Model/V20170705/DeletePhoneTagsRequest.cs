...
{
    public class DeletePhoneTagsRequest : RpcAcsRequest<DeletePhoneTagsResponse>
    {
        public DeletePhoneTagsRequest()
            : base("CCC", "2017-07-05", "DeletePhoneTags", "CCC", "openAPI")
        {
        ...
        public override DeletePhoneTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePhoneTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
