...
{
    public class SuspendPredictiveJobsRequest : RpcAcsRequest<SuspendPredictiveJobsResponse>
    {
        public SuspendPredictiveJobsRequest()
            : base("CCC", "2017-07-05", "SuspendPredictiveJobs", "CCC", "openAPI")
        {
        ...
        public override SuspendPredictiveJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SuspendPredictiveJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
