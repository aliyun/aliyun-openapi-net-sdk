...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class GetJobStatusByCallIdRequest : RpcAcsRequest<GetJobStatusByCallIdResponse>
    {
        public GetJobStatusByCallIdRequest()
            : base("CCC", "2017-07-05", "GetJobStatusByCallId", "ccc", "openAPI")
        {
        }
        ...
        public override GetJobStatusByCallIdResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
