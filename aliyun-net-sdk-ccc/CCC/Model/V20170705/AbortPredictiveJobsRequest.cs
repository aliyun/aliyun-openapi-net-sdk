...
{
    public class AbortPredictiveJobsRequest : RpcAcsRequest<AbortPredictiveJobsResponse>
    {
        public AbortPredictiveJobsRequest()
            : base("CCC", "2017-07-05", "AbortPredictiveJobs", "CCC", "openAPI")
        {
        ...
        public override AbortPredictiveJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AbortPredictiveJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
