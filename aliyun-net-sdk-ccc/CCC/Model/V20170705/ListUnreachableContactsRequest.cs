...
namespace Aliyun.Acs.CCC.Model.V20170705
{
    public class ListUnreachableContactsRequest : RpcAcsRequest<ListUnreachableContactsResponse>
    {
        public ListUnreachableContactsRequest()
            : base("CCC", "2017-07-05", "ListUnreachableContacts", "ccc", "openAPI")
        {
        }
        ...
        public override ListUnreachableContactsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
