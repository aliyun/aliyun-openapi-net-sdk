...
{
    public class GetPredictiveJobGroupRequest : RpcAcsRequest<GetPredictiveJobGroupResponse>
    {
        public GetPredictiveJobGroupRequest()
            : base("CCC", "2017-07-05", "GetPredictiveJobGroup", "CCC", "openAPI")
        {
        ...
        public override GetPredictiveJobGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPredictiveJobGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
