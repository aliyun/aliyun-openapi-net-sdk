...
{
    public class CheckNumberAvaliableRequest : RpcAcsRequest<CheckNumberAvaliableResponse>
    {
        public CheckNumberAvaliableRequest()
            : base("CCC", "2017-07-05", "CheckNumberAvaliable", "CCC", "openAPI")
        {
        ...
        public override CheckNumberAvaliableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckNumberAvaliableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
