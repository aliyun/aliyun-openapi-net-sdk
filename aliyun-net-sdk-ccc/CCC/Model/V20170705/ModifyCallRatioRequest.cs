...
{
    public class ModifyCallRatioRequest : RpcAcsRequest<ModifyCallRatioResponse>
    {
        public ModifyCallRatioRequest()
            : base("CCC", "2017-07-05", "ModifyCallRatio", "CCC", "openAPI")
        {
        ...
        public override ModifyCallRatioResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyCallRatioResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
