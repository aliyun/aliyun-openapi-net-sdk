...
{
    public class ResumePredictiveJobsRequest : RpcAcsRequest<ResumePredictiveJobsResponse>
    {
        public ResumePredictiveJobsRequest()
            : base("CCC", "2017-07-05", "ResumePredictiveJobs", "CCC", "openAPI")
        {
        ...
        public override ResumePredictiveJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResumePredictiveJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
