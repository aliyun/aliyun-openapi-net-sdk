...
namespace Aliyun.Acs.TeslaMaxCompute.Model.V20180104
{
    public class QueryTopologyRequest : RpcAcsRequest<QueryTopologyResponse>
    {
        ...
        public override QueryTopologyResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return QueryTopologyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}