...
{
    public class GetPredictResultHighRequest : RpcAcsRequest<GetPredictResultHighResponse>
    {
        public GetPredictResultHighRequest()
            : base("nlp-automl", "2019-11-11", "GetPredictResultHigh")
        {
        ...
        public override GetPredictResultHighResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPredictResultHighResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
