...
{
    public class RunPreTrainServiceNewRequest : RpcAcsRequest<RunPreTrainServiceNewResponse>
    {
        public RunPreTrainServiceNewRequest()
            : base("nlp-automl", "2019-11-11", "RunPreTrainServiceNew")
        {
        ...
        public override RunPreTrainServiceNewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RunPreTrainServiceNewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
