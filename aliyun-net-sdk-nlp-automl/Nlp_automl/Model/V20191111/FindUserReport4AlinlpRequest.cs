...
{
    public class FindUserReport4AlinlpRequest : RpcAcsRequest<FindUserReport4AlinlpResponse>
    {
        public FindUserReport4AlinlpRequest()
            : base("nlp-automl", "2019-11-11", "FindUserReport4Alinlp")
        {
		...
		public long? CustomerUserParentId
		{
			...
			set	
			{
				customerUserParentId = value;
				DictionaryUtil.Add(BodyParameters, "CustomerUserParentId", value.ToString());
			}
		}
        ...
        public override FindUserReport4AlinlpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FindUserReport4AlinlpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
