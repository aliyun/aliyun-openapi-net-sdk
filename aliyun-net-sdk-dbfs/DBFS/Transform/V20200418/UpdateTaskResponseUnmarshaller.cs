...
namespace Aliyun.Acs.DBFS.Transform.V20200418
{
    ...
    {
        public static UpdateTaskResponse Unmarshall(UnmarshallerContext _ctx)
        {
			UpdateTaskResponse updateTaskResponse = new UpdateTaskResponse();

			updateTaskResponse.HttpResponse = _ctx.HttpResponse;
			updateTaskResponse.RequestId = _ctx.StringValue("UpdateTask.RequestId");
