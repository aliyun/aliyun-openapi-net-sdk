...
{
    public class StopUpgradeTaskRequest : RpcAcsRequest<StopUpgradeTaskResponse>
    {
        public StopUpgradeTaskRequest()
            : base("DBFS", "2020-04-18", "StopUpgradeTask")
        {
        ...
        public override StopUpgradeTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopUpgradeTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
