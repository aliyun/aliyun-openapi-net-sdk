...
{
    public class UpdateConstantsRequest : RpcAcsRequest<UpdateConstantsResponse>
    {
        public UpdateConstantsRequest()
            : base("DBFS", "2020-04-18", "UpdateConstants")
        {
        ...
        public override UpdateConstantsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateConstantsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
