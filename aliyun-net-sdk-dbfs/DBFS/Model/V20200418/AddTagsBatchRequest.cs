...
namespace Aliyun.Acs.DBFS.Model.V20200418
{
    public class AddTagsBatchRequest : RpcAcsRequest<AddTagsBatchResponse>
    {
        ...
        public override AddTagsBatchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddTagsBatchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
