...
{
    public class ListConstantsRequest : RpcAcsRequest<ListConstantsResponse>
    {
        public ListConstantsRequest()
            : base("DBFS", "2020-04-18", "ListConstants")
        {
        ...
        public override ListConstantsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListConstantsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
