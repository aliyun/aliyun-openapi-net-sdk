...
{
    public class DbfsRecordRequest : RpcAcsRequest<DbfsRecordResponse>
    {
        public DbfsRecordRequest()
            : base("DBFS", "2020-04-18", "DbfsRecord")
        {
        ...
        public override DbfsRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DbfsRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
