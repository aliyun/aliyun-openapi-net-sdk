...
{
    public class PublishUpgradeTaskRequest : RpcAcsRequest<PublishUpgradeTaskResponse>
    {
        public PublishUpgradeTaskRequest()
            : base("DBFS", "2020-04-18", "PublishUpgradeTask")
        {
        ...
        public override PublishUpgradeTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PublishUpgradeTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
