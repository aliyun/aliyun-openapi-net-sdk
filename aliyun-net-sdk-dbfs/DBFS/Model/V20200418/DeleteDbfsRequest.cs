...
namespace Aliyun.Acs.DBFS.Model.V20200418
{
    public class DeleteDbfsRequest : RpcAcsRequest<DeleteDbfsResponse>
    {
        ...
        public override DeleteDbfsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDbfsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
