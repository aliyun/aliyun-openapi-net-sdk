...
{
    public class DeleteConstantsRequest : RpcAcsRequest<DeleteConstantsResponse>
    {
        public DeleteConstantsRequest()
            : base("DBFS", "2020-04-18", "DeleteConstants")
        {
        ...
        public override DeleteConstantsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteConstantsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
