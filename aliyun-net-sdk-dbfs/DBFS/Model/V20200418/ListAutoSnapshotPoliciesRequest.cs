...
namespace Aliyun.Acs.DBFS.Model.V20200418
{
    public class ListAutoSnapshotPoliciesRequest : RpcAcsRequest<ListAutoSnapshotPoliciesResponse>
    {
        ...
        public override ListAutoSnapshotPoliciesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAutoSnapshotPoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
