...
{
    public class TagDbfsRequest : RpcAcsRequest<TagDbfsResponse>
    {
        public TagDbfsRequest()
            : base("DBFS", "2020-04-18", "TagDbfs", "dbfs", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "DbfsId")]
		public string DbfsId
		{
			...
			{
				dbfsId = value;
				DictionaryUtil.Add(QueryParameters, "DbfsId", value);
			}
		}
        ...
        public override TagDbfsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TagDbfsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
