...
{
	public class DescribeDbfsSpecificationsResponse : AcsResponse
	{

		private string requestId;

		private string maxDbfsNumberPerEcs;
		...
		public List<string> SupportedEcsInstanceTypeFamily
		{
			...
			set	
			{
				supportedEcsInstanceTypeFamily = value;
			}
		}
	}
}
