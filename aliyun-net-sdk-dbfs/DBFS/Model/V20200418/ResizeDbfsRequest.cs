...
{
    public class ResizeDbfsRequest : RpcAcsRequest<ResizeDbfsResponse>
    {
        public ResizeDbfsRequest()
            : base("DBFS", "2020-04-18", "ResizeDbfs", "dbfs", "openAPI")
        {
		...
		public int? NewSizeG
		{
			...
			{
				newSizeG = value;
				DictionaryUtil.Add(QueryParameters, "NewSizeG", value.ToString());
			}
		}
        ...
        public override ResizeDbfsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResizeDbfsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
