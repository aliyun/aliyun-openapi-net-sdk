...
namespace Aliyun.Acs.DBFS.Model.V20200418
{
    public class DetachDbfsRequest : RpcAcsRequest<DetachDbfsResponse>
    {
        ...
        public override DetachDbfsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetachDbfsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
