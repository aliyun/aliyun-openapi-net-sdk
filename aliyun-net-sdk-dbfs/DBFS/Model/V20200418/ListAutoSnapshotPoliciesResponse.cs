...
{
	public class ListAutoSnapshotPoliciesResponse : AcsResponse
	{
		...
		private List<ListAutoSnapshotPolicies_SnapshotPoliciesItem> snapshotPolicies;
		...
		[JsonProperty(PropertyName = "SnapshotPolicies")]
		public List<ListAutoSnapshotPolicies_SnapshotPoliciesItem> SnapshotPolicies
		{
			get
			{
		...
		public class ListAutoSnapshotPolicies_SnapshotPoliciesItem
		{
