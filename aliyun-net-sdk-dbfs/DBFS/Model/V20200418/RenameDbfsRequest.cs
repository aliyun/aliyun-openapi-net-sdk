...
{
    public class RenameDbfsRequest : RpcAcsRequest<RenameDbfsResponse>
    {
        public RenameDbfsRequest()
            : base("DBFS", "2020-04-18", "RenameDbfs", "dbfs", "openAPI")
        {
        ...
        public override RenameDbfsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenameDbfsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
