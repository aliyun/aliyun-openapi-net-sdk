...
{
    public class CreateConstantsRequest : RpcAcsRequest<CreateConstantsResponse>
    {
        public CreateConstantsRequest()
            : base("DBFS", "2020-04-18", "CreateConstants")
        {
        ...
        public override CreateConstantsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateConstantsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
