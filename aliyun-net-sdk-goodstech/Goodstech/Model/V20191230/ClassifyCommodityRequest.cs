...
{
    public class ClassifyCommodityRequest : RpcAcsRequest<ClassifyCommodityResponse>
    {
        public ClassifyCommodityRequest()
            : base("goodstech", "2019-12-30", "ClassifyCommodity", "goodstech", "openAPI")
        {
        ...
        public override ClassifyCommodityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ClassifyCommodityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
