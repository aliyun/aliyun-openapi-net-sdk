...
{
	public class RecognizeFurnitureSpuResponse : AcsResponse
	{

		private string requestId;

		private RecognizeFurnitureSpu_Data data;
		...
		public RecognizeFurnitureSpu_Data Data
		{
			get
			{
				return data;
		...
		public class RecognizeFurnitureSpu_Data
		{
