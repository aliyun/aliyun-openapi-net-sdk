...
{
    public class ProcessOcrAlgorithmRequest : RpcAcsRequest<ProcessOcrAlgorithmResponse>
    {
        public ProcessOcrAlgorithmRequest()
            : base("multimediaai", "2019-08-10", "ProcessOcrAlgorithm")
        {
        ...
        public override ProcessOcrAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ProcessOcrAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
