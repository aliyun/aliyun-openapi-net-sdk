...
{
    public class CreateCoverTaskRequest : RpcAcsRequest<CreateCoverTaskResponse>
    {
        public CreateCoverTaskRequest()
            : base("multimediaai", "2019-08-10", "CreateCoverTask")
        {
        ...
        public override CreateCoverTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCoverTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
