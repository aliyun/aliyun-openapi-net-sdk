...
{
    public class ProcessNewsAlgorithmRequest : RpcAcsRequest<ProcessNewsAlgorithmResponse>
    {
        public ProcessNewsAlgorithmRequest()
            : base("multimediaai", "2019-08-10", "ProcessNewsAlgorithm")
        {
        ...
        public override ProcessNewsAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ProcessNewsAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
