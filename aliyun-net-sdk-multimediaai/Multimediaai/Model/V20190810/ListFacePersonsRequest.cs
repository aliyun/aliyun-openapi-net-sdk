...
{
    public class ListFacePersonsRequest : RpcAcsRequest<ListFacePersonsResponse>
    {
        public ListFacePersonsRequest()
            : base("multimediaai", "2019-08-10", "ListFacePersons")
        {
        ...
        public override ListFacePersonsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFacePersonsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
