...
{
    public class ProcessNlpAlgorithmRequest : RpcAcsRequest<ProcessNlpAlgorithmResponse>
    {
        public ProcessNlpAlgorithmRequest()
            : base("multimediaai", "2019-08-10", "ProcessNlpAlgorithm")
        {
        ...
        public override ProcessNlpAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ProcessNlpAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
