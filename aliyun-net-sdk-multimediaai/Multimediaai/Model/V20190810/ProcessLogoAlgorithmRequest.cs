...
{
    public class ProcessLogoAlgorithmRequest : RpcAcsRequest<ProcessLogoAlgorithmResponse>
    {
        public ProcessLogoAlgorithmRequest()
            : base("multimediaai", "2019-08-10", "ProcessLogoAlgorithm")
        {
        ...
        public override ProcessLogoAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ProcessLogoAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
