...
{
    public class ProcessLandmarkAlgorithmRequest : RpcAcsRequest<ProcessLandmarkAlgorithmResponse>
    {
        public ProcessLandmarkAlgorithmRequest()
            : base("multimediaai", "2019-08-10", "ProcessLandmarkAlgorithm")
        {
        ...
        public override ProcessLandmarkAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ProcessLandmarkAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
