...
{
    public class DeleteFacePersonRequest : RpcAcsRequest<DeleteFacePersonResponse>
    {
        public DeleteFacePersonRequest()
            : base("multimediaai", "2019-08-10", "DeleteFacePerson")
        {
        ...
        public override DeleteFacePersonResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFacePersonResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
