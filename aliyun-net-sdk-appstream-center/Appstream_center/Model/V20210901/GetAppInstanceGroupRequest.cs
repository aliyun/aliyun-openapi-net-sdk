...
{
    public class GetAppInstanceGroupRequest : RpcAcsRequest<GetAppInstanceGroupResponse>
    {
        public GetAppInstanceGroupRequest()
            : base("appstream-center", "2021-09-01", "GetAppInstanceGroup")
        {
        ...
        public override GetAppInstanceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAppInstanceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
