...
{
    public class DeleteAppInstanceGroupRequest : RpcAcsRequest<DeleteAppInstanceGroupResponse>
    {
        public DeleteAppInstanceGroupRequest()
            : base("appstream-center", "2021-09-01", "DeleteAppInstanceGroup")
        {
        ...
        public override DeleteAppInstanceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAppInstanceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
