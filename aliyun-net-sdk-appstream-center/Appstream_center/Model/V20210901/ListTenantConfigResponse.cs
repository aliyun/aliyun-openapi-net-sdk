...
{
	public class ListTenantConfigResponse : AcsResponse
	{

		private string requestId;

		private ListTenantConfig_TenantConfigModel tenantConfigModel;
		...
		[JsonProperty(PropertyName = "TenantConfigModel")]
		public ListTenantConfig_TenantConfigModel TenantConfigModel
		{
			get
			{
			...
			set	
			{
				tenantConfigModel = value;
			}
		}

		public class ListTenantConfig_TenantConfigModel
		{
