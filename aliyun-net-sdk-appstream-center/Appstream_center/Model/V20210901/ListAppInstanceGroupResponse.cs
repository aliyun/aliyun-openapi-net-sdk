...
{
	public class ListAppInstanceGroupResponse : AcsResponse
	{
		...
		private List<ListAppInstanceGroup_Data> appInstanceGroupModels;
		...
		public List<ListAppInstanceGroup_Data> AppInstanceGroupModels
		{
			get
			{
		...
		public class ListAppInstanceGroup_Data
		{
			...
			private List<ListAppInstanceGroup_AppsItem> apps;

			private List<ListAppInstanceGroup_Node> nodePool;

			private ListAppInstanceGroup_OtaInfo otaInfo;
			...
			[JsonProperty(PropertyName = "AppPolicyId")]
			...
			public List<ListAppInstanceGroup_AppsItem> Apps
			{
				get
				{
					return apps;
			...
			public List<ListAppInstanceGroup_Node> NodePool
			{
				get
				{
					return nodePool;
			...
			public ListAppInstanceGroup_OtaInfo OtaInfo
			{
				get
				{
					return otaInfo;
			...
			public class ListAppInstanceGroup_AppsItem
			{
			...
			public class ListAppInstanceGroup_Node
			{
				...
				private List<ListAppInstanceGroup_RecurrenceSchedule> recurrenceSchedules;
				...
				public List<ListAppInstanceGroup_RecurrenceSchedule> RecurrenceSchedules
				{
					get
					{
				...
				public class ListAppInstanceGroup_RecurrenceSchedule
				{

					private string recurrenceType;

					private List<ListAppInstanceGroup_TimerPeriod> timerPeriods;
					...
					public List<ListAppInstanceGroup_TimerPeriod> TimerPeriods
					{
						get
						{
							return timerPeriods;
					...
					public class ListAppInstanceGroup_TimerPeriod
					{
			...
			public class ListAppInstanceGroup_OtaInfo
			{
