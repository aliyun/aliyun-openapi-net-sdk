...
{
    public class LogOffAllSessionsInAppInstanceGroupRequest : RpcAcsRequest<LogOffAllSessionsInAppInstanceGroupResponse>
    {
        public LogOffAllSessionsInAppInstanceGroupRequest()
            : base("appstream-center", "2021-09-01", "LogOffAllSessionsInAppInstanceGroup")
        {
        ...
        public override LogOffAllSessionsInAppInstanceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LogOffAllSessionsInAppInstanceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
