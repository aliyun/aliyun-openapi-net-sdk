...
{
    public class CancelOtaTaskRequest : RpcAcsRequest<CancelOtaTaskResponse>
    {
        public CancelOtaTaskRequest()
            : base("appstream-center", "2021-09-01", "CancelOtaTask")
        {
        ...
        public override CancelOtaTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelOtaTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
