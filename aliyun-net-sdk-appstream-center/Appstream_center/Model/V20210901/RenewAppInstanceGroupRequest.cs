...
{
    public class RenewAppInstanceGroupRequest : RpcAcsRequest<RenewAppInstanceGroupResponse>
    {
        public RenewAppInstanceGroupRequest()
            : base("appstream-center", "2021-09-01", "RenewAppInstanceGroup")
        {
        ...
        public override RenewAppInstanceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenewAppInstanceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
