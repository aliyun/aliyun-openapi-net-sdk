...
{
    public class PageListAppInstanceGroupUserRequest : RpcAcsRequest<PageListAppInstanceGroupUserResponse>
    {
        public PageListAppInstanceGroupUserRequest()
            : base("appstream-center", "2021-09-01", "PageListAppInstanceGroupUser")
        {
        ...
        public override PageListAppInstanceGroupUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PageListAppInstanceGroupUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
