...
{
    public class DeleteScriptRecordingRequest : RpcAcsRequest<DeleteScriptRecordingResponse>
    {
        public DeleteScriptRecordingRequest()
            : base("OutboundBot", "2019-12-26", "DeleteScriptRecording")
        {
        ...
        public override DeleteScriptRecordingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteScriptRecordingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
