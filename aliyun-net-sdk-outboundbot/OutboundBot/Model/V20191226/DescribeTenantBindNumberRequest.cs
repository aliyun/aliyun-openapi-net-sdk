...
{
    public class DescribeTenantBindNumberRequest : RpcAcsRequest<DescribeTenantBindNumberResponse>
    {
        public DescribeTenantBindNumberRequest()
            : base("OutboundBot", "2019-12-26", "DescribeTenantBindNumber", "outboundbot", "openAPI")
        {
        ...
        public override DescribeTenantBindNumberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantBindNumberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
