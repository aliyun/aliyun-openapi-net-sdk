...
{
    public class GetMaxAttemptsPerDayRequest : RpcAcsRequest<GetMaxAttemptsPerDayResponse>
    {
        public GetMaxAttemptsPerDayRequest()
            : base("OutboundBot", "2019-12-26", "GetMaxAttemptsPerDay", "outboundbot", "openAPI")
        {
        ...
        public override GetMaxAttemptsPerDayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMaxAttemptsPerDayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
