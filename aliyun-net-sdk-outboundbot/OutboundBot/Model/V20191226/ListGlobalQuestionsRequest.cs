...
{
    public class ListGlobalQuestionsRequest : RpcAcsRequest<ListGlobalQuestionsResponse>
    {
        public ListGlobalQuestionsRequest()
            : base("OutboundBot", "2019-12-26", "ListGlobalQuestions", "outboundbot", "openAPI")
        {
        ...
        public override ListGlobalQuestionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGlobalQuestionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
