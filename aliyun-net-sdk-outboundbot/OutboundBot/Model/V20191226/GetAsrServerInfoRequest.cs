...
{
    public class GetAsrServerInfoRequest : RpcAcsRequest<GetAsrServerInfoResponse>
    {
        public GetAsrServerInfoRequest()
            : base("OutboundBot", "2019-12-26", "GetAsrServerInfo", "outboundbot", "openAPI")
        {
        ...
        public override GetAsrServerInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAsrServerInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
