...
{
    public class GetBaseStrategyPeriodRequest : RpcAcsRequest<GetBaseStrategyPeriodResponse>
    {
        public GetBaseStrategyPeriodRequest()
            : base("OutboundBot", "2019-12-26", "GetBaseStrategyPeriod", "outboundbot", "openAPI")
        {
        ...
        public override GetBaseStrategyPeriodResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetBaseStrategyPeriodResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
