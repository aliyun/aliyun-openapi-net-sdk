...
{
    public class ListSchedulerInstancesRequest : RpcAcsRequest<ListSchedulerInstancesResponse>
    {
        public ListSchedulerInstancesRequest()
            : base("OutboundBot", "2019-12-26", "ListSchedulerInstances", "outboundbot", "openAPI")
        {
        ...
        public override ListSchedulerInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSchedulerInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
