...
{
    public class CreateNumberDistrictInfoDownloadUrlRequest : RpcAcsRequest<CreateNumberDistrictInfoDownloadUrlResponse>
    {
        public CreateNumberDistrictInfoDownloadUrlRequest()
            : base("OutboundBot", "2019-12-26", "CreateNumberDistrictInfoDownloadUrl", "outboundbot", "openAPI")
        {
        ...
        public override CreateNumberDistrictInfoDownloadUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateNumberDistrictInfoDownloadUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
