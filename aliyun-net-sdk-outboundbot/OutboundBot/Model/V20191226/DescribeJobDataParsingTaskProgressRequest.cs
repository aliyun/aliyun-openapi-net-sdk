...
{
    public class DescribeJobDataParsingTaskProgressRequest : RpcAcsRequest<DescribeJobDataParsingTaskProgressResponse>
    {
        public DescribeJobDataParsingTaskProgressRequest()
            : base("OutboundBot", "2019-12-26", "DescribeJobDataParsingTaskProgress", "outboundbot", "openAPI")
        {
        ...
        public override DescribeJobDataParsingTaskProgressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeJobDataParsingTaskProgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
