...
{
    public class DescribeDialogueNodeStatisticsRequest : RpcAcsRequest<DescribeDialogueNodeStatisticsResponse>
    {
        public DescribeDialogueNodeStatisticsRequest()
            : base("OutboundBot", "2019-12-26", "DescribeDialogueNodeStatistics", "outboundbot", "openAPI")
        {
        ...
        public override DescribeDialogueNodeStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDialogueNodeStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
