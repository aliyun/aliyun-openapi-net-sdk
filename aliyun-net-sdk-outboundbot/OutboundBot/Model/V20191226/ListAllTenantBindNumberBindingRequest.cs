...
{
    public class ListAllTenantBindNumberBindingRequest : RpcAcsRequest<ListAllTenantBindNumberBindingResponse>
    {
        public ListAllTenantBindNumberBindingRequest()
            : base("OutboundBot", "2019-12-26", "ListAllTenantBindNumberBinding", "outboundbot", "openAPI")
        {
        ...
        public override ListAllTenantBindNumberBindingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAllTenantBindNumberBindingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
