...
{
    public class SaveContactWhiteListRequest : RpcAcsRequest<SaveContactWhiteListResponse>
    {
        public SaveContactWhiteListRequest()
            : base("OutboundBot", "2019-12-26", "SaveContactWhiteList", "outboundbot", "openAPI")
        {
		...
		private List<string> contactWhiteListLists = new List<string>(){ };

		private string contactWhiteListsJson;

		private string instanceId;

		public List<string> ContactWhiteListLists
		{
			get
			{
				return contactWhiteListLists;
			}
		...
		public string ContactWhiteListsJson
		{
			...
			set	
			{
				contactWhiteListsJson = value;
				DictionaryUtil.Add(QueryParameters, "ContactWhiteListsJson", value);
			}
		}
        ...
        public override SaveContactWhiteListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveContactWhiteListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
