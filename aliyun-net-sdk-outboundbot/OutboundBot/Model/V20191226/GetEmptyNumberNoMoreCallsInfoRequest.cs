...
{
    public class GetEmptyNumberNoMoreCallsInfoRequest : RpcAcsRequest<GetEmptyNumberNoMoreCallsInfoResponse>
    {
        public GetEmptyNumberNoMoreCallsInfoRequest()
            : base("OutboundBot", "2019-12-26", "GetEmptyNumberNoMoreCallsInfo", "outboundbot", "openAPI")
        {
        ...
        public override GetEmptyNumberNoMoreCallsInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEmptyNumberNoMoreCallsInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
