...
{
    public class CreateJobGroupExportTaskRequest : RpcAcsRequest<CreateJobGroupExportTaskResponse>
    {
        public CreateJobGroupExportTaskRequest()
            : base("OutboundBot", "2019-12-26", "CreateJobGroupExportTask", "outboundbot", "openAPI")
        {
        ...
        public override CreateJobGroupExportTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateJobGroupExportTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
