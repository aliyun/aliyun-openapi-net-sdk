...
{
    public class DescribeIntentStatisticsRequest : RpcAcsRequest<DescribeIntentStatisticsResponse>
    {
        public DescribeIntentStatisticsRequest()
            : base("OutboundBot", "2019-12-26", "DescribeIntentStatistics", "outboundbot", "openAPI")
        {
        ...
        public override DescribeIntentStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeIntentStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
