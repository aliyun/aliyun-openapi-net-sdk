...
{
    public class CreateNumberDistrictInfoParsingTaskRequest : RpcAcsRequest<CreateNumberDistrictInfoParsingTaskResponse>
    {
        public CreateNumberDistrictInfoParsingTaskRequest()
            : base("OutboundBot", "2019-12-26", "CreateNumberDistrictInfoParsingTask", "outboundbot", "openAPI")
        {
        ...
        public override CreateNumberDistrictInfoParsingTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateNumberDistrictInfoParsingTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
