...
{
    public class CreateInstanceBindNumberRequest : RpcAcsRequest<CreateInstanceBindNumberResponse>
    {
        public CreateInstanceBindNumberRequest()
            : base("OutboundBot", "2019-12-26", "CreateInstanceBindNumber", "outboundbot", "openAPI")
        {
		...
		public string InstanceList
		{
			...
			{
				instanceList = value;
				DictionaryUtil.Add(QueryParameters, "InstanceList", value);
			}
		}
        ...
        public override CreateInstanceBindNumberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateInstanceBindNumberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
