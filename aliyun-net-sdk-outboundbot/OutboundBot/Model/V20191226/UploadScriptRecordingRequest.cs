...
{
    public class UploadScriptRecordingRequest : RpcAcsRequest<UploadScriptRecordingResponse>
    {
        public UploadScriptRecordingRequest()
            : base("OutboundBot", "2019-12-26", "UploadScriptRecording")
        {
        ...
        public override UploadScriptRecordingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadScriptRecordingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
