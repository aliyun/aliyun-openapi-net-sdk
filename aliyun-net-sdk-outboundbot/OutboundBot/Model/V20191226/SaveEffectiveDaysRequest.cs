...
{
    public class SaveEffectiveDaysRequest : RpcAcsRequest<SaveEffectiveDaysResponse>
    {
        public SaveEffectiveDaysRequest()
            : base("OutboundBot", "2019-12-26", "SaveEffectiveDays", "outboundbot", "openAPI")
        {
		...
		public int? EffectiveDays
		{
			...
			{
				effectiveDays = value;
				DictionaryUtil.Add(QueryParameters, "EffectiveDays", value.ToString());
			}
		}
        ...
        public override SaveEffectiveDaysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveEffectiveDaysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
