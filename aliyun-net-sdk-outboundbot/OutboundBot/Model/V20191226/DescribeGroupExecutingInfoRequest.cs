...
{
    public class DescribeGroupExecutingInfoRequest : RpcAcsRequest<DescribeGroupExecutingInfoResponse>
    {
        public DescribeGroupExecutingInfoRequest()
            : base("OutboundBot", "2019-12-26", "DescribeGroupExecutingInfo", "outboundbot", "openAPI")
        {
        ...
        public override DescribeGroupExecutingInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGroupExecutingInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
