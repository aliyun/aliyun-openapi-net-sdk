...
{
    public class DownloadScriptRecordingRequest : RpcAcsRequest<DownloadScriptRecordingResponse>
    {
        public DownloadScriptRecordingRequest()
            : base("OutboundBot", "2019-12-26", "DownloadScriptRecording")
        {
        ...
        public override DownloadScriptRecordingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DownloadScriptRecordingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
