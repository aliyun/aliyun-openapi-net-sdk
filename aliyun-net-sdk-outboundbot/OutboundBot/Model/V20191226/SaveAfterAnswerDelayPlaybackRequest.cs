...
{
    public class SaveAfterAnswerDelayPlaybackRequest : RpcAcsRequest<SaveAfterAnswerDelayPlaybackResponse>
    {
        public SaveAfterAnswerDelayPlaybackRequest()
            : base("OutboundBot", "2019-12-26", "SaveAfterAnswerDelayPlayback", "outboundbot", "openAPI")
        {
		...
		private int? afterAnswerDelayPlayback;
		...
		public int? AfterAnswerDelayPlayback
		{
			get
			{
			...
			set	
			{
				afterAnswerDelayPlayback = value;
				DictionaryUtil.Add(QueryParameters, "AfterAnswerDelayPlayback", value.ToString());
			}
		}

        public override SaveAfterAnswerDelayPlaybackResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveAfterAnswerDelayPlaybackResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
