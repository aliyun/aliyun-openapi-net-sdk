...
{
    public class SaveMaxAttemptsPerDayRequest : RpcAcsRequest<SaveMaxAttemptsPerDayResponse>
    {
        public SaveMaxAttemptsPerDayRequest()
            : base("OutboundBot", "2019-12-26", "SaveMaxAttemptsPerDay", "outboundbot", "openAPI")
        {
		...
		public int? MaxAttemptsPerDay
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MaxAttemptsPerDay", value.ToString());
			}
		}
        ...
        public override SaveMaxAttemptsPerDayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveMaxAttemptsPerDayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
