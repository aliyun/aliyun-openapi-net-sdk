...
{
    public class DeleteContactWhiteListRequest : RpcAcsRequest<DeleteContactWhiteListResponse>
    {
        public DeleteContactWhiteListRequest()
            : base("OutboundBot", "2019-12-26", "DeleteContactWhiteList", "outboundbot", "openAPI")
        {
		...
		public string ContactWhiteListId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ContactWhiteListId", value);
			}
		}

        public override DeleteContactWhiteListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteContactWhiteListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
