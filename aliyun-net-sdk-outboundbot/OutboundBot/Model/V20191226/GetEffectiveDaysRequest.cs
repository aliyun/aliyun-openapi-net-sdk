...
{
    public class GetEffectiveDaysRequest : RpcAcsRequest<GetEffectiveDaysResponse>
    {
        public GetEffectiveDaysRequest()
            : base("OutboundBot", "2019-12-26", "GetEffectiveDays", "outboundbot", "openAPI")
        {
        ...
        public override GetEffectiveDaysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEffectiveDaysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
