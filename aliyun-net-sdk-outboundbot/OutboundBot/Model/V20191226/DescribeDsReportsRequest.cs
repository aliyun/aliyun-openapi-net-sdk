...
{
    public class DescribeDsReportsRequest : RpcAcsRequest<DescribeDsReportsResponse>
    {
        public DescribeDsReportsRequest()
            : base("OutboundBot", "2019-12-26", "DescribeDsReports", "outboundbot", "openAPI")
        {
        ...
        public override DescribeDsReportsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDsReportsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
