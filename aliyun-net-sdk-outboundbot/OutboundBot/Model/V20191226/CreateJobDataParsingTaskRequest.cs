...
{
    public class CreateJobDataParsingTaskRequest : RpcAcsRequest<CreateJobDataParsingTaskResponse>
    {
        public CreateJobDataParsingTaskRequest()
            : base("OutboundBot", "2019-12-26", "CreateJobDataParsingTask", "outboundbot", "openAPI")
        {
        ...
        public override CreateJobDataParsingTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateJobDataParsingTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
