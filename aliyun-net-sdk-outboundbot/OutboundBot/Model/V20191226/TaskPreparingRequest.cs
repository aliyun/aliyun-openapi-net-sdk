...
{
    public class TaskPreparingRequest : RpcAcsRequest<TaskPreparingResponse>
    {
        public TaskPreparingRequest()
            : base("OutboundBot", "2019-12-26", "TaskPreparing", "outboundbot", "openAPI")
        {
        ...
        public override TaskPreparingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TaskPreparingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
