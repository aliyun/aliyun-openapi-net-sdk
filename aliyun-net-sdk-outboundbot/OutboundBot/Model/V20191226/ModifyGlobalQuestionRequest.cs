...
{
    public class ModifyGlobalQuestionRequest : RpcAcsRequest<ModifyGlobalQuestionResponse>
    {
        public ModifyGlobalQuestionRequest()
            : base("OutboundBot", "2019-12-26", "ModifyGlobalQuestion", "outboundbot", "openAPI")
        {
        ...
        public override ModifyGlobalQuestionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGlobalQuestionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
