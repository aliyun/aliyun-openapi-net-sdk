...
{
    public class InflightTaskTimeoutRequest : RpcAcsRequest<InflightTaskTimeoutResponse>
    {
        public InflightTaskTimeoutRequest()
            : base("OutboundBot", "2019-12-26", "InflightTaskTimeout", "outboundbot", "openAPI")
        {
        ...
        public override InflightTaskTimeoutResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InflightTaskTimeoutResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
