...
{
    public class GetVersionRequest : RpcAcsRequest<GetVersionResponse>
    {
        public GetVersionRequest()
            : base("OutboundBot", "2019-12-26", "GetVersion", "outboundbot", "openAPI")
        {
        ...
        public override GetVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
