...
{
    public class ListScriptRecordingRequest : RpcAcsRequest<ListScriptRecordingResponse>
    {
        public ListScriptRecordingRequest()
            : base("OutboundBot", "2019-12-26", "ListScriptRecording")
        {
		...
		public string UuidsJson
		{
			...
			{
				uuidsJson = value;
				DictionaryUtil.Add(QueryParameters, "UuidsJson", value);
			}
		}
		...
		public string StatesJson
		{
			...
			{
				statesJson = value;
				DictionaryUtil.Add(QueryParameters, "StatesJson", value);
			}
		}
        ...
        public override ListScriptRecordingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListScriptRecordingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
