...
{
    public class ApplyNumberDistrictInfoParsingResultRequest : RpcAcsRequest<ApplyNumberDistrictInfoParsingResultResponse>
    {
        public ApplyNumberDistrictInfoParsingResultRequest()
            : base("OutboundBot", "2019-12-26", "ApplyNumberDistrictInfoParsingResult", "outboundbot", "openAPI")
        {
        ...
        public override ApplyNumberDistrictInfoParsingResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ApplyNumberDistrictInfoParsingResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
