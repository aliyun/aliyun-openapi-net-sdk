...
namespace Aliyun.Acs.Edas.Transform.V20170801
{
    public class StopApplicationResponseUnmarshaller
    {
        public static StopApplicationResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			stopApplicationResponse.ChangeOrderId = _ctx.StringValue("StopApplication.ChangeOrderId");
			stopApplicationResponse.Code = _ctx.IntegerValue("StopApplication.Code");
