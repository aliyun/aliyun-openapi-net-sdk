...
{
    public class DeleteClusterMemberRequest : RoaAcsRequest<DeleteClusterMemberResponse>
    {
        public DeleteClusterMemberRequest()
            : base("Edas", "2017-08-01", "DeleteClusterMember", "Edas", "openAPI")
        {
		...
		public string ClusterMemberId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ClusterMemberId", value);
			}
		}
        ...
        public override DeleteClusterMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteClusterMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
