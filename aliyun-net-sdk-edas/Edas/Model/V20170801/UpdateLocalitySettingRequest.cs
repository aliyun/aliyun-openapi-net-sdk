...
{
    public class UpdateLocalitySettingRequest : RoaAcsRequest<UpdateLocalitySettingResponse>
    {
        public UpdateLocalitySettingRequest()
            : base("Edas", "2017-08-01", "UpdateLocalitySetting", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/applications/locality/setting";
        ...
        public override UpdateLocalitySettingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateLocalitySettingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
