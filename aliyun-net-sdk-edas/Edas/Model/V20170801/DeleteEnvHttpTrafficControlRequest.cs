...
{
    public class DeleteEnvHttpTrafficControlRequest : RoaAcsRequest<DeleteEnvHttpTrafficControlResponse>
    {
        public DeleteEnvHttpTrafficControlRequest()
            : base("Edas", "2017-08-01", "DeleteEnvHttpTrafficControl", "Edas", "openAPI")
        {
        ...
        public override DeleteEnvHttpTrafficControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEnvHttpTrafficControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
