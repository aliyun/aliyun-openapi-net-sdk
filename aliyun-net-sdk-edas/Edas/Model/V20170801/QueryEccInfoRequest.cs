...
{
    public class QueryEccInfoRequest : RoaAcsRequest<QueryEccInfoResponse>
    {
        public QueryEccInfoRequest()
            : base("Edas", "2017-08-01", "QueryEccInfo", "Edas", "openAPI")
        {
        ...
        public override QueryEccInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryEccInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
