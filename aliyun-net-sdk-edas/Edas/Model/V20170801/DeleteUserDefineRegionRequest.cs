...
{
    public class DeleteUserDefineRegionRequest : RoaAcsRequest<DeleteUserDefineRegionResponse>
    {
        public DeleteUserDefineRegionRequest()
            : base("Edas", "2017-08-01", "DeleteUserDefineRegion", "Edas", "openAPI")
        {
        ...
        public override DeleteUserDefineRegionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteUserDefineRegionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
