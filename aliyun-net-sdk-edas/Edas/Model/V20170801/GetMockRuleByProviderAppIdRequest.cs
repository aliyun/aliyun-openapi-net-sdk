...
{
    public class GetMockRuleByProviderAppIdRequest : RoaAcsRequest<GetMockRuleByProviderAppIdResponse>
    {
        public GetMockRuleByProviderAppIdRequest()
            : base("Edas", "2017-08-01", "GetMockRuleByProviderAppId", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mock/getMockRuleByProviderAppId";
        ...
        public override GetMockRuleByProviderAppIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMockRuleByProviderAppIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
