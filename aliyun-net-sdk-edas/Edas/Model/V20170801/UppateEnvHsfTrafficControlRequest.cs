...
{
    public class UppateEnvHsfTrafficControlRequest : RoaAcsRequest<UppateEnvHsfTrafficControlResponse>
    {
        public UppateEnvHsfTrafficControlRequest()
            : base("Edas", "2017-08-01", "UppateEnvHsfTrafficControl", "Edas", "openAPI")
        {
		...
		public string ParamTypes
		{
			...
			{
				paramTypes = value;
				DictionaryUtil.Add(BodyParameters, "ParamTypes", value);
			}
		}
        ...
        public override UppateEnvHsfTrafficControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UppateEnvHsfTrafficControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
