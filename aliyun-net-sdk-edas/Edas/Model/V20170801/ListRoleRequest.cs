...
{
    public class ListRoleRequest : RoaAcsRequest<ListRoleResponse>
    {
        public ListRoleRequest()
            : base("Edas", "2017-08-01", "ListRole", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/account/role_list";
			Method = MethodType.POST;
        }

        public override ListRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
