...
{
    public class CreateEnvHsfTrafficControlRequest : RoaAcsRequest<CreateEnvHsfTrafficControlResponse>
    {
        public CreateEnvHsfTrafficControlRequest()
            : base("Edas", "2017-08-01", "CreateEnvHsfTrafficControl", "Edas", "openAPI")
        {
        ...
        public override CreateEnvHsfTrafficControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateEnvHsfTrafficControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
