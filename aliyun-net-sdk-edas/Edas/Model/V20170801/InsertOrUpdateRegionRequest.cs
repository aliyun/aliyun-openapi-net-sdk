...
{
    public class InsertOrUpdateRegionRequest : RoaAcsRequest<InsertOrUpdateRegionResponse>
    {
        public InsertOrUpdateRegionRequest()
            : base("Edas", "2017-08-01", "InsertOrUpdateRegion", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/user_region_def";
        ...
        public override InsertOrUpdateRegionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertOrUpdateRegionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
