...
{
    public class ListEcuByRegionRequest : RoaAcsRequest<ListEcuByRegionResponse>
    {
        public ListEcuByRegionRequest()
            : base("Edas", "2017-08-01", "ListEcuByRegion", "Edas", "openAPI")
        {
        ...
        public override ListEcuByRegionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListEcuByRegionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
