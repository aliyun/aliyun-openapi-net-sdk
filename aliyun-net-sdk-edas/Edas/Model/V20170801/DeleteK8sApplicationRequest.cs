...
{
    public class DeleteK8sApplicationRequest : RoaAcsRequest<DeleteK8sApplicationResponse>
    {
        public DeleteK8sApplicationRequest()
            : base("Edas", "2017-08-01", "DeleteK8sApplication", "Edas", "openAPI")
        {
        ...
        public override DeleteK8sApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteK8sApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
