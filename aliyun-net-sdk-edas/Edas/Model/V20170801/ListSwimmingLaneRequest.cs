...
{
    public class ListSwimmingLaneRequest : RoaAcsRequest<ListSwimmingLaneResponse>
    {
        public ListSwimmingLaneRequest()
            : base("Edas", "2017-08-01", "ListSwimmingLane", "Edas", "openAPI")
        {
        ...
        public override ListSwimmingLaneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSwimmingLaneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
