...
{
    public class DisableDegradeControlRequest : RoaAcsRequest<DisableDegradeControlResponse>
    {
        public DisableDegradeControlRequest()
            : base("Edas", "2017-08-01", "DisableDegradeControl", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/degradecontrol/disable";
        ...
        public override DisableDegradeControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableDegradeControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
