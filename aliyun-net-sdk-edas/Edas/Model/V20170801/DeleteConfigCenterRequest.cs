...
{
    public class DeleteConfigCenterRequest : RoaAcsRequest<DeleteConfigCenterResponse>
    {
        public DeleteConfigCenterRequest()
            : base("Edas", "2017-08-01", "DeleteConfigCenter", "Edas", "openAPI")
        {
        ...
        public override DeleteConfigCenterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteConfigCenterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
