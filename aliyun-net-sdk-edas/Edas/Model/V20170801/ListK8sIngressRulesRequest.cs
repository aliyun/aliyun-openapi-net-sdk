...
{
    public class ListK8sIngressRulesRequest : RoaAcsRequest<ListK8sIngressRulesResponse>
    {
        public ListK8sIngressRulesRequest()
            : base("Edas", "2017-08-01", "ListK8sIngressRules", "Edas", "openAPI")
        {
        ...
        public override ListK8sIngressRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListK8sIngressRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
