...
{
    public class UpdateEnvHttpTrafficControlRequest : RoaAcsRequest<UpdateEnvHttpTrafficControlResponse>
    {
        public UpdateEnvHttpTrafficControlRequest()
            : base("Edas", "2017-08-01", "UpdateEnvHttpTrafficControl", "Edas", "openAPI")
        {
        ...
        public override UpdateEnvHttpTrafficControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEnvHttpTrafficControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
