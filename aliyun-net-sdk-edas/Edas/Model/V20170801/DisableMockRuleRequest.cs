...
{
    public class DisableMockRuleRequest : RoaAcsRequest<DisableMockRuleResponse>
    {
        public DisableMockRuleRequest()
            : base("Edas", "2017-08-01", "DisableMockRule", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mock/disableMockRule";
        ...
        public override DisableMockRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableMockRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
