...
{
    public class QueryConfigCenterRequest : RoaAcsRequest<QueryConfigCenterResponse>
    {
        public QueryConfigCenterRequest()
            : base("Edas", "2017-08-01", "QueryConfigCenter", "Edas", "openAPI")
        {
        ...
        public override QueryConfigCenterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryConfigCenterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
