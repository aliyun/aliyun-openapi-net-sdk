...
namespace Aliyun.Acs.Edas.Model.V20170801
{
	public class UpdateApplicationScalingRuleResponse : AcsResponse
	{
		...
		private UpdateApplicationScalingRule_AppScalingRule appScalingRule;
		...
		public UpdateApplicationScalingRule_AppScalingRule AppScalingRule
		{
			get
			{
		...
		public class UpdateApplicationScalingRule_AppScalingRule
		{
			...
			private UpdateApplicationScalingRule_Trigger trigger;
			...
			public UpdateApplicationScalingRule_Trigger Trigger
			{
				get
				{
					return trigger;
			...
			public class UpdateApplicationScalingRule_Trigger
			{
				...
				private List<UpdateApplicationScalingRule_Trigger2> triggers;
				...
				public List<UpdateApplicationScalingRule_Trigger2> Triggers
				{
					get
					{
						return triggers;
				...
				public class UpdateApplicationScalingRule_Trigger2
				{
