...
{
    public class DeleteDegradeControlRequest : RoaAcsRequest<DeleteDegradeControlResponse>
    {
        public DeleteDegradeControlRequest()
            : base("Edas", "2017-08-01", "DeleteDegradeControl", "Edas", "openAPI")
        {
        ...
        public override DeleteDegradeControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDegradeControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
