...
{
    public class ListVpcRequest : RoaAcsRequest<ListVpcResponse>
    {
        public ListVpcRequest()
            : base("Edas", "2017-08-01", "ListVpc", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/vpc_list";
			Method = MethodType.GET;
        }

        public override ListVpcResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVpcResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
