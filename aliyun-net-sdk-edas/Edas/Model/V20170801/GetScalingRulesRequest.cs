...
{
    public class GetScalingRulesRequest : RoaAcsRequest<GetScalingRulesResponse>
    {
        public GetScalingRulesRequest()
            : base("Edas", "2017-08-01", "GetScalingRules", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/app/scalingRules";
        ...
        public override GetScalingRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetScalingRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
