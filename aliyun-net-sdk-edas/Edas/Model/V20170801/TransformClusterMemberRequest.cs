...
{
    public class TransformClusterMemberRequest : RoaAcsRequest<TransformClusterMemberResponse>
    {
        public TransformClusterMemberRequest()
            : base("Edas", "2017-08-01", "TransformClusterMember", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/resource/transform_cluster_member";
        ...
        public override TransformClusterMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TransformClusterMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
