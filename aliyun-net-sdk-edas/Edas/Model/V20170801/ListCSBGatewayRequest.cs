...
{
    public class ListCSBGatewayRequest : RoaAcsRequest<ListCSBGatewayResponse>
    {
        public ListCSBGatewayRequest()
            : base("Edas", "2017-08-01", "ListCSBGateway", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/csbgateway/gateway";
        ...
        public override ListCSBGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCSBGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
