...
{
    public class DeleteGrayEnvironmentRequest : RoaAcsRequest<DeleteGrayEnvironmentResponse>
    {
        public DeleteGrayEnvironmentRequest()
            : base("Edas", "2017-08-01", "DeleteGrayEnvironment", "Edas", "openAPI")
        {
        ...
        public override DeleteGrayEnvironmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGrayEnvironmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
