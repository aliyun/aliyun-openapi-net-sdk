...
{
    public class GetServiceListPageRequest : RoaAcsRequest<GetServiceListPageResponse>
    {
        public GetServiceListPageRequest()
            : base("Edas", "2017-08-01", "GetServiceListPage", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mseForOam/getServiceListPage";
        ...
        public override GetServiceListPageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceListPageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
