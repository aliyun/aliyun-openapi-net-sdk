...
{
    public class CreateIDCImportCommandRequest : RoaAcsRequest<CreateIDCImportCommandResponse>
    {
        public CreateIDCImportCommandRequest()
            : base("Edas", "2017-08-01", "CreateIDCImportCommand", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/create_idc_import_command";
        ...
        public override CreateIDCImportCommandResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateIDCImportCommandResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
