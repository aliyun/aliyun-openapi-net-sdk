...
{
    public class QueryMigrateRegionListRequest : RoaAcsRequest<QueryMigrateRegionListResponse>
    {
        public QueryMigrateRegionListRequest()
            : base("Edas", "2017-08-01", "QueryMigrateRegionList", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/resource/migrate_region_select";
        ...
        public override QueryMigrateRegionListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMigrateRegionListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
