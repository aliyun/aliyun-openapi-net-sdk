...
{
    public class AddLogPathRequest : RoaAcsRequest<AddLogPathResponse>
    {
        public AddLogPathRequest()
            : base("Edas", "2017-08-01", "AddLogPath", "Edas", "openAPI")
        {
        ...
        public override AddLogPathResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddLogPathResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
