...
{
    public class EnableFlowControlRequest : RoaAcsRequest<EnableFlowControlResponse>
    {
        public EnableFlowControlRequest()
            : base("Edas", "2017-08-01", "EnableFlowControl", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/flowcontrol/enable";
        ...
        public override EnableFlowControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableFlowControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
