...
{
    public class InsertConfigCenterRequest : RoaAcsRequest<InsertConfigCenterResponse>
    {
        public InsertConfigCenterRequest()
            : base("Edas", "2017-08-01", "InsertConfigCenter", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/configCenter";
        ...
        public override InsertConfigCenterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertConfigCenterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
