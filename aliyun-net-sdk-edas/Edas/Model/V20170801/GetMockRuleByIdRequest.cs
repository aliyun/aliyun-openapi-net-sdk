...
{
    public class GetMockRuleByIdRequest : RoaAcsRequest<GetMockRuleByIdResponse>
    {
        public GetMockRuleByIdRequest()
            : base("Edas", "2017-08-01", "GetMockRuleById", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mock/getMockRuleById";
        ...
        public override GetMockRuleByIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMockRuleByIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
