...
{
    public class ListOperationLogsRequest : RoaAcsRequest<ListOperationLogsResponse>
    {
        public ListOperationLogsRequest()
            : base("Edas", "2017-08-01", "ListOperationLogs", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/operationlog/log_list";
        ...
        public override ListOperationLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOperationLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
