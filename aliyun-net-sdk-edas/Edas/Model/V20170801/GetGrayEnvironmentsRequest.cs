...
{
    public class GetGrayEnvironmentsRequest : RoaAcsRequest<GetGrayEnvironmentsResponse>
    {
        public GetGrayEnvironmentsRequest()
            : base("Edas", "2017-08-01", "GetGrayEnvironments", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/gray/env_list";
        ...
        public override GetGrayEnvironmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGrayEnvironmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
