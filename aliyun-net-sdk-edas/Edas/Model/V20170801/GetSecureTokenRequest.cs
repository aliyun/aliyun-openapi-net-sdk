...
{
    public class GetSecureTokenRequest : RoaAcsRequest<GetSecureTokenResponse>
    {
        public GetSecureTokenRequest()
            : base("Edas", "2017-08-01", "GetSecureToken", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/secure_token";
        ...
        public override GetSecureTokenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSecureTokenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
