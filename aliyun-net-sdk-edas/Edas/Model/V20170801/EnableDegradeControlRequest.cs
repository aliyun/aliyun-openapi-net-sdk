...
{
    public class EnableDegradeControlRequest : RoaAcsRequest<EnableDegradeControlResponse>
    {
        public EnableDegradeControlRequest()
            : base("Edas", "2017-08-01", "EnableDegradeControl", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/degradecontrol/enable";
        ...
        public override EnableDegradeControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableDegradeControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
