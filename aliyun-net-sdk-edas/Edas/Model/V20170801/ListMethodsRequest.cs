...
{
    public class ListMethodsRequest : RoaAcsRequest<ListMethodsResponse>
    {
        public ListMethodsRequest()
            : base("Edas", "2017-08-01", "ListMethods", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/service/list_methods";
        ...
        public override ListMethodsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMethodsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
