...
{
    public class UpdateApplicationBaseInfoRequest : RoaAcsRequest<UpdateApplicationBaseInfoResponse>
    {
        public UpdateApplicationBaseInfoRequest()
            : base("Edas", "2017-08-01", "UpdateApplicationBaseInfo", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/app/update_app_info";
        ...
        public override UpdateApplicationBaseInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateApplicationBaseInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
