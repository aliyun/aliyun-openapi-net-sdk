...
{
    public class StopK8sApplicationRequest : RoaAcsRequest<StopK8sApplicationResponse>
    {
        public StopK8sApplicationRequest()
            : base("Edas", "2017-08-01", "StopK8sApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/k8s/acs/stop_k8s_app";
        ...
        public override StopK8sApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopK8sApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
