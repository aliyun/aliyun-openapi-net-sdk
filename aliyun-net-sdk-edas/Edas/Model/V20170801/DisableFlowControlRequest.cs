...
{
    public class DisableFlowControlRequest : RoaAcsRequest<DisableFlowControlResponse>
    {
        public DisableFlowControlRequest()
            : base("Edas", "2017-08-01", "DisableFlowControl", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/flowcontrol/disable";
        ...
        public override DisableFlowControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableFlowControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
