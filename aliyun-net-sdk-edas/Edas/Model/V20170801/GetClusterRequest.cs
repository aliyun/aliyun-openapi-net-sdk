...
{
    public class GetClusterRequest : RoaAcsRequest<GetClusterResponse>
    {
        public GetClusterRequest()
            : base("Edas", "2017-08-01", "GetCluster", "Edas", "openAPI")
        {
        ...
        public override GetClusterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetClusterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
