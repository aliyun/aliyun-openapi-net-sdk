...
{
    public class RestartK8sApplicationRequest : RoaAcsRequest<RestartK8sApplicationResponse>
    {
        public RestartK8sApplicationRequest()
            : base("Edas", "2017-08-01", "RestartK8sApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/k8s/acs/restart_k8s_app";
        ...
        public override RestartK8sApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestartK8sApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
