...
{
    public class GetSubAccountInfoRequest : RoaAcsRequest<GetSubAccountInfoResponse>
    {
        public GetSubAccountInfoRequest()
            : base("Edas", "2017-08-01", "GetSubAccountInfo", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/account/sub_account_info";
        ...
        public override GetSubAccountInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSubAccountInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
