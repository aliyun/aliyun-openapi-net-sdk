...
{
    public class ListStatusRequest : RoaAcsRequest<ListStatusResponse>
    {
        public ListStatusRequest()
            : base("Edas", "2017-08-01", "ListStatus", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mse/status/list";
        ...
        public override ListStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
