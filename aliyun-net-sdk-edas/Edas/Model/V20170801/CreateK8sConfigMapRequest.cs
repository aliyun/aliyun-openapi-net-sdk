...
{
    public class CreateK8sConfigMapRequest : RoaAcsRequest<CreateK8sConfigMapResponse>
    {
        public CreateK8sConfigMapRequest()
            : base("Edas", "2017-08-01", "CreateK8sConfigMap", "Edas", "openAPI")
        {
        ...
        public override CreateK8sConfigMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateK8sConfigMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
