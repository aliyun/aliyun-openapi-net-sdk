...
{
    public class DeleteLogPathRequest : RoaAcsRequest<DeleteLogPathResponse>
    {
        public DeleteLogPathRequest()
            : base("Edas", "2017-08-01", "DeleteLogPath", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/log/popListLogDirs";
        ...
        public override DeleteLogPathResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLogPathResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
