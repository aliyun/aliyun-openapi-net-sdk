...
{
    public class GetMockRuleByConsumerAppIdRequest : RoaAcsRequest<GetMockRuleByConsumerAppIdResponse>
    {
        public GetMockRuleByConsumerAppIdRequest()
            : base("Edas", "2017-08-01", "GetMockRuleByConsumerAppId", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mock/getMockRuleByConsumerAppId";
        ...
        public override GetMockRuleByConsumerAppIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMockRuleByConsumerAppIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
