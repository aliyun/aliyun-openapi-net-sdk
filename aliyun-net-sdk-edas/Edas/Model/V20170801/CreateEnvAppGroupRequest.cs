...
{
    public class CreateEnvAppGroupRequest : RoaAcsRequest<CreateEnvAppGroupResponse>
    {
        public CreateEnvAppGroupRequest()
            : base("Edas", "2017-08-01", "CreateEnvAppGroup", "Edas", "openAPI")
        {
        ...
        public override CreateEnvAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateEnvAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
