...
{
    public class ConvertK8sResourceRequest : RoaAcsRequest<ConvertK8sResourceResponse>
    {
        public ConvertK8sResourceRequest()
            : base("Edas", "2017-08-01", "ConvertK8sResource", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/oam/k8s_resource_convert";
        ...
        public override ConvertK8sResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConvertK8sResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
