...
{
    public class StartK8sApplicationRequest : RoaAcsRequest<StartK8sApplicationResponse>
    {
        public StartK8sApplicationRequest()
            : base("Edas", "2017-08-01", "StartK8sApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/k8s/acs/start_k8s_app";
        ...
        public override StartK8sApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartK8sApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
