...
{
    public class ResetApplicationRequest : RoaAcsRequest<ResetApplicationResponse>
    {
        public ResetApplicationRequest()
            : base("Edas", "2017-08-01", "ResetApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/changeorder/co_reset";
        ...
        public override ResetApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
