...
{
    public class DeleteK8sSecretRequest : RoaAcsRequest<DeleteK8sSecretResponse>
    {
        public DeleteK8sSecretRequest()
            : base("Edas", "2017-08-01", "DeleteK8sSecret", "Edas", "openAPI")
        {
        ...
        public override DeleteK8sSecretResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteK8sSecretResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
