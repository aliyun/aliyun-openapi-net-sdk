...
{
    public class DeleteFlowControlRequest : RoaAcsRequest<DeleteFlowControlResponse>
    {
        public DeleteFlowControlRequest()
            : base("Edas", "2017-08-01", "DeleteFlowControl", "Edas", "openAPI")
        {
        ...
        public override DeleteFlowControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFlowControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
