...
{
    public class DeleteK8sConfigMapRequest : RoaAcsRequest<DeleteK8sConfigMapResponse>
    {
        public DeleteK8sConfigMapRequest()
            : base("Edas", "2017-08-01", "DeleteK8sConfigMap", "Edas", "openAPI")
        {
        ...
        public override DeleteK8sConfigMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteK8sConfigMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
