...
{
    public class ListK8sSecretsRequest : RoaAcsRequest<ListK8sSecretsResponse>
    {
        public ListK8sSecretsRequest()
            : base("Edas", "2017-08-01", "ListK8sSecrets", "Edas", "openAPI")
        {
        ...
        public override ListK8sSecretsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListK8sSecretsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
