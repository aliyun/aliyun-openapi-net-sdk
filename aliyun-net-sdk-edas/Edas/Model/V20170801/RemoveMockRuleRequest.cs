...
{
    public class RemoveMockRuleRequest : RoaAcsRequest<RemoveMockRuleResponse>
    {
        public RemoveMockRuleRequest()
            : base("Edas", "2017-08-01", "RemoveMockRule", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mock/removeMockRule";
        ...
        public override RemoveMockRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveMockRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
