...
{
    public class GetSwimmingLaneRequest : RoaAcsRequest<GetSwimmingLaneResponse>
    {
        public GetSwimmingLaneRequest()
            : base("Edas", "2017-08-01", "GetSwimmingLane", "Edas", "openAPI")
        {
        ...
        public override GetSwimmingLaneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSwimmingLaneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
