...
{
	public class GetMockRuleByConsumerAppIdResponse : AcsResponse
	{
		...
		private List<GetMockRuleByConsumerAppId_RuleItemList> data;
		...
		public List<GetMockRuleByConsumerAppId_RuleItemList> Data
		{
			get
			{
				return data;
		...
		public class GetMockRuleByConsumerAppId_RuleItemList
		{
