...
{
    public class DelegateAdminRoleRequest : RoaAcsRequest<DelegateAdminRoleResponse>
    {
        public DelegateAdminRoleRequest()
            : base("Edas", "2017-08-01", "DelegateAdminRole", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/account/delegate_admin_role";
        ...
        public override DelegateAdminRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DelegateAdminRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
