...
{
    public class ListApplicationRequest : RoaAcsRequest<ListApplicationResponse>
    {
        public ListApplicationRequest()
            : base("Edas", "2017-08-01", "ListApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/app/app_list";
		...
		public string LogicalRegionIdFilter
		{
			...
			set	
			{
				logicalRegionIdFilter = value;
				DictionaryUtil.Add(QueryParameters, "LogicalRegionIdFilter", value);
			}
		}

        public override ListApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
