...
{
    public class UnbindK8sSlbRequest : RoaAcsRequest<UnbindK8sSlbResponse>
    {
        public UnbindK8sSlbRequest()
            : base("Edas", "2017-08-01", "UnbindK8sSlb", "Edas", "openAPI")
        {
        ...
        public override UnbindK8sSlbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindK8sSlbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
