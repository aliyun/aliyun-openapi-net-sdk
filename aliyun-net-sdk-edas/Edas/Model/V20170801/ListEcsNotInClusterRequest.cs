...
{
    public class ListEcsNotInClusterRequest : RoaAcsRequest<ListEcsNotInClusterResponse>
    {
        public ListEcsNotInClusterRequest()
            : base("Edas", "2017-08-01", "ListEcsNotInCluster", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/resource/ecs_not_in_cluster";
        ...
        public override ListEcsNotInClusterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListEcsNotInClusterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
