...
{
    public class GetServiceProvidersPageRequest : RoaAcsRequest<GetServiceProvidersPageResponse>
    {
        public GetServiceProvidersPageRequest()
            : base("Edas", "2017-08-01", "GetServiceProvidersPage", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mseForOam/getServiceProvidersPage";
        ...
        public override GetServiceProvidersPageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceProvidersPageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
