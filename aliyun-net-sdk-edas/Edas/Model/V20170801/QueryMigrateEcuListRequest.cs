...
{
    public class QueryMigrateEcuListRequest : RoaAcsRequest<QueryMigrateEcuListResponse>
    {
        public QueryMigrateEcuListRequest()
            : base("Edas", "2017-08-01", "QueryMigrateEcuList", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/resource/migrate_ecu_list";
        ...
        public override QueryMigrateEcuListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMigrateEcuListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
