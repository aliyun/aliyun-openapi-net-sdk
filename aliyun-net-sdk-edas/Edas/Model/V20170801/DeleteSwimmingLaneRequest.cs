...
{
    public class DeleteSwimmingLaneRequest : RoaAcsRequest<DeleteSwimmingLaneResponse>
    {
        public DeleteSwimmingLaneRequest()
            : base("Edas", "2017-08-01", "DeleteSwimmingLane", "Edas", "openAPI")
        {
        ...
        public override DeleteSwimmingLaneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSwimmingLaneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
