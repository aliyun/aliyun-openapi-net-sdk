...
{
    public class InsertSwimmingLaneGroupRequest : RoaAcsRequest<InsertSwimmingLaneGroupResponse>
    {
        public InsertSwimmingLaneGroupRequest()
            : base("Edas", "2017-08-01", "InsertSwimmingLaneGroup", "Edas", "openAPI")
        {
        ...
        public override InsertSwimmingLaneGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertSwimmingLaneGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
