...
{
    public class EnableMockRuleRequest : RoaAcsRequest<EnableMockRuleResponse>
    {
        public EnableMockRuleRequest()
            : base("Edas", "2017-08-01", "EnableMockRule", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mock/enableMockRule";
        ...
        public override EnableMockRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableMockRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
