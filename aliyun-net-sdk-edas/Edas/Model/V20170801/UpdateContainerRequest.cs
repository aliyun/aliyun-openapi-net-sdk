...
{
    public class UpdateContainerRequest : RoaAcsRequest<UpdateContainerResponse>
    {
        public UpdateContainerRequest()
            : base("Edas", "2017-08-01", "UpdateContainer", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/changeorder/co_update_container";
        ...
        public override UpdateContainerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateContainerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
