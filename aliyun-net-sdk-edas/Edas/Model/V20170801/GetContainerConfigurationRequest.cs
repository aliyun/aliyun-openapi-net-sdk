...
{
    public class GetContainerConfigurationRequest : RoaAcsRequest<GetContainerConfigurationResponse>
    {
        public GetContainerConfigurationRequest()
            : base("Edas", "2017-08-01", "GetContainerConfiguration", "Edas", "openAPI")
        {
        ...
        public override GetContainerConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetContainerConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
