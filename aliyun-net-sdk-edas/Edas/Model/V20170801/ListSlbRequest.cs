...
{
    public class ListSlbRequest : RoaAcsRequest<ListSlbResponse>
    {
        public ListSlbRequest()
            : base("Edas", "2017-08-01", "ListSlb", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/slb_list";
			Method = MethodType.GET;
        }

        public override ListSlbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSlbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
