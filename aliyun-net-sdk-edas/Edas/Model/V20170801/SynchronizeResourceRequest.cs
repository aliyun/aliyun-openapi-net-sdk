...
{
    public class SynchronizeResourceRequest : RoaAcsRequest<SynchronizeResourceResponse>
    {
        public SynchronizeResourceRequest()
            : base("Edas", "2017-08-01", "SynchronizeResource", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/resource/pop_sync_resource";
        ...
        public override SynchronizeResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SynchronizeResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
