...
{
    public class InstallAgentRequest : RoaAcsRequest<InstallAgentResponse>
    {
        public InstallAgentRequest()
            : base("Edas", "2017-08-01", "InstallAgent", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/ecss/install_agent";
		...
		public bool? DoAsync
		{
			...
			{
				doAsync = value;
				DictionaryUtil.Add(QueryParameters, "DoAsync", value.ToString());
			}
		}
        ...
        public override InstallAgentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InstallAgentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
