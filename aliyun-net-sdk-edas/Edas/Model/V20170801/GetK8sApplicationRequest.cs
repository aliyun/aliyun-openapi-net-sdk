...
{
    public class GetK8sApplicationRequest : RoaAcsRequest<GetK8sApplicationResponse>
    {
        public GetK8sApplicationRequest()
            : base("Edas", "2017-08-01", "GetK8sApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/changeorder/co_application";
        ...
        public override GetK8sApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetK8sApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
