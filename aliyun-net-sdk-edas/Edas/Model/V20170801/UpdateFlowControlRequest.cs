...
{
    public class UpdateFlowControlRequest : RoaAcsRequest<UpdateFlowControlResponse>
    {
        public UpdateFlowControlRequest()
            : base("Edas", "2017-08-01", "UpdateFlowControl", "Edas", "openAPI")
        {
        ...
        public override UpdateFlowControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateFlowControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
