...
{
    public class GetGrayAppGroupRequest : RoaAcsRequest<GetGrayAppGroupResponse>
    {
        public GetGrayAppGroupRequest()
            : base("Edas", "2017-08-01", "GetGrayAppGroup", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/gray/app_group_list";
        ...
        public override GetGrayAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGrayAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
