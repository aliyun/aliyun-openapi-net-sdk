...
{
    public class AuthorizeApplicationRequest : RoaAcsRequest<AuthorizeApplicationResponse>
    {
        public AuthorizeApplicationRequest()
            : base("Edas", "2017-08-01", "AuthorizeApplication", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/account/authorize_app";
        ...
        public override AuthorizeApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AuthorizeApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
