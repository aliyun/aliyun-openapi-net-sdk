...
{
    public class UpdateEnvAppGroupRequest : RoaAcsRequest<UpdateEnvAppGroupResponse>
    {
        public UpdateEnvAppGroupRequest()
            : base("Edas", "2017-08-01", "UpdateEnvAppGroup", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/gray/env_app_groups";
		...
		public string Scopes
		{
			...
			{
				scopes = value;
				DictionaryUtil.Add(BodyParameters, "Scopes", value);
			}
		}
        ...
        public override UpdateEnvAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEnvAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
