...
{
    public class InsertDegradeControlRequest : RoaAcsRequest<InsertDegradeControlResponse>
    {
        public InsertDegradeControlRequest()
            : base("Edas", "2017-08-01", "InsertDegradeControl", "Edas", "openAPI")
        {
        ...
        public override InsertDegradeControlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertDegradeControlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
