...
{
    public class UpdateK8sConfigMapRequest : RoaAcsRequest<UpdateK8sConfigMapResponse>
    {
        public UpdateK8sConfigMapRequest()
            : base("Edas", "2017-08-01", "UpdateK8sConfigMap", "Edas", "openAPI")
        {
        ...
        public override UpdateK8sConfigMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateK8sConfigMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
