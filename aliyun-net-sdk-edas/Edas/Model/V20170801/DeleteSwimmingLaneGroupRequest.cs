...
{
    public class DeleteSwimmingLaneGroupRequest : RoaAcsRequest<DeleteSwimmingLaneGroupResponse>
    {
        public DeleteSwimmingLaneGroupRequest()
            : base("Edas", "2017-08-01", "DeleteSwimmingLaneGroup", "Edas", "openAPI")
        {
        ...
        public override DeleteSwimmingLaneGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSwimmingLaneGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
