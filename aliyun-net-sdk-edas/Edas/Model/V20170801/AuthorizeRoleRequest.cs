...
{
    public class AuthorizeRoleRequest : RoaAcsRequest<AuthorizeRoleResponse>
    {
        public AuthorizeRoleRequest()
            : base("Edas", "2017-08-01", "AuthorizeRole", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/account/authorize_role";
        ...
        public override AuthorizeRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AuthorizeRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
