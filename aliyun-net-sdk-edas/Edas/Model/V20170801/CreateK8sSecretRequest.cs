...
{
    public class CreateK8sSecretRequest : RoaAcsRequest<CreateK8sSecretResponse>
    {
        public CreateK8sSecretRequest()
            : base("Edas", "2017-08-01", "CreateK8sSecret", "Edas", "openAPI")
        {
        ...
        public override CreateK8sSecretResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateK8sSecretResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
