...
{
    public class ListSwimmingLaneGroupRequest : RoaAcsRequest<ListSwimmingLaneGroupResponse>
    {
        public ListSwimmingLaneGroupRequest()
            : base("Edas", "2017-08-01", "ListSwimmingLaneGroup", "Edas", "openAPI")
        {
        ...
        public override ListSwimmingLaneGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSwimmingLaneGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
