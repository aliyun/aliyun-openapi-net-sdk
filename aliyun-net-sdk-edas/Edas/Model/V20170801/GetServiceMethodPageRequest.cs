...
{
    public class GetServiceMethodPageRequest : RoaAcsRequest<GetServiceMethodPageResponse>
    {
        public GetServiceMethodPageRequest()
            : base("Edas", "2017-08-01", "GetServiceMethodPage", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/sp/api/mseForOam/getServiceMethodPage";
        ...
        public override GetServiceMethodPageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceMethodPageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
