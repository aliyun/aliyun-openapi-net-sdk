...
{
    public class MigrateEcuRequest : RoaAcsRequest<MigrateEcuResponse>
    {
        public MigrateEcuRequest()
            : base("Edas", "2017-08-01", "MigrateEcu", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/resource/migrate_ecu";
        ...
        public override MigrateEcuResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MigrateEcuResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
