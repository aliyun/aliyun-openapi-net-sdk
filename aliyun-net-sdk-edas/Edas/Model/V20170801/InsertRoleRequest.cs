...
{
    public class InsertRoleRequest : RoaAcsRequest<InsertRoleResponse>
    {
        public InsertRoleRequest()
            : base("Edas", "2017-08-01", "InsertRole", "Edas", "openAPI")
        {
			...
			UriPattern = "/pop/v5/account/create_role";
        ...
        public override InsertRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
