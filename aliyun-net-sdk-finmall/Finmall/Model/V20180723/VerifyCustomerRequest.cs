...
{
    public class VerifyCustomerRequest : RpcAcsRequest<VerifyCustomerResponse>
    {
        public VerifyCustomerRequest()
            : base("finmall", "2018-07-23", "VerifyCustomer", "finmall", "openAPI")
        {
        }
        ...
        public override VerifyCustomerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyCustomerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
