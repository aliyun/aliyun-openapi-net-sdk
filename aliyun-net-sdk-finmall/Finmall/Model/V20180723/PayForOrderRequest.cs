...
{
    public class PayForOrderRequest : RpcAcsRequest<PayForOrderResponse>
    {
        public PayForOrderRequest()
            : base("finmall", "2018-07-23", "PayForOrder", "finmall", "openAPI")
        {
        }
        ...
        public override PayForOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PayForOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
