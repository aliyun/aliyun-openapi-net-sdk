    ...
    public class DescribeIntentResponseUnmarshaller
    {
        public static DescribeIntentResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeIntentResponse describeIntentResponse = new DescribeIntentResponse
            {
                ...
                RequestId = context.StringValue("DescribeIntent.RequestId"),
                IntentId = context.LongValue("DescribeIntent.IntentId"),
                Name = context.StringValue("DescribeIntent.Name"),
                Type = context.StringValue("DescribeIntent.Type"),
                DialogId = context.LongValue("DescribeIntent.DialogId"),
                CreateTime = context.StringValue("DescribeIntent.CreateTime"),
                ModifyTime = context.StringValue("DescribeIntent.ModifyTime"),
                CreateUserId = context.StringValue("DescribeIntent.CreateUserId"),
                CreateUserName = context.StringValue("DescribeIntent.CreateUserName"),
                ModifyUserId = context.StringValue("DescribeIntent.ModifyUserId"),
                ModifyUserName = context.StringValue("DescribeIntent.ModifyUserName")
            };
			...
			for (int i = 0; i < context.Length("DescribeIntent.RuleCheck.Length"); i++) {
                ...
                {
                    Text = context.StringValue("DescribeIntent.RuleCheck[" + i + "].Text"),
                    Strict = context.BooleanValue("DescribeIntent.RuleCheck[" + i + "].Strict")
                };
			...
			for (int i = 0; i < context.Length("DescribeIntent.Slot.Length"); i++) {
                ...
                {
                    Name = context.StringValue("DescribeIntent.Slot[" + i + "].Name"),
                    _Value = context.StringValue("DescribeIntent.Slot[" + i + "].Value"),
                    IsNecessary = context.BooleanValue("DescribeIntent.Slot[" + i + "].IsNecessary"),
                    IsArray = context.BooleanValue("DescribeIntent.Slot[" + i + "].IsArray"),
                    LifeSpan = context.IntegerValue("DescribeIntent.Slot[" + i + "].LifeSpan")
                };
				...
				for (int j = 0; j < context.Length("DescribeIntent.Slot["+ i +"].Tags.Length"); j++) {
                    ...
                    {
                        _Value = context.StringValue("DescribeIntent.Slot[" + i + "].Tags[" + j + "].Value"),
                        UserSayId = context.StringValue("DescribeIntent.Slot[" + i + "].Tags[" + j + "].UserSayId")
                    };
			...
			for (int i = 0; i < context.Length("DescribeIntent.UserSay.Length"); i++) {
                ...
                {
                    Strict = context.BooleanValue("DescribeIntent.UserSay[" + i + "].Strict")
                };
				...
				for (int j = 0; j < context.Length("DescribeIntent.UserSay["+ i +"].Data.Length"); j++) {
                    ...
                    {
                        Text = context.StringValue("DescribeIntent.UserSay[" + i + "].Data[" + j + "].Text"),
                        SlotId = context.StringValue("DescribeIntent.UserSay[" + i + "].Data[" + j + "].SlotId")
                    };
