...
{
    public class ListRobotTaskCallsRequest : RpcAcsRequest<ListRobotTaskCallsResponse>
    {
        public ListRobotTaskCallsRequest()
            : base("Dyvmsapi", "2017-05-25", "ListRobotTaskCalls", "dyvms", "openAPI")
        {
        ...
        public override ListRobotTaskCallsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRobotTaskCallsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
