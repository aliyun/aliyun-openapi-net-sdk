...
{
    public class DoRtcNumberAuthRequest : RpcAcsRequest<DoRtcNumberAuthResponse>
    {
        public DoRtcNumberAuthRequest()
            : base("Dyvmsapi", "2017-05-25", "DoRtcNumberAuth", "dyvms", "openAPI")
        {
        ...
        public override DoRtcNumberAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DoRtcNumberAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
