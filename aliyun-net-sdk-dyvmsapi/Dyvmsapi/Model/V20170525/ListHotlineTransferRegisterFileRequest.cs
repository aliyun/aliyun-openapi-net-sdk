...
{
    public class ListHotlineTransferRegisterFileRequest : RpcAcsRequest<ListHotlineTransferRegisterFileResponse>
    {
        public ListHotlineTransferRegisterFileRequest()
            : base("Dyvmsapi", "2017-05-25", "ListHotlineTransferRegisterFile", "dyvms", "openAPI")
        {
        ...
        public override ListHotlineTransferRegisterFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListHotlineTransferRegisterFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
