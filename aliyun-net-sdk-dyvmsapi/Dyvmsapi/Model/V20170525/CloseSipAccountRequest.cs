...
{
    public class CloseSipAccountRequest : RpcAcsRequest<CloseSipAccountResponse>
    {
        public CloseSipAccountRequest()
            : base("Dyvmsapi", "2017-05-25", "CloseSipAccount", "dyvms", "openAPI")
        {
		...
		public string SipAccountID
		{
			...
			{
				sipAccountID = value;
				DictionaryUtil.Add(QueryParameters, "SipAccountID", value);
			}
		}
        ...
        public override CloseSipAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseSipAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
