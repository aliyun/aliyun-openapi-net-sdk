...
{
    public class QueryRtcNumberAuthStatusRequest : RpcAcsRequest<QueryRtcNumberAuthStatusResponse>
    {
        public QueryRtcNumberAuthStatusRequest()
            : base("Dyvmsapi", "2017-05-25", "QueryRtcNumberAuthStatus", "dyvms", "openAPI")
        {
        ...
        public override QueryRtcNumberAuthStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRtcNumberAuthStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
