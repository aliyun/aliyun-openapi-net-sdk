...
{
    public class UndoRtcNumberAuthRequest : RpcAcsRequest<UndoRtcNumberAuthResponse>
    {
        public UndoRtcNumberAuthRequest()
            : base("Dyvmsapi", "2017-05-25", "UndoRtcNumberAuth", "dyvms", "openAPI")
        {
        ...
        public override UndoRtcNumberAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UndoRtcNumberAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
