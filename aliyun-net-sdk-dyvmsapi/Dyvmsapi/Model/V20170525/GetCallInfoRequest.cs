...
{
    public class GetCallInfoRequest : RpcAcsRequest<GetCallInfoResponse>
    {
        public GetCallInfoRequest()
            : base("Dyvmsapi", "2017-05-25", "GetCallInfo", "dyvms", "openAPI")
        {
		...
		public string RtcId
		{
			...
			{
				rtcId = value;
				DictionaryUtil.Add(QueryParameters, "RtcId", value);
			}
		}
        ...
        public override GetCallInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCallInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
