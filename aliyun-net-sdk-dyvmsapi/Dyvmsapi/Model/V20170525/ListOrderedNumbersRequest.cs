...
{
    public class ListOrderedNumbersRequest : RpcAcsRequest<ListOrderedNumbersResponse>
    {
        public ListOrderedNumbersRequest()
            : base("Dyvmsapi", "2017-05-25", "ListOrderedNumbers", "dyvms", "openAPI")
        {
        ...
        public override ListOrderedNumbersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOrderedNumbersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
