...
{
    public class SendVerificationRequest : RpcAcsRequest<SendVerificationResponse>
    {
        public SendVerificationRequest()
            : base("Dyvmsapi", "2017-05-25", "SendVerification", "dyvms", "openAPI")
        {
        ...
        public override SendVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SendVerificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
