...
{
    public class DescribeRecordDataRequest : RpcAcsRequest<DescribeRecordDataResponse>
    {
        public DescribeRecordDataRequest()
            : base("Dyvmsapi", "2017-05-25", "DescribeRecordData", "dyvms", "openAPI")
        {
		...
		public int? SecLevel
		{
			...
			{
				secLevel = value;
				DictionaryUtil.Add(QueryParameters, "SecLevel", value.ToString());
			}
		}
        ...
        public override DescribeRecordDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRecordDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
