...
{
    public class ExecuteCallTaskRequest : RpcAcsRequest<ExecuteCallTaskResponse>
    {
        public ExecuteCallTaskRequest()
            : base("Dyvmsapi", "2017-05-25", "ExecuteCallTask", "dyvms", "openAPI")
        {
        ...
        public override ExecuteCallTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExecuteCallTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
