...
{
    public class ListCallTaskDetailRequest : RpcAcsRequest<ListCallTaskDetailResponse>
    {
        public ListCallTaskDetailRequest()
            : base("Dyvmsapi", "2017-05-25", "ListCallTaskDetail", "dyvms", "openAPI")
        {
		...
		public string CalledNum
		{
			...
			{
				calledNum = value;
				DictionaryUtil.Add(QueryParameters, "CalledNum", value);
			}
		}
        ...
        public override ListCallTaskDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCallTaskDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
