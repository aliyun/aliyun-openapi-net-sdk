...
{
    public class ListHotlineTransferNumberRequest : RpcAcsRequest<ListHotlineTransferNumberResponse>
    {
        public ListHotlineTransferNumberRequest()
            : base("Dyvmsapi", "2017-05-25", "ListHotlineTransferNumber", "dyvms", "openAPI")
        {
        ...
        public override ListHotlineTransferNumberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListHotlineTransferNumberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
