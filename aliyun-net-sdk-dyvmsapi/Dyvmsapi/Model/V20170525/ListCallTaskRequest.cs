...
{
    public class ListCallTaskRequest : RpcAcsRequest<ListCallTaskResponse>
    {
        public ListCallTaskRequest()
            : base("Dyvmsapi", "2017-05-25", "ListCallTask", "dyvms", "openAPI")
        {
        ...
        public override ListCallTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCallTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
