...
{
    public class ListUserHistoryProducesRequest : RpcAcsRequest<ListUserHistoryProducesResponse>
    {
        public ListUserHistoryProducesRequest()
            : base("Copyright", "2019-01-23", "ListUserHistoryProduces")
        {
        ...
        public override ListUserHistoryProducesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserHistoryProducesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
