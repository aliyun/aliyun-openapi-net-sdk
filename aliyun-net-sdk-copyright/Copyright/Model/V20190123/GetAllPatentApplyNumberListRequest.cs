...
{
    public class GetAllPatentApplyNumberListRequest : RpcAcsRequest<GetAllPatentApplyNumberListResponse>
    {
        public GetAllPatentApplyNumberListRequest()
            : base("Copyright", "2019-01-23", "GetAllPatentApplyNumberList")
        {
        ...
        public override GetAllPatentApplyNumberListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAllPatentApplyNumberListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
