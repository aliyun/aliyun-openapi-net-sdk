...
{
    public class SavePatentContactRequest : RpcAcsRequest<SavePatentContactResponse>
    {
        public SavePatentContactRequest()
            : base("Copyright", "2019-01-23", "SavePatentContact")
        {
        ...
        public override SavePatentContactResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SavePatentContactResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
