...
{
	public class ListUserHistoryProducesResponse : AcsResponse
	{
		...
		private List<ListUserHistoryProduces_Produces> data;
		...
		public List<ListUserHistoryProduces_Produces> Data
		{
			get
			{
				return data;
		...
		public class ListUserHistoryProduces_Produces
		{
