...
namespace Aliyun.Acs.Copyright.Transform.V20190123
{
    public class DescribePolicyResponseUnmarshaller
    {
        public static DescribePolicyResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			describePolicyResponse.AccessId = _ctx.StringValue("DescribePolicy.AccessId");
			describePolicyResponse.EncodedPolicy = _ctx.StringValue("DescribePolicy.EncodedPolicy");
			describePolicyResponse.Signature = _ctx.StringValue("DescribePolicy.Signature");
			describePolicyResponse.FileDir = _ctx.StringValue("DescribePolicy.FileDir");
			describePolicyResponse.Host = _ctx.StringValue("DescribePolicy.Host");
			describePolicyResponse.ExpireTime = _ctx.LongValue("DescribePolicy.ExpireTime");
