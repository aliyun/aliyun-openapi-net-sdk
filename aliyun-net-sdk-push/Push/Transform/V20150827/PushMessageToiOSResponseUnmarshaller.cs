...
namespace Aliyun.Acs.Push.Transform.V20150827
{
    public class PushMessageToiOSResponseUnmarshaller
    {
        public static PushMessageToiOSResponse Unmarshall(UnmarshallerContext context)
        {
			...
			pushMessageToiOSResponse.ResponseId = context.StringValue("PushMessageToiOS.ResponseId");
			pushMessageToiOSResponse.Message = context.StringValue("PushMessageToiOS.Message");
