...
{
    public class BindTagsToKeyRequest : RpcAcsRequest<BindTagsToKeyResponse>
    {
        public BindTagsToKeyRequest()
            : base("Push", "2015-08-27", "BindTagsToKey")
        {
        }
        ...
        public override BindTagsToKeyResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return BindTagsToKeyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}