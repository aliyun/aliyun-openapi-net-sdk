...
{
    public class ModifyDdosStatusRequest : RpcAcsRequest<ModifyDdosStatusResponse>
    {
        public ModifyDdosStatusRequest()
            : base("antiddos-public", "2017-05-18", "ModifyDdosStatus")
        {
        ...
        public override ModifyDdosStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDdosStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
