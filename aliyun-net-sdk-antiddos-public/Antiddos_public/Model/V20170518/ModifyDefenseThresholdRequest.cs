...
{
    public class ModifyDefenseThresholdRequest : RpcAcsRequest<ModifyDefenseThresholdResponse>
    {
        public ModifyDefenseThresholdRequest()
            : base("antiddos-public", "2017-05-18", "ModifyDefenseThreshold")
        {
        ...
        public override ModifyDefenseThresholdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDefenseThresholdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
