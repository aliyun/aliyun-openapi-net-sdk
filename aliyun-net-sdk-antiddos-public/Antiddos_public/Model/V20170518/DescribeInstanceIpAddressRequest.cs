...
{
    public class DescribeInstanceIpAddressRequest : RpcAcsRequest<DescribeInstanceIpAddressResponse>
    {
        public DescribeInstanceIpAddressRequest()
            : base("antiddos-public", "2017-05-18", "DescribeInstanceIpAddress")
        {
        ...
        public override DescribeInstanceIpAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceIpAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
