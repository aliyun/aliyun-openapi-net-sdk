...
{
    public class ListSizesRequest : RpcAcsRequest<ListSizesResponse>
    {
        public ListSizesRequest()
            : base("digitalstore", "2020-01-07", "ListSizes", "digitalstore", "openAPI")
        {
        ...
        public override ListSizesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSizesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
