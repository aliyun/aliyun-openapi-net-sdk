...
{
    public class ListProduceOrderCaseSkusRequest : RpcAcsRequest<ListProduceOrderCaseSkusResponse>
    {
        public ListProduceOrderCaseSkusRequest()
            : base("digitalstore", "2020-01-07", "ListProduceOrderCaseSkus", "digitalstore", "openAPI")
        {
        ...
        public override ListProduceOrderCaseSkusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProduceOrderCaseSkusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
