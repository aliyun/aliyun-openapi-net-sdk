...
{
    public class ListExpressCompanyRequest : RpcAcsRequest<ListExpressCompanyResponse>
    {
        public ListExpressCompanyRequest()
            : base("digitalstore", "2020-01-07", "ListExpressCompany", "digitalstore", "openAPI")
        {
		...
		public string ExpressCompanyName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "ExpressCompanyName", value);
			}
		}
		...
		public string ExpressCompanyCode
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "ExpressCompanyCode", value);
			}
		}
        ...
        public override ListExpressCompanyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListExpressCompanyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
