...
{
    public class CreateSizeRequest : RpcAcsRequest<CreateSizeResponse>
    {
        public CreateSizeRequest()
            : base("digitalstore", "2020-01-07", "CreateSize", "digitalstore", "openAPI")
        {
        ...
        public override CreateSizeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSizeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
