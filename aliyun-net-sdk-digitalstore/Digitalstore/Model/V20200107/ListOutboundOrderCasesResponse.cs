...
{
	public class ListOutboundOrderCasesResponse : AcsResponse
	{
		...
		private List<ListOutboundOrderCases_CaseBiz> cases;
		...
		public List<ListOutboundOrderCases_CaseBiz> Cases
		{
			get
			{
				return cases;
		...
		public class ListOutboundOrderCases_CaseBiz
		{
