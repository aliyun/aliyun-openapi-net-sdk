...
{
    public class GrantRightsRequest : RpcAcsRequest<GrantRightsResponse>
    {
        public GrantRightsRequest()
            : base("digitalstore", "2020-01-07", "GrantRights", "digitalstore", "openAPI")
        {
		...
		public string AliyunAccount
		{
			...
			{
				aliyunAccount = value;
				DictionaryUtil.Add(BodyParameters, "AliyunAccount", value);
			}
		}
        ...
        public override GrantRightsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GrantRightsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
