...
{
    public class ListTakeStockOrderLinesRequest : RpcAcsRequest<ListTakeStockOrderLinesResponse>
    {
        public ListTakeStockOrderLinesRequest()
            : base("digitalstore", "2020-01-07", "ListTakeStockOrderLines", "digitalstore", "openAPI")
        {
        ...
        public override ListTakeStockOrderLinesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTakeStockOrderLinesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
