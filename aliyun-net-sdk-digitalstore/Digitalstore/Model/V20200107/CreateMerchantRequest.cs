...
{
    public class CreateMerchantRequest : RpcAcsRequest<CreateMerchantResponse>
    {
        public CreateMerchantRequest()
            : base("digitalstore", "2020-01-07", "CreateMerchant", "digitalstore", "openAPI")
        {
        ...
        public override CreateMerchantResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMerchantResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
