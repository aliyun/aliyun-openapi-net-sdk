...
{
    public class UpdateGoodsStyleRequest : RpcAcsRequest<UpdateGoodsStyleResponse>
    {
        public UpdateGoodsStyleRequest()
            : base("digitalstore", "2020-01-07", "UpdateGoodsStyle", "digitalstore", "openAPI")
        {
        ...
        public override UpdateGoodsStyleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateGoodsStyleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
