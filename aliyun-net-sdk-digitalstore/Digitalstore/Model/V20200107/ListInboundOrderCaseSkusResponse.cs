...
{
	public class ListInboundOrderCaseSkusResponse : AcsResponse
	{
		...
		private List<ListInboundOrderCaseSkus_InOutOrderCaseSkuModel> skuTags;
		...
		public List<ListInboundOrderCaseSkus_InOutOrderCaseSkuModel> SkuTags
		{
			get
			{
				return skuTags;
		...
		public class ListInboundOrderCaseSkus_InOutOrderCaseSkuModel
		{
