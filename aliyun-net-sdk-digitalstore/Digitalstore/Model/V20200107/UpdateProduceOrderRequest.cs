...
{
    public class UpdateProduceOrderRequest : RpcAcsRequest<UpdateProduceOrderResponse>
    {
        public UpdateProduceOrderRequest()
            : base("digitalstore", "2020-01-07", "UpdateProduceOrder", "digitalstore", "openAPI")
        {
        ...
        public override UpdateProduceOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateProduceOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
