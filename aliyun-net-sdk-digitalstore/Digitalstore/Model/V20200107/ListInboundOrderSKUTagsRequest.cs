...
{
    public class ListInboundOrderSKUTagsRequest : RpcAcsRequest<ListInboundOrderSKUTagsResponse>
    {
        public ListInboundOrderSKUTagsRequest()
            : base("digitalstore", "2020-01-07", "ListInboundOrderSKUTags", "digitalstore", "openAPI")
        {
        ...
        public override ListInboundOrderSKUTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListInboundOrderSKUTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
