...
{
    public class ImportWarehouseRequest : RpcAcsRequest<ImportWarehouseResponse>
    {
        public ImportWarehouseRequest()
            : base("digitalstore", "2020-01-07", "ImportWarehouse", "digitalstore", "openAPI")
        {
        ...
        public override ImportWarehouseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportWarehouseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
