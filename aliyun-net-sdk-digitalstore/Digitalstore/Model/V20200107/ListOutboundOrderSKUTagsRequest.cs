...
{
    public class ListOutboundOrderSKUTagsRequest : RpcAcsRequest<ListOutboundOrderSKUTagsResponse>
    {
        public ListOutboundOrderSKUTagsRequest()
            : base("digitalstore", "2020-01-07", "ListOutboundOrderSKUTags", "digitalstore", "openAPI")
        {
        ...
        public override ListOutboundOrderSKUTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOutboundOrderSKUTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
