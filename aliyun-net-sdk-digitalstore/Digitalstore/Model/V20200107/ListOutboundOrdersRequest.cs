...
{
    public class ListOutboundOrdersRequest : RpcAcsRequest<ListOutboundOrdersResponse>
    {
        public ListOutboundOrdersRequest()
            : base("digitalstore", "2020-01-07", "ListOutboundOrders", "digitalstore", "openAPI")
        {
        ...
        public override ListOutboundOrdersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOutboundOrdersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
