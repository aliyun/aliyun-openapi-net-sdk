...
{
    public class ListWarehousesRequest : RpcAcsRequest<ListWarehousesResponse>
    {
        public ListWarehousesRequest()
            : base("digitalstore", "2020-01-07", "ListWarehouses", "digitalstore", "openAPI")
        {
		...
		public string Tel
		{
			...
			{
				tel = value;
				DictionaryUtil.Add(BodyParameters, "Tel", value);
			}
		}
        ...
        public override ListWarehousesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListWarehousesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
