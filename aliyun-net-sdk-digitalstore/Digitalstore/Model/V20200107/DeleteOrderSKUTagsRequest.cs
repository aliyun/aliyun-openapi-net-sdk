...
{
    public class DeleteOrderSKUTagsRequest : RpcAcsRequest<DeleteOrderSKUTagsResponse>
    {
        public DeleteOrderSKUTagsRequest()
            : base("digitalstore", "2020-01-07", "DeleteOrderSKUTags", "digitalstore", "openAPI")
        {
        ...
        public override DeleteOrderSKUTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteOrderSKUTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
