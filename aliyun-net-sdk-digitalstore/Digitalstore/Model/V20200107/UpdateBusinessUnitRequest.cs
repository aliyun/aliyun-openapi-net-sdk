...
{
    public class UpdateBusinessUnitRequest : RpcAcsRequest<UpdateBusinessUnitResponse>
    {
        public UpdateBusinessUnitRequest()
            : base("digitalstore", "2020-01-07", "UpdateBusinessUnit", "digitalstore", "openAPI")
        {
        ...
        public override UpdateBusinessUnitResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateBusinessUnitResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
