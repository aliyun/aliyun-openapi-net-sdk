...
{
    public class ListInboundOrderCaseSkusRequest : RpcAcsRequest<ListInboundOrderCaseSkusResponse>
    {
        public ListInboundOrderCaseSkusRequest()
            : base("digitalstore", "2020-01-07", "ListInboundOrderCaseSkus", "digitalstore", "openAPI")
        {
        ...
        public override ListInboundOrderCaseSkusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListInboundOrderCaseSkusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
