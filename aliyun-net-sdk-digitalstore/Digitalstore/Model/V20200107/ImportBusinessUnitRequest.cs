...
{
    public class ImportBusinessUnitRequest : RpcAcsRequest<ImportBusinessUnitResponse>
    {
        public ImportBusinessUnitRequest()
            : base("digitalstore", "2020-01-07", "ImportBusinessUnit", "digitalstore", "openAPI")
        {
        ...
        public override ImportBusinessUnitResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportBusinessUnitResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
