...
{
    public class ListTakeStockOrderTaskSkuTagsRequest : RpcAcsRequest<ListTakeStockOrderTaskSkuTagsResponse>
    {
        public ListTakeStockOrderTaskSkuTagsRequest()
            : base("digitalstore", "2020-01-07", "ListTakeStockOrderTaskSkuTags", "digitalstore", "openAPI")
        {
        ...
        public override ListTakeStockOrderTaskSkuTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTakeStockOrderTaskSkuTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
