...
{
    public class CreateTakeStockOrderRequest : RpcAcsRequest<CreateTakeStockOrderResponse>
    {
        public CreateTakeStockOrderRequest()
            : base("digitalstore", "2020-01-07", "CreateTakeStockOrder", "digitalstore", "openAPI")
        {
        ...
        public override CreateTakeStockOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTakeStockOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
