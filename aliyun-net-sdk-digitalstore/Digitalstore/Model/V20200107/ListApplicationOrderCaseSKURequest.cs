...
{
    public class ListApplicationOrderCaseSKURequest : RpcAcsRequest<ListApplicationOrderCaseSKUResponse>
    {
        public ListApplicationOrderCaseSKURequest()
            : base("digitalstore", "2020-01-07", "ListApplicationOrderCaseSKU", "digitalstore", "openAPI")
        {
        ...
        public override ListApplicationOrderCaseSKUResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListApplicationOrderCaseSKUResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
