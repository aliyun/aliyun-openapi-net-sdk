...
{
    public class ListColorsRequest : RpcAcsRequest<ListColorsResponse>
    {
        public ListColorsRequest()
            : base("digitalstore", "2020-01-07", "ListColors", "digitalstore", "openAPI")
        {
        ...
        public override ListColorsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListColorsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
