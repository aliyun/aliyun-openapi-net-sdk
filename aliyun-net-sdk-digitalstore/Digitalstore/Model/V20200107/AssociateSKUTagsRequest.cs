...
{
    public class AssociateSKUTagsRequest : RpcAcsRequest<AssociateSKUTagsResponse>
    {
        public AssociateSKUTagsRequest()
            : base("digitalstore", "2020-01-07", "AssociateSKUTags", "digitalstore", "openAPI")
        {
        ...
        public override AssociateSKUTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssociateSKUTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
