...
{
	public class ListApplicationOrderCaseSKUResponse : AcsResponse
	{
		...
		private List<ListApplicationOrderCaseSKU_ApplyOrderCaseSkuModel> applyOrderCaseSkus;
		...
		public List<ListApplicationOrderCaseSKU_ApplyOrderCaseSkuModel> ApplyOrderCaseSkus
		{
			get
			{
				return applyOrderCaseSkus;
			}
			set	
			{
				applyOrderCaseSkus = value;
			}
		}

		public class ListApplicationOrderCaseSKU_ApplyOrderCaseSkuModel
		{
