...
{
    public class ImportOutBoundOrderRequest : RpcAcsRequest<ImportOutBoundOrderResponse>
    {
        public ImportOutBoundOrderRequest()
            : base("digitalstore", "2020-01-07", "ImportOutBoundOrder", "digitalstore", "openAPI")
        {
        ...
        public override ImportOutBoundOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportOutBoundOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
