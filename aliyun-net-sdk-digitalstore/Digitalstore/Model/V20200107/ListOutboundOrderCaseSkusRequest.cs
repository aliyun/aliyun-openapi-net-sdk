...
{
    public class ListOutboundOrderCaseSkusRequest : RpcAcsRequest<ListOutboundOrderCaseSkusResponse>
    {
        public ListOutboundOrderCaseSkusRequest()
            : base("digitalstore", "2020-01-07", "ListOutboundOrderCaseSkus", "digitalstore", "openAPI")
        {
        ...
        public override ListOutboundOrderCaseSkusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOutboundOrderCaseSkusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
