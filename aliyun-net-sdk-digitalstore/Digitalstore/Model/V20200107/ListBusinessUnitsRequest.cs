...
{
    public class ListBusinessUnitsRequest : RpcAcsRequest<ListBusinessUnitsResponse>
    {
        public ListBusinessUnitsRequest()
            : base("digitalstore", "2020-01-07", "ListBusinessUnits", "digitalstore", "openAPI")
        {
        ...
        public override ListBusinessUnitsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListBusinessUnitsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
