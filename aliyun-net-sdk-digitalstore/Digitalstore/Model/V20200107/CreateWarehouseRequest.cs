...
{
    public class CreateWarehouseRequest : RpcAcsRequest<CreateWarehouseResponse>
    {
        public CreateWarehouseRequest()
            : base("digitalstore", "2020-01-07", "CreateWarehouse", "digitalstore", "openAPI")
        {
        ...
        public override CreateWarehouseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateWarehouseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
