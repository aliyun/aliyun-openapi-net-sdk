...
{
    public class DeletePlaybookRequest : RpcAcsRequest<DeletePlaybookResponse>
    {
        public DeletePlaybookRequest()
            : base("sophonsoar", "2022-07-28", "DeletePlaybook")
        {
        ...
        public override DeletePlaybookResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePlaybookResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
