...
{
    public class ConvertPlaybookRequest : RpcAcsRequest<ConvertPlaybookResponse>
    {
        public ConvertPlaybookRequest()
            : base("sophonsoar", "2022-07-28", "ConvertPlaybook")
        {
        ...
        public override ConvertPlaybookResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConvertPlaybookResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
