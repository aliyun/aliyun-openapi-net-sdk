...
{
    public class RunNotifyComponentWithEmailRequest : RpcAcsRequest<RunNotifyComponentWithEmailResponse>
    {
        public RunNotifyComponentWithEmailRequest()
            : base("sophonsoar", "2022-07-28", "RunNotifyComponentWithEmail")
        {
		...
		private List<string> receiverss = new List<string>(){ };
        ...
        public override RunNotifyComponentWithEmailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RunNotifyComponentWithEmailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
