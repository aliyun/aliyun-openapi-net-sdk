...
{
    public class ModifyPlaybookRequest : RpcAcsRequest<ModifyPlaybookResponse>
    {
        public ModifyPlaybookRequest()
            : base("sophonsoar", "2022-07-28", "ModifyPlaybook")
        {
        ...
        public override ModifyPlaybookResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyPlaybookResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
