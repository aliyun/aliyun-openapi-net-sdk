...
namespace Aliyun.Acs.Emr.Model.V20160408
{
	public class DescribeEmrMainVersionResponse : AcsResponse
	{
		...
		public class DescribeEmrMainVersion_EmrMainVersion
		{
			...
			private List<DescribeEmrMainVersion_ClusterTypeWhiteUser> clusterTypeWhiteUserList;
			...
			public List<DescribeEmrMainVersion_ClusterTypeWhiteUser> ClusterTypeWhiteUserList
			{
				get
				{
