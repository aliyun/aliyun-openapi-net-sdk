...
{
    public class ListScalingConfigItemV2Request : RpcAcsRequest<ListScalingConfigItemV2Response>
    {
        public ListScalingConfigItemV2Request()
            : base("Emr", "2016-04-08", "ListScalingConfigItemV2", "emr", "openAPI")
        {
        ...
        public override ListScalingConfigItemV2Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListScalingConfigItemV2ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
