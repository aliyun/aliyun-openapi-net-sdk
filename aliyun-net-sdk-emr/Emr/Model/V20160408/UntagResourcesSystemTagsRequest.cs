...
{
    public class UntagResourcesSystemTagsRequest : RpcAcsRequest<UntagResourcesSystemTagsResponse>
    {
        public UntagResourcesSystemTagsRequest()
            : base("Emr", "2016-04-08", "UntagResourcesSystemTags", "emr", "openAPI")
        {
        ...
        public override UntagResourcesSystemTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UntagResourcesSystemTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
