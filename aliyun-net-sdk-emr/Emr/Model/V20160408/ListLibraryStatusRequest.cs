...
{
    public class ListLibraryStatusRequest : RpcAcsRequest<ListLibraryStatusResponse>
    {
        public ListLibraryStatusRequest()
            : base("Emr", "2016-04-08", "ListLibraryStatus", "emr", "openAPI")
        {
        ...
        public override ListLibraryStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLibraryStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
