...
{
    public class RemoveScalingConfigItemV2Request : RpcAcsRequest<RemoveScalingConfigItemV2Response>
    {
        public RemoveScalingConfigItemV2Request()
            : base("Emr", "2016-04-08", "RemoveScalingConfigItemV2", "emr", "openAPI")
        {
        ...
        public override RemoveScalingConfigItemV2Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveScalingConfigItemV2ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
