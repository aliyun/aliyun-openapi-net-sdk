...
{
    public class ListLibraryInstallTasksRequest : RpcAcsRequest<ListLibraryInstallTasksResponse>
    {
        public ListLibraryInstallTasksRequest()
            : base("Emr", "2016-04-08", "ListLibraryInstallTasks", "emr", "openAPI")
        {
        ...
        public override ListLibraryInstallTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLibraryInstallTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
