...
{
    public class ListFlowEntitySnapshotRequest : RpcAcsRequest<ListFlowEntitySnapshotResponse>
    {
        public ListFlowEntitySnapshotRequest()
            : base("Emr", "2016-04-08", "ListFlowEntitySnapshot", "emr", "openAPI")
        {
        ...
        public override ListFlowEntitySnapshotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFlowEntitySnapshotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
