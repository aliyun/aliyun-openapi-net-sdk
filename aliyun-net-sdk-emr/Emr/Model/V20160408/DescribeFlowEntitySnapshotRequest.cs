...
{
    public class DescribeFlowEntitySnapshotRequest : RpcAcsRequest<DescribeFlowEntitySnapshotResponse>
    {
        public DescribeFlowEntitySnapshotRequest()
            : base("Emr", "2016-04-08", "DescribeFlowEntitySnapshot", "emr", "openAPI")
        {
		...
		public string CommitterId
		{
			...
			{
				committerId = value;
				DictionaryUtil.Add(QueryParameters, "CommitterId", value);
			}
		}
		...
		public string Revision
		{
			...
			{
				revision = value;
				DictionaryUtil.Add(QueryParameters, "Revision", value);
			}
		}
        ...
        public override DescribeFlowEntitySnapshotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeFlowEntitySnapshotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
