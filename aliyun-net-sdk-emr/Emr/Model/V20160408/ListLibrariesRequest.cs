...
{
    public class ListLibrariesRequest : RpcAcsRequest<ListLibrariesResponse>
    {
        public ListLibrariesRequest()
            : base("Emr", "2016-04-08", "ListLibraries", "emr", "openAPI")
        {
        ...
        public override ListLibrariesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLibrariesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
