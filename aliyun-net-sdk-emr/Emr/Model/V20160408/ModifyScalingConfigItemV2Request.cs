...
{
    public class ModifyScalingConfigItemV2Request : RpcAcsRequest<ModifyScalingConfigItemV2Response>
    {
        public ModifyScalingConfigItemV2Request()
            : base("Emr", "2016-04-08", "ModifyScalingConfigItemV2", "emr", "openAPI")
        {
		...
		public string ConfigItemBizId
		{
			...
			set	
			{
				configItemBizId = value;
				DictionaryUtil.Add(QueryParameters, "ConfigItemBizId", value);
			}
		}
        ...
        public override ModifyScalingConfigItemV2Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyScalingConfigItemV2ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
