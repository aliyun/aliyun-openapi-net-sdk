...
{
    public class CreateClusterBootstrapActionRequest : RpcAcsRequest<CreateClusterBootstrapActionResponse>
    {
        public CreateClusterBootstrapActionRequest()
            : base("Emr", "2016-04-08", "CreateClusterBootstrapAction", "emr", "openAPI")
        {
        ...
        public override CreateClusterBootstrapActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateClusterBootstrapActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
