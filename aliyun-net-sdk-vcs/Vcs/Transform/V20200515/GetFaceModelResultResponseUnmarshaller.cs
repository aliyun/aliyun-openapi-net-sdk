    ...
    public class GetFaceModelResultResponseUnmarshaller
    {
        public static GetFaceModelResultResponse Unmarshall(UnmarshallerContext context)
        {
			...
			for (int i = 0; i < context.Length("GetFaceModelResult.Data.Records.Length"); i++) {
				...
				recordsItem.RightBottomY = context.IntegerValue("GetFaceModelResult.Data.Records["+ i +"].RightBottomY");
				recordsItem.RightBottomX = context.IntegerValue("GetFaceModelResult.Data.Records["+ i +"].RightBottomX");
				...
				recordsItem.LeftTopY = context.IntegerValue("GetFaceModelResult.Data.Records["+ i +"].LeftTopY");
				recordsItem.LeftTopX = context.IntegerValue("GetFaceModelResult.Data.Records["+ i +"].LeftTopX");
