...
namespace Aliyun.Acs.Vcs.Transform.V20200515
{
    ...
    {
        public static GetDeviceLiveUrlResponse Unmarshall(UnmarshallerContext context)
        {
			GetDeviceLiveUrlResponse getDeviceLiveUrlResponse = new GetDeviceLiveUrlResponse();
