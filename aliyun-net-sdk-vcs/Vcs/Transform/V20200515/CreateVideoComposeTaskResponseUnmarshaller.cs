...
namespace Aliyun.Acs.Vcs.Transform.V20200515
{
    ...
    {
        public static CreateVideoComposeTaskResponse Unmarshall(UnmarshallerContext context)
        {
			CreateVideoComposeTaskResponse createVideoComposeTaskResponse = new CreateVideoComposeTaskResponse();

			createVideoComposeTaskResponse.HttpResponse = context.HttpResponse;
