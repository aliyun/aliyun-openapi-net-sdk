...
namespace Aliyun.Acs.Vcs.Transform.V20200515
{
    ...
    {
        public static GetVideoComposeResultResponse Unmarshall(UnmarshallerContext context)
        {
			GetVideoComposeResultResponse getVideoComposeResultResponse = new GetVideoComposeResultResponse();

			getVideoComposeResultResponse.HttpResponse = context.HttpResponse;
