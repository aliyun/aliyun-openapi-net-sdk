...
namespace Aliyun.Acs.Vcs.Model.V20200515
{
    public class GetPersonDetailRequest : RpcAcsRequest<GetPersonDetailResponse>
    {
        ...
        public override GetPersonDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPersonDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
