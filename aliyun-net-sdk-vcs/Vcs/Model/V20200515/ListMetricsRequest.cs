...
{
    public class ListMetricsRequest : RpcAcsRequest<ListMetricsResponse>
    {
        public ListMetricsRequest()
            : base("Vcs", "2020-05-15", "ListMetrics", "vcs", "openAPI")
        {
        ...
        public override ListMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
