...
namespace Aliyun.Acs.Vcs.Model.V20200515
{
    public class ListPersonsRequest : RpcAcsRequest<ListPersonsResponse>
    {
		...
		public string PageNo
		{
			...
			{
				pageNo = value;
				DictionaryUtil.Add(BodyParameters, "PageNo", value);
			}
		}
        ...
        public override ListPersonsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPersonsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
