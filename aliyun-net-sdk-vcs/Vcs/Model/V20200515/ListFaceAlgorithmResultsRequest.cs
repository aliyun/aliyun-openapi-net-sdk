...
{
    public class ListFaceAlgorithmResultsRequest : RpcAcsRequest<ListFaceAlgorithmResultsResponse>
    {
        public ListFaceAlgorithmResultsRequest()
            : base("Vcs", "2020-05-15", "ListFaceAlgorithmResults", "vcs", "openAPI")
        {
        ...
        public override ListFaceAlgorithmResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFaceAlgorithmResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
