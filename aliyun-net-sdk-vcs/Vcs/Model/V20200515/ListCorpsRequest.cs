...
namespace Aliyun.Acs.Vcs.Model.V20200515
{
    public class ListCorpsRequest : RpcAcsRequest<ListCorpsResponse>
    {
        ...
        public override ListCorpsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCorpsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
