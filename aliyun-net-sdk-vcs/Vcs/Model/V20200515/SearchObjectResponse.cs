...
namespace Aliyun.Acs.Vcs.Model.V20200515
{
	public class SearchObjectResponse : AcsResponse
	{
		...
		private List<SearchObject_DataItem> data;
		...
		public List<SearchObject_DataItem> Data
		{
			get
			{
				return data;
		...
		public class SearchObject_DataItem
		{
			...
			public class SearchObject_RecordsItem
			{
				...
				public string MotorShotTime
				{
					get
					{
						return motorShotTime;
					}
					set	
					{
						motorShotTime = value;
