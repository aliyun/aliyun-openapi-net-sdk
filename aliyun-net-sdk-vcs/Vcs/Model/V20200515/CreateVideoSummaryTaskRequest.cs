...
namespace Aliyun.Acs.Vcs.Model.V20200515
{
    public class CreateVideoSummaryTaskRequest : RpcAcsRequest<CreateVideoSummaryTaskResponse>
    {
		...
		public string LiveVideoSummary
		{
			...
			set	
			{
				liveVideoSummary = value;
				DictionaryUtil.Add(BodyParameters, "LiveVideoSummary", value);
			}
		}
        ...
        public override CreateVideoSummaryTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateVideoSummaryTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
