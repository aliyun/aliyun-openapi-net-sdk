...
namespace Aliyun.Acs.Vcs.Model.V20200515
{
    public class GetPersonListRequest : RpcAcsRequest<GetPersonListResponse>
    {
        ...
        public override GetPersonListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPersonListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
