...
{
    public class AddProfileRequest : RpcAcsRequest<AddProfileResponse>
    {
        public AddProfileRequest()
            : base("Vcs", "2020-05-15", "AddProfile", "vcs", "openAPI")
        {
        ...
        public override AddProfileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddProfileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
