...
{
    public class ListMotorAlgorithmResultsRequest : RpcAcsRequest<ListMotorAlgorithmResultsResponse>
    {
        public ListMotorAlgorithmResultsRequest()
            : base("Vcs", "2020-05-15", "ListMotorAlgorithmResults", "vcs", "openAPI")
        {
		...
		public string PlateNumber
		{
			...
			{
				plateNumber = value;
				DictionaryUtil.Add(BodyParameters, "PlateNumber", value);
			}
		}
        ...
        public override ListMotorAlgorithmResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMotorAlgorithmResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
