...
{
    public class ListDevicesImagesRequest : RpcAcsRequest<ListDevicesImagesResponse>
    {
        public ListDevicesImagesRequest()
            : base("reid_cloud", "2020-10-29", "ListDevicesImages", "1.2.1", "openAPI")
        {
		...
		public string IpcIdList
		{
			...
			{
				ipcIdList = value;
				DictionaryUtil.Add(BodyParameters, "IpcIdList", value);
			}
		}
        ...
        public override ListDevicesImagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDevicesImagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
