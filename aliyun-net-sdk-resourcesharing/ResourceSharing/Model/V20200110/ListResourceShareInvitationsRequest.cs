...
{
    public class ListResourceShareInvitationsRequest : RpcAcsRequest<ListResourceShareInvitationsResponse>
    {
        public ListResourceShareInvitationsRequest()
            : base("ResourceSharing", "2020-01-10", "ListResourceShareInvitations", "ressharing", "openAPI")
        {
		...
		private List<string> resourceShareInvitationIdss = new List<string>(){ };
		...
		public List<string> ResourceShareInvitationIdss
		{
			get
			{
				return resourceShareInvitationIdss;
			}

			set
			{
				resourceShareInvitationIdss = value;
			}
		}
        ...
        public override ListResourceShareInvitationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListResourceShareInvitationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
