...
{
    public class RejectResourceShareInvitationRequest : RpcAcsRequest<RejectResourceShareInvitationResponse>
    {
        public RejectResourceShareInvitationRequest()
            : base("ResourceSharing", "2020-01-10", "RejectResourceShareInvitation", "ressharing", "openAPI")
        {
        ...
        public override RejectResourceShareInvitationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RejectResourceShareInvitationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
