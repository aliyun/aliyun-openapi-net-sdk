...
{
    public class DeleteResourceShareRequest : RpcAcsRequest<DeleteResourceShareResponse>
    {
        public DeleteResourceShareRequest()
            : base("ResourceSharing", "2020-01-10", "DeleteResourceShare", "ressharing", "openAPI")
        {
        ...
        public override DeleteResourceShareResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteResourceShareResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
