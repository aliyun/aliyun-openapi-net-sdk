...
{
    public class ListPermissionVersionsRequest : RpcAcsRequest<ListPermissionVersionsResponse>
    {
        public ListPermissionVersionsRequest()
            : base("ResourceSharing", "2020-01-10", "ListPermissionVersions", "ressharing", "openAPI")
        {
        ...
        public override ListPermissionVersionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPermissionVersionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
