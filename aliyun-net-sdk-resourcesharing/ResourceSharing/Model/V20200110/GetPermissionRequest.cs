...
{
    public class GetPermissionRequest : RpcAcsRequest<GetPermissionResponse>
    {
        public GetPermissionRequest()
            : base("ResourceSharing", "2020-01-10", "GetPermission", "ressharing", "openAPI")
        {
		...
		public string PermissionVersion
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "PermissionVersion", value);
			}
		}
        ...
        public override GetPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
