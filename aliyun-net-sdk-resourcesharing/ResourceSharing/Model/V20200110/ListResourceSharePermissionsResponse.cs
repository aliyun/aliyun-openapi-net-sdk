...
{
	public class ListResourceSharePermissionsResponse : AcsResponse
	{
		...
		private List<ListResourceSharePermissions_Permission> permissions;
		...
		public List<ListResourceSharePermissions_Permission> Permissions
		{
			get
			{
				return permissions;
		...
		public class ListResourceSharePermissions_Permission
		{
