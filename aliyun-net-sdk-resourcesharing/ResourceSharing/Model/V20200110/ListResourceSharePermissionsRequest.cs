...
{
    public class ListResourceSharePermissionsRequest : RpcAcsRequest<ListResourceSharePermissionsResponse>
    {
        public ListResourceSharePermissionsRequest()
            : base("ResourceSharing", "2020-01-10", "ListResourceSharePermissions", "ressharing", "openAPI")
        {
        ...
        public override ListResourceSharePermissionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListResourceSharePermissionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
