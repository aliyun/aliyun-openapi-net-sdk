...
{
	public class ListPermissionsResponse : AcsResponse
	{
		...
		private List<ListPermissions_Permission> permissions;
		...
		public List<ListPermissions_Permission> Permissions
		{
			get
			{
				return permissions;
		...
		public class ListPermissions_Permission
		{
