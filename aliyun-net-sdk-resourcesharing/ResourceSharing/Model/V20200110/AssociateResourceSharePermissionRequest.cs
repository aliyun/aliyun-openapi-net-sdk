...
{
    public class AssociateResourceSharePermissionRequest : RpcAcsRequest<AssociateResourceSharePermissionResponse>
    {
        public AssociateResourceSharePermissionRequest()
            : base("ResourceSharing", "2020-01-10", "AssociateResourceSharePermission", "ressharing", "openAPI")
        {
        ...
        public override AssociateResourceSharePermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssociateResourceSharePermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
