...
{
    public class EnableSharingWithResourceDirectoryRequest : RpcAcsRequest<EnableSharingWithResourceDirectoryResponse>
    {
        public EnableSharingWithResourceDirectoryRequest()
            : base("ResourceSharing", "2020-01-10", "EnableSharingWithResourceDirectory", "ressharing", "openAPI")
        {
        ...
        public override EnableSharingWithResourceDirectoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableSharingWithResourceDirectoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
