...
{
    public class CheckSharingWithResourceDirectoryStatusRequest : RpcAcsRequest<CheckSharingWithResourceDirectoryStatusResponse>
    {
        public CheckSharingWithResourceDirectoryStatusRequest()
            : base("ResourceSharing", "2020-01-10", "CheckSharingWithResourceDirectoryStatus", "ressharing", "openAPI")
        {
        ...
        public override CheckSharingWithResourceDirectoryStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckSharingWithResourceDirectoryStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
