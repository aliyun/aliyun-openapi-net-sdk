...
{
    public class ListResourceShareAssociationsRequest : RpcAcsRequest<ListResourceShareAssociationsResponse>
    {
        public ListResourceShareAssociationsRequest()
            : base("ResourceSharing", "2020-01-10", "ListResourceShareAssociations", "ressharing", "openAPI")
        {
		...
		public string AssociationType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AssociationType", value);
			}
		}
		...
		public string AssociationStatus
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AssociationStatus", value);
			}
		}
        ...
        public override ListResourceShareAssociationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListResourceShareAssociationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
