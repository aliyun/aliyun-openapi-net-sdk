...
{
    public class DisassociateResourceShareRequest : RpcAcsRequest<DisassociateResourceShareResponse>
    {
        public DisassociateResourceShareRequest()
            : base("ResourceSharing", "2020-01-10", "DisassociateResourceShare", "ressharing", "openAPI")
        {
        ...
        public override DisassociateResourceShareResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisassociateResourceShareResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
