...
{
    public class ListSharedTargetsRequest : RpcAcsRequest<ListSharedTargetsResponse>
    {
        public ListSharedTargetsRequest()
            : base("ResourceSharing", "2020-01-10", "ListSharedTargets", "ressharing", "openAPI")
        {
        ...
        public override ListSharedTargetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSharedTargetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
