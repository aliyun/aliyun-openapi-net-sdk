...
{
	public class DisassociateResourceShareResponse : AcsResponse
	{

		private string requestId;

		private List<DisassociateResourceShare_ResourceShareAssociation> resourceShareAssociations;
		...
		public List<DisassociateResourceShare_ResourceShareAssociation> ResourceShareAssociations
		{
			get
			{
		...
		public class DisassociateResourceShare_ResourceShareAssociation
		{
