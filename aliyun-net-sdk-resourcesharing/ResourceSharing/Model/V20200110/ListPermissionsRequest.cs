...
{
    public class ListPermissionsRequest : RpcAcsRequest<ListPermissionsResponse>
    {
        public ListPermissionsRequest()
            : base("ResourceSharing", "2020-01-10", "ListPermissions", "ressharing", "openAPI")
        {
        ...
        public override ListPermissionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPermissionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
