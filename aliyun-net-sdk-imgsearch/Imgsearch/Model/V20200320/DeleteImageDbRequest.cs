...
{
    public class DeleteImageDbRequest : RpcAcsRequest<DeleteImageDbResponse>
    {
        public DeleteImageDbRequest()
            : base("imgsearch", "2020-03-20", "DeleteImageDb", "imgsearch", "openAPI")
        {
        ...
        public override DeleteImageDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteImageDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
