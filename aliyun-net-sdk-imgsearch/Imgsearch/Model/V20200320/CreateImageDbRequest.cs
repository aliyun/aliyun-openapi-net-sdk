...
{
    public class CreateImageDbRequest : RpcAcsRequest<CreateImageDbResponse>
    {
        public CreateImageDbRequest()
            : base("imgsearch", "2020-03-20", "CreateImageDb", "imgsearch", "openAPI")
        {
        ...
        public override CreateImageDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateImageDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
