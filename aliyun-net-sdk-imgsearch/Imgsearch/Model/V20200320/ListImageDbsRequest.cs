...
namespace Aliyun.Acs.imgsearch.Model.V20200320
{
    public class ListImageDbsRequest : RpcAcsRequest<ListImageDbsResponse>
    {
        ...
        public override ListImageDbsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListImageDbsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
