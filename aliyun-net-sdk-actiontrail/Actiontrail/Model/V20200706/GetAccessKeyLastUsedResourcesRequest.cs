...
{
    public class GetAccessKeyLastUsedResourcesRequest : RpcAcsRequest<GetAccessKeyLastUsedResourcesResponse>
    {
        public GetAccessKeyLastUsedResourcesRequest()
            : base("Actiontrail", "2020-07-06", "GetAccessKeyLastUsedResources")
        {
        ...
        public override GetAccessKeyLastUsedResourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAccessKeyLastUsedResourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
