...
{
    public class GetAccessKeyLastUsedIpsRequest : RpcAcsRequest<GetAccessKeyLastUsedIpsResponse>
    {
        public GetAccessKeyLastUsedIpsRequest()
            : base("Actiontrail", "2020-07-06", "GetAccessKeyLastUsedIps")
        {
        ...
        public override GetAccessKeyLastUsedIpsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAccessKeyLastUsedIpsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
