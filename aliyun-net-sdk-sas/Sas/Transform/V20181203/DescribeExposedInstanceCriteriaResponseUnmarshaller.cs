...
namespace Aliyun.Acs.Sas.Transform.V20181203
{
    ...
    {
        public static DescribeExposedInstanceCriteriaResponse Unmarshall(UnmarshallerContext _ctx)
        {
			DescribeExposedInstanceCriteriaResponse describeExposedInstanceCriteriaResponse = new DescribeExposedInstanceCriteriaResponse();

			describeExposedInstanceCriteriaResponse.HttpResponse = _ctx.HttpResponse;
			describeExposedInstanceCriteriaResponse.RequestId = _ctx.StringValue("DescribeExposedInstanceCriteria.RequestId");
			...
			describeExposedInstanceCriteriaResponse.CriteriaList = describeExposedInstanceCriteriaResponse_criteriaList;
