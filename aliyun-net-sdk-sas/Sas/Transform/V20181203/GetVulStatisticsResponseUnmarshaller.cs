...
namespace Aliyun.Acs.Sas.Transform.V20181203
{
    ...
    {
        public static GetVulStatisticsResponse Unmarshall(UnmarshallerContext _ctx)
        {
			GetVulStatisticsResponse getVulStatisticsResponse = new GetVulStatisticsResponse();
