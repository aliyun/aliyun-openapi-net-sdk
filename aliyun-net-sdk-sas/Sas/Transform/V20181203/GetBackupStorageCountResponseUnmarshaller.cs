...
namespace Aliyun.Acs.Sas.Transform.V20181203
{
    ...
    {
        public static GetBackupStorageCountResponse Unmarshall(UnmarshallerContext _ctx)
        {
			GetBackupStorageCountResponse getBackupStorageCountResponse = new GetBackupStorageCountResponse();

			getBackupStorageCountResponse.HttpResponse = _ctx.HttpResponse;
