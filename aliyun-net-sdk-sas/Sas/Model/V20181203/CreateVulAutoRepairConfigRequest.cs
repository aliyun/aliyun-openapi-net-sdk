...
{
    public class CreateVulAutoRepairConfigRequest : RpcAcsRequest<CreateVulAutoRepairConfigResponse>
    {
        public CreateVulAutoRepairConfigRequest()
            : base("Sas", "2018-12-03", "CreateVulAutoRepairConfig")
        {
		...
		public List<VulAutoRepairConfigList> VulAutoRepairConfigLists
		{
			get
			{
				return vulAutoRepairConfigLists;
			}
		...
		public class VulAutoRepairConfigList
		{
        ...
        public override CreateVulAutoRepairConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateVulAutoRepairConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
