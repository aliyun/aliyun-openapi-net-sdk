...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribeCriteriaRequest : RpcAcsRequest<DescribeCriteriaResponse>
    {
        ...
        public override DescribeCriteriaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCriteriaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
