...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribePropertyUserDetailRequest : RpcAcsRequest<DescribePropertyUserDetailResponse>
    {
		...
		public string IsRoot
		{
			...
			{
				isRoot = value;
				DictionaryUtil.Add(QueryParameters, "IsRoot", value);
			}
		}
        ...
        public override DescribePropertyUserDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePropertyUserDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
