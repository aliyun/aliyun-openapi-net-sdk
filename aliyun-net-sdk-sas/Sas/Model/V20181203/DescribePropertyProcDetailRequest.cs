...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribePropertyProcDetailRequest : RpcAcsRequest<DescribePropertyProcDetailResponse>
    {
		...
		public string Cmdline
		{
			...
			{
				cmdline = value;
				DictionaryUtil.Add(QueryParameters, "Cmdline", value);
			}
		}
        ...
        public override DescribePropertyProcDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePropertyProcDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
