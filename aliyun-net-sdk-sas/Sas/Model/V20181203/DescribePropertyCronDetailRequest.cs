...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribePropertyCronDetailRequest : RpcAcsRequest<DescribePropertyCronDetailResponse>
    {
        ...
        public override DescribePropertyCronDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePropertyCronDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
