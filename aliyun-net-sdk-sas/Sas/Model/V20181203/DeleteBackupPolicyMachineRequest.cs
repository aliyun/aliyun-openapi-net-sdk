...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DeleteBackupPolicyMachineRequest : RpcAcsRequest<DeleteBackupPolicyMachineResponse>
    {
        ...
        public override DeleteBackupPolicyMachineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteBackupPolicyMachineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
