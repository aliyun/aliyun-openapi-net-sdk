...
{
    public class CreateAntiBruteForceRuleRequest : RpcAcsRequest<CreateAntiBruteForceRuleResponse>
    {
        public CreateAntiBruteForceRuleRequest()
            : base("Sas", "2018-12-03", "CreateAntiBruteForceRule", "sas", "openAPI")
        {
        ...
        public override CreateAntiBruteForceRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateAntiBruteForceRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
