...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribeGroupedInstancesRequest : RpcAcsRequest<DescribeGroupedInstancesResponse>
    {
        ...
        public override DescribeGroupedInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGroupedInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
