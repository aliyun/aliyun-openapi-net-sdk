...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class ModifyBackupPolicyStatusRequest : RpcAcsRequest<ModifyBackupPolicyStatusResponse>
    {
        ...
        public override ModifyBackupPolicyStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyBackupPolicyStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
