...
{
    public class DescribeAffectedMaliciousFileImagesRequest : RpcAcsRequest<DescribeAffectedMaliciousFileImagesResponse>
    {
        public DescribeAffectedMaliciousFileImagesRequest()
            : base("Sas", "2018-12-03", "DescribeAffectedMaliciousFileImages", "sas", "openAPI")
        {
		...
		public string MaliciousMd5
		{
			...
			{
				maliciousMd5 = value;
				DictionaryUtil.Add(QueryParameters, "MaliciousMd5", value);
			}
		}
        ...
        public override DescribeAffectedMaliciousFileImagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAffectedMaliciousFileImagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
