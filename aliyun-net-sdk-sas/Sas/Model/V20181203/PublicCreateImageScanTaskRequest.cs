...
{
    public class PublicCreateImageScanTaskRequest : RpcAcsRequest<PublicCreateImageScanTaskResponse>
    {
        public PublicCreateImageScanTaskRequest()
            : base("Sas", "2018-12-03", "PublicCreateImageScanTask")
        {
        ...
        public override PublicCreateImageScanTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PublicCreateImageScanTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
