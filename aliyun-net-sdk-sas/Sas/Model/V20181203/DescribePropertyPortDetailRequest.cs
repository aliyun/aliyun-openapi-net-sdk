...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribePropertyPortDetailRequest : RpcAcsRequest<DescribePropertyPortDetailResponse>
    {
		...
		public string ProcName
		{
			...
			{
				procName = value;
				DictionaryUtil.Add(QueryParameters, "ProcName", value);
			}
		}
        ...
        public override DescribePropertyPortDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePropertyPortDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
