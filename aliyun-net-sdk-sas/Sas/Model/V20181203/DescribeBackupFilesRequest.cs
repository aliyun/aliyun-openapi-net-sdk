...
namespace Aliyun.Acs.Sas.Model.V20181203
{
    public class DescribeBackupFilesRequest : RpcAcsRequest<DescribeBackupFilesResponse>
    {
        ...
        public override DescribeBackupFilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupFilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
