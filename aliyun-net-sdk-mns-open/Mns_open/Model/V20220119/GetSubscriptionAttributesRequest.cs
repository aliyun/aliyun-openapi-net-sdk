...
{
    public class GetSubscriptionAttributesRequest : RpcAcsRequest<GetSubscriptionAttributesResponse>
    {
        public GetSubscriptionAttributesRequest()
            : base("Mns-open", "2022-01-19", "GetSubscriptionAttributes", "mns", "openAPI")
        {
        ...
        public override GetSubscriptionAttributesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSubscriptionAttributesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
