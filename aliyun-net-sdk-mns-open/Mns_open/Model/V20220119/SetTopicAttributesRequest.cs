...
{
    public class SetTopicAttributesRequest : RpcAcsRequest<SetTopicAttributesResponse>
    {
        public SetTopicAttributesRequest()
            : base("Mns-open", "2022-01-19", "SetTopicAttributes", "mns", "openAPI")
        {
		...
		public long? MaxMessageSize
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MaxMessageSize", value.ToString());
			}
		}
        ...
        public override SetTopicAttributesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetTopicAttributesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
