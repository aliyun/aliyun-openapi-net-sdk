...
{
    public class ListQueueRequest : RpcAcsRequest<ListQueueResponse>
    {
        public ListQueueRequest()
            : base("Mns-open", "2022-01-19", "ListQueue", "mns", "openAPI")
        {
        ...
        public override ListQueueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListQueueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
