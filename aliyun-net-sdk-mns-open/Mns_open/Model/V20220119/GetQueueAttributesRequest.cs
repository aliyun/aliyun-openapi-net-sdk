...
{
    public class GetQueueAttributesRequest : RpcAcsRequest<GetQueueAttributesResponse>
    {
        public GetQueueAttributesRequest()
            : base("Mns-open", "2022-01-19", "GetQueueAttributes", "mns", "openAPI")
        {
        ...
        public override GetQueueAttributesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQueueAttributesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
