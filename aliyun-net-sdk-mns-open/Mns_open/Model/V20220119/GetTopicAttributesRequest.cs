...
{
    public class GetTopicAttributesRequest : RpcAcsRequest<GetTopicAttributesResponse>
    {
        public GetTopicAttributesRequest()
            : base("Mns-open", "2022-01-19", "GetTopicAttributes", "mns", "openAPI")
        {
        ...
        public override GetTopicAttributesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTopicAttributesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
