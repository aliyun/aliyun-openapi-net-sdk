...
{
    public class UnsubscribeRequest : RpcAcsRequest<UnsubscribeResponse>
    {
        public UnsubscribeRequest()
            : base("Mns-open", "2022-01-19", "Unsubscribe", "mns", "openAPI")
        {
        ...
        public override UnsubscribeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnsubscribeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
