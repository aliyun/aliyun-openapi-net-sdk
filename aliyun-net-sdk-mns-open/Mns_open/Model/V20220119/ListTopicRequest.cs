...
{
    public class ListTopicRequest : RpcAcsRequest<ListTopicResponse>
    {
        public ListTopicRequest()
            : base("Mns-open", "2022-01-19", "ListTopic", "mns", "openAPI")
        {
        ...
        public override ListTopicResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTopicResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
