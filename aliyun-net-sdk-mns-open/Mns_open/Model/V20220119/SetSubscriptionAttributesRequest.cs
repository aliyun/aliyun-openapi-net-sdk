...
{
    public class SetSubscriptionAttributesRequest : RpcAcsRequest<SetSubscriptionAttributesResponse>
    {
        public SetSubscriptionAttributesRequest()
            : base("Mns-open", "2022-01-19", "SetSubscriptionAttributes", "mns", "openAPI")
        {
        ...
        public override SetSubscriptionAttributesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetSubscriptionAttributesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
