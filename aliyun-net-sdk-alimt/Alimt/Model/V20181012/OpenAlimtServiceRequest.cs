...
{
    public class OpenAlimtServiceRequest : RpcAcsRequest<OpenAlimtServiceResponse>
    {
        public OpenAlimtServiceRequest()
            : base("alimt", "2018-10-12", "OpenAlimtService")
        {
        ...
        public override OpenAlimtServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenAlimtServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
