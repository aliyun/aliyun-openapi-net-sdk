...
{
    public class GetBatchTranslateRequest : RpcAcsRequest<GetBatchTranslateResponse>
    {
        public GetBatchTranslateRequest()
            : base("alimt", "2018-10-12", "GetBatchTranslate", "alimt", "openAPI")
        {
        ...
        public override GetBatchTranslateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetBatchTranslateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
