...
namespace Aliyun.Acs.vod.Transform.V20170321
{
    ...
    {
        public static DescribeVodDomainRealTimeQpsDataResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			describeVodDomainRealTimeQpsDataResponse.HttpResponse = _ctx.HttpResponse;
			describeVodDomainRealTimeQpsDataResponse.RequestId = _ctx.StringValue("DescribeVodDomainRealTimeQpsData.RequestId");
			...
			for (int i = 0; i < _ctx.Length("DescribeVodDomainRealTimeQpsData.Data.Length"); i++) {
				...
				qpsModel.Qps = _ctx.FloatValue("DescribeVodDomainRealTimeQpsData.Data["+ i +"].Qps");
				qpsModel.TimeStamp = _ctx.StringValue("DescribeVodDomainRealTimeQpsData.Data["+ i +"].TimeStamp");
