...
namespace Aliyun.Acs.vod.Transform.V20170321
{
    ...
    {
        public static UploadStreamByURLResponse Unmarshall(UnmarshallerContext _ctx)
        {
			UploadStreamByURLResponse uploadStreamByURLResponse = new UploadStreamByURLResponse();
