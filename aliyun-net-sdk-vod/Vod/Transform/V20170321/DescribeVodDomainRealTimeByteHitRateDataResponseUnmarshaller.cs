...
namespace Aliyun.Acs.vod.Transform.V20170321
{
    ...
    {
        public static DescribeVodDomainRealTimeByteHitRateDataResponse Unmarshall(UnmarshallerContext context)
        {
			...
			describeVodDomainRealTimeByteHitRateDataResponse.HttpResponse = context.HttpResponse;
			describeVodDomainRealTimeByteHitRateDataResponse.RequestId = context.StringValue("DescribeVodDomainRealTimeByteHitRateData.RequestId");
			...
			for (int i = 0; i < context.Length("DescribeVodDomainRealTimeByteHitRateData.Data.Length"); i++) {
				...
				byteHitRateDataModel.ByteHitRate = context.FloatValue("DescribeVodDomainRealTimeByteHitRateData.Data["+ i +"].ByteHitRate");
				byteHitRateDataModel.TimeStamp = context.StringValue("DescribeVodDomainRealTimeByteHitRateData.Data["+ i +"].TimeStamp");
