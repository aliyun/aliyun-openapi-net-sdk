...
namespace Aliyun.Acs.vod.Model.V20170321
{
    public class SubmitAICaptionExtractionJobRequest : RpcAcsRequest<SubmitAICaptionExtractionJobResponse>
    {
        ...
        public override SubmitAICaptionExtractionJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitAICaptionExtractionJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
