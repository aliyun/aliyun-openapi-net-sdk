...
{
    public class SubmitLiveEditingRequest : RpcAcsRequest<SubmitLiveEditingResponse>
    {
        public SubmitLiveEditingRequest()
            : base("vod", "2017-03-21", "SubmitLiveEditing", "vod", "openAPI")
        {
		...
		public string Clips
		{
			...
			{
				clips = value;
				DictionaryUtil.Add(QueryParameters, "Clips", value);
			}
		}
        ...
        public override SubmitLiveEditingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitLiveEditingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
