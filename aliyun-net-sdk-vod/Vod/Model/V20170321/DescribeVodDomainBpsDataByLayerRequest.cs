...
{
    public class DescribeVodDomainBpsDataByLayerRequest : RpcAcsRequest<DescribeVodDomainBpsDataByLayerResponse>
    {
        public DescribeVodDomainBpsDataByLayerRequest()
            : base("vod", "2017-03-21", "DescribeVodDomainBpsDataByLayer", "vod", "openAPI")
        {
        ...
        public override DescribeVodDomainBpsDataByLayerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeVodDomainBpsDataByLayerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
