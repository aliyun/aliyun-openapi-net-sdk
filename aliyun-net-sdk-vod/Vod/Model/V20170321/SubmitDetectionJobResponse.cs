...
{
	public class SubmitDetectionJobResponse : AcsResponse
	{

		private string requestId;

		private SubmitDetectionJob_DetectionJob detectionJob;
		...
		public SubmitDetectionJob_DetectionJob DetectionJob
		{
			get
			{
				return detectionJob;
		...
		public class SubmitDetectionJob_DetectionJob
		{
