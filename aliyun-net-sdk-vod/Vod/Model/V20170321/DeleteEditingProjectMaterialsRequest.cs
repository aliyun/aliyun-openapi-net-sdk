...
{
    public class DeleteEditingProjectMaterialsRequest : RpcAcsRequest<DeleteEditingProjectMaterialsResponse>
    {
        public DeleteEditingProjectMaterialsRequest()
            : base("vod", "2017-03-21", "DeleteEditingProjectMaterials", "vod", "openAPI")
        {
        ...
        public override DeleteEditingProjectMaterialsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEditingProjectMaterialsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
