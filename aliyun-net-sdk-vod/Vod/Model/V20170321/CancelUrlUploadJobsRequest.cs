...
{
    public class CancelUrlUploadJobsRequest : RpcAcsRequest<CancelUrlUploadJobsResponse>
    {
        public CancelUrlUploadJobsRequest()
            : base("vod", "2017-03-21", "CancelUrlUploadJobs", "vod", "openAPI")
        {
        ...
        public override CancelUrlUploadJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelUrlUploadJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
