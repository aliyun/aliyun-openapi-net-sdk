...
{
    public class UpdateDetectionTemplateRequest : RpcAcsRequest<UpdateDetectionTemplateResponse>
    {
        public UpdateDetectionTemplateRequest()
            : base("vod", "2017-03-21", "UpdateDetectionTemplate", "vod", "openAPI")
        {
        ...
        public override UpdateDetectionTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDetectionTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
