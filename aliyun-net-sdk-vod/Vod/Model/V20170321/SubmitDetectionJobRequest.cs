...
{
    public class SubmitDetectionJobRequest : RpcAcsRequest<SubmitDetectionJobResponse>
    {
        public SubmitDetectionJobRequest()
            : base("vod", "2017-03-21", "SubmitDetectionJob", "vod", "openAPI")
        {
		...
		public string WhiteListUrls
		{
			...
			{
				whiteListUrls = value;
				DictionaryUtil.Add(QueryParameters, "WhiteListUrls", value);
			}
		}
		...
		public string CopyrightEndTime
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CopyrightEndTime", value);
			}
		}
		...
		public string CopyrightStatus
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CopyrightStatus", value);
			}
		}
		...
		public string CopyrightBeginTime
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CopyrightBeginTime", value);
			}
		}
		...
		public bool? ShortVideo
		{
			...
			{
				shortVideo = value;
				DictionaryUtil.Add(QueryParameters, "ShortVideo", value.ToString());
			}
		}
		...
		public string CopyrightFile
		{
			...
			{
				copyrightFile = value;
				DictionaryUtil.Add(QueryParameters, "CopyrightFile", value);
			}
		}
        ...
        public override SubmitDetectionJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitDetectionJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
