...
{
    public class GetMediaRefreshJobsRequest : RpcAcsRequest<GetMediaRefreshJobsResponse>
    {
        public GetMediaRefreshJobsRequest()
            : base("vod", "2017-03-21", "GetMediaRefreshJobs", "vod", "openAPI")
        {
		...
		public string MediaRefreshJobId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MediaRefreshJobId", value);
			}
		}
        ...
        public override GetMediaRefreshJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMediaRefreshJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
