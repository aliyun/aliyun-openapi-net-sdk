...
{
    public class CreateDetectionTemplateRequest : RpcAcsRequest<CreateDetectionTemplateResponse>
    {
        public CreateDetectionTemplateRequest()
            : base("vod", "2017-03-21", "CreateDetectionTemplate", "vod", "openAPI")
        {
        ...
        public override CreateDetectionTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDetectionTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
