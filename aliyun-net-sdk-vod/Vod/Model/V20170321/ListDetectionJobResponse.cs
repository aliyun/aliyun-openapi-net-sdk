...
{
	public class ListDetectionJobResponse : AcsResponse
	{

		private string requestId;

		private List<ListDetectionJob_DetectionJob> detectionJobList;
		...
		public List<ListDetectionJob_DetectionJob> DetectionJobList
		{
			get
			{
			...
			set	
			{
				detectionJobList = value;
			}
		}

		public class ListDetectionJob_DetectionJob
		{
