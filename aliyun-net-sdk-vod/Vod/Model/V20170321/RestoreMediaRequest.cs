...
{
    public class RestoreMediaRequest : RpcAcsRequest<RestoreMediaResponse>
    {
        public RestoreMediaRequest()
            : base("vod", "2017-03-21", "RestoreMedia", "vod", "openAPI")
        {
		...
		public string RestoreDays
		{
			...
			{
				restoreDays = value;
				DictionaryUtil.Add(QueryParameters, "RestoreDays", value);
			}
		}
        ...
        public override RestoreMediaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestoreMediaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
