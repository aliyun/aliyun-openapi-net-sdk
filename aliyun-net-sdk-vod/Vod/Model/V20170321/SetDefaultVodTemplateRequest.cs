...
namespace Aliyun.Acs.vod.Model.V20170321
{
    public class SetDefaultVodTemplateRequest : RpcAcsRequest<SetDefaultVodTemplateResponse>
    {
        ...
        public override SetDefaultVodTemplateResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return SetDefaultVodTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}