...
{
    public class SetCrossdomainContentRequest : RpcAcsRequest<SetCrossdomainContentResponse>
    {
        public SetCrossdomainContentRequest()
            : base("vod", "2017-03-21", "SetCrossdomainContent", "vod", "openAPI")
        {
		...
		public string ResourceRealOwnerId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ResourceRealOwnerId", value);
			}
		}
        ...
        public override SetCrossdomainContentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetCrossdomainContentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
