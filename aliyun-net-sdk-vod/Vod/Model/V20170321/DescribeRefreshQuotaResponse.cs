...
namespace Aliyun.Acs.vod.Model.V20170321
{
	public class DescribeRefreshQuotaResponse : AcsResponse
	{
		...
		private DescribeRefreshQuota_RefreshCacheQuota refreshCacheQuota;
		...
		public DescribeRefreshQuota_RefreshCacheQuota RefreshCacheQuota
		{
			get
			{
			...
			set	
			{
				refreshCacheQuota = value;
			}
		}

		public class DescribeRefreshQuota_RefreshCacheQuota
		{
