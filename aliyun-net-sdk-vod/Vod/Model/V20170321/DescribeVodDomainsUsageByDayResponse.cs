...
{
	public class DescribeVodDomainsUsageByDayResponse : AcsResponse
	{
		...
		private List<DescribeVodDomainsUsageByDay_UsageByDay> usageByDays;

		private DescribeVodDomainsUsageByDay_UsageTotal usageTotal;
		...
		public List<DescribeVodDomainsUsageByDay_UsageByDay> UsageByDays
		{
			get
			{
				return usageByDays;
		...
		public DescribeVodDomainsUsageByDay_UsageTotal UsageTotal
		{
			get
			{
				return usageTotal;
		...
		public class DescribeVodDomainsUsageByDay_UsageByDay
		{
		...
		public class DescribeVodDomainsUsageByDay_UsageTotal
		{
