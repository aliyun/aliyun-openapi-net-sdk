...
{
	public class UpdateDetectionJobResponse : AcsResponse
	{

		private string requestId;

		private UpdateDetectionJob_DetectionJob detectionJob;
		...
		public UpdateDetectionJob_DetectionJob DetectionJob
		{
			get
			{
				return detectionJob;
		...
		public class UpdateDetectionJob_DetectionJob
		{
