...
{
	public class DescribeVodServiceResponse : AcsResponse
	{
		...
		private List<DescribeVodService_LockReason> operationLocks;
		...
		public List<DescribeVodService_LockReason> OperationLocks
		{
			get
			{
		...
		public class DescribeVodService_LockReason
		{
