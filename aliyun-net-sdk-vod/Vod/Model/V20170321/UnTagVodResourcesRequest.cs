...
{
    public class UnTagVodResourcesRequest : RpcAcsRequest<UnTagVodResourcesResponse>
    {
        public UnTagVodResourcesRequest()
            : base("vod", "2017-03-21", "UnTagVodResources", "vod", "openAPI")
        {
        ...
        public override UnTagVodResourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnTagVodResourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
