...
namespace Aliyun.Acs.vod.Model.V20170321
{
    public class ListDetectionJobRequest : RpcAcsRequest<ListDetectionJobResponse>
    {
        ...
        public override ListDetectionJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDetectionJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
