    ...
    public class GetSecretParameterRequest : RpcAcsRequest<GetSecretParameterResponse>
    {
		...
		public int? ParameterVersion
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ParameterVersion", value.ToString());
			}
		}
        ...
        public override GetSecretParameterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSecretParameterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
