...
{
    public class DeletePatchBaselineRequest : RpcAcsRequest<DeletePatchBaselineResponse>
    {
        public DeletePatchBaselineRequest()
            : base("oos", "2019-06-01", "DeletePatchBaseline", "oos", "openAPI")
        {
        ...
        public override DeletePatchBaselineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePatchBaselineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
