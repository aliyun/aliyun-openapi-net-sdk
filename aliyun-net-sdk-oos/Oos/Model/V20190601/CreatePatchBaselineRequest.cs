...
{
    public class CreatePatchBaselineRequest : RpcAcsRequest<CreatePatchBaselineResponse>
    {
        public CreatePatchBaselineRequest()
            : base("oos", "2019-06-01", "CreatePatchBaseline", "oos", "openAPI")
        {
		...
		public string OperationSystem
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "OperationSystem", value);
			}
		}
        ...
        public override CreatePatchBaselineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePatchBaselineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
