...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class GetParameterRequest : RpcAcsRequest<GetParameterResponse>
    {
        ...
        public override GetParameterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetParameterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
