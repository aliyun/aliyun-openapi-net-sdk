...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class UpdateStateConfigurationRequest : RpcAcsRequest<UpdateStateConfigurationResponse>
    {
        ...
        public override UpdateStateConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateStateConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
