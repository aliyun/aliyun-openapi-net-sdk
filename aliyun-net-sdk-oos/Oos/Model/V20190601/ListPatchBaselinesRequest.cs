...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class ListPatchBaselinesRequest : RpcAcsRequest<ListPatchBaselinesResponse>
    {
        ...
        public override ListPatchBaselinesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPatchBaselinesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
