...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class ListInstancePatchesRequest : RpcAcsRequest<ListInstancePatchesResponse>
    {
        ...
        public override ListInstancePatchesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListInstancePatchesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
