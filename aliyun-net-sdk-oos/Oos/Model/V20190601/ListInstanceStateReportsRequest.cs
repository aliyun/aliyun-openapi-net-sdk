...
{
    public class ListInstanceStateReportsRequest : RpcAcsRequest<ListInstanceStateReportsResponse>
    {
        public ListInstanceStateReportsRequest()
            : base("oos", "2019-06-01", "ListInstanceStateReports", "oos", "openAPI")
        {
		...
		public string StateConfigurationId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "StateConfigurationId", value);
			}
		}
        ...
        public override ListInstanceStateReportsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListInstanceStateReportsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
