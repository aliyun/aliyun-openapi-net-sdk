...
{
    public class GetSecretParametersRequest : RpcAcsRequest<GetSecretParametersResponse>
    {
        public GetSecretParametersRequest()
            : base("oos", "2019-06-01", "GetSecretParameters", "oos", "openAPI")
        {
        ...
        public override GetSecretParametersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSecretParametersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
