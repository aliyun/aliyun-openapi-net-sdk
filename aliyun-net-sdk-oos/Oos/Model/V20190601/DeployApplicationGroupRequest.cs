...
{
    public class DeployApplicationGroupRequest : RpcAcsRequest<DeployApplicationGroupResponse>
    {
        public DeployApplicationGroupRequest()
            : base("oos", "2019-06-01", "DeployApplicationGroup", "oos", "openAPI")
        {
        ...
        public override DeployApplicationGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeployApplicationGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
