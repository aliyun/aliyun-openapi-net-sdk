...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class UpdateSecretParameterRequest : RpcAcsRequest<UpdateSecretParameterResponse>
    {
        ...
        public override UpdateSecretParameterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateSecretParameterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
