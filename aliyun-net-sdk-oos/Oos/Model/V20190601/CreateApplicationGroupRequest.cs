...
{
    public class CreateApplicationGroupRequest : RpcAcsRequest<CreateApplicationGroupResponse>
    {
        public CreateApplicationGroupRequest()
            : base("oos", "2019-06-01", "CreateApplicationGroup", "oos", "openAPI")
        {
		...
		public string CmsGroupId
		{
			...
			{
				cmsGroupId = value;
				DictionaryUtil.Add(QueryParameters, "CmsGroupId", value);
			}
		}
		...
		public string ImportTagValue
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ImportTagValue", value);
			}
		}
		...
		public string ImportTagKey
		{
			...
			{
				importTagKey = value;
				DictionaryUtil.Add(QueryParameters, "ImportTagKey", value);
			}
		}
        ...
        public override CreateApplicationGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateApplicationGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
