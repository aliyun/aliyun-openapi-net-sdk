...
{
    public class GetPatchBaselineRequest : RpcAcsRequest<GetPatchBaselineResponse>
    {
        public GetPatchBaselineRequest()
            : base("oos", "2019-06-01", "GetPatchBaseline", "oos", "openAPI")
        {
        ...
        public override GetPatchBaselineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPatchBaselineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
