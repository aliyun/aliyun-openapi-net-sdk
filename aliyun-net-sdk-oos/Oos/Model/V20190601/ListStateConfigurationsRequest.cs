...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class ListStateConfigurationsRequest : RpcAcsRequest<ListStateConfigurationsResponse>
    {
        ...
        public override ListStateConfigurationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListStateConfigurationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
