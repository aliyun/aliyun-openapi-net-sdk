...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class ListSecretParametersRequest : RpcAcsRequest<ListSecretParametersResponse>
    {
        ...
        public override ListSecretParametersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSecretParametersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
