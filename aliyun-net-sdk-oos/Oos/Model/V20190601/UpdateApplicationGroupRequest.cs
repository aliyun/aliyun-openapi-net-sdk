...
{
    public class UpdateApplicationGroupRequest : RpcAcsRequest<UpdateApplicationGroupResponse>
    {
        public UpdateApplicationGroupRequest()
            : base("oos", "2019-06-01", "UpdateApplicationGroup", "oos", "openAPI")
        {
		...
		public string NewName
		{
			...
			{
				newName = value;
				DictionaryUtil.Add(QueryParameters, "NewName", value);
			}
		}
        ...
        public override UpdateApplicationGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateApplicationGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
