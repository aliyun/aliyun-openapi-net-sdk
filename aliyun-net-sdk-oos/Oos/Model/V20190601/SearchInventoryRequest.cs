...
namespace Aliyun.Acs.oos.Model.V20190601
{
    public class SearchInventoryRequest : RpcAcsRequest<SearchInventoryResponse>
    {
        ...
        public override SearchInventoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchInventoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
