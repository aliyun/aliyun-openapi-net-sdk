...
{
    public class ContinueDeployApplicationGroupRequest : RpcAcsRequest<ContinueDeployApplicationGroupResponse>
    {
        public ContinueDeployApplicationGroupRequest()
            : base("oos", "2019-06-01", "ContinueDeployApplicationGroup", "oos", "openAPI")
        {
		...
		public string DeployParameters
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "DeployParameters", value);
			}
		}
        ...
        public override ContinueDeployApplicationGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ContinueDeployApplicationGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
