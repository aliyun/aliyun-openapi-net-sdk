...
namespace Aliyun.Acs.oos.Transform.V20190601
{
    public class GetApplicationResponseUnmarshaller
    {
        public static GetApplicationResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			application.ResourceGroupId = _ctx.StringValue("GetApplication.Application.ResourceGroupId");
			application.Tags = _ctx.StringValue("GetApplication.Application.Tags");
