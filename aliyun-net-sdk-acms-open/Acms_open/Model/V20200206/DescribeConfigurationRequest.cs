...
{
    public class DescribeConfigurationRequest : RoaAcsRequest<DescribeConfigurationResponse>
    {
        public DescribeConfigurationRequest()
            : base("acms-open", "2020-02-06", "DescribeConfiguration", "acms", "openAPI")
        {
        ...
        public override DescribeConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
