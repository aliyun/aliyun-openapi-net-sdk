...
{
    public class DeleteConfigurationRequest : RoaAcsRequest<DeleteConfigurationResponse>
    {
        public DeleteConfigurationRequest()
            : base("acms-open", "2020-02-06", "DeleteConfiguration", "acms", "openAPI")
        {
        ...
        public override DeleteConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
