...
{
    public class DeployConfigurationRequest : RoaAcsRequest<DeployConfigurationResponse>
    {
        public DeployConfigurationRequest()
            : base("acms-open", "2020-02-06", "DeployConfiguration", "acms", "openAPI")
        {
        ...
        public override DeployConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeployConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
