...
{
    public class UpdateProjectRequest : RoaAcsRequest<UpdateProjectResponse>
    {
        public UpdateProjectRequest()
            : base("foas", "2018-11-11", "UpdateProject", "foas", "openAPI")
        {
		...
		public string GlobalJobConfig
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "globalJobConfig", value);
			}
		}
