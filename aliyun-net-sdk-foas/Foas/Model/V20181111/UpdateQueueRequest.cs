...
{
    public class UpdateQueueRequest : RoaAcsRequest<UpdateQueueResponse>
    {
        public UpdateQueueRequest()
            : base("foas", "2018-11-11", "UpdateQueue", "foas", "openAPI")
        {
        ...
        public override UpdateQueueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateQueueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
