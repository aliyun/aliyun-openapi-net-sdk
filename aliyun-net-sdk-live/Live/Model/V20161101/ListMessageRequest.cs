...
{
    public class ListMessageRequest : RpcAcsRequest<ListMessageResponse>
    {
        public ListMessageRequest()
            : base("live", "2016-11-01", "ListMessage", "live", "openAPI")
        {
        ...
        public override ListMessageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMessageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
