...
{
    public class DescribeRTSNativeSDKVvDataRequest : RpcAcsRequest<DescribeRTSNativeSDKVvDataResponse>
    {
        public DescribeRTSNativeSDKVvDataRequest()
            : base("live", "2016-11-01", "DescribeRTSNativeSDKVvData", "live", "openAPI")
        {
        ...
        public override DescribeRTSNativeSDKVvDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRTSNativeSDKVvDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
