...
{
    public class AddLiveASRConfigRequest : RpcAcsRequest<AddLiveASRConfigResponse>
    {
        public AddLiveASRConfigRequest()
            : base("live", "2016-11-01", "AddLiveASRConfig", "live", "openAPI")
        {
        ...
        public override AddLiveASRConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddLiveASRConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
