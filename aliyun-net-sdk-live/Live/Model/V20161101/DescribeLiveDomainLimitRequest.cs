...
namespace Aliyun.Acs.live.Model.V20161101
{
    public class DescribeLiveDomainLimitRequest : RpcAcsRequest<DescribeLiveDomainLimitResponse>
    {
        ...
        public override DescribeLiveDomainLimitResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLiveDomainLimitResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
