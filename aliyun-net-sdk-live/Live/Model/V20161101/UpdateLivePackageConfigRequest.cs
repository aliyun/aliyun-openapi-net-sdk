...
{
    public class UpdateLivePackageConfigRequest : RpcAcsRequest<UpdateLivePackageConfigResponse>
    {
        public UpdateLivePackageConfigRequest()
            : base("live", "2016-11-01", "UpdateLivePackageConfig", "live", "openAPI")
        {
        ...
        public override UpdateLivePackageConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateLivePackageConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
