...
{
    public class LeaveMessageGroupRequest : RpcAcsRequest<LeaveMessageGroupResponse>
    {
        public LeaveMessageGroupRequest()
            : base("live", "2016-11-01", "LeaveMessageGroup", "live", "openAPI")
        {
        ...
        public override LeaveMessageGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LeaveMessageGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
