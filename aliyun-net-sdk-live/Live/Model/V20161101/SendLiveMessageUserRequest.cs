...
{
    public class SendLiveMessageUserRequest : RpcAcsRequest<SendLiveMessageUserResponse>
    {
        public SendLiveMessageUserRequest()
            : base("live", "2016-11-01", "SendLiveMessageUser", "live", "openAPI")
        {
		...
		public string SenderInfo
		{
			...
			{
				senderInfo = value;
				DictionaryUtil.Add(QueryParameters, "SenderInfo", value);
			}
		}
        ...
        public override SendLiveMessageUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SendLiveMessageUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
