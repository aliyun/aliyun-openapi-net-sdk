...
{
    public class DescribeRTSNativeSDKFirstFrameDelayRequest : RpcAcsRequest<DescribeRTSNativeSDKFirstFrameDelayResponse>
    {
        public DescribeRTSNativeSDKFirstFrameDelayRequest()
            : base("live", "2016-11-01", "DescribeRTSNativeSDKFirstFrameDelay", "live", "openAPI")
        {
        ...
        public override DescribeRTSNativeSDKFirstFrameDelayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRTSNativeSDKFirstFrameDelayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
