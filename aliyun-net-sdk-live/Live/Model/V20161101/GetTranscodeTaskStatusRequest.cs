...
{
    public class GetTranscodeTaskStatusRequest : RpcAcsRequest<GetTranscodeTaskStatusResponse>
    {
        public GetTranscodeTaskStatusRequest()
            : base("live", "2016-11-01", "GetTranscodeTaskStatus", "live", "openAPI")
        {
        ...
        public override GetTranscodeTaskStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTranscodeTaskStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
