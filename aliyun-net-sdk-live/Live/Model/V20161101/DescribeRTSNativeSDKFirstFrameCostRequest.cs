...
{
    public class DescribeRTSNativeSDKFirstFrameCostRequest : RpcAcsRequest<DescribeRTSNativeSDKFirstFrameCostResponse>
    {
        public DescribeRTSNativeSDKFirstFrameCostRequest()
            : base("live", "2016-11-01", "DescribeRTSNativeSDKFirstFrameCost", "live", "openAPI")
        {
        ...
        public override DescribeRTSNativeSDKFirstFrameCostResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRTSNativeSDKFirstFrameCostResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
