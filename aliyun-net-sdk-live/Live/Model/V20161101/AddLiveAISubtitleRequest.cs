...
{
    public class AddLiveAISubtitleRequest : RpcAcsRequest<AddLiveAISubtitleResponse>
    {
        public AddLiveAISubtitleRequest()
            : base("live", "2016-11-01", "AddLiveAISubtitle", "live", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "CopyFrom")]
		public string CopyFrom
		{
			...
			{
				copyFrom = value;
				DictionaryUtil.Add(QueryParameters, "CopyFrom", value);
			}
		}

        public override AddLiveAISubtitleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddLiveAISubtitleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
