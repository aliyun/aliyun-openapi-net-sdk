...
{
	public class GetEdgeTranscodeJobResponse : AcsResponse
	{

		private string requestId;

		private GetEdgeTranscodeJob_Job job;
		...
		public GetEdgeTranscodeJob_Job Job
		{
			get
			{
				return job;
		...
		public class GetEdgeTranscodeJob_Job
		{
