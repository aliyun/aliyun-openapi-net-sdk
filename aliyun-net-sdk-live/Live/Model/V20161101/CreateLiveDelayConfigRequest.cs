...
{
    public class CreateLiveDelayConfigRequest : RpcAcsRequest<CreateLiveDelayConfigResponse>
    {
        public CreateLiveDelayConfigRequest()
            : base("live", "2016-11-01", "CreateLiveDelayConfig", "live", "openAPI")
        {
        ...
        public override CreateLiveDelayConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLiveDelayConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
