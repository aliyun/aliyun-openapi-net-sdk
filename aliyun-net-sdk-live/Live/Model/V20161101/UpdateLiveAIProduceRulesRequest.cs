...
{
    public class UpdateLiveAIProduceRulesRequest : RpcAcsRequest<UpdateLiveAIProduceRulesResponse>
    {
        public UpdateLiveAIProduceRulesRequest()
            : base("live", "2016-11-01", "UpdateLiveAIProduceRules", "live", "openAPI")
        {
		...
		public bool? IsLazy
		{
			...
			{
				isLazy = value;
				DictionaryUtil.Add(QueryParameters, "IsLazy", value.ToString());
			}
		}
		...
		public string LiveTemplate
		{
			...
			{
				liveTemplate = value;
				DictionaryUtil.Add(QueryParameters, "LiveTemplate", value);
			}
		}
        ...
        public override UpdateLiveAIProduceRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateLiveAIProduceRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
