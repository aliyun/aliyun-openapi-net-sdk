...
{
    public class UpdateEdgeTranscodeJobRequest : RpcAcsRequest<UpdateEdgeTranscodeJobResponse>
    {
        public UpdateEdgeTranscodeJobRequest()
            : base("live", "2016-11-01", "UpdateEdgeTranscodeJob", "live", "openAPI")
        {
        ...
        public override UpdateEdgeTranscodeJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEdgeTranscodeJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
