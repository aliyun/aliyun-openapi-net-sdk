...
{
    public class ListMessageGroupUserRequest : RpcAcsRequest<ListMessageGroupUserResponse>
    {
        public ListMessageGroupUserRequest()
            : base("live", "2016-11-01", "ListMessageGroupUser", "live", "openAPI")
        {
        ...
        public override ListMessageGroupUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMessageGroupUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
