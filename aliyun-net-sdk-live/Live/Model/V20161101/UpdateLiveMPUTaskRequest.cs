...
{
    public class UpdateLiveMPUTaskRequest : RpcAcsRequest<UpdateLiveMPUTaskResponse>
    {
        public UpdateLiveMPUTaskRequest()
            : base("live", "2016-11-01", "UpdateLiveMPUTask", "live", "openAPI")
        {
        ...
        public override UpdateLiveMPUTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateLiveMPUTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
