...
namespace Aliyun.Acs.live.Transform.V20161101
{
    ...
    {
        public static CreateLiveMessageAppResponse Unmarshall(UnmarshallerContext _ctx)
        {
			CreateLiveMessageAppResponse createLiveMessageAppResponse = new CreateLiveMessageAppResponse();

			createLiveMessageAppResponse.HttpResponse = _ctx.HttpResponse;
			createLiveMessageAppResponse.RequestId = _ctx.StringValue("CreateLiveMessageApp.RequestId");
