...
namespace Aliyun.Acs.live.Transform.V20161101
{
    ...
    {
        public static BatchGetOnlineUsersResponse Unmarshall(UnmarshallerContext _ctx)
        {
			BatchGetOnlineUsersResponse batchGetOnlineUsersResponse = new BatchGetOnlineUsersResponse();

			batchGetOnlineUsersResponse.HttpResponse = _ctx.HttpResponse;
			batchGetOnlineUsersResponse.RequestId = _ctx.StringValue("BatchGetOnlineUsers.RequestId");

			BatchGetOnlineUsersResponse.BatchGetOnlineUsers_Result result = new BatchGetOnlineUsersResponse.BatchGetOnlineUsers_Result();
			...
			result.OnlineUsers = result_onlineUsers;
			batchGetOnlineUsersResponse.Result = result;
