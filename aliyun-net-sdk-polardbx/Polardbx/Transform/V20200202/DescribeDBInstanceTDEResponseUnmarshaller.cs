...
namespace Aliyun.Acs.polardbx.Transform.V20200202
{
    public class DescribeDBInstanceTDEResponseUnmarshaller
    {
        public static DescribeDBInstanceTDEResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			DescribeDBInstanceTDEResponse.DescribeDBInstanceTDE_Data data = new DescribeDBInstanceTDEResponse.DescribeDBInstanceTDE_Data();
			data.TDEStatus = _ctx.StringValue("DescribeDBInstanceTDE.Data.TDEStatus");
			describeDBInstanceTDEResponse.Data = data;
