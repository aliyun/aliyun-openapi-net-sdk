...
{
    public class DescribeBackupSetRequest : RpcAcsRequest<DescribeBackupSetResponse>
    {
        public DescribeBackupSetRequest()
            : base("polardbx", "2020-02-02", "DescribeBackupSet", "polardbx", "openAPI")
        {
        ...
        public override DescribeBackupSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
