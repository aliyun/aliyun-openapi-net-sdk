...
{
    public class CreatePolarxOrderRequest : RpcAcsRequest<CreatePolarxOrderResponse>
    {
        public CreatePolarxOrderRequest()
            : base("polardbx", "2020-02-02", "CreatePolarxOrder", "polardbx", "openAPI")
        {
		...
		public string NodeCount
		{
			...
			{
				nodeCount = value;
				DictionaryUtil.Add(QueryParameters, "NodeCount", value);
			}
		}
        ...
        public override CreatePolarxOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePolarxOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
