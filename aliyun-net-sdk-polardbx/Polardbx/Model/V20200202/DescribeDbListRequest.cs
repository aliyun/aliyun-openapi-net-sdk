...
{
    public class DescribeDbListRequest : RpcAcsRequest<DescribeDbListResponse>
    {
        public DescribeDbListRequest()
            : base("polardbx", "2020-02-02", "DescribeDbList", "polardbx", "openAPI")
        {
        ...
        public override DescribeDbListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDbListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
