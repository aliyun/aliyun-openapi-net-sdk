...
{
    public class GetPolarxCommodityRequest : RpcAcsRequest<GetPolarxCommodityResponse>
    {
        public GetPolarxCommodityRequest()
            : base("polardbx", "2020-02-02", "GetPolarxCommodity", "polardbx", "openAPI")
        {
        ...
        public override GetPolarxCommodityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPolarxCommodityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
