...
{
    public class DescribeTableDetailRequest : RpcAcsRequest<DescribeTableDetailResponse>
    {
        public DescribeTableDetailRequest()
            : base("polardbx", "2020-02-02", "DescribeTableDetail", "polardbx", "openAPI")
        {
        ...
        public override DescribeTableDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTableDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
