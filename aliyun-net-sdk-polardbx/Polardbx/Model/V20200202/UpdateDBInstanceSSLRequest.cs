...
{
    public class UpdateDBInstanceSSLRequest : RpcAcsRequest<UpdateDBInstanceSSLResponse>
    {
        public UpdateDBInstanceSSLRequest()
            : base("polardbx", "2020-02-02", "UpdateDBInstanceSSL", "polardbx", "openAPI")
        {
		...
		public string CertCommonName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CertCommonName", value);
			}
		}
        ...
        public override UpdateDBInstanceSSLResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDBInstanceSSLResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
