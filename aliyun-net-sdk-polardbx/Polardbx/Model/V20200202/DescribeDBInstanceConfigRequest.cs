...
{
    public class DescribeDBInstanceConfigRequest : RpcAcsRequest<DescribeDBInstanceConfigResponse>
    {
        public DescribeDBInstanceConfigRequest()
            : base("polardbx", "2020-02-02", "DescribeDBInstanceConfig", "polardbx", "openAPI")
        {
        ...
        public override DescribeDBInstanceConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBInstanceConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
