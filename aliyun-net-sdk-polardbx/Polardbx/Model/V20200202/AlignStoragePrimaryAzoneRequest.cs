...
{
    public class AlignStoragePrimaryAzoneRequest : RpcAcsRequest<AlignStoragePrimaryAzoneResponse>
    {
        public AlignStoragePrimaryAzoneRequest()
            : base("polardbx", "2020-02-02", "AlignStoragePrimaryAzone", "polardbx", "openAPI")
        {
		...
		public string StorageInstanceName
		{
			...
			set	
			{
				storageInstanceName = value;
				DictionaryUtil.Add(QueryParameters, "StorageInstanceName", value);
			}
		}
        ...
        public override AlignStoragePrimaryAzoneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AlignStoragePrimaryAzoneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
