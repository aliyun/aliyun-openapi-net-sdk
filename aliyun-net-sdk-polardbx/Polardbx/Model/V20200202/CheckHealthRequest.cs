...
{
    public class CheckHealthRequest : RpcAcsRequest<CheckHealthResponse>
    {
        public CheckHealthRequest()
            : base("polardbx", "2020-02-02", "CheckHealth", "polardbx", "openAPI")
        {
        ...
        public override CheckHealthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckHealthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
