...
{
    public class DisableRightsSeparationRequest : RpcAcsRequest<DisableRightsSeparationResponse>
    {
        public DisableRightsSeparationRequest()
            : base("polardbx", "2020-02-02", "DisableRightsSeparation", "polardbx", "openAPI")
        {
		...
		public string DbaAccountPassword
		{
			...
			set	
			{
				dbaAccountPassword = value;
				DictionaryUtil.Add(QueryParameters, "DbaAccountPassword", value);
			}
		}
		...
		public string DbaAccountName
		{
			...
			set	
			{
				dbaAccountName = value;
				DictionaryUtil.Add(QueryParameters, "DbaAccountName", value);
			}
		}
        ...
        public override DisableRightsSeparationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableRightsSeparationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
