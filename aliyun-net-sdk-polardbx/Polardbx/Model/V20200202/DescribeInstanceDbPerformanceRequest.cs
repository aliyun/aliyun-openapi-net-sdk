...
{
    public class DescribeInstanceDbPerformanceRequest : RpcAcsRequest<DescribeInstanceDbPerformanceResponse>
    {
        public DescribeInstanceDbPerformanceRequest()
            : base("polardbx", "2020-02-02", "DescribeInstanceDbPerformance", "polardbx", "openAPI")
        {
        ...
        public override DescribeInstanceDbPerformanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceDbPerformanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
