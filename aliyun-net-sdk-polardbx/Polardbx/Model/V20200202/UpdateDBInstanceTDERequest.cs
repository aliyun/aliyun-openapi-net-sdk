...
{
    public class UpdateDBInstanceTDERequest : RpcAcsRequest<UpdateDBInstanceTDEResponse>
    {
        public UpdateDBInstanceTDERequest()
            : base("polardbx", "2020-02-02", "UpdateDBInstanceTDE", "polardbx", "openAPI")
        {
        ...
        public override UpdateDBInstanceTDEResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDBInstanceTDEResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
