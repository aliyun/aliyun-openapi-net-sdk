...
{
    public class DescribeCharacterSetRequest : RpcAcsRequest<DescribeCharacterSetResponse>
    {
        public DescribeCharacterSetRequest()
            : base("polardbx", "2020-02-02", "DescribeCharacterSet", "polardbx", "openAPI")
        {
        ...
        public override DescribeCharacterSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCharacterSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
