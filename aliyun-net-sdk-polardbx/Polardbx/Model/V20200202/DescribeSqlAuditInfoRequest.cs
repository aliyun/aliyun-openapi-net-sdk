...
{
    public class DescribeSqlAuditInfoRequest : RpcAcsRequest<DescribeSqlAuditInfoResponse>
    {
        public DescribeSqlAuditInfoRequest()
            : base("polardbx", "2020-02-02", "DescribeSqlAuditInfo", "polardbx", "openAPI")
        {
        ...
        public override DescribeSqlAuditInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSqlAuditInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
