...
{
    public class DescribeDistributeTableListRequest : RpcAcsRequest<DescribeDistributeTableListResponse>
    {
        public DescribeDistributeTableListRequest()
            : base("polardbx", "2020-02-02", "DescribeDistributeTableList", "polardbx", "openAPI")
        {
        ...
        public override DescribeDistributeTableListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDistributeTableListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
