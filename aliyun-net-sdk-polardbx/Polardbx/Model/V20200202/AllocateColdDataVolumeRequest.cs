...
{
    public class AllocateColdDataVolumeRequest : RpcAcsRequest<AllocateColdDataVolumeResponse>
    {
        public AllocateColdDataVolumeRequest()
            : base("polardbx", "2020-02-02", "AllocateColdDataVolume", "polardbx", "openAPI")
        {
        ...
        public override AllocateColdDataVolumeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AllocateColdDataVolumeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
