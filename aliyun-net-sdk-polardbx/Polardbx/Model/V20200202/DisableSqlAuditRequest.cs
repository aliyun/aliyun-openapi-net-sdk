...
{
    public class DisableSqlAuditRequest : RpcAcsRequest<DisableSqlAuditResponse>
    {
        public DisableSqlAuditRequest()
            : base("polardbx", "2020-02-02", "DisableSqlAudit", "polardbx", "openAPI")
        {
        ...
        public override DisableSqlAuditResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableSqlAuditResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
