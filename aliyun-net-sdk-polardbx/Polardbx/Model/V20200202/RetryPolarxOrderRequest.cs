...
{
    public class RetryPolarxOrderRequest : RpcAcsRequest<RetryPolarxOrderResponse>
    {
        public RetryPolarxOrderRequest()
            : base("polardbx", "2020-02-02", "RetryPolarxOrder", "polardbx", "openAPI")
        {
        ...
        public override RetryPolarxOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RetryPolarxOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
