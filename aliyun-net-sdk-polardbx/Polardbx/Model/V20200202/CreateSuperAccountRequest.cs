...
{
    public class CreateSuperAccountRequest : RpcAcsRequest<CreateSuperAccountResponse>
    {
        public CreateSuperAccountRequest()
            : base("polardbx", "2020-02-02", "CreateSuperAccount", "polardbx", "openAPI")
        {
        ...
        public override CreateSuperAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSuperAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
