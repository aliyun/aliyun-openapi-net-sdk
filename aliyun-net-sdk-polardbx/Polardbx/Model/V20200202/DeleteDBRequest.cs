...
{
    public class DeleteDBRequest : RpcAcsRequest<DeleteDBResponse>
    {
        public DeleteDBRequest()
            : base("polardbx", "2020-02-02", "DeleteDB", "polardbx", "openAPI")
        {
        ...
        public override DeleteDBResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDBResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
