...
{
    public class UpdatePolarDBXInstanceNodeRequest : RpcAcsRequest<UpdatePolarDBXInstanceNodeResponse>
    {
        public UpdatePolarDBXInstanceNodeRequest()
            : base("polardbx", "2020-02-02", "UpdatePolarDBXInstanceNode", "polardbx", "openAPI")
        {
        ...
        public override UpdatePolarDBXInstanceNodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdatePolarDBXInstanceNodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
