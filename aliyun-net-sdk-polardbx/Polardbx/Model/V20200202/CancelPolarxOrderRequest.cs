...
{
    public class CancelPolarxOrderRequest : RpcAcsRequest<CancelPolarxOrderResponse>
    {
        public CancelPolarxOrderRequest()
            : base("polardbx", "2020-02-02", "CancelPolarxOrder", "polardbx", "openAPI")
        {
		...
		public string ScaleOutToken
		{
			...
			{
				scaleOutToken = value;
				DictionaryUtil.Add(QueryParameters, "ScaleOutToken", value);
			}
		}
        ...
        public override CancelPolarxOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelPolarxOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
