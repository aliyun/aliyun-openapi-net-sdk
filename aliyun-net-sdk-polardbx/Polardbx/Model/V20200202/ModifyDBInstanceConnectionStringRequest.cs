...
namespace Aliyun.Acs.polardbx.Model.V20200202
{
    public class ModifyDBInstanceConnectionStringRequest : RpcAcsRequest<ModifyDBInstanceConnectionStringResponse>
    {
        public ModifyDBInstanceConnectionStringRequest()
            : base("polardbx", "2020-02-02", "ModifyDBInstanceConnectionString", "polardbx", "openAPI")
        {
		...
		public string NewPort
		{
			...
			{
				newPort = value;
				DictionaryUtil.Add(QueryParameters, "NewPort", value);
			}
		}
		...
		public string NewPrefix
		{
			...
			{
				newPrefix = value;
				DictionaryUtil.Add(QueryParameters, "NewPrefix", value);
			}
		}
