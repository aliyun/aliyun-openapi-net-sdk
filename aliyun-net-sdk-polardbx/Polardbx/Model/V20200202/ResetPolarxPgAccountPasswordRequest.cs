...
{
    public class ResetPolarxPgAccountPasswordRequest : RpcAcsRequest<ResetPolarxPgAccountPasswordResponse>
    {
        public ResetPolarxPgAccountPasswordRequest()
            : base("polardbx", "2020-02-02", "ResetPolarxPgAccountPassword", "polardbx", "openAPI")
        {
        ...
        public override ResetPolarxPgAccountPasswordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetPolarxPgAccountPasswordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
