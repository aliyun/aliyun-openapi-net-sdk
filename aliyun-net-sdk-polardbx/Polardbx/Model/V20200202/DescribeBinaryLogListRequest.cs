...
{
    public class DescribeBinaryLogListRequest : RpcAcsRequest<DescribeBinaryLogListResponse>
    {
        public DescribeBinaryLogListRequest()
            : base("polardbx", "2020-02-02", "DescribeBinaryLogList", "polardbx", "openAPI")
        {
        ...
        public override DescribeBinaryLogListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBinaryLogListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
