...
{
    public class GetVmMetaRequest : RpcAcsRequest<GetVmMetaResponse>
    {
        public GetVmMetaRequest()
            : base("servicemesh", "2020-01-11", "GetVmMeta", "servicemesh", "openAPI")
        {
		...
		public string TrustDomain
		{
			...
			{
				trustDomain = value;
				DictionaryUtil.Add(QueryParameters, "TrustDomain", value);
			}
		}
        ...
        public override GetVmMetaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVmMetaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
