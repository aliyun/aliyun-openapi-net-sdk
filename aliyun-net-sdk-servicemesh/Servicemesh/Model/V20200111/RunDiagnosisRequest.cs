...
{
    public class RunDiagnosisRequest : RpcAcsRequest<RunDiagnosisResponse>
    {
        public RunDiagnosisRequest()
            : base("servicemesh", "2020-01-11", "RunDiagnosis", "servicemesh", "openAPI")
        {
        ...
        public override RunDiagnosisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RunDiagnosisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
