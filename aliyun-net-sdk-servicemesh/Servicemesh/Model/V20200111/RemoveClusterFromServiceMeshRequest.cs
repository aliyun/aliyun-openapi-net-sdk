...
{
    public class RemoveClusterFromServiceMeshRequest : RpcAcsRequest<RemoveClusterFromServiceMeshResponse>
    {
        public RemoveClusterFromServiceMeshRequest()
            : base("servicemesh", "2020-01-11", "RemoveClusterFromServiceMesh", "servicemesh", "openAPI")
        {
        ...
        public override RemoveClusterFromServiceMeshResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveClusterFromServiceMeshResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
