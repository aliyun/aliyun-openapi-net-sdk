...
{
    public class GetServiceMeshSlbRequest : RpcAcsRequest<GetServiceMeshSlbResponse>
    {
        public GetServiceMeshSlbRequest()
            : base("servicemesh", "2020-01-11", "GetServiceMeshSlb", "servicemesh", "openAPI")
        {
        ...
        public override GetServiceMeshSlbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceMeshSlbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
