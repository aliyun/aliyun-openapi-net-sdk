...
{
    public class DescribeIngressGatewaysRequest : RpcAcsRequest<DescribeIngressGatewaysResponse>
    {
        public DescribeIngressGatewaysRequest()
            : base("servicemesh", "2020-01-11", "DescribeIngressGateways", "servicemesh", "openAPI")
        {
        ...
        public override DescribeIngressGatewaysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeIngressGatewaysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
