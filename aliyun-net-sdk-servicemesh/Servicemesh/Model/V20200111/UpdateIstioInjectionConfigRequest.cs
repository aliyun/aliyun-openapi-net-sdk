...
{
    public class UpdateIstioInjectionConfigRequest : RpcAcsRequest<UpdateIstioInjectionConfigResponse>
    {
        public UpdateIstioInjectionConfigRequest()
            : base("servicemesh", "2020-01-11", "UpdateIstioInjectionConfig", "servicemesh", "openAPI")
        {
		...
		private bool? enableIstioInjection;

		private string _namespace;

		private string serviceMeshId;

		public bool? EnableIstioInjection
		{
			get
			{
			...
			set	
			{
				enableIstioInjection = value;
				DictionaryUtil.Add(BodyParameters, "EnableIstioInjection", value.ToString());
			}
		}
        ...
        public override UpdateIstioInjectionConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateIstioInjectionConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
