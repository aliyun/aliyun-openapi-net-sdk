...
{
    public class GetRegisteredServicesRequest : RpcAcsRequest<GetRegisteredServicesResponse>
    {
        public GetRegisteredServicesRequest()
            : base("servicemesh", "2020-01-11", "GetRegisteredServices", "servicemesh", "openAPI")
        {
        ...
        public override GetRegisteredServicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRegisteredServicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
