...
{
    public class UpgradeMeshVersionRequest : RpcAcsRequest<UpgradeMeshVersionResponse>
    {
        public UpgradeMeshVersionRequest()
            : base("servicemesh", "2020-01-11", "UpgradeMeshVersion", "servicemesh", "openAPI")
        {
        ...
        public override UpgradeMeshVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpgradeMeshVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
