...
{
    public class GetDiagnosisRequest : RpcAcsRequest<GetDiagnosisResponse>
    {
        public GetDiagnosisRequest()
            : base("servicemesh", "2020-01-11", "GetDiagnosis", "servicemesh", "openAPI")
        {
        ...
        public override GetDiagnosisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDiagnosisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
