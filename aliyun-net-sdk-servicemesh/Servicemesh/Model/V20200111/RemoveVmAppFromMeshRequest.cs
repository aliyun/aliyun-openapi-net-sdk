...
{
    public class RemoveVmAppFromMeshRequest : RpcAcsRequest<RemoveVmAppFromMeshResponse>
    {
        public RemoveVmAppFromMeshRequest()
            : base("servicemesh", "2020-01-11", "RemoveVmAppFromMesh", "servicemesh", "openAPI")
        {
        ...
        public override RemoveVmAppFromMeshResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveVmAppFromMeshResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
