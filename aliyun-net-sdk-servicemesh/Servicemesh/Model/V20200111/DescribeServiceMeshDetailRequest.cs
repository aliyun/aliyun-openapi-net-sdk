...
{
    public class DescribeServiceMeshDetailRequest : RpcAcsRequest<DescribeServiceMeshDetailResponse>
    {
        public DescribeServiceMeshDetailRequest()
            : base("servicemesh", "2020-01-11", "DescribeServiceMeshDetail", "servicemesh", "openAPI")
        {
        ...
        public override DescribeServiceMeshDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeServiceMeshDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
