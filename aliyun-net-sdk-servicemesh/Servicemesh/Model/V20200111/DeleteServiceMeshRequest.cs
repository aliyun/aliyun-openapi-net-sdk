...
{
    public class DeleteServiceMeshRequest : RpcAcsRequest<DeleteServiceMeshResponse>
    {
        public DeleteServiceMeshRequest()
            : base("servicemesh", "2020-01-11", "DeleteServiceMesh", "servicemesh", "openAPI")
        {
		...
		public bool? Force
		{
			...
			{
				force = value;
				DictionaryUtil.Add(BodyParameters, "Force", value.ToString());
			}
		}
        ...
        public override DeleteServiceMeshResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteServiceMeshResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
