...
{
    public class AddClusterIntoServiceMeshRequest : RpcAcsRequest<AddClusterIntoServiceMeshResponse>
    {
        public AddClusterIntoServiceMeshRequest()
            : base("servicemesh", "2020-01-11", "AddClusterIntoServiceMesh", "servicemesh", "openAPI")
        {
        ...
        public override AddClusterIntoServiceMeshResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddClusterIntoServiceMeshResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
