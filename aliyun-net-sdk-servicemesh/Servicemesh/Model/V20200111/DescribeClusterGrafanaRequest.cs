...
{
    public class DescribeClusterGrafanaRequest : RpcAcsRequest<DescribeClusterGrafanaResponse>
    {
        public DescribeClusterGrafanaRequest()
            : base("servicemesh", "2020-01-11", "DescribeClusterGrafana", "servicemesh", "openAPI")
        {
        ...
        public override DescribeClusterGrafanaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeClusterGrafanaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
