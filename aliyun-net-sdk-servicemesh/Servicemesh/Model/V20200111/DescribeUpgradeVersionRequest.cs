...
{
    public class DescribeUpgradeVersionRequest : RpcAcsRequest<DescribeUpgradeVersionResponse>
    {
        public DescribeUpgradeVersionRequest()
            : base("servicemesh", "2020-01-11", "DescribeUpgradeVersion", "servicemesh", "openAPI")
        {
        ...
        public override DescribeUpgradeVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUpgradeVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
