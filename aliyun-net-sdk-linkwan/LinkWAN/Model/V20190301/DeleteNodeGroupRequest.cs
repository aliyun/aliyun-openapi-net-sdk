...
{
    public class DeleteNodeGroupRequest : RpcAcsRequest<DeleteNodeGroupResponse>
    {
        public DeleteNodeGroupRequest()
            : base("LinkWAN", "2019-03-01", "DeleteNodeGroup", "linkwan", "openAPI")
        {
        ...
        public override DeleteNodeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteNodeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
