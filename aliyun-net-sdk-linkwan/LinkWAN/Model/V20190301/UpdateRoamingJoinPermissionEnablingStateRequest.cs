...
{
    public class UpdateRoamingJoinPermissionEnablingStateRequest : RpcAcsRequest<UpdateRoamingJoinPermissionEnablingStateResponse>
    {
        public UpdateRoamingJoinPermissionEnablingStateRequest()
            : base("LinkWAN", "2019-03-01", "UpdateRoamingJoinPermissionEnablingState", "linkwan", "openAPI")
        {
        ...
        public override UpdateRoamingJoinPermissionEnablingStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRoamingJoinPermissionEnablingStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
