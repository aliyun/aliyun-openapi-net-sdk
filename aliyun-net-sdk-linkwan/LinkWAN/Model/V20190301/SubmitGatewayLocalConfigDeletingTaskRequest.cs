...
{
    public class SubmitGatewayLocalConfigDeletingTaskRequest : RpcAcsRequest<SubmitGatewayLocalConfigDeletingTaskResponse>
    {
        public SubmitGatewayLocalConfigDeletingTaskRequest()
            : base("LinkWAN", "2019-03-01", "SubmitGatewayLocalConfigDeletingTask", "linkwan", "openAPI")
        {
        ...
        public override SubmitGatewayLocalConfigDeletingTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitGatewayLocalConfigDeletingTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
