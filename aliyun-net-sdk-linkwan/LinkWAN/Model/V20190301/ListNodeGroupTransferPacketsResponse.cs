...
{
	public class ListNodeGroupTransferPacketsResponse : AcsResponse
	{
		...
		private ListNodeGroupTransferPackets_Data data;
		...
		public ListNodeGroupTransferPackets_Data Data
		{
			get
			{
				return data;
		...
		public class ListNodeGroupTransferPackets_Data
		{

			private long? totalCount;

			private List<ListNodeGroupTransferPackets_Packet> list;
			...
			public List<ListNodeGroupTransferPackets_Packet> List
			{
				get
				{
					return list;
			...
			public class ListNodeGroupTransferPackets_Packet
			{
