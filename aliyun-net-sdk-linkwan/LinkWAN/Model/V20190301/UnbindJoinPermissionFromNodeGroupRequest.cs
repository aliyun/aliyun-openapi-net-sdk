...
{
    public class UnbindJoinPermissionFromNodeGroupRequest : RpcAcsRequest<UnbindJoinPermissionFromNodeGroupResponse>
    {
        public UnbindJoinPermissionFromNodeGroupRequest()
            : base("LinkWAN", "2019-03-01", "UnbindJoinPermissionFromNodeGroup", "linkwan", "openAPI")
        {
        ...
        public override UnbindJoinPermissionFromNodeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindJoinPermissionFromNodeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
