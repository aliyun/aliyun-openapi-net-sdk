...
{
    public class ListGatewayTransferPacketsRequest : RpcAcsRequest<ListGatewayTransferPacketsResponse>
    {
        public ListGatewayTransferPacketsRequest()
            : base("LinkWAN", "2019-03-01", "ListGatewayTransferPackets", "linkwan", "openAPI")
        {
        ...
        public override ListGatewayTransferPacketsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGatewayTransferPacketsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
