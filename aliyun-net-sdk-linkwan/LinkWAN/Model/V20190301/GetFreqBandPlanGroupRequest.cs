...
{
    public class GetFreqBandPlanGroupRequest : RpcAcsRequest<GetFreqBandPlanGroupResponse>
    {
        public GetFreqBandPlanGroupRequest()
            : base("LinkWAN", "2019-03-01", "GetFreqBandPlanGroup", "linkwan", "openAPI")
        {
        ...
        public override GetFreqBandPlanGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFreqBandPlanGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
