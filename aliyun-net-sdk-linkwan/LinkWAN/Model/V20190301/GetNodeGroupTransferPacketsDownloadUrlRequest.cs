...
{
    public class GetNodeGroupTransferPacketsDownloadUrlRequest : RpcAcsRequest<GetNodeGroupTransferPacketsDownloadUrlResponse>
    {
        public GetNodeGroupTransferPacketsDownloadUrlRequest()
            : base("LinkWAN", "2019-03-01", "GetNodeGroupTransferPacketsDownloadUrl", "linkwan", "openAPI")
        {
        ...
        public override GetNodeGroupTransferPacketsDownloadUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeGroupTransferPacketsDownloadUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
