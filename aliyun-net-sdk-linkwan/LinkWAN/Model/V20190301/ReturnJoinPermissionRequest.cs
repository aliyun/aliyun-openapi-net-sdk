...
{
    public class ReturnJoinPermissionRequest : RpcAcsRequest<ReturnJoinPermissionResponse>
    {
        public ReturnJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "ReturnJoinPermission", "linkwan", "openAPI")
        {
		...
		public string JoinPermissionType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "JoinPermissionType", value);
			}
		}
        ...
        public override ReturnJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReturnJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
