...
{
    public class UpdateOwnedLocalJoinPermissionEnablingStateRequest : RpcAcsRequest<UpdateOwnedLocalJoinPermissionEnablingStateResponse>
    {
        public UpdateOwnedLocalJoinPermissionEnablingStateRequest()
            : base("LinkWAN", "2019-03-01", "UpdateOwnedLocalJoinPermissionEnablingState", "linkwan", "openAPI")
        {
        ...
        public override UpdateOwnedLocalJoinPermissionEnablingStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateOwnedLocalJoinPermissionEnablingStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
