...
{
    public class ListGatewayLocalConfigsRequest : RpcAcsRequest<ListGatewayLocalConfigsResponse>
    {
        public ListGatewayLocalConfigsRequest()
            : base("LinkWAN", "2019-03-01", "ListGatewayLocalConfigs", "linkwan", "openAPI")
        {
        ...
        public override ListGatewayLocalConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGatewayLocalConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
