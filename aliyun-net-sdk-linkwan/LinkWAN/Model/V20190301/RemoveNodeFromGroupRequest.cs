...
{
    public class RemoveNodeFromGroupRequest : RpcAcsRequest<RemoveNodeFromGroupResponse>
    {
        public RemoveNodeFromGroupRequest()
            : base("LinkWAN", "2019-03-01", "RemoveNodeFromGroup", "linkwan", "openAPI")
        {
        ...
        public override RemoveNodeFromGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveNodeFromGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
