...
{
    public class GetUserNetProfileDescriptionRequest : RpcAcsRequest<GetUserNetProfileDescriptionResponse>
    {
        public GetUserNetProfileDescriptionRequest()
            : base("LinkWAN", "2019-03-01", "GetUserNetProfileDescription", "linkwan", "openAPI")
        {
        ...
        public override GetUserNetProfileDescriptionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserNetProfileDescriptionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
