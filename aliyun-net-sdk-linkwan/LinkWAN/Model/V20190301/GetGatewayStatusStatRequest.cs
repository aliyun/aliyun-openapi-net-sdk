...
{
    public class GetGatewayStatusStatRequest : RpcAcsRequest<GetGatewayStatusStatResponse>
    {
        public GetGatewayStatusStatRequest()
            : base("LinkWAN", "2019-03-01", "GetGatewayStatusStat", "linkwan", "openAPI")
        {
        ...
        public override GetGatewayStatusStatResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGatewayStatusStatResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
