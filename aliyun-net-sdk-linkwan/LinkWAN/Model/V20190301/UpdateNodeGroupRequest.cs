...
{
    public class UpdateNodeGroupRequest : RpcAcsRequest<UpdateNodeGroupResponse>
    {
        public UpdateNodeGroupRequest()
            : base("LinkWAN", "2019-03-01", "UpdateNodeGroup", "linkwan", "openAPI")
        {
        ...
        public override UpdateNodeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateNodeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
