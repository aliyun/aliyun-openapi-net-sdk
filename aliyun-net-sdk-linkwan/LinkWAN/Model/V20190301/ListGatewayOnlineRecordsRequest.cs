...
{
    public class ListGatewayOnlineRecordsRequest : RpcAcsRequest<ListGatewayOnlineRecordsResponse>
    {
        public ListGatewayOnlineRecordsRequest()
            : base("LinkWAN", "2019-03-01", "ListGatewayOnlineRecords", "linkwan", "openAPI")
        {
        ...
        public override ListGatewayOnlineRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGatewayOnlineRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
