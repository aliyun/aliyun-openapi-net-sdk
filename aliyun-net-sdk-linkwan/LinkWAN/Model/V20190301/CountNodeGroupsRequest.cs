...
{
    public class CountNodeGroupsRequest : RpcAcsRequest<CountNodeGroupsResponse>
    {
        public CountNodeGroupsRequest()
            : base("LinkWAN", "2019-03-01", "CountNodeGroups", "linkwan", "openAPI")
        {
        ...
        public override CountNodeGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountNodeGroupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
