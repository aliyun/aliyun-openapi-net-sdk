...
{
    public class ListGatewayTransferFlowStatsRequest : RpcAcsRequest<ListGatewayTransferFlowStatsResponse>
    {
        public ListGatewayTransferFlowStatsRequest()
            : base("LinkWAN", "2019-03-01", "ListGatewayTransferFlowStats", "linkwan", "openAPI")
        {
        ...
        public override ListGatewayTransferFlowStatsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGatewayTransferFlowStatsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
