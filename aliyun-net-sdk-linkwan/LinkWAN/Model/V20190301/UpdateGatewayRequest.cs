...
{
    public class UpdateGatewayRequest : RpcAcsRequest<UpdateGatewayResponse>
    {
        public UpdateGatewayRequest()
            : base("LinkWAN", "2019-03-01", "UpdateGateway", "linkwan", "openAPI")
        {
        ...
        public override UpdateGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
