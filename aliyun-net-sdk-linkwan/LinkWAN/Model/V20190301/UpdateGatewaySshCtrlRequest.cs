...
{
    public class UpdateGatewaySshCtrlRequest : RpcAcsRequest<UpdateGatewaySshCtrlResponse>
    {
        public UpdateGatewaySshCtrlRequest()
            : base("LinkWAN", "2019-03-01", "UpdateGatewaySshCtrl", "linkwan", "openAPI")
        {
        ...
        public override UpdateGatewaySshCtrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateGatewaySshCtrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
