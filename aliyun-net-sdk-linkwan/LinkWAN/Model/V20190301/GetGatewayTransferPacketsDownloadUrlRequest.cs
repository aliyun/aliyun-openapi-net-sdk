...
{
    public class GetGatewayTransferPacketsDownloadUrlRequest : RpcAcsRequest<GetGatewayTransferPacketsDownloadUrlResponse>
    {
        public GetGatewayTransferPacketsDownloadUrlRequest()
            : base("LinkWAN", "2019-03-01", "GetGatewayTransferPacketsDownloadUrl", "linkwan", "openAPI")
        {
        ...
        public override GetGatewayTransferPacketsDownloadUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGatewayTransferPacketsDownloadUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
