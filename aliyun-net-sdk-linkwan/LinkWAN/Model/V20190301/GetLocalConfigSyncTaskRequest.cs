...
{
    public class GetLocalConfigSyncTaskRequest : RpcAcsRequest<GetLocalConfigSyncTaskResponse>
    {
        public GetLocalConfigSyncTaskRequest()
            : base("LinkWAN", "2019-03-01", "GetLocalConfigSyncTask", "linkwan", "openAPI")
        {
        ...
        public override GetLocalConfigSyncTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLocalConfigSyncTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
