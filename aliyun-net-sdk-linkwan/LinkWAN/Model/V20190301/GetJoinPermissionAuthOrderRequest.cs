...
{
    public class GetJoinPermissionAuthOrderRequest : RpcAcsRequest<GetJoinPermissionAuthOrderResponse>
    {
        public GetJoinPermissionAuthOrderRequest()
            : base("LinkWAN", "2019-03-01", "GetJoinPermissionAuthOrder", "linkwan", "openAPI")
        {
        ...
        public override GetJoinPermissionAuthOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetJoinPermissionAuthOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
