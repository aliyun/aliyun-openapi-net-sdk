...
{
    public class SubmitGatewayTupleOrderRequest : RpcAcsRequest<SubmitGatewayTupleOrderResponse>
    {
        public SubmitGatewayTupleOrderRequest()
            : base("LinkWAN", "2019-03-01", "SubmitGatewayTupleOrder", "linkwan", "openAPI")
        {
        ...
        public override SubmitGatewayTupleOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitGatewayTupleOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
