...
{
    public class GetRentedJoinPermissionRequest : RpcAcsRequest<GetRentedJoinPermissionResponse>
    {
        public GetRentedJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "GetRentedJoinPermission", "linkwan", "openAPI")
        {
        ...
        public override GetRentedJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRentedJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
