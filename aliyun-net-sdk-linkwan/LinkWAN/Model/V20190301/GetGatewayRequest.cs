...
{
    public class GetGatewayRequest : RpcAcsRequest<GetGatewayResponse>
    {
        public GetGatewayRequest()
            : base("LinkWAN", "2019-03-01", "GetGateway", "linkwan", "openAPI")
        {
        ...
        public override GetGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
