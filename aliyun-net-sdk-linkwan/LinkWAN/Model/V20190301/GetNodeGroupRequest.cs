...
{
    public class GetNodeGroupRequest : RpcAcsRequest<GetNodeGroupResponse>
    {
        public GetNodeGroupRequest()
            : base("LinkWAN", "2019-03-01", "GetNodeGroup", "linkwan", "openAPI")
        {
        ...
        public override GetNodeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
