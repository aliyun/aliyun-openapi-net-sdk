...
{
    public class UpdateGatewayEnablingStateRequest : RpcAcsRequest<UpdateGatewayEnablingStateResponse>
    {
        public UpdateGatewayEnablingStateRequest()
            : base("LinkWAN", "2019-03-01", "UpdateGatewayEnablingState", "linkwan", "openAPI")
        {
        ...
        public override UpdateGatewayEnablingStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateGatewayEnablingStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
