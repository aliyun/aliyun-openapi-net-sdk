...
{
	public class GetNotificationResponse : AcsResponse
	{
		...
		private GetNotification_Data data;
		...
		public GetNotification_Data Data
		{
			get
			{
				return data;
		...
		public class GetNotification_Data
		{
			...
			private GetNotification_GatewayOfflineInfo gatewayOfflineInfo;

			private GetNotification_JoinPermissionAuthInfo joinPermissionAuthInfo;
			...
			public GetNotification_GatewayOfflineInfo GatewayOfflineInfo
			{
				get
				{
			...
			public GetNotification_JoinPermissionAuthInfo JoinPermissionAuthInfo
			{
				get
				{
			...
			public class GetNotification_GatewayOfflineInfo
			{
			...
			public class GetNotification_JoinPermissionAuthInfo
			{
