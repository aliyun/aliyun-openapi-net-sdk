...
{
    public class GetNodeTuplesDownloadUrlRequest : RpcAcsRequest<GetNodeTuplesDownloadUrlResponse>
    {
        public GetNodeTuplesDownloadUrlRequest()
            : base("LinkWAN", "2019-03-01", "GetNodeTuplesDownloadUrl", "linkwan", "openAPI")
        {
        ...
        public override GetNodeTuplesDownloadUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeTuplesDownloadUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
