...
{
	public class GetNodeTupleOrderResponse : AcsResponse
	{
		...
		private GetNodeTupleOrder_Data data;
		...
		public GetNodeTupleOrder_Data Data
		{
			get
			{
				return data;
		...
		public class GetNodeTupleOrder_Data
		{
