...
{
    public class SubmitNodeLocalConfigAddingTaskRequest : RpcAcsRequest<SubmitNodeLocalConfigAddingTaskResponse>
    {
        public SubmitNodeLocalConfigAddingTaskRequest()
            : base("LinkWAN", "2019-03-01", "SubmitNodeLocalConfigAddingTask", "linkwan", "openAPI")
        {
        ...
        public override SubmitNodeLocalConfigAddingTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitNodeLocalConfigAddingTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
