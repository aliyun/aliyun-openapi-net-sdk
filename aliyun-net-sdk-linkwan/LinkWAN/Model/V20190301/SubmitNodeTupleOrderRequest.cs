...
{
    public class SubmitNodeTupleOrderRequest : RpcAcsRequest<SubmitNodeTupleOrderResponse>
    {
        public SubmitNodeTupleOrderRequest()
            : base("LinkWAN", "2019-03-01", "SubmitNodeTupleOrder", "linkwan", "openAPI")
        {
        ...
        public override SubmitNodeTupleOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitNodeTupleOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
