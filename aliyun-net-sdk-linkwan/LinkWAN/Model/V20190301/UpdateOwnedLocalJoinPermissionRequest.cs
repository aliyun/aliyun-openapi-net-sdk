...
{
    public class UpdateOwnedLocalJoinPermissionRequest : RpcAcsRequest<UpdateOwnedLocalJoinPermissionResponse>
    {
        public UpdateOwnedLocalJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "UpdateOwnedLocalJoinPermission", "linkwan", "openAPI")
        {
		...
		public string RxDelay
		{
			...
			{
				rxDelay = value;
				DictionaryUtil.Add(QueryParameters, "RxDelay", value);
			}
		}
		...
		public string DataRate
		{
			...
			{
				dataRate = value;
				DictionaryUtil.Add(QueryParameters, "DataRate", value);
			}
		}
        ...
        public override UpdateOwnedLocalJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateOwnedLocalJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
