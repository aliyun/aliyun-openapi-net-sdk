...
{
    public class CountNodeTupleOrdersRequest : RpcAcsRequest<CountNodeTupleOrdersResponse>
    {
        public CountNodeTupleOrdersRequest()
            : base("LinkWAN", "2019-03-01", "CountNodeTupleOrders", "linkwan", "openAPI")
        {
        ...
        public override CountNodeTupleOrdersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountNodeTupleOrdersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
