...
{
    public class DeleteLocalJoinPermissionRequest : RpcAcsRequest<DeleteLocalJoinPermissionResponse>
    {
        public DeleteLocalJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "DeleteLocalJoinPermission", "linkwan", "openAPI")
        {
        ...
        public override DeleteLocalJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLocalJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
