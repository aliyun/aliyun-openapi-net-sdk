...
{
    public class GetGatewayPacketStatRequest : RpcAcsRequest<GetGatewayPacketStatResponse>
    {
        public GetGatewayPacketStatRequest()
            : base("LinkWAN", "2019-03-01", "GetGatewayPacketStat", "linkwan", "openAPI")
        {
        ...
        public override GetGatewayPacketStatResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGatewayPacketStatResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
