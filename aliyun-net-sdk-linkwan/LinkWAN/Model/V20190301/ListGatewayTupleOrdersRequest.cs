...
{
    public class ListGatewayTupleOrdersRequest : RpcAcsRequest<ListGatewayTupleOrdersResponse>
    {
        public ListGatewayTupleOrdersRequest()
            : base("LinkWAN", "2019-03-01", "ListGatewayTupleOrders", "linkwan", "openAPI")
        {
        ...
        public override ListGatewayTupleOrdersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGatewayTupleOrdersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
