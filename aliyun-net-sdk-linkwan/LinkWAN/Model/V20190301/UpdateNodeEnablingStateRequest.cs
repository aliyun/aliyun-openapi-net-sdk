...
{
    public class UpdateNodeEnablingStateRequest : RpcAcsRequest<UpdateNodeEnablingStateResponse>
    {
        public UpdateNodeEnablingStateRequest()
            : base("LinkWAN", "2019-03-01", "UpdateNodeEnablingState", "linkwan", "openAPI")
        {
        ...
        public override UpdateNodeEnablingStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateNodeEnablingStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
