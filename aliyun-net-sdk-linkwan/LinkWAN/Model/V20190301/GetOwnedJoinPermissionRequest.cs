...
{
    public class GetOwnedJoinPermissionRequest : RpcAcsRequest<GetOwnedJoinPermissionResponse>
    {
        public GetOwnedJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "GetOwnedJoinPermission", "linkwan", "openAPI")
        {
        ...
        public override GetOwnedJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOwnedJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
