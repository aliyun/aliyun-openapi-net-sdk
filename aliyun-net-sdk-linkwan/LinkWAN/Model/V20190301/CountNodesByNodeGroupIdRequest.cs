...
{
    public class CountNodesByNodeGroupIdRequest : RpcAcsRequest<CountNodesByNodeGroupIdResponse>
    {
        public CountNodesByNodeGroupIdRequest()
            : base("LinkWAN", "2019-03-01", "CountNodesByNodeGroupId", "linkwan", "openAPI")
        {
        ...
        public override CountNodesByNodeGroupIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountNodesByNodeGroupIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
