...
{
    public class CreateNodeGroupRequest : RpcAcsRequest<CreateNodeGroupResponse>
    {
        public CreateNodeGroupRequest()
            : base("LinkWAN", "2019-03-01", "CreateNodeGroup", "linkwan", "openAPI")
        {
		...
		public string NodeGroupName
		{
			...
			{
				nodeGroupName = value;
				DictionaryUtil.Add(QueryParameters, "NodeGroupName", value);
			}
		}
        ...
        public override CreateNodeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateNodeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
