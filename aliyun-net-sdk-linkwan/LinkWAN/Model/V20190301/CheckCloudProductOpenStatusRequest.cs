...
{
    public class CheckCloudProductOpenStatusRequest : RpcAcsRequest<CheckCloudProductOpenStatusResponse>
    {
        public CheckCloudProductOpenStatusRequest()
            : base("LinkWAN", "2019-03-01", "CheckCloudProductOpenStatus", "linkwan", "openAPI")
        {
        ...
        public override CheckCloudProductOpenStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckCloudProductOpenStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
