...
{
    public class GetUserLicenseRequest : RpcAcsRequest<GetUserLicenseResponse>
    {
        public GetUserLicenseRequest()
            : base("LinkWAN", "2019-03-01", "GetUserLicense", "linkwan", "openAPI")
        {
        ...
        public override GetUserLicenseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserLicenseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
