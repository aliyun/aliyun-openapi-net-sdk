...
{
    public class ListNodeGroupTransferPacketsRequest : RpcAcsRequest<ListNodeGroupTransferPacketsResponse>
    {
        public ListNodeGroupTransferPacketsRequest()
            : base("LinkWAN", "2019-03-01", "ListNodeGroupTransferPackets", "linkwan", "openAPI")
        {
        ...
        public override ListNodeGroupTransferPacketsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListNodeGroupTransferPacketsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
