...
{
    public class CountNotificationsRequest : RpcAcsRequest<CountNotificationsResponse>
    {
        public CountNotificationsRequest()
            : base("LinkWAN", "2019-03-01", "CountNotifications", "linkwan", "openAPI")
        {
        ...
        public override CountNotificationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountNotificationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
