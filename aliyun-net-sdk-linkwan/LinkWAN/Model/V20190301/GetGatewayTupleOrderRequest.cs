...
{
    public class GetGatewayTupleOrderRequest : RpcAcsRequest<GetGatewayTupleOrderResponse>
    {
        public GetGatewayTupleOrderRequest()
            : base("LinkWAN", "2019-03-01", "GetGatewayTupleOrder", "linkwan", "openAPI")
        {
        ...
        public override GetGatewayTupleOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetGatewayTupleOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
