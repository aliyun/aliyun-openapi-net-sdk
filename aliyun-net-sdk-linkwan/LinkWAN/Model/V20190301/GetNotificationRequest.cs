...
{
    public class GetNotificationRequest : RpcAcsRequest<GetNotificationResponse>
    {
        public GetNotificationRequest()
            : base("LinkWAN", "2019-03-01", "GetNotification", "linkwan", "openAPI")
        {
		...
		public string NotificationId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "NotificationId", value);
			}
		}
        ...
        public override GetNotificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNotificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
