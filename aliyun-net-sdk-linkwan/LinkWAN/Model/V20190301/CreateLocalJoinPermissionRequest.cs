...
{
    public class CreateLocalJoinPermissionRequest : RpcAcsRequest<CreateLocalJoinPermissionResponse>
    {
        public CreateLocalJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "CreateLocalJoinPermission", "linkwan", "openAPI")
        {
		...
		private bool? useDefaultJoinEui;
		...
		public long? RxDelay
		{
			...
			{
				rxDelay = value;
				DictionaryUtil.Add(QueryParameters, "RxDelay", value.ToString());
			}
		}
		...
		public bool? UseDefaultJoinEui
		{
			get
			{
				return useDefaultJoinEui;
			}
			set	
			{
				useDefaultJoinEui = value;
				DictionaryUtil.Add(QueryParameters, "UseDefaultJoinEui", value.ToString());
			}
		}
		...
		public long? DataRate
		{
			...
			{
				dataRate = value;
				DictionaryUtil.Add(QueryParameters, "DataRate", value.ToString());
			}
		}
        ...
        public override CreateLocalJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLocalJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
