...
{
    public class ListNodeTransferPacketsRequest : RpcAcsRequest<ListNodeTransferPacketsResponse>
    {
        public ListNodeTransferPacketsRequest()
            : base("LinkWAN", "2019-03-01", "ListNodeTransferPackets", "linkwan", "openAPI")
        {
        ...
        public override ListNodeTransferPacketsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListNodeTransferPacketsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
