...
{
    public class UpdateRoamingJoinPermissionRequest : RpcAcsRequest<UpdateRoamingJoinPermissionResponse>
    {
        public UpdateRoamingJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "UpdateRoamingJoinPermission", "linkwan", "openAPI")
        {
        ...
        public override UpdateRoamingJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRoamingJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
