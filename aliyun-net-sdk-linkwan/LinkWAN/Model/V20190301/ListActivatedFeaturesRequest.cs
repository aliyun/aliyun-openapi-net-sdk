...
{
    public class ListActivatedFeaturesRequest : RpcAcsRequest<ListActivatedFeaturesResponse>
    {
        public ListActivatedFeaturesRequest()
            : base("LinkWAN", "2019-03-01", "ListActivatedFeatures", "linkwan", "openAPI")
        {
        ...
        public override ListActivatedFeaturesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListActivatedFeaturesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
