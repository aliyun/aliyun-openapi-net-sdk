...
{
    public class GetNodeLocalConfigRequest : RpcAcsRequest<GetNodeLocalConfigResponse>
    {
        public GetNodeLocalConfigRequest()
            : base("LinkWAN", "2019-03-01", "GetNodeLocalConfig", "linkwan", "openAPI")
        {
        ...
        public override GetNodeLocalConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeLocalConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
