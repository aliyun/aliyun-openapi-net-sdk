...
{
    public class ListNodeGroupTransferFlowStatsRequest : RpcAcsRequest<ListNodeGroupTransferFlowStatsResponse>
    {
        public ListNodeGroupTransferFlowStatsRequest()
            : base("LinkWAN", "2019-03-01", "ListNodeGroupTransferFlowStats", "linkwan", "openAPI")
        {
		...
		public string TimeIntervalUnit
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "TimeIntervalUnit", value);
			}
		}
        ...
        public override ListNodeGroupTransferFlowStatsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListNodeGroupTransferFlowStatsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
