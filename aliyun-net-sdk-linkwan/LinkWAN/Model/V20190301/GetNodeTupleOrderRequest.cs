...
{
    public class GetNodeTupleOrderRequest : RpcAcsRequest<GetNodeTupleOrderResponse>
    {
        public GetNodeTupleOrderRequest()
            : base("LinkWAN", "2019-03-01", "GetNodeTupleOrder", "linkwan", "openAPI")
        {
        ...
        public override GetNodeTupleOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeTupleOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
