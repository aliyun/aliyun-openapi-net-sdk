...
{
	public class GetNodeLocalConfigResponse : AcsResponse
	{
		...
		private GetNodeLocalConfig_Data data;
		...
		public GetNodeLocalConfig_Data Data
		{
			get
			{
				return data;
		...
		public class GetNodeLocalConfig_Data
		{
