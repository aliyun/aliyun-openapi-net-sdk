...
{
    public class ListGatewaysGisInfoRequest : RpcAcsRequest<ListGatewaysGisInfoResponse>
    {
        public ListGatewaysGisInfoRequest()
            : base("LinkWAN", "2019-03-01", "ListGatewaysGisInfo", "linkwan", "openAPI")
        {
        ...
        public override ListGatewaysGisInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGatewaysGisInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
