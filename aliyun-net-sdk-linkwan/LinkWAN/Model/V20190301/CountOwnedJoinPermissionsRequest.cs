...
{
    public class CountOwnedJoinPermissionsRequest : RpcAcsRequest<CountOwnedJoinPermissionsResponse>
    {
        public CountOwnedJoinPermissionsRequest()
            : base("LinkWAN", "2019-03-01", "CountOwnedJoinPermissions", "linkwan", "openAPI")
        {
        ...
        public override CountOwnedJoinPermissionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountOwnedJoinPermissionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
