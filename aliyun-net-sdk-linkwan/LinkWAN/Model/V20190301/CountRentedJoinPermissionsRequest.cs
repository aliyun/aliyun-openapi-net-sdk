...
{
    public class CountRentedJoinPermissionsRequest : RpcAcsRequest<CountRentedJoinPermissionsResponse>
    {
        public CountRentedJoinPermissionsRequest()
            : base("LinkWAN", "2019-03-01", "CountRentedJoinPermissions", "linkwan", "openAPI")
        {
        ...
        public override CountRentedJoinPermissionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountRentedJoinPermissionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
