...
{
    public class ApplyRoamingJoinPermissionRequest : RpcAcsRequest<ApplyRoamingJoinPermissionResponse>
    {
        public ApplyRoamingJoinPermissionRequest()
            : base("LinkWAN", "2019-03-01", "ApplyRoamingJoinPermission", "linkwan", "openAPI")
        {
        ...
        public override ApplyRoamingJoinPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ApplyRoamingJoinPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
