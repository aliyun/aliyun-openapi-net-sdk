...
{
	public class ListNodesByNodeGroupIdResponse : AcsResponse
	{
		...
		private ListNodesByNodeGroupId_Data data;
		...
		public ListNodesByNodeGroupId_Data Data
		{
			get
			{
				return data;
		...
		public class ListNodesByNodeGroupId_Data
		{

			private long? totalCount;

			private List<ListNodesByNodeGroupId_Node> list;
			...
			public List<ListNodesByNodeGroupId_Node> List
			{
				get
				{
					return list;
			...
			public class ListNodesByNodeGroupId_Node
			{
