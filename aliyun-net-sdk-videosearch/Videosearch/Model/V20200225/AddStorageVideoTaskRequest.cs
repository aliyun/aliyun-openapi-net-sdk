...
{
    public class AddStorageVideoTaskRequest : RpcAcsRequest<AddStorageVideoTaskResponse>
    {
        public AddStorageVideoTaskRequest()
            : base("videosearch", "2020-02-25", "AddStorageVideoTask")
        {
        ...
        public override AddStorageVideoTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddStorageVideoTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
