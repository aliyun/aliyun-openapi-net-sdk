...
{
    public class AddDeletionVideoTaskRequest : RpcAcsRequest<AddDeletionVideoTaskResponse>
    {
        ...
        public override AddDeletionVideoTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddDeletionVideoTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
