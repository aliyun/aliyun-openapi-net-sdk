...
namespace Aliyun.Acs.Dyplsapi.Transform.V20170525
{
    public class BindAxnResponseUnmarshaller
    {
        public static BindAxnResponse Unmarshall(UnmarshallerContext context)
        {
            ...
            bindAxnResponse.SubsId = context.StringValue("BindAxn.SubsId");
            bindAxnResponse.SecretNo = context.StringValue("BindAxn.SecretNo");
            bindAxnResponse.Extension = context.StringValue("BindAxn.Extension");
