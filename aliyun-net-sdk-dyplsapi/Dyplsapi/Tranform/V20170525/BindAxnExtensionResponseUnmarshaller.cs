...
namespace Aliyun.Acs.Dyplsapi.Transform.V20170525
{
    public class BindAxnExtensionResponseUnmarshaller
    {
        public static BindAxnExtensionResponse Unmarshall(UnmarshallerContext context)
        {
            ...
            bindAxnExtensionResponse.SubsId = context.StringValue("BindAxnExtension.SubsId");
            bindAxnExtensionResponse.SecretNo = context.StringValue("BindAxnExtension.SecretNo");
            bindAxnExtensionResponse.Extension = context.StringValue("BindAxnExtension.Extension");
