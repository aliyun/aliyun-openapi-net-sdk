...
namespace Aliyun.Acs.Dyplsapi.Transform.V20170525
{
    public class QueryCallStatusResponseUnmarshaller
    {
        public static QueryCallStatusResponse Unmarshall(UnmarshallerContext context)
        {
            ...
            queryCallStatusResponse.Status = context.IntegerValue("QueryCallStatus.Status");
            queryCallStatusResponse.CalledNo = context.StringValue("QueryCallStatus.CalledNo");
