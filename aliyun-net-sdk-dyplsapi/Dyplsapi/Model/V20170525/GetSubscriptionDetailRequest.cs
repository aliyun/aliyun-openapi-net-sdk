...
{
    public class GetSubscriptionDetailRequest : RpcAcsRequest<GetSubscriptionDetailResponse>
    {
        public GetSubscriptionDetailRequest()
            : base("Dyplsapi", "2017-05-25", "GetSubscriptionDetail")
        {
        ...
        public override GetSubscriptionDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSubscriptionDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
