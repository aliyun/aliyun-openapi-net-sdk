...
{
    public class GetFaceVerifyRequest : RpcAcsRequest<GetFaceVerifyResponse>
    {
        public GetFaceVerifyRequest()
            : base("Dyplsapi", "2017-05-25", "GetFaceVerify")
        {
        ...
        public override GetFaceVerifyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFaceVerifyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
