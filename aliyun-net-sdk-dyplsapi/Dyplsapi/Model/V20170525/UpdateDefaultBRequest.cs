...
{
    public class UpdateDefaultBRequest : RpcAcsRequest<UpdateDefaultBResponse>
    {
        public UpdateDefaultBRequest()
            : base("Dyplsapi", "2017-05-25", "UpdateDefaultB")
        {
        ...
        public override UpdateDefaultBResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDefaultBResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
