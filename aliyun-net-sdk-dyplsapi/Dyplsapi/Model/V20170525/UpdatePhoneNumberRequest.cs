...
{
    public class UpdatePhoneNumberRequest : RpcAcsRequest<UpdatePhoneNumberResponse>
    {
        public UpdatePhoneNumberRequest()
            : base("Dyplsapi", "2017-05-25", "UpdatePhoneNumber")
        {
		...
		public string BindToken
		{
			...
			{
				bindToken = value;
				DictionaryUtil.Add(QueryParameters, "BindToken", value);
			}
		}
		...
		public string NewPhoneNo
		{
			...
			{
				newPhoneNo = value;
				DictionaryUtil.Add(QueryParameters, "NewPhoneNo", value);
			}
		}
        ...
        public override UpdatePhoneNumberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdatePhoneNumberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
