...
{
    public class ConfirmSendSmsRequest : RpcAcsRequest<ConfirmSendSmsResponse>
    {
        public ConfirmSendSmsRequest()
            : base("Dyplsapi", "2017-05-25", "ConfirmSendSms")
        {
        ...
        public override ConfirmSendSmsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfirmSendSmsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
