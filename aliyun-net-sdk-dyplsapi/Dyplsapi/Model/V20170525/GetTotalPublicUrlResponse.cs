...
{
	public class GetTotalPublicUrlResponse : AcsResponse
	{
		...
		private GetTotalPublicUrl_Data data;
		...
		public GetTotalPublicUrl_Data Data
		{
			get
			{
				return data;
		...
		public class GetTotalPublicUrl_Data
		{
