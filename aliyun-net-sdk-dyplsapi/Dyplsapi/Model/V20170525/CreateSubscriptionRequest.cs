...
{
    public class CreateSubscriptionRequest : RpcAcsRequest<CreateSubscriptionResponse>
    {
        public CreateSubscriptionRequest()
            : base("Dyplsapi", "2017-05-25", "CreateSubscription")
        {
        ...
        public override CreateSubscriptionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSubscriptionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
