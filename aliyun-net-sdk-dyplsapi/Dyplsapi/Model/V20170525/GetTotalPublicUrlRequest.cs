...
{
    public class GetTotalPublicUrlRequest : RpcAcsRequest<GetTotalPublicUrlResponse>
    {
        public GetTotalPublicUrlRequest()
            : base("Dyplsapi", "2017-05-25", "GetTotalPublicUrl")
        {
		...
		public bool? CheckSubs
		{
			...
			{
				checkSubs = value;
				DictionaryUtil.Add(QueryParameters, "CheckSubs", value.ToString());
			}
		}
		...
		public string PartnerKey
		{
			...
			{
				partnerKey = value;
				DictionaryUtil.Add(QueryParameters, "PartnerKey", value);
			}
		}
        ...
        public override GetTotalPublicUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTotalPublicUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
