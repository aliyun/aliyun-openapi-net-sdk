...
{
    public class SearchVerificationRequest : RpcAcsRequest<SearchVerificationResponse>
    {
        public SearchVerificationRequest()
            : base("Dypnsapi-intl", "2017-07-25", "SearchVerification")
        {
		...
		public long? SendDate
		{
			...
			{
				sendDate = value;
				DictionaryUtil.Add(QueryParameters, "SendDate", value.ToString());
			}
		}
        ...
        public override SearchVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchVerificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
