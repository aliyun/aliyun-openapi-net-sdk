...
{
    public class StartVerificationRequest : RpcAcsRequest<StartVerificationResponse>
    {
        public StartVerificationRequest()
            : base("Dypnsapi-intl", "2017-07-25", "StartVerification")
        {
        ...
        public override StartVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartVerificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
