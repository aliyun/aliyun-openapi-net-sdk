...
{
    public class DeleteServiceInstancesRequest : RpcAcsRequest<DeleteServiceInstancesResponse>
    {
        public DeleteServiceInstancesRequest()
            : base("ComputeNest", "2021-06-01", "DeleteServiceInstances", "computenest", "openAPI")
        {
		...
		private List<string> serviceInstanceIds = new List<string>(){ };
        ...
        public override DeleteServiceInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteServiceInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
