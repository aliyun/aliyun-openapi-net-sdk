...
{
    public class GetServiceInstanceRequest : RpcAcsRequest<GetServiceInstanceResponse>
    {
        public GetServiceInstanceRequest()
            : base("ComputeNest", "2021-06-01", "GetServiceInstance", "computenest", "openAPI")
        {
		...
		public string MarketInstanceId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MarketInstanceId", value);
			}
		}
        ...
        public override GetServiceInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
