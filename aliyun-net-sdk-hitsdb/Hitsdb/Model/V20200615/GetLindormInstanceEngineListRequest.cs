...
{
    public class GetLindormInstanceEngineListRequest : RpcAcsRequest<GetLindormInstanceEngineListResponse>
    {
        public GetLindormInstanceEngineListRequest()
            : base("hitsdb", "2020-06-15", "GetLindormInstanceEngineList", "hitsdb", "openAPI")
        {
        ...
        public override GetLindormInstanceEngineListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLindormInstanceEngineListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
