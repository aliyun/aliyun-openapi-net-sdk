...
{
    public class UpdateInstanceIpWhiteListRequest : RpcAcsRequest<UpdateInstanceIpWhiteListResponse>
    {
        public UpdateInstanceIpWhiteListRequest()
            : base("hitsdb", "2020-06-15", "UpdateInstanceIpWhiteList", "hitsdb", "openAPI")
        {
        ...
        public override UpdateInstanceIpWhiteListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateInstanceIpWhiteListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
