...
{
    public class RenewLindormInstanceRequest : RpcAcsRequest<RenewLindormInstanceResponse>
    {
        public RenewLindormInstanceRequest()
            : base("hitsdb", "2020-06-15", "RenewLindormInstance", "hitsdb", "openAPI")
        {
        ...
        public override RenewLindormInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenewLindormInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
