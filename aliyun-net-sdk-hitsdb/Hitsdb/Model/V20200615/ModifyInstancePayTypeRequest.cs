...
{
    public class ModifyInstancePayTypeRequest : RpcAcsRequest<ModifyInstancePayTypeResponse>
    {
        public ModifyInstancePayTypeRequest()
            : base("hitsdb", "2020-06-15", "ModifyInstancePayType", "hitsdb", "openAPI")
        {
        ...
        public override ModifyInstancePayTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyInstancePayTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
