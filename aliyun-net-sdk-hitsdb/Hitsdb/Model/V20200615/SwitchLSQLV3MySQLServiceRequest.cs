...
{
    public class SwitchLSQLV3MySQLServiceRequest : RpcAcsRequest<SwitchLSQLV3MySQLServiceResponse>
    {
        public SwitchLSQLV3MySQLServiceRequest()
            : base("hitsdb", "2020-06-15", "SwitchLSQLV3MySQLService", "hitsdb", "openAPI")
        {
        ...
        public override SwitchLSQLV3MySQLServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwitchLSQLV3MySQLServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
