...
{
    public class UpdateLdpsComputeGroupRequest : RpcAcsRequest<UpdateLdpsComputeGroupResponse>
    {
        public UpdateLdpsComputeGroupRequest()
            : base("hitsdb", "2020-06-15", "UpdateLdpsComputeGroup", "hitsdb", "openAPI")
        {
        ...
        public override UpdateLdpsComputeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateLdpsComputeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
