...
{
    public class CreateLdpsComputeGroupRequest : RpcAcsRequest<CreateLdpsComputeGroupResponse>
    {
        public CreateLdpsComputeGroupRequest()
            : base("hitsdb", "2020-06-15", "CreateLdpsComputeGroup", "hitsdb", "openAPI")
        {
        ...
        public override CreateLdpsComputeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLdpsComputeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
