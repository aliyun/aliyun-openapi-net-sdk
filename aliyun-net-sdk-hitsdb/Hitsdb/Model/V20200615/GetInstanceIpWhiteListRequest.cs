...
{
    public class GetInstanceIpWhiteListRequest : RpcAcsRequest<GetInstanceIpWhiteListResponse>
    {
        public GetInstanceIpWhiteListRequest()
            : base("hitsdb", "2020-06-15", "GetInstanceIpWhiteList", "hitsdb", "openAPI")
        {
        ...
        public override GetInstanceIpWhiteListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInstanceIpWhiteListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
