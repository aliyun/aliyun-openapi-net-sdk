...
{
    public class CreateLdpsNamespaceRequest : RpcAcsRequest<CreateLdpsNamespaceResponse>
    {
        public CreateLdpsNamespaceRequest()
            : base("hitsdb", "2020-06-15", "CreateLdpsNamespace", "hitsdb", "openAPI")
        {
        ...
        public override CreateLdpsNamespaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLdpsNamespaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
