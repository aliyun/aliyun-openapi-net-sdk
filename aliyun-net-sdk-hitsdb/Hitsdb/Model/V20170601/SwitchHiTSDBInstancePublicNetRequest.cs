...
namespace Aliyun.Acs.hitsdb.Model.V20170601
{
    public class SwitchHiTSDBInstancePublicNetRequest : RpcAcsRequest<SwitchHiTSDBInstancePublicNetResponse>
    {
		...
		public long? SwitchAction
		{
			...
			{
				switchAction = value;
				DictionaryUtil.Add(QueryParameters, "SwitchAction", value.ToString());
			}
		}
        ...
        public override SwitchHiTSDBInstancePublicNetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwitchHiTSDBInstancePublicNetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
