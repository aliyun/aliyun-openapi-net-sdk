...
{
    public class DeleteHiTSDBInstanceRequest : RpcAcsRequest<DeleteHiTSDBInstanceResponse>
    {
        public DeleteHiTSDBInstanceRequest()
            : base("hitsdb", "2017-06-01", "DeleteHiTSDBInstance", "hitsdb", "openAPI")
        {
        ...
        public override DeleteHiTSDBInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteHiTSDBInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
