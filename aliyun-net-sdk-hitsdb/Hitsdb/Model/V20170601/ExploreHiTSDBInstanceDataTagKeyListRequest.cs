...
namespace Aliyun.Acs.hitsdb.Model.V20170601
{
    public class ExploreHiTSDBInstanceDataTagKeyListRequest : RpcAcsRequest<ExploreHiTSDBInstanceDataTagKeyListResponse>
    {
        ...
        public override ExploreHiTSDBInstanceDataTagKeyListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExploreHiTSDBInstanceDataTagKeyListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
