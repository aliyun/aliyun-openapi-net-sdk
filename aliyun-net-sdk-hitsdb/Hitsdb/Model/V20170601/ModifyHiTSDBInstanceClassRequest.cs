...
{
    public class ModifyHiTSDBInstanceClassRequest : RpcAcsRequest<ModifyHiTSDBInstanceClassResponse>
    {
        public ModifyHiTSDBInstanceClassRequest()
            : base("hitsdb", "2017-06-01", "ModifyHiTSDBInstanceClass", "hitsdb", "openAPI")
        {
        ...
        public override ModifyHiTSDBInstanceClassResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyHiTSDBInstanceClassResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
