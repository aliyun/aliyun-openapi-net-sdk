...
namespace Aliyun.Acs.hitsdb.Model.V20170601
{
    public class DescribeHiTSDBInstanceRequest : RpcAcsRequest<DescribeHiTSDBInstanceResponse>
    {
        ...
        public override DescribeHiTSDBInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeHiTSDBInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
