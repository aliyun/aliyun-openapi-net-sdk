...
{
    public class ModifyHiTSDBInstanceSecurityIpListRequest : RpcAcsRequest<ModifyHiTSDBInstanceSecurityIpListResponse>
    {
        public ModifyHiTSDBInstanceSecurityIpListRequest()
            : base("hitsdb", "2017-06-01", "ModifyHiTSDBInstanceSecurityIpList", "hitsdb", "openAPI")
        {
        ...
        public override ModifyHiTSDBInstanceSecurityIpListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyHiTSDBInstanceSecurityIpListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
