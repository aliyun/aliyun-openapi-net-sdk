...
namespace Aliyun.Acs.hitsdb.Model.V20170601
{
    public class RenewTSDBInstanceRequest : RpcAcsRequest<RenewTSDBInstanceResponse>
    {
        ...
        public override RenewTSDBInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenewTSDBInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
