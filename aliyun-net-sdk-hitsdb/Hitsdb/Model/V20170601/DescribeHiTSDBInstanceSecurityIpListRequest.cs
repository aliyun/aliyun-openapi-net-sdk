...
namespace Aliyun.Acs.hitsdb.Model.V20170601
{
    public class DescribeHiTSDBInstanceSecurityIpListRequest : RpcAcsRequest<DescribeHiTSDBInstanceSecurityIpListResponse>
    {
        ...
        public override DescribeHiTSDBInstanceSecurityIpListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeHiTSDBInstanceSecurityIpListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
