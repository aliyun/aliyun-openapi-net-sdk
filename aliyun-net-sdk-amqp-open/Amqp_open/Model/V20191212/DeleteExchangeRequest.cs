...
{
    public class DeleteExchangeRequest : RpcAcsRequest<DeleteExchangeResponse>
    {
        public DeleteExchangeRequest()
            : base("amqp-open", "2019-12-12", "DeleteExchange", "onsproxy", "openAPI")
        {
        ...
        public override DeleteExchangeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteExchangeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
