...
{
    public class ListStatisticsTaskRequest : RpcAcsRequest<ListStatisticsTaskResponse>
    {
        public ListStatisticsTaskRequest()
            : base("idrsservice", "2020-06-30", "ListStatisticsTask", "idrsservice", "openAPI")
        {
        ...
        public override ListStatisticsTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListStatisticsTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
