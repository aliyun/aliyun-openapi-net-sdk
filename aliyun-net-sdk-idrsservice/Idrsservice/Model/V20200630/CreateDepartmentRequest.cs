...
{
    public class CreateDepartmentRequest : RpcAcsRequest<CreateDepartmentResponse>
    {
        public CreateDepartmentRequest()
            : base("idrsservice", "2020-06-30", "CreateDepartment", "idrsservice", "openAPI")
        {
        ...
        public override CreateDepartmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDepartmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
