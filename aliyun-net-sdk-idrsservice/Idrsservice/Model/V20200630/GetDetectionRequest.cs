...
{
    public class GetDetectionRequest : RpcAcsRequest<GetDetectionResponse>
    {
        public GetDetectionRequest()
            : base("idrsservice", "2020-06-30", "GetDetection", "idrsservice", "openAPI")
        {
        ...
        public override GetDetectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDetectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
