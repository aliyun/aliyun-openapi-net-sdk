...
{
    public class GetPreSignedUrlRequest : RpcAcsRequest<GetPreSignedUrlResponse>
    {
        public GetPreSignedUrlRequest()
            : base("idrsservice", "2020-06-30", "GetPreSignedUrl", "idrsservice", "openAPI")
        {
        ...
        public override GetPreSignedUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPreSignedUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
