...
{
    public class CreateUserDepartmentsRequest : RpcAcsRequest<CreateUserDepartmentsResponse>
    {
        public CreateUserDepartmentsRequest()
            : base("idrsservice", "2020-06-30", "CreateUserDepartments", "idrsservice", "openAPI")
        {
        ...
        public override CreateUserDepartmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateUserDepartmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
