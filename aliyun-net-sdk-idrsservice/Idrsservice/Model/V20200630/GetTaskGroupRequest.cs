...
{
    public class GetTaskGroupRequest : RpcAcsRequest<GetTaskGroupResponse>
    {
        public GetTaskGroupRequest()
            : base("idrsservice", "2020-06-30", "GetTaskGroup", "idrsservice", "openAPI")
        {
        ...
        public override GetTaskGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTaskGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
