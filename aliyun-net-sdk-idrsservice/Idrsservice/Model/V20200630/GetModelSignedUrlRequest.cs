...
{
    public class GetModelSignedUrlRequest : RpcAcsRequest<GetModelSignedUrlResponse>
    {
        public GetModelSignedUrlRequest()
            : base("idrsservice", "2020-06-30", "GetModelSignedUrl", "idrsservice", "openAPI")
        {
		...
		public List<string> ModelPaths
		{
			...
			set
			{
				...
				{
					DictionaryUtil.Add(BodyParameters,"ModelPath." + (i + 1) , modelPaths[i]);
				}
			}
		}
        ...
        public override GetModelSignedUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetModelSignedUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
