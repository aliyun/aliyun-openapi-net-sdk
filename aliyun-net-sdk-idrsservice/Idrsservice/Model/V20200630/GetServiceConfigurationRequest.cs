...
{
    public class GetServiceConfigurationRequest : RpcAcsRequest<GetServiceConfigurationResponse>
    {
        public GetServiceConfigurationRequest()
            : base("idrsservice", "2020-06-30", "GetServiceConfiguration", "idrsservice", "openAPI")
        {
        ...
        public override GetServiceConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
