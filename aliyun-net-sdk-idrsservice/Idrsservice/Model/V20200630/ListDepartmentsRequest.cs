...
{
    public class ListDepartmentsRequest : RpcAcsRequest<ListDepartmentsResponse>
    {
        public ListDepartmentsRequest()
            : base("idrsservice", "2020-06-30", "ListDepartments", "idrsservice", "openAPI")
        {
        ...
        public override ListDepartmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDepartmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
