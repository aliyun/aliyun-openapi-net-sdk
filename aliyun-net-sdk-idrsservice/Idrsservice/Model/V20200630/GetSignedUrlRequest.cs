...
{
    public class GetSignedUrlRequest : RpcAcsRequest<GetSignedUrlResponse>
    {
        public GetSignedUrlRequest()
            : base("idrsservice", "2020-06-30", "GetSignedUrl", "idrsservice", "openAPI")
        {
        ...
        public override GetSignedUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSignedUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
