...
{
    public class ListLivesRequest : RpcAcsRequest<ListLivesResponse>
    {
        public ListLivesRequest()
            : base("idrsservice", "2020-06-30", "ListLives", "idrsservice", "openAPI")
        {
        ...
        public override ListLivesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLivesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
