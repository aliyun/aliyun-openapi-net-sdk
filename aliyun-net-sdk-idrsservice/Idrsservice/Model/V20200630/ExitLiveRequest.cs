...
{
    public class ExitLiveRequest : RpcAcsRequest<ExitLiveResponse>
    {
        public ExitLiveRequest()
            : base("idrsservice", "2020-06-30", "ExitLive", "idrsservice", "openAPI")
        {
        ...
        public override ExitLiveResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExitLiveResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
