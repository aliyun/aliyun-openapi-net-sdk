...
{
    public class GetDepartmentRequest : RpcAcsRequest<GetDepartmentResponse>
    {
        public GetDepartmentRequest()
            : base("idrsservice", "2020-06-30", "GetDepartment", "idrsservice", "openAPI")
        {
        ...
        public override GetDepartmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDepartmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
