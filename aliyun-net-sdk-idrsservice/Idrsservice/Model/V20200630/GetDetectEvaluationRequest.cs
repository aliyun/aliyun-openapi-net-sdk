...
{
    public class GetDetectEvaluationRequest : RpcAcsRequest<GetDetectEvaluationResponse>
    {
        public GetDetectEvaluationRequest()
            : base("idrsservice", "2020-06-30", "GetDetectEvaluation", "idrsservice", "openAPI")
        {
        ...
        public override GetDetectEvaluationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDetectEvaluationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
