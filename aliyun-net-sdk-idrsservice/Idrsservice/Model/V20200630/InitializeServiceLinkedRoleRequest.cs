...
{
    public class InitializeServiceLinkedRoleRequest : RpcAcsRequest<InitializeServiceLinkedRoleResponse>
    {
        public InitializeServiceLinkedRoleRequest()
            : base("idrsservice", "2020-06-30", "InitializeServiceLinkedRole", "idrsservice", "openAPI")
        {
        ...
        public override InitializeServiceLinkedRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InitializeServiceLinkedRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
