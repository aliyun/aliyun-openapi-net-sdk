...
{
    public class ListTaskGroupsRequest : RpcAcsRequest<ListTaskGroupsResponse>
    {
        public ListTaskGroupsRequest()
            : base("idrsservice", "2020-06-30", "ListTaskGroups", "idrsservice", "openAPI")
        {
        ...
        public override ListTaskGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTaskGroupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
