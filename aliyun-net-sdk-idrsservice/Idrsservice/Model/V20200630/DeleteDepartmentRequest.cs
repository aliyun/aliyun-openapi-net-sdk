...
{
    public class DeleteDepartmentRequest : RpcAcsRequest<DeleteDepartmentResponse>
    {
        public DeleteDepartmentRequest()
            : base("idrsservice", "2020-06-30", "DeleteDepartment", "idrsservice", "openAPI")
        {
        ...
        public override DeleteDepartmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDepartmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
