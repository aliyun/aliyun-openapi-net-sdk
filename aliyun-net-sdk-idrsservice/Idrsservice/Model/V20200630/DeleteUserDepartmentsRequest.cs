...
{
    public class DeleteUserDepartmentsRequest : RpcAcsRequest<DeleteUserDepartmentsResponse>
    {
        public DeleteUserDepartmentsRequest()
            : base("idrsservice", "2020-06-30", "DeleteUserDepartments", "idrsservice", "openAPI")
        {
		...
		public List<string> UserIds
		{
			...
			set
			{
				...
				{
					DictionaryUtil.Add(BodyParameters,"UserId." + (i + 1) , userIds[i]);
				}
			}
		}
        ...
        public override DeleteUserDepartmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteUserDepartmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
