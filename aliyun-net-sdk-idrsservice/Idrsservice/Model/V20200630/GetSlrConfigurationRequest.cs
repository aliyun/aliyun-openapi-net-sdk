...
{
    public class GetSlrConfigurationRequest : RpcAcsRequest<GetSlrConfigurationResponse>
    {
        public GetSlrConfigurationRequest()
            : base("idrsservice", "2020-06-30", "GetSlrConfiguration", "idrsservice", "openAPI")
        {
        ...
        public override GetSlrConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSlrConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
