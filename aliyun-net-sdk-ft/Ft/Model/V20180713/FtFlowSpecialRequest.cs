...
{
    public class FtFlowSpecialRequest : RpcAcsRequest<FtFlowSpecialResponse>
    {
        public FtFlowSpecialRequest()
            : base("Ft", "2018-07-13", "FtFlowSpecial")
        {
        ...
        public override FtFlowSpecialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FtFlowSpecialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
