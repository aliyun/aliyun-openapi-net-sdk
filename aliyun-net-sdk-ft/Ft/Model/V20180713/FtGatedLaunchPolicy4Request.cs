...
{
    public class FtGatedLaunchPolicy4Request : RpcAcsRequest<FtGatedLaunchPolicy4Response>
    {
        public FtGatedLaunchPolicy4Request()
            : base("Ft", "2018-07-13", "FtGatedLaunchPolicy4")
        {
		...
		public string IsGatedLaunch
		{
			...
			{
				isGatedLaunch = value;
				DictionaryUtil.Add(QueryParameters, "IsGatedLaunch", value);
			}
		}

        public override FtGatedLaunchPolicy4Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FtGatedLaunchPolicy4ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
