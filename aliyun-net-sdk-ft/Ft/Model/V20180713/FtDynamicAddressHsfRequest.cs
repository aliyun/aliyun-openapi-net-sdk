...
{
    public class FtDynamicAddressHsfRequest : RpcAcsRequest<FtDynamicAddressHsfResponse>
    {
        public FtDynamicAddressHsfRequest()
            : base("Ft", "2018-07-13", "FtDynamicAddressHsf")
        {
        ...
        public override FtDynamicAddressHsfResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FtDynamicAddressHsfResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
