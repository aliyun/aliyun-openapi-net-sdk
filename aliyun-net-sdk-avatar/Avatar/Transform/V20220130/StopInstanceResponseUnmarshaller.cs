...
namespace Aliyun.Acs.avatar.Transform.V20220130
{
    public class StopInstanceResponseUnmarshaller
    {
        public static StopInstanceResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			stopInstanceResponse.Code = _ctx.StringValue("StopInstance.Code");
			...
			StopInstanceResponse.StopInstance_Data data = new StopInstanceResponse.StopInstance_Data();
			data.RequestId = _ctx.StringValue("StopInstance.Data.RequestId");
			data.SessionId = _ctx.StringValue("StopInstance.Data.SessionId");
			stopInstanceResponse.Data = data;
