...
{
    public class LicenseAuthRequest : RpcAcsRequest<LicenseAuthResponse>
    {
        public LicenseAuthRequest()
            : base("avatar", "2022-01-30", "LicenseAuth")
        {
        ...
        public override LicenseAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LicenseAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
