...
{
    public class SendTextRequest : RpcAcsRequest<SendTextResponse>
    {
        public SendTextRequest()
            : base("avatar", "2022-01-30", "SendText")
        {
		...
		[JsonProperty(PropertyName = "Interrupt")]
        ...
        public override SendTextResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SendTextResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
