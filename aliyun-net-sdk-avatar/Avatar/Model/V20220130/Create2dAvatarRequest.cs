...
{
    public class Create2dAvatarRequest : RpcAcsRequest<Create2dAvatarResponse>
    {
        public Create2dAvatarRequest()
            : base("avatar", "2022-01-30", "Create2dAvatar")
        {
        ...
        public override Create2dAvatarResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return Create2dAvatarResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
