...
{
    public class GetVideoTaskInfoRequest : RpcAcsRequest<GetVideoTaskInfoResponse>
    {
        public GetVideoTaskInfoRequest()
            : base("avatar", "2022-01-30", "GetVideoTaskInfo")
        {
        }
        ...
        public override GetVideoTaskInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVideoTaskInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
