...
{
    public class DescribeApiMeteringRequest : RpcAcsRequest<DescribeApiMeteringResponse>
    {
        public DescribeApiMeteringRequest()
            : base("Market", "2015-11-01", "DescribeApiMetering", "yunmarket", "openAPI")
        {
        ...
        public override DescribeApiMeteringResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeApiMeteringResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
