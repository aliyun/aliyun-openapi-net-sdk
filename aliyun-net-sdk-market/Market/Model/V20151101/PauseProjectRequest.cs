...
namespace Aliyun.Acs.Market.Model.V20151101
{
    public class PauseProjectRequest : RpcAcsRequest<PauseProjectResponse>
    {
        ...
        public override PauseProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PauseProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
