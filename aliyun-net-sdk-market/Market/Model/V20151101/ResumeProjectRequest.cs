...
{
    public class ResumeProjectRequest : RpcAcsRequest<ResumeProjectResponse>
    {
        public ResumeProjectRequest()
            : base("Market", "2015-11-01", "ResumeProject", "yunmarket", "openAPI")
        {
        ...
        public override ResumeProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResumeProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
