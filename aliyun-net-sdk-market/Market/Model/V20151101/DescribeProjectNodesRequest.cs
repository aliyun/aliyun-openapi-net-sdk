...
{
    public class DescribeProjectNodesRequest : RpcAcsRequest<DescribeProjectNodesResponse>
    {
        public DescribeProjectNodesRequest()
            : base("Market", "2015-11-01", "DescribeProjectNodes", "yunmarket", "openAPI")
        {
        ...
        public override DescribeProjectNodesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProjectNodesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
