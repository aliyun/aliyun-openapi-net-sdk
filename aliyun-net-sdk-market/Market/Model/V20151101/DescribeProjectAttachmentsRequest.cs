...
{
    public class DescribeProjectAttachmentsRequest : RpcAcsRequest<DescribeProjectAttachmentsResponse>
    {
        public DescribeProjectAttachmentsRequest()
            : base("Market", "2015-11-01", "DescribeProjectAttachments", "yunmarket", "openAPI")
        {
        ...
        public override DescribeProjectAttachmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProjectAttachmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
