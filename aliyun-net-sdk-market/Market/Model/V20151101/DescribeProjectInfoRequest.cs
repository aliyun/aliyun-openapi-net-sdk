...
{
    public class DescribeProjectInfoRequest : RpcAcsRequest<DescribeProjectInfoResponse>
    {
        public DescribeProjectInfoRequest()
            : base("Market", "2015-11-01", "DescribeProjectInfo", "yunmarket", "openAPI")
        {
        ...
        public override DescribeProjectInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProjectInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
