...
{
    public class DescribeProjectMessagesRequest : RpcAcsRequest<DescribeProjectMessagesResponse>
    {
        public DescribeProjectMessagesRequest()
            : base("Market", "2015-11-01", "DescribeProjectMessages", "yunmarket", "openAPI")
        {
        ...
        public override DescribeProjectMessagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProjectMessagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
