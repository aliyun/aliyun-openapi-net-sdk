...
{
    public class DescribeDistributionProductsRequest : RpcAcsRequest<DescribeDistributionProductsResponse>
    {
        public DescribeDistributionProductsRequest()
            : base("Market", "2015-11-01", "DescribeDistributionProducts", "yunmarket", "openAPI")
        {
        ...
        public override DescribeDistributionProductsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDistributionProductsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
