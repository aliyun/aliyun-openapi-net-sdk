...
{
    public class DescribeProjectOperateLogsRequest : RpcAcsRequest<DescribeProjectOperateLogsResponse>
    {
        public DescribeProjectOperateLogsRequest()
            : base("Market", "2015-11-01", "DescribeProjectOperateLogs", "yunmarket", "openAPI")
        {
        ...
        public override DescribeProjectOperateLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProjectOperateLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
