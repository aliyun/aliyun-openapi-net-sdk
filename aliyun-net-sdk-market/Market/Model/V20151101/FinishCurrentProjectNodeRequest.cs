...
{
    public class FinishCurrentProjectNodeRequest : RpcAcsRequest<FinishCurrentProjectNodeResponse>
    {
        public FinishCurrentProjectNodeRequest()
            : base("Market", "2015-11-01", "FinishCurrentProjectNode", "yunmarket", "openAPI")
        {
		...
		public string TemplateForm
		{
			...
			{
				templateForm = value;
				DictionaryUtil.Add(QueryParameters, "TemplateForm", value);
			}
		}
		...
		public long? NodeId
		{
			...
			{
				nodeId = value;
				DictionaryUtil.Add(QueryParameters, "NodeId", value.ToString());
			}
		}
        ...
        public override FinishCurrentProjectNodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FinishCurrentProjectNodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
