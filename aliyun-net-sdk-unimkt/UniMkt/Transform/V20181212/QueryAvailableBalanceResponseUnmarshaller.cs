...
namespace Aliyun.Acs.UniMkt.Transform.V20181212
{
    ...
    {
        public static QueryAvailableBalanceResponse Unmarshall(UnmarshallerContext _ctx)
        {
			QueryAvailableBalanceResponse queryAvailableBalanceResponse = new QueryAvailableBalanceResponse();
