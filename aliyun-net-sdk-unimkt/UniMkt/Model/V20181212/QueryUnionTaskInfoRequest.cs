...
namespace Aliyun.Acs.UniMkt.Model.V20181212
{
    public class QueryUnionTaskInfoRequest : RpcAcsRequest<QueryUnionTaskInfoResponse>
    {
        ...
        public override QueryUnionTaskInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUnionTaskInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
