...
namespace Aliyun.Acs.UniMkt.Model.V20181212
{
    public class QueryUnionChannelRequest : RpcAcsRequest<QueryUnionChannelResponse>
    {
        ...
        public override QueryUnionChannelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUnionChannelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
