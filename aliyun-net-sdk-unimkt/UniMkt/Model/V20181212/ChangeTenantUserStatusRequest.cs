...
{
    public class ChangeTenantUserStatusRequest : RpcAcsRequest<ChangeTenantUserStatusResponse>
    {
        public ChangeTenantUserStatusRequest()
            : base("UniMkt", "2018-12-12", "ChangeTenantUserStatus", "1.0.0", "openAPI")
        {
        ...
        public override ChangeTenantUserStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeTenantUserStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
