...
{
    public class ChangeTenantStatusRequest : RpcAcsRequest<ChangeTenantStatusResponse>
    {
        public ChangeTenantStatusRequest()
            : base("UniMkt", "2018-12-12", "ChangeTenantStatus", "uniMkt", "openAPI")
        {
        ...
        public override ChangeTenantStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeTenantStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
