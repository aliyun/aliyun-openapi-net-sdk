...
{
    public class QueryTaskRulesRequest : RpcAcsRequest<QueryTaskRulesResponse>
    {
        public QueryTaskRulesRequest()
            : base("UniMkt", "2018-12-12", "QueryTaskRules", "uniMkt", "openAPI")
        {
        ...
        public override QueryTaskRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTaskRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
