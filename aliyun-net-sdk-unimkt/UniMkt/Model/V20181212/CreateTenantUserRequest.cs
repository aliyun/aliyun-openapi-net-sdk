...
{
    public class CreateTenantUserRequest : RpcAcsRequest<CreateTenantUserResponse>
    {
        public CreateTenantUserRequest()
            : base("UniMkt", "2018-12-12", "CreateTenantUser", "1.0.0", "openAPI")
        {
		...
		public string TenantUser
		{
			...
			{
				tenantUser = value;
				DictionaryUtil.Add(BodyParameters, "TenantUser", value);
			}
		}
        ...
        public override CreateTenantUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTenantUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
