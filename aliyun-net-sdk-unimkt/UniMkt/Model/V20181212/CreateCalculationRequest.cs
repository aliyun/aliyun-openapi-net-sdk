...
{
    public class CreateCalculationRequest : RpcAcsRequest<CreateCalculationResponse>
    {
        public CreateCalculationRequest()
            : base("UniMkt", "2018-12-12", "CreateCalculation", "uniMkt", "openAPI")
        {
		...
		public string CloudCodeUserId
		{
			get
			{
				return cloudCodeUserId;
			}
			set	
			{
				cloudCodeUserId = value;
				DictionaryUtil.Add(QueryParameters, "CloudCodeUserId", value);
			}
		}
        ...
        public override CreateCalculationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCalculationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
