...
{
    public class QueryChannelHistoryDataRequest : RpcAcsRequest<QueryChannelHistoryDataResponse>
    {
        public QueryChannelHistoryDataRequest()
            : base("UniMkt", "2018-12-12", "QueryChannelHistoryData", "1.0.0", "openAPI")
        {
        ...
        public override QueryChannelHistoryDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryChannelHistoryDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
