...
namespace Aliyun.Acs.UniMkt.Model.V20181212
{
    public class CreatesSlotTemplateRequest : RpcAcsRequest<CreatesSlotTemplateResponse>
    {
        ...
        public override CreatesSlotTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatesSlotTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
