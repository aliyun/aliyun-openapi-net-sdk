...
{
    public class QueryTenantUserByUserIdRequest : RpcAcsRequest<QueryTenantUserByUserIdResponse>
    {
        public QueryTenantUserByUserIdRequest()
            : base("UniMkt", "2018-12-12", "QueryTenantUserByUserId", "1.0.0", "openAPI")
        {
        ...
        public override QueryTenantUserByUserIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTenantUserByUserIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
