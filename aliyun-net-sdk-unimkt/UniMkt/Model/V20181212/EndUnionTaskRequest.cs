...
{
    public class EndUnionTaskRequest : RpcAcsRequest<EndUnionTaskResponse>
    {
        public EndUnionTaskRequest()
            : base("UniMkt", "2018-12-12", "EndUnionTask", "uniMkt", "openAPI")
        {
        ...
        public override EndUnionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EndUnionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
