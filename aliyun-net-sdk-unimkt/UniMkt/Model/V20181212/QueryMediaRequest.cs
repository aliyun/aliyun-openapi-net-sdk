...
namespace Aliyun.Acs.UniMkt.Model.V20181212
{
    public class QueryMediaRequest : RpcAcsRequest<QueryMediaResponse>
    {
        ...
        public override QueryMediaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMediaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
