...
{
	public class QueryTenantUserByUserIdResponse : AcsResponse
	{
		...
		private QueryTenantUserByUserId_Model model;
		...
		public QueryTenantUserByUserId_Model Model
		{
			get
			{
				return model;
		...
		public class QueryTenantUserByUserId_Model
		{
