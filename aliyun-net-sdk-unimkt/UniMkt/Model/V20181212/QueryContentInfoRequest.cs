...
{
    public class QueryContentInfoRequest : RpcAcsRequest<QueryContentInfoResponse>
    {
        public QueryContentInfoRequest()
            : base("UniMkt", "2018-12-12", "QueryContentInfo", "uniMkt", "openAPI")
        {
        ...
        public override QueryContentInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryContentInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
