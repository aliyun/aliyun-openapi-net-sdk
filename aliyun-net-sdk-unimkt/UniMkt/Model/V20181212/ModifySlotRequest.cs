...
{
    public class ModifySlotRequest : RpcAcsRequest<ModifySlotResponse>
    {
        public ModifySlotRequest()
            : base("UniMkt", "2018-12-12", "ModifySlot", "uniMkt", "openAPI")
        {
        ...
        public override ModifySlotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySlotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
