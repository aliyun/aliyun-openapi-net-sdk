...
{
	public class ChangeTenantUserStatusResponse : AcsResponse
	{
		...
		private ChangeTenantUserStatus_Model model;
		...
		public ChangeTenantUserStatus_Model Model
		{
			get
			{
				return model;
		...
		public class ChangeTenantUserStatus_Model
		{
