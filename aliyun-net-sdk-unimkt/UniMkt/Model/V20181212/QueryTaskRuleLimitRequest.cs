...
{
    public class QueryTaskRuleLimitRequest : RpcAcsRequest<QueryTaskRuleLimitResponse>
    {
        public QueryTaskRuleLimitRequest()
            : base("UniMkt", "2018-12-12", "QueryTaskRuleLimit", "uniMkt", "openAPI")
        {
        ...
        public override QueryTaskRuleLimitResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTaskRuleLimitResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
