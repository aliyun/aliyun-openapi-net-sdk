...
{
    public class QuerySlotRequest : RpcAcsRequest<QuerySlotResponse>
    {
        public QuerySlotRequest()
            : base("UniMkt", "2018-12-12", "QuerySlot", "uniMkt", "openAPI")
        {
        ...
        public override QuerySlotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySlotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
