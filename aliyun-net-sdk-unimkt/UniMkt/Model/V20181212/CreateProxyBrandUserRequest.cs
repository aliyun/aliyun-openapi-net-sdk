...
{
    public class CreateProxyBrandUserRequest : RpcAcsRequest<CreateProxyBrandUserResponse>
    {
        public CreateProxyBrandUserRequest()
            : base("UniMkt", "2018-12-12", "CreateProxyBrandUser", "uniMkt", "openAPI")
        {
		...
		public string Company
		{
			...
			{
				company = value;
				DictionaryUtil.Add(QueryParameters, "Company", value);
			}
		}
		...
		public string ContactPhone
		{
			...
			{
				contactPhone = value;
				DictionaryUtil.Add(QueryParameters, "ContactPhone", value);
			}
		}
        ...
        public override CreateProxyBrandUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateProxyBrandUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
