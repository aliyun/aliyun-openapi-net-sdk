...
namespace Aliyun.Acs.UniMkt.Model.V20181212
{
    public class GetUnionTaskStatusRequest : RpcAcsRequest<GetUnionTaskStatusResponse>
    {
        ...
        public override GetUnionTaskStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUnionTaskStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
