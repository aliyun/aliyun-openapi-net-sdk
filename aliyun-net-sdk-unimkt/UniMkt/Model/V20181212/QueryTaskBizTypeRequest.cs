...
{
    public class QueryTaskBizTypeRequest : RpcAcsRequest<QueryTaskBizTypeResponse>
    {
        public QueryTaskBizTypeRequest()
            : base("UniMkt", "2018-12-12", "QueryTaskBizType", "uniMkt", "openAPI")
        {
        ...
        public override QueryTaskBizTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTaskBizTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
