...
{
	public class ChangeSlotStatusResponse : AcsResponse
	{
		...
		private ChangeSlotStatus_Model model;
		...
		public ChangeSlotStatus_Model Model
		{
			get
			{
				return model;
		...
		public class ChangeSlotStatus_Model
		{
