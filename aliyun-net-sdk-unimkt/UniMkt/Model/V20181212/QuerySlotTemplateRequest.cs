...
{
    public class QuerySlotTemplateRequest : RpcAcsRequest<QuerySlotTemplateResponse>
    {
        public QuerySlotTemplateRequest()
            : base("UniMkt", "2018-12-12", "QuerySlotTemplate", "uniMkt", "openAPI")
        {
		...
		public string AdSlotTemplateId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AdSlotTemplateId", value);
			}
		}
        ...
        public override QuerySlotTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySlotTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
