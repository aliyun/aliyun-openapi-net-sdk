...
{
    public class ModifyTenantInfoRequest : RpcAcsRequest<ModifyTenantInfoResponse>
    {
        public ModifyTenantInfoRequest()
            : base("UniMkt", "2018-12-12", "ModifyTenantInfo", "uniMkt", "openAPI")
        {
        ...
        public override ModifyTenantInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
