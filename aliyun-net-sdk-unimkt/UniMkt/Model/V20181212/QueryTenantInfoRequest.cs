...
{
    public class QueryTenantInfoRequest : RpcAcsRequest<QueryTenantInfoResponse>
    {
        public QueryTenantInfoRequest()
            : base("UniMkt", "2018-12-12", "QueryTenantInfo", "uniMkt", "openAPI")
        {
        ...
        public override QueryTenantInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTenantInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
