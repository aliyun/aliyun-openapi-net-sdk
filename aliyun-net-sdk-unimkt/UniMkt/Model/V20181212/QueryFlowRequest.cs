...
{
    public class QueryFlowRequest : RpcAcsRequest<QueryFlowResponse>
    {
        public QueryFlowRequest()
            : base("UniMkt", "2018-12-12", "QueryFlow", "1.0.0", "openAPI")
        {
        ...
        public override QueryFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
