...
{
	public class ListUserResponse : AcsResponse
	{
		...
		private List<ListUser_SspUserDTOModel> model;
		...
		public List<ListUser_SspUserDTOModel> Model
		{
			get
			{
				return model;
		...
		public class ListUser_SspUserDTOModel
		{
