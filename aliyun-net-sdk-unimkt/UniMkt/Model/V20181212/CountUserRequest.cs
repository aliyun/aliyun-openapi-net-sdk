...
{
    public class CountUserRequest : RpcAcsRequest<CountUserResponse>
    {
        public CountUserRequest()
            : base("UniMkt", "2018-12-12", "CountUser", "1.0.0", "openAPI")
        {
		...
		public string SspUser
		{
			...
			{
				sspUser = value;
				DictionaryUtil.Add(BodyParameters, "SspUser", value);
			}
		}
        ...
        public override CountUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
