...
{
    public class PushDeviceStatusRequest : RpcAcsRequest<PushDeviceStatusResponse>
    {
        public PushDeviceStatusRequest()
            : base("UniMkt", "2018-12-12", "PushDeviceStatus", "uniMkt", "openAPI")
        {
        ...
        public override PushDeviceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PushDeviceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
