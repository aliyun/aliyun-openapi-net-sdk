...
namespace Aliyun.Acs.UniMkt.Model.V20181212
{
    public class QueryIndustryLabelBagRequest : RpcAcsRequest<QueryIndustryLabelBagResponse>
    {
        ...
        public override QueryIndustryLabelBagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryIndustryLabelBagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
