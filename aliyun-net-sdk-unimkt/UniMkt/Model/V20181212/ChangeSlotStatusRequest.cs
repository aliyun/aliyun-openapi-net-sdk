...
{
    public class ChangeSlotStatusRequest : RpcAcsRequest<ChangeSlotStatusResponse>
    {
        public ChangeSlotStatusRequest()
            : base("UniMkt", "2018-12-12", "ChangeSlotStatus", "uniMkt", "openAPI")
        {
		...
		public string AdSlotStatus
		{
			...
			{
				adSlotStatus = value;
				DictionaryUtil.Add(BodyParameters, "AdSlotStatus", value);
			}
		}
		...
		public string AdSlotId
		{
			...
			{
				adSlotId = value;
				DictionaryUtil.Add(BodyParameters, "AdSlotId", value);
			}
		}
		...
		public string AdSlotCorporateStatus
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "AdSlotCorporateStatus", value);
			}
		}
        ...
        public override ChangeSlotStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeSlotStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
