...
{
	public class QuerySlotTemplateResponse : AcsResponse
	{
		...
		private QuerySlotTemplate_Model model;
		...
		public QuerySlotTemplate_Model Model
		{
			get
			{
				return model;
		...
		public class QuerySlotTemplate_Model
		{
