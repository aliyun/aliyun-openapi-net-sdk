...
{
    public class QueryUserRequest : RpcAcsRequest<QueryUserResponse>
    {
        public QueryUserRequest()
            : base("UniMkt", "2018-12-12", "QueryUser", "1.0.0", "openAPI")
        {
        ...
        public override QueryUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
