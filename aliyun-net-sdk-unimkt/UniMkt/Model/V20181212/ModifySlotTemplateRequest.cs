...
{
    public class ModifySlotTemplateRequest : RpcAcsRequest<ModifySlotTemplateResponse>
    {
        public ModifySlotTemplateRequest()
            : base("UniMkt", "2018-12-12", "ModifySlotTemplate", "uniMkt", "openAPI")
        {
		...
		public string AdSlotTemplate
		{
			get
			{
				return adSlotTemplate;
			}
			set	
			{
				adSlotTemplate = value;
				DictionaryUtil.Add(BodyParameters, "AdSlotTemplate", value);
			}
		}
        ...
        public override ModifySlotTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySlotTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
