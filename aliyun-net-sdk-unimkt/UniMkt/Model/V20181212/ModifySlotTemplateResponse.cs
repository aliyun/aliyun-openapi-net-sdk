...
{
	public class ModifySlotTemplateResponse : AcsResponse
	{
		...
		private ModifySlotTemplate_Model model;
		...
		public ModifySlotTemplate_Model Model
		{
			get
			{
				return model;
		...
		public class ModifySlotTemplate_Model
		{
