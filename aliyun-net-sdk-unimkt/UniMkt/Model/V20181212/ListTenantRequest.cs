...
{
    public class ListTenantRequest : RpcAcsRequest<ListTenantResponse>
    {
        public ListTenantRequest()
            : base("UniMkt", "2018-12-12", "ListTenant", "uniMkt", "openAPI")
        {
        ...
        public override ListTenantResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTenantResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
