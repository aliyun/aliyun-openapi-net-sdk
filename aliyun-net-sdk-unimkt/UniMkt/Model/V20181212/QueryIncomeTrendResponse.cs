...
{
	public class QueryIncomeTrendResponse : AcsResponse
	{
		...
		private List<QueryIncomeTrend_Data> model;
		...
		public List<QueryIncomeTrend_Data> Model
		{
			get
			{
				return model;
		...
		public class QueryIncomeTrend_Data
		{
