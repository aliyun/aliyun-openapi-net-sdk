...
{
    public class ReduceAmountRequest : RpcAcsRequest<ReduceAmountResponse>
    {
        public ReduceAmountRequest()
            : base("UniMkt", "2018-12-12", "ReduceAmount", "uniMkt", "openAPI")
        {
        ...
        public override ReduceAmountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReduceAmountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
