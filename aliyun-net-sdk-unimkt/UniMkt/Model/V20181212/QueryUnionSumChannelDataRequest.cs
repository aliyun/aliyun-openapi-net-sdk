...
{
    public class QueryUnionSumChannelDataRequest : RpcAcsRequest<QueryUnionSumChannelDataResponse>
    {
        public QueryUnionSumChannelDataRequest()
            : base("UniMkt", "2018-12-12", "QueryUnionSumChannelData", "1.0.0", "openAPI")
        {
        ...
        public override QueryUnionSumChannelDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUnionSumChannelDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
