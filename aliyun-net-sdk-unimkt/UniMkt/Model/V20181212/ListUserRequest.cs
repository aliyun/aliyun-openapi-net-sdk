...
{
    public class ListUserRequest : RpcAcsRequest<ListUserResponse>
    {
        public ListUserRequest()
            : base("UniMkt", "2018-12-12", "ListUser", "1.0.0", "openAPI")
        {
        ...
        public override ListUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
