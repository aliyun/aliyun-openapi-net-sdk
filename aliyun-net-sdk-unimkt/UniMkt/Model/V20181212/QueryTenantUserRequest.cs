...
{
    public class QueryTenantUserRequest : RpcAcsRequest<QueryTenantUserResponse>
    {
        public QueryTenantUserRequest()
            : base("UniMkt", "2018-12-12", "QueryTenantUser", "uniMkt", "openAPI")
        {
        ...
        public override QueryTenantUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTenantUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
