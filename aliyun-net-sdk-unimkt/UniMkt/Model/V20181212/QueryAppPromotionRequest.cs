...
{
    public class QueryAppPromotionRequest : RpcAcsRequest<QueryAppPromotionResponse>
    {
        public QueryAppPromotionRequest()
            : base("UniMkt", "2018-12-12", "QueryAppPromotion", "1.0.0", "openAPI")
        {
        ...
        public override QueryAppPromotionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryAppPromotionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
