...
{
    public class CreateSlotRequest : RpcAcsRequest<CreateSlotResponse>
    {
        public CreateSlotRequest()
            : base("UniMkt", "2018-12-12", "CreateSlot", "uniMkt", "openAPI")
        {
		...
		public string AdSlot
		{
			...
			{
				adSlot = value;
				DictionaryUtil.Add(BodyParameters, "AdSlot", value);
			}
		}
        ...
        public override CreateSlotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSlotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
