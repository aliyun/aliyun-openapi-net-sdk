...
namespace Aliyun.Acs.UniMkt.Model.V20181207
{
    public class GetConsoleInfoRequest : RpcAcsRequest<GetConsoleInfoResponse>
    {
        ...
        public override GetConsoleInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetConsoleInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
