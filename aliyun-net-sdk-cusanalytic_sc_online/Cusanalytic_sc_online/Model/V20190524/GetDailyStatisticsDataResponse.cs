...
{
	public class GetDailyStatisticsDataResponse : AcsResponse
	{
		...
		private List<GetDailyStatisticsData_BaseStatisticsData> baseStatisticsDatas;
		...
		public List<GetDailyStatisticsData_BaseStatisticsData> BaseStatisticsDatas
		{
			get
			{
		...
		public class GetDailyStatisticsData_BaseStatisticsData
		{
