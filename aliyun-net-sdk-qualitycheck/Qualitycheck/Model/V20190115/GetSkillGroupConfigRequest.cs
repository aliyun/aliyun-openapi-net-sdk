...
{
    public class GetSkillGroupConfigRequest : RpcAcsRequest<GetSkillGroupConfigResponse>
    {
        public GetSkillGroupConfigRequest()
            : base("Qualitycheck", "2019-01-15", "GetSkillGroupConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override GetSkillGroupConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSkillGroupConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
