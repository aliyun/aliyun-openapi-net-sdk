...
{
    public class AddRuleCategoryRequest : RpcAcsRequest<AddRuleCategoryResponse>
    {
        public AddRuleCategoryRequest()
            : base("Qualitycheck", "2019-01-15", "AddRuleCategory", "Qualitycheck", "openAPI")
        {
        ...
        public override AddRuleCategoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddRuleCategoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
