...
{
    public class UpdateWarningConfigRequest : RpcAcsRequest<UpdateWarningConfigResponse>
    {
        public UpdateWarningConfigRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateWarningConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateWarningConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateWarningConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
