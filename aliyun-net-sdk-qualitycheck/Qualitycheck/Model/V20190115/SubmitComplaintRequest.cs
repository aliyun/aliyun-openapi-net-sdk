...
{
    public class SubmitComplaintRequest : RpcAcsRequest<SubmitComplaintResponse>
    {
        public SubmitComplaintRequest()
            : base("Qualitycheck", "2019-01-15", "SubmitComplaint", "Qualitycheck", "openAPI")
        {
        ...
        public override SubmitComplaintResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitComplaintResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
