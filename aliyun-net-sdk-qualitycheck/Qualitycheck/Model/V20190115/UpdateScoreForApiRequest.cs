...
{
    public class UpdateScoreForApiRequest : RpcAcsRequest<UpdateScoreForApiResponse>
    {
        public UpdateScoreForApiRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateScoreForApi", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateScoreForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateScoreForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
