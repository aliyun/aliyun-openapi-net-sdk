...
{
    public class UpdateSkillGroupConfigRequest : RpcAcsRequest<UpdateSkillGroupConfigResponse>
    {
        public UpdateSkillGroupConfigRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateSkillGroupConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateSkillGroupConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateSkillGroupConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
