...
{
    public class GetResultRequest : RpcAcsRequest<GetResultResponse>
    {
        public GetResultRequest()
            : base("Qualitycheck", "2019-01-15", "GetResult", "Qualitycheck", "openAPI")
        {
        ...
        public override GetResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
