...
{
    public class SubmitPrecisionTaskRequest : RpcAcsRequest<SubmitPrecisionTaskResponse>
    {
        public SubmitPrecisionTaskRequest()
            : base("Qualitycheck", "2019-01-15", "SubmitPrecisionTask", "Qualitycheck", "openAPI")
        {
        ...
        public override SubmitPrecisionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitPrecisionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
