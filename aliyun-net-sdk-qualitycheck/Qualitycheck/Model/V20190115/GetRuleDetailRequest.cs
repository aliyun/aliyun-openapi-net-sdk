...
{
    public class GetRuleDetailRequest : RpcAcsRequest<GetRuleDetailResponse>
    {
        public GetRuleDetailRequest()
            : base("Qualitycheck", "2019-01-15", "GetRuleDetail", "Qualitycheck", "openAPI")
        {
        ...
        public override GetRuleDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRuleDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
