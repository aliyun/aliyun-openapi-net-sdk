...
{
    public class GetHitResultRequest : RpcAcsRequest<GetHitResultResponse>
    {
        public GetHitResultRequest()
            : base("Qualitycheck", "2019-01-15", "GetHitResult", "Qualitycheck", "openAPI")
        {
        ...
        public override GetHitResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetHitResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
