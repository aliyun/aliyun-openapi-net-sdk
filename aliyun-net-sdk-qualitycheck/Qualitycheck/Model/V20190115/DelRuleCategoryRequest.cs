...
{
    public class DelRuleCategoryRequest : RpcAcsRequest<DelRuleCategoryResponse>
    {
        public DelRuleCategoryRequest()
            : base("Qualitycheck", "2019-01-15", "DelRuleCategory", "Qualitycheck", "openAPI")
        {
        ...
        public override DelRuleCategoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DelRuleCategoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
