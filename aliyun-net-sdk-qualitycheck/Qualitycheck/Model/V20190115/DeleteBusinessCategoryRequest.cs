...
{
    public class DeleteBusinessCategoryRequest : RpcAcsRequest<DeleteBusinessCategoryResponse>
    {
        public DeleteBusinessCategoryRequest()
            : base("Qualitycheck", "2019-01-15", "DeleteBusinessCategory", "Qualitycheck", "openAPI")
        {
        ...
        public override DeleteBusinessCategoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteBusinessCategoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
