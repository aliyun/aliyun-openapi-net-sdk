...
{
    public class UploadDataSyncRequest : RpcAcsRequest<UploadDataSyncResponse>
    {
        public UploadDataSyncRequest()
            : base("Qualitycheck", "2019-01-15", "UploadDataSync", "Qualitycheck", "openAPI")
        {
        ...
        public override UploadDataSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadDataSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
