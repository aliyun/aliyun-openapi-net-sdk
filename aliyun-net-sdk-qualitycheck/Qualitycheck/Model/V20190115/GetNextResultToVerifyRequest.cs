...
{
    public class GetNextResultToVerifyRequest : RpcAcsRequest<GetNextResultToVerifyResponse>
    {
        public GetNextResultToVerifyRequest()
            : base("Qualitycheck", "2019-01-15", "GetNextResultToVerify", "Qualitycheck", "openAPI")
        {
        ...
        public override GetNextResultToVerifyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNextResultToVerifyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
