...
{
    public class UpdateTaskAssignRuleRequest : RpcAcsRequest<UpdateTaskAssignRuleResponse>
    {
        public UpdateTaskAssignRuleRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateTaskAssignRule", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateTaskAssignRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTaskAssignRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
