...
{
    public class UpdateAsrVocabRequest : RpcAcsRequest<UpdateAsrVocabResponse>
    {
        public UpdateAsrVocabRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateAsrVocab", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateAsrVocabResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateAsrVocabResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
