...
{
    public class GetRecognizeResultRequest : RpcAcsRequest<GetRecognizeResultResponse>
    {
        public GetRecognizeResultRequest()
            : base("Qualitycheck", "2019-01-15", "GetRecognizeResult", "Qualitycheck", "openAPI")
        {
        ...
        public override GetRecognizeResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRecognizeResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
