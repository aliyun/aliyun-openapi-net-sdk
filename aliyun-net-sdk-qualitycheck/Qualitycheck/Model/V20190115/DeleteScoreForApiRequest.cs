...
{
    public class DeleteScoreForApiRequest : RpcAcsRequest<DeleteScoreForApiResponse>
    {
        public DeleteScoreForApiRequest()
            : base("Qualitycheck", "2019-01-15", "DeleteScoreForApi", "Qualitycheck", "openAPI")
        {
        ...
        public override DeleteScoreForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteScoreForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
