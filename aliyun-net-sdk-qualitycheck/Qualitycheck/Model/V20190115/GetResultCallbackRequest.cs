...
{
    public class GetResultCallbackRequest : RpcAcsRequest<GetResultCallbackResponse>
    {
        public GetResultCallbackRequest()
            : base("Qualitycheck", "2019-01-15", "GetResultCallback", "Qualitycheck", "openAPI")
        {
        ...
        public override GetResultCallbackResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResultCallbackResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
