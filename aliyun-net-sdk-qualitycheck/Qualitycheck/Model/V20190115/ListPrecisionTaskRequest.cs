...
{
    public class ListPrecisionTaskRequest : RpcAcsRequest<ListPrecisionTaskResponse>
    {
        public ListPrecisionTaskRequest()
            : base("Qualitycheck", "2019-01-15", "ListPrecisionTask", "Qualitycheck", "openAPI")
        {
        ...
        public override ListPrecisionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPrecisionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
