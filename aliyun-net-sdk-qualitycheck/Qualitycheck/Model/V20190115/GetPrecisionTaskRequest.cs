...
{
    public class GetPrecisionTaskRequest : RpcAcsRequest<GetPrecisionTaskResponse>
    {
        public GetPrecisionTaskRequest()
            : base("Qualitycheck", "2019-01-15", "GetPrecisionTask", "Qualitycheck", "openAPI")
        {
        ...
        public override GetPrecisionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPrecisionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
