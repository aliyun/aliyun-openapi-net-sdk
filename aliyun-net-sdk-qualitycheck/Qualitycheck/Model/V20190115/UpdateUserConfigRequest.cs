...
{
    public class UpdateUserConfigRequest : RpcAcsRequest<UpdateUserConfigResponse>
    {
        public UpdateUserConfigRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateUserConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateUserConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateUserConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
