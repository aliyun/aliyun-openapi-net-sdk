...
{
    public class GetRuleCategoryRequest : RpcAcsRequest<GetRuleCategoryResponse>
    {
        public GetRuleCategoryRequest()
            : base("Qualitycheck", "2019-01-15", "GetRuleCategory", "Qualitycheck", "openAPI")
        {
        ...
        public override GetRuleCategoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRuleCategoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
