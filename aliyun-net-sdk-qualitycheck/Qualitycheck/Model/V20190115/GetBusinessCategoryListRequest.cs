...
{
    public class GetBusinessCategoryListRequest : RpcAcsRequest<GetBusinessCategoryListResponse>
    {
        public GetBusinessCategoryListRequest()
            : base("Qualitycheck", "2019-01-15", "GetBusinessCategoryList", "Qualitycheck", "openAPI")
        {
        ...
        public override GetBusinessCategoryListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetBusinessCategoryListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
