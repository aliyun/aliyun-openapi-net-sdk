...
{
    public class UpdateRuleForAntRequest : RpcAcsRequest<UpdateRuleForAntResponse>
    {
        public UpdateRuleForAntRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateRuleForAnt", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateRuleForAntResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRuleForAntResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
