...
{
    public class ValidateRoleSetRequest : RpcAcsRequest<ValidateRoleSetResponse>
    {
        public ValidateRoleSetRequest()
            : base("Qualitycheck", "2019-01-15", "ValidateRoleSet", "Qualitycheck", "openAPI")
        {
        ...
        public override ValidateRoleSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ValidateRoleSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
