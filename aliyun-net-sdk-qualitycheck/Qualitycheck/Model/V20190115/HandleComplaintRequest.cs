...
{
    public class HandleComplaintRequest : RpcAcsRequest<HandleComplaintResponse>
    {
        public HandleComplaintRequest()
            : base("Qualitycheck", "2019-01-15", "HandleComplaint", "Qualitycheck", "openAPI")
        {
        ...
        public override HandleComplaintResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return HandleComplaintResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
