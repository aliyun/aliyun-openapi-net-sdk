...
namespace Aliyun.Acs.Qualitycheck.Model.V20190115
{
    public class GetCustomizationConfigListRequest : RpcAcsRequest<GetCustomizationConfigListResponse>
    {
        ...
        public override GetCustomizationConfigListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCustomizationConfigListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
