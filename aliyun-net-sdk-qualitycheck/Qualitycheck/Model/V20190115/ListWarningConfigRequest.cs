...
{
    public class ListWarningConfigRequest : RpcAcsRequest<ListWarningConfigResponse>
    {
        public ListWarningConfigRequest()
            : base("Qualitycheck", "2019-01-15", "ListWarningConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override ListWarningConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListWarningConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
