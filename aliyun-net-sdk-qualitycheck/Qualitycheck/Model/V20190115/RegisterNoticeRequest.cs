...
{
    public class RegisterNoticeRequest : RpcAcsRequest<RegisterNoticeResponse>
    {
        public RegisterNoticeRequest()
            : base("Qualitycheck", "2019-01-15", "RegisterNotice", "Qualitycheck", "openAPI")
        {
        ...
        public override RegisterNoticeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RegisterNoticeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
