...
{
    public class VerifySentenceRequest : RpcAcsRequest<VerifySentenceResponse>
    {
        public VerifySentenceRequest()
            : base("Qualitycheck", "2019-01-15", "VerifySentence", "Qualitycheck", "openAPI")
        {
        ...
        public override VerifySentenceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifySentenceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
