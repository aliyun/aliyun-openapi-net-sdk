...
{
    public class GetAsrVocabRequest : RpcAcsRequest<GetAsrVocabResponse>
    {
        public GetAsrVocabRequest()
            : base("Qualitycheck", "2019-01-15", "GetAsrVocab", "Qualitycheck", "openAPI")
        {
        ...
        public override GetAsrVocabResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAsrVocabResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
