...
{
    public class GetSyncResultRequest : RpcAcsRequest<GetSyncResultResponse>
    {
        public GetSyncResultRequest()
            : base("Qualitycheck", "2019-01-15", "GetSyncResult", "Qualitycheck", "openAPI")
        {
        ...
        public override GetSyncResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSyncResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
