...
{
    public class CreateAsrVocabRequest : RpcAcsRequest<CreateAsrVocabResponse>
    {
        public CreateAsrVocabRequest()
            : base("Qualitycheck", "2019-01-15", "CreateAsrVocab", "Qualitycheck", "openAPI")
        {
        ...
        public override CreateAsrVocabResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateAsrVocabResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
