...
{
    public class UploadDataRequest : RpcAcsRequest<UploadDataResponse>
    {
        public UploadDataRequest()
            : base("Qualitycheck", "2019-01-15", "UploadData", "Qualitycheck", "openAPI")
        {
        ...
        public override UploadDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
