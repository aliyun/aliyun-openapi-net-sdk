...
{
    public class UploadRuleRequest : RpcAcsRequest<UploadRuleResponse>
    {
        public UploadRuleRequest()
            : base("Qualitycheck", "2019-01-15", "UploadRule", "Qualitycheck", "openAPI")
        {
        ...
        public override UploadRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
