...
{
    public class SubmitQualityCheckTaskRequest : RpcAcsRequest<SubmitQualityCheckTaskResponse>
    {
        public SubmitQualityCheckTaskRequest()
            : base("Qualitycheck", "2019-01-15", "SubmitQualityCheckTask", "Qualitycheck", "openAPI")
        {
        ...
        public override SubmitQualityCheckTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitQualityCheckTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
