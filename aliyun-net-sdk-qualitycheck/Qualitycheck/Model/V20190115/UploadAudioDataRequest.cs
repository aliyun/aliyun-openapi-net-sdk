...
{
    public class UploadAudioDataRequest : RpcAcsRequest<UploadAudioDataResponse>
    {
        public UploadAudioDataRequest()
            : base("Qualitycheck", "2019-01-15", "UploadAudioData", "Qualitycheck", "openAPI")
        {
        ...
        public override UploadAudioDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadAudioDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
