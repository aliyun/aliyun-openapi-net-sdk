...
{
    public class CreateTaskAssignRuleRequest : RpcAcsRequest<CreateTaskAssignRuleResponse>
    {
        public CreateTaskAssignRuleRequest()
            : base("Qualitycheck", "2019-01-15", "CreateTaskAssignRule", "Qualitycheck", "openAPI")
        {
        ...
        public override CreateTaskAssignRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTaskAssignRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
