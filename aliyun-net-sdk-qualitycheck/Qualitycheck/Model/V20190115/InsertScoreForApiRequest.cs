...
{
    public class InsertScoreForApiRequest : RpcAcsRequest<InsertScoreForApiResponse>
    {
        public InsertScoreForApiRequest()
            : base("Qualitycheck", "2019-01-15", "InsertScoreForApi", "Qualitycheck", "openAPI")
        {
        ...
        public override InsertScoreForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InsertScoreForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
