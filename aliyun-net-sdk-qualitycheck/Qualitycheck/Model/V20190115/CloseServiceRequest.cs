...
{
    public class CloseServiceRequest : RpcAcsRequest<CloseServiceResponse>
    {
        public CloseServiceRequest()
            : base("Qualitycheck", "2019-01-15", "CloseService", "Qualitycheck", "openAPI")
        {
        ...
        public override CloseServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
