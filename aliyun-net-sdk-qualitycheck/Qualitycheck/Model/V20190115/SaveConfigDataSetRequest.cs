...
{
    public class SaveConfigDataSetRequest : RpcAcsRequest<SaveConfigDataSetResponse>
    {
        public SaveConfigDataSetRequest()
            : base("Qualitycheck", "2019-01-15", "SaveConfigDataSet", "Qualitycheck", "openAPI")
        {
        ...
        public override SaveConfigDataSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveConfigDataSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
