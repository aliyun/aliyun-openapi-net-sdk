...
{
    public class AddBusinessCategoryRequest : RpcAcsRequest<AddBusinessCategoryResponse>
    {
        public AddBusinessCategoryRequest()
            : base("Qualitycheck", "2019-01-15", "AddBusinessCategory", "Qualitycheck", "openAPI")
        {
        ...
        public override AddBusinessCategoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddBusinessCategoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
