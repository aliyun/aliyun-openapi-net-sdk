...
{
    public class VerifyFileRequest : RpcAcsRequest<VerifyFileResponse>
    {
        public VerifyFileRequest()
            : base("Qualitycheck", "2019-01-15", "VerifyFile", "Qualitycheck", "openAPI")
        {
        ...
        public override VerifyFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
