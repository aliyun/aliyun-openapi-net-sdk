...
{
    public class OpenServiceRequest : RpcAcsRequest<OpenServiceResponse>
    {
        public OpenServiceRequest()
            : base("Qualitycheck", "2019-01-15", "OpenService", "Qualitycheck", "openAPI")
        {
        ...
        public override OpenServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
