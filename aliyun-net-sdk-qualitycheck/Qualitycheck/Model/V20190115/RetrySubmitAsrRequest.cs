...
{
    public class RetrySubmitAsrRequest : RpcAcsRequest<RetrySubmitAsrResponse>
    {
        public RetrySubmitAsrRequest()
            : base("Qualitycheck", "2019-01-15", "RetrySubmitAsr", "Qualitycheck", "openAPI")
        {
        ...
        public override RetrySubmitAsrResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RetrySubmitAsrResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
