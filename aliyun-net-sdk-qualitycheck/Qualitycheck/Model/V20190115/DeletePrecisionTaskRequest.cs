...
{
    public class DeletePrecisionTaskRequest : RpcAcsRequest<DeletePrecisionTaskResponse>
    {
        public DeletePrecisionTaskRequest()
            : base("Qualitycheck", "2019-01-15", "DeletePrecisionTask", "Qualitycheck", "openAPI")
        {
        ...
        public override DeletePrecisionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePrecisionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
