...
{
    public class DeleteCustomizationConfigRequest : RpcAcsRequest<DeleteCustomizationConfigResponse>
    {
        public DeleteCustomizationConfigRequest()
            : base("Qualitycheck", "2019-01-15", "DeleteCustomizationConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override DeleteCustomizationConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCustomizationConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
