...
namespace Aliyun.Acs.Qualitycheck.Model.V20190115
{
    public class DelThesaurusForApiRequest : RpcAcsRequest<DelThesaurusForApiResponse>
    {
        ...
        public override DelThesaurusForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DelThesaurusForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
