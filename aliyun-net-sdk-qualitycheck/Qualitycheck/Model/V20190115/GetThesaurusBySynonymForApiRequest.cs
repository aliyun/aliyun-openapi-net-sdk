...
{
    public class GetThesaurusBySynonymForApiRequest : RpcAcsRequest<GetThesaurusBySynonymForApiResponse>
    {
        public GetThesaurusBySynonymForApiRequest()
            : base("Qualitycheck", "2019-01-15", "GetThesaurusBySynonymForApi", "Qualitycheck", "openAPI")
        {
        ...
        public override GetThesaurusBySynonymForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetThesaurusBySynonymForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
