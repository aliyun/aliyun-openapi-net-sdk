...
{
    public class GetResultToReviewRequest : RpcAcsRequest<GetResultToReviewResponse>
    {
        public GetResultToReviewRequest()
            : base("Qualitycheck", "2019-01-15", "GetResultToReview", "Qualitycheck", "openAPI")
        {
        ...
        public override GetResultToReviewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResultToReviewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
