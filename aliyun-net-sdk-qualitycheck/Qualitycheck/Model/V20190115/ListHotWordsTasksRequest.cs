...
{
    public class ListHotWordsTasksRequest : RpcAcsRequest<ListHotWordsTasksResponse>
    {
        public ListHotWordsTasksRequest()
            : base("Qualitycheck", "2019-01-15", "ListHotWordsTasks", "Qualitycheck", "openAPI")
        {
        ...
        public override ListHotWordsTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListHotWordsTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
