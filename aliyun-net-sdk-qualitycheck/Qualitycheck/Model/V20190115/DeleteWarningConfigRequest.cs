...
{
    public class DeleteWarningConfigRequest : RpcAcsRequest<DeleteWarningConfigResponse>
    {
        public DeleteWarningConfigRequest()
            : base("Qualitycheck", "2019-01-15", "DeleteWarningConfig", "Qualitycheck", "openAPI")
        {
        ...
        public override DeleteWarningConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteWarningConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
