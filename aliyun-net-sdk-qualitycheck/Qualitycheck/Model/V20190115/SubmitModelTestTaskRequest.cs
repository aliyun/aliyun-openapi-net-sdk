...
{
    public class SubmitModelTestTaskRequest : RpcAcsRequest<SubmitModelTestTaskResponse>
    {
        public SubmitModelTestTaskRequest()
            : base("Qualitycheck", "2019-01-15", "SubmitModelTestTask", "Qualitycheck", "openAPI")
        {
        ...
        public override SubmitModelTestTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitModelTestTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
