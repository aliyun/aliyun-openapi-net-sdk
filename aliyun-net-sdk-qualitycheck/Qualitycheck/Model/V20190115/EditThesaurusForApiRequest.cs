...
{
    public class EditThesaurusForApiRequest : RpcAcsRequest<EditThesaurusForApiResponse>
    {
        public EditThesaurusForApiRequest()
            : base("Qualitycheck", "2019-01-15", "EditThesaurusForApi", "Qualitycheck", "openAPI")
        {
        ...
        public override EditThesaurusForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EditThesaurusForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
