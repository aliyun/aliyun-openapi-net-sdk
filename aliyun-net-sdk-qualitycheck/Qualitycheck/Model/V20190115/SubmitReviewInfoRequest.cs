...
{
    public class SubmitReviewInfoRequest : RpcAcsRequest<SubmitReviewInfoResponse>
    {
        public SubmitReviewInfoRequest()
            : base("Qualitycheck", "2019-01-15", "SubmitReviewInfo", "Qualitycheck", "openAPI")
        {
        ...
        public override SubmitReviewInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitReviewInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
