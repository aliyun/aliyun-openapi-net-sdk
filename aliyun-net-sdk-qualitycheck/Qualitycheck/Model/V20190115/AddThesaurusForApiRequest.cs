...
{
    public class AddThesaurusForApiRequest : RpcAcsRequest<AddThesaurusForApiResponse>
    {
        public AddThesaurusForApiRequest()
            : base("Qualitycheck", "2019-01-15", "AddThesaurusForApi", "Qualitycheck", "openAPI")
        {
        ...
        public override AddThesaurusForApiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddThesaurusForApiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
