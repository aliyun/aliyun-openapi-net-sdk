...
{
    public class UpdateSyncQualityCheckDataRequest : RpcAcsRequest<UpdateSyncQualityCheckDataResponse>
    {
        public UpdateSyncQualityCheckDataRequest()
            : base("Qualitycheck", "2019-01-15", "UpdateSyncQualityCheckData", "Qualitycheck", "openAPI")
        {
        ...
        public override UpdateSyncQualityCheckDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateSyncQualityCheckDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
