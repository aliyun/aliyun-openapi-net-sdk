...
{
    public class ListAsrVocabRequest : RpcAcsRequest<ListAsrVocabResponse>
    {
        public ListAsrVocabRequest()
            : base("Qualitycheck", "2019-01-15", "ListAsrVocab", "Qualitycheck", "openAPI")
        {
        ...
        public override ListAsrVocabResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAsrVocabResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
