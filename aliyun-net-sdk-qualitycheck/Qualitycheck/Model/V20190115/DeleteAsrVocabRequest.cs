...
{
    public class DeleteAsrVocabRequest : RpcAcsRequest<DeleteAsrVocabResponse>
    {
        public DeleteAsrVocabRequest()
            : base("Qualitycheck", "2019-01-15", "DeleteAsrVocab", "Qualitycheck", "openAPI")
        {
        ...
        public override DeleteAsrVocabResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAsrVocabResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
