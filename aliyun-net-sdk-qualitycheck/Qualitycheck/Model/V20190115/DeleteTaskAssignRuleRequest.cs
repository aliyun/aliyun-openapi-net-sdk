...
{
    public class DeleteTaskAssignRuleRequest : RpcAcsRequest<DeleteTaskAssignRuleResponse>
    {
        public DeleteTaskAssignRuleRequest()
            : base("Qualitycheck", "2019-01-15", "DeleteTaskAssignRule", "Qualitycheck", "openAPI")
        {
        ...
        public override DeleteTaskAssignRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTaskAssignRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
