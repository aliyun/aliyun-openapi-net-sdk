...
{
    public class AssignReviewerRequest : RpcAcsRequest<AssignReviewerResponse>
    {
        public AssignReviewerRequest()
            : base("Qualitycheck", "2019-01-15", "AssignReviewer", "Qualitycheck", "openAPI")
        {
        ...
        public override AssignReviewerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssignReviewerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
