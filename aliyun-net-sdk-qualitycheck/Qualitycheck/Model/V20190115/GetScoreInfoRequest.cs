...
{
    public class GetScoreInfoRequest : RpcAcsRequest<GetScoreInfoResponse>
    {
        public GetScoreInfoRequest()
            : base("Qualitycheck", "2019-01-15", "GetScoreInfo", "Qualitycheck", "openAPI")
        {
        ...
        public override GetScoreInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetScoreInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
