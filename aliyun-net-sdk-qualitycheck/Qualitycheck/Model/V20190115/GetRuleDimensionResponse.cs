...
{
	public class GetRuleDimensionResponse : AcsResponse
	{
		...
		private List<GetRuleDimension_RuleCountInfo> data;
		...
		public List<GetRuleDimension_RuleCountInfo> Data
		{
			get
			{
				return data;
		...
		public class GetRuleDimension_RuleCountInfo
		{
