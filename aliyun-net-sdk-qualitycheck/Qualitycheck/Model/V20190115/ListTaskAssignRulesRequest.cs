...
{
    public class ListTaskAssignRulesRequest : RpcAcsRequest<ListTaskAssignRulesResponse>
    {
        public ListTaskAssignRulesRequest()
            : base("Qualitycheck", "2019-01-15", "ListTaskAssignRules", "Qualitycheck", "openAPI")
        {
        ...
        public override ListTaskAssignRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTaskAssignRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
