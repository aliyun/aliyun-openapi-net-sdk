...
namespace Aliyun.Acs.Qualitycheck.Model.V20190115
{
    public class InvalidRuleRequest : RpcAcsRequest<InvalidRuleResponse>
    {
        ...
        public override InvalidRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InvalidRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
