...
namespace Aliyun.Acs.Qualitycheck.Transform.V20190115
{
    ...
    {
        public static InsertScoreForApiResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			data.ScoreName = _ctx.StringValue("InsertScoreForApi.Data.ScoreName");
			insertScoreForApiResponse.Data = data;
