...
namespace Aliyun.Acs.Qualitycheck
{
    public class Endpoint
    {
        public static Dictionary<string, string> endpointMap = new Dictionary<string, string>() 
        {
            ...
            { "cn-zhangbei", "qualitycheck.aliyuncs.com" },
            ...
            { "cn-huhehaote-nebula-1", "qualitycheck.aliyuncs.com" },
            ...
            { "cn-wulanchabu", "qualitycheck.aliyuncs.com" },
