...
{
    public class DescribeInstanceRecoverTimeRequest : RpcAcsRequest<DescribeInstanceRecoverTimeResponse>
    {
        public DescribeInstanceRecoverTimeRequest()
            : base("Dds", "2015-12-01", "DescribeInstanceRecoverTime", "dds", "openAPI")
        {
        ...
        public override DescribeInstanceRecoverTimeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceRecoverTimeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
