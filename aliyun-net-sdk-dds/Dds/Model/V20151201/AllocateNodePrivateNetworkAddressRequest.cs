...
namespace Aliyun.Acs.Dds.Model.V20151201
{
    public class AllocateNodePrivateNetworkAddressRequest : RpcAcsRequest<AllocateNodePrivateNetworkAddressResponse>
    {
        public AllocateNodePrivateNetworkAddressRequest()
            : base("Dds", "2015-12-01", "AllocateNodePrivateNetworkAddress")
        {
        ...
        public override AllocateNodePrivateNetworkAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AllocateNodePrivateNetworkAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
