...
{
    public class DescribeKmsKeysRequest : RpcAcsRequest<DescribeKmsKeysResponse>
    {
        public DescribeKmsKeysRequest()
            : base("Dds", "2015-12-01", "DescribeKmsKeys", "dds", "openAPI")
        {
        ...
        public override DescribeKmsKeysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeKmsKeysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
