...
namespace Aliyun.Acs.Dds.Model.V20151201
{
    public class DescribeMongoDBLogConfigRequest : RpcAcsRequest<DescribeMongoDBLogConfigResponse>
    {
        public DescribeMongoDBLogConfigRequest()
            : base("Dds", "2015-12-01", "DescribeMongoDBLogConfig")
        {
        ...
        public override DescribeMongoDBLogConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMongoDBLogConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
