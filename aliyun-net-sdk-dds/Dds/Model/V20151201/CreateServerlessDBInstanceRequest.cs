...
namespace Aliyun.Acs.Dds.Model.V20151201
{
    public class CreateServerlessDBInstanceRequest : RpcAcsRequest<CreateServerlessDBInstanceResponse>
    {
		...
		public string PeriodPriceType
		{
			...
			set	
			{
				periodPriceType = value;
				DictionaryUtil.Add(QueryParameters, "PeriodPriceType", value);
			}
		}
        ...
        public override CreateServerlessDBInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateServerlessDBInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
