...
{
	public class DescribeGlobalSecurityIPGroupResponse : AcsResponse
	{

		private string requestId;

		private List<DescribeGlobalSecurityIPGroup_GlobalSecurityIPGroupItem> globalSecurityIPGroup;
		...
		public List<DescribeGlobalSecurityIPGroup_GlobalSecurityIPGroupItem> GlobalSecurityIPGroup
		{
			get
			{
		...
		public class DescribeGlobalSecurityIPGroup_GlobalSecurityIPGroupItem
		{
