...
{
    public class ReleaseNodePrivateNetworkAddressRequest : RpcAcsRequest<ReleaseNodePrivateNetworkAddressResponse>
    {
        public ReleaseNodePrivateNetworkAddressRequest()
            : base("Dds", "2015-12-01", "ReleaseNodePrivateNetworkAddress")
        {
        ...
        public override ReleaseNodePrivateNetworkAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseNodePrivateNetworkAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
