...
{
    public class StopProjectRequest : RpcAcsRequest<StopProjectResponse>
    {
        public StopProjectRequest()
            : base("OceanBasePro", "2019-09-01", "StopProject", "oceanbase", "openAPI")
        {
        ...
        public override StopProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
