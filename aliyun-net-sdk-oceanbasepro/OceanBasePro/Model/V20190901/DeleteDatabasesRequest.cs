...
{
    public class DeleteDatabasesRequest : RpcAcsRequest<DeleteDatabasesResponse>
    {
        public DeleteDatabasesRequest()
            : base("OceanBasePro", "2019-09-01", "DeleteDatabases", "oceanbase", "openAPI")
        {
		...
		public string DatabaseNames
		{
			...
			{
				databaseNames = value;
				DictionaryUtil.Add(BodyParameters, "DatabaseNames", value);
			}
		}
        ...
        public override DeleteDatabasesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDatabasesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
