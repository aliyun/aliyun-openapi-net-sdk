...
{
    public class DescribeOasSQLHistoryListRequest : RpcAcsRequest<DescribeOasSQLHistoryListResponse>
    {
        public DescribeOasSQLHistoryListRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOasSQLHistoryList", "oceanbase", "openAPI")
        {
        ...
        public override DescribeOasSQLHistoryListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOasSQLHistoryListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
