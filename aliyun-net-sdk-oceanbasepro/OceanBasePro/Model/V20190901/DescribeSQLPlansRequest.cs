...
{
    public class DescribeSQLPlansRequest : RpcAcsRequest<DescribeSQLPlansResponse>
    {
        public DescribeSQLPlansRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeSQLPlans", "oceanbase", "openAPI")
        {
        ...
        public override DescribeSQLPlansResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLPlansResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
