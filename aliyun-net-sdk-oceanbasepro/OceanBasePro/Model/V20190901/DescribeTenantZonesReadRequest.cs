...
{
    public class DescribeTenantZonesReadRequest : RpcAcsRequest<DescribeTenantZonesReadResponse>
    {
        public DescribeTenantZonesReadRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenantZonesRead", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTenantZonesReadResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantZonesReadResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
