...
{
    public class ReleaseProjectRequest : RpcAcsRequest<ReleaseProjectResponse>
    {
        public ReleaseProjectRequest()
            : base("OceanBasePro", "2019-09-01", "ReleaseProject", "oceanbase", "openAPI")
        {
        ...
        public override ReleaseProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
