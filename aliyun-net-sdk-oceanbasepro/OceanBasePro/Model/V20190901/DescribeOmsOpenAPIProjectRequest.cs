...
{
    public class DescribeOmsOpenAPIProjectRequest : RpcAcsRequest<DescribeOmsOpenAPIProjectResponse>
    {
        public DescribeOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override DescribeOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
