...
{
    public class DescribeOmsOpenAPIProjectStepsRequest : RpcAcsRequest<DescribeOmsOpenAPIProjectStepsResponse>
    {
        public DescribeOmsOpenAPIProjectStepsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOmsOpenAPIProjectSteps", "oceanbase", "openAPI")
        {
        ...
        public override DescribeOmsOpenAPIProjectStepsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOmsOpenAPIProjectStepsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
