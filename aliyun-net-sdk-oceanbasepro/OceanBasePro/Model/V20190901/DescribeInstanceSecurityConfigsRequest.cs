...
{
    public class DescribeInstanceSecurityConfigsRequest : RpcAcsRequest<DescribeInstanceSecurityConfigsResponse>
    {
        public DescribeInstanceSecurityConfigsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeInstanceSecurityConfigs", "oceanbase", "openAPI")
        {
        ...
        public override DescribeInstanceSecurityConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceSecurityConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
