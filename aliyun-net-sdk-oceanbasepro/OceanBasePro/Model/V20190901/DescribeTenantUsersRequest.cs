...
{
    public class DescribeTenantUsersRequest : RpcAcsRequest<DescribeTenantUsersResponse>
    {
        public DescribeTenantUsersRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenantUsers", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTenantUsersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantUsersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
