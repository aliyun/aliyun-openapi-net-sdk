...
{
    public class DescribeRecommendIndexRequest : RpcAcsRequest<DescribeRecommendIndexResponse>
    {
        public DescribeRecommendIndexRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeRecommendIndex", "oceanbase", "openAPI")
        {
        ...
        public override DescribeRecommendIndexResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRecommendIndexResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
