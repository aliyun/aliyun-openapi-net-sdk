...
{
    public class CreateSecurityIpGroupRequest : RpcAcsRequest<CreateSecurityIpGroupResponse>
    {
        public CreateSecurityIpGroupRequest()
            : base("OceanBasePro", "2019-09-01", "CreateSecurityIpGroup", "oceanbase", "openAPI")
        {
        ...
        public override CreateSecurityIpGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSecurityIpGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
