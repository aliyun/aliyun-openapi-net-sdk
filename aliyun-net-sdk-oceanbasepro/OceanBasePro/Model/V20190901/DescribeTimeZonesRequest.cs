...
{
    public class DescribeTimeZonesRequest : RpcAcsRequest<DescribeTimeZonesResponse>
    {
        public DescribeTimeZonesRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTimeZones", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTimeZonesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTimeZonesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
