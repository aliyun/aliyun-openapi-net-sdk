...
{
    public class ModifyTenantUserDescriptionRequest : RpcAcsRequest<ModifyTenantUserDescriptionResponse>
    {
        public ModifyTenantUserDescriptionRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyTenantUserDescription", "oceanbase", "openAPI")
        {
        ...
        public override ModifyTenantUserDescriptionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantUserDescriptionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
