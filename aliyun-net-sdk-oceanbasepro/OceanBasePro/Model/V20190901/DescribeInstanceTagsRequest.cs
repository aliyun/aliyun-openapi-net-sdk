...
{
    public class DescribeInstanceTagsRequest : RpcAcsRequest<DescribeInstanceTagsResponse>
    {
        public DescribeInstanceTagsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeInstanceTags", "oceanbase", "openAPI")
        {
        ...
        public override DescribeInstanceTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
