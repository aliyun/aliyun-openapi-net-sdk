...
{
    public class CreateLabelRequest : RpcAcsRequest<CreateLabelResponse>
    {
        public CreateLabelRequest()
            : base("OceanBasePro", "2019-09-01", "CreateLabel", "oceanbase", "openAPI")
        {
        ...
        public override CreateLabelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLabelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
