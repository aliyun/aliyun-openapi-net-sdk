...
{
    public class DescribeParametersHistoryRequest : RpcAcsRequest<DescribeParametersHistoryResponse>
    {
        public DescribeParametersHistoryRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeParametersHistory", "oceanbase", "openAPI")
        {
        ...
        public override DescribeParametersHistoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeParametersHistoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
