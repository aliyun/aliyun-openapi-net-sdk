...
{
    public class ModifyDatabaseDescriptionRequest : RpcAcsRequest<ModifyDatabaseDescriptionResponse>
    {
        public ModifyDatabaseDescriptionRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyDatabaseDescription", "oceanbase", "openAPI")
        {
        ...
        public override ModifyDatabaseDescriptionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDatabaseDescriptionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
