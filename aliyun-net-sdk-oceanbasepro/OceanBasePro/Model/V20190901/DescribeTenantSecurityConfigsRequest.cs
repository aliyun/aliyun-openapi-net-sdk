...
{
    public class DescribeTenantSecurityConfigsRequest : RpcAcsRequest<DescribeTenantSecurityConfigsResponse>
    {
        public DescribeTenantSecurityConfigsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenantSecurityConfigs", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTenantSecurityConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantSecurityConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
