...
{
    public class StopOmsOpenAPIProjectRequest : RpcAcsRequest<StopOmsOpenAPIProjectResponse>
    {
        public StopOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "StopOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override StopOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
