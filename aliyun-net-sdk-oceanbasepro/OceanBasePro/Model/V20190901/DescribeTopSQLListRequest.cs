...
{
    public class DescribeTopSQLListRequest : RpcAcsRequest<DescribeTopSQLListResponse>
    {
        public DescribeTopSQLListRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTopSQLList", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTopSQLListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTopSQLListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
