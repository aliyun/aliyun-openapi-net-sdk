...
{
    public class DescribeSQLSamplesRequest : RpcAcsRequest<DescribeSQLSamplesResponse>
    {
        public DescribeSQLSamplesRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeSQLSamples", "oceanbase", "openAPI")
        {
        ...
        public override DescribeSQLSamplesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLSamplesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
