...
{
    public class CreateTenantSecurityIpGroupRequest : RpcAcsRequest<CreateTenantSecurityIpGroupResponse>
    {
        public CreateTenantSecurityIpGroupRequest()
            : base("OceanBasePro", "2019-09-01", "CreateTenantSecurityIpGroup", "oceanbase", "openAPI")
        {
        ...
        public override CreateTenantSecurityIpGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTenantSecurityIpGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
