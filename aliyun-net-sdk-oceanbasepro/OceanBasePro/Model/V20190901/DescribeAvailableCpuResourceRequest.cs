...
{
    public class DescribeAvailableCpuResourceRequest : RpcAcsRequest<DescribeAvailableCpuResourceResponse>
    {
        public DescribeAvailableCpuResourceRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeAvailableCpuResource", "oceanbase", "openAPI")
        {
        ...
        public override DescribeAvailableCpuResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAvailableCpuResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
