...
{
    public class DescribeOasAnomalySQLListRequest : RpcAcsRequest<DescribeOasAnomalySQLListResponse>
    {
        public DescribeOasAnomalySQLListRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOasAnomalySQLList", "oceanbase", "openAPI")
        {
        ...
        public override DescribeOasAnomalySQLListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOasAnomalySQLListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
