...
{
    public class ModifyDatabaseUserRolesRequest : RpcAcsRequest<ModifyDatabaseUserRolesResponse>
    {
        public ModifyDatabaseUserRolesRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyDatabaseUserRoles", "oceanbase", "openAPI")
        {
		...
		public string Users
		{
			...
			{
				users = value;
				DictionaryUtil.Add(BodyParameters, "Users", value);
			}
		}
        ...
        public override ModifyDatabaseUserRolesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDatabaseUserRolesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
