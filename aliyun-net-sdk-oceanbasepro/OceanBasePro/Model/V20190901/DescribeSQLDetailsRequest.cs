...
{
    public class DescribeSQLDetailsRequest : RpcAcsRequest<DescribeSQLDetailsResponse>
    {
        public DescribeSQLDetailsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeSQLDetails", "oceanbase", "openAPI")
        {
        ...
        public override DescribeSQLDetailsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLDetailsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
