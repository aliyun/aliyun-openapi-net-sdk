...
{
    public class ModifyTenantTagsRequest : RpcAcsRequest<ModifyTenantTagsResponse>
    {
        public ModifyTenantTagsRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyTenantTags", "oceanbase", "openAPI")
        {
        ...
        public override ModifyTenantTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
