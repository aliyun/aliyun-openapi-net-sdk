...
{
    public class DescribeTenantTagsRequest : RpcAcsRequest<DescribeTenantTagsResponse>
    {
        public DescribeTenantTagsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenantTags", "oceanbase", "openAPI")
        {
		...
		public string TenantIds
		{
			...
			{
				tenantIds = value;
				DictionaryUtil.Add(BodyParameters, "TenantIds", value);
			}
		}
        ...
        public override DescribeTenantTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
