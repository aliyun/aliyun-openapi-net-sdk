...
{
    public class DescribeOasSlowSQLListRequest : RpcAcsRequest<DescribeOasSlowSQLListResponse>
    {
        public DescribeOasSlowSQLListRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOasSlowSQLList", "oceanbase", "openAPI")
        {
        ...
        public override DescribeOasSlowSQLListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOasSlowSQLListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
