...
namespace Aliyun.Acs.OceanBasePro.Model.V20190901
{
    public class DescribeParametersRequest : RpcAcsRequest<DescribeParametersResponse>
    {
        public DescribeParametersRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeParameters", "oceanbase", "openAPI")
        {
		...
		public string DimensionValue
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "DimensionValue", value);
			}
		}
		...
		public string Dimension
		{
			...
			{
				dimension = value;
				DictionaryUtil.Add(BodyParameters, "Dimension", value);
			}
		}
