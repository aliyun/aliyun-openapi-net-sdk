...
{
    public class DescribeOutlineBindingRequest : RpcAcsRequest<DescribeOutlineBindingResponse>
    {
        public DescribeOutlineBindingRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOutlineBinding", "oceanbase", "openAPI")
        {
		...
		private bool? isConcurrentLimit;
		...
		[JsonProperty(PropertyName = "IsConcurrentLimit")]
		public bool? IsConcurrentLimit
		{
			get
			{
			...
			set	
			{
				isConcurrentLimit = value;
				DictionaryUtil.Add(BodyParameters, "IsConcurrentLimit", value.ToString());
			}
		}
        ...
        public override DescribeOutlineBindingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOutlineBindingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
