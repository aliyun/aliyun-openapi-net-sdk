...
{
    public class DescribeTenantRequest : RpcAcsRequest<DescribeTenantResponse>
    {
        public DescribeTenantRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenant", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTenantResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
