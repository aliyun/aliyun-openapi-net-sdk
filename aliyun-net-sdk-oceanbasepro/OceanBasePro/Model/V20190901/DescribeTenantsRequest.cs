...
{
    public class DescribeTenantsRequest : RpcAcsRequest<DescribeTenantsResponse>
    {
        public DescribeTenantsRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenants", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTenantsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
