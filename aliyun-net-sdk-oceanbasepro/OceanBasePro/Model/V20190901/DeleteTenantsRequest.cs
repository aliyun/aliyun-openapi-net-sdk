...
{
    public class DeleteTenantsRequest : RpcAcsRequest<DeleteTenantsResponse>
    {
        public DeleteTenantsRequest()
            : base("OceanBasePro", "2019-09-01", "DeleteTenants", "oceanbase", "openAPI")
        {
        ...
        public override DeleteTenantsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTenantsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
