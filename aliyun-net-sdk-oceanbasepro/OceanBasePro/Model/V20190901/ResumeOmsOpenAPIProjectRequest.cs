...
{
    public class ResumeOmsOpenAPIProjectRequest : RpcAcsRequest<ResumeOmsOpenAPIProjectResponse>
    {
        public ResumeOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "ResumeOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override ResumeOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResumeOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
