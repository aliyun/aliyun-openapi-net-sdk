...
{
    public class DescribeOasSQLPlansRequest : RpcAcsRequest<DescribeOasSQLPlansResponse>
    {
        public DescribeOasSQLPlansRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeOasSQLPlans", "oceanbase", "openAPI")
        {
        ...
        public override DescribeOasSQLPlansResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOasSQLPlansResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
