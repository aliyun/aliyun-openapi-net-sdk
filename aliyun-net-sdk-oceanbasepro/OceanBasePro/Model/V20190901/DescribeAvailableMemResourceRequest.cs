...
{
    public class DescribeAvailableMemResourceRequest : RpcAcsRequest<DescribeAvailableMemResourceResponse>
    {
        public DescribeAvailableMemResourceRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeAvailableMemResource", "oceanbase", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "CpuNum")]
		public long? CpuNum
		{
			get
			{
			...
			{
				cpuNum = value;
				DictionaryUtil.Add(BodyParameters, "CpuNum", value.ToString());
			}
		}
        ...
        public override DescribeAvailableMemResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAvailableMemResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
