...
{
    public class DeleteTenantUsersRequest : RpcAcsRequest<DeleteTenantUsersResponse>
    {
        public DeleteTenantUsersRequest()
            : base("OceanBasePro", "2019-09-01", "DeleteTenantUsers", "oceanbase", "openAPI")
        {
        ...
        public override DeleteTenantUsersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTenantUsersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
