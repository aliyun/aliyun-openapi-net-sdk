...
{
    public class StopProjectsByLabelRequest : RpcAcsRequest<StopProjectsByLabelResponse>
    {
        public StopProjectsByLabelRequest()
            : base("OceanBasePro", "2019-09-01", "StopProjectsByLabel", "oceanbase", "openAPI")
        {
        ...
        public override StopProjectsByLabelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopProjectsByLabelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
