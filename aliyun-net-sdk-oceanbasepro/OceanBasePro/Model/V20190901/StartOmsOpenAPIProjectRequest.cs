...
{
    public class StartOmsOpenAPIProjectRequest : RpcAcsRequest<StartOmsOpenAPIProjectResponse>
    {
        public StartOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "StartOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override StartOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
