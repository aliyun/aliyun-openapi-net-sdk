...
{
    public class ReleaseOmsOpenAPIProjectRequest : RpcAcsRequest<ReleaseOmsOpenAPIProjectResponse>
    {
        public ReleaseOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "ReleaseOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override ReleaseOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
