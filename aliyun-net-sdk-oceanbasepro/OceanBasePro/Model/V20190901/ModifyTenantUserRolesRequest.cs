...
{
    public class ModifyTenantUserRolesRequest : RpcAcsRequest<ModifyTenantUserRolesResponse>
    {
        public ModifyTenantUserRolesRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyTenantUserRoles", "oceanbase", "openAPI")
        {
		...
		public string UserRole
		{
			...
			{
				userRole = value;
				DictionaryUtil.Add(BodyParameters, "UserRole", value);
			}
		}
        ...
        public override ModifyTenantUserRolesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantUserRolesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
