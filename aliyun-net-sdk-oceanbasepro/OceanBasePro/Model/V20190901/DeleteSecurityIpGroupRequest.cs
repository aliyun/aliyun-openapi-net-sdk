...
{
    public class DeleteSecurityIpGroupRequest : RpcAcsRequest<DeleteSecurityIpGroupResponse>
    {
        public DeleteSecurityIpGroupRequest()
            : base("OceanBasePro", "2019-09-01", "DeleteSecurityIpGroup", "oceanbase", "openAPI")
        {
        ...
        public override DeleteSecurityIpGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSecurityIpGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
