...
{
	public class DescribeOasSlowSQLListResponse : AcsResponse
	{

		private string requestId;

		private List<DescribeOasSlowSQLList_DataItem> data;
		...
		public List<DescribeOasSlowSQLList_DataItem> Data
		{
			get
			{
				return data;
		...
		public class DescribeOasSlowSQLList_DataItem
		{
			...
			private List<DescribeOasSlowSQLList_SqlListItem> sqlList;
			...
			public List<DescribeOasSlowSQLList_SqlListItem> SqlList
			{
				get
				{
					return sqlList;
			...
			public class DescribeOasSlowSQLList_SqlListItem
			{
