...
{
    public class ResetOmsOpenAPIProjectRequest : RpcAcsRequest<ResetOmsOpenAPIProjectResponse>
    {
        public ResetOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "ResetOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override ResetOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
