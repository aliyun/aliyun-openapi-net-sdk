...
{
    public class ModifyTenantUserStatusRequest : RpcAcsRequest<ModifyTenantUserStatusResponse>
    {
        public ModifyTenantUserStatusRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyTenantUserStatus", "oceanbase", "openAPI")
        {
		...
		public string UserStatus
		{
			...
			{
				userStatus = value;
				DictionaryUtil.Add(BodyParameters, "UserStatus", value);
			}
		}
        ...
        public override ModifyTenantUserStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantUserStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
