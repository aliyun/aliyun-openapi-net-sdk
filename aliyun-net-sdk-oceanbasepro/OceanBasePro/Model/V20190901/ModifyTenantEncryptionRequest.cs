...
{
    public class ModifyTenantEncryptionRequest : RpcAcsRequest<ModifyTenantEncryptionResponse>
    {
        public ModifyTenantEncryptionRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyTenantEncryption", "oceanbase", "openAPI")
        {
		...
		public string EncryptionKeyId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "EncryptionKeyId", value);
			}
		}
        ...
        public override ModifyTenantEncryptionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantEncryptionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
