...
{
    public class ModifyTenantSecurityIpGroupRequest : RpcAcsRequest<ModifyTenantSecurityIpGroupResponse>
    {
        public ModifyTenantSecurityIpGroupRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyTenantSecurityIpGroup", "oceanbase", "openAPI")
        {
		...
		public string SecurityIps
		{
			...
			{
				securityIps = value;
				DictionaryUtil.Add(BodyParameters, "SecurityIps", value);
			}
		}
		...
		public string SecurityIpGroupName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "SecurityIpGroupName", value);
			}
		}
        ...
        public override ModifyTenantSecurityIpGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTenantSecurityIpGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
