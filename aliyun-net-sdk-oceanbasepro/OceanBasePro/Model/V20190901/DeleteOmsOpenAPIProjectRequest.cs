...
{
    public class DeleteOmsOpenAPIProjectRequest : RpcAcsRequest<DeleteOmsOpenAPIProjectResponse>
    {
        public DeleteOmsOpenAPIProjectRequest()
            : base("OceanBasePro", "2019-09-01", "DeleteOmsOpenAPIProject", "oceanbase", "openAPI")
        {
        ...
        public override DeleteOmsOpenAPIProjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteOmsOpenAPIProjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
