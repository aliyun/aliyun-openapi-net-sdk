...
{
    public class ModifyInstanceNodeNumRequest : RpcAcsRequest<ModifyInstanceNodeNumResponse>
    {
        public ModifyInstanceNodeNumRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyInstanceNodeNum", "oceanbase", "openAPI")
        {
		...
		public string NodeNum
		{
			...
			{
				nodeNum = value;
				DictionaryUtil.Add(BodyParameters, "NodeNum", value);
			}
		}
        ...
        public override ModifyInstanceNodeNumResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyInstanceNodeNumResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
