...
{
    public class DescribeTenantUserRolesRequest : RpcAcsRequest<DescribeTenantUserRolesResponse>
    {
        public DescribeTenantUserRolesRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeTenantUserRoles", "oceanbase", "openAPI")
        {
        ...
        public override DescribeTenantUserRolesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTenantUserRolesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
