...
{
    public class DeleteTenantSecurityIpGroupRequest : RpcAcsRequest<DeleteTenantSecurityIpGroupResponse>
    {
        public DeleteTenantSecurityIpGroupRequest()
            : base("OceanBasePro", "2019-09-01", "DeleteTenantSecurityIpGroup", "oceanbase", "openAPI")
        {
        ...
        public override DeleteTenantSecurityIpGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTenantSecurityIpGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
