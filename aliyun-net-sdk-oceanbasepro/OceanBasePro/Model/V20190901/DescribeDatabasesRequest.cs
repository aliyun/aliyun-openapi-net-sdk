...
namespace Aliyun.Acs.OceanBasePro.Model.V20190901
{
    public class DescribeDatabasesRequest : RpcAcsRequest<DescribeDatabasesResponse>
    {
        public DescribeDatabasesRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeDatabases", "oceanbase", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "WithTables")]
		public bool? WithTables
		{
			...
			{
				withTables = value;
				DictionaryUtil.Add(BodyParameters, "WithTables", value.ToString());
			}
		}
