...
{
    public class DescribeAnomalySQLListRequest : RpcAcsRequest<DescribeAnomalySQLListResponse>
    {
        public DescribeAnomalySQLListRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeAnomalySQLList", "oceanbase", "openAPI")
        {
        ...
        public override DescribeAnomalySQLListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAnomalySQLListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
