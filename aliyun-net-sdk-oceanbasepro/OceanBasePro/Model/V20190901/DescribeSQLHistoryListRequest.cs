...
{
    public class DescribeSQLHistoryListRequest : RpcAcsRequest<DescribeSQLHistoryListResponse>
    {
        public DescribeSQLHistoryListRequest()
            : base("OceanBasePro", "2019-09-01", "DescribeSQLHistoryList", "oceanbase", "openAPI")
        {
        ...
        public override DescribeSQLHistoryListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLHistoryListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
