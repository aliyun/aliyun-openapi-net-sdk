...
{
    public class ModifyInstanceTagsRequest : RpcAcsRequest<ModifyInstanceTagsResponse>
    {
        public ModifyInstanceTagsRequest()
            : base("OceanBasePro", "2019-09-01", "ModifyInstanceTags", "oceanbase", "openAPI")
        {
        ...
        public override ModifyInstanceTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyInstanceTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
