...
{
    public class PullTaskRequest : RpcAcsRequest<PullTaskResponse>
    {
        public PullTaskRequest()
            : base("mseap", "2021-01-18", "PullTask")
        {
        ...
        public override PullTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PullTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
