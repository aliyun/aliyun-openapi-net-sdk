...
{
    public class GetNodeByFlowIdRequest : RpcAcsRequest<GetNodeByFlowIdResponse>
    {
        public GetNodeByFlowIdRequest()
            : base("mseap", "2021-01-18", "GetNodeByFlowId")
        {
		...
		public long? FlowId
		{
			...
			{
				flowId = value;
				DictionaryUtil.Add(QueryParameters, "FlowId", value.ToString());
			}
		}
        ...
        public override GetNodeByFlowIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeByFlowIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
