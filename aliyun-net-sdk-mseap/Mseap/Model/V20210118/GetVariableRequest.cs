...
{
    public class GetVariableRequest : RpcAcsRequest<GetVariableResponse>
    {
        public GetVariableRequest()
            : base("mseap", "2021-01-18", "GetVariable")
        {
        ...
        public override GetVariableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVariableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
