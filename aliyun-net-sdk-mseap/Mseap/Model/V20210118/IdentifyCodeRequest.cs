...
{
    public class IdentifyCodeRequest : RpcAcsRequest<IdentifyCodeResponse>
    {
        public IdentifyCodeRequest()
            : base("mseap", "2021-01-18", "IdentifyCode")
        {
        ...
        public override IdentifyCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return IdentifyCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
