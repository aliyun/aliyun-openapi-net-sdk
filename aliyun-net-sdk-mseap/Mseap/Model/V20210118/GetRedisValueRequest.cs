...
{
    public class GetRedisValueRequest : RpcAcsRequest<GetRedisValueResponse>
    {
        public GetRedisValueRequest()
            : base("mseap", "2021-01-18", "GetRedisValue")
        {
        ...
        public override GetRedisValueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRedisValueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
