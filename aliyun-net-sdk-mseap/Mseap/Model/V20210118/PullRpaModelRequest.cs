...
{
    public class PullRpaModelRequest : RpcAcsRequest<PullRpaModelResponse>
    {
        public PullRpaModelRequest()
            : base("mseap", "2021-01-18", "PullRpaModel")
        {
        ...
        public override PullRpaModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PullRpaModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
