...
{
    public class GetNodeByTemplateIdRequest : RpcAcsRequest<GetNodeByTemplateIdResponse>
    {
        public GetNodeByTemplateIdRequest()
            : base("mseap", "2021-01-18", "GetNodeByTemplateId")
        {
        ...
        public override GetNodeByTemplateIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNodeByTemplateIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
