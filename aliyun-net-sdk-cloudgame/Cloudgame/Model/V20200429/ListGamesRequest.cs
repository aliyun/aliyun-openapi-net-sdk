...
{
    public class ListGamesRequest : RpcAcsRequest<ListGamesResponse>
    {
        public ListGamesRequest()
            : base("cloudgame", "2020-04-29", "ListGames")
        {
        ...
        public override ListGamesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGamesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
