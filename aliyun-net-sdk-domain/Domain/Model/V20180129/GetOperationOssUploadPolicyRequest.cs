...
namespace Aliyun.Acs.Domain.Model.V20180129
{
    public class GetOperationOssUploadPolicyRequest : RpcAcsRequest<GetOperationOssUploadPolicyResponse>
    {
        ...
        public override GetOperationOssUploadPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOperationOssUploadPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
