...
{
    public class QueryOperationAuditInfoListRequest : RpcAcsRequest<QueryOperationAuditInfoListResponse>
    {
        public QueryOperationAuditInfoListRequest()
            : base("Domain", "2018-01-29", "QueryOperationAuditInfoList", "domain", "openAPI")
        {
        ...
        public override QueryOperationAuditInfoListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryOperationAuditInfoListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
