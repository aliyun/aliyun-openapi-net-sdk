...
{
    public class SaveRegistrantProfileRealNameVerificationRequest : RpcAcsRequest<SaveRegistrantProfileRealNameVerificationResponse>
    {
        public SaveRegistrantProfileRealNameVerificationRequest()
            : base("Domain", "2018-01-29", "SaveRegistrantProfileRealNameVerification", "domain", "openAPI")
        {
        ...
        public override SaveRegistrantProfileRealNameVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveRegistrantProfileRealNameVerificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
