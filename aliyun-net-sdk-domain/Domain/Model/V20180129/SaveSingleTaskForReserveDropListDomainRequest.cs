...
{
    public class SaveSingleTaskForReserveDropListDomainRequest : RpcAcsRequest<SaveSingleTaskForReserveDropListDomainResponse>
    {
        public SaveSingleTaskForReserveDropListDomainRequest()
            : base("Domain", "2018-01-29", "SaveSingleTaskForReserveDropListDomain", "domain", "openAPI")
        {
        ...
        public override SaveSingleTaskForReserveDropListDomainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveSingleTaskForReserveDropListDomainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
