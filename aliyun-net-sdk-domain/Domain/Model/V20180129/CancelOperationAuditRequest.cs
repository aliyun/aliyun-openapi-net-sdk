...
namespace Aliyun.Acs.Domain.Model.V20180129
{
    public class CancelOperationAuditRequest : RpcAcsRequest<CancelOperationAuditResponse>
    {
        ...
        public override CancelOperationAuditResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelOperationAuditResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
