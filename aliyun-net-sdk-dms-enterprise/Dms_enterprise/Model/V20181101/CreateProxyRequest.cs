...
{
    public class CreateProxyRequest : RpcAcsRequest<CreateProxyResponse>
    {
        public CreateProxyRequest()
            : base("dms-enterprise", "2018-11-01", "CreateProxy", "dms-enterprise", "openAPI")
        {
        ...
        public override CreateProxyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateProxyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
