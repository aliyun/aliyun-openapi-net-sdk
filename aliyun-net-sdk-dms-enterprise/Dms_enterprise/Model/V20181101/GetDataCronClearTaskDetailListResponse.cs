...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
	public class GetDataCronClearTaskDetailListResponse : AcsResponse
	{
		...
		[JsonProperty(PropertyName = "DataCronClearTaskDetailList")]
		public List<GetDataCronClearTaskDetailList_DataCronClearTaskDetail> DataCronClearTaskDetailList
		{
			get
			{
			...
			set	
			{
				dataCronClearTaskDetailList = value;
			}
		}
