...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class GetPermApplyOrderDetailRequest : RpcAcsRequest<GetPermApplyOrderDetailResponse>
    {
        ...
        public override GetPermApplyOrderDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPermApplyOrderDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
