...
{
    public class GetSQLReviewCheckResultStatusRequest : RpcAcsRequest<GetSQLReviewCheckResultStatusResponse>
    {
        public GetSQLReviewCheckResultStatusRequest()
            : base("dms-enterprise", "2018-11-01", "GetSQLReviewCheckResultStatus", "dms-enterprise", "openAPI")
        {
        ...
        public override GetSQLReviewCheckResultStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSQLReviewCheckResultStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
