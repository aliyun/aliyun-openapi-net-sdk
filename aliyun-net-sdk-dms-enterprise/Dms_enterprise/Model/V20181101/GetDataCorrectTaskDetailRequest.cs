...
{
    public class GetDataCorrectTaskDetailRequest : RpcAcsRequest<GetDataCorrectTaskDetailResponse>
    {
        public GetDataCorrectTaskDetailRequest()
            : base("dms-enterprise", "2018-11-01", "GetDataCorrectTaskDetail", "dms-enterprise", "openAPI")
        {
        ...
        public override GetDataCorrectTaskDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataCorrectTaskDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
