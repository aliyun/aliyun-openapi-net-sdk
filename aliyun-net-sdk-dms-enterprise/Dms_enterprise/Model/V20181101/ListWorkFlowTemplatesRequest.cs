...
{
    public class ListWorkFlowTemplatesRequest : RpcAcsRequest<ListWorkFlowTemplatesResponse>
    {
        public ListWorkFlowTemplatesRequest()
            : base("dms-enterprise", "2018-11-01", "ListWorkFlowTemplates", "dms-enterprise", "openAPI")
        {
        ...
        public override ListWorkFlowTemplatesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListWorkFlowTemplatesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
