...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class GetDatabaseRequest : RpcAcsRequest<GetDatabaseResponse>
    {
        public GetDatabaseRequest()
            : base("dms-enterprise", "2018-11-01", "GetDatabase")
        {
        ...
        public override GetDatabaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDatabaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
