...
{
    public class GetDataCorrectSQLFileRequest : RpcAcsRequest<GetDataCorrectSQLFileResponse>
    {
        public GetDataCorrectSQLFileRequest()
            : base("dms-enterprise", "2018-11-01", "GetDataCorrectSQLFile", "dms-enterprise", "openAPI")
        {
        ...
        public override GetDataCorrectSQLFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataCorrectSQLFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
