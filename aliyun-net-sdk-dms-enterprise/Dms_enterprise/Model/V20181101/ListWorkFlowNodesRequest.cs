...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class ListWorkFlowNodesRequest : RpcAcsRequest<ListWorkFlowNodesResponse>
    {
        public ListWorkFlowNodesRequest()
            : base("dms-enterprise", "2018-11-01", "ListWorkFlowNodes")
        {
        ...
        public override ListWorkFlowNodesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListWorkFlowNodesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
