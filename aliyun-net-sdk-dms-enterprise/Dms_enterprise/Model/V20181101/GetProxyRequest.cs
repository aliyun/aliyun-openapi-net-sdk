...
{
    public class GetProxyRequest : RpcAcsRequest<GetProxyResponse>
    {
        public GetProxyRequest()
            : base("dms-enterprise", "2018-11-01", "GetProxy", "dms-enterprise", "openAPI")
        {
        ...
        public override GetProxyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetProxyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
