...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class DisableUserRequest : RpcAcsRequest<DisableUserResponse>
    {
        public DisableUserRequest()
            : base("dms-enterprise", "2018-11-01", "DisableUser", "dms-enterprise", "openAPI")
        {
        ...
        public override DisableUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
