...
{
    public class RestartDataCorrectSQLJobRequest : RpcAcsRequest<RestartDataCorrectSQLJobResponse>
    {
        public RestartDataCorrectSQLJobRequest()
            : base("dms-enterprise", "2018-11-01", "RestartDataCorrectSQLJob", "dms-enterprise", "openAPI")
        {
        ...
        public override RestartDataCorrectSQLJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestartDataCorrectSQLJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
