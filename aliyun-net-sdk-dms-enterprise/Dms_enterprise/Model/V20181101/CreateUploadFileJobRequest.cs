...
{
    public class CreateUploadFileJobRequest : RpcAcsRequest<CreateUploadFileJobResponse>
    {
        public CreateUploadFileJobRequest()
            : base("dms-enterprise", "2018-11-01", "CreateUploadFileJob", "dms-enterprise", "openAPI")
        {
		...
		public string UploadURL
		{
			...
			{
				uploadURL = value;
				DictionaryUtil.Add(QueryParameters, "UploadURL", value);
			}
		}
        ...
        public override CreateUploadFileJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateUploadFileJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
