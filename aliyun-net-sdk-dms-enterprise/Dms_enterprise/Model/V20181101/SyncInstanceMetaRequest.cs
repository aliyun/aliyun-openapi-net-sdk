...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class SyncInstanceMetaRequest : RpcAcsRequest<SyncInstanceMetaResponse>
    {
		...
		public bool? IgnoreTable
		{
			...
			{
				ignoreTable = value;
				DictionaryUtil.Add(QueryParameters, "IgnoreTable", value.ToString());
			}
		}
        ...
        public override SyncInstanceMetaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SyncInstanceMetaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
