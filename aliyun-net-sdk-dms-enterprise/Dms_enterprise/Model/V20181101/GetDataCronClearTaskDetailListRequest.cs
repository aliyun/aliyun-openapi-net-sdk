...
{
    public class GetDataCronClearTaskDetailListRequest : RpcAcsRequest<GetDataCronClearTaskDetailListResponse>
    {
        public GetDataCronClearTaskDetailListRequest()
            : base("dms-enterprise", "2018-11-01", "GetDataCronClearTaskDetailList", "dms-enterprise", "openAPI")
        {
        ...
        public override GetDataCronClearTaskDetailListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataCronClearTaskDetailListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
