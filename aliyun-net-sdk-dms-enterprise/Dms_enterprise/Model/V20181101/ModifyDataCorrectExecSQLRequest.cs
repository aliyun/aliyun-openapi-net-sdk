...
{
    public class ModifyDataCorrectExecSQLRequest : RpcAcsRequest<ModifyDataCorrectExecSQLResponse>
    {
        public ModifyDataCorrectExecSQLRequest()
            : base("dms-enterprise", "2018-11-01", "ModifyDataCorrectExecSQL", "dms-enterprise", "openAPI")
        {
		...
		public string ExecSQL
		{
			...
			{
				execSQL = value;
				DictionaryUtil.Add(QueryParameters, "ExecSQL", value);
			}
		}
        ...
        public override ModifyDataCorrectExecSQLResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDataCorrectExecSQLResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
