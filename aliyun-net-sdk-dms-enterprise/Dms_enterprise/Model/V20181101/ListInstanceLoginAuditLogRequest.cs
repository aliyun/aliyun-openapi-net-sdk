...
{
    public class ListInstanceLoginAuditLogRequest : RpcAcsRequest<ListInstanceLoginAuditLogResponse>
    {
        public ListInstanceLoginAuditLogRequest()
            : base("dms-enterprise", "2018-11-01", "ListInstanceLoginAuditLog", "dms-enterprise", "openAPI")
        {
        ...
        public override ListInstanceLoginAuditLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListInstanceLoginAuditLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
