...
{
    public class GetOwnerApplyOrderDetailRequest : RpcAcsRequest<GetOwnerApplyOrderDetailResponse>
    {
        public GetOwnerApplyOrderDetailRequest()
            : base("dms-enterprise", "2018-11-01", "GetOwnerApplyOrderDetail", "dms-enterprise", "openAPI")
        {
        ...
        public override GetOwnerApplyOrderDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOwnerApplyOrderDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
