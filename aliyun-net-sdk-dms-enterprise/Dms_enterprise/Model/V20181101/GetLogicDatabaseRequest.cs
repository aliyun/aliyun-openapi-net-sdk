...
{
    public class GetLogicDatabaseRequest : RpcAcsRequest<GetLogicDatabaseResponse>
    {
        public GetLogicDatabaseRequest()
            : base("dms-enterprise", "2018-11-01", "GetLogicDatabase", "dms-enterprise", "openAPI")
        {
        ...
        public override GetLogicDatabaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLogicDatabaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
