...
{
    public class GetTableTopologyRequest : RpcAcsRequest<GetTableTopologyResponse>
    {
        public GetTableTopologyRequest()
            : base("dms-enterprise", "2018-11-01", "GetTableTopology", "dms-enterprise", "openAPI")
        {
        ...
        public override GetTableTopologyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTableTopologyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
