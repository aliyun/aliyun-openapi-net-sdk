...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class CloseOrderRequest : RpcAcsRequest<CloseOrderResponse>
    {
		...
		public string CloseReason
		{
			...
			{
				closeReason = value;
				DictionaryUtil.Add(QueryParameters, "CloseReason", value);
			}
		}
        ...
        public override CloseOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
