...
{
    public class ListDataCorrectPreCheckSQLRequest : RpcAcsRequest<ListDataCorrectPreCheckSQLResponse>
    {
        public ListDataCorrectPreCheckSQLRequest()
            : base("dms-enterprise", "2018-11-01", "ListDataCorrectPreCheckSQL", "dms-enterprise", "openAPI")
        {
        ...
        public override ListDataCorrectPreCheckSQLResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDataCorrectPreCheckSQLResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
