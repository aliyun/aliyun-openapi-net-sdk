...
{
    public class DeleteLogicTableRouteConfigRequest : RpcAcsRequest<DeleteLogicTableRouteConfigResponse>
    {
        public DeleteLogicTableRouteConfigRequest()
            : base("dms-enterprise", "2018-11-01", "DeleteLogicTableRouteConfig", "dms-enterprise", "openAPI")
        {
        ...
        public override DeleteLogicTableRouteConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLogicTableRouteConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
