...
{
	public class GetLogicDatabaseResponse : AcsResponse
	{
		...
		private GetLogicDatabase_LogicDatabase logicDatabase;
		...
		[JsonProperty(PropertyName = "LogicDatabase")]
		public GetLogicDatabase_LogicDatabase LogicDatabase
		{
			get
			{
