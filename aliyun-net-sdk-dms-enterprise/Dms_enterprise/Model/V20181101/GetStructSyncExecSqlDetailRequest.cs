...
{
    public class GetStructSyncExecSqlDetailRequest : RpcAcsRequest<GetStructSyncExecSqlDetailResponse>
    {
        public GetStructSyncExecSqlDetailRequest()
            : base("dms-enterprise", "2018-11-01", "GetStructSyncExecSqlDetail", "dms-enterprise", "openAPI")
        {
        ...
        public override GetStructSyncExecSqlDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStructSyncExecSqlDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
