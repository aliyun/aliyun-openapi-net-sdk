...
{
    public class ExecuteStructSyncRequest : RpcAcsRequest<ExecuteStructSyncResponse>
    {
        public ExecuteStructSyncRequest()
            : base("dms-enterprise", "2018-11-01", "ExecuteStructSync", "dms-enterprise", "openAPI")
        {
        ...
        public override ExecuteStructSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExecuteStructSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
