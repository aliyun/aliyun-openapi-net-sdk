...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class SyncDatabaseMetaRequest : RpcAcsRequest<SyncDatabaseMetaResponse>
    {
        public SyncDatabaseMetaRequest()
            : base("dms-enterprise", "2018-11-01", "SyncDatabaseMeta")
        {
        ...
        public override SyncDatabaseMetaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SyncDatabaseMetaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
