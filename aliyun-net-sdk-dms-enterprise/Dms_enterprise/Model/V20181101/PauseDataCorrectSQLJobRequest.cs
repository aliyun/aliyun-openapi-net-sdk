...
{
    public class PauseDataCorrectSQLJobRequest : RpcAcsRequest<PauseDataCorrectSQLJobResponse>
    {
        public PauseDataCorrectSQLJobRequest()
            : base("dms-enterprise", "2018-11-01", "PauseDataCorrectSQLJob", "dms-enterprise", "openAPI")
        {
        ...
        public override PauseDataCorrectSQLJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PauseDataCorrectSQLJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
