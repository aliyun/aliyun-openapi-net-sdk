...
{
    public class SubmitStructSyncOrderApprovalRequest : RpcAcsRequest<SubmitStructSyncOrderApprovalResponse>
    {
        public SubmitStructSyncOrderApprovalRequest()
            : base("dms-enterprise", "2018-11-01", "SubmitStructSyncOrderApproval", "dms-enterprise", "openAPI")
        {
        ...
        public override SubmitStructSyncOrderApprovalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitStructSyncOrderApprovalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
