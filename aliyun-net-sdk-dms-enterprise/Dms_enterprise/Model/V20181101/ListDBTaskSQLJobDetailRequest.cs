...
{
    public class ListDBTaskSQLJobDetailRequest : RpcAcsRequest<ListDBTaskSQLJobDetailResponse>
    {
        public ListDBTaskSQLJobDetailRequest()
            : base("dms-enterprise", "2018-11-01", "ListDBTaskSQLJobDetail", "dms-enterprise", "openAPI")
        {
        ...
        public override ListDBTaskSQLJobDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDBTaskSQLJobDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
