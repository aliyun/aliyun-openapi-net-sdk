...
{
    public class GetUserUploadFileJobRequest : RpcAcsRequest<GetUserUploadFileJobResponse>
    {
        public GetUserUploadFileJobRequest()
            : base("dms-enterprise", "2018-11-01", "GetUserUploadFileJob", "dms-enterprise", "openAPI")
        {
        ...
        public override GetUserUploadFileJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserUploadFileJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
