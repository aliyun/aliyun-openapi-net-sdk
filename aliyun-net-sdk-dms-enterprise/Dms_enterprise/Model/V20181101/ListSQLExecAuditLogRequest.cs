...
{
    public class ListSQLExecAuditLogRequest : RpcAcsRequest<ListSQLExecAuditLogResponse>
    {
        public ListSQLExecAuditLogRequest()
            : base("dms-enterprise", "2018-11-01", "ListSQLExecAuditLog", "dms-enterprise", "openAPI")
        {
        ...
        public override ListSQLExecAuditLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSQLExecAuditLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
