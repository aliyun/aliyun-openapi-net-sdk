...
{
    public class ListLogicTableRouteConfigRequest : RpcAcsRequest<ListLogicTableRouteConfigResponse>
    {
        public ListLogicTableRouteConfigRequest()
            : base("dms-enterprise", "2018-11-01", "ListLogicTableRouteConfig", "dms-enterprise", "openAPI")
        {
        ...
        public override ListLogicTableRouteConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLogicTableRouteConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
