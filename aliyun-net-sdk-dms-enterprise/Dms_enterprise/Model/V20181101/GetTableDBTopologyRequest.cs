...
{
    public class GetTableDBTopologyRequest : RpcAcsRequest<GetTableDBTopologyResponse>
    {
        public GetTableDBTopologyRequest()
            : base("dms-enterprise", "2018-11-01", "GetTableDBTopology", "dms-enterprise", "openAPI")
        {
        ...
        public override GetTableDBTopologyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTableDBTopologyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
