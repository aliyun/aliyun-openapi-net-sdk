...
{
    public class GetDBTopologyRequest : RpcAcsRequest<GetDBTopologyResponse>
    {
        public GetDBTopologyRequest()
            : base("dms-enterprise", "2018-11-01", "GetDBTopology", "dms-enterprise", "openAPI")
        {
        ...
        public override GetDBTopologyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDBTopologyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
