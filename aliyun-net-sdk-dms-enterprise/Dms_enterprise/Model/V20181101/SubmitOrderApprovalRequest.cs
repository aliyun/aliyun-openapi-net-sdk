...
{
    public class SubmitOrderApprovalRequest : RpcAcsRequest<SubmitOrderApprovalResponse>
    {
        public SubmitOrderApprovalRequest()
            : base("dms-enterprise", "2018-11-01", "SubmitOrderApproval", "dms-enterprise", "openAPI")
        {
        ...
        public override SubmitOrderApprovalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitOrderApprovalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
