...
{
    public class KillSparkJobRequest : RpcAcsRequest<KillSparkJobResponse>
    {
        public KillSparkJobRequest()
            : base("dms-enterprise", "2018-11-01", "KillSparkJob", "dms-enterprise", "openAPI")
        {
        ...
        public override KillSparkJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return KillSparkJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
