...
{
    public class GetStructSyncOrderDetailRequest : RpcAcsRequest<GetStructSyncOrderDetailResponse>
    {
        public GetStructSyncOrderDetailRequest()
            : base("dms-enterprise", "2018-11-01", "GetStructSyncOrderDetail", "dms-enterprise", "openAPI")
        {
