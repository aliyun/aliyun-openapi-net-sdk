...
{
    public class GetSparkJobLogRequest : RpcAcsRequest<GetSparkJobLogResponse>
    {
        public GetSparkJobLogRequest()
            : base("dms-enterprise", "2018-11-01", "GetSparkJobLog", "dms-enterprise", "openAPI")
        {
        ...
        public override GetSparkJobLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkJobLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
