...
{
	public class GetPhysicalDatabaseResponse : AcsResponse
	{
		...
		private GetPhysicalDatabase_Database database;
		...
		public GetPhysicalDatabase_Database Database
		{
			get
			{
				return database;
		...
		public class GetPhysicalDatabase_Database
		{
