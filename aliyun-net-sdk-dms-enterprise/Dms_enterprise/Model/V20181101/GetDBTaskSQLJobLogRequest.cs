...
{
    public class GetDBTaskSQLJobLogRequest : RpcAcsRequest<GetDBTaskSQLJobLogResponse>
    {
        public GetDBTaskSQLJobLogRequest()
            : base("dms-enterprise", "2018-11-01", "GetDBTaskSQLJobLog", "dms-enterprise", "openAPI")
        {
        ...
        public override GetDBTaskSQLJobLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDBTaskSQLJobLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
