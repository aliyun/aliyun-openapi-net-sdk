...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class GetUserActiveTenantRequest : RpcAcsRequest<GetUserActiveTenantResponse>
    {
        ...
        public override GetUserActiveTenantResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserActiveTenantResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
