...
{
    public class GetDataCorrectBackupFilesRequest : RpcAcsRequest<GetDataCorrectBackupFilesResponse>
    {
        public GetDataCorrectBackupFilesRequest()
            : base("dms-enterprise", "2018-11-01", "GetDataCorrectBackupFiles", "dms-enterprise", "openAPI")
        {
        ...
        public override GetDataCorrectBackupFilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataCorrectBackupFilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
