...
namespace Aliyun.Acs.dms_enterprise.Model.V20181101
{
    public class SetOwnersRequest : RpcAcsRequest<SetOwnersResponse>
    {
        public SetOwnersRequest()
            : base("dms-enterprise", "2018-11-01", "SetOwners")
        {
		...
		public string OwnerIds
		{
			...
			{
				ownerIds = value;
				DictionaryUtil.Add(QueryParameters, "OwnerIds", value);
			}
		}
        ...
        public override SetOwnersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetOwnersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
