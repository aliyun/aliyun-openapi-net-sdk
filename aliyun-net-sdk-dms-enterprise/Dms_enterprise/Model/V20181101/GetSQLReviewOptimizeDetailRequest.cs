...
{
    public class GetSQLReviewOptimizeDetailRequest : RpcAcsRequest<GetSQLReviewOptimizeDetailResponse>
    {
        public GetSQLReviewOptimizeDetailRequest()
            : base("dms-enterprise", "2018-11-01", "GetSQLReviewOptimizeDetail", "dms-enterprise", "openAPI")
        {
		...
		public string SQLReviewQueryKey
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SQLReviewQueryKey", value);
			}
		}
        ...
        public override GetSQLReviewOptimizeDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSQLReviewOptimizeDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
