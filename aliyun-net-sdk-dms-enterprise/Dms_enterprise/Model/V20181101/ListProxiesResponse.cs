...
{
	public class ListProxiesResponse : AcsResponse
	{
		...
		private List<ListProxies_ProxyListItem> proxyList;
		...
		[JsonProperty(PropertyName = "ProxyList")]
		public List<ListProxies_ProxyListItem> ProxyList
		{
			get
			{
				return proxyList;
		...
		public class ListProxies_ProxyListItem
		{
