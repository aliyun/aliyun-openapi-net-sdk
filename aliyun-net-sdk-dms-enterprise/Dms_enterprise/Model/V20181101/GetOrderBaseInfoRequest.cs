...
{
    public class GetOrderBaseInfoRequest : RpcAcsRequest<GetOrderBaseInfoResponse>
    {
        public GetOrderBaseInfoRequest()
            : base("dms-enterprise", "2018-11-01", "GetOrderBaseInfo", "dms-enterprise", "openAPI")
        {
        ...
        public override GetOrderBaseInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOrderBaseInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
