...
{
    public class DeleteMPULayoutRequest : RpcAcsRequest<DeleteMPULayoutResponse>
    {
        public DeleteMPULayoutRequest()
            : base("rtc", "2018-01-11", "DeleteMPULayout", "rtc", "openAPI")
        {
        ...
        public override DeleteMPULayoutResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMPULayoutResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
