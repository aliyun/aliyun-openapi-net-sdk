...
{
    public class DeleteMPURuleRequest : RpcAcsRequest<DeleteMPURuleResponse>
    {
        public DeleteMPURuleRequest()
            : base("rtc", "2018-01-11", "DeleteMPURule", "rtc", "openAPI")
        {
        ...
        public override DeleteMPURuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMPURuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
