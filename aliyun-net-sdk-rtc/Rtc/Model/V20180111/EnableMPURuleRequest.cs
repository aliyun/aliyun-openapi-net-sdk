...
{
    public class EnableMPURuleRequest : RpcAcsRequest<EnableMPURuleResponse>
    {
        public EnableMPURuleRequest()
            : base("rtc", "2018-01-11", "EnableMPURule", "rtc", "openAPI")
        {
        ...
        public override EnableMPURuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableMPURuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
