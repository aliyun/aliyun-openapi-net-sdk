...
{
    public class DescribeRtcUserEventsRequest : RpcAcsRequest<DescribeRtcUserEventsResponse>
    {
        public DescribeRtcUserEventsRequest()
            : base("rtc", "2018-01-11", "DescribeRtcUserEvents", "rtc", "openAPI")
        {
        ...
        public override DescribeRtcUserEventsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRtcUserEventsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
