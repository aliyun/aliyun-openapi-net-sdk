...
{
    public class DeleteRecordTemplateRequest : RpcAcsRequest<DeleteRecordTemplateResponse>
    {
        public DeleteRecordTemplateRequest()
            : base("rtc", "2018-01-11", "DeleteRecordTemplate", "rtc", "openAPI")
        {
        ...
        public override DeleteRecordTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRecordTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
