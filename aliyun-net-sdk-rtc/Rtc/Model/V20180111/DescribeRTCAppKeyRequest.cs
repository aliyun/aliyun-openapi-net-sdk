...
{
    public class DescribeRTCAppKeyRequest : RpcAcsRequest<DescribeRTCAppKeyResponse>
    {
        public DescribeRTCAppKeyRequest()
            : base("rtc", "2018-01-11", "DescribeRTCAppKey", "rtc", "openAPI")
        {
        ...
        public override DescribeRTCAppKeyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRTCAppKeyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
