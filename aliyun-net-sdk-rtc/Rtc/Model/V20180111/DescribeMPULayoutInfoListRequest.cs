...
{
    public class DescribeMPULayoutInfoListRequest : RpcAcsRequest<DescribeMPULayoutInfoListResponse>
    {
        public DescribeMPULayoutInfoListRequest()
            : base("rtc", "2018-01-11", "DescribeMPULayoutInfoList", "rtc", "openAPI")
        {
        ...
        public override DescribeMPULayoutInfoListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMPULayoutInfoListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
