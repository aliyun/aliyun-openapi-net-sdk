...
{
    public class DescribeUserInfoInChannelRequest : RpcAcsRequest<DescribeUserInfoInChannelResponse>
    {
        public DescribeUserInfoInChannelRequest()
            : base("rtc", "2018-01-11", "DescribeUserInfoInChannel", "rtc", "openAPI")
        {
        ...
        public override DescribeUserInfoInChannelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUserInfoInChannelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
