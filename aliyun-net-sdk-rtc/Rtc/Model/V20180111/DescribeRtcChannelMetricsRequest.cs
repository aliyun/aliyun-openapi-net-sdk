...
{
    public class DescribeRtcChannelMetricsRequest : RpcAcsRequest<DescribeRtcChannelMetricsResponse>
    {
        public DescribeRtcChannelMetricsRequest()
            : base("rtc", "2018-01-11", "DescribeRtcChannelMetrics", "rtc", "openAPI")
        {
		...
		public string PubUid
		{
			...
			{
				pubUid = value;
				DictionaryUtil.Add(QueryParameters, "PubUid", value);
			}
		}
        ...
        public override DescribeRtcChannelMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRtcChannelMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
