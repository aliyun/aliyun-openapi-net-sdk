...
{
    public class DescribeRtcChannelMetricRequest : RpcAcsRequest<DescribeRtcChannelMetricResponse>
    {
        public DescribeRtcChannelMetricRequest()
            : base("rtc", "2018-01-11", "DescribeRtcChannelMetric", "rtc", "openAPI")
        {
        ...
        public override DescribeRtcChannelMetricResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRtcChannelMetricResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
