...
{
    public class DisableMPURuleRequest : RpcAcsRequest<DisableMPURuleResponse>
    {
        public DisableMPURuleRequest()
            : base("rtc", "2018-01-11", "DisableMPURule", "rtc", "openAPI")
        {
        ...
        public override DisableMPURuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableMPURuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
