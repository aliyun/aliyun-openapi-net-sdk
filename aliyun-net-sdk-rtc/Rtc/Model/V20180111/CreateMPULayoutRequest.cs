...
{
    public class CreateMPULayoutRequest : RpcAcsRequest<CreateMPULayoutResponse>
    {
        public CreateMPULayoutRequest()
            : base("rtc", "2018-01-11", "CreateMPULayout", "rtc", "openAPI")
        {
        ...
        public override CreateMPULayoutResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMPULayoutResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
