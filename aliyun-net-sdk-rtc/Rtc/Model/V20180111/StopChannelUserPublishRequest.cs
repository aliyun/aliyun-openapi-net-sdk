...
{
    public class StopChannelUserPublishRequest : RpcAcsRequest<StopChannelUserPublishResponse>
    {
        public StopChannelUserPublishRequest()
            : base("rtc", "2018-01-11", "StopChannelUserPublish", "rtc", "openAPI")
        {
        ...
        public override StopChannelUserPublishResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopChannelUserPublishResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
