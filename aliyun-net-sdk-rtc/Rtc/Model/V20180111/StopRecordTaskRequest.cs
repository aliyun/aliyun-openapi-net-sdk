...
{
    public class StopRecordTaskRequest : RpcAcsRequest<StopRecordTaskResponse>
    {
        public StopRecordTaskRequest()
            : base("rtc", "2018-01-11", "StopRecordTask", "rtc", "openAPI")
        {
        ...
        public override StopRecordTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopRecordTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
