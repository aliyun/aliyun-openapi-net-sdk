...
{
    public class DescribeRtcUserListRequest : RpcAcsRequest<DescribeRtcUserListResponse>
    {
        public DescribeRtcUserListRequest()
            : base("rtc", "2018-01-11", "DescribeRtcUserList", "rtc", "openAPI")
        {
        ...
        public override DescribeRtcUserListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRtcUserListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
