...
{
    public class UpdateRecordTaskRequest : RpcAcsRequest<UpdateRecordTaskResponse>
    {
        public UpdateRecordTaskRequest()
            : base("rtc", "2018-01-11", "UpdateRecordTask", "rtc", "openAPI")
        {
        ...
        public override UpdateRecordTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRecordTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
