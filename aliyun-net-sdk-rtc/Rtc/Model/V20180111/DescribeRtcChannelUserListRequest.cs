...
{
    public class DescribeRtcChannelUserListRequest : RpcAcsRequest<DescribeRtcChannelUserListResponse>
    {
        public DescribeRtcChannelUserListRequest()
            : base("rtc", "2018-01-11", "DescribeRtcChannelUserList", "rtc", "openAPI")
        {
        ...
        public override DescribeRtcChannelUserListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRtcChannelUserListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
