...
namespace Aliyun.Acs.Sddp.Model.V20190103
{
    public class ExecDatamaskRequest : RpcAcsRequest<ExecDatamaskResponse>
    {
        ...
        public override ExecDatamaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExecDatamaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
