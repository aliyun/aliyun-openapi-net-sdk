...
{
    public class DescribeRuleCategoryRequest : RpcAcsRequest<DescribeRuleCategoryResponse>
    {
        public DescribeRuleCategoryRequest()
            : base("Sddp", "2019-01-03", "DescribeRuleCategory")
        {
        ...
        public override DescribeRuleCategoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRuleCategoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
