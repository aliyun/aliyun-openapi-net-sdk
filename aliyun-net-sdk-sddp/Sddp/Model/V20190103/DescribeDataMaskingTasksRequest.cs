...
{
    public class DescribeDataMaskingTasksRequest : RpcAcsRequest<DescribeDataMaskingTasksResponse>
    {
        public DescribeDataMaskingTasksRequest()
            : base("Sddp", "2019-01-03", "DescribeDataMaskingTasks", "sddp", "openAPI")
        {
        ...
        public override DescribeDataMaskingTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataMaskingTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
