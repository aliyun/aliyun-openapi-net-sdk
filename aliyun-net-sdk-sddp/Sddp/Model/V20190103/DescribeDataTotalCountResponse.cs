	...
	public class DescribeDataTotalCountResponse : AcsResponse
	{
		...
		public class DescribeDataTotalCount_DataCount
		{
			...
			public class DescribeDataTotalCount_Column
			{
				...
				private List<DescribeDataTotalCount_ColumnCount> columnRuleTop;
				...
				public List<DescribeDataTotalCount_ColumnCount> ColumnRuleTop
				{
					get
					{
				...
				public class DescribeDataTotalCount_ColumnCount
				{
			...
			public class DescribeDataTotalCount_Oss
			{
				...
				private List<DescribeDataTotalCount_OssCount> ossRuleTop;
				...
				public List<DescribeDataTotalCount_OssCount> OssRuleTop
				{
					get
					{
						return ossRuleTop;
				...
				public class DescribeDataTotalCount_OssCount
				{
