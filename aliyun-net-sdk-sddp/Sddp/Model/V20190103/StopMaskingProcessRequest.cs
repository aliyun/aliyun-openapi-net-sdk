...
namespace Aliyun.Acs.Sddp.Model.V20190103
{
    public class StopMaskingProcessRequest : RpcAcsRequest<StopMaskingProcessResponse>
    {
        ...
        public override StopMaskingProcessResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopMaskingProcessResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
