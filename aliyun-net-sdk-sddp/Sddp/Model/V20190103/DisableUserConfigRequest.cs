...
{
    public class DisableUserConfigRequest : RpcAcsRequest<DisableUserConfigResponse>
    {
        public DisableUserConfigRequest()
            : base("Sddp", "2019-01-03", "DisableUserConfig", "sddp", "openAPI")
        {
        ...
        public override DisableUserConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableUserConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
