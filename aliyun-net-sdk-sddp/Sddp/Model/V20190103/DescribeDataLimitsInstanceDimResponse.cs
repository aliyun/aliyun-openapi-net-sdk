...
{
	public class DescribeDataLimitsInstanceDimResponse : AcsResponse
	{
		...
		private List<DescribeDataLimitsInstanceDim_DataLimit> items;
		...
		public List<DescribeDataLimitsInstanceDim_DataLimit> Items
		{
			get
			{
				return items;
		...
		public class DescribeDataLimitsInstanceDim_DataLimit
		{
			...
			private List<DescribeDataLimitsInstanceDim_DataLimitListInner> dataLimitList;
			...
			public List<DescribeDataLimitsInstanceDim_DataLimitListInner> DataLimitList
			{
				get
				{
			...
			public class DescribeDataLimitsInstanceDim_DataLimitListInner
			{
				...
				private bool? autoCreateAccount;
