...
{
    public class DescribeDataObjectColumnDetailV2Request : RpcAcsRequest<DescribeDataObjectColumnDetailV2Response>
    {
        public DescribeDataObjectColumnDetailV2Request()
            : base("Sddp", "2019-01-03", "DescribeDataObjectColumnDetailV2", "sddp", "openAPI")
        {
        ...
        public override DescribeDataObjectColumnDetailV2Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataObjectColumnDetailV2ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
