...
{
    public class GetRepoTagScanStatusRequest : RoaAcsRequest<GetRepoTagScanStatusResponse>
    {
        public GetRepoTagScanStatusRequest()
            : base("cr", "2016-06-07", "GetRepoTagScanStatus", "acr", "openAPI")
        {
			...
			UriPattern = "/repos/[RepoNamespace]/[RepoName]/tags/[Tag]/scanStatus";
        ...
        public override GetRepoTagScanStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRepoTagScanStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
