...
{
    public class DescribeBackendServersRequest : RpcAcsRequest<DescribeBackendServersResponse>
    {
        public DescribeBackendServersRequest()
            : base("Slb", "2013-02-21", "DescribeBackendServers", "slb", "openAPI")
        {
        ...
        public override DescribeBackendServersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackendServersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
