...
{
    public class DeleteTLSCipherPolicyRequest : RpcAcsRequest<DeleteTLSCipherPolicyResponse>
    {
        public DeleteTLSCipherPolicyRequest()
            : base("Slb", "2014-05-15", "DeleteTLSCipherPolicy", "slb", "openAPI")
        {
        ...
        public override DeleteTLSCipherPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTLSCipherPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
