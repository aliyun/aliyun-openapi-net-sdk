...
{
    public class ListTLSCipherPoliciesRequest : RpcAcsRequest<ListTLSCipherPoliciesResponse>
    {
        public ListTLSCipherPoliciesRequest()
            : base("Slb", "2014-05-15", "ListTLSCipherPolicies", "slb", "openAPI")
        {
        ...
        public override ListTLSCipherPoliciesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTLSCipherPoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
