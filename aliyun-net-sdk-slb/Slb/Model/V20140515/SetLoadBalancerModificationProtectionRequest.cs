...
{
    public class SetLoadBalancerModificationProtectionRequest : RpcAcsRequest<SetLoadBalancerModificationProtectionResponse>
    {
        public SetLoadBalancerModificationProtectionRequest()
            : base("Slb", "2014-05-15", "SetLoadBalancerModificationProtection", "slb", "openAPI")
        {
        ...
        public override SetLoadBalancerModificationProtectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetLoadBalancerModificationProtectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
