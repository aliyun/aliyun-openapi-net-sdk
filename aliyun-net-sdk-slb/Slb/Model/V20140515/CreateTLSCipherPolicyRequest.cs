...
{
    public class CreateTLSCipherPolicyRequest : RpcAcsRequest<CreateTLSCipherPolicyResponse>
    {
        public CreateTLSCipherPolicyRequest()
            : base("Slb", "2014-05-15", "CreateTLSCipherPolicy", "slb", "openAPI")
        {
        ...
        public override CreateTLSCipherPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTLSCipherPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
