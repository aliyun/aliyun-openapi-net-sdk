...
namespace Aliyun.Acs.ddoscoo.Transform.V20200101
{
    ...
    {
        public static DescribeDefenseCountStatisticsResponse Unmarshall(UnmarshallerContext _ctx)
        {
			DescribeDefenseCountStatisticsResponse describeDefenseCountStatisticsResponse = new DescribeDefenseCountStatisticsResponse();

			describeDefenseCountStatisticsResponse.HttpResponse = _ctx.HttpResponse;
