...
{
    public class DescribeDomainAttackEventsRequest : RpcAcsRequest<DescribeDomainAttackEventsResponse>
    {
        public DescribeDomainAttackEventsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainAttackEvents")
        {
        ...
        public override DescribeDomainAttackEventsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainAttackEventsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
