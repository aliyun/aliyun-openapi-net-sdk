...
{
    public class DescribeWebCacheConfigsRequest : RpcAcsRequest<DescribeWebCacheConfigsResponse>
    {
        public DescribeWebCacheConfigsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebCacheConfigs")
        {
        ...
        public override DescribeWebCacheConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebCacheConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
