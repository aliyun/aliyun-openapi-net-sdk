...
{
    public class DescribeWebCustomPortsRequest : RpcAcsRequest<DescribeWebCustomPortsResponse>
    {
        public DescribeWebCustomPortsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebCustomPorts")
        {
        ...
        public override DescribeWebCustomPortsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebCustomPortsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
