...
{
    public class ModifyWebIpSetSwitchRequest : RpcAcsRequest<ModifyWebIpSetSwitchResponse>
    {
        public ModifyWebIpSetSwitchRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebIpSetSwitch")
        {
        ...
        public override ModifyWebIpSetSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebIpSetSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
