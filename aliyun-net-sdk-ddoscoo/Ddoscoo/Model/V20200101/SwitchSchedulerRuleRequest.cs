...
{
    public class SwitchSchedulerRuleRequest : RpcAcsRequest<SwitchSchedulerRuleResponse>
    {
        public SwitchSchedulerRuleRequest()
            : base("ddoscoo", "2020-01-01", "SwitchSchedulerRule")
        {
		...
		public string SwitchData
		{
			...
			{
				switchData = value;
				DictionaryUtil.Add(QueryParameters, "SwitchData", value);
			}
		}
        ...
        public override SwitchSchedulerRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwitchSchedulerRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
