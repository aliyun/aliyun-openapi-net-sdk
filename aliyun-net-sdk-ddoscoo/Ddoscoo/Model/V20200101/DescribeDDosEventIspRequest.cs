...
{
    public class DescribeDDosEventIspRequest : RpcAcsRequest<DescribeDDosEventIspResponse>
    {
        public DescribeDDosEventIspRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDDosEventIsp")
        {
        ...
        public override DescribeDDosEventIspResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDDosEventIspResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
