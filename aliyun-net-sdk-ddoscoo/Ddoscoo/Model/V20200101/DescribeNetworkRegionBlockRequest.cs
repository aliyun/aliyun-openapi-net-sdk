...
{
    public class DescribeNetworkRegionBlockRequest : RpcAcsRequest<DescribeNetworkRegionBlockResponse>
    {
        public DescribeNetworkRegionBlockRequest()
            : base("ddoscoo", "2020-01-01", "DescribeNetworkRegionBlock")
        {
        ...
        public override DescribeNetworkRegionBlockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNetworkRegionBlockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
