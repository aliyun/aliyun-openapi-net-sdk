...
{
    public class DescribeInstanceDetailsRequest : RpcAcsRequest<DescribeInstanceDetailsResponse>
    {
        public DescribeInstanceDetailsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeInstanceDetails")
        {
        ...
        public override DescribeInstanceDetailsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceDetailsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
