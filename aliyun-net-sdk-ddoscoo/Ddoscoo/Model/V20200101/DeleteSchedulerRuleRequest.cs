...
{
    public class DeleteSchedulerRuleRequest : RpcAcsRequest<DeleteSchedulerRuleResponse>
    {
        public DeleteSchedulerRuleRequest()
            : base("ddoscoo", "2020-01-01", "DeleteSchedulerRule")
        {
        ...
        public override DeleteSchedulerRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSchedulerRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
