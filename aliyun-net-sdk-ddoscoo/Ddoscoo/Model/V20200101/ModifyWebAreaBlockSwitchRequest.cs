...
{
    public class ModifyWebAreaBlockSwitchRequest : RpcAcsRequest<ModifyWebAreaBlockSwitchResponse>
    {
        public ModifyWebAreaBlockSwitchRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebAreaBlockSwitch")
        {
        ...
        public override ModifyWebAreaBlockSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebAreaBlockSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
