...
{
    public class EnableWebCCRequest : RpcAcsRequest<EnableWebCCResponse>
    {
        public EnableWebCCRequest()
            : base("ddoscoo", "2020-01-01", "EnableWebCC")
        {
        ...
        public override EnableWebCCResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableWebCCResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
