...
{
    public class DescribeCnameReusesRequest : RpcAcsRequest<DescribeCnameReusesResponse>
    {
        public DescribeCnameReusesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeCnameReuses")
        {
        ...
        public override DescribeCnameReusesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCnameReusesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
