...
{
    public class DescribeNetworkRulesRequest : RpcAcsRequest<DescribeNetworkRulesResponse>
    {
        public DescribeNetworkRulesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeNetworkRules")
        {
        ...
        public override DescribeNetworkRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNetworkRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
