...
{
    public class ModifyHealthCheckConfigRequest : RpcAcsRequest<ModifyHealthCheckConfigResponse>
    {
        public ModifyHealthCheckConfigRequest()
            : base("ddoscoo", "2020-01-01", "ModifyHealthCheckConfig")
        {
        ...
        public override ModifyHealthCheckConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyHealthCheckConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
