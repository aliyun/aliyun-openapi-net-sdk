...
{
    public class DeleteWebCacheCustomRuleRequest : RpcAcsRequest<DeleteWebCacheCustomRuleResponse>
    {
        public DeleteWebCacheCustomRuleRequest()
            : base("ddoscoo", "2020-01-01", "DeleteWebCacheCustomRule")
        {
        ...
        public override DeleteWebCacheCustomRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteWebCacheCustomRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
