...
{
    public class DescribeBlockStatusRequest : RpcAcsRequest<DescribeBlockStatusResponse>
    {
        public DescribeBlockStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribeBlockStatus")
        {
        ...
        public override DescribeBlockStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBlockStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
