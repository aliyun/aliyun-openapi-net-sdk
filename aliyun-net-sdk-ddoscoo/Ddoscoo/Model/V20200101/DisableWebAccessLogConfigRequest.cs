...
{
    public class DisableWebAccessLogConfigRequest : RpcAcsRequest<DisableWebAccessLogConfigResponse>
    {
        public DisableWebAccessLogConfigRequest()
            : base("ddoscoo", "2020-01-01", "DisableWebAccessLogConfig")
        {
        ...
        public override DisableWebAccessLogConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableWebAccessLogConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
