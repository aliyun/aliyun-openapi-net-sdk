...
{
    public class DescribeCertsRequest : RpcAcsRequest<DescribeCertsResponse>
    {
        public DescribeCertsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeCerts")
        {
        ...
        public override DescribeCertsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCertsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
