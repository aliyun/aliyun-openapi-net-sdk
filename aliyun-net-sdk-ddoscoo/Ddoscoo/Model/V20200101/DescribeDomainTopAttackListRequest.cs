...
{
    public class DescribeDomainTopAttackListRequest : RpcAcsRequest<DescribeDomainTopAttackListResponse>
    {
        public DescribeDomainTopAttackListRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainTopAttackList")
        {
        ...
        public override DescribeDomainTopAttackListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainTopAttackListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
