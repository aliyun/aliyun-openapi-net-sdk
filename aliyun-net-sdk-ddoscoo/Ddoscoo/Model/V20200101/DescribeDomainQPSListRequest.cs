...
{
    public class DescribeDomainQPSListRequest : RpcAcsRequest<DescribeDomainQPSListResponse>
    {
        public DescribeDomainQPSListRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainQPSList")
        {
        ...
        public override DescribeDomainQPSListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainQPSListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
