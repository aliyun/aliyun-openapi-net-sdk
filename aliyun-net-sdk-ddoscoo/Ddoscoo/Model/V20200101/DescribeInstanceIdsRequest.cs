...
{
    public class DescribeInstanceIdsRequest : RpcAcsRequest<DescribeInstanceIdsResponse>
    {
        public DescribeInstanceIdsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeInstanceIds")
        {
        ...
        public override DescribeInstanceIdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceIdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
