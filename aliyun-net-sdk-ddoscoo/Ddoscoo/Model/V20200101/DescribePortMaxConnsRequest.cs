...
{
    public class DescribePortMaxConnsRequest : RpcAcsRequest<DescribePortMaxConnsResponse>
    {
        public DescribePortMaxConnsRequest()
            : base("ddoscoo", "2020-01-01", "DescribePortMaxConns")
        {
        ...
        public override DescribePortMaxConnsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePortMaxConnsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
