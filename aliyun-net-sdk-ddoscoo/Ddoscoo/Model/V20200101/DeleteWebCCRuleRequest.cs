...
{
    public class DeleteWebCCRuleRequest : RpcAcsRequest<DeleteWebCCRuleResponse>
    {
        public DeleteWebCCRuleRequest()
            : base("ddoscoo", "2020-01-01", "DeleteWebCCRule")
        {
        ...
        public override DeleteWebCCRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteWebCCRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
