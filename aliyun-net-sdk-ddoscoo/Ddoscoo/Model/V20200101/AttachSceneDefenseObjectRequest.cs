...
{
    public class AttachSceneDefenseObjectRequest : RpcAcsRequest<AttachSceneDefenseObjectResponse>
    {
        public AttachSceneDefenseObjectRequest()
            : base("ddoscoo", "2020-01-01", "AttachSceneDefenseObject")
        {
        ...
        public override AttachSceneDefenseObjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AttachSceneDefenseObjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
