...
{
    public class DescribeStsGrantStatusRequest : RpcAcsRequest<DescribeStsGrantStatusResponse>
    {
        public DescribeStsGrantStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribeStsGrantStatus")
        {
        ...
        public override DescribeStsGrantStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeStsGrantStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
