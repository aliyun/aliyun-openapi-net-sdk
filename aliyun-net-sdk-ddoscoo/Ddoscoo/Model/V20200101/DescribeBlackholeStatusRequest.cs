...
{
    public class DescribeBlackholeStatusRequest : RpcAcsRequest<DescribeBlackholeStatusResponse>
    {
        public DescribeBlackholeStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribeBlackholeStatus")
        {
        ...
        public override DescribeBlackholeStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBlackholeStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
