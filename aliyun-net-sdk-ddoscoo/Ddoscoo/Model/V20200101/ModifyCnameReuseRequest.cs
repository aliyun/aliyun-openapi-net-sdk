...
{
    public class ModifyCnameReuseRequest : RpcAcsRequest<ModifyCnameReuseResponse>
    {
        public ModifyCnameReuseRequest()
            : base("ddoscoo", "2020-01-01", "ModifyCnameReuse")
        {
        ...
        public override ModifyCnameReuseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyCnameReuseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
