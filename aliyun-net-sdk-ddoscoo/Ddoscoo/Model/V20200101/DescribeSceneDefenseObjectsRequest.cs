...
{
    public class DescribeSceneDefenseObjectsRequest : RpcAcsRequest<DescribeSceneDefenseObjectsResponse>
    {
        public DescribeSceneDefenseObjectsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeSceneDefenseObjects")
        {
        ...
        public override DescribeSceneDefenseObjectsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSceneDefenseObjectsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
