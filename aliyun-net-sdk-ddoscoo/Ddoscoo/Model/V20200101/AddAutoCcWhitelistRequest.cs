...
{
    public class AddAutoCcWhitelistRequest : RpcAcsRequest<AddAutoCcWhitelistResponse>
    {
        public AddAutoCcWhitelistRequest()
            : base("ddoscoo", "2020-01-01", "AddAutoCcWhitelist")
        {
        ...
        public override AddAutoCcWhitelistResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddAutoCcWhitelistResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
