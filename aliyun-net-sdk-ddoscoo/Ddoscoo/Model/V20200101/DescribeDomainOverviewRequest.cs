...
{
    public class DescribeDomainOverviewRequest : RpcAcsRequest<DescribeDomainOverviewResponse>
    {
        public DescribeDomainOverviewRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainOverview")
        {
        ...
        public override DescribeDomainOverviewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainOverviewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
