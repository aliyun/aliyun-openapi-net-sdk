...
{
    public class CreateNetworkRulesRequest : RpcAcsRequest<CreateNetworkRulesResponse>
    {
        public CreateNetworkRulesRequest()
            : base("ddoscoo", "2020-01-01", "CreateNetworkRules")
        {
        ...
        public override CreateNetworkRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateNetworkRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
