...
{
    public class DeletePortRequest : RpcAcsRequest<DeletePortResponse>
    {
        public DeletePortRequest()
            : base("ddoscoo", "2020-01-01", "DeletePort")
        {
        ...
        public override DeletePortResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePortResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
