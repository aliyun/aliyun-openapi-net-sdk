...
{
    public class ModifyWebAreaBlockRequest : RpcAcsRequest<ModifyWebAreaBlockResponse>
    {
        public ModifyWebAreaBlockRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebAreaBlock")
        {
		...
		private List<string> regionss = new List<string>(){ };

		private string resourceGroupId;

		private string domain;

		public List<string> Regionss
		{
			get
			{
				return regionss;
        ...
        public override ModifyWebAreaBlockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebAreaBlockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
