...
{
    public class ModifyWebAIProtectModeRequest : RpcAcsRequest<ModifyWebAIProtectModeResponse>
    {
        public ModifyWebAIProtectModeRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebAIProtectMode")
        {
        ...
        public override ModifyWebAIProtectModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebAIProtectModeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
