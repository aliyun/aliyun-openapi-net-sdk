...
{
    public class DescribeDefenseCountStatisticsRequest : RpcAcsRequest<DescribeDefenseCountStatisticsResponse>
    {
        public DescribeDefenseCountStatisticsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDefenseCountStatistics")
        {
        ...
        public override DescribeDefenseCountStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDefenseCountStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
