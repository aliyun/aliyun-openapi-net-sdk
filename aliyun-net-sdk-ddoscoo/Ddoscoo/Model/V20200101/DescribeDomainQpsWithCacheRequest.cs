...
{
    public class DescribeDomainQpsWithCacheRequest : RpcAcsRequest<DescribeDomainQpsWithCacheResponse>
    {
        public DescribeDomainQpsWithCacheRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainQpsWithCache")
        {
        ...
        public override DescribeDomainQpsWithCacheResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainQpsWithCacheResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
