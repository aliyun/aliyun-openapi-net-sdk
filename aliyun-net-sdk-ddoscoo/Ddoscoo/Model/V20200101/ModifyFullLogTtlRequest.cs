...
{
    public class ModifyFullLogTtlRequest : RpcAcsRequest<ModifyFullLogTtlResponse>
    {
        public ModifyFullLogTtlRequest()
            : base("ddoscoo", "2020-01-01", "ModifyFullLogTtl")
        {
        ...
        public override ModifyFullLogTtlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFullLogTtlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
