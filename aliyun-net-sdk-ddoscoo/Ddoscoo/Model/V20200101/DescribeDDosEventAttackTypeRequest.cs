...
{
    public class DescribeDDosEventAttackTypeRequest : RpcAcsRequest<DescribeDDosEventAttackTypeResponse>
    {
        public DescribeDDosEventAttackTypeRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDDosEventAttackType")
        {
        ...
        public override DescribeDDosEventAttackTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDDosEventAttackTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
