...
{
    public class ConfigWebCCTemplateRequest : RpcAcsRequest<ConfigWebCCTemplateResponse>
    {
        public ConfigWebCCTemplateRequest()
            : base("ddoscoo", "2020-01-01", "ConfigWebCCTemplate")
        {
        ...
        public override ConfigWebCCTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigWebCCTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
