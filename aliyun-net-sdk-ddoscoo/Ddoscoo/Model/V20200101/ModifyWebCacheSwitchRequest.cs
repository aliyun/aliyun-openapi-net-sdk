...
{
    public class ModifyWebCacheSwitchRequest : RpcAcsRequest<ModifyWebCacheSwitchResponse>
    {
        public ModifyWebCacheSwitchRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebCacheSwitch")
        {
        ...
        public override ModifyWebCacheSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebCacheSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
