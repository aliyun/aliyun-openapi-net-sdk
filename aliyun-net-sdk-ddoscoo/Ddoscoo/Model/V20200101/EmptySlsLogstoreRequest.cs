...
{
    public class EmptySlsLogstoreRequest : RpcAcsRequest<EmptySlsLogstoreResponse>
    {
        public EmptySlsLogstoreRequest()
            : base("ddoscoo", "2020-01-01", "EmptySlsLogstore")
        {
        ...
        public override EmptySlsLogstoreResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EmptySlsLogstoreResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
