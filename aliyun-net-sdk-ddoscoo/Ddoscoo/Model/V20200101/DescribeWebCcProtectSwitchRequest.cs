...
{
    public class DescribeWebCcProtectSwitchRequest : RpcAcsRequest<DescribeWebCcProtectSwitchResponse>
    {
        public DescribeWebCcProtectSwitchRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebCcProtectSwitch")
        {
        ...
        public override DescribeWebCcProtectSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebCcProtectSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
