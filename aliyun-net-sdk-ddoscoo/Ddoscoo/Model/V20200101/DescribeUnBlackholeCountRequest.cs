...
{
    public class DescribeUnBlackholeCountRequest : RpcAcsRequest<DescribeUnBlackholeCountResponse>
    {
        public DescribeUnBlackholeCountRequest()
            : base("ddoscoo", "2020-01-01", "DescribeUnBlackholeCount")
        {
        ...
        public override DescribeUnBlackholeCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUnBlackholeCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
