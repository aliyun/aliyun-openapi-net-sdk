...
{
    public class DescribePortAttackMaxFlowRequest : RpcAcsRequest<DescribePortAttackMaxFlowResponse>
    {
        public DescribePortAttackMaxFlowRequest()
            : base("ddoscoo", "2020-01-01", "DescribePortAttackMaxFlow")
        {
        ...
        public override DescribePortAttackMaxFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePortAttackMaxFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
