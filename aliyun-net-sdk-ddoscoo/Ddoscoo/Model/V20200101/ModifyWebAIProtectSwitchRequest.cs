...
{
    public class ModifyWebAIProtectSwitchRequest : RpcAcsRequest<ModifyWebAIProtectSwitchResponse>
    {
        public ModifyWebAIProtectSwitchRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebAIProtectSwitch")
        {
        ...
        public override ModifyWebAIProtectSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebAIProtectSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
