...
{
    public class ConfigL7RsPolicyRequest : RpcAcsRequest<ConfigL7RsPolicyResponse>
    {
        public ConfigL7RsPolicyRequest()
            : base("ddoscoo", "2020-01-01", "ConfigL7RsPolicy")
        {
        ...
        public override ConfigL7RsPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigL7RsPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
