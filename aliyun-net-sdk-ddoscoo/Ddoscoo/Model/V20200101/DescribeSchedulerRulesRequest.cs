...
{
    public class DescribeSchedulerRulesRequest : RpcAcsRequest<DescribeSchedulerRulesResponse>
    {
        public DescribeSchedulerRulesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeSchedulerRules")
        {
        ...
        public override DescribeSchedulerRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSchedulerRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
