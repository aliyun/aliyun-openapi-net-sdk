...
{
    public class DescribeSceneDefensePoliciesRequest : RpcAcsRequest<DescribeSceneDefensePoliciesResponse>
    {
        public DescribeSceneDefensePoliciesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeSceneDefensePolicies")
        {
        ...
        public override DescribeSceneDefensePoliciesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSceneDefensePoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
