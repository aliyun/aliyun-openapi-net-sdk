...
{
    public class DescribePortConnsListRequest : RpcAcsRequest<DescribePortConnsListResponse>
    {
        public DescribePortConnsListRequest()
            : base("ddoscoo", "2020-01-01", "DescribePortConnsList")
        {
        ...
        public override DescribePortConnsListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePortConnsListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
