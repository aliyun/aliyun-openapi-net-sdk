...
{
    public class DetachSceneDefenseObjectRequest : RpcAcsRequest<DetachSceneDefenseObjectResponse>
    {
        public DetachSceneDefenseObjectRequest()
            : base("ddoscoo", "2020-01-01", "DetachSceneDefenseObject")
        {
		...
		public string Objects
		{
			...
			{
				objects = value;
				DictionaryUtil.Add(QueryParameters, "Objects", value);
			}
		}
        ...
        public override DetachSceneDefenseObjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetachSceneDefenseObjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
