...
{
    public class DeleteSceneDefensePolicyRequest : RpcAcsRequest<DeleteSceneDefensePolicyResponse>
    {
        public DeleteSceneDefensePolicyRequest()
            : base("ddoscoo", "2020-01-01", "DeleteSceneDefensePolicy")
        {
        ...
        public override DeleteSceneDefensePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSceneDefensePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
