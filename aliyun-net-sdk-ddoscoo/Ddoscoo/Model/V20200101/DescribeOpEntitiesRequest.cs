...
{
    public class DescribeOpEntitiesRequest : RpcAcsRequest<DescribeOpEntitiesResponse>
    {
        public DescribeOpEntitiesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeOpEntities")
        {
        ...
        public override DescribeOpEntitiesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOpEntitiesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
