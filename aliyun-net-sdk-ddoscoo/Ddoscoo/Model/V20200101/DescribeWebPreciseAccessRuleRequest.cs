...
{
    public class DescribeWebPreciseAccessRuleRequest : RpcAcsRequest<DescribeWebPreciseAccessRuleResponse>
    {
        public DescribeWebPreciseAccessRuleRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebPreciseAccessRule")
        {
        ...
        public override DescribeWebPreciseAccessRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebPreciseAccessRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
