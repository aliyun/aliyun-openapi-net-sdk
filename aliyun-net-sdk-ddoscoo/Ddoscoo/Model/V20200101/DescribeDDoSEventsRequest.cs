...
{
    public class DescribeDDoSEventsRequest : RpcAcsRequest<DescribeDDoSEventsResponse>
    {
        public DescribeDDoSEventsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDDoSEvents")
        {
        ...
        public override DescribeDDoSEventsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDDoSEventsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
