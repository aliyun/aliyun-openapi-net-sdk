...
{
    public class AddAutoCcBlacklistRequest : RpcAcsRequest<AddAutoCcBlacklistResponse>
    {
        public AddAutoCcBlacklistRequest()
            : base("ddoscoo", "2020-01-01", "AddAutoCcBlacklist")
        {
        ...
        public override AddAutoCcBlacklistResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddAutoCcBlacklistResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
