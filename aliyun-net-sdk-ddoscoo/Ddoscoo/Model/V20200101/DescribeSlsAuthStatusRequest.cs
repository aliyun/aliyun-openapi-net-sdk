...
{
    public class DescribeSlsAuthStatusRequest : RpcAcsRequest<DescribeSlsAuthStatusResponse>
    {
        public DescribeSlsAuthStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribeSlsAuthStatus")
        {
        ...
        public override DescribeSlsAuthStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSlsAuthStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
