...
{
    public class ConfigLayer4RemarkRequest : RpcAcsRequest<ConfigLayer4RemarkResponse>
    {
        public ConfigLayer4RemarkRequest()
            : base("ddoscoo", "2020-01-01", "ConfigLayer4Remark")
        {
        ...
        public override ConfigLayer4RemarkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigLayer4RemarkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
