...
{
    public class DeleteWebPreciseAccessRuleRequest : RpcAcsRequest<DeleteWebPreciseAccessRuleResponse>
    {
        public DeleteWebPreciseAccessRuleRequest()
            : base("ddoscoo", "2020-01-01", "DeleteWebPreciseAccessRule")
        {
		...
		private List<string> ruleNamess = new List<string>(){ };
        ...
        public override DeleteWebPreciseAccessRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteWebPreciseAccessRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
