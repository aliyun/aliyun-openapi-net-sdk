...
{
    public class DescribeHealthCheckStatusRequest : RpcAcsRequest<DescribeHealthCheckStatusResponse>
    {
        public DescribeHealthCheckStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribeHealthCheckStatus")
        {
        ...
        public override DescribeHealthCheckStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeHealthCheckStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
