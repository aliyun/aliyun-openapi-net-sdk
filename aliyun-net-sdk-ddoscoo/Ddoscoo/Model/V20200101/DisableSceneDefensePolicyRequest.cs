...
{
    public class DisableSceneDefensePolicyRequest : RpcAcsRequest<DisableSceneDefensePolicyResponse>
    {
        public DisableSceneDefensePolicyRequest()
            : base("ddoscoo", "2020-01-01", "DisableSceneDefensePolicy")
        {
        ...
        public override DisableSceneDefensePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableSceneDefensePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
