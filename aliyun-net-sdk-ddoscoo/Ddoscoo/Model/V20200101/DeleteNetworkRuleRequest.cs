...
{
    public class DeleteNetworkRuleRequest : RpcAcsRequest<DeleteNetworkRuleResponse>
    {
        public DeleteNetworkRuleRequest()
            : base("ddoscoo", "2020-01-01", "DeleteNetworkRule")
        {
		...
		public string NetworkRule
		{
			...
			{
				networkRule = value;
				DictionaryUtil.Add(QueryParameters, "NetworkRule", value);
			}
		}
        ...
        public override DeleteNetworkRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteNetworkRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
