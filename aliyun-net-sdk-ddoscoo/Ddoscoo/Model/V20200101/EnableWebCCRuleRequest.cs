...
{
    public class EnableWebCCRuleRequest : RpcAcsRequest<EnableWebCCRuleResponse>
    {
        public EnableWebCCRuleRequest()
            : base("ddoscoo", "2020-01-01", "EnableWebCCRule")
        {
        ...
        public override EnableWebCCRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableWebCCRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
