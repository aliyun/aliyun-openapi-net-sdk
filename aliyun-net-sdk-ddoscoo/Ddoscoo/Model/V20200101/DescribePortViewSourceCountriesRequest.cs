...
{
    public class DescribePortViewSourceCountriesRequest : RpcAcsRequest<DescribePortViewSourceCountriesResponse>
    {
        public DescribePortViewSourceCountriesRequest()
            : base("ddoscoo", "2020-01-01", "DescribePortViewSourceCountries")
        {
        ...
        public override DescribePortViewSourceCountriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePortViewSourceCountriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
