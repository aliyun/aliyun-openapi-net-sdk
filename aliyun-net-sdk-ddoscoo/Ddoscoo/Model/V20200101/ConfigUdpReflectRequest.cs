...
{
    public class ConfigUdpReflectRequest : RpcAcsRequest<ConfigUdpReflectResponse>
    {
        public ConfigUdpReflectRequest()
            : base("ddoscoo", "2020-01-01", "ConfigUdpReflect")
        {
        ...
        public override ConfigUdpReflectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigUdpReflectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
