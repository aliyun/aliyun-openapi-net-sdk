...
{
    public class DescribeWebAccessLogStatusRequest : RpcAcsRequest<DescribeWebAccessLogStatusResponse>
    {
        public DescribeWebAccessLogStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebAccessLogStatus")
        {
        ...
        public override DescribeWebAccessLogStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebAccessLogStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
