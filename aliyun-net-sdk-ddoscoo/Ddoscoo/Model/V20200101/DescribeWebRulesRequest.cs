...
{
    public class DescribeWebRulesRequest : RpcAcsRequest<DescribeWebRulesResponse>
    {
        public DescribeWebRulesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebRules")
        {
        ...
        public override DescribeWebRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
