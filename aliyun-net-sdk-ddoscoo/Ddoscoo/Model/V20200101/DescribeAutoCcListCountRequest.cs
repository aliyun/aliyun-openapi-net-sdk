...
{
    public class DescribeAutoCcListCountRequest : RpcAcsRequest<DescribeAutoCcListCountResponse>
    {
        public DescribeAutoCcListCountRequest()
            : base("ddoscoo", "2020-01-01", "DescribeAutoCcListCount")
        {
        ...
        public override DescribeAutoCcListCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAutoCcListCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
