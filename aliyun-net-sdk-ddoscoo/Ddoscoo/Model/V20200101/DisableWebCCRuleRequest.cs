...
{
    public class DisableWebCCRuleRequest : RpcAcsRequest<DisableWebCCRuleResponse>
    {
        public DisableWebCCRuleRequest()
            : base("ddoscoo", "2020-01-01", "DisableWebCCRule")
        {
        ...
        public override DisableWebCCRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableWebCCRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
