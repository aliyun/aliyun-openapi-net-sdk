...
{
    public class DescribeDDosEventAreaRequest : RpcAcsRequest<DescribeDDosEventAreaResponse>
    {
        public DescribeDDosEventAreaRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDDosEventArea")
        {
        ...
        public override DescribeDDosEventAreaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDDosEventAreaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
