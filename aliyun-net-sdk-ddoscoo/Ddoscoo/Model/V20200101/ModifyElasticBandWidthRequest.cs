...
{
    public class ModifyElasticBandWidthRequest : RpcAcsRequest<ModifyElasticBandWidthResponse>
    {
        public ModifyElasticBandWidthRequest()
            : base("ddoscoo", "2020-01-01", "ModifyElasticBandWidth")
        {
        ...
        public override ModifyElasticBandWidthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyElasticBandWidthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
