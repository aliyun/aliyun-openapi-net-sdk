...
{
    public class ModifyBlackholeStatusRequest : RpcAcsRequest<ModifyBlackholeStatusResponse>
    {
        public ModifyBlackholeStatusRequest()
            : base("ddoscoo", "2020-01-01", "ModifyBlackholeStatus")
        {
		...
		public string BlackholeStatus
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "BlackholeStatus", value);
			}
		}
        ...
        public override ModifyBlackholeStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyBlackholeStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
