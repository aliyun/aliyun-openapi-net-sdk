...
{
    public class ModifyHttp2EnableRequest : RpcAcsRequest<ModifyHttp2EnableResponse>
    {
        public ModifyHttp2EnableRequest()
            : base("ddoscoo", "2020-01-01", "ModifyHttp2Enable")
        {
        ...
        public override ModifyHttp2EnableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyHttp2EnableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
