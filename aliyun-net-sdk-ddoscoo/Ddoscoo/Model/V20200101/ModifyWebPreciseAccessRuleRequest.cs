...
{
    public class ModifyWebPreciseAccessRuleRequest : RpcAcsRequest<ModifyWebPreciseAccessRuleResponse>
    {
        public ModifyWebPreciseAccessRuleRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebPreciseAccessRule")
        {
        ...
        public override ModifyWebPreciseAccessRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebPreciseAccessRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
