...
{
    public class DescribeDomainViewTopUrlRequest : RpcAcsRequest<DescribeDomainViewTopUrlResponse>
    {
        public DescribeDomainViewTopUrlRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainViewTopUrl")
        {
        ...
        public override DescribeDomainViewTopUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainViewTopUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
