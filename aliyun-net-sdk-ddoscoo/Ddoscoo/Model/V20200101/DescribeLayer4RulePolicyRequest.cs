...
{
    public class DescribeLayer4RulePolicyRequest : RpcAcsRequest<DescribeLayer4RulePolicyResponse>
    {
        public DescribeLayer4RulePolicyRequest()
            : base("ddoscoo", "2020-01-01", "DescribeLayer4RulePolicy")
        {
        ...
        public override DescribeLayer4RulePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLayer4RulePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
