...
{
    public class DescribeWebAccessModeRequest : RpcAcsRequest<DescribeWebAccessModeResponse>
    {
        public DescribeWebAccessModeRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebAccessMode")
        {
        ...
        public override DescribeWebAccessModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebAccessModeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
