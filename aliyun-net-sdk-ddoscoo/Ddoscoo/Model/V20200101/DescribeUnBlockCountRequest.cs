...
{
    public class DescribeUnBlockCountRequest : RpcAcsRequest<DescribeUnBlockCountResponse>
    {
        public DescribeUnBlockCountRequest()
            : base("ddoscoo", "2020-01-01", "DescribeUnBlockCount")
        {
        ...
        public override DescribeUnBlockCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUnBlockCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
