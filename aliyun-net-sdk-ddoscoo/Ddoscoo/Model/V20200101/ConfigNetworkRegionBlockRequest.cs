...
{
    public class ConfigNetworkRegionBlockRequest : RpcAcsRequest<ConfigNetworkRegionBlockResponse>
    {
        public ConfigNetworkRegionBlockRequest()
            : base("ddoscoo", "2020-01-01", "ConfigNetworkRegionBlock")
        {
        ...
        public override ConfigNetworkRegionBlockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigNetworkRegionBlockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
