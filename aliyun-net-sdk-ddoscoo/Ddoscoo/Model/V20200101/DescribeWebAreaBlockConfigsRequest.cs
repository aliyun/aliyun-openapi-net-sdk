...
{
    public class DescribeWebAreaBlockConfigsRequest : RpcAcsRequest<DescribeWebAreaBlockConfigsResponse>
    {
        public DescribeWebAreaBlockConfigsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebAreaBlockConfigs")
        {
        ...
        public override DescribeWebAreaBlockConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebAreaBlockConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
