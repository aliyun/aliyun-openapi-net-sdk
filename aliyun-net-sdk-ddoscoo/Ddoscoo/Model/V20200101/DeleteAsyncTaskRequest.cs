...
{
    public class DeleteAsyncTaskRequest : RpcAcsRequest<DeleteAsyncTaskResponse>
    {
        public DeleteAsyncTaskRequest()
            : base("ddoscoo", "2020-01-01", "DeleteAsyncTask")
        {
        ...
        public override DeleteAsyncTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAsyncTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
