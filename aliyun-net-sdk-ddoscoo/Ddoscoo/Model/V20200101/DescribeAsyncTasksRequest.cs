...
{
    public class DescribeAsyncTasksRequest : RpcAcsRequest<DescribeAsyncTasksResponse>
    {
        public DescribeAsyncTasksRequest()
            : base("ddoscoo", "2020-01-01", "DescribeAsyncTasks")
        {
        ...
        public override DescribeAsyncTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAsyncTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
