...
{
    public class DescribePortAutoCcStatusRequest : RpcAcsRequest<DescribePortAutoCcStatusResponse>
    {
        public DescribePortAutoCcStatusRequest()
            : base("ddoscoo", "2020-01-01", "DescribePortAutoCcStatus")
        {
        ...
        public override DescribePortAutoCcStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePortAutoCcStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
