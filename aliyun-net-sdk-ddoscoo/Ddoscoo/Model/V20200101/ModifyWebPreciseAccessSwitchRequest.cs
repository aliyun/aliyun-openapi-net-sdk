...
{
    public class ModifyWebPreciseAccessSwitchRequest : RpcAcsRequest<ModifyWebPreciseAccessSwitchResponse>
    {
        public ModifyWebPreciseAccessSwitchRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebPreciseAccessSwitch")
        {
        ...
        public override ModifyWebPreciseAccessSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebPreciseAccessSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
