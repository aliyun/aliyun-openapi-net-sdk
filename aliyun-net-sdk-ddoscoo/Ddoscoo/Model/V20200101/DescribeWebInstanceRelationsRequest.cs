...
{
    public class DescribeWebInstanceRelationsRequest : RpcAcsRequest<DescribeWebInstanceRelationsResponse>
    {
        public DescribeWebInstanceRelationsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebInstanceRelations")
        {
        ...
        public override DescribeWebInstanceRelationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebInstanceRelationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
