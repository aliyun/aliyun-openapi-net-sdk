...
{
    public class DescribeDefenseRecordsRequest : RpcAcsRequest<DescribeDefenseRecordsResponse>
    {
        public DescribeDefenseRecordsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDefenseRecords")
        {
        ...
        public override DescribeDefenseRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDefenseRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
