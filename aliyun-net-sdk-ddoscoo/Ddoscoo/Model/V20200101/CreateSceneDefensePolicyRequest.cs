...
{
    public class CreateSceneDefensePolicyRequest : RpcAcsRequest<CreateSceneDefensePolicyResponse>
    {
        public CreateSceneDefensePolicyRequest()
            : base("ddoscoo", "2020-01-01", "CreateSceneDefensePolicy")
        {
        ...
        public override CreateSceneDefensePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSceneDefensePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
