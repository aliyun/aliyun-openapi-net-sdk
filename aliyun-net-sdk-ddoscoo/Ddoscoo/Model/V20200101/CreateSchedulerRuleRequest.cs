...
{
    public class CreateSchedulerRuleRequest : RpcAcsRequest<CreateSchedulerRuleResponse>
    {
        public CreateSchedulerRuleRequest()
            : base("ddoscoo", "2020-01-01", "CreateSchedulerRule")
        {
        ...
        public override CreateSchedulerRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSchedulerRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
