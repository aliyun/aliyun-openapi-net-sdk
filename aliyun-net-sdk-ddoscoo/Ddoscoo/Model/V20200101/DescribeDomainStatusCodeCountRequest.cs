...
{
    public class DescribeDomainStatusCodeCountRequest : RpcAcsRequest<DescribeDomainStatusCodeCountResponse>
    {
        public DescribeDomainStatusCodeCountRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainStatusCodeCount")
        {
        ...
        public override DescribeDomainStatusCodeCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainStatusCodeCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
