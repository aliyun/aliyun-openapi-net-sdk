...
{
    public class DescribeWebCCRulesRequest : RpcAcsRequest<DescribeWebCCRulesResponse>
    {
        public DescribeWebCCRulesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeWebCCRules")
        {
        ...
        public override DescribeWebCCRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeWebCCRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
