...
{
    public class CreateWebCCRuleRequest : RpcAcsRequest<CreateWebCCRuleResponse>
    {
        public CreateWebCCRuleRequest()
            : base("ddoscoo", "2020-01-01", "CreateWebCCRule")
        {
        ...
        public override CreateWebCCRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateWebCCRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
