...
{
    public class ModifyWebCacheCustomRuleRequest : RpcAcsRequest<ModifyWebCacheCustomRuleResponse>
    {
        public ModifyWebCacheCustomRuleRequest()
            : base("ddoscoo", "2020-01-01", "ModifyWebCacheCustomRule")
        {
        ...
        public override ModifyWebCacheCustomRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyWebCacheCustomRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
