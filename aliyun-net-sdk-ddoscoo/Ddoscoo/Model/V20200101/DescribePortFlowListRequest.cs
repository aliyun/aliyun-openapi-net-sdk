...
{
    public class DescribePortFlowListRequest : RpcAcsRequest<DescribePortFlowListResponse>
    {
        public DescribePortFlowListRequest()
            : base("ddoscoo", "2020-01-01", "DescribePortFlowList")
        {
        ...
        public override DescribePortFlowListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePortFlowListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
