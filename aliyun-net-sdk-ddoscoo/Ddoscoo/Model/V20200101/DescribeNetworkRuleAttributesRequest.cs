...
{
    public class DescribeNetworkRuleAttributesRequest : RpcAcsRequest<DescribeNetworkRuleAttributesResponse>
    {
        public DescribeNetworkRuleAttributesRequest()
            : base("ddoscoo", "2020-01-01", "DescribeNetworkRuleAttributes")
        {
		...
		public string NetworkRules
		{
			...
			{
				networkRules = value;
				DictionaryUtil.Add(QueryParameters, "NetworkRules", value);
			}
		}
        ...
        public override DescribeNetworkRuleAttributesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNetworkRuleAttributesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
