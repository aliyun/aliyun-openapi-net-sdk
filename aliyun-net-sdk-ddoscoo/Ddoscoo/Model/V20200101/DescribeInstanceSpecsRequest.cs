...
{
    public class DescribeInstanceSpecsRequest : RpcAcsRequest<DescribeInstanceSpecsResponse>
    {
        public DescribeInstanceSpecsRequest()
            : base("ddoscoo", "2020-01-01", "DescribeInstanceSpecs")
        {
        ...
        public override DescribeInstanceSpecsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceSpecsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
