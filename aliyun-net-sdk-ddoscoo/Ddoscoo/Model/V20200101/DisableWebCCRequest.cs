...
{
    public class DisableWebCCRequest : RpcAcsRequest<DisableWebCCResponse>
    {
        public DisableWebCCRequest()
            : base("ddoscoo", "2020-01-01", "DisableWebCC")
        {
        ...
        public override DisableWebCCResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableWebCCResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
