...
{
    public class DeleteWebRuleRequest : RpcAcsRequest<DeleteWebRuleResponse>
    {
        public DeleteWebRuleRequest()
            : base("ddoscoo", "2020-01-01", "DeleteWebRule")
        {
        ...
        public override DeleteWebRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteWebRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
