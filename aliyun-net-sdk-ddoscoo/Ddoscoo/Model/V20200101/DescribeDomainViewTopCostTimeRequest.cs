...
{
    public class DescribeDomainViewTopCostTimeRequest : RpcAcsRequest<DescribeDomainViewTopCostTimeResponse>
    {
        public DescribeDomainViewTopCostTimeRequest()
            : base("ddoscoo", "2020-01-01", "DescribeDomainViewTopCostTime")
        {
        ...
        public override DescribeDomainViewTopCostTimeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainViewTopCostTimeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
