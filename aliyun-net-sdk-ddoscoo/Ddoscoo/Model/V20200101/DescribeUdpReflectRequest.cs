...
{
    public class DescribeUdpReflectRequest : RpcAcsRequest<DescribeUdpReflectResponse>
    {
        public DescribeUdpReflectRequest()
            : base("ddoscoo", "2020-01-01", "DescribeUdpReflect")
        {
        ...
        public override DescribeUdpReflectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUdpReflectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
