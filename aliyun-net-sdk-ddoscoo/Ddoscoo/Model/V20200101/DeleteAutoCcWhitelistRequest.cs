...
{
    public class DeleteAutoCcWhitelistRequest : RpcAcsRequest<DeleteAutoCcWhitelistResponse>
    {
        public DeleteAutoCcWhitelistRequest()
            : base("ddoscoo", "2020-01-01", "DeleteAutoCcWhitelist")
        {
        ...
        public override DeleteAutoCcWhitelistResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAutoCcWhitelistResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
