...
{
    public class ModifyInstanceRemarkRequest : RpcAcsRequest<ModifyInstanceRemarkResponse>
    {
        public ModifyInstanceRemarkRequest()
            : base("ddoscoo", "2020-01-01", "ModifyInstanceRemark")
        {
        ...
        public override ModifyInstanceRemarkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyInstanceRemarkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
