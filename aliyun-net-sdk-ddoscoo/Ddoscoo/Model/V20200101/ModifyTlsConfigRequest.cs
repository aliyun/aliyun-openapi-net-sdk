...
{
    public class ModifyTlsConfigRequest : RpcAcsRequest<ModifyTlsConfigResponse>
    {
        public ModifyTlsConfigRequest()
            : base("ddoscoo", "2020-01-01", "ModifyTlsConfig")
        {
        ...
        public override ModifyTlsConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTlsConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
