...
{
    public class ScreenCRCRequest : RpcAcsRequest<ScreenCRCResponse>
    {
        public ScreenCRCRequest()
            : base("imageprocess", "2020-03-20", "ScreenCRC", "imageprocess", "openAPI")
        {
        ...
        public override ScreenCRCResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ScreenCRCResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
