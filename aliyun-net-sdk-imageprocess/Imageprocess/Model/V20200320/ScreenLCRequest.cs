...
{
    public class ScreenLCRequest : RpcAcsRequest<ScreenLCResponse>
    {
        public ScreenLCRequest()
            : base("imageprocess", "2020-03-20", "ScreenLC", "imageprocess", "openAPI")
        {
        ...
        public override ScreenLCResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ScreenLCResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
