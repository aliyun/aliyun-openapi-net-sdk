...
{
    public class DetectKneeKeypointXRayRequest : RpcAcsRequest<DetectKneeKeypointXRayResponse>
    {
        public DetectKneeKeypointXRayRequest()
            : base("imageprocess", "2020-03-20", "DetectKneeKeypointXRay", "imageprocess", "openAPI")
        {
        ...
        public override DetectKneeKeypointXRayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectKneeKeypointXRayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
