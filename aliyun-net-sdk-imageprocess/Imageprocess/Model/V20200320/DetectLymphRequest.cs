...
{
    public class DetectLymphRequest : RpcAcsRequest<DetectLymphResponse>
    {
        public DetectLymphRequest()
            : base("imageprocess", "2020-03-20", "DetectLymph", "imageprocess", "openAPI")
        {
        ...
        public override DetectLymphResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectLymphResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
