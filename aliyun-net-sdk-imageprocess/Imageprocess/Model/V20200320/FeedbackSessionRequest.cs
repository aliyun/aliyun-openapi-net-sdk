...
{
    public class FeedbackSessionRequest : RpcAcsRequest<FeedbackSessionResponse>
    {
        public FeedbackSessionRequest()
            : base("imageprocess", "2020-03-20", "FeedbackSession", "imageprocess", "openAPI")
        {
		...
		public string Feedback
		{
			...
			{
				feedback = value;
				DictionaryUtil.Add(BodyParameters, "Feedback", value);
			}
		}
        ...
        public override FeedbackSessionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FeedbackSessionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
