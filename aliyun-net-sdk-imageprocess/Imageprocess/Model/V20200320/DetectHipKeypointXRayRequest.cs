...
{
    public class DetectHipKeypointXRayRequest : RpcAcsRequest<DetectHipKeypointXRayResponse>
    {
        public DetectHipKeypointXRayRequest()
            : base("imageprocess", "2020-03-20", "DetectHipKeypointXRay", "imageprocess", "openAPI")
        {
        ...
        public override DetectHipKeypointXRayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectHipKeypointXRayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
