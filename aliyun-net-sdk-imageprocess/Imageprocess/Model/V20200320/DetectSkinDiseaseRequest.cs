...
{
    public class DetectSkinDiseaseRequest : RpcAcsRequest<DetectSkinDiseaseResponse>
    {
        public DetectSkinDiseaseRequest()
            : base("imageprocess", "2020-03-20", "DetectSkinDisease", "imageprocess", "openAPI")
        {
        ...
        public override DetectSkinDiseaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectSkinDiseaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
