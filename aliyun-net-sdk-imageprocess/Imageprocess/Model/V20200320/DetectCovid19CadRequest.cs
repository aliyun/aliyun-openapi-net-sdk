...
{
    public class DetectCovid19CadRequest : RpcAcsRequest<DetectCovid19CadResponse>
    {
        public DetectCovid19CadRequest()
            : base("imageprocess", "2020-03-20", "DetectCovid19Cad", "imageprocess", "openAPI")
        {
        ...
        public override DetectCovid19CadResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectCovid19CadResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
