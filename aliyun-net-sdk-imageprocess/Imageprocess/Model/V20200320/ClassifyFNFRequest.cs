...
{
    public class ClassifyFNFRequest : RpcAcsRequest<ClassifyFNFResponse>
    {
        public ClassifyFNFRequest()
            : base("imageprocess", "2020-03-20", "ClassifyFNF", "imageprocess", "openAPI")
        {
        ...
        public override ClassifyFNFResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ClassifyFNFResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
