...
{
    public class DetectSpineMRIRequest : RpcAcsRequest<DetectSpineMRIResponse>
    {
        public DetectSpineMRIRequest()
            : base("imageprocess", "2020-03-20", "DetectSpineMRI", "imageprocess", "openAPI")
        {
        ...
        public override DetectSpineMRIResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectSpineMRIResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
