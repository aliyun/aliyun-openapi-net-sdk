...
{
    public class DetectRibFractureRequest : RpcAcsRequest<DetectRibFractureResponse>
    {
        public DetectRibFractureRequest()
            : base("imageprocess", "2020-03-20", "DetectRibFracture", "imageprocess", "openAPI")
        {
        ...
        public override DetectRibFractureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectRibFractureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
