...
{
    public class ScreenECRequest : RpcAcsRequest<ScreenECResponse>
    {
        public ScreenECRequest()
            : base("imageprocess", "2020-03-20", "ScreenEC", "imageprocess", "openAPI")
        {
        ...
        public override ScreenECResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ScreenECResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
