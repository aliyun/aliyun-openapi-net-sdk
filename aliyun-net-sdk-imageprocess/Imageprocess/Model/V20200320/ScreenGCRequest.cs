...
{
    public class ScreenGCRequest : RpcAcsRequest<ScreenGCResponse>
    {
        public ScreenGCRequest()
            : base("imageprocess", "2020-03-20", "ScreenGC", "imageprocess", "openAPI")
        {
        ...
        public override ScreenGCResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ScreenGCResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
