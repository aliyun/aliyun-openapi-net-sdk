...
{
    public class SegmentOARRequest : RpcAcsRequest<SegmentOARResponse>
    {
        public SegmentOARRequest()
            : base("imageprocess", "2020-03-20", "SegmentOAR", "imageprocess", "openAPI")
        {
		...
		private List<string> maskLists = new List<string>(){ };
		...
		public bool? Contrast
		{
			...
			{
				contrast = value;
				DictionaryUtil.Add(BodyParameters, "Contrast", value.ToString());
			}
		}

		public List<string> MaskLists
		{
			get
			{
				return maskLists;
        ...
        public override SegmentOARResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SegmentOARResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
