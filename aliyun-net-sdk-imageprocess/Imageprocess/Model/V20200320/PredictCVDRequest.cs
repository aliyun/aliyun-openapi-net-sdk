...
{
    public class PredictCVDRequest : RpcAcsRequest<PredictCVDResponse>
    {
        public PredictCVDRequest()
            : base("imageprocess", "2020-03-20", "PredictCVD", "imageprocess", "openAPI")
        {
        ...
        public override PredictCVDResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PredictCVDResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
