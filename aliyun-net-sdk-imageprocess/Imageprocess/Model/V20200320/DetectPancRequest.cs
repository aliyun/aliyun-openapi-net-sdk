...
{
    public class DetectPancRequest : RpcAcsRequest<DetectPancResponse>
    {
        public DetectPancRequest()
            : base("imageprocess", "2020-03-20", "DetectPanc", "imageprocess", "openAPI")
        {
        ...
        public override DetectPancResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectPancResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
