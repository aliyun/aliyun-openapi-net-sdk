...
{
    public class AnalyzeChestVesselRequest : RpcAcsRequest<AnalyzeChestVesselResponse>
    {
        public AnalyzeChestVesselRequest()
            : base("imageprocess", "2020-03-20", "AnalyzeChestVessel", "imageprocess", "openAPI")
        {
        ...
        public override AnalyzeChestVesselResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AnalyzeChestVesselResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
