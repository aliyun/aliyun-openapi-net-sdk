...
{
    public class TargetVolumeSegmentRequest : RpcAcsRequest<TargetVolumeSegmentResponse>
    {
        public TargetVolumeSegmentRequest()
            : base("imageprocess", "2020-03-20", "TargetVolumeSegment", "imageprocess", "openAPI")
        {
		...
		public string CancerType
		{
			...
			{
				cancerType = value;
				DictionaryUtil.Add(BodyParameters, "CancerType", value);
			}
		}
		...
		public string TargetVolumeType
		{
			...
			set	
			{
				targetVolumeType = value;
				DictionaryUtil.Add(BodyParameters, "TargetVolumeType", value);
			}
		}
        ...
        public override TargetVolumeSegmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TargetVolumeSegmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
