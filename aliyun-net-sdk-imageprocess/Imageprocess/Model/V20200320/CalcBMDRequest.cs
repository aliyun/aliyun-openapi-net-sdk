...
{
    public class CalcBMDRequest : RpcAcsRequest<CalcBMDResponse>
    {
        public CalcBMDRequest()
            : base("imageprocess", "2020-03-20", "CalcBMD", "imageprocess", "openAPI")
        {
        ...
        public override CalcBMDResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CalcBMDResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
