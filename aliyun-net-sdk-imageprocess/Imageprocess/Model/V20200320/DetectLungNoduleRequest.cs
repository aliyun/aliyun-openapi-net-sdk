...
{
    public class DetectLungNoduleRequest : RpcAcsRequest<DetectLungNoduleResponse>
    {
        public DetectLungNoduleRequest()
            : base("imageprocess", "2020-03-20", "DetectLungNodule", "imageprocess", "openAPI")
        {
        ...
        public override DetectLungNoduleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectLungNoduleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
