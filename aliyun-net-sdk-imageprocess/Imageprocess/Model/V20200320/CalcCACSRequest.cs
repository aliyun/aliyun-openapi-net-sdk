...
{
    public class CalcCACSRequest : RpcAcsRequest<CalcCACSResponse>
    {
        public CalcCACSRequest()
            : base("imageprocess", "2020-03-20", "CalcCACS", "imageprocess", "openAPI")
        {
        ...
        public override CalcCACSResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CalcCACSResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
