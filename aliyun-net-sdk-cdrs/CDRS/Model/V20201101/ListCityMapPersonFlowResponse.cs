...
{
	public class ListCityMapPersonFlowResponse : AcsResponse
	{
		...
		private List<ListCityMapPersonFlow_Datas> data;
		...
		public List<ListCityMapPersonFlow_Datas> Data
		{
			get
			{
				return data;
		...
		public class ListCityMapPersonFlow_Datas
		{
