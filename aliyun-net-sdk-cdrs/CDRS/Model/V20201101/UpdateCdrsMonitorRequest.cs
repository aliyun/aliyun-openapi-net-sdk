...
{
    public class UpdateCdrsMonitorRequest : RpcAcsRequest<UpdateCdrsMonitorResponse>
    {
        public UpdateCdrsMonitorRequest()
            : base("CDRS", "2020-11-01", "UpdateCdrsMonitor")
        {
        ...
        public override UpdateCdrsMonitorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCdrsMonitorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
