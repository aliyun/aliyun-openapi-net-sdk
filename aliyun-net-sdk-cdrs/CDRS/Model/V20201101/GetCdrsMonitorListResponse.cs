...
{
	public class GetCdrsMonitorListResponse : AcsResponse
	{
		...
		private GetCdrsMonitorList_Data data;
		...
		public GetCdrsMonitorList_Data Data
		{
			get
			{
				return data;
		...
		public class GetCdrsMonitorList_Data
		{
			...
			private List<GetCdrsMonitorList_Record> records;
			...
			public List<GetCdrsMonitorList_Record> Records
			{
				get
				{
					return records;
			...
			public class GetCdrsMonitorList_Record
			{
