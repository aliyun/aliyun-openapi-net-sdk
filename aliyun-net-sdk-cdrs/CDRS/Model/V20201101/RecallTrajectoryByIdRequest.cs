...
{
    public class RecallTrajectoryByIdRequest : RpcAcsRequest<RecallTrajectoryByIdResponse>
    {
        public RecallTrajectoryByIdRequest()
            : base("CDRS", "2020-11-01", "RecallTrajectoryById")
        {
        ...
        public override RecallTrajectoryByIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecallTrajectoryByIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
