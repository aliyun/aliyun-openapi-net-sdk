...
{
    public class StopCdrsMonitorRequest : RpcAcsRequest<StopCdrsMonitorResponse>
    {
        public StopCdrsMonitorRequest()
            : base("CDRS", "2020-11-01", "StopCdrsMonitor")
        {
        ...
        public override StopCdrsMonitorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopCdrsMonitorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
