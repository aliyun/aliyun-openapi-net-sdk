...
{
	public class ListPersonTraceResponse : AcsResponse
	{
		...
		private List<ListPersonTrace_DataItem> data;
		...
		public List<ListPersonTrace_DataItem> Data
		{
			get
			{
				return data;
		...
		public class ListPersonTrace_DataItem
		{
