...
{
    public class ValidateTrajectoryRequest : RpcAcsRequest<ValidateTrajectoryResponse>
    {
        public ValidateTrajectoryRequest()
            : base("CDRS", "2020-11-01", "ValidateTrajectory")
        {
        ...
        public override ValidateTrajectoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ValidateTrajectoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
