...
namespace Aliyun.Acs.EHPC.Model.V20170714
{
    public class EditJobTemplateRequest : RpcAcsRequest<EditJobTemplateResponse>
    {
        public EditJobTemplateRequest()
            : base("EHPC", "2017-07-14", "EditJobTemplate", "ehs", "openAPI")
        {
        }
		...
		public bool? ReRunnable
		{
			...
			{
				reRunnable = value;
				DictionaryUtil.Add(QueryParameters, "ReRunnable", value.ToString());
			}
		}
        ...
        public override EditJobTemplateResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
