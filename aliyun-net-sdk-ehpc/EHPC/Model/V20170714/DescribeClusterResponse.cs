...
namespace Aliyun.Acs.EHPC.Model.V20170714
{
	public class DescribeClusterResponse : AcsResponse
	{
		...
		public class DescribeCluster_ClusterInfo
		{
			...
			private List<DescribeCluster_ApplicationInfoItem> applicationInfo;
			...
			public List<DescribeCluster_ApplicationInfoItem> ApplicationInfo
			{
				get
				{
			...
			public class DescribeCluster_ApplicationInfoItem
			{
