...
namespace Aliyun.Acs.EHPC.Model.V20170714
{
    public class ListPreferredEcsTypesRequest : RpcAcsRequest<ListPreferredEcsTypesResponse>
    {
        public ListPreferredEcsTypesRequest()
            : base("EHPC", "2017-07-14", "ListPreferredEcsTypes", "ehs", "openAPI")
        {
        }
        ...
        public override ListPreferredEcsTypesResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
