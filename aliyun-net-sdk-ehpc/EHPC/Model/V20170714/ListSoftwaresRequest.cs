...
namespace Aliyun.Acs.EHPC.Model.V20170714
{
    public class ListSoftwaresRequest : RpcAcsRequest<ListSoftwaresResponse>
    {
        public ListSoftwaresRequest()
            : base("EHPC", "2017-07-14", "ListSoftwares", "ehs", "openAPI")
        {
        }
        ...
        public override ListSoftwaresResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
