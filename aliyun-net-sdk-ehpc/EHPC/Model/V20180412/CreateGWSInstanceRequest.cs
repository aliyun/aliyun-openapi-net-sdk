...
{
    public class CreateGWSInstanceRequest : RpcAcsRequest<CreateGWSInstanceResponse>
    {
        public CreateGWSInstanceRequest()
            : base("EHPC", "2018-04-12", "CreateGWSInstance", "ehs", "openAPI")
        {
        }
		...
		public string AppList
		{
			...
			{
				appList = value;
				DictionaryUtil.Add(QueryParameters, "AppList", value);
			}
		}
        ...
        public override CreateGWSInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateGWSInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
