...
{
    public class CheckTrademarkOrderRequest : RpcAcsRequest<CheckTrademarkOrderResponse>
    {
        public CheckTrademarkOrderRequest()
            : base("Trademark", "2018-07-24", "CheckTrademarkOrder", "trademark", "openAPI")
        {
        ...
        public override CheckTrademarkOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckTrademarkOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
