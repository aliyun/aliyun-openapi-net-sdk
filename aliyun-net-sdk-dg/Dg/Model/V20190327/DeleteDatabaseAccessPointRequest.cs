...
{
    public class DeleteDatabaseAccessPointRequest : RpcAcsRequest<DeleteDatabaseAccessPointResponse>
    {
        public DeleteDatabaseAccessPointRequest()
            : base("dg", "2019-03-27", "DeleteDatabaseAccessPoint", "dg", "openAPI")
        {
        ...
        public override DeleteDatabaseAccessPointResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDatabaseAccessPointResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
