...
{
    public class DeleteGatewayInstanceRequest : RpcAcsRequest<DeleteGatewayInstanceResponse>
    {
        public DeleteGatewayInstanceRequest()
            : base("dg", "2019-03-27", "DeleteGatewayInstance", "dg", "openAPI")
        {
        ...
        public override DeleteGatewayInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGatewayInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
