...
{
    public class ModifyGatewayRequest : RpcAcsRequest<ModifyGatewayResponse>
    {
        public ModifyGatewayRequest()
            : base("dg", "2019-03-27", "ModifyGateway", "dg", "openAPI")
        {
		...
		public string GatewayDesc
		{
			...
			{
				gatewayDesc = value;
				DictionaryUtil.Add(BodyParameters, "GatewayDesc", value);
			}
		}
		...
		public string GatewayName
		{
			...
			{
				gatewayName = value;
				DictionaryUtil.Add(BodyParameters, "GatewayName", value);
			}
		}
        ...
        public override ModifyGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
