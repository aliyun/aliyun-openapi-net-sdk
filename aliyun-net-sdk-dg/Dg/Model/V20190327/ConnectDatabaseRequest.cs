...
{
    public class ConnectDatabaseRequest : RpcAcsRequest<ConnectDatabaseResponse>
    {
        public ConnectDatabaseRequest()
            : base("dg", "2019-03-27", "ConnectDatabase", "dg", "openAPI")
        {
        ...
        public override ConnectDatabaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConnectDatabaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
