...
{
    public class FindUserGatewayByIdRequest : RpcAcsRequest<FindUserGatewayByIdResponse>
    {
        public FindUserGatewayByIdRequest()
            : base("dg", "2019-03-27", "FindUserGatewayById", "dg", "openAPI")
        {
        ...
        public override FindUserGatewayByIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FindUserGatewayByIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
