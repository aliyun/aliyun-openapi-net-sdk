...
{
    public class GetUserGatewayInstancesRequest : RpcAcsRequest<GetUserGatewayInstancesResponse>
    {
        public GetUserGatewayInstancesRequest()
            : base("dg", "2019-03-27", "GetUserGatewayInstances", "dg", "openAPI")
        {
        ...
        public override GetUserGatewayInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserGatewayInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
