...
{
    public class CreateGatewayVerifyCodeRequest : RpcAcsRequest<CreateGatewayVerifyCodeResponse>
    {
        public CreateGatewayVerifyCodeRequest()
            : base("dg", "2019-03-27", "CreateGatewayVerifyCode", "dg", "openAPI")
        {
        ...
        public override CreateGatewayVerifyCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateGatewayVerifyCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
