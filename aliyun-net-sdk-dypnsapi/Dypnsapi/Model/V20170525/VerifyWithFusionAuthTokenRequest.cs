...
{
    public class VerifyWithFusionAuthTokenRequest : RpcAcsRequest<VerifyWithFusionAuthTokenResponse>
    {
        public VerifyWithFusionAuthTokenRequest()
            : base("Dypnsapi", "2017-05-25", "VerifyWithFusionAuthToken", "dypnsapi", "openAPI")
        {
        ...
        public override VerifyWithFusionAuthTokenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyWithFusionAuthTokenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
