...
{
    public class GetStackGroupRequest : RpcAcsRequest<GetStackGroupResponse>
    {
        public GetStackGroupRequest()
            : base("ROS", "2019-09-10", "GetStackGroup", "ros", "openAPI")
        {
        ...
        public override GetStackGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStackGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
