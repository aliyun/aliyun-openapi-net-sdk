...
{
    public class GetStackDriftDetectionStatusRequest : RpcAcsRequest<GetStackDriftDetectionStatusResponse>
    {
        public GetStackDriftDetectionStatusRequest()
            : base("ROS", "2019-09-10", "GetStackDriftDetectionStatus", "ros", "openAPI")
        {
		...
		public string DriftDetectionId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "DriftDetectionId", value);
			}
		}
        ...
        public override GetStackDriftDetectionStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStackDriftDetectionStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
