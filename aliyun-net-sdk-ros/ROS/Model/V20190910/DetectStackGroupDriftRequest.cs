...
{
    public class DetectStackGroupDriftRequest : RpcAcsRequest<DetectStackGroupDriftResponse>
    {
        public DetectStackGroupDriftRequest()
            : base("ROS", "2019-09-10", "DetectStackGroupDrift", "ros", "openAPI")
        {
		...
		public string OperationPreferences
		{
			get
			{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "OperationPreferences", value);
			}
		}
        ...
        public override DetectStackGroupDriftResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectStackGroupDriftResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
