...
namespace Aliyun.Acs.ROS.Model.V20190910
{
    public class DeleteStackGroupRequest : RpcAcsRequest<DeleteStackGroupResponse>
    {
        ...
        public override DeleteStackGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteStackGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
