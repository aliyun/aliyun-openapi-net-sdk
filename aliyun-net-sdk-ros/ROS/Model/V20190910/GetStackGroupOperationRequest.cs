...
{
    public class GetStackGroupOperationRequest : RpcAcsRequest<GetStackGroupOperationResponse>
    {
        public GetStackGroupOperationRequest()
            : base("ROS", "2019-09-10", "GetStackGroupOperation", "ros", "openAPI")
        {
        ...
        public override GetStackGroupOperationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStackGroupOperationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
