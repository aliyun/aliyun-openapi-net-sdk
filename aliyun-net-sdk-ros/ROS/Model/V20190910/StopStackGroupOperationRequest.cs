...
{
    public class StopStackGroupOperationRequest : RpcAcsRequest<StopStackGroupOperationResponse>
    {
        public StopStackGroupOperationRequest()
            : base("ROS", "2019-09-10", "StopStackGroupOperation", "ros", "openAPI")
        {
        ...
        public override StopStackGroupOperationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopStackGroupOperationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
