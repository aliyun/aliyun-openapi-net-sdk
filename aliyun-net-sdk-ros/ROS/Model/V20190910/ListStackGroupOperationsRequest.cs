...
{
    public class ListStackGroupOperationsRequest : RpcAcsRequest<ListStackGroupOperationsResponse>
    {
        public ListStackGroupOperationsRequest()
            : base("ROS", "2019-09-10", "ListStackGroupOperations", "ros", "openAPI")
        {
        ...
        public override ListStackGroupOperationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListStackGroupOperationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
