...
{
    public class ListStackGroupOperationResultsRequest : RpcAcsRequest<ListStackGroupOperationResultsResponse>
    {
        public ListStackGroupOperationResultsRequest()
            : base("ROS", "2019-09-10", "ListStackGroupOperationResults", "ros", "openAPI")
        {
        ...
        public override ListStackGroupOperationResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListStackGroupOperationResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
