...
{
    public class UpdateStackInstancesRequest : RpcAcsRequest<UpdateStackInstancesResponse>
    {
        public UpdateStackInstancesRequest()
            : base("ROS", "2019-09-10", "UpdateStackInstances", "ros", "openAPI")
        {
        ...
        public override UpdateStackInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateStackInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
