...
{
    public class GenerateTemplatePolicyRequest : RpcAcsRequest<GenerateTemplatePolicyResponse>
    {
        public GenerateTemplatePolicyRequest()
            : base("ROS", "2019-09-10", "GenerateTemplatePolicy", "ros", "openAPI")
        {
        ...
        public override GenerateTemplatePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateTemplatePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
