...
{
    public class DeleteRepositoryTagRequest : RoaAcsRequest<DeleteRepositoryTagResponse>
    {
        public DeleteRepositoryTagRequest()
            : base("codeup", "2020-04-14", "DeleteRepositoryTag")
        {
        ...
        public override DeleteRepositoryTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepositoryTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
