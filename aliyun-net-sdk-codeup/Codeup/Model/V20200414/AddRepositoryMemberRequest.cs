...
{
    public class AddRepositoryMemberRequest : RoaAcsRequest<AddRepositoryMemberResponse>
    {
        public AddRepositoryMemberRequest()
            : base("codeup", "2020-04-14", "AddRepositoryMember")
        {
			UriPattern = "/api/v4/projects/[ProjectId]/members";
        ...
        public override AddRepositoryMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddRepositoryMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
