...
{
    public class AddGroupMemberRequest : RoaAcsRequest<AddGroupMemberResponse>
    {
        public AddGroupMemberRequest()
            : base("codeup", "2020-04-14", "AddGroupMember")
        {
			UriPattern = "/api/v4/groups/[GroupId]/members";
        ...
        public override AddGroupMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddGroupMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
