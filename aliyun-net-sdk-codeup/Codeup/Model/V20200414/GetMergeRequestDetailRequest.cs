...
{
    public class GetMergeRequestDetailRequest : RoaAcsRequest<GetMergeRequestDetailResponse>
    {
        public GetMergeRequestDetailRequest()
            : base("codeup", "2020-04-14", "GetMergeRequestDetail")
        {
			UriPattern = "/api/v4/projects/[ProjectId]/merge_request/[MergeRequestId]";
        ...
        public override GetMergeRequestDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMergeRequestDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
