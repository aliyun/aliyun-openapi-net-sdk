...
{
    public class CreateMergeRequestCommentRequest : RoaAcsRequest<CreateMergeRequestCommentResponse>
    {
        public CreateMergeRequestCommentRequest()
            : base("codeup", "2020-04-14", "CreateMergeRequestComment")
        {
        ...
        public override CreateMergeRequestCommentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMergeRequestCommentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
