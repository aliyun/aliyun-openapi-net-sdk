...
{
    public class GetFileBlobsRequest : RoaAcsRequest<GetFileBlobsResponse>
    {
        public GetFileBlobsRequest()
            : base("codeup", "2020-04-14", "GetFileBlobs")
        {
			UriPattern = "/api/v4/projects/[ProjectId]/repository/blobs";
		...
		public string _Ref
		{
			...
			{
				_ref = value;
				DictionaryUtil.Add(QueryParameters, "Ref", value);
			}
		}
        ...
        public override GetFileBlobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFileBlobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
