...
{
    public class DeleteGroupMemberRequest : RoaAcsRequest<DeleteGroupMemberResponse>
    {
        public DeleteGroupMemberRequest()
            : base("codeup", "2020-04-14", "DeleteGroupMember")
        {
        ...
        public override DeleteGroupMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGroupMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
