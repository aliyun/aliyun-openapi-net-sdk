...
{
    public class ListRepositoryTreeRequest : RoaAcsRequest<ListRepositoryTreeResponse>
    {
        public ListRepositoryTreeRequest()
            : base("codeup", "2020-04-14", "ListRepositoryTree")
        {
			UriPattern = "/api/v4/projects/[ProjectId]/repository/tree";
        ...
        public override ListRepositoryTreeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRepositoryTreeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
