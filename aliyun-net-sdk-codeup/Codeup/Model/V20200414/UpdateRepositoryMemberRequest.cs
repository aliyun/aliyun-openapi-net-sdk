...
{
    public class UpdateRepositoryMemberRequest : RoaAcsRequest<UpdateRepositoryMemberResponse>
    {
        public UpdateRepositoryMemberRequest()
            : base("codeup", "2020-04-14", "UpdateRepositoryMember")
        {
        ...
        public override UpdateRepositoryMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRepositoryMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
