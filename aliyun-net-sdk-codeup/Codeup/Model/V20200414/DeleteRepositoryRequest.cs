...
{
    public class DeleteRepositoryRequest : RoaAcsRequest<DeleteRepositoryResponse>
    {
        ...
        public override DeleteRepositoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepositoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
