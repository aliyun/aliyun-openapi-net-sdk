...
{
    public class UpdateMergeRequestRequest : RoaAcsRequest<UpdateMergeRequestResponse>
    {
        public UpdateMergeRequestRequest()
            : base("codeup", "2020-04-14", "UpdateMergeRequest")
        {
			UriPattern = "/api/v3/projects/[ProjectId]/merge_request/[MergeRequestId]";
        ...
        public override UpdateMergeRequestResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateMergeRequestResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
