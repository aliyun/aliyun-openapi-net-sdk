...
{
    public class ListGroupMemberRequest : RoaAcsRequest<ListGroupMemberResponse>
    {
        public ListGroupMemberRequest()
            : base("codeup", "2020-04-14", "ListGroupMember")
        {
			UriPattern = "/api/v3/groups/[GroupId]/members";
        ...
        public override ListGroupMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListGroupMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
