...
{
    public class DeleteRepositoryMemberRequest : RoaAcsRequest<DeleteRepositoryMemberResponse>
    {
        public DeleteRepositoryMemberRequest()
            : base("codeup", "2020-04-14", "DeleteRepositoryMember")
        {
        ...
        public override DeleteRepositoryMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRepositoryMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
