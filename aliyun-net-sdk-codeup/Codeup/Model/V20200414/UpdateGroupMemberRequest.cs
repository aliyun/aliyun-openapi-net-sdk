...
{
    public class UpdateGroupMemberRequest : RoaAcsRequest<UpdateGroupMemberResponse>
    {
        public UpdateGroupMemberRequest()
            : base("codeup", "2020-04-14", "UpdateGroupMember")
        {
			UriPattern = "/api/v3/groups/[GroupId]/members/[UserId]";
        ...
        public override UpdateGroupMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateGroupMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
