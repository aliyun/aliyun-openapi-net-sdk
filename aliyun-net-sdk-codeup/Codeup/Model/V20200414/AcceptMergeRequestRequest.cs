...
{
    public class AcceptMergeRequestRequest : RoaAcsRequest<AcceptMergeRequestResponse>
    {
        public AcceptMergeRequestRequest()
            : base("codeup", "2020-04-14", "AcceptMergeRequest")
        {
			UriPattern = "/api/v3/projects/[ProjectId]/merge_request/[MergeRequestId]/accept";
        ...
        public override AcceptMergeRequestResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AcceptMergeRequestResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
