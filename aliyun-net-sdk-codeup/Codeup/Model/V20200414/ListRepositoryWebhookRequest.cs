...
{
    public class ListRepositoryWebhookRequest : RoaAcsRequest<ListRepositoryWebhookResponse>
    {
        public ListRepositoryWebhookRequest()
            : base("codeup", "2020-04-14", "ListRepositoryWebhook")
        {
        ...
        public override ListRepositoryWebhookResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRepositoryWebhookResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
