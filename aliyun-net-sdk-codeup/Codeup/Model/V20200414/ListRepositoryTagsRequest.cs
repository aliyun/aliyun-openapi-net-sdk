...
{
    public class ListRepositoryTagsRequest : RoaAcsRequest<ListRepositoryTagsResponse>
    {
        public ListRepositoryTagsRequest()
            : base("codeup", "2020-04-14", "ListRepositoryTags")
        {
			UriPattern = "/api/v4/projects/[ProjectId]/repository/tags";
        ...
        public override ListRepositoryTagsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRepositoryTagsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
