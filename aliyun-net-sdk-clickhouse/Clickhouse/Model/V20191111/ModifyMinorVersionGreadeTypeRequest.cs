...
{
    public class ModifyMinorVersionGreadeTypeRequest : RpcAcsRequest<ModifyMinorVersionGreadeTypeResponse>
    {
        public ModifyMinorVersionGreadeTypeRequest()
            : base("clickhouse", "2019-11-11", "ModifyMinorVersionGreadeType", "service", "openAPI")
        {
		...
		public bool? MaintainAutoType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MaintainAutoType", value.ToString());
			}
		}
        ...
        public override ModifyMinorVersionGreadeTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMinorVersionGreadeTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
