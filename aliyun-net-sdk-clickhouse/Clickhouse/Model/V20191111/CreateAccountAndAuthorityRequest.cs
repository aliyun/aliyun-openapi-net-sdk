...
{
    public class CreateAccountAndAuthorityRequest : RpcAcsRequest<CreateAccountAndAuthorityResponse>
    {
        public CreateAccountAndAuthorityRequest()
            : base("clickhouse", "2019-11-11", "CreateAccountAndAuthority", "service", "openAPI")
        {
        ...
        public override CreateAccountAndAuthorityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateAccountAndAuthorityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
