...
{
    public class DescribeDBClusterConfigRequest : RpcAcsRequest<DescribeDBClusterConfigResponse>
    {
        public DescribeDBClusterConfigRequest()
            : base("clickhouse", "2019-11-11", "DescribeDBClusterConfig", "service", "openAPI")
        {
        ...
        public override DescribeDBClusterConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBClusterConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
