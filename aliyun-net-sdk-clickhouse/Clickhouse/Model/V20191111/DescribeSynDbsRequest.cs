...
{
    public class DescribeSynDbsRequest : RpcAcsRequest<DescribeSynDbsResponse>
    {
        public DescribeSynDbsRequest()
            : base("clickhouse", "2019-11-11", "DescribeSynDbs", "service", "openAPI")
        {
        ...
        public override DescribeSynDbsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSynDbsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
