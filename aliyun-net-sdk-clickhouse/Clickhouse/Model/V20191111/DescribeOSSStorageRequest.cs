...
{
    public class DescribeOSSStorageRequest : RpcAcsRequest<DescribeOSSStorageResponse>
    {
        public DescribeOSSStorageRequest()
            : base("clickhouse", "2019-11-11", "DescribeOSSStorage", "service", "openAPI")
        {
        ...
        public override DescribeOSSStorageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOSSStorageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
