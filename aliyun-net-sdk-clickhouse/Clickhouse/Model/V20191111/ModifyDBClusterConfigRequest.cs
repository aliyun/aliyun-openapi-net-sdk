...
{
    public class ModifyDBClusterConfigRequest : RpcAcsRequest<ModifyDBClusterConfigResponse>
    {
        public ModifyDBClusterConfigRequest()
            : base("clickhouse", "2019-11-11", "ModifyDBClusterConfig", "service", "openAPI")
        {
		...
		public string UserConfig
		{
			...
			{
				userConfig = value;
				DictionaryUtil.Add(QueryParameters, "UserConfig", value);
			}
		}
        ...
        public override ModifyDBClusterConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
