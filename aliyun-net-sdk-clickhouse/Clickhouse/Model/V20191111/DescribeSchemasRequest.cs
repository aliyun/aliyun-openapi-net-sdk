...
{
    public class DescribeSchemasRequest : RpcAcsRequest<DescribeSchemasResponse>
    {
        public DescribeSchemasRequest()
            : base("clickhouse", "2019-11-11", "DescribeSchemas", "service", "openAPI")
        {
        ...
        public override DescribeSchemasResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSchemasResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
