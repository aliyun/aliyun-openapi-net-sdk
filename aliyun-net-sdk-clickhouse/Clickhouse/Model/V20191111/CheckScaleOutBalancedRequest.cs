...
{
    public class CheckScaleOutBalancedRequest : RpcAcsRequest<CheckScaleOutBalancedResponse>
    {
        public CheckScaleOutBalancedRequest()
            : base("clickhouse", "2019-11-11", "CheckScaleOutBalanced", "service", "openAPI")
        {
        ...
        public override CheckScaleOutBalancedResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckScaleOutBalancedResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
