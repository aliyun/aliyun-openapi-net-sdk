...
{
    public class DescribeTransferHistoryRequest : RpcAcsRequest<DescribeTransferHistoryResponse>
    {
        public DescribeTransferHistoryRequest()
            : base("clickhouse", "2019-11-11", "DescribeTransferHistory", "service", "openAPI")
        {
        ...
        public override DescribeTransferHistoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTransferHistoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
