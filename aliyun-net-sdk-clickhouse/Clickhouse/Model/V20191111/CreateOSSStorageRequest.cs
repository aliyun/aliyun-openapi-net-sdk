...
{
    public class CreateOSSStorageRequest : RpcAcsRequest<CreateOSSStorageResponse>
    {
        public CreateOSSStorageRequest()
            : base("clickhouse", "2019-11-11", "CreateOSSStorage", "service", "openAPI")
        {
        ...
        public override CreateOSSStorageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateOSSStorageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
