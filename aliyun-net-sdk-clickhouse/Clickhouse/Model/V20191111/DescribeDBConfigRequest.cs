...
{
    public class DescribeDBConfigRequest : RpcAcsRequest<DescribeDBConfigResponse>
    {
        public DescribeDBConfigRequest()
            : base("clickhouse", "2019-11-11", "DescribeDBConfig", "service", "openAPI")
        {
        ...
        public override DescribeDBConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
