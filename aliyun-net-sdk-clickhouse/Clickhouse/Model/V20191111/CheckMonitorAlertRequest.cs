...
{
    public class CheckMonitorAlertRequest : RpcAcsRequest<CheckMonitorAlertResponse>
    {
        public CheckMonitorAlertRequest()
            : base("clickhouse", "2019-11-11", "CheckMonitorAlert", "service", "openAPI")
        {
        ...
        public override CheckMonitorAlertResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckMonitorAlertResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
