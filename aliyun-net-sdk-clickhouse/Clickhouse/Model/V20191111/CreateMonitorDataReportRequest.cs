...
{
    public class CreateMonitorDataReportRequest : RpcAcsRequest<CreateMonitorDataReportResponse>
    {
        public CreateMonitorDataReportRequest()
            : base("clickhouse", "2019-11-11", "CreateMonitorDataReport", "service", "openAPI")
        {
        ...
        public override CreateMonitorDataReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMonitorDataReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
