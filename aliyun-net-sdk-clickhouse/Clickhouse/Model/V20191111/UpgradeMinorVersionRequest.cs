...
namespace Aliyun.Acs.clickhouse.Model.V20191111
{
    public class UpgradeMinorVersionRequest : RpcAcsRequest<UpgradeMinorVersionResponse>
    {
        public UpgradeMinorVersionRequest()
            : base("clickhouse", "2019-11-11", "UpgradeMinorVersion", "service", "openAPI")
        {
		...
		private bool? upgradeImmediately;
		...
		public bool? UpgradeImmediately
		{
			get
			{
			...
			set	
			{
				upgradeImmediately = value;
				DictionaryUtil.Add(QueryParameters, "UpgradeImmediately", value.ToString());
			}
		}
		...
		public string UpgradeVersion
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "UpgradeVersion", value);
			}
		}
