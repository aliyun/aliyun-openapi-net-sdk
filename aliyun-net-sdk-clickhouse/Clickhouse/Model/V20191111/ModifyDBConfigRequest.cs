...
{
    public class ModifyDBConfigRequest : RpcAcsRequest<ModifyDBConfigResponse>
    {
        public ModifyDBConfigRequest()
            : base("clickhouse", "2019-11-11", "ModifyDBConfig", "service", "openAPI")
        {
        ...
        public override ModifyDBConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
