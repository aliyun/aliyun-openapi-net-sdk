...
{
    public class CreateRDSToClickhouseDbRequest : RpcAcsRequest<CreateRDSToClickhouseDbResponse>
    {
        public CreateRDSToClickhouseDbRequest()
            : base("clickhouse", "2019-11-11", "CreateRDSToClickhouseDb", "service", "openAPI")
        {
		...
		public string SynDbTables
		{
			...
			{
				synDbTables = value;
				DictionaryUtil.Add(QueryParameters, "SynDbTables", value);
			}
		}
        ...
        public override CreateRDSToClickhouseDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRDSToClickhouseDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
