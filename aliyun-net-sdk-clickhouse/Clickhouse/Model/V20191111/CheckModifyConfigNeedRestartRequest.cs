...
{
    public class CheckModifyConfigNeedRestartRequest : RpcAcsRequest<CheckModifyConfigNeedRestartResponse>
    {
        public CheckModifyConfigNeedRestartRequest()
            : base("clickhouse", "2019-11-11", "CheckModifyConfigNeedRestart", "service", "openAPI")
        {
        ...
        public override CheckModifyConfigNeedRestartResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckModifyConfigNeedRestartResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
