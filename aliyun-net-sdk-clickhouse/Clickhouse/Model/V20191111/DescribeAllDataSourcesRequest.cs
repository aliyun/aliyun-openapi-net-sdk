...
{
    public class DescribeAllDataSourcesRequest : RpcAcsRequest<DescribeAllDataSourcesResponse>
    {
        public DescribeAllDataSourcesRequest()
            : base("clickhouse", "2019-11-11", "DescribeAllDataSources", "service", "openAPI")
        {
        ...
        public override DescribeAllDataSourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAllDataSourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
