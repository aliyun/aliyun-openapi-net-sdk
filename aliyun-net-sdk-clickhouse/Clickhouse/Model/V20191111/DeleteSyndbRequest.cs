...
{
    public class DeleteSyndbRequest : RpcAcsRequest<DeleteSyndbResponse>
    {
        public DeleteSyndbRequest()
            : base("clickhouse", "2019-11-11", "DeleteSyndb", "service", "openAPI")
        {
        ...
        public override DeleteSyndbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSyndbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
