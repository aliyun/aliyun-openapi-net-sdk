...
{
    public class CreatePortsForClickHouseRequest : RpcAcsRequest<CreatePortsForClickHouseResponse>
    {
        public CreatePortsForClickHouseRequest()
            : base("clickhouse", "2019-11-11", "CreatePortsForClickHouse", "service", "openAPI")
        {
        ...
        public override CreatePortsForClickHouseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePortsForClickHouseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
