...
{
    public class CreateSQLAccountRequest : RpcAcsRequest<CreateSQLAccountResponse>
    {
        public CreateSQLAccountRequest()
            : base("clickhouse", "2019-11-11", "CreateSQLAccount", "service", "openAPI")
        {
        ...
        public override CreateSQLAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSQLAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
