...
namespace Aliyun.Acs.clickhouse.Model.V20191111
{
	public class DescribeDBClusterAccessWhiteListResponse : AcsResponse
	{
		...
		private List<DescribeDBClusterAccessWhiteList_IPArray> dBClusterAccessWhiteList;
		...
		public List<DescribeDBClusterAccessWhiteList_IPArray> DBClusterAccessWhiteList
		{
			get
			{
			...
			set	
			{
				dBClusterAccessWhiteList = value;
			}
		}
