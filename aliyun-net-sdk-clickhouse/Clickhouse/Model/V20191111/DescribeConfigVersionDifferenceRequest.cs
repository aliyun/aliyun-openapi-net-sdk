...
{
    public class DescribeConfigVersionDifferenceRequest : RpcAcsRequest<DescribeConfigVersionDifferenceResponse>
    {
        public DescribeConfigVersionDifferenceRequest()
            : base("clickhouse", "2019-11-11", "DescribeConfigVersionDifference", "service", "openAPI")
        {
        ...
        public override DescribeConfigVersionDifferenceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConfigVersionDifferenceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
