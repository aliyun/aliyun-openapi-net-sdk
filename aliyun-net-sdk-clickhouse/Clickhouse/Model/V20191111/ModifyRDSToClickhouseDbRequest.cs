...
{
    public class ModifyRDSToClickhouseDbRequest : RpcAcsRequest<ModifyRDSToClickhouseDbResponse>
    {
        public ModifyRDSToClickhouseDbRequest()
            : base("clickhouse", "2019-11-11", "ModifyRDSToClickhouseDb", "service", "openAPI")
        {
		...
		public string RdsSynTables
		{
			...
			{
				rdsSynTables = value;
				DictionaryUtil.Add(QueryParameters, "RdsSynTables", value);
			}
		}
		...
		public string RdsSynDb
		{
			...
			{
				rdsSynDb = value;
				DictionaryUtil.Add(QueryParameters, "RdsSynDb", value);
			}
		}
		...
		public long? LimitUpper
		{
			...
			{
				limitUpper = value;
				DictionaryUtil.Add(QueryParameters, "LimitUpper", value.ToString());
			}
		}
		...
		public bool? SkipUnsupported
		{
			...
			set	
			{
				skipUnsupported = value;
				DictionaryUtil.Add(QueryParameters, "SkipUnsupported", value.ToString());
			}
		}
        ...
        public override ModifyRDSToClickhouseDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyRDSToClickhouseDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
