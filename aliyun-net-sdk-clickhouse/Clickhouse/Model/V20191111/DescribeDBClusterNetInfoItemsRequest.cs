...
{
    public class DescribeDBClusterNetInfoItemsRequest : RpcAcsRequest<DescribeDBClusterNetInfoItemsResponse>
    {
        public DescribeDBClusterNetInfoItemsRequest()
            : base("clickhouse", "2019-11-11", "DescribeDBClusterNetInfoItems", "service", "openAPI")
        {
        ...
        public override DescribeDBClusterNetInfoItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBClusterNetInfoItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
