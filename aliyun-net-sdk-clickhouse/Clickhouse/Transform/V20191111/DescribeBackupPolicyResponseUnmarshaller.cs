...
namespace Aliyun.Acs.clickhouse.Transform.V20191111
{
    public class DescribeBackupPolicyResponseUnmarshaller
    {
        public static DescribeBackupPolicyResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			describeBackupPolicyResponse._Switch = _ctx.StringValue("DescribeBackupPolicy.Switch");
			...
			describeBackupPolicyResponse.BackupSize = _ctx.StringValue("DescribeBackupPolicy.BackupSize");
