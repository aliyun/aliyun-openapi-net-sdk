...
{
    public class GetSceneListRequest : RpcAcsRequest<GetSceneListResponse>
    {
        public GetSceneListRequest()
            : base("tdsr", "2020-01-01", "GetSceneList")
        {
        ...
        public override GetSceneListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSceneListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
