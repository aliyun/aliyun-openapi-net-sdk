...
{
    public class SaveFileRequest : RpcAcsRequest<SaveFileResponse>
    {
        public SaveFileRequest()
            : base("tdsr", "2020-01-01", "SaveFile")
        {
		...
		public string ParamFile
		{
			...
			{
				paramFile = value;
				DictionaryUtil.Add(QueryParameters, "ParamFile", value);
			}
		}
        ...
        public override SaveFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
