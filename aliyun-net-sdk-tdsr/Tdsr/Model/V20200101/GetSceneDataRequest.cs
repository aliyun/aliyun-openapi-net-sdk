...
{
    public class GetSceneDataRequest : RpcAcsRequest<GetSceneDataResponse>
    {
        public GetSceneDataRequest()
            : base("tdsr", "2020-01-01", "GetSceneData")
        {
        ...
        public override GetSceneDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSceneDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
