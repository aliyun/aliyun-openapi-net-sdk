...
{
    public class CheckPermissionRequest : RpcAcsRequest<CheckPermissionResponse>
    {
        public CheckPermissionRequest()
            : base("tdsr", "2020-01-01", "CheckPermission")
        {
        ...
        public override CheckPermissionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckPermissionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
