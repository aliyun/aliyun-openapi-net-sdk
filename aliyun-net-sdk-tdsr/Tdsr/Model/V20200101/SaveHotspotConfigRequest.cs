...
{
    public class SaveHotspotConfigRequest : RpcAcsRequest<SaveHotspotConfigResponse>
    {
        public SaveHotspotConfigRequest()
            : base("tdsr", "2020-01-01", "SaveHotspotConfig")
        {
		...
		public string PreviewToken
		{
			...
			{
				previewToken = value;
				DictionaryUtil.Add(QueryParameters, "PreviewToken", value);
			}
		}
        ...
        public override SaveHotspotConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveHotspotConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
