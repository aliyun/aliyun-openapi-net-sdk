...
{
    public class ListMainScenesRequest : RpcAcsRequest<ListMainScenesResponse>
    {
        public ListMainScenesRequest()
            : base("tdsr", "2020-01-01", "ListMainScenes")
        {
        ...
        public override ListMainScenesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMainScenesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
