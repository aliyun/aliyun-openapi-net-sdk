...
{
    public class SaveHotspotTagRequest : RpcAcsRequest<SaveHotspotTagResponse>
    {
        public SaveHotspotTagRequest()
            : base("tdsr", "2020-01-01", "SaveHotspotTag")
        {
        ...
        public override SaveHotspotTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveHotspotTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
