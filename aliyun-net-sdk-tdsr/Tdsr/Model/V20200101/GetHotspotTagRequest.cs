...
{
    public class GetHotspotTagRequest : RpcAcsRequest<GetHotspotTagResponse>
    {
        public GetHotspotTagRequest()
            : base("tdsr", "2020-01-01", "GetHotspotTag")
        {
        ...
        public override GetHotspotTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetHotspotTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
