...
{
    public class ListScenesRequest : RpcAcsRequest<ListScenesResponse>
    {
        public ListScenesRequest()
            : base("tdsr", "2020-01-01", "ListScenes")
        {
		...
		public bool? IsPublishQuery
		{
			...
			set	
			{
				isPublishQuery = value;
				DictionaryUtil.Add(QueryParameters, "IsPublishQuery", value.ToString());
			}
		}
        ...
        public override ListScenesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListScenesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
