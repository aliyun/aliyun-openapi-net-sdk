...
{
    public class GetDeviceCredentialRequest : RpcAcsRequest<GetDeviceCredentialResponse>
    {
        public GetDeviceCredentialRequest()
            : base("OnsMqtt", "2020-04-20", "GetDeviceCredential", "onsmqtt", "openAPI")
        {
        ...
        public override GetDeviceCredentialResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDeviceCredentialResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
