...
{
    public class ResumeVsStreamRequest : RpcAcsRequest<ResumeVsStreamResponse>
    {
        public ResumeVsStreamRequest()
            : base("vs", "2018-12-12", "ResumeVsStream", "vs", "openAPI")
        {
        ...
        public override ResumeVsStreamResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResumeVsStreamResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
