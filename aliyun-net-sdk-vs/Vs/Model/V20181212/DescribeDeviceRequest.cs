...
{
    public class DescribeDeviceRequest : RpcAcsRequest<DescribeDeviceResponse>
    {
        public DescribeDeviceRequest()
            : base("vs", "2018-12-12", "DescribeDevice", "vs", "openAPI")
        {
        ...
        public override DescribeDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
