...
namespace Aliyun.Acs.vs.Model.V20181212
{
    public class DescribePresetsRequest : RpcAcsRequest<DescribePresetsResponse>
    {
        ...
        public override DescribePresetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePresetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
