...
namespace Aliyun.Acs.vs.Model.V20181212
{
    public class DescribePurchasedDeviceRequest : RpcAcsRequest<DescribePurchasedDeviceResponse>
    {
        ...
        public override DescribePurchasedDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePurchasedDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
