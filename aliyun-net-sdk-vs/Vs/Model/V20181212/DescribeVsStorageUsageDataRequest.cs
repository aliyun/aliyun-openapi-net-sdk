...
{
    public class DescribeVsStorageUsageDataRequest : RpcAcsRequest<DescribeVsStorageUsageDataResponse>
    {
        public DescribeVsStorageUsageDataRequest()
            : base("vs", "2018-12-12", "DescribeVsStorageUsageData", "vs", "openAPI")
        {
        ...
        public override DescribeVsStorageUsageDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeVsStorageUsageDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
