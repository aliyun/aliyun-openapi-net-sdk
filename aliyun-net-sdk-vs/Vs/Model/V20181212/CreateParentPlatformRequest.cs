...
{
    public class CreateParentPlatformRequest : RpcAcsRequest<CreateParentPlatformResponse>
    {
        public CreateParentPlatformRequest()
            : base("vs", "2018-12-12", "CreateParentPlatform", "vs", "openAPI")
        {
        ...
        public override CreateParentPlatformResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateParentPlatformResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
