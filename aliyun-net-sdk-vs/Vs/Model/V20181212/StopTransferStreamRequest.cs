...
{
    public class StopTransferStreamRequest : RpcAcsRequest<StopTransferStreamResponse>
    {
        public StopTransferStreamRequest()
            : base("vs", "2018-12-12", "StopTransferStream", "vs", "openAPI")
        {
        ...
        public override StopTransferStreamResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopTransferStreamResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
