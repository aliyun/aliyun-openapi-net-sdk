...
{
    public class DeleteVsPullStreamInfoConfigRequest : RpcAcsRequest<DeleteVsPullStreamInfoConfigResponse>
    {
        public DeleteVsPullStreamInfoConfigRequest()
            : base("vs", "2018-12-12", "DeleteVsPullStreamInfoConfig", "vs", "openAPI")
        {
        ...
        public override DeleteVsPullStreamInfoConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteVsPullStreamInfoConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
