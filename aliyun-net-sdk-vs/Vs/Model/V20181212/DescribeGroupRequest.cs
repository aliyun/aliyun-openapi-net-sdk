...
{
    public class DescribeGroupRequest : RpcAcsRequest<DescribeGroupResponse>
    {
        public DescribeGroupRequest()
            : base("vs", "2018-12-12", "DescribeGroup", "vs", "openAPI")
        {
        ...
        public override DescribeGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
