...
{
    public class OpenVsServiceRequest : RpcAcsRequest<OpenVsServiceResponse>
    {
        public OpenVsServiceRequest()
            : base("vs", "2018-12-12", "OpenVsService", "vs", "openAPI")
        {
        ...
        public override OpenVsServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenVsServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
