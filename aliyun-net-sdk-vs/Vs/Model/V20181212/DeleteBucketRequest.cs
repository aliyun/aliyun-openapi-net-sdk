...
{
    public class DeleteBucketRequest : RpcAcsRequest<DeleteBucketResponse>
    {
        public DeleteBucketRequest()
            : base("vs", "2018-12-12", "DeleteBucket", "vs", "openAPI")
        {
        ...
        public override DeleteBucketResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteBucketResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
