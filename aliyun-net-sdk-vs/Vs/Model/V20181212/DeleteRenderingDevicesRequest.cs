...
{
    public class DeleteRenderingDevicesRequest : RpcAcsRequest<DeleteRenderingDevicesResponse>
    {
        public DeleteRenderingDevicesRequest()
            : base("vs", "2018-12-12", "DeleteRenderingDevices", "vs", "openAPI")
        {
        ...
        public override DeleteRenderingDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRenderingDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
