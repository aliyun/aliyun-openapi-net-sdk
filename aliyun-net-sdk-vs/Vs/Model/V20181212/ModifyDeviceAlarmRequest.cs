...
{
    public class ModifyDeviceAlarmRequest : RpcAcsRequest<ModifyDeviceAlarmResponse>
    {
        public ModifyDeviceAlarmRequest()
            : base("vs", "2018-12-12", "ModifyDeviceAlarm", "vs", "openAPI")
        {
        ...
        public override ModifyDeviceAlarmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDeviceAlarmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
