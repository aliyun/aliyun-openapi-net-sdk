...
{
    public class DescribeStreamsRequest : RpcAcsRequest<DescribeStreamsResponse>
    {
        public DescribeStreamsRequest()
            : base("vs", "2018-12-12", "DescribeStreams", "vs", "openAPI")
        {
        ...
        public override DescribeStreamsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeStreamsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
