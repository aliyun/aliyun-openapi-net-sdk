...
namespace Aliyun.Acs.vs.Model.V20181212
{
    public class BatchStopDevicesRequest : RpcAcsRequest<BatchStopDevicesResponse>
    {
        ...
        public override BatchStopDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchStopDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
