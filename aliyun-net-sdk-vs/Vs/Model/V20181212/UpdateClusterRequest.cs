...
{
    public class UpdateClusterRequest : RpcAcsRequest<UpdateClusterResponse>
    {
        public UpdateClusterRequest()
            : base("vs", "2018-12-12", "UpdateCluster", "vs", "openAPI")
        {
        ...
        public override UpdateClusterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateClusterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
