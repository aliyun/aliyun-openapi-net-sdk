...
{
    public class BatchResumeVsStreamRequest : RpcAcsRequest<BatchResumeVsStreamResponse>
    {
        public BatchResumeVsStreamRequest()
            : base("vs", "2018-12-12", "BatchResumeVsStream", "vs", "openAPI")
        {
        ...
        public override BatchResumeVsStreamResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchResumeVsStreamResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
