...
{
    public class UpdateBucketInfoRequest : RpcAcsRequest<UpdateBucketInfoResponse>
    {
        public UpdateBucketInfoRequest()
            : base("vs", "2018-12-12", "UpdateBucketInfo", "vs", "openAPI")
        {
        ...
        public override UpdateBucketInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateBucketInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
