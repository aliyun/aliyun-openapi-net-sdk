...
namespace Aliyun.Acs.vs.Model.V20181212
{
	public class DescribeDevicesResponse : AcsResponse
	{
		...
		public class DescribeDevices_Device
		{
			...
			private DescribeDevices_Stats stats;

			private DescribeDevices_Directory directory;
			...
			public DescribeDevices_Stats Stats
			{
				get
				{
					return stats;
			...
			public DescribeDevices_Directory Directory
			{
				get
				{
					return directory;
			...
			public class DescribeDevices_Stats
			{
			...
			public class DescribeDevices_Directory
			{
