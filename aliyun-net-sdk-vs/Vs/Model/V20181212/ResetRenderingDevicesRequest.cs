...
{
    public class ResetRenderingDevicesRequest : RpcAcsRequest<ResetRenderingDevicesResponse>
    {
        public ResetRenderingDevicesRequest()
            : base("vs", "2018-12-12", "ResetRenderingDevices", "vs", "openAPI")
        {
        ...
        public override ResetRenderingDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetRenderingDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
