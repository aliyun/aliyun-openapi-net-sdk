...
{
	public class DescribeVsDomainRegionDataResponse : AcsResponse
	{
		...
		private List<DescribeVsDomainRegionData_RegionProportionData> _value;
		...
		public List<DescribeVsDomainRegionData_RegionProportionData> _Value
		{
			get
			{
				return _value;
		...
		public class DescribeVsDomainRegionData_RegionProportionData
		{
