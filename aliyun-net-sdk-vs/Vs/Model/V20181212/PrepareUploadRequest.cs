...
{
    public class PrepareUploadRequest : RpcAcsRequest<PrepareUploadResponse>
    {
        public PrepareUploadRequest()
            : base("vs", "2018-12-12", "PrepareUpload", "vs", "openAPI")
        {
        ...
        public override PrepareUploadResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PrepareUploadResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
