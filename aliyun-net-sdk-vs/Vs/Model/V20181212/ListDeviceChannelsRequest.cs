...
{
    public class ListDeviceChannelsRequest : RpcAcsRequest<ListDeviceChannelsResponse>
    {
        public ListDeviceChannelsRequest()
            : base("vs", "2018-12-12", "ListDeviceChannels", "vs", "openAPI")
        {
        ...
        public override ListDeviceChannelsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDeviceChannelsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
