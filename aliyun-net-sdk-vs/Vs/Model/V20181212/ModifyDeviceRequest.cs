...
{
    public class ModifyDeviceRequest : RpcAcsRequest<ModifyDeviceResponse>
    {
        public ModifyDeviceRequest()
            : base("vs", "2018-12-12", "ModifyDevice", "vs", "openAPI")
        {
        ...
        public override ModifyDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
