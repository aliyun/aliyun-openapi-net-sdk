...
{
	public class DescribeVsTopDomainsByFlowResponse : AcsResponse
	{
		...
		private List<DescribeVsTopDomainsByFlow_TopDomain> topDomains;
		...
		public List<DescribeVsTopDomainsByFlow_TopDomain> TopDomains
		{
			get
			{
				return topDomains;
		...
		public class DescribeVsTopDomainsByFlow_TopDomain
		{
