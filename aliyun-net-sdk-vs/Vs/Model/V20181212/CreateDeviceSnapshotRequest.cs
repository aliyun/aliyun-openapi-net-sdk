...
{
    public class CreateDeviceSnapshotRequest : RpcAcsRequest<CreateDeviceSnapshotResponse>
    {
        public CreateDeviceSnapshotRequest()
            : base("vs", "2018-12-12", "CreateDeviceSnapshot", "vs", "openAPI")
        {
        ...
        public override CreateDeviceSnapshotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDeviceSnapshotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
