...
{
    public class DescribePurchasedDevicesRequest : RpcAcsRequest<DescribePurchasedDevicesResponse>
    {
        public DescribePurchasedDevicesRequest()
            : base("vs", "2018-12-12", "DescribePurchasedDevices", "vs", "openAPI")
        {
        ...
        public override DescribePurchasedDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePurchasedDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
