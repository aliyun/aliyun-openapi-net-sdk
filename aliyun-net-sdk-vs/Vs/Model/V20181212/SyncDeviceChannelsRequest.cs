...
{
    public class SyncDeviceChannelsRequest : RpcAcsRequest<SyncDeviceChannelsResponse>
    {
        public SyncDeviceChannelsRequest()
            : base("vs", "2018-12-12", "SyncDeviceChannels", "vs", "openAPI")
        {
        ...
        public override SyncDeviceChannelsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SyncDeviceChannelsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
