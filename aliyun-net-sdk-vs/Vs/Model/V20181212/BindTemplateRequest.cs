...
{
    public class BindTemplateRequest : RpcAcsRequest<BindTemplateResponse>
    {
        public BindTemplateRequest()
            : base("vs", "2018-12-12", "BindTemplate", "vs", "openAPI")
        {
        ...
        public override BindTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
