...
{
    public class GetBucketInfoRequest : RpcAcsRequest<GetBucketInfoResponse>
    {
        public GetBucketInfoRequest()
            : base("vs", "2018-12-12", "GetBucketInfo", "vs", "openAPI")
        {
        ...
        public override GetBucketInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetBucketInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
