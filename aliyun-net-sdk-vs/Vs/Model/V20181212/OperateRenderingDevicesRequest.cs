...
{
    public class OperateRenderingDevicesRequest : RpcAcsRequest<OperateRenderingDevicesResponse>
    {
        public OperateRenderingDevicesRequest()
            : base("vs", "2018-12-12", "OperateRenderingDevices", "vs", "openAPI")
        {
        ...
        public override OperateRenderingDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OperateRenderingDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
