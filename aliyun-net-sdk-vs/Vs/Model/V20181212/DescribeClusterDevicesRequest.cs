...
{
    public class DescribeClusterDevicesRequest : RpcAcsRequest<DescribeClusterDevicesResponse>
    {
        public DescribeClusterDevicesRequest()
            : base("vs", "2018-12-12", "DescribeClusterDevices", "vs", "openAPI")
        {
        ...
        public override DescribeClusterDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeClusterDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
