...
{
    public class DescribeNodeDevicesInfoRequest : RpcAcsRequest<DescribeNodeDevicesInfoResponse>
    {
        public DescribeNodeDevicesInfoRequest()
            : base("vs", "2018-12-12", "DescribeNodeDevicesInfo", "vs", "openAPI")
        {
        ...
        public override DescribeNodeDevicesInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNodeDevicesInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
