...
{
    public class ListDeviceRecordsRequest : RpcAcsRequest<ListDeviceRecordsResponse>
    {
        public ListDeviceRecordsRequest()
            : base("vs", "2018-12-12", "ListDeviceRecords", "vs", "openAPI")
        {
        ...
        public override ListDeviceRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDeviceRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
