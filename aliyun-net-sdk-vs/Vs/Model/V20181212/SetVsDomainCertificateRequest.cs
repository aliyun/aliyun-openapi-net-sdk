...
{
    public class SetVsDomainCertificateRequest : RpcAcsRequest<SetVsDomainCertificateResponse>
    {
        public SetVsDomainCertificateRequest()
            : base("vs", "2018-12-12", "SetVsDomainCertificate", "vs", "openAPI")
        {
        ...
        public override SetVsDomainCertificateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetVsDomainCertificateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
