...
{
    public class ReconstructBodyBySingleImageRequest : RpcAcsRequest<ReconstructBodyBySingleImageResponse>
    {
        public ReconstructBodyBySingleImageRequest()
            : base("threedvision", "2021-01-31", "ReconstructBodyBySingleImage", "threedvision", "openAPI")
        {
        ...
        public override ReconstructBodyBySingleImageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReconstructBodyBySingleImageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
