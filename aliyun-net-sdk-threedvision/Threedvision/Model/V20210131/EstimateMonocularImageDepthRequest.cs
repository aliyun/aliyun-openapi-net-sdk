...
{
    public class EstimateMonocularImageDepthRequest : RpcAcsRequest<EstimateMonocularImageDepthResponse>
    {
        public EstimateMonocularImageDepthRequest()
            : base("threedvision", "2021-01-31", "EstimateMonocularImageDepth", "threedvision", "openAPI")
        {
        ...
        public override EstimateMonocularImageDepthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EstimateMonocularImageDepthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
