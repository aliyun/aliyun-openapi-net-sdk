...
{
    public class EstimateMonocularVideoDepthRequest : RpcAcsRequest<EstimateMonocularVideoDepthResponse>
    {
        public EstimateMonocularVideoDepthRequest()
            : base("threedvision", "2021-01-31", "EstimateMonocularVideoDepth", "threedvision", "openAPI")
        {
		...
		public string SampleRate
		{
			...
			{
				sampleRate = value;
				DictionaryUtil.Add(BodyParameters, "SampleRate", value);
			}
		}
        ...
        public override EstimateMonocularVideoDepthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EstimateMonocularVideoDepthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
