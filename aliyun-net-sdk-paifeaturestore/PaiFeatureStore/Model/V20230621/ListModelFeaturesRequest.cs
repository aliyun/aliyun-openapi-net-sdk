...
{
    public class ListModelFeaturesRequest : RoaAcsRequest<ListModelFeaturesResponse>
    {
        public ListModelFeaturesRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListModelFeatures")
        {
        ...
        public override ListModelFeaturesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListModelFeaturesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
