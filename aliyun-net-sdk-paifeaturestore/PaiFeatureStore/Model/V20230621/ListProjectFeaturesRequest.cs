...
{
    public class ListProjectFeaturesRequest : RoaAcsRequest<ListProjectFeaturesResponse>
    {
        public ListProjectFeaturesRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListProjectFeatures")
        {
			Protocol = ProtocolType.HTTPS;
			UriPattern = "/api/v1/instances/[InstanceId]/projects/[ProjectId]/features";
        ...
        public override ListProjectFeaturesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProjectFeaturesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
