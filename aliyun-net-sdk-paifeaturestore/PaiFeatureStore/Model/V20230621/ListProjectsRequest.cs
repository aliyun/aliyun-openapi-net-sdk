...
{
    public class ListProjectsRequest : RoaAcsRequest<ListProjectsResponse>
    {
        public ListProjectsRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListProjects")
        {
			UriPattern = "/api/v1/instances/[InstanceId]/projects";
