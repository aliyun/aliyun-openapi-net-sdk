...
{
    public class ListFeatureEntitiesRequest : RoaAcsRequest<ListFeatureEntitiesResponse>
    {
        public ListFeatureEntitiesRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListFeatureEntities")
        {
        ...
        public override ListFeatureEntitiesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFeatureEntitiesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
