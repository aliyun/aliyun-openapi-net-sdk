...
{
    public class ListModelFeatureAvailableFeaturesRequest : RoaAcsRequest<ListModelFeatureAvailableFeaturesResponse>
    {
        public ListModelFeatureAvailableFeaturesRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListModelFeatureAvailableFeatures")
        {
			UriPattern = "/api/v1/instances/[InstanceId]/modelfeatures/[ModelFeatureId]/availablefeatures";
        ...
        public override ListModelFeatureAvailableFeaturesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListModelFeatureAvailableFeaturesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
