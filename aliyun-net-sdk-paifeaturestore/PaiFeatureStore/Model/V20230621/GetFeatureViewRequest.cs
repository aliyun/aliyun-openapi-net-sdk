...
{
    public class GetFeatureViewRequest : RoaAcsRequest<GetFeatureViewResponse>
    {
        public GetFeatureViewRequest()
            : base("PaiFeatureStore", "2023-06-21", "GetFeatureView")
        {
        ...
        public override GetFeatureViewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFeatureViewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
