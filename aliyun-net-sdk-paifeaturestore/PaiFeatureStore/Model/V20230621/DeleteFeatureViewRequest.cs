...
{
    public class DeleteFeatureViewRequest : RoaAcsRequest<DeleteFeatureViewResponse>
    {
        public DeleteFeatureViewRequest()
            : base("PaiFeatureStore", "2023-06-21", "DeleteFeatureView")
        {
        ...
        public override DeleteFeatureViewResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFeatureViewResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
