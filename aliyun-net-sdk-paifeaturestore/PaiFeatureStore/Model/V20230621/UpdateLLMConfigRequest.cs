...
{
    public class UpdateLLMConfigRequest : RoaAcsRequest<UpdateLLMConfigResponse>
    {
        public UpdateLLMConfigRequest()
            : base("PaiFeatureStore", "2023-06-21", "UpdateLLMConfig")
        {
        ...
        public override UpdateLLMConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateLLMConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
