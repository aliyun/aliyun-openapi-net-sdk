...
{
    public class ListLabelTablesRequest : RoaAcsRequest<ListLabelTablesResponse>
    {
        public ListLabelTablesRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListLabelTables")
        {
        ...
        public override ListLabelTablesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLabelTablesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
