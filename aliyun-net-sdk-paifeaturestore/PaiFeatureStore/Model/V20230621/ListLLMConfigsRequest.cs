...
{
    public class ListLLMConfigsRequest : RoaAcsRequest<ListLLMConfigsResponse>
    {
        public ListLLMConfigsRequest()
            : base("PaiFeatureStore", "2023-06-21", "ListLLMConfigs")
        {
        ...
        public override ListLLMConfigsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLLMConfigsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
