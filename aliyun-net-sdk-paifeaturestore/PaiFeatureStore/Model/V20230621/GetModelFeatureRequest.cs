...
{
    public class GetModelFeatureRequest : RoaAcsRequest<GetModelFeatureResponse>
    {
        public GetModelFeatureRequest()
            : base("PaiFeatureStore", "2023-06-21", "GetModelFeature")
        {
        ...
        public override GetModelFeatureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetModelFeatureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
