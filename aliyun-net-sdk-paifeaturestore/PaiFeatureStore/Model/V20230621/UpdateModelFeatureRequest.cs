...
{
    public class UpdateModelFeatureRequest : RoaAcsRequest<UpdateModelFeatureResponse>
    {
        public UpdateModelFeatureRequest()
            : base("PaiFeatureStore", "2023-06-21", "UpdateModelFeature")
        {
        ...
        public override UpdateModelFeatureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateModelFeatureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
