...
{
    public class PublishFeatureViewTableRequest : RoaAcsRequest<PublishFeatureViewTableResponse>
    {
        public PublishFeatureViewTableRequest()
            : base("PaiFeatureStore", "2023-06-21", "PublishFeatureViewTable")
        {
			UriPattern = "/api/v1/instances/[InstanceId]/featureviews/[FeatureViewId]/action/publishtable";
        ...
        public override PublishFeatureViewTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PublishFeatureViewTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
