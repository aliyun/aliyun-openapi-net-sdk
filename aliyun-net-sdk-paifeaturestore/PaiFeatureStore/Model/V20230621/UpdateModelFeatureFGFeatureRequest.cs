...
{
    public class UpdateModelFeatureFGFeatureRequest : RoaAcsRequest<UpdateModelFeatureFGFeatureResponse>
    {
        public UpdateModelFeatureFGFeatureRequest()
            : base("PaiFeatureStore", "2023-06-21", "UpdateModelFeatureFGFeature")
        {
			UriPattern = "/api/v1/instances/[InstanceId]/modelfeatures/[ModelFeatureId]/fgfeature";
        ...
        public override UpdateModelFeatureFGFeatureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateModelFeatureFGFeatureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
