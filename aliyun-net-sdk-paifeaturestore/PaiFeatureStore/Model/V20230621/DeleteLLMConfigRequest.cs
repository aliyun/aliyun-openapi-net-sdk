...
{
    public class DeleteLLMConfigRequest : RoaAcsRequest<DeleteLLMConfigResponse>
    {
        public DeleteLLMConfigRequest()
            : base("PaiFeatureStore", "2023-06-21", "DeleteLLMConfig")
        {
        ...
        public override DeleteLLMConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLLMConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
