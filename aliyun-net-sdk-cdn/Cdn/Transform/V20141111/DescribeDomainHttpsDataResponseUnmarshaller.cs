...
namespace Aliyun.Acs.Cdn.Transform.V20141111
{
    public class DescribeDomainHttpsDataResponseUnmarshaller
    {
        public static DescribeDomainHttpsDataResponse Unmarshall(UnmarshallerContext context)
        {
			...
			List<DescribeDomainHttpsDataResponse.HttpsStatisticsInfo> httpsStatisticsInfos = new List<DescribeDomainHttpsDataResponse.HttpsStatisticsInfo>();
			...
			describeDomainHttpsDataResponse.HttpsStatisticsInfos = httpsStatisticsInfos;
