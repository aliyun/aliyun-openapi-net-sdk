...
namespace Aliyun.Acs.Cdn.Transform.V20141111
{
    public class DescribeExtensiveDomainDataResponseUnmarshaller
    {
        public static DescribeExtensiveDomainDataResponse Unmarshall(UnmarshallerContext context)
        {
			...
			List<DescribeExtensiveDomainDataResponse.UsageData> dataPerInterval = new List<DescribeExtensiveDomainDataResponse.UsageData>();
			...
			describeExtensiveDomainDataResponse.DataPerInterval = dataPerInterval;
