...
{
    public class DescribeDomainBpsDataByLayerRequest : RpcAcsRequest<DescribeDomainBpsDataByLayerResponse>
    {
        public DescribeDomainBpsDataByLayerRequest()
            : base("Cdn", "2018-05-10", "DescribeDomainBpsDataByLayer")
        {
        ...
        public override DescribeDomainBpsDataByLayerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainBpsDataByLayerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
