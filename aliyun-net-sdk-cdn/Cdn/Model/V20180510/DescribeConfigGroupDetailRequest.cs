...
{
    public class DescribeConfigGroupDetailRequest : RpcAcsRequest<DescribeConfigGroupDetailResponse>
    {
        public DescribeConfigGroupDetailRequest()
            : base("Cdn", "2018-05-10", "DescribeConfigGroupDetail")
        {
        ...
        public override DescribeConfigGroupDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConfigGroupDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
