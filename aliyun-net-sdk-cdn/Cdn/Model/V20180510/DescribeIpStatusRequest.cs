...
{
    public class DescribeIpStatusRequest : RpcAcsRequest<DescribeIpStatusResponse>
    {
        public DescribeIpStatusRequest()
            : base("Cdn", "2018-05-10", "DescribeIpStatus")
        {
        ...
        public override DescribeIpStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeIpStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
