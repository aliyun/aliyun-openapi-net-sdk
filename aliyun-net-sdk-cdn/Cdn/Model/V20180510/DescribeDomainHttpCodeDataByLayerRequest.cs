...
{
    public class DescribeDomainHttpCodeDataByLayerRequest : RpcAcsRequest<DescribeDomainHttpCodeDataByLayerResponse>
    {
        public DescribeDomainHttpCodeDataByLayerRequest()
            : base("Cdn", "2018-05-10", "DescribeDomainHttpCodeDataByLayer")
        {
        ...
        public override DescribeDomainHttpCodeDataByLayerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDomainHttpCodeDataByLayerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
