...
{
	public class TestDescribeDomainBpsDataResponse : AcsResponse
	{
		...
		private List<TestDescribeDomainBpsData_DataModule> bpsDataPerInterval;
		...
		public List<TestDescribeDomainBpsData_DataModule> BpsDataPerInterval
		{
			get
			{
		...
		public class TestDescribeDomainBpsData_DataModule
		{
