...
namespace Aliyun.Acs.Cdn.Model.V20141111
{
    public class BatchUpdateCdnDomainRequest : RpcAcsRequest<BatchUpdateCdnDomainResponse>
    {
        public BatchUpdateCdnDomainRequest()
            : base("Cdn", "2014-11-11", "BatchUpdateCdnDomain")
        {
        }
        ...
        public override BatchUpdateCdnDomainResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
