...
{
    public class TestDescribeDomainBpsDataRequest : RpcAcsRequest<TestDescribeDomainBpsDataResponse>
    {
        public TestDescribeDomainBpsDataRequest()
            : base("Cdn", "2014-11-11", "TestDescribeDomainBpsData")
        {
        ...
        public override TestDescribeDomainBpsDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TestDescribeDomainBpsDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
