...
{
    public class StopDatabaseInstanceRequest : RpcAcsRequest<StopDatabaseInstanceResponse>
    {
        public StopDatabaseInstanceRequest()
            : base("SWAS-OPEN", "2020-06-01", "StopDatabaseInstance", "SWAS-OPEN", "openAPI")
        {
        ...
        public override StopDatabaseInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDatabaseInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
