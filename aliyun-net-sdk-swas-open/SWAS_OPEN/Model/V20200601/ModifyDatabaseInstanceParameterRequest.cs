...
{
    public class ModifyDatabaseInstanceParameterRequest : RpcAcsRequest<ModifyDatabaseInstanceParameterResponse>
    {
        public ModifyDatabaseInstanceParameterRequest()
            : base("SWAS-OPEN", "2020-06-01", "ModifyDatabaseInstanceParameter", "SWAS-OPEN", "openAPI")
        {
        ...
        public override ModifyDatabaseInstanceParameterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDatabaseInstanceParameterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
