...
{
    public class CheckBlockVolumeNameRequest : RpcAcsRequest<CheckBlockVolumeNameResponse>
    {
        public CheckBlockVolumeNameRequest()
            : base("sgw", "2018-05-11", "CheckBlockVolumeName", "hcs_sgw", "openAPI")
        {
        ...
        public override CheckBlockVolumeNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckBlockVolumeNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
