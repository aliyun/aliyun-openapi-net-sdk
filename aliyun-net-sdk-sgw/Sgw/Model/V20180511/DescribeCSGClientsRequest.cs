...
{
    public class DescribeCSGClientsRequest : RpcAcsRequest<DescribeCSGClientsResponse>
    {
        public DescribeCSGClientsRequest()
            : base("sgw", "2018-05-11", "DescribeCSGClients", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeCSGClientsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCSGClientsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
