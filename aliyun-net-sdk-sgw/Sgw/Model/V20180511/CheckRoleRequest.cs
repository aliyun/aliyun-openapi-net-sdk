...
{
    public class CheckRoleRequest : RpcAcsRequest<CheckRoleResponse>
    {
        public CheckRoleRequest()
            : base("sgw", "2018-05-11", "CheckRole", "hcs_sgw", "openAPI")
        {
        ...
        public override CheckRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
