...
{
    public class DescribePayAsYouGoPriceRequest : RpcAcsRequest<DescribePayAsYouGoPriceResponse>
    {
        public DescribePayAsYouGoPriceRequest()
            : base("sgw", "2018-05-11", "DescribePayAsYouGoPrice", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribePayAsYouGoPriceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePayAsYouGoPriceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
