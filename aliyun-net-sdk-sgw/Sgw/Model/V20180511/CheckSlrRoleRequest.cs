...
{
    public class CheckSlrRoleRequest : RpcAcsRequest<CheckSlrRoleResponse>
    {
        public CheckSlrRoleRequest()
            : base("sgw", "2018-05-11", "CheckSlrRole", "hcs_sgw", "openAPI")
        {
		...
		public bool? CreateIfNotExist
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "CreateIfNotExist", value.ToString());
			}
		}
        ...
        public override CheckSlrRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckSlrRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
