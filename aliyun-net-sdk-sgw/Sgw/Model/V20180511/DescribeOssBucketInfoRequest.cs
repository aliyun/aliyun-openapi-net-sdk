...
{
    public class DescribeOssBucketInfoRequest : RpcAcsRequest<DescribeOssBucketInfoResponse>
    {
        public DescribeOssBucketInfoRequest()
            : base("sgw", "2018-05-11", "DescribeOssBucketInfo", "hcs_sgw", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "BucketEndpoint")]
		public string BucketEndpoint
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "BucketEndpoint", value);
			}
		}
        ...
        public override DescribeOssBucketInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOssBucketInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
