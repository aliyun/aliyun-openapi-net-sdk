...
{
    public class DescribeCSGClientTasksRequest : RpcAcsRequest<DescribeCSGClientTasksResponse>
    {
        public DescribeCSGClientTasksRequest()
            : base("sgw", "2018-05-11", "DescribeCSGClientTasks", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeCSGClientTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCSGClientTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
