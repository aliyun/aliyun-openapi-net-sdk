...
{
    public class TriggerGatewayRemoteSyncRequest : RpcAcsRequest<TriggerGatewayRemoteSyncResponse>
    {
        public TriggerGatewayRemoteSyncRequest()
            : base("sgw", "2018-05-11", "TriggerGatewayRemoteSync", "hcs_sgw", "openAPI")
        {
        ...
        public override TriggerGatewayRemoteSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TriggerGatewayRemoteSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
