...
{
    public class DescribeStorageBundleRequest : RpcAcsRequest<DescribeStorageBundleResponse>
    {
        public DescribeStorageBundleRequest()
            : base("sgw", "2018-05-11", "DescribeStorageBundle", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeStorageBundleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeStorageBundleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
