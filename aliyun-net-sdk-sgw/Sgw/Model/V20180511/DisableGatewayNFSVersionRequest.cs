...
{
    public class DisableGatewayNFSVersionRequest : RpcAcsRequest<DisableGatewayNFSVersionResponse>
    {
        public DisableGatewayNFSVersionRequest()
            : base("sgw", "2018-05-11", "DisableGatewayNFSVersion", "hcs_sgw", "openAPI")
        {
		...
		public string NFSVersion
		{
			...
			{
				nFSVersion = value;
				DictionaryUtil.Add(QueryParameters, "NFSVersion", value);
			}
		}
        ...
        public override DisableGatewayNFSVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableGatewayNFSVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
