...
{
    public class DescribeGatewayFileStatusRequest : RpcAcsRequest<DescribeGatewayFileStatusResponse>
    {
        public DescribeGatewayFileStatusRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayFileStatus", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayFileStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayFileStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
