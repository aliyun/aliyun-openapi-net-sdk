...
{
    public class DescribeGatewayFileSharesRequest : RpcAcsRequest<DescribeGatewayFileSharesResponse>
    {
        public DescribeGatewayFileSharesRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayFileShares", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayFileSharesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayFileSharesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
