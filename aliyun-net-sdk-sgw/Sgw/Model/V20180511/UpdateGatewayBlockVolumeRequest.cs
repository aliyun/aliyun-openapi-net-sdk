...
{
    public class UpdateGatewayBlockVolumeRequest : RpcAcsRequest<UpdateGatewayBlockVolumeResponse>
    {
        public UpdateGatewayBlockVolumeRequest()
            : base("sgw", "2018-05-11", "UpdateGatewayBlockVolume", "hcs_sgw", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "ChapInPassword")]
        ...
        public override UpdateGatewayBlockVolumeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateGatewayBlockVolumeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
