...
{
    public class CheckUpgradeVersionRequest : RpcAcsRequest<CheckUpgradeVersionResponse>
    {
        public CheckUpgradeVersionRequest()
            : base("sgw", "2018-05-11", "CheckUpgradeVersion", "hcs_sgw", "openAPI")
        {
		...
		public string GatewayVersion
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "GatewayVersion", value);
			}
		}
        ...
        public override CheckUpgradeVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckUpgradeVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
