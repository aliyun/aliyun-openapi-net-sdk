...
{
    public class DeleteExpressSyncRequest : RpcAcsRequest<DeleteExpressSyncResponse>
    {
        public DeleteExpressSyncRequest()
            : base("sgw", "2018-05-11", "DeleteExpressSync", "hcs_sgw", "openAPI")
        {
        ...
        public override DeleteExpressSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteExpressSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
