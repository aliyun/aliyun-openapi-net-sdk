...
{
    public class DeleteGatewayFileSharesRequest : RpcAcsRequest<DeleteGatewayFileSharesResponse>
    {
        public DeleteGatewayFileSharesRequest()
            : base("sgw", "2018-05-11", "DeleteGatewayFileShares", "hcs_sgw", "openAPI")
        {
        ...
        public override DeleteGatewayFileSharesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGatewayFileSharesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
