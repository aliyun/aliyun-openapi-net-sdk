...
{
    public class ReportGatewayUsageRequest : RpcAcsRequest<ReportGatewayUsageResponse>
    {
        public ReportGatewayUsageRequest()
            : base("sgw", "2018-05-11", "ReportGatewayUsage", "hcs_sgw", "openAPI")
        {
        ...
        public override ReportGatewayUsageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReportGatewayUsageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
