...
{
    public class DescribeGatewayTypesRequest : RpcAcsRequest<DescribeGatewayTypesResponse>
    {
        public DescribeGatewayTypesRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayTypes", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayTypesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayTypesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
