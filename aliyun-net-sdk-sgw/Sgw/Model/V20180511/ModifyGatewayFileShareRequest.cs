...
{
    public class ModifyGatewayFileShareRequest : RpcAcsRequest<ModifyGatewayFileShareResponse>
    {
        public ModifyGatewayFileShareRequest()
            : base("sgw", "2018-05-11", "ModifyGatewayFileShare", "hcs_sgw", "openAPI")
        {
        ...
        public override ModifyGatewayFileShareResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGatewayFileShareResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
