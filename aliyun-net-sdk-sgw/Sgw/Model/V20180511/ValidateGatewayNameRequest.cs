...
{
    public class ValidateGatewayNameRequest : RpcAcsRequest<ValidateGatewayNameResponse>
    {
        public ValidateGatewayNameRequest()
            : base("sgw", "2018-05-11", "ValidateGatewayName", "hcs_sgw", "openAPI")
        {
        ...
        public override ValidateGatewayNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ValidateGatewayNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
