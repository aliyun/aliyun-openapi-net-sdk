...
{
    public class DescribeGatewayCategoriesRequest : RpcAcsRequest<DescribeGatewayCategoriesResponse>
    {
        public DescribeGatewayCategoriesRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayCategories", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayCategoriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayCategoriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
