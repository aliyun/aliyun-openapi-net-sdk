...
{
    public class UpgradeGatewayRequest : RpcAcsRequest<UpgradeGatewayResponse>
    {
        public UpgradeGatewayRequest()
            : base("sgw", "2018-05-11", "UpgradeGateway", "hcs_sgw", "openAPI")
        {
        ...
        public override UpgradeGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpgradeGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
