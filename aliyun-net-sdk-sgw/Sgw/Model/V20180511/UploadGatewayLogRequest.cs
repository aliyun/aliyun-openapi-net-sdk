...
{
    public class UploadGatewayLogRequest : RpcAcsRequest<UploadGatewayLogResponse>
    {
        public UploadGatewayLogRequest()
            : base("sgw", "2018-05-11", "UploadGatewayLog", "hcs_sgw", "openAPI")
        {
        ...
        public override UploadGatewayLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadGatewayLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
