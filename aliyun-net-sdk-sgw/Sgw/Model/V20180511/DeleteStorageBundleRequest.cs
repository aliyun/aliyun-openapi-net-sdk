...
{
    public class DeleteStorageBundleRequest : RpcAcsRequest<DeleteStorageBundleResponse>
    {
        public DeleteStorageBundleRequest()
            : base("sgw", "2018-05-11", "DeleteStorageBundle", "hcs_sgw", "openAPI")
        {
        ...
        public override DeleteStorageBundleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteStorageBundleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
