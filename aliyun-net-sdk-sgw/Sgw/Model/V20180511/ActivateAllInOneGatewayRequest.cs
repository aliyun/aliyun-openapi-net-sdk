...
{
    public class ActivateAllInOneGatewayRequest : RpcAcsRequest<ActivateAllInOneGatewayResponse>
    {
        public ActivateAllInOneGatewayRequest()
            : base("sgw", "2018-05-11", "ActivateAllInOneGateway", "hcs_sgw", "openAPI")
        {
		...
		public string DeviceNumber
		{
			...
			{
				deviceNumber = value;
				DictionaryUtil.Add(QueryParameters, "DeviceNumber", value);
			}
		}
        ...
        public override ActivateAllInOneGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ActivateAllInOneGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
