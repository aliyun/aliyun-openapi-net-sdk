...
{
    public class CreateGatewayLoggingRequest : RpcAcsRequest<CreateGatewayLoggingResponse>
    {
        public CreateGatewayLoggingRequest()
            : base("sgw", "2018-05-11", "CreateGatewayLogging", "hcs_sgw", "openAPI")
        {
        ...
        public override CreateGatewayLoggingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateGatewayLoggingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
