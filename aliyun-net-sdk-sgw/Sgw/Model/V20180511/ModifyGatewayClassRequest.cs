...
{
    public class ModifyGatewayClassRequest : RpcAcsRequest<ModifyGatewayClassResponse>
    {
        public ModifyGatewayClassRequest()
            : base("sgw", "2018-05-11", "ModifyGatewayClass", "hcs_sgw", "openAPI")
        {
        ...
        public override ModifyGatewayClassResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGatewayClassResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
