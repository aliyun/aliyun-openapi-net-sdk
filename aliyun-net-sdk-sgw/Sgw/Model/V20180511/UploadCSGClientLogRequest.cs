...
{
    public class UploadCSGClientLogRequest : RpcAcsRequest<UploadCSGClientLogResponse>
    {
        public UploadCSGClientLogRequest()
            : base("sgw", "2018-05-11", "UploadCSGClientLog", "hcs_sgw", "openAPI")
        {
        ...
        public override UploadCSGClientLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadCSGClientLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
