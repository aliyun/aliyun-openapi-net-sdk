...
{
    public class ReleaseServiceRequest : RpcAcsRequest<ReleaseServiceResponse>
    {
        public ReleaseServiceRequest()
            : base("sgw", "2018-05-11", "ReleaseService", "hcs_sgw", "openAPI")
        {
        ...
        public override ReleaseServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
