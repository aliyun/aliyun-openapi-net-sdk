...
{
    public class DescribeDashboardRequest : RpcAcsRequest<DescribeDashboardResponse>
    {
        public DescribeDashboardRequest()
            : base("sgw", "2018-05-11", "DescribeDashboard", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeDashboardResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDashboardResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
