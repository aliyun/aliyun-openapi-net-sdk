...
{
    public class DescribeGatewayCapacityLimitRequest : RpcAcsRequest<DescribeGatewayCapacityLimitResponse>
    {
        public DescribeGatewayCapacityLimitRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayCapacityLimit", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayCapacityLimitResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayCapacityLimitResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
