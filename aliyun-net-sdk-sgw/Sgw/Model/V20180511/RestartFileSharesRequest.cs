...
{
    public class RestartFileSharesRequest : RpcAcsRequest<RestartFileSharesResponse>
    {
        public RestartFileSharesRequest()
            : base("sgw", "2018-05-11", "RestartFileShares", "hcs_sgw", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "ShareProtocol")]
        ...
        public override RestartFileSharesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestartFileSharesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
