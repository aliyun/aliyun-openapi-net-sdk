...
{
    public class AddSharesToExpressSyncRequest : RpcAcsRequest<AddSharesToExpressSyncResponse>
    {
        public AddSharesToExpressSyncRequest()
            : base("sgw", "2018-05-11", "AddSharesToExpressSync", "hcs_sgw", "openAPI")
        {
        ...
        public override AddSharesToExpressSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddSharesToExpressSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
