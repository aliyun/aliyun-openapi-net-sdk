...
{
    public class DescribeGatewayStockRequest : RpcAcsRequest<DescribeGatewayStockResponse>
    {
        public DescribeGatewayStockRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayStock", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayStockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayStockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
