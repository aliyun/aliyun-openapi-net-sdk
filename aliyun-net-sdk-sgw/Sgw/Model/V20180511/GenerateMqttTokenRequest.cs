...
{
    public class GenerateMqttTokenRequest : RpcAcsRequest<GenerateMqttTokenResponse>
    {
        public GenerateMqttTokenRequest()
            : base("sgw", "2018-05-11", "GenerateMqttToken", "hcs_sgw", "openAPI")
        {
        ...
        public override GenerateMqttTokenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateMqttTokenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
