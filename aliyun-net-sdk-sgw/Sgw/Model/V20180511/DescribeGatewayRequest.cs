...
{
    public class DescribeGatewayRequest : RpcAcsRequest<DescribeGatewayResponse>
    {
        public DescribeGatewayRequest()
            : base("sgw", "2018-05-11", "DescribeGateway", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
