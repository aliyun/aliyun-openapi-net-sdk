...
{
    public class AddTagsToGatewayRequest : RpcAcsRequest<AddTagsToGatewayResponse>
    {
        public AddTagsToGatewayRequest()
            : base("sgw", "2018-05-11", "AddTagsToGateway", "hcs_sgw", "openAPI")
        {
        ...
        public override AddTagsToGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddTagsToGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
