...
{
    public class CreateExpressSyncRequest : RpcAcsRequest<CreateExpressSyncResponse>
    {
        public CreateExpressSyncRequest()
            : base("sgw", "2018-05-11", "CreateExpressSync", "hcs_sgw", "openAPI")
        {
        ...
        public override CreateExpressSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateExpressSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
