...
{
    public class ModifyStorageBundleRequest : RpcAcsRequest<ModifyStorageBundleResponse>
    {
        public ModifyStorageBundleRequest()
            : base("sgw", "2018-05-11", "ModifyStorageBundle", "hcs_sgw", "openAPI")
        {
        ...
        public override ModifyStorageBundleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyStorageBundleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
