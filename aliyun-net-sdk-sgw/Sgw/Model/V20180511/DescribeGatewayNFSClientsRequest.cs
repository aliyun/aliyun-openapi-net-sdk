...
{
    public class DescribeGatewayNFSClientsRequest : RpcAcsRequest<DescribeGatewayNFSClientsResponse>
    {
        public DescribeGatewayNFSClientsRequest()
            : base("sgw", "2018-05-11", "DescribeGatewayNFSClients", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewayNFSClientsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewayNFSClientsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
