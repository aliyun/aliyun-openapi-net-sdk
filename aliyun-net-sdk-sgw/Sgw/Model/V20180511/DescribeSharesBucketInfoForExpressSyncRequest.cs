...
{
    public class DescribeSharesBucketInfoForExpressSyncRequest : RpcAcsRequest<DescribeSharesBucketInfoForExpressSyncResponse>
    {
        public DescribeSharesBucketInfoForExpressSyncRequest()
            : base("sgw", "2018-05-11", "DescribeSharesBucketInfoForExpressSync", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeSharesBucketInfoForExpressSyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSharesBucketInfoForExpressSyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
