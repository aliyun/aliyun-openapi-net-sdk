...
{
    public class CreateGatewayCacheDiskRequest : RpcAcsRequest<CreateGatewayCacheDiskResponse>
    {
        public CreateGatewayCacheDiskRequest()
            : base("sgw", "2018-05-11", "CreateGatewayCacheDisk", "hcs_sgw", "openAPI")
        {
		...
		public long? CacheDiskSizeInGB
		{
			...
			set	
			{
				cacheDiskSizeInGB = value;
				DictionaryUtil.Add(QueryParameters, "CacheDiskSizeInGB", value.ToString());
			}
		}
		...
		public string CacheDiskCategory
		{
			...
			set	
			{
				cacheDiskCategory = value;
				DictionaryUtil.Add(QueryParameters, "CacheDiskCategory", value);
			}
		}
        ...
        public override CreateGatewayCacheDiskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateGatewayCacheDiskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
