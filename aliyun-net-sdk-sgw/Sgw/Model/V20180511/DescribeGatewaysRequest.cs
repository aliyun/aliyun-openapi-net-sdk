...
{
    public class DescribeGatewaysRequest : RpcAcsRequest<DescribeGatewaysResponse>
    {
        public DescribeGatewaysRequest()
            : base("sgw", "2018-05-11", "DescribeGateways", "hcs_sgw", "openAPI")
        {
        ...
        public override DescribeGatewaysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGatewaysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
