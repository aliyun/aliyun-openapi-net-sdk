...
{
    public class EnableGatewayIpv6Request : RpcAcsRequest<EnableGatewayIpv6Response>
    {
        public EnableGatewayIpv6Request()
            : base("sgw", "2018-05-11", "EnableGatewayIpv6", "hcs_sgw", "openAPI")
        {
        ...
        public override EnableGatewayIpv6Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableGatewayIpv6ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
