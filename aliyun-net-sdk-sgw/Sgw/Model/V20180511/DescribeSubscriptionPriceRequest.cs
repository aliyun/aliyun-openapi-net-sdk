...
{
    public class DescribeSubscriptionPriceRequest : RpcAcsRequest<DescribeSubscriptionPriceResponse>
    {
        public DescribeSubscriptionPriceRequest()
            : base("sgw", "2018-05-11", "DescribeSubscriptionPrice", "hcs_sgw", "openAPI")
        {
		...
		public long? CacheSSDSize
		{
			...
			{
				cacheSSDSize = value;
				DictionaryUtil.Add(QueryParameters, "CacheSSDSize", value.ToString());
			}
		}
		...
		public int? PeriodQuantity
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "PeriodQuantity", value.ToString());
			}
		}
		...
		public long? CacheCloudEfficiencySize
		{
			...
			set	
			{
				cacheCloudEfficiencySize = value;
				DictionaryUtil.Add(QueryParameters, "CacheCloudEfficiencySize", value.ToString());
			}
		}

        public override DescribeSubscriptionPriceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSubscriptionPriceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
