...
{
    public class DeployGatewayRequest : RpcAcsRequest<DeployGatewayResponse>
    {
        public DeployGatewayRequest()
            : base("sgw", "2018-05-11", "DeployGateway", "hcs_sgw", "openAPI")
        {
        ...
        public override DeployGatewayResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeployGatewayResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
