...
{
    public class CreateCacheRequest : RpcAcsRequest<CreateCacheResponse>
    {
        public CreateCacheRequest()
            : base("sgw", "2018-05-11", "CreateCache", "hcs_sgw", "openAPI")
        {
        ...
        public override CreateCacheResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCacheResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
