...
{
    public class ReportBlockVolumesRequest : RpcAcsRequest<ReportBlockVolumesResponse>
    {
        public ReportBlockVolumesRequest()
            : base("sgw", "2018-05-11", "ReportBlockVolumes", "hcs_sgw", "openAPI")
        {
        ...
        public override ReportBlockVolumesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReportBlockVolumesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
