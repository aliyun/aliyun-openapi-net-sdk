...
{
    public class StructureAddressRequest : RpcAcsRequest<StructureAddressResponse>
    {
        public StructureAddressRequest()
            : base("address-purification", "2019-11-18", "StructureAddress", "addrp", "openAPI")
        {
        ...
        public override StructureAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StructureAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
