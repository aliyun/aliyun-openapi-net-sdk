...
{
    public class CorrectAddressRequest : RpcAcsRequest<CorrectAddressResponse>
    {
        public CorrectAddressRequest()
            : base("address-purification", "2019-11-18", "CorrectAddress", "addrp", "openAPI")
        {
        ...
        public override CorrectAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CorrectAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
