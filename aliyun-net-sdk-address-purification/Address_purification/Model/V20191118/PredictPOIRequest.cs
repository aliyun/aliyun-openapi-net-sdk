...
{
    public class PredictPOIRequest : RpcAcsRequest<PredictPOIResponse>
    {
        public PredictPOIRequest()
            : base("address-purification", "2019-11-18", "PredictPOI", "addrp", "openAPI")
        {
        ...
        public override PredictPOIResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PredictPOIResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
