...
{
    public class GetAddressDivisionCodeRequest : RpcAcsRequest<GetAddressDivisionCodeResponse>
    {
        public GetAddressDivisionCodeRequest()
            : base("address-purification", "2019-11-18", "GetAddressDivisionCode", "addrp", "openAPI")
        {
        ...
        public override GetAddressDivisionCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddressDivisionCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
