...
{
    public class GetAddressBlockMappingRequest : RpcAcsRequest<GetAddressBlockMappingResponse>
    {
        public GetAddressBlockMappingRequest()
            : base("address-purification", "2019-11-18", "GetAddressBlockMapping", "addrp", "openAPI")
        {
        ...
        public override GetAddressBlockMappingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddressBlockMappingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
