...
{
    public class GetAddressSimilarityRequest : RpcAcsRequest<GetAddressSimilarityResponse>
    {
        public GetAddressSimilarityRequest()
            : base("address-purification", "2019-11-18", "GetAddressSimilarity", "addrp", "openAPI")
        {
        ...
        public override GetAddressSimilarityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddressSimilarityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
