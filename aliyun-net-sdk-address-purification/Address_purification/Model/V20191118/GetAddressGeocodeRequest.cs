...
{
    public class GetAddressGeocodeRequest : RpcAcsRequest<GetAddressGeocodeResponse>
    {
        public GetAddressGeocodeRequest()
            : base("address-purification", "2019-11-18", "GetAddressGeocode", "addrp", "openAPI")
        {
        ...
        public override GetAddressGeocodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddressGeocodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
