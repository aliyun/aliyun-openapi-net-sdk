...
{
    public class ExtractExpressRequest : RpcAcsRequest<ExtractExpressResponse>
    {
        public ExtractExpressRequest()
            : base("address-purification", "2019-11-18", "ExtractExpress", "addrp", "openAPI")
        {
        ...
        public override ExtractExpressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExtractExpressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
