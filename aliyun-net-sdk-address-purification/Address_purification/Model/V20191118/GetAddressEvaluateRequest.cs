...
{
    public class GetAddressEvaluateRequest : RpcAcsRequest<GetAddressEvaluateResponse>
    {
        public GetAddressEvaluateRequest()
            : base("address-purification", "2019-11-18", "GetAddressEvaluate", "addrp", "openAPI")
        {
        ...
        public override GetAddressEvaluateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddressEvaluateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
