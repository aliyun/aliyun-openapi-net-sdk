...
{
    public class GetZipcodeRequest : RpcAcsRequest<GetZipcodeResponse>
    {
        public GetZipcodeRequest()
            : base("address-purification", "2019-11-18", "GetZipcode", "addrp", "openAPI")
        {
        ...
        public override GetZipcodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetZipcodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
