...
{
    public class ExtractAddressRequest : RpcAcsRequest<ExtractAddressResponse>
    {
        public ExtractAddressRequest()
            : base("address-purification", "2019-11-18", "ExtractAddress", "addrp", "openAPI")
        {
        ...
        public override ExtractAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExtractAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
