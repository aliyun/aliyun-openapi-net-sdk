...
{
    public class GetAddressSearchRequest : RpcAcsRequest<GetAddressSearchResponse>
    {
        public GetAddressSearchRequest()
            : base("address-purification", "2019-11-18", "GetAddressSearch", "addrp", "openAPI")
        {
        ...
        public override GetAddressSearchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAddressSearchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
