...
{
    public class GetInputSearchRequest : RpcAcsRequest<GetInputSearchResponse>
    {
        public GetInputSearchRequest()
            : base("address-purification", "2019-11-18", "GetInputSearch", "addrp", "openAPI")
        {
        ...
        public override GetInputSearchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInputSearchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
