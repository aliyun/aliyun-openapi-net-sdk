...
{
    public class TransferCoordRequest : RpcAcsRequest<TransferCoordResponse>
    {
        public TransferCoordRequest()
            : base("address-purification", "2019-11-18", "TransferCoord", "addrp", "openAPI")
        {
		...
		public string SrcCoord
		{
			...
			{
				srcCoord = value;
				DictionaryUtil.Add(BodyParameters, "SrcCoord", value);
			}
		}
        ...
        public override TransferCoordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TransferCoordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
