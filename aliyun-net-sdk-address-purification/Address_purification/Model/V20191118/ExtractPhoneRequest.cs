...
{
    public class ExtractPhoneRequest : RpcAcsRequest<ExtractPhoneResponse>
    {
        public ExtractPhoneRequest()
            : base("address-purification", "2019-11-18", "ExtractPhone", "addrp", "openAPI")
        {
        ...
        public override ExtractPhoneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExtractPhoneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
