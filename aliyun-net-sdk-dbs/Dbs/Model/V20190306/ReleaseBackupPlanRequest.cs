...
{
    public class ReleaseBackupPlanRequest : RpcAcsRequest<ReleaseBackupPlanResponse>
    {
        public ReleaseBackupPlanRequest()
            : base("Dbs", "2019-03-06", "ReleaseBackupPlan", "cbs", "openAPI")
        {
        ...
        public override ReleaseBackupPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseBackupPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
