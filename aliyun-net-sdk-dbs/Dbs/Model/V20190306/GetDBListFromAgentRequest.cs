...
{
    public class GetDBListFromAgentRequest : RpcAcsRequest<GetDBListFromAgentResponse>
    {
        public GetDBListFromAgentRequest()
            : base("Dbs", "2019-03-06", "GetDBListFromAgent", "cbs", "openAPI")
        {
        ...
        public override GetDBListFromAgentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDBListFromAgentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
