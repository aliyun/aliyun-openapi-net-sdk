...
{
    public class DisableBackupLogRequest : RpcAcsRequest<DisableBackupLogResponse>
    {
        public DisableBackupLogRequest()
            : base("Dbs", "2019-03-06", "DisableBackupLog", "cbs", "openAPI")
        {
        ...
        public override DisableBackupLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableBackupLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
