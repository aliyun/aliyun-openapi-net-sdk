...
{
    public class GetIncomeStatementInfoRequest : RpcAcsRequest<GetIncomeStatementInfoResponse>
    {
        public GetIncomeStatementInfoRequest()
            : base("companyreg", "2020-10-22", "GetIncomeStatementInfo", "companyreg", "openAPI")
        {
        ...
        public override GetIncomeStatementInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetIncomeStatementInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
