...
{
    public class SaveOpeningBalanceStatusRequest : RpcAcsRequest<SaveOpeningBalanceStatusResponse>
    {
        public SaveOpeningBalanceStatusRequest()
            : base("companyreg", "2020-10-22", "SaveOpeningBalanceStatus", "companyreg", "openAPI")
        {
		...
		public string OpeningBalanceStatus
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "OpeningBalanceStatus", value);
			}
		}
        ...
        public override SaveOpeningBalanceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveOpeningBalanceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
