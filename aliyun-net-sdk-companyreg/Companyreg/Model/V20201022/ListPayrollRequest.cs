...
{
    public class ListPayrollRequest : RpcAcsRequest<ListPayrollResponse>
    {
        public ListPayrollRequest()
            : base("companyreg", "2020-10-22", "ListPayroll", "companyreg", "openAPI")
        {
        ...
        public override ListPayrollResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPayrollResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
