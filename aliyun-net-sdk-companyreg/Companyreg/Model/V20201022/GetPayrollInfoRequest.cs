...
{
    public class GetPayrollInfoRequest : RpcAcsRequest<GetPayrollInfoResponse>
    {
        public GetPayrollInfoRequest()
            : base("companyreg", "2020-10-22", "GetPayrollInfo", "companyreg", "openAPI")
        {
        ...
        public override GetPayrollInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPayrollInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
