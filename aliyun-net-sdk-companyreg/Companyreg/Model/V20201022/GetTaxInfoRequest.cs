...
{
    public class GetTaxInfoRequest : RpcAcsRequest<GetTaxInfoResponse>
    {
        public GetTaxInfoRequest()
            : base("companyreg", "2020-10-22", "GetTaxInfo", "companyreg", "openAPI")
        {
		...
		public string CityArea
		{
			...
			{
				cityArea = value;
				DictionaryUtil.Add(QueryParameters, "CityArea", value);
			}
		}
		...
		public string Periods
		{
			...
			{
				periods = value;
				DictionaryUtil.Add(QueryParameters, "Periods", value);
			}
		}
        ...
        public override GetTaxInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTaxInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
