...
{
    public class GetTaxationInfoRequest : RpcAcsRequest<GetTaxationInfoResponse>
    {
        public GetTaxationInfoRequest()
            : base("companyreg", "2020-10-22", "GetTaxationInfo", "companyreg", "openAPI")
        {
        ...
        public override GetTaxationInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTaxationInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
