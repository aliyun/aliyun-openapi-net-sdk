...
{
    public class GetCashFlowInfoRequest : RpcAcsRequest<GetCashFlowInfoResponse>
    {
        public GetCashFlowInfoRequest()
            : base("companyreg", "2020-10-22", "GetCashFlowInfo", "companyreg", "openAPI")
        {
        ...
        public override GetCashFlowInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCashFlowInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
