...
{
    public class GetInitFlowRequest : RpcAcsRequest<GetInitFlowResponse>
    {
        public GetInitFlowRequest()
            : base("companyreg", "2020-10-22", "GetInitFlow", "companyreg", "openAPI")
        {
        ...
        public override GetInitFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInitFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
