...
{
    public class ClearTrailDataRequest : RpcAcsRequest<ClearTrailDataResponse>
    {
        public ClearTrailDataRequest()
            : base("companyreg", "2020-10-22", "ClearTrailData", "companyreg", "openAPI")
        {
        ...
        public override ClearTrailDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ClearTrailDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
