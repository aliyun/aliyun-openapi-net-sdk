...
{
    public class UpdateTaxationProcessRequest : RpcAcsRequest<UpdateTaxationProcessResponse>
    {
        public UpdateTaxationProcessRequest()
            : base("companyreg", "2020-10-22", "UpdateTaxationProcess", "companyreg", "openAPI")
        {
		...
		public string TargetProcess
		{
			...
			{
				targetProcess = value;
				DictionaryUtil.Add(QueryParameters, "TargetProcess", value);
			}
		}
        ...
        public override UpdateTaxationProcessResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTaxationProcessResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
