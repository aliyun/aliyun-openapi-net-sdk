...
{
    public class GetServiceInfoRequest : RpcAcsRequest<GetServiceInfoResponse>
    {
        public GetServiceInfoRequest()
            : base("companyreg", "2020-10-22", "GetServiceInfo", "companyreg", "openAPI")
        {
        ...
        public override GetServiceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetServiceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
