...
{
    public class GetQuarterCashFlowInfoRequest : RpcAcsRequest<GetQuarterCashFlowInfoResponse>
    {
        public GetQuarterCashFlowInfoRequest()
            : base("companyreg", "2020-10-22", "GetQuarterCashFlowInfo", "companyreg", "openAPI")
        {
        ...
        public override GetQuarterCashFlowInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQuarterCashFlowInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
