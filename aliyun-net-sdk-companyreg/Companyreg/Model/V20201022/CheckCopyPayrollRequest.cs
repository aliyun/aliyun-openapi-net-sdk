...
{
    public class CheckCopyPayrollRequest : RpcAcsRequest<CheckCopyPayrollResponse>
    {
        public CheckCopyPayrollRequest()
            : base("companyreg", "2020-10-22", "CheckCopyPayroll", "companyreg", "openAPI")
        {
        ...
        public override CheckCopyPayrollResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckCopyPayrollResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
