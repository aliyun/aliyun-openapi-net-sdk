...
{
    public class ConvertFeeRequest : RpcAcsRequest<ConvertFeeResponse>
    {
        public ConvertFeeRequest()
            : base("companyreg", "2020-10-22", "ConvertFee", "companyreg", "openAPI")
        {
        ...
        public override ConvertFeeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConvertFeeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
