...
{
    public class GetPayrollSettingRequest : RpcAcsRequest<GetPayrollSettingResponse>
    {
        public GetPayrollSettingRequest()
            : base("companyreg", "2020-10-22", "GetPayrollSetting", "companyreg", "openAPI")
        {
        ...
        public override GetPayrollSettingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPayrollSettingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
