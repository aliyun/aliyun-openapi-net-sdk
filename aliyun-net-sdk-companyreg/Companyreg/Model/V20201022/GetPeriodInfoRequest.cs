...
{
    public class GetPeriodInfoRequest : RpcAcsRequest<GetPeriodInfoResponse>
    {
        public GetPeriodInfoRequest()
            : base("companyreg", "2020-10-22", "GetPeriodInfo", "companyreg", "openAPI")
        {
        ...
        public override GetPeriodInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPeriodInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
