...
{
    public class GetTypeListRequest : RpcAcsRequest<GetTypeListResponse>
    {
        public GetTypeListRequest()
            : base("companyreg", "2020-10-22", "GetTypeList", "companyreg", "openAPI")
        {
        ...
        public override GetTypeListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTypeListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
