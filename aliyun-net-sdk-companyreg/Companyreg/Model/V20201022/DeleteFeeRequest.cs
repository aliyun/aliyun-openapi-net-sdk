...
{
    public class DeleteFeeRequest : RpcAcsRequest<DeleteFeeResponse>
    {
        public DeleteFeeRequest()
            : base("companyreg", "2020-10-22", "DeleteFee", "companyreg", "openAPI")
        {
        ...
        public override DeleteFeeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFeeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
