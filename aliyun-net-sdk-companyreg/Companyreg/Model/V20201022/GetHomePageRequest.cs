...
{
    public class GetHomePageRequest : RpcAcsRequest<GetHomePageResponse>
    {
        public GetHomePageRequest()
            : base("companyreg", "2020-10-22", "GetHomePage", "companyreg", "openAPI")
        {
        ...
        public override GetHomePageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetHomePageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
