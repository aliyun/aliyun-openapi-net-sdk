...
{
    public class GetTaxationCalendarRequest : RpcAcsRequest<GetTaxationCalendarResponse>
    {
        public GetTaxationCalendarRequest()
            : base("companyreg", "2020-10-22", "GetTaxationCalendar", "companyreg", "openAPI")
        {
        ...
        public override GetTaxationCalendarResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTaxationCalendarResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
