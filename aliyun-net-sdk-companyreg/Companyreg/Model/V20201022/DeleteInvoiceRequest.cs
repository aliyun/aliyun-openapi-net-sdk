...
{
    public class DeleteInvoiceRequest : RpcAcsRequest<DeleteInvoiceResponse>
    {
        public DeleteInvoiceRequest()
            : base("companyreg", "2020-10-22", "DeleteInvoice", "companyreg", "openAPI")
        {
        ...
        public override DeleteInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
