...
{
    public class CopyPayrollRequest : RpcAcsRequest<CopyPayrollResponse>
    {
        public CopyPayrollRequest()
            : base("companyreg", "2020-10-22", "CopyPayroll", "companyreg", "openAPI")
        {
        ...
        public override CopyPayrollResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CopyPayrollResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
