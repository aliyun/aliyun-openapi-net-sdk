...
{
    public class GetOssStsRequest : RpcAcsRequest<GetOssStsResponse>
    {
        public GetOssStsRequest()
            : base("companyreg", "2020-10-22", "GetOssSts", "companyreg", "openAPI")
        {
        ...
        public override GetOssStsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOssStsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
