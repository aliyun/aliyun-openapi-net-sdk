...
{
    public class GetVoucherCountRequest : RpcAcsRequest<GetVoucherCountResponse>
    {
        public GetVoucherCountRequest()
            : base("companyreg", "2020-10-22", "GetVoucherCount", "companyreg", "openAPI")
        {
        ...
        public override GetVoucherCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVoucherCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
