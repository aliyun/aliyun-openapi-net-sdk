...
{
    public class ListInvoiceRequest : RpcAcsRequest<ListInvoiceResponse>
    {
        public ListInvoiceRequest()
            : base("companyreg", "2020-10-22", "ListInvoice", "companyreg", "openAPI")
        {
        ...
        public override ListInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
