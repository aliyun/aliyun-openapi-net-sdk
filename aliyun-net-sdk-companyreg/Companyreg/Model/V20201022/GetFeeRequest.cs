...
{
    public class GetFeeRequest : RpcAcsRequest<GetFeeResponse>
    {
        public GetFeeRequest()
            : base("companyreg", "2020-10-22", "GetFee", "companyreg", "openAPI")
        {
        ...
        public override GetFeeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFeeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
