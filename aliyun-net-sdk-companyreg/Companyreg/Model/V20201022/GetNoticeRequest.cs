...
{
    public class GetNoticeRequest : RpcAcsRequest<GetNoticeResponse>
    {
        public GetNoticeRequest()
            : base("companyreg", "2020-10-22", "GetNotice", "companyreg", "openAPI")
        {
        ...
        public override GetNoticeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNoticeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
