...
{
    public class ListLastMonthInvoiceRequest : RpcAcsRequest<ListLastMonthInvoiceResponse>
    {
        public ListLastMonthInvoiceRequest()
            : base("companyreg", "2020-10-22", "ListLastMonthInvoice", "companyreg", "openAPI")
        {
        ...
        public override ListLastMonthInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLastMonthInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
