...
{
    public class SavePayrollRequest : RpcAcsRequest<SavePayrollResponse>
    {
        public SavePayrollRequest()
            : base("companyreg", "2020-10-22", "SavePayroll", "companyreg", "openAPI")
        {
        ...
        public override SavePayrollResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SavePayrollResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
