...
{
    public class ListEnterprisesRequest : RpcAcsRequest<ListEnterprisesResponse>
    {
        public ListEnterprisesRequest()
            : base("companyreg", "2020-10-22", "ListEnterprises", "companyreg", "openAPI")
        {
        ...
        public override ListEnterprisesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListEnterprisesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
