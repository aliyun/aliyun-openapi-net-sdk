...
{
    public class DeletePayrollRequest : RpcAcsRequest<DeletePayrollResponse>
    {
        public DeletePayrollRequest()
            : base("companyreg", "2020-10-22", "DeletePayroll", "companyreg", "openAPI")
        {
        ...
        public override DeletePayrollResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePayrollResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
