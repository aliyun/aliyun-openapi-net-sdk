...
{
    public class RefreshCustomerInfoRequest : RpcAcsRequest<RefreshCustomerInfoResponse>
    {
        public RefreshCustomerInfoRequest()
            : base("companyreg", "2020-10-22", "RefreshCustomerInfo", "companyreg", "openAPI")
        {
        ...
        public override RefreshCustomerInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RefreshCustomerInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
