...
{
    public class GetQuarterIncomeStatementInfoRequest : RpcAcsRequest<GetQuarterIncomeStatementInfoResponse>
    {
        public GetQuarterIncomeStatementInfoRequest()
            : base("companyreg", "2020-10-22", "GetQuarterIncomeStatementInfo", "companyreg", "openAPI")
        {
		...
		public bool? IsQuarter
		{
			...
			{
				isQuarter = value;
				DictionaryUtil.Add(QueryParameters, "IsQuarter", value.ToString());
			}
		}
        ...
        public override GetQuarterIncomeStatementInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQuarterIncomeStatementInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
