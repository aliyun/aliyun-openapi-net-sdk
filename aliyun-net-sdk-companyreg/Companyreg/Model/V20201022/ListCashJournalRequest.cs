...
{
    public class ListCashJournalRequest : RpcAcsRequest<ListCashJournalResponse>
    {
        public ListCashJournalRequest()
            : base("companyreg", "2020-10-22", "ListCashJournal", "companyreg", "openAPI")
        {
        ...
        public override ListCashJournalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCashJournalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
