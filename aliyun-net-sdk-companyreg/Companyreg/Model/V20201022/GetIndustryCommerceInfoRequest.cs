...
{
    public class GetIndustryCommerceInfoRequest : RpcAcsRequest<GetIndustryCommerceInfoResponse>
    {
        public GetIndustryCommerceInfoRequest()
            : base("companyreg", "2020-10-22", "GetIndustryCommerceInfo", "companyreg", "openAPI")
        {
        ...
        public override GetIndustryCommerceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetIndustryCommerceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
