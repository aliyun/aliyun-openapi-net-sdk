...
{
    public class GetInvoiceInfoRequest : RpcAcsRequest<GetInvoiceInfoResponse>
    {
        public GetInvoiceInfoRequest()
            : base("companyreg", "2020-10-22", "GetInvoiceInfo", "companyreg", "openAPI")
        {
        ...
        public override GetInvoiceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInvoiceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
