...
{
    public class VerifyTaxSmsCodeRequest : RpcAcsRequest<VerifyTaxSmsCodeResponse>
    {
        public VerifyTaxSmsCodeRequest()
            : base("companyreg", "2020-10-22", "VerifyTaxSmsCode", "companyreg", "openAPI")
        {
        ...
        public override VerifyTaxSmsCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VerifyTaxSmsCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
