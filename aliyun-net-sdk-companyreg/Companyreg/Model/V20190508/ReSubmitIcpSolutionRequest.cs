...
{
    public class ReSubmitIcpSolutionRequest : RpcAcsRequest<ReSubmitIcpSolutionResponse>
    {
        public ReSubmitIcpSolutionRequest()
            : base("companyreg", "2019-05-08", "ReSubmitIcpSolution", "companyreg", "openAPI")
        {
        ...
        public override ReSubmitIcpSolutionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReSubmitIcpSolutionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
