...
{
    public class ConfirmIcpIntentionRequest : RpcAcsRequest<ConfirmIcpIntentionResponse>
    {
        public ConfirmIcpIntentionRequest()
            : base("companyreg", "2019-05-08", "ConfirmIcpIntention", "companyreg", "openAPI")
        {
		...
		public string BizIds
		{
			...
			{
				bizIds = value;
				DictionaryUtil.Add(QueryParameters, "BizIds", value);
			}
		}
        ...
        public override ConfirmIcpIntentionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfirmIcpIntentionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
