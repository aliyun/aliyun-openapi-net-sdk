...
{
    public class QueryBookkeepingCommodityModulesRequest : RpcAcsRequest<QueryBookkeepingCommodityModulesResponse>
    {
        public QueryBookkeepingCommodityModulesRequest()
            : base("companyreg", "2019-05-08", "QueryBookkeepingCommodityModules", "companyreg", "openAPI")
        {
        ...
        public override QueryBookkeepingCommodityModulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryBookkeepingCommodityModulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
