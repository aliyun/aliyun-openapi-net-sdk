...
{
    public class UpdateBookkeepingOrgRequest : RpcAcsRequest<UpdateBookkeepingOrgResponse>
    {
        public UpdateBookkeepingOrgRequest()
            : base("companyreg", "2019-05-08", "UpdateBookkeepingOrg", "companyreg", "openAPI")
        {
        }
        ...
        public override UpdateBookkeepingOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateBookkeepingOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
