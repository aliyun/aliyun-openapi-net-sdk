...
{
    public class UpdateProduceRequest : RpcAcsRequest<UpdateProduceResponse>
    {
        public UpdateProduceRequest()
            : base("companyreg", "2019-05-08", "UpdateProduce", "companyreg", "openAPI")
        {
		...
		public string ExtendMessage
		{
			...
			{
				extendMessage = value;
				DictionaryUtil.Add(QueryParameters, "ExtendMessage", value);
			}
		}
        ...
        public override UpdateProduceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateProduceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
