...
{
    public class ListUserIntentionNotesRequest : RpcAcsRequest<ListUserIntentionNotesResponse>
    {
        public ListUserIntentionNotesRequest()
            : base("companyreg", "2020-03-06", "ListUserIntentionNotes", "companyreg", "openAPI")
        {
        ...
        public override ListUserIntentionNotesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserIntentionNotesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
