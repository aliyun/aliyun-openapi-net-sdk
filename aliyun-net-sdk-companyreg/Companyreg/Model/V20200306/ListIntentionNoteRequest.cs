...
{
    public class ListIntentionNoteRequest : RpcAcsRequest<ListIntentionNoteResponse>
    {
        public ListIntentionNoteRequest()
            : base("companyreg", "2020-03-06", "ListIntentionNote", "companyreg", "openAPI")
        {
        ...
        public override ListIntentionNoteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListIntentionNoteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
