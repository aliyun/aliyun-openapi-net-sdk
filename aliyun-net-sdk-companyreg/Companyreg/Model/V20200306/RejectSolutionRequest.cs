...
{
    public class RejectSolutionRequest : RpcAcsRequest<RejectSolutionResponse>
    {
        public RejectSolutionRequest()
            : base("companyreg", "2020-03-06", "RejectSolution", "companyreg", "openAPI")
        {
        ...
        public override RejectSolutionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RejectSolutionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
