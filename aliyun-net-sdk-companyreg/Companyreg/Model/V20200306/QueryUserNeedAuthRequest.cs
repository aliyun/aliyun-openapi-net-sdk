...
{
    public class QueryUserNeedAuthRequest : RpcAcsRequest<QueryUserNeedAuthResponse>
    {
        public QueryUserNeedAuthRequest()
            : base("companyreg", "2020-03-06", "QueryUserNeedAuth", "companyreg", "openAPI")
        {
        ...
        public override QueryUserNeedAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUserNeedAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
