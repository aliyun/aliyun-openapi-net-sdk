...
{
    public class ListUserSolutionsRequest : RpcAcsRequest<ListUserSolutionsResponse>
    {
        public ListUserSolutionsRequest()
            : base("companyreg", "2020-03-06", "ListUserSolutions", "companyreg", "openAPI")
        {
        ...
        public override ListUserSolutionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserSolutionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
