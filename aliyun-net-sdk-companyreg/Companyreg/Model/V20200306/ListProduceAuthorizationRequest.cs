...
{
    public class ListProduceAuthorizationRequest : RpcAcsRequest<ListProduceAuthorizationResponse>
    {
        public ListProduceAuthorizationRequest()
            : base("companyreg", "2020-03-06", "ListProduceAuthorization", "companyreg", "openAPI")
        {
        ...
        public override ListProduceAuthorizationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProduceAuthorizationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
