...
{
    public class PutMeasureDataRequest : RpcAcsRequest<PutMeasureDataResponse>
    {
        public PutMeasureDataRequest()
            : base("companyreg", "2020-03-06", "PutMeasureData", "companyreg", "openAPI")
        {
        ...
        public override PutMeasureDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PutMeasureDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
