...
{
    public class QueryBagRemainingRequest : RpcAcsRequest<QueryBagRemainingResponse>
    {
        public QueryBagRemainingRequest()
            : base("companyreg", "2020-03-06", "QueryBagRemaining", "companyreg", "openAPI")
        {
        ...
        public override QueryBagRemainingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryBagRemainingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
