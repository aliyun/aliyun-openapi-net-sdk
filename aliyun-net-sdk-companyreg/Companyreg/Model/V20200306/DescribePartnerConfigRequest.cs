...
{
    public class DescribePartnerConfigRequest : RpcAcsRequest<DescribePartnerConfigResponse>
    {
        public DescribePartnerConfigRequest()
            : base("companyreg", "2020-03-06", "DescribePartnerConfig", "companyreg", "openAPI")
        {
        ...
        public override DescribePartnerConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePartnerConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
