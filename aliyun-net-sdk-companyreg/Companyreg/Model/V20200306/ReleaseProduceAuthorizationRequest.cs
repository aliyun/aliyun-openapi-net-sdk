...
{
    public class ReleaseProduceAuthorizationRequest : RpcAcsRequest<ReleaseProduceAuthorizationResponse>
    {
        public ReleaseProduceAuthorizationRequest()
            : base("companyreg", "2020-03-06", "ReleaseProduceAuthorization", "companyreg", "openAPI")
        {
		...
		public string AuthorizedUserId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "AuthorizedUserId", value);
			}
		}
        ...
        public override ReleaseProduceAuthorizationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseProduceAuthorizationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
