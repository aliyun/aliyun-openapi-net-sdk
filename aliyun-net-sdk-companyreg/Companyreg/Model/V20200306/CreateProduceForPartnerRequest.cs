...
{
    public class CreateProduceForPartnerRequest : RpcAcsRequest<CreateProduceForPartnerResponse>
    {
        public CreateProduceForPartnerRequest()
            : base("companyreg", "2020-03-06", "CreateProduceForPartner", "companyreg", "openAPI")
        {
        ...
        public override CreateProduceForPartnerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateProduceForPartnerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
