...
{
    public class CloseUserIntentionRequest : RpcAcsRequest<CloseUserIntentionResponse>
    {
        public CloseUserIntentionRequest()
            : base("companyreg", "2020-03-06", "CloseUserIntention", "companyreg", "openAPI")
        {
        ...
        public override CloseUserIntentionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseUserIntentionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
