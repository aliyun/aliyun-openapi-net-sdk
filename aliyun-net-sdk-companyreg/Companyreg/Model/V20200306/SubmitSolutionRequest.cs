...
{
    public class SubmitSolutionRequest : RpcAcsRequest<SubmitSolutionResponse>
    {
        public SubmitSolutionRequest()
            : base("companyreg", "2020-03-06", "SubmitSolution", "companyreg", "openAPI")
        {
        ...
        public override SubmitSolutionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitSolutionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
