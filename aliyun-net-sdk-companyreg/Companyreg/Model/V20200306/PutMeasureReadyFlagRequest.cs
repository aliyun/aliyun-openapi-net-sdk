...
{
    public class PutMeasureReadyFlagRequest : RpcAcsRequest<PutMeasureReadyFlagResponse>
    {
        public PutMeasureReadyFlagRequest()
            : base("companyreg", "2020-03-06", "PutMeasureReadyFlag", "companyreg", "openAPI")
        {
		...
		public string ReadyFlag
		{
			...
			{
				readyFlag = value;
				DictionaryUtil.Add(QueryParameters, "ReadyFlag", value);
			}
		}
        ...
        public override PutMeasureReadyFlagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PutMeasureReadyFlagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
