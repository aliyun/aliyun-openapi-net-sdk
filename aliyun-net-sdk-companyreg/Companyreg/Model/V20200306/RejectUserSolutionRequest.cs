...
{
    public class RejectUserSolutionRequest : RpcAcsRequest<RejectUserSolutionResponse>
    {
        public RejectUserSolutionRequest()
            : base("companyreg", "2020-03-06", "RejectUserSolution", "companyreg", "openAPI")
        {
        ...
        public override RejectUserSolutionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RejectUserSolutionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
