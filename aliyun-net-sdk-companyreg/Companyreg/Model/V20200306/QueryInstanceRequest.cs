...
{
    public class QueryInstanceRequest : RpcAcsRequest<QueryInstanceResponse>
    {
        public QueryInstanceRequest()
            : base("companyreg", "2020-03-06", "QueryInstance", "companyreg", "openAPI")
        {
        ...
        public override QueryInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
