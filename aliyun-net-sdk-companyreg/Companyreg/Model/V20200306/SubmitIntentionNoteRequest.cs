...
{
    public class SubmitIntentionNoteRequest : RpcAcsRequest<SubmitIntentionNoteResponse>
    {
        public SubmitIntentionNoteRequest()
            : base("companyreg", "2020-03-06", "SubmitIntentionNote", "companyreg", "openAPI")
        {
        ...
        public override SubmitIntentionNoteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitIntentionNoteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
