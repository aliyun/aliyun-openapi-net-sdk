...
{
    public class QueryCommodityConfigRequest : RpcAcsRequest<QueryCommodityConfigResponse>
    {
        public QueryCommodityConfigRequest()
            : base("companyreg", "2020-03-06", "QueryCommodityConfig", "companyreg", "openAPI")
        {
		...
		public bool? QueryModule
		{
			...
			{
				queryModule = value;
				DictionaryUtil.Add(QueryParameters, "QueryModule", value.ToString());
			}
		}
        ...
        public override QueryCommodityConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryCommodityConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
