...
{
    public class BindProduceAuthorizationRequest : RpcAcsRequest<BindProduceAuthorizationResponse>
    {
        public BindProduceAuthorizationRequest()
            : base("companyreg", "2020-03-06", "BindProduceAuthorization", "companyreg", "openAPI")
        {
		...
		public string AuthorizedUserIds
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "AuthorizedUserIds", value);
			}
		}
        ...
        public override BindProduceAuthorizationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindProduceAuthorizationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
