...
{
    public class OperateProduceForPartnerRequest : RpcAcsRequest<OperateProduceForPartnerResponse>
    {
        public OperateProduceForPartnerRequest()
            : base("companyreg", "2020-03-06", "OperateProduceForPartner", "companyreg", "openAPI")
        {
        ...
        public override OperateProduceForPartnerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OperateProduceForPartnerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
