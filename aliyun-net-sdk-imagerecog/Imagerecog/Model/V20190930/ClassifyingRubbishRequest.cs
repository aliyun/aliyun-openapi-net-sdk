...
namespace Aliyun.Acs.imagerecog.Model.V20190930
{
    public class ClassifyingRubbishRequest : RpcAcsRequest<ClassifyingRubbishResponse>
    {
        ...
        public override ClassifyingRubbishResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ClassifyingRubbishResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
