...
namespace Aliyun.Acs.imagerecog.Model.V20190930
{
	public class RecognizeFoodResponse : AcsResponse
	{
		...
		public RecognizeFood_Data Data
		{
			get
			{
				return data;
		...
		public class RecognizeFood_Data
		{

			private List<RecognizeFood_TopFivesItem> topFives;

			public List<RecognizeFood_TopFivesItem> TopFives
			{
				get
				{
					return topFives;
