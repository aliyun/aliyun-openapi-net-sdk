...
{
    public class RecognizeSceneRequest : RpcAcsRequest<RecognizeSceneResponse>
    {
        public RecognizeSceneRequest()
            : base("imagerecog", "2019-09-30", "RecognizeScene", "imagerecog", "openAPI")
        {
        ...
        public override RecognizeSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
