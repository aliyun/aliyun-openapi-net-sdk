...
{
    public class DetectFruitsRequest : RpcAcsRequest<DetectFruitsResponse>
    {
        public DetectFruitsRequest()
            : base("imagerecog", "2019-09-30", "DetectFruits", "imagerecog", "openAPI")
        {
        ...
        public override DetectFruitsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectFruitsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
