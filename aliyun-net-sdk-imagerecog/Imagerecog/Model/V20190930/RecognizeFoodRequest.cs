...
{
    public class RecognizeFoodRequest : RpcAcsRequest<RecognizeFoodResponse>
    {
        public RecognizeFoodRequest()
            : base("imagerecog", "2019-09-30", "RecognizeFood", "imagerecog", "openAPI")
        {
        ...
        public override RecognizeFoodResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeFoodResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
