...
{
    public class EvaluateCertificateQualityRequest : RpcAcsRequest<EvaluateCertificateQualityResponse>
    {
        public EvaluateCertificateQualityRequest()
            : base("imagerecog", "2019-09-30", "EvaluateCertificateQuality", "imagerecog", "openAPI")
        {
        ...
        public override EvaluateCertificateQualityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EvaluateCertificateQualityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
