...
namespace Aliyun.Acs.alikafka.Model.V20190916
{
    public class ReleaseInstanceRequest : RpcAcsRequest<ReleaseInstanceResponse>
    {
        public ReleaseInstanceRequest()
            : base("alikafka", "2019-09-16", "ReleaseInstance", "alikafka", "openAPI")
        {
		...
		private bool? forceDeleteInstance;

		private string instanceId;

		public bool? ForceDeleteInstance
		{
			get
			{
			...
			set	
			{
				forceDeleteInstance = value;
				DictionaryUtil.Add(QueryParameters, "ForceDeleteInstance", value.ToString());
			}
		}
