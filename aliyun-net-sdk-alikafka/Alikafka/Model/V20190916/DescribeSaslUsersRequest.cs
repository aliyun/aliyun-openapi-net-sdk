...
{
    public class DescribeSaslUsersRequest : RpcAcsRequest<DescribeSaslUsersResponse>
    {
        public DescribeSaslUsersRequest()
            : base("alikafka", "2019-09-16", "DescribeSaslUsers", "alikafka", "openAPI")
        {
        ...
        public override DescribeSaslUsersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSaslUsersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
