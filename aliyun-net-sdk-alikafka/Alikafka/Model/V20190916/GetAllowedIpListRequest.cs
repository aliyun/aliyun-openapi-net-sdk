...
{
    public class GetAllowedIpListRequest : RpcAcsRequest<GetAllowedIpListResponse>
    {
        public GetAllowedIpListRequest()
            : base("alikafka", "2019-09-16", "GetAllowedIpList", "alikafka", "openAPI")
        {
        ...
        public override GetAllowedIpListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAllowedIpListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
