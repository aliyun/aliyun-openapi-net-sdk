...
{
    public class DeleteSaslUserRequest : RpcAcsRequest<DeleteSaslUserResponse>
    {
        public DeleteSaslUserRequest()
            : base("alikafka", "2019-09-16", "DeleteSaslUser", "alikafka", "openAPI")
        {
        ...
        public override DeleteSaslUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSaslUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
