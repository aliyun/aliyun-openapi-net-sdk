...
namespace Aliyun.Acs.alikafka.Model.V20190916
{
    public class CreateAclRequest : RpcAcsRequest<CreateAclResponse>
    {
        public CreateAclRequest()
            : base("alikafka", "2019-09-16", "CreateAcl", "alikafka", "openAPI")
        {
		...
		public string AclResourcePatternType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AclResourcePatternType", value);
			}
		}
		...
		public string AclResourceType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AclResourceType", value);
			}
		}
		...
		public string AclOperationType
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AclOperationType", value);
			}
		}
		...
		public string AclResourceName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AclResourceName", value);
			}
		}
