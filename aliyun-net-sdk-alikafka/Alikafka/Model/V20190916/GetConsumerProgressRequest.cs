...
{
    public class GetConsumerProgressRequest : RpcAcsRequest<GetConsumerProgressResponse>
    {
        public GetConsumerProgressRequest()
            : base("alikafka", "2019-09-16", "GetConsumerProgress", "alikafka", "openAPI")
        {
        ...
        public override GetConsumerProgressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetConsumerProgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
