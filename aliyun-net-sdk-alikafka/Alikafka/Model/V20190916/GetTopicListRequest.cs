...
{
    public class GetTopicListRequest : RpcAcsRequest<GetTopicListResponse>
    {
        public GetTopicListRequest()
            : base("alikafka", "2019-09-16", "GetTopicList", "alikafka", "openAPI")
        {
        ...
        public override GetTopicListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTopicListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
