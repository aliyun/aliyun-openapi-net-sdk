...
{
    public class ConvertPostPayOrderRequest : RpcAcsRequest<ConvertPostPayOrderResponse>
    {
        public ConvertPostPayOrderRequest()
            : base("alikafka", "2019-09-16", "ConvertPostPayOrder", "alikafka", "openAPI")
        {
        ...
        public override ConvertPostPayOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConvertPostPayOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
