...
{
    public class GetTopicStatusRequest : RpcAcsRequest<GetTopicStatusResponse>
    {
        public GetTopicStatusRequest()
            : base("alikafka", "2019-09-16", "GetTopicStatus", "alikafka", "openAPI")
        {
        ...
        public override GetTopicStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTopicStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
