...
{
    public class DeleteTopicRequest : RpcAcsRequest<DeleteTopicResponse>
    {
        public DeleteTopicRequest()
            : base("alikafka", "2019-09-16", "DeleteTopic", "alikafka", "openAPI")
        {
        ...
        public override DeleteTopicResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTopicResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
