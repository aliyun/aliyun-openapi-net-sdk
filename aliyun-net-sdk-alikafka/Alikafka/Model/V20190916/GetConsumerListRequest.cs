...
{
    public class GetConsumerListRequest : RpcAcsRequest<GetConsumerListResponse>
    {
        public GetConsumerListRequest()
            : base("alikafka", "2019-09-16", "GetConsumerList", "alikafka", "openAPI")
        {
        ...
        public override GetConsumerListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetConsumerListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
