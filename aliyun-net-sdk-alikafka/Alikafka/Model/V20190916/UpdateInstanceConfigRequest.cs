...
{
    public class UpdateInstanceConfigRequest : RpcAcsRequest<UpdateInstanceConfigResponse>
    {
        public UpdateInstanceConfigRequest()
            : base("alikafka", "2019-09-16", "UpdateInstanceConfig", "alikafka", "openAPI")
        {
        ...
        public override UpdateInstanceConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateInstanceConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
