...
{
    public class CreatePrePayOrderRequest : RpcAcsRequest<CreatePrePayOrderResponse>
    {
        public CreatePrePayOrderRequest()
            : base("alikafka", "2019-09-16", "CreatePrePayOrder", "alikafka", "openAPI")
        {
        ...
        public override CreatePrePayOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePrePayOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
