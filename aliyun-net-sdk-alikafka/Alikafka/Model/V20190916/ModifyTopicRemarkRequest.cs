...
{
    public class ModifyTopicRemarkRequest : RpcAcsRequest<ModifyTopicRemarkResponse>
    {
        public ModifyTopicRemarkRequest()
            : base("alikafka", "2019-09-16", "ModifyTopicRemark", "alikafka", "openAPI")
        {
        ...
        public override ModifyTopicRemarkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTopicRemarkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
