...
{
    public class GetInstanceListRequest : RpcAcsRequest<GetInstanceListResponse>
    {
        public GetInstanceListRequest()
            : base("alikafka", "2019-09-16", "GetInstanceList", "alikafka", "openAPI")
        {
        ...
        public override GetInstanceListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetInstanceListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
