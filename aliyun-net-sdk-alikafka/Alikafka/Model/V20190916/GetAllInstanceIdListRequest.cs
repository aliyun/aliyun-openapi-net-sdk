...
{
    public class GetAllInstanceIdListRequest : RpcAcsRequest<GetAllInstanceIdListResponse>
    {
        public GetAllInstanceIdListRequest()
            : base("alikafka", "2019-09-16", "GetAllInstanceIdList", "alikafka", "openAPI")
        {
        ...
        public override GetAllInstanceIdListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAllInstanceIdListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
