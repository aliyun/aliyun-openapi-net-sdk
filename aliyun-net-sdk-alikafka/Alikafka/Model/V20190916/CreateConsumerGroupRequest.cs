...
namespace Aliyun.Acs.alikafka.Model.V20190916
{
    public class CreateConsumerGroupRequest : RpcAcsRequest<CreateConsumerGroupResponse>
    {
        public CreateConsumerGroupRequest()
            : base("alikafka", "2019-09-16", "CreateConsumerGroup", "alikafka", "openAPI")
        {
        ...
        public override CreateConsumerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateConsumerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
