...
{
    public class GetQuotaTipRequest : RpcAcsRequest<GetQuotaTipResponse>
    {
        public GetQuotaTipRequest()
            : base("alikafka", "2019-09-16", "GetQuotaTip", "alikafka", "openAPI")
        {
        ...
        public override GetQuotaTipResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQuotaTipResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
