...
{
    public class DeleteConsumerGroupRequest : RpcAcsRequest<DeleteConsumerGroupResponse>
    {
        public DeleteConsumerGroupRequest()
            : base("alikafka", "2019-09-16", "DeleteConsumerGroup", "alikafka", "openAPI")
        {
        ...
        public override DeleteConsumerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteConsumerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
