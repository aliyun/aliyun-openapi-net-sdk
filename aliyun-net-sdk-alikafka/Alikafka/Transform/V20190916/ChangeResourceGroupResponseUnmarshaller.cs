...
namespace Aliyun.Acs.alikafka.Transform.V20190916
{
    public class ChangeResourceGroupResponseUnmarshaller
    {
        public static ChangeResourceGroupResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			changeResourceGroupResponse.Code = _ctx.IntegerValue("ChangeResourceGroup.Code");
			...
			changeResourceGroupResponse.Success = _ctx.LongValue("ChangeResourceGroup.Success");
			changeResourceGroupResponse.NewResourceGroupId = _ctx.StringValue("ChangeResourceGroup.NewResourceGroupId");
