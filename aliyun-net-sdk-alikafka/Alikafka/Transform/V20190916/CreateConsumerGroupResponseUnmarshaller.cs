...
namespace Aliyun.Acs.alikafka.Transform.V20190916
{
    public class CreateConsumerGroupResponseUnmarshaller
    {
        public static CreateConsumerGroupResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			createConsumerGroupResponse.Code = _ctx.IntegerValue("CreateConsumerGroup.Code");
			createConsumerGroupResponse.Message = _ctx.StringValue("CreateConsumerGroup.Message");
