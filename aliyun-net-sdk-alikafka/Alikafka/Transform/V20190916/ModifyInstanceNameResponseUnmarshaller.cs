...
namespace Aliyun.Acs.alikafka.Transform.V20190916
{
    ...
    {
        public static ModifyInstanceNameResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			modifyInstanceNameResponse.Code = _ctx.IntegerValue("ModifyInstanceName.Code");
			modifyInstanceNameResponse.Message = _ctx.StringValue("ModifyInstanceName.Message");
			modifyInstanceNameResponse.RequestId = _ctx.StringValue("ModifyInstanceName.RequestId");
			modifyInstanceNameResponse.Success = _ctx.BooleanValue("ModifyInstanceName.Success");
