...
namespace Aliyun.Acs.alikafka.Transform.V20190916
{
    ...
    {
        public static UpgradeInstanceVersionResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			upgradeInstanceVersionResponse.Code = _ctx.IntegerValue("UpgradeInstanceVersion.Code");
			upgradeInstanceVersionResponse.Message = _ctx.StringValue("UpgradeInstanceVersion.Message");
			upgradeInstanceVersionResponse.RequestId = _ctx.StringValue("UpgradeInstanceVersion.RequestId");
			upgradeInstanceVersionResponse.Success = _ctx.BooleanValue("UpgradeInstanceVersion.Success");
