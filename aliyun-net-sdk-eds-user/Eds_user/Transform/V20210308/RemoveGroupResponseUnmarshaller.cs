...
namespace Aliyun.Acs.eds_user.Transform.V20210308
{
    ...
    {
        public static RemoveGroupResponse Unmarshall(UnmarshallerContext _ctx)
        {
			RemoveGroupResponse removeGroupResponse = new RemoveGroupResponse();

			removeGroupResponse.HttpResponse = _ctx.HttpResponse;
			removeGroupResponse.RequestId = _ctx.StringValue("RemoveGroup.RequestId");
