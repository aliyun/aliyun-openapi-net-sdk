...
{
    public class DescribeMfaDevicesRequest : RpcAcsRequest<DescribeMfaDevicesResponse>
    {
        public DescribeMfaDevicesRequest()
            : base("eds-user", "2021-03-08", "DescribeMfaDevices", "eds-user", "openAPI")
        {
		...
		private List<string> serialNumberss = new List<string>(){ };
		...
		public List<string> SerialNumberss
		{
			get
			{
		...
		public string AdDomain
		{
			...
			{
				adDomain = value;
				DictionaryUtil.Add(QueryParameters, "AdDomain", value);
			}
		}
        ...
        public override DescribeMfaDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMfaDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
