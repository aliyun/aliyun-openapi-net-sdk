...
{
    public class ModifyOrgRequest : RpcAcsRequest<ModifyOrgResponse>
    {
        public ModifyOrgRequest()
            : base("eds-user", "2021-03-08", "ModifyOrg", "eds-user", "openAPI")
        {
        ...
        public override ModifyOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
