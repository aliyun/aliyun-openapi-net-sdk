...
{
    public class SetUserPropertyValueRequest : RpcAcsRequest<SetUserPropertyValueResponse>
    {
        public SetUserPropertyValueRequest()
            : base("eds-user", "2021-03-08", "SetUserPropertyValue", "eds-user", "openAPI")
        {
        ...
        public override SetUserPropertyValueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetUserPropertyValueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
