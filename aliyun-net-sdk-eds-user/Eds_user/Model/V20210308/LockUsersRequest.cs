...
{
    public class LockUsersRequest : RpcAcsRequest<LockUsersResponse>
    {
        public LockUsersRequest()
            : base("eds-user", "2021-03-08", "LockUsers", "eds-user", "openAPI")
        {
		...
		private bool? logoutSession;

		private List<string> userss = new List<string>(){ };

		[JsonProperty(PropertyName = "LogoutSession")]
		public bool? LogoutSession
		{
			...
			{
				logoutSession = value;
				DictionaryUtil.Add(QueryParameters, "LogoutSession", value.ToString());
			}
		}
        ...
        public override LockUsersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LockUsersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
