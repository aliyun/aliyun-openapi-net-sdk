...
{
    public class MoveOrgRequest : RpcAcsRequest<MoveOrgResponse>
    {
        public MoveOrgRequest()
            : base("eds-user", "2021-03-08", "MoveOrg", "eds-user", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "NewParentOrgId")]
		public string NewParentOrgId
		{
			...
			set	
			{
				newParentOrgId = value;
				DictionaryUtil.Add(BodyParameters, "NewParentOrgId", value);
			}
		}
        ...
        public override MoveOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MoveOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
