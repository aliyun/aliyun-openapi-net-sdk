...
{
    public class UserBatchJoinGroupRequest : RpcAcsRequest<UserBatchJoinGroupResponse>
    {
        public UserBatchJoinGroupRequest()
            : base("eds-user", "2021-03-08", "UserBatchJoinGroup", "eds-user", "openAPI")
        {
        ...
        public override UserBatchJoinGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UserBatchJoinGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
