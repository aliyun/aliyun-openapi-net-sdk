...
{
    public class RemoveOrgRequest : RpcAcsRequest<RemoveOrgResponse>
    {
        public RemoveOrgRequest()
            : base("eds-user", "2021-03-08", "RemoveOrg", "eds-user", "openAPI")
        {
        ...
        public override RemoveOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
