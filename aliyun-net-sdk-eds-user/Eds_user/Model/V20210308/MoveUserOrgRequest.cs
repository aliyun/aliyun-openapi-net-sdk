...
{
    public class MoveUserOrgRequest : RpcAcsRequest<MoveUserOrgResponse>
    {
        public MoveUserOrgRequest()
            : base("eds-user", "2021-03-08", "MoveUserOrg", "eds-user", "openAPI")
        {
        ...
        public override MoveUserOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MoveUserOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
