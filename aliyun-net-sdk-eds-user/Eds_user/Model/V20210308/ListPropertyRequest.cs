...
{
    public class ListPropertyRequest : RpcAcsRequest<ListPropertyResponse>
    {
        public ListPropertyRequest()
            : base("eds-user", "2021-03-08", "ListProperty", "eds-user", "openAPI")
        {
        ...
        public override ListPropertyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPropertyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
