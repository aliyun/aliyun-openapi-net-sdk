...
{
    public class ModifyGroupRequest : RpcAcsRequest<ModifyGroupResponse>
    {
        public ModifyGroupRequest()
            : base("eds-user", "2021-03-08", "ModifyGroup", "eds-user", "openAPI")
        {
        ...
        public override ModifyGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
