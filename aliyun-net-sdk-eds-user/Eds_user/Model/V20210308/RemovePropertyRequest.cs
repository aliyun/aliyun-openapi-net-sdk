...
{
    public class RemovePropertyRequest : RpcAcsRequest<RemovePropertyResponse>
    {
        public RemovePropertyRequest()
            : base("eds-user", "2021-03-08", "RemoveProperty", "eds-user", "openAPI")
        {
        ...
        public override RemovePropertyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemovePropertyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
