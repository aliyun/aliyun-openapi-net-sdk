...
{
    public class QuerySyncStatusByAliUidRequest : RpcAcsRequest<QuerySyncStatusByAliUidResponse>
    {
        public QuerySyncStatusByAliUidRequest()
            : base("eds-user", "2021-03-08", "QuerySyncStatusByAliUid", "eds-user", "openAPI")
        {
        ...
        public override QuerySyncStatusByAliUidResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySyncStatusByAliUidResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
