...
{
    public class DescribeOrgByLayerRequest : RpcAcsRequest<DescribeOrgByLayerResponse>
    {
        public DescribeOrgByLayerRequest()
            : base("eds-user", "2021-03-08", "DescribeOrgByLayer", "eds-user", "openAPI")
        {
		...
		public string ParentOrgId
		{
			...
			{
				parentOrgId = value;
				DictionaryUtil.Add(BodyParameters, "ParentOrgId", value);
			}
		}
        ...
        public override DescribeOrgByLayerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOrgByLayerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
