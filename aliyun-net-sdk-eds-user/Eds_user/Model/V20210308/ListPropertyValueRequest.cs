...
{
    public class ListPropertyValueRequest : RpcAcsRequest<ListPropertyValueResponse>
    {
        public ListPropertyValueRequest()
            : base("eds-user", "2021-03-08", "ListPropertyValue", "eds-user", "openAPI")
        {
        ...
        public override ListPropertyValueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPropertyValueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
