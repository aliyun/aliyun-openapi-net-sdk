...
{
    public class RemoveGroupRequest : RpcAcsRequest<RemoveGroupResponse>
    {
        public RemoveGroupRequest()
            : base("eds-user", "2021-03-08", "RemoveGroup", "eds-user", "openAPI")
        {
        ...
        public override RemoveGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
