...
{
    public class GetManagerInfoByAuthCodeRequest : RpcAcsRequest<GetManagerInfoByAuthCodeResponse>
    {
        public GetManagerInfoByAuthCodeRequest()
            : base("eds-user", "2021-03-08", "GetManagerInfoByAuthCode", "eds-user", "openAPI")
        {
        ...
        public override GetManagerInfoByAuthCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetManagerInfoByAuthCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
