...
{
    public class LockMfaDeviceRequest : RpcAcsRequest<LockMfaDeviceResponse>
    {
        public LockMfaDeviceRequest()
            : base("eds-user", "2021-03-08", "LockMfaDevice", "eds-user", "openAPI")
        {
        ...
        public override LockMfaDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LockMfaDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
