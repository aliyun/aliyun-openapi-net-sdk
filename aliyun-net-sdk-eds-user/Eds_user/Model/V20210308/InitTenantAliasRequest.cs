...
{
    public class InitTenantAliasRequest : RpcAcsRequest<InitTenantAliasResponse>
    {
        public InitTenantAliasRequest()
            : base("eds-user", "2021-03-08", "InitTenantAlias", "eds-user", "openAPI")
        {
        ...
        public override InitTenantAliasResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InitTenantAliasResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
