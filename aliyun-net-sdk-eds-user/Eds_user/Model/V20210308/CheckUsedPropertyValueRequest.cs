...
{
    public class CheckUsedPropertyValueRequest : RpcAcsRequest<CheckUsedPropertyValueResponse>
    {
        public CheckUsedPropertyValueRequest()
            : base("eds-user", "2021-03-08", "CheckUsedPropertyValue", "eds-user", "openAPI")
        {
		...
		public long? PropertyValueId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "PropertyValueId", value.ToString());
			}
		}
        ...
        public override CheckUsedPropertyValueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckUsedPropertyValueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
