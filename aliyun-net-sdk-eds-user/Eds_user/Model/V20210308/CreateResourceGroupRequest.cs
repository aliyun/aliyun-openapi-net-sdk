...
{
    public class CreateResourceGroupRequest : RpcAcsRequest<CreateResourceGroupResponse>
    {
        public CreateResourceGroupRequest()
            : base("eds-user", "2021-03-08", "CreateResourceGroup", "eds-user", "openAPI")
        {
		...
		public long? IsResourceGroupWithOfficeSite
		{
			...
			set	
			{
				isResourceGroupWithOfficeSite = value;
				DictionaryUtil.Add(QueryParameters, "IsResourceGroupWithOfficeSite", value.ToString());
			}
		}
        ...
        public override CreateResourceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateResourceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
