...
namespace Aliyun.Acs.Iot.Model.V20170420
{
    public class QueryTopicReverseRouteTableRequest : RpcAcsRequest<QueryTopicReverseRouteTableResponse>
    {
        public QueryTopicReverseRouteTableRequest()
            : base("Iot", "2017-04-20", "QueryTopicReverseRouteTable")
        {
        }
        ...
        public override QueryTopicReverseRouteTableResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
