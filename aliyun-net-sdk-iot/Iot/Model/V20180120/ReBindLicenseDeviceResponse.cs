...
{
	public class ReBindLicenseDeviceResponse : AcsResponse
	{
		...
		private ReBindLicenseDevice_Data data;
		...
		public ReBindLicenseDevice_Data Data
		{
			get
			{
				return data;
		...
		public class ReBindLicenseDevice_Data
		{
