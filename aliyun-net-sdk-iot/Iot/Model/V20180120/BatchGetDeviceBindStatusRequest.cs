...
namespace Aliyun.Acs.Iot.Model.V20180120
{
    public class BatchGetDeviceBindStatusRequest : RpcAcsRequest<BatchGetDeviceBindStatusResponse>
    {
        public BatchGetDeviceBindStatusRequest()
            : base("Iot", "2018-01-20", "BatchGetDeviceBindStatus")
        {
        ...
        public override BatchGetDeviceBindStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchGetDeviceBindStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
