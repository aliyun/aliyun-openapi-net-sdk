...
namespace Aliyun.Acs.Iot.Model.V20180120
{
    public class ListOTAJobByDeviceRequest : RpcAcsRequest<ListOTAJobByDeviceResponse>
    {
        public ListOTAJobByDeviceRequest()
            : base("Iot", "2018-01-20", "ListOTAJobByDevice")
        {
        ...
        public override ListOTAJobByDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOTAJobByDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
