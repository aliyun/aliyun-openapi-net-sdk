...
{
	public class AddShareTaskDeviceResponse : AcsResponse
	{
		...
		private AddShareTaskDevice_Data data;
		...
		public AddShareTaskDevice_Data Data
		{
			get
			{
				return data;
		...
		public class AddShareTaskDevice_Data
		{
