...
namespace Aliyun.Acs.Iot.Model.V20180120
{
    public class CreateDownloadDataJobRequest : RpcAcsRequest<CreateDownloadDataJobResponse>
    {
		...
		public string FileConfig
		{
			...
			{
				fileConfig = value;
				DictionaryUtil.Add(QueryParameters, "FileConfig", value);
			}
		}
		...
		public string DownloadDataType
		{
			...
			set	
			{
				downloadDataType = value;
				DictionaryUtil.Add(QueryParameters, "DownloadDataType", value);
			}
		}
        ...
        public override CreateDownloadDataJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDownloadDataJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
