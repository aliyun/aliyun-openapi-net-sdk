...
{
	public class BindLicenseDeviceResponse : AcsResponse
	{
		...
		private BindLicenseDevice_Data data;
		...
		public BindLicenseDevice_Data Data
		{
			get
			{
				return data;
		...
		public class BindLicenseDevice_Data
		{
