...
{
    public class DeletePowerStationRequest : RpcAcsRequest<DeletePowerStationResponse>
    {
        public DeletePowerStationRequest()
            : base("Iot", "2018-01-20", "DeletePowerStation", "iot", "openAPI")
        {
        ...
        public override DeletePowerStationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePowerStationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
