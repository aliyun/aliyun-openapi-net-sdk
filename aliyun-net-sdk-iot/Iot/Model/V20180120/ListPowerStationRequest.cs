...
{
    public class ListPowerStationRequest : RpcAcsRequest<ListPowerStationResponse>
    {
        public ListPowerStationRequest()
            : base("Iot", "2018-01-20", "ListPowerStation", "iot", "openAPI")
        {
        ...
        public override ListPowerStationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPowerStationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
