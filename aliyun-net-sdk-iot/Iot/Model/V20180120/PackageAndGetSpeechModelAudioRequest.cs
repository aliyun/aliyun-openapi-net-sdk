...
{
    public class PackageAndGetSpeechModelAudioRequest : RpcAcsRequest<PackageAndGetSpeechModelAudioResponse>
    {
        public PackageAndGetSpeechModelAudioRequest()
            : base("Iot", "2018-01-20", "PackageAndGetSpeechModelAudio", "iot", "openAPI")
        {
        ...
        public override PackageAndGetSpeechModelAudioResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PackageAndGetSpeechModelAudioResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
