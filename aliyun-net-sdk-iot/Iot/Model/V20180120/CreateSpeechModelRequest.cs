...
{
    public class CreateSpeechModelRequest : RpcAcsRequest<CreateSpeechModelResponse>
    {
        public CreateSpeechModelRequest()
            : base("Iot", "2018-01-20", "CreateSpeechModel", "iot", "openAPI")
        {
        ...
        public override CreateSpeechModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSpeechModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
