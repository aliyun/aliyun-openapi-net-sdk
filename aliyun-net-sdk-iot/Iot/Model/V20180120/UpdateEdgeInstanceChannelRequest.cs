...
namespace Aliyun.Acs.Iot.Model.V20180120
{
    public class UpdateEdgeInstanceChannelRequest : RpcAcsRequest<UpdateEdgeInstanceChannelResponse>
    {
        public UpdateEdgeInstanceChannelRequest()
            : base("Iot", "2018-01-20", "UpdateEdgeInstanceChannel")
        {
        ...
        public override UpdateEdgeInstanceChannelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEdgeInstanceChannelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
