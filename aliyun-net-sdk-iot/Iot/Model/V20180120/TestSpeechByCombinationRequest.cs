...
{
    public class TestSpeechByCombinationRequest : RpcAcsRequest<TestSpeechByCombinationResponse>
    {
        public TestSpeechByCombinationRequest()
            : base("Iot", "2018-01-20", "TestSpeechByCombination", "iot", "openAPI")
        {
        ...
        public override TestSpeechByCombinationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TestSpeechByCombinationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
