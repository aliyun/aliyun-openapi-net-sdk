...
{
    public class DeleteSpeechRequest : RpcAcsRequest<DeleteSpeechResponse>
    {
        public DeleteSpeechRequest()
            : base("Iot", "2018-01-20", "DeleteSpeech", "iot", "openAPI")
        {
        ...
        public override DeleteSpeechResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSpeechResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
