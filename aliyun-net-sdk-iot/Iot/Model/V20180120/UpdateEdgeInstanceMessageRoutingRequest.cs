...
{
    public class UpdateEdgeInstanceMessageRoutingRequest : RpcAcsRequest<UpdateEdgeInstanceMessageRoutingResponse>
    {
        public UpdateEdgeInstanceMessageRoutingRequest()
            : base("Iot", "2018-01-20", "UpdateEdgeInstanceMessageRouting", "iot", "openAPI")
        {
        ...
        public override UpdateEdgeInstanceMessageRoutingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEdgeInstanceMessageRoutingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
