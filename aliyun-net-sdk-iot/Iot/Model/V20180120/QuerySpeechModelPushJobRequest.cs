...
{
    public class QuerySpeechModelPushJobRequest : RpcAcsRequest<QuerySpeechModelPushJobResponse>
    {
        public QuerySpeechModelPushJobRequest()
            : base("Iot", "2018-01-20", "QuerySpeechModelPushJob", "iot", "openAPI")
        {
        ...
        public override QuerySpeechModelPushJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySpeechModelPushJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
