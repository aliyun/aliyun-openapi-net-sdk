...
{
	public class QueryEdgeDriverVersionResponse : AcsResponse
	{
		...
		private QueryEdgeDriverVersion_Data data;
		...
		public QueryEdgeDriverVersion_Data Data
		{
			get
			{
				return data;
		...
		public class QueryEdgeDriverVersion_Data
		{
			...
			private List<QueryEdgeDriverVersion_DriverVersion> driverVersionList;
			...
			public List<QueryEdgeDriverVersion_DriverVersion> DriverVersionList
			{
				get
				{
				...
				set	
				{
					driverVersionList = value;
				}
			}

			public class QueryEdgeDriverVersion_DriverVersion
			{
