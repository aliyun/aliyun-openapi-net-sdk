...
{
    public class CountSpeechBroadcastHourRequest : RpcAcsRequest<CountSpeechBroadcastHourResponse>
    {
        public CountSpeechBroadcastHourRequest()
            : base("Iot", "2018-01-20", "CountSpeechBroadcastHour", "iot", "openAPI")
        {
        ...
        public override CountSpeechBroadcastHourResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CountSpeechBroadcastHourResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
