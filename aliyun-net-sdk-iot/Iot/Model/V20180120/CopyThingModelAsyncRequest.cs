...
{
    public class CopyThingModelAsyncRequest : RpcAcsRequest<CopyThingModelAsyncResponse>
    {
        public CopyThingModelAsyncRequest()
            : base("Iot", "2018-01-20", "CopyThingModelAsync", "iot", "openAPI")
        {
        ...
        public override CopyThingModelAsyncResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CopyThingModelAsyncResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
