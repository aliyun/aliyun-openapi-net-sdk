...
namespace Aliyun.Acs.Iot.Transform.V20160104
{
    public class PushByteMessageResponseUnmarshaller
    {
        public static PushByteMessageResponse Unmarshall(UnmarshallerContext context)
        {
			...
			pushByteMessageResponse.Success = context.BooleanValue("PushByteMessage.Success");
			pushByteMessageResponse.ErrorMessage = context.StringValue("PushByteMessage.ErrorMessage");
			pushByteMessageResponse.MessageId = context.StringValue("PushByteMessage.MessageId");
