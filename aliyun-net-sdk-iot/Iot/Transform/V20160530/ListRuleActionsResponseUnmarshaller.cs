...
namespace Aliyun.Acs.Iot.Transform.V20160530
{
    public class ListRuleActionsResponseUnmarshaller
    {
        public static ListRuleActionsResponse Unmarshall(UnmarshallerContext context)
        {
			...
			List<ListRuleActionsResponse.RuleActionInfo> ruleActionList = new List<ListRuleActionsResponse.RuleActionInfo>();
			...
			listRuleActionsResponse.RuleActionList = ruleActionList;
