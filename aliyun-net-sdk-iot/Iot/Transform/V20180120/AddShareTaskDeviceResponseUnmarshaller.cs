...
namespace Aliyun.Acs.Iot.Transform.V20180120
{
    ...
    {
        public static AddShareTaskDeviceResponse Unmarshall(UnmarshallerContext _ctx)
        {
			AddShareTaskDeviceResponse addShareTaskDeviceResponse = new AddShareTaskDeviceResponse();

			addShareTaskDeviceResponse.HttpResponse = _ctx.HttpResponse;
			addShareTaskDeviceResponse.RequestId = _ctx.StringValue("AddShareTaskDevice.RequestId");
			addShareTaskDeviceResponse.Success = _ctx.BooleanValue("AddShareTaskDevice.Success");
			addShareTaskDeviceResponse.Code = _ctx.StringValue("AddShareTaskDevice.Code");
			addShareTaskDeviceResponse.ErrorMessage = _ctx.StringValue("AddShareTaskDevice.ErrorMessage");
