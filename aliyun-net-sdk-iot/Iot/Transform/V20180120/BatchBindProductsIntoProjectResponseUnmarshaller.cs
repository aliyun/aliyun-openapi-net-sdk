...
namespace Aliyun.Acs.Iot.Transform.V20180120
{
    ...
    {
        public static BatchBindProductsIntoProjectResponse Unmarshall(UnmarshallerContext _ctx)
        {
			BatchBindProductsIntoProjectResponse batchBindProductsIntoProjectResponse = new BatchBindProductsIntoProjectResponse();

			batchBindProductsIntoProjectResponse.HttpResponse = _ctx.HttpResponse;
			batchBindProductsIntoProjectResponse.RequestId = _ctx.StringValue("BatchBindProductsIntoProject.RequestId");
