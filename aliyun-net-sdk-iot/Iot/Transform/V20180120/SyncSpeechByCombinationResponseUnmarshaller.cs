...
namespace Aliyun.Acs.Iot.Transform.V20180120
{
    ...
    {
        public static SyncSpeechByCombinationResponse Unmarshall(UnmarshallerContext _ctx)
        {
			SyncSpeechByCombinationResponse syncSpeechByCombinationResponse = new SyncSpeechByCombinationResponse();

			syncSpeechByCombinationResponse.HttpResponse = _ctx.HttpResponse;
			syncSpeechByCombinationResponse.RequestId = _ctx.StringValue("SyncSpeechByCombination.RequestId");
			syncSpeechByCombinationResponse.Success = _ctx.BooleanValue("SyncSpeechByCombination.Success");
			syncSpeechByCombinationResponse.Code = _ctx.StringValue("SyncSpeechByCombination.Code");
			syncSpeechByCombinationResponse.ErrorMessage = _ctx.StringValue("SyncSpeechByCombination.ErrorMessage");
