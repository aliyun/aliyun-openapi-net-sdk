...
namespace Aliyun.Acs.Iot.Transform.V20180120
{
    ...
    {
        public static PublishScriptResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			publishScriptResponse.ErrorMessage = _ctx.StringValue("PublishScript.ErrorMessage");
			publishScriptResponse.SyntaxErrorMsg = _ctx.StringValue("PublishScript.SyntaxErrorMsg");
