...
{
    public class GetBrandChEcomRequest : RpcAcsRequest<GetBrandChEcomResponse>
    {
        public GetBrandChEcomRequest()
            : base("alinlp", "2020-06-29", "GetBrandChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetBrandChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetBrandChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
