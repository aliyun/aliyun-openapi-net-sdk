...
{
    public class GetKeywordEnEcomRequest : RpcAcsRequest<GetKeywordEnEcomResponse>
    {
        public GetKeywordEnEcomRequest()
            : base("alinlp", "2020-06-29", "GetKeywordEnEcom", "alinlp", "openAPI")
        {
        ...
        public override GetKeywordEnEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetKeywordEnEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
