...
{
    public class GetWsCustomizedChGeneralRequest : RpcAcsRequest<GetWsCustomizedChGeneralResponse>
    {
        public GetWsCustomizedChGeneralRequest()
            : base("alinlp", "2020-06-29", "GetWsCustomizedChGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetWsCustomizedChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsCustomizedChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
