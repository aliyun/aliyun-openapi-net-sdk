...
{
    public class GetCheckDuplicationChMedicalRequest : RpcAcsRequest<GetCheckDuplicationChMedicalResponse>
    {
        public GetCheckDuplicationChMedicalRequest()
            : base("alinlp", "2020-06-29", "GetCheckDuplicationChMedical", "alinlp", "openAPI")
        {
        ...
        public override GetCheckDuplicationChMedicalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCheckDuplicationChMedicalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
