...
{
    public class GetTableQAServiceInfoByIdRequest : RpcAcsRequest<GetTableQAServiceInfoByIdResponse>
    {
        public GetTableQAServiceInfoByIdRequest()
            : base("alinlp", "2020-06-29", "GetTableQAServiceInfoById", "alinlp", "openAPI")
        {
        ...
        public override GetTableQAServiceInfoByIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTableQAServiceInfoByIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
