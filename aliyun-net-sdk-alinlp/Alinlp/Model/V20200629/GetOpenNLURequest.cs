...
{
    public class GetOpenNLURequest : RpcAcsRequest<GetOpenNLUResponse>
    {
        public GetOpenNLURequest()
            : base("alinlp", "2020-06-29", "GetOpenNLU", "alinlp", "openAPI")
        {
        ...
        public override GetOpenNLUResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOpenNLUResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
