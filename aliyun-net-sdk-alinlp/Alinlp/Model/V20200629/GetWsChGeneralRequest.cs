...
{
    public class GetWsChGeneralRequest : RpcAcsRequest<GetWsChGeneralResponse>
    {
        public GetWsChGeneralRequest()
            : base("alinlp", "2020-06-29", "GetWsChGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetWsChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
