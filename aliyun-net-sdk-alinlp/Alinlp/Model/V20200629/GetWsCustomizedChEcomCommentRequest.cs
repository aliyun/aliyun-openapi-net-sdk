...
{
    public class GetWsCustomizedChEcomCommentRequest : RpcAcsRequest<GetWsCustomizedChEcomCommentResponse>
    {
        public GetWsCustomizedChEcomCommentRequest()
            : base("alinlp", "2020-06-29", "GetWsCustomizedChEcomComment", "alinlp", "openAPI")
        {
        ...
        public override GetWsCustomizedChEcomCommentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsCustomizedChEcomCommentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
