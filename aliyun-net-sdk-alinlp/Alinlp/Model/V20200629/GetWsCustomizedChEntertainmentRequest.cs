...
{
    public class GetWsCustomizedChEntertainmentRequest : RpcAcsRequest<GetWsCustomizedChEntertainmentResponse>
    {
        public GetWsCustomizedChEntertainmentRequest()
            : base("alinlp", "2020-06-29", "GetWsCustomizedChEntertainment", "alinlp", "openAPI")
        {
		...
		public string OutType
		{
			...
			{
				outType = value;
				DictionaryUtil.Add(BodyParameters, "OutType", value);
			}
		}
        ...
        public override GetWsCustomizedChEntertainmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsCustomizedChEntertainmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
