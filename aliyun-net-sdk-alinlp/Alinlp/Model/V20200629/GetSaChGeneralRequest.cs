...
{
    public class GetSaChGeneralRequest : RpcAcsRequest<GetSaChGeneralResponse>
    {
        public GetSaChGeneralRequest()
            : base("alinlp", "2020-06-29", "GetSaChGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetSaChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSaChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
