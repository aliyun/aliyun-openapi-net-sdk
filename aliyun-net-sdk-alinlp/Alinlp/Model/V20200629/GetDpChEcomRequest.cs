...
{
    public class GetDpChEcomRequest : RpcAcsRequest<GetDpChEcomResponse>
    {
        public GetDpChEcomRequest()
            : base("alinlp", "2020-06-29", "GetDpChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetDpChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDpChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
