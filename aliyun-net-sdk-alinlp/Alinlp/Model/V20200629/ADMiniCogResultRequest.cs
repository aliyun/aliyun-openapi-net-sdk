...
{
    public class ADMiniCogResultRequest : RpcAcsRequest<ADMiniCogResultResponse>
    {
        public ADMiniCogResultRequest()
            : base("alinlp", "2020-06-29", "ADMiniCogResult", "alinlp", "openAPI")
        {
        ...
        public override ADMiniCogResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ADMiniCogResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
