...
{
    public class RequestTableQARequest : RpcAcsRequest<RequestTableQAResponse>
    {
        public RequestTableQARequest()
            : base("alinlp", "2020-06-29", "RequestTableQA", "alinlp", "openAPI")
        {
        ...
        public override RequestTableQAResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RequestTableQAResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
