...
{
    public class OpenAlinlpServiceRequest : RpcAcsRequest<OpenAlinlpServiceResponse>
    {
        public OpenAlinlpServiceRequest()
            : base("alinlp", "2020-06-29", "OpenAlinlpService", "alinlp", "openAPI")
        {
        ...
        public override OpenAlinlpServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenAlinlpServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
