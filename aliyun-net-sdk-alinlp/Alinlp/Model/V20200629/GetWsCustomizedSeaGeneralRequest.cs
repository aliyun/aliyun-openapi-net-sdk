...
{
    public class GetWsCustomizedSeaGeneralRequest : RpcAcsRequest<GetWsCustomizedSeaGeneralResponse>
    {
        public GetWsCustomizedSeaGeneralRequest()
            : base("alinlp", "2020-06-29", "GetWsCustomizedSeaGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetWsCustomizedSeaGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsCustomizedSeaGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
