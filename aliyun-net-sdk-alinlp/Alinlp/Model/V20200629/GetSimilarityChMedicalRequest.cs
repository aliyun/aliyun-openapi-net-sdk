...
{
    public class GetSimilarityChMedicalRequest : RpcAcsRequest<GetSimilarityChMedicalResponse>
    {
        public GetSimilarityChMedicalRequest()
            : base("alinlp", "2020-06-29", "GetSimilarityChMedical", "alinlp", "openAPI")
        {
        ...
        public override GetSimilarityChMedicalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSimilarityChMedicalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
