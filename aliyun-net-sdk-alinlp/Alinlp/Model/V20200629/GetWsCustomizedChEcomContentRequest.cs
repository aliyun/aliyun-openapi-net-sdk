...
{
    public class GetWsCustomizedChEcomContentRequest : RpcAcsRequest<GetWsCustomizedChEcomContentResponse>
    {
        public GetWsCustomizedChEcomContentRequest()
            : base("alinlp", "2020-06-29", "GetWsCustomizedChEcomContent", "alinlp", "openAPI")
        {
        ...
        public override GetWsCustomizedChEcomContentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsCustomizedChEcomContentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
