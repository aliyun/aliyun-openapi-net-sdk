...
{
    public class ADMiniCogRequest : RpcAcsRequest<ADMiniCogResponse>
    {
        public ADMiniCogRequest()
            : base("alinlp", "2020-06-29", "ADMiniCog", "alinlp", "openAPI")
        {
        ...
        public override ADMiniCogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ADMiniCogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
