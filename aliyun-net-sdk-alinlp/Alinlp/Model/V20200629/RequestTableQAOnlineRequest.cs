...
{
    public class RequestTableQAOnlineRequest : RpcAcsRequest<RequestTableQAOnlineResponse>
    {
        public RequestTableQAOnlineRequest()
            : base("alinlp", "2020-06-29", "RequestTableQAOnline", "alinlp", "openAPI")
        {
		...
		public string BotId
		{
			...
			{
				botId = value;
				DictionaryUtil.Add(BodyParameters, "BotId", value);
			}
		}
        ...
        public override RequestTableQAOnlineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RequestTableQAOnlineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
