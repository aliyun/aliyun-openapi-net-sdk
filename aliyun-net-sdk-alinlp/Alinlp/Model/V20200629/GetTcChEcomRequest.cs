...
{
    public class GetTcChEcomRequest : RpcAcsRequest<GetTcChEcomResponse>
    {
        public GetTcChEcomRequest()
            : base("alinlp", "2020-06-29", "GetTcChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetTcChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTcChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
