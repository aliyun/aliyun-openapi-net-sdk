...
{
    public class GetNerCustomizedSeaEcomRequest : RpcAcsRequest<GetNerCustomizedSeaEcomResponse>
    {
        public GetNerCustomizedSeaEcomRequest()
            : base("alinlp", "2020-06-29", "GetNerCustomizedSeaEcom", "alinlp", "openAPI")
        {
        ...
        public override GetNerCustomizedSeaEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNerCustomizedSeaEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
