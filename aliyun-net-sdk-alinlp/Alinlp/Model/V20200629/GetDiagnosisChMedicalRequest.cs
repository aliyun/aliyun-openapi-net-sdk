...
{
    public class GetDiagnosisChMedicalRequest : RpcAcsRequest<GetDiagnosisChMedicalResponse>
    {
        public GetDiagnosisChMedicalRequest()
            : base("alinlp", "2020-06-29", "GetDiagnosisChMedical", "alinlp", "openAPI")
        {
        ...
        public override GetDiagnosisChMedicalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDiagnosisChMedicalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
