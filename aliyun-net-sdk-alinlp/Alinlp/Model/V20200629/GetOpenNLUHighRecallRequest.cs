...
{
    public class GetOpenNLUHighRecallRequest : RpcAcsRequest<GetOpenNLUHighRecallResponse>
    {
        public GetOpenNLUHighRecallRequest()
            : base("alinlp", "2020-06-29", "GetOpenNLUHighRecall", "alinlp", "openAPI")
        {
		...
		public string Sentence
		{
			...
			{
				sentence = value;
				DictionaryUtil.Add(BodyParameters, "Sentence", value);
			}
		}
		...
		public string Task
		{
			...
			{
				task = value;
				DictionaryUtil.Add(BodyParameters, "Task", value);
			}
		}
		...
		public string Examples
		{
			...
			{
				examples = value;
				DictionaryUtil.Add(BodyParameters, "Examples", value);
			}
		}
        ...
        public override GetOpenNLUHighRecallResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOpenNLUHighRecallResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
