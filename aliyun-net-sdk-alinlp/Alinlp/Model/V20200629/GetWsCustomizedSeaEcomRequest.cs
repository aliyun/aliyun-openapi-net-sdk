...
{
    public class GetWsCustomizedSeaEcomRequest : RpcAcsRequest<GetWsCustomizedSeaEcomResponse>
    {
        public GetWsCustomizedSeaEcomRequest()
            : base("alinlp", "2020-06-29", "GetWsCustomizedSeaEcom", "alinlp", "openAPI")
        {
        ...
        public override GetWsCustomizedSeaEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWsCustomizedSeaEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
