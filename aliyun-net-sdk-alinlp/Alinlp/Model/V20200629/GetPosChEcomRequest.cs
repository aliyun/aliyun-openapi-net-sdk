...
{
    public class GetPosChEcomRequest : RpcAcsRequest<GetPosChEcomResponse>
    {
        public GetPosChEcomRequest()
            : base("alinlp", "2020-06-29", "GetPosChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetPosChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPosChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
