...
{
    public class GetEmbeddingRequest : RpcAcsRequest<GetEmbeddingResponse>
    {
        public GetEmbeddingRequest()
            : base("alinlp", "2020-06-29", "GetEmbedding", "alinlp", "openAPI")
        {
        ...
        public override GetEmbeddingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEmbeddingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
