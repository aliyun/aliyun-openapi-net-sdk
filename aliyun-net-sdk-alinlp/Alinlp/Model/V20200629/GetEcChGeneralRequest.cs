...
{
    public class GetEcChGeneralRequest : RpcAcsRequest<GetEcChGeneralResponse>
    {
        public GetEcChGeneralRequest()
            : base("alinlp", "2020-06-29", "GetEcChGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetEcChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEcChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
