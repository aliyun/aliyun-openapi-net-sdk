...
{
    public class GetCateChEcomRequest : RpcAcsRequest<GetCateChEcomResponse>
    {
        public GetCateChEcomRequest()
            : base("alinlp", "2020-06-29", "GetCateChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetCateChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCateChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
