...
{
    public class GetWeChCommentRequest : RpcAcsRequest<GetWeChCommentResponse>
    {
        public GetWeChCommentRequest()
            : base("alinlp", "2020-06-29", "GetWeChComment", "alinlp", "openAPI")
        {
        ...
        public override GetWeChCommentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWeChCommentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
