...
{
    public class GetItemPubChEcomRequest : RpcAcsRequest<GetItemPubChEcomResponse>
    {
        public GetItemPubChEcomRequest()
            : base("alinlp", "2020-06-29", "GetItemPubChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetItemPubChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetItemPubChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
