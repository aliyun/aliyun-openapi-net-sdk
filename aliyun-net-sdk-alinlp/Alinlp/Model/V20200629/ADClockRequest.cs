...
{
    public class ADClockRequest : RpcAcsRequest<ADClockResponse>
    {
        public ADClockRequest()
            : base("alinlp", "2020-06-29", "ADClock", "alinlp", "openAPI")
        {
        ...
        public override ADClockResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ADClockResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
