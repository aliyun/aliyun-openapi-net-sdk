...
namespace Aliyun.Acs.alinlp.Model.V20200629
{
    public class GetTcChGeneralRequest : RpcAcsRequest<GetTcChGeneralResponse>
    {
        ...
        public override GetTcChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTcChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
