...
{
    public class GetWeChGeneralRequest : RpcAcsRequest<GetWeChGeneralResponse>
    {
        public GetWeChGeneralRequest()
            : base("alinlp", "2020-06-29", "GetWeChGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetWeChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWeChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
