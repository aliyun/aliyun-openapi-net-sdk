...
{
    public class GetSSETestRequest : RpcAcsRequest<GetSSETestResponse>
    {
        public GetSSETestRequest()
            : base("alinlp", "2020-06-29", "GetSSETest", "alinlp", "openAPI")
        {
        ...
        public override GetSSETestResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSSETestResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
