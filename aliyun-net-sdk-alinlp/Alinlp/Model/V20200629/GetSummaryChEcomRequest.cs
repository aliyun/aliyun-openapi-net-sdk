...
{
    public class GetSummaryChEcomRequest : RpcAcsRequest<GetSummaryChEcomResponse>
    {
        public GetSummaryChEcomRequest()
            : base("alinlp", "2020-06-29", "GetSummaryChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetSummaryChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSummaryChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
