...
{
    public class GetPriceChEcomRequest : RpcAcsRequest<GetPriceChEcomResponse>
    {
        public GetPriceChEcomRequest()
            : base("alinlp", "2020-06-29", "GetPriceChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetPriceChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPriceChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
