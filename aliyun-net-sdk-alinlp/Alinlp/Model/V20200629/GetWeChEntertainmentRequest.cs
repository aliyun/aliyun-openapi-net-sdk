...
{
    public class GetWeChEntertainmentRequest : RpcAcsRequest<GetWeChEntertainmentResponse>
    {
        public GetWeChEntertainmentRequest()
            : base("alinlp", "2020-06-29", "GetWeChEntertainment", "alinlp", "openAPI")
        {
        ...
        public override GetWeChEntertainmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWeChEntertainmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
