...
{
    public class GetNerChMedicalRequest : RpcAcsRequest<GetNerChMedicalResponse>
    {
        public GetNerChMedicalRequest()
            : base("alinlp", "2020-06-29", "GetNerChMedical", "alinlp", "openAPI")
        {
        ...
        public override GetNerChMedicalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNerChMedicalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
