...
{
    public class GetPosChGeneralRequest : RpcAcsRequest<GetPosChGeneralResponse>
    {
        public GetPosChGeneralRequest()
            : base("alinlp", "2020-06-29", "GetPosChGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetPosChGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPosChGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
