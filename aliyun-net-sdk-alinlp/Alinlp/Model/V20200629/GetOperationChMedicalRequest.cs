...
{
    public class GetOperationChMedicalRequest : RpcAcsRequest<GetOperationChMedicalResponse>
    {
        public GetOperationChMedicalRequest()
            : base("alinlp", "2020-06-29", "GetOperationChMedical", "alinlp", "openAPI")
        {
        ...
        public override GetOperationChMedicalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOperationChMedicalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
