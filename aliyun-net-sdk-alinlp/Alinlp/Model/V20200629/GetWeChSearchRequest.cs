...
{
    public class GetWeChSearchRequest : RpcAcsRequest<GetWeChSearchResponse>
    {
        public GetWeChSearchRequest()
            : base("alinlp", "2020-06-29", "GetWeChSearch", "alinlp", "openAPI")
        {
        ...
        public override GetWeChSearchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWeChSearchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
