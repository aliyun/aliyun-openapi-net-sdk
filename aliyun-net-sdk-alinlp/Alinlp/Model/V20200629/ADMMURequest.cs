...
{
    public class ADMMURequest : RpcAcsRequest<ADMMUResponse>
    {
        public ADMMURequest()
            : base("alinlp", "2020-06-29", "ADMMU", "alinlp", "openAPI")
        {
        ...
        public override ADMMUResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ADMMUResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
