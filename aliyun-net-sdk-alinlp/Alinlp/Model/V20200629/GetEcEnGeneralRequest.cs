...
{
    public class GetEcEnGeneralRequest : RpcAcsRequest<GetEcEnGeneralResponse>
    {
        public GetEcEnGeneralRequest()
            : base("alinlp", "2020-06-29", "GetEcEnGeneral", "alinlp", "openAPI")
        {
        ...
        public override GetEcEnGeneralResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEcEnGeneralResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
