...
{
    public class GetNerChEcomRequest : RpcAcsRequest<GetNerChEcomResponse>
    {
        public GetNerChEcomRequest()
            : base("alinlp", "2020-06-29", "GetNerChEcom", "alinlp", "openAPI")
        {
        ...
        public override GetNerChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNerChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
