...
{
    public class GetNerCustomizedChEcomRequest : RpcAcsRequest<GetNerCustomizedChEcomResponse>
    {
        public GetNerCustomizedChEcomRequest()
            : base("alinlp", "2020-06-29", "GetNerCustomizedChEcom", "alinlp", "openAPI")
        {
		...
		public string LexerId
		{
			...
			{
				lexerId = value;
				DictionaryUtil.Add(BodyParameters, "LexerId", value);
			}
		}
        ...
        public override GetNerCustomizedChEcomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetNerCustomizedChEcomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
