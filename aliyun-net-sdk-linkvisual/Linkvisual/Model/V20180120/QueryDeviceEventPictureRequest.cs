...
{
    public class QueryDeviceEventPictureRequest : RpcAcsRequest<QueryDeviceEventPictureResponse>
    {
        public QueryDeviceEventPictureRequest()
            : base("Linkvisual", "2018-01-20", "QueryDeviceEventPicture", "Linkvisual", "openAPI")
        {
        ...
        public override QueryDeviceEventPictureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceEventPictureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
