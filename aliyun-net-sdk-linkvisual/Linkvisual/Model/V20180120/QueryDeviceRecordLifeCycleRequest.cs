...
{
    public class QueryDeviceRecordLifeCycleRequest : RpcAcsRequest<QueryDeviceRecordLifeCycleResponse>
    {
        public QueryDeviceRecordLifeCycleRequest()
            : base("Linkvisual", "2018-01-20", "QueryDeviceRecordLifeCycle", "Linkvisual", "openAPI")
        {
		...
		private List<string> deviceLists = new List<string>(){ };
        ...
        public override QueryDeviceRecordLifeCycleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceRecordLifeCycleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
