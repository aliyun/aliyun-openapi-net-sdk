...
{
    public class AddFaceDeviceGroupRequest : RpcAcsRequest<AddFaceDeviceGroupResponse>
    {
        public AddFaceDeviceGroupRequest()
            : base("Linkvisual", "2018-01-20", "AddFaceDeviceGroup", "Linkvisual", "openAPI")
        {
        ...
        public override AddFaceDeviceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceDeviceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
