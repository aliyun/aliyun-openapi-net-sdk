...
{
    public class QueryFaceAllUserGroupRequest : RpcAcsRequest<QueryFaceAllUserGroupResponse>
    {
        public QueryFaceAllUserGroupRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceAllUserGroup", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceAllUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceAllUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
