...
{
    public class QueryFaceAllUserIdsByGroupIdRequest : RpcAcsRequest<QueryFaceAllUserIdsByGroupIdResponse>
    {
        public QueryFaceAllUserIdsByGroupIdRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceAllUserIdsByGroupId", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceAllUserIdsByGroupIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceAllUserIdsByGroupIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
