...
{
    public class DeleteRecordRequest : RpcAcsRequest<DeleteRecordResponse>
    {
        public DeleteRecordRequest()
            : base("Linkvisual", "2018-01-20", "DeleteRecord", "Linkvisual", "openAPI")
        {
		...
		private List<string> fileNameLists = new List<string>(){ };
		...
		public List<string> FileNameLists
		{
			get
			{
        ...
        public override DeleteRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
