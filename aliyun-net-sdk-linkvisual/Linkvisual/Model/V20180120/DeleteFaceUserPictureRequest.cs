...
{
    public class DeleteFaceUserPictureRequest : RpcAcsRequest<DeleteFaceUserPictureResponse>
    {
        public DeleteFaceUserPictureRequest()
            : base("Linkvisual", "2018-01-20", "DeleteFaceUserPicture", "Linkvisual", "openAPI")
        {
		...
		public string FacePicMd5
		{
			...
			{
				facePicMd5 = value;
				DictionaryUtil.Add(QueryParameters, "FacePicMd5", value);
			}
		}
        ...
        public override DeleteFaceUserPictureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFaceUserPictureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
