...
{
    public class CreateRecordPlanRequest : RpcAcsRequest<CreateRecordPlanResponse>
    {
        public CreateRecordPlanRequest()
            : base("Linkvisual", "2018-01-20", "CreateRecordPlan", "Linkvisual", "openAPI")
        {
        ...
        public override CreateRecordPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRecordPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
