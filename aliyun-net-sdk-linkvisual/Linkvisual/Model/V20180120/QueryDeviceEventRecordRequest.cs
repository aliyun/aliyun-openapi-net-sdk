...
{
    public class QueryDeviceEventRecordRequest : RpcAcsRequest<QueryDeviceEventRecordResponse>
    {
        public QueryDeviceEventRecordRequest()
            : base("Linkvisual", "2018-01-20", "QueryDeviceEventRecord", "Linkvisual", "openAPI")
        {
        ...
        public override QueryDeviceEventRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceEventRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
