...
{
    public class RemoveFaceUserFromUserGroupRequest : RpcAcsRequest<RemoveFaceUserFromUserGroupResponse>
    {
        public RemoveFaceUserFromUserGroupRequest()
            : base("Linkvisual", "2018-01-20", "RemoveFaceUserFromUserGroup", "Linkvisual", "openAPI")
        {
        ...
        public override RemoveFaceUserFromUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveFaceUserFromUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
