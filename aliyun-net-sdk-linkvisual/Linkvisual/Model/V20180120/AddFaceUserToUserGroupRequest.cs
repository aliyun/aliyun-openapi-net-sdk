...
{
    public class AddFaceUserToUserGroupRequest : RpcAcsRequest<AddFaceUserToUserGroupResponse>
    {
        public AddFaceUserToUserGroupRequest()
            : base("Linkvisual", "2018-01-20", "AddFaceUserToUserGroup", "Linkvisual", "openAPI")
        {
        ...
        public override AddFaceUserToUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceUserToUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
