...
{
    public class QueryMonthRecordRequest : RpcAcsRequest<QueryMonthRecordResponse>
    {
        public QueryMonthRecordRequest()
            : base("Linkvisual", "2018-01-20", "QueryMonthRecord", "Linkvisual", "openAPI")
        {
        ...
        public override QueryMonthRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryMonthRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
