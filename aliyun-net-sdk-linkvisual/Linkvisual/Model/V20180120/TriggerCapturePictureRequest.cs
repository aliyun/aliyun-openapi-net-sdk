...
{
    public class TriggerCapturePictureRequest : RpcAcsRequest<TriggerCapturePictureResponse>
    {
        public TriggerCapturePictureRequest()
            : base("Linkvisual", "2018-01-20", "TriggerCapturePicture", "Linkvisual", "openAPI")
        {
        ...
        public override TriggerCapturePictureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TriggerCapturePictureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
