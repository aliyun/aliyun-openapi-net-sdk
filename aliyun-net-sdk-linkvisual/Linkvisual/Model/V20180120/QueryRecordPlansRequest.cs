...
{
    public class QueryRecordPlansRequest : RpcAcsRequest<QueryRecordPlansResponse>
    {
        public QueryRecordPlansRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecordPlans", "Linkvisual", "openAPI")
        {
        ...
        public override QueryRecordPlansResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordPlansResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
