...
{
    public class DeleteEventRecordPlanRequest : RpcAcsRequest<DeleteEventRecordPlanResponse>
    {
        public DeleteEventRecordPlanRequest()
            : base("Linkvisual", "2018-01-20", "DeleteEventRecordPlan", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteEventRecordPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEventRecordPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
