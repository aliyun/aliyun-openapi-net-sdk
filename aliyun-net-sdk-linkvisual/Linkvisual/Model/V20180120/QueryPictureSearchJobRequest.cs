...
{
    public class QueryPictureSearchJobRequest : RpcAcsRequest<QueryPictureSearchJobResponse>
    {
        public QueryPictureSearchJobRequest()
            : base("Linkvisual", "2018-01-20", "QueryPictureSearchJob", "Linkvisual", "openAPI")
        {
		...
		public int? JobStatus
		{
			...
			{
				jobStatus = value;
				DictionaryUtil.Add(QueryParameters, "JobStatus", value.ToString());
			}
		}
        ...
        public override QueryPictureSearchJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryPictureSearchJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
