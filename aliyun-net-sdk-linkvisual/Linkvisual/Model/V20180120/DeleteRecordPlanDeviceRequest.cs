...
{
    public class DeleteRecordPlanDeviceRequest : RpcAcsRequest<DeleteRecordPlanDeviceResponse>
    {
        public DeleteRecordPlanDeviceRequest()
            : base("Linkvisual", "2018-01-20", "DeleteRecordPlanDevice", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteRecordPlanDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRecordPlanDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
