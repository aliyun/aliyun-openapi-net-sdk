...
{
    public class AddFaceDeviceToDeviceGroupRequest : RpcAcsRequest<AddFaceDeviceToDeviceGroupResponse>
    {
        public AddFaceDeviceToDeviceGroupRequest()
            : base("Linkvisual", "2018-01-20", "AddFaceDeviceToDeviceGroup", "Linkvisual", "openAPI")
        {
        ...
        public override AddFaceDeviceToDeviceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceDeviceToDeviceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
