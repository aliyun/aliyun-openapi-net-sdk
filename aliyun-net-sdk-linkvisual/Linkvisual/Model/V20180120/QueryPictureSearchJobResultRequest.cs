...
{
    public class QueryPictureSearchJobResultRequest : RpcAcsRequest<QueryPictureSearchJobResultResponse>
    {
        public QueryPictureSearchJobResultRequest()
            : base("Linkvisual", "2018-01-20", "QueryPictureSearchJobResult", "Linkvisual", "openAPI")
        {
        ...
        public override QueryPictureSearchJobResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryPictureSearchJobResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
