...
{
    public class QueryDeviceEventRequest : RpcAcsRequest<QueryDeviceEventResponse>
    {
        public QueryDeviceEventRequest()
            : base("Linkvisual", "2018-01-20", "QueryDeviceEvent", "Linkvisual", "openAPI")
        {
		...
		public int? EventType
		{
			...
			{
				eventType = value;
				DictionaryUtil.Add(QueryParameters, "EventType", value.ToString());
			}
		}
        ...
        public override QueryDeviceEventResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceEventResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
