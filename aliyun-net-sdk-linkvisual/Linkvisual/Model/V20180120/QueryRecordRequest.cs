...
{
    public class QueryRecordRequest : RpcAcsRequest<QueryRecordResponse>
    {
        public QueryRecordRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecord", "Linkvisual", "openAPI")
        {
		...
		public int? RecordType
		{
			...
			{
				recordType = value;
				DictionaryUtil.Add(QueryParameters, "RecordType", value.ToString());
			}
		}
		...
		public bool? NeedSnapshot
		{
			...
			{
				needSnapshot = value;
				DictionaryUtil.Add(QueryParameters, "NeedSnapshot", value.ToString());
			}
		}
        ...
        public override QueryRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
