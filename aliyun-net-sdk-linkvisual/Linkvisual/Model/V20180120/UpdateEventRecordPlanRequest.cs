...
{
    public class UpdateEventRecordPlanRequest : RpcAcsRequest<UpdateEventRecordPlanResponse>
    {
        public UpdateEventRecordPlanRequest()
            : base("Linkvisual", "2018-01-20", "UpdateEventRecordPlan", "Linkvisual", "openAPI")
        {
        ...
        public override UpdateEventRecordPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateEventRecordPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
