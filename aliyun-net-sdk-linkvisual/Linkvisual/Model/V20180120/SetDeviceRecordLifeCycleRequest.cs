...
{
    public class SetDeviceRecordLifeCycleRequest : RpcAcsRequest<SetDeviceRecordLifeCycleResponse>
    {
        public SetDeviceRecordLifeCycleRequest()
            : base("Linkvisual", "2018-01-20", "SetDeviceRecordLifeCycle", "Linkvisual", "openAPI")
        {
        ...
        public override SetDeviceRecordLifeCycleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetDeviceRecordLifeCycleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
