...
{
    public class QueryFaceAllDeviceGroupRequest : RpcAcsRequest<QueryFaceAllDeviceGroupResponse>
    {
        public QueryFaceAllDeviceGroupRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceAllDeviceGroup", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceAllDeviceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceAllDeviceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
