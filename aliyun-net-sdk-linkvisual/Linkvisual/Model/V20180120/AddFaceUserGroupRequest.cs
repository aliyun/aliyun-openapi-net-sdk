...
{
    public class AddFaceUserGroupRequest : RpcAcsRequest<AddFaceUserGroupResponse>
    {
        public AddFaceUserGroupRequest()
            : base("Linkvisual", "2018-01-20", "AddFaceUserGroup", "Linkvisual", "openAPI")
        {
        ...
        public override AddFaceUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
