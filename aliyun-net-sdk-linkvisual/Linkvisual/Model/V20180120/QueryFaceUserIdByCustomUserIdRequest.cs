...
{
    public class QueryFaceUserIdByCustomUserIdRequest : RpcAcsRequest<QueryFaceUserIdByCustomUserIdResponse>
    {
        public QueryFaceUserIdByCustomUserIdRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceUserIdByCustomUserId", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceUserIdByCustomUserIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceUserIdByCustomUserIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
