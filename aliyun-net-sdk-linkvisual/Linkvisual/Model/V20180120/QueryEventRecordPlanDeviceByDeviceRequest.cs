...
{
    public class QueryEventRecordPlanDeviceByDeviceRequest : RpcAcsRequest<QueryEventRecordPlanDeviceByDeviceResponse>
    {
        public QueryEventRecordPlanDeviceByDeviceRequest()
            : base("Linkvisual", "2018-01-20", "QueryEventRecordPlanDeviceByDevice", "Linkvisual", "openAPI")
        {
        ...
        public override QueryEventRecordPlanDeviceByDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryEventRecordPlanDeviceByDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
