...
{
    public class CreateTimeTemplateRequest : RpcAcsRequest<CreateTimeTemplateResponse>
    {
        public CreateTimeTemplateRequest()
            : base("Linkvisual", "2018-01-20", "CreateTimeTemplate", "Linkvisual", "openAPI")
        {
        ...
        public override CreateTimeTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTimeTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
