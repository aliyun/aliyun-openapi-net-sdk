...
{
    public class QueryEventRecordPlanDetailRequest : RpcAcsRequest<QueryEventRecordPlanDetailResponse>
    {
        public QueryEventRecordPlanDetailRequest()
            : base("Linkvisual", "2018-01-20", "QueryEventRecordPlanDetail", "Linkvisual", "openAPI")
        {
        ...
        public override QueryEventRecordPlanDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryEventRecordPlanDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
