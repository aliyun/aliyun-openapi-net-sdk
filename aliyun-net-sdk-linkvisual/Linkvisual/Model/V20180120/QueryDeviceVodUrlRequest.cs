...
{
    public class QueryDeviceVodUrlRequest : RpcAcsRequest<QueryDeviceVodUrlResponse>
    {
        public QueryDeviceVodUrlRequest()
            : base("Linkvisual", "2018-01-20", "QueryDeviceVodUrl", "Linkvisual", "openAPI")
        {
        ...
        public override QueryDeviceVodUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceVodUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
