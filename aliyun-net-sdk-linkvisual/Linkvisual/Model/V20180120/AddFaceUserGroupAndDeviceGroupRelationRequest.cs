...
{
    public class AddFaceUserGroupAndDeviceGroupRelationRequest : RpcAcsRequest<AddFaceUserGroupAndDeviceGroupRelationResponse>
    {
        public AddFaceUserGroupAndDeviceGroupRelationRequest()
            : base("Linkvisual", "2018-01-20", "AddFaceUserGroupAndDeviceGroupRelation", "Linkvisual", "openAPI")
        {
        ...
        public override AddFaceUserGroupAndDeviceGroupRelationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceUserGroupAndDeviceGroupRelationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
