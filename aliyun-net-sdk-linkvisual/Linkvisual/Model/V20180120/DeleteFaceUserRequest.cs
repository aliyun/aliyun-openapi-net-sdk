...
{
    public class DeleteFaceUserRequest : RpcAcsRequest<DeleteFaceUserResponse>
    {
        public DeleteFaceUserRequest()
            : base("Linkvisual", "2018-01-20", "DeleteFaceUser", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteFaceUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFaceUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
