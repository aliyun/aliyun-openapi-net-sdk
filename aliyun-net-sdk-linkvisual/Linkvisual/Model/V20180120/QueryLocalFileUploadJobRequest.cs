...
{
    public class QueryLocalFileUploadJobRequest : RpcAcsRequest<QueryLocalFileUploadJobResponse>
    {
        public QueryLocalFileUploadJobRequest()
            : base("Linkvisual", "2018-01-20", "QueryLocalFileUploadJob", "Linkvisual", "openAPI")
        {
        ...
        public override QueryLocalFileUploadJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryLocalFileUploadJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
