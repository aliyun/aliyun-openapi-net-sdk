...
{
    public class QueryFaceUserGroupRequest : RpcAcsRequest<QueryFaceUserGroupResponse>
    {
        public QueryFaceUserGroupRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceUserGroup", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
