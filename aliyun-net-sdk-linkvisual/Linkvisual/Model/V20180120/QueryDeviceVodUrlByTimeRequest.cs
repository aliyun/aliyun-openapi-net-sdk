...
{
    public class QueryDeviceVodUrlByTimeRequest : RpcAcsRequest<QueryDeviceVodUrlByTimeResponse>
    {
        public QueryDeviceVodUrlByTimeRequest()
            : base("Linkvisual", "2018-01-20", "QueryDeviceVodUrlByTime", "Linkvisual", "openAPI")
        {
		...
		public int? SeekTime
		{
			...
			{
				seekTime = value;
				DictionaryUtil.Add(QueryParameters, "SeekTime", value.ToString());
			}
		}
        ...
        public override QueryDeviceVodUrlByTimeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDeviceVodUrlByTimeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
