...
{
    public class CheckFaceUserDoExistOnDeviceRequest : RpcAcsRequest<CheckFaceUserDoExistOnDeviceResponse>
    {
        public CheckFaceUserDoExistOnDeviceRequest()
            : base("Linkvisual", "2018-01-20", "CheckFaceUserDoExistOnDevice", "Linkvisual", "openAPI")
        {
        ...
        public override CheckFaceUserDoExistOnDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckFaceUserDoExistOnDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
