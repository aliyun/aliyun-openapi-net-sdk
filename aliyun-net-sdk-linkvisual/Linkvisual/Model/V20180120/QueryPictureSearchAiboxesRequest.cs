...
{
    public class QueryPictureSearchAiboxesRequest : RpcAcsRequest<QueryPictureSearchAiboxesResponse>
    {
        public QueryPictureSearchAiboxesRequest()
            : base("Linkvisual", "2018-01-20", "QueryPictureSearchAiboxes", "Linkvisual", "openAPI")
        {
        ...
        public override QueryPictureSearchAiboxesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryPictureSearchAiboxesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
