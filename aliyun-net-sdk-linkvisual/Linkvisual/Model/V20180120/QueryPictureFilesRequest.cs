...
{
    public class QueryPictureFilesRequest : RpcAcsRequest<QueryPictureFilesResponse>
    {
        public QueryPictureFilesRequest()
            : base("Linkvisual", "2018-01-20", "QueryPictureFiles", "Linkvisual", "openAPI")
        {
		...
		public int? PictureSource
		{
			...
			{
				pictureSource = value;
				DictionaryUtil.Add(QueryParameters, "PictureSource", value.ToString());
			}
		}
        ...
        public override QueryPictureFilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryPictureFilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
