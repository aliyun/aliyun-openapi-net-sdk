...
{
    public class QueryRecordUrlRequest : RpcAcsRequest<QueryRecordUrlResponse>
    {
        public QueryRecordUrlRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecordUrl", "Linkvisual", "openAPI")
        {
        ...
        public override QueryRecordUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
