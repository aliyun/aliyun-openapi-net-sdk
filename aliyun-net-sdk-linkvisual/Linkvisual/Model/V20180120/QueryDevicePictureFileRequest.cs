...
{
    public class QueryDevicePictureFileRequest : RpcAcsRequest<QueryDevicePictureFileResponse>
    {
        public QueryDevicePictureFileRequest()
            : base("Linkvisual", "2018-01-20", "QueryDevicePictureFile", "Linkvisual", "openAPI")
        {
		...
		public string CaptureId
		{
			...
			{
				captureId = value;
				DictionaryUtil.Add(QueryParameters, "CaptureId", value);
			}
		}
        ...
        public override QueryDevicePictureFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDevicePictureFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
