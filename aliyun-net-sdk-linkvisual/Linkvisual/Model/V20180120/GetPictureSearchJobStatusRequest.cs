...
{
    public class GetPictureSearchJobStatusRequest : RpcAcsRequest<GetPictureSearchJobStatusResponse>
    {
        public GetPictureSearchJobStatusRequest()
            : base("Linkvisual", "2018-01-20", "GetPictureSearchJobStatus", "Linkvisual", "openAPI")
        {
        ...
        public override GetPictureSearchJobStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPictureSearchJobStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
