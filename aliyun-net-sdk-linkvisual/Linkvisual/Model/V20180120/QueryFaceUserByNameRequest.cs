...
{
    public class QueryFaceUserByNameRequest : RpcAcsRequest<QueryFaceUserByNameResponse>
    {
        public QueryFaceUserByNameRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceUserByName", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceUserByNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceUserByNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
