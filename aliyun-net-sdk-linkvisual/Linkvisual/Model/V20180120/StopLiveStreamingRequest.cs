...
{
    public class StopLiveStreamingRequest : RpcAcsRequest<StopLiveStreamingResponse>
    {
        public StopLiveStreamingRequest()
            : base("Linkvisual", "2018-01-20", "StopLiveStreaming", "Linkvisual", "openAPI")
        {
        ...
        public override StopLiveStreamingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopLiveStreamingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
