...
{
    public class QueryTimeTemplateDetailRequest : RpcAcsRequest<QueryTimeTemplateDetailResponse>
    {
        public QueryTimeTemplateDetailRequest()
            : base("Linkvisual", "2018-01-20", "QueryTimeTemplateDetail", "Linkvisual", "openAPI")
        {
        ...
        public override QueryTimeTemplateDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTimeTemplateDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
