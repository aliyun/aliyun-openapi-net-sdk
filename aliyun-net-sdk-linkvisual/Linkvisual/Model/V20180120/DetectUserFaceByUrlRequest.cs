...
{
    public class DetectUserFaceByUrlRequest : RpcAcsRequest<DetectUserFaceByUrlResponse>
    {
        public DetectUserFaceByUrlRequest()
            : base("Linkvisual", "2018-01-20", "DetectUserFaceByUrl", "Linkvisual", "openAPI")
        {
        ...
        public override DetectUserFaceByUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectUserFaceByUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
