...
{
    public class RemoveFaceDeviceFromDeviceGroupRequest : RpcAcsRequest<RemoveFaceDeviceFromDeviceGroupResponse>
    {
        public RemoveFaceDeviceFromDeviceGroupRequest()
            : base("Linkvisual", "2018-01-20", "RemoveFaceDeviceFromDeviceGroup", "Linkvisual", "openAPI")
        {
        ...
        public override RemoveFaceDeviceFromDeviceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveFaceDeviceFromDeviceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
