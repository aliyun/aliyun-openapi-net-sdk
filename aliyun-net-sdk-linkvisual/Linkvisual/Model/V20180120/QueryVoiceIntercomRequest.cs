...
{
    public class QueryVoiceIntercomRequest : RpcAcsRequest<QueryVoiceIntercomResponse>
    {
        public QueryVoiceIntercomRequest()
            : base("Linkvisual", "2018-01-20", "QueryVoiceIntercom", "Linkvisual", "openAPI")
        {
        ...
        public override QueryVoiceIntercomResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryVoiceIntercomResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
