...
{
    public class DeleteFaceUserGroupRequest : RpcAcsRequest<DeleteFaceUserGroupResponse>
    {
        public DeleteFaceUserGroupRequest()
            : base("Linkvisual", "2018-01-20", "DeleteFaceUserGroup", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteFaceUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFaceUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
