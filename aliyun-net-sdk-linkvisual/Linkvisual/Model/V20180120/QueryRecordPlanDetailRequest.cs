...
{
    public class QueryRecordPlanDetailRequest : RpcAcsRequest<QueryRecordPlanDetailResponse>
    {
        public QueryRecordPlanDetailRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecordPlanDetail", "Linkvisual", "openAPI")
        {
        ...
        public override QueryRecordPlanDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordPlanDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
