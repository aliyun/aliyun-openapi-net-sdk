...
namespace Aliyun.Acs.Linkvisual.Model.V20180120
{
    public class UpdateRecordPlanRequest : RpcAcsRequest<UpdateRecordPlanResponse>
    {
        public UpdateRecordPlanRequest()
            : base("Linkvisual", "2018-01-20", "UpdateRecordPlan", "Linkvisual", "openAPI")
        {
        ...
        public override UpdateRecordPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
