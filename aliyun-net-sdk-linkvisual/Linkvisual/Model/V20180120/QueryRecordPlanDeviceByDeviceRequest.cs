...
{
    public class QueryRecordPlanDeviceByDeviceRequest : RpcAcsRequest<QueryRecordPlanDeviceByDeviceResponse>
    {
        public QueryRecordPlanDeviceByDeviceRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecordPlanDeviceByDevice", "Linkvisual", "openAPI")
        {
        ...
        public override QueryRecordPlanDeviceByDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordPlanDeviceByDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
