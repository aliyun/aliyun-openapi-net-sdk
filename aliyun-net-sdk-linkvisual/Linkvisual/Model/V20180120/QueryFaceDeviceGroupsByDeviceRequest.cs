...
{
    public class QueryFaceDeviceGroupsByDeviceRequest : RpcAcsRequest<QueryFaceDeviceGroupsByDeviceResponse>
    {
        public QueryFaceDeviceGroupsByDeviceRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceDeviceGroupsByDevice", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceDeviceGroupsByDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceDeviceGroupsByDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
