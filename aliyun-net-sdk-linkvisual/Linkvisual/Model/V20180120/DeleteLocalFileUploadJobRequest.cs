...
{
    public class DeleteLocalFileUploadJobRequest : RpcAcsRequest<DeleteLocalFileUploadJobResponse>
    {
        public DeleteLocalFileUploadJobRequest()
            : base("Linkvisual", "2018-01-20", "DeleteLocalFileUploadJob", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteLocalFileUploadJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLocalFileUploadJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
