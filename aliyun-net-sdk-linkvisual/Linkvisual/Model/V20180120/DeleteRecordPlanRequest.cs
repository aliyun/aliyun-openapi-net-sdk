...
{
    public class DeleteRecordPlanRequest : RpcAcsRequest<DeleteRecordPlanResponse>
    {
        public DeleteRecordPlanRequest()
            : base("Linkvisual", "2018-01-20", "DeleteRecordPlan", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteRecordPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRecordPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
