...
{
    public class UpdateFaceUserRequest : RpcAcsRequest<UpdateFaceUserResponse>
    {
        public UpdateFaceUserRequest()
            : base("Linkvisual", "2018-01-20", "UpdateFaceUser", "Linkvisual", "openAPI")
        {
        ...
        public override UpdateFaceUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateFaceUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
