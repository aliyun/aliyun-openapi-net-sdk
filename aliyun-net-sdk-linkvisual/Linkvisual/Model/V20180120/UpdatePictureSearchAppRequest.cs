...
{
    public class UpdatePictureSearchAppRequest : RpcAcsRequest<UpdatePictureSearchAppResponse>
    {
        public UpdatePictureSearchAppRequest()
            : base("Linkvisual", "2018-01-20", "UpdatePictureSearchApp", "Linkvisual", "openAPI")
        {
        ...
        public override UpdatePictureSearchAppResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdatePictureSearchAppResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
