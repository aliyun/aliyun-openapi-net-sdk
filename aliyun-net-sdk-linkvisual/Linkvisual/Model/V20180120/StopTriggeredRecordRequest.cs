...
{
    public class StopTriggeredRecordRequest : RpcAcsRequest<StopTriggeredRecordResponse>
    {
        public StopTriggeredRecordRequest()
            : base("Linkvisual", "2018-01-20", "StopTriggeredRecord", "Linkvisual", "openAPI")
        {
        ...
        public override StopTriggeredRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopTriggeredRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
