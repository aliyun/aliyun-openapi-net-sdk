...
{
    public class DeleteTimeTemplateRequest : RpcAcsRequest<DeleteTimeTemplateResponse>
    {
        public DeleteTimeTemplateRequest()
            : base("Linkvisual", "2018-01-20", "DeleteTimeTemplate", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteTimeTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTimeTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
