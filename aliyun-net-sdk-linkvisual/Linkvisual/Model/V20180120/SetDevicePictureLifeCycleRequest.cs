...
{
    public class SetDevicePictureLifeCycleRequest : RpcAcsRequest<SetDevicePictureLifeCycleResponse>
    {
        public SetDevicePictureLifeCycleRequest()
            : base("Linkvisual", "2018-01-20", "SetDevicePictureLifeCycle", "Linkvisual", "openAPI")
        {
        ...
        public override SetDevicePictureLifeCycleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetDevicePictureLifeCycleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
