...
{
    public class AddFaceUserPictureRequest : RpcAcsRequest<AddFaceUserPictureResponse>
    {
        public AddFaceUserPictureRequest()
            : base("Linkvisual", "2018-01-20", "AddFaceUserPicture", "Linkvisual", "openAPI")
        {
        ...
        public override AddFaceUserPictureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFaceUserPictureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
