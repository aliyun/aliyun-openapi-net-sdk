...
{
    public class QueryTimeTemplateRequest : RpcAcsRequest<QueryTimeTemplateResponse>
    {
        public QueryTimeTemplateRequest()
            : base("Linkvisual", "2018-01-20", "QueryTimeTemplate", "Linkvisual", "openAPI")
        {
        ...
        public override QueryTimeTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryTimeTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
