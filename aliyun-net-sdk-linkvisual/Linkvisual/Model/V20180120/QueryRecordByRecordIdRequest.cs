...
{
    public class QueryRecordByRecordIdRequest : RpcAcsRequest<QueryRecordByRecordIdResponse>
    {
        public QueryRecordByRecordIdRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecordByRecordId", "Linkvisual", "openAPI")
        {
        ...
        public override QueryRecordByRecordIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordByRecordIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
