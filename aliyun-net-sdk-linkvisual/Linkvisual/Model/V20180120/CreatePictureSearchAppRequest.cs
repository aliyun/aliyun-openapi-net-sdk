...
{
    public class CreatePictureSearchAppRequest : RpcAcsRequest<CreatePictureSearchAppResponse>
    {
        public CreatePictureSearchAppRequest()
            : base("Linkvisual", "2018-01-20", "CreatePictureSearchApp", "Linkvisual", "openAPI")
        {
        ...
        public override CreatePictureSearchAppResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePictureSearchAppResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
