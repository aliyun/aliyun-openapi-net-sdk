...
{
    public class TransferDeviceInstanceRequest : RpcAcsRequest<TransferDeviceInstanceResponse>
    {
        public TransferDeviceInstanceRequest()
            : base("Linkvisual", "2018-01-20", "TransferDeviceInstance", "Linkvisual", "openAPI")
        {
        ...
        public override TransferDeviceInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TransferDeviceInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
