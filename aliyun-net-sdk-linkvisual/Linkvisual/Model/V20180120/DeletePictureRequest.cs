...
{
    public class DeletePictureRequest : RpcAcsRequest<DeletePictureResponse>
    {
        public DeletePictureRequest()
            : base("Linkvisual", "2018-01-20", "DeletePicture", "Linkvisual", "openAPI")
        {
        ...
        public override DeletePictureResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePictureResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
