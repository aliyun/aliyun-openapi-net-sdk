...
{
    public class QueryFaceUserBatchRequest : RpcAcsRequest<QueryFaceUserBatchResponse>
    {
        public QueryFaceUserBatchRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceUserBatch", "Linkvisual", "openAPI")
        {
		...
		private List<string> userIdLists = new List<string>(){ };
        ...
        public override QueryFaceUserBatchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceUserBatchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
