...
{
    public class ClearFaceDeviceDBRequest : RpcAcsRequest<ClearFaceDeviceDBResponse>
    {
        public ClearFaceDeviceDBRequest()
            : base("Linkvisual", "2018-01-20", "ClearFaceDeviceDB", "Linkvisual", "openAPI")
        {
        ...
        public override ClearFaceDeviceDBResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ClearFaceDeviceDBResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
