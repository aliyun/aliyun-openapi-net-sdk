...
{
    public class QueryRecordDownloadUrlRequest : RpcAcsRequest<QueryRecordDownloadUrlResponse>
    {
        public QueryRecordDownloadUrlRequest()
            : base("Linkvisual", "2018-01-20", "QueryRecordDownloadUrl", "Linkvisual", "openAPI")
        {
        ...
        public override QueryRecordDownloadUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRecordDownloadUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
