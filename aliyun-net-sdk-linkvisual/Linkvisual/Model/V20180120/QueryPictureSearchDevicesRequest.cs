...
{
    public class QueryPictureSearchDevicesRequest : RpcAcsRequest<QueryPictureSearchDevicesResponse>
    {
        public QueryPictureSearchDevicesRequest()
            : base("Linkvisual", "2018-01-20", "QueryPictureSearchDevices", "Linkvisual", "openAPI")
        {
        ...
        public override QueryPictureSearchDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryPictureSearchDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
