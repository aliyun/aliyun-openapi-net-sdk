...
{
    public class AddEventRecordPlanDeviceRequest : RpcAcsRequest<AddEventRecordPlanDeviceResponse>
    {
        public AddEventRecordPlanDeviceRequest()
            : base("Linkvisual", "2018-01-20", "AddEventRecordPlanDevice", "Linkvisual", "openAPI")
        {
        ...
        public override AddEventRecordPlanDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddEventRecordPlanDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
