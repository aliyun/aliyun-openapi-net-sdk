...
{
    public class QueryFaceUserRequest : RpcAcsRequest<QueryFaceUserResponse>
    {
        public QueryFaceUserRequest()
            : base("Linkvisual", "2018-01-20", "QueryFaceUser", "Linkvisual", "openAPI")
        {
        ...
        public override QueryFaceUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
