...
{
    public class DeleteEventRecordPlanDeviceRequest : RpcAcsRequest<DeleteEventRecordPlanDeviceResponse>
    {
        public DeleteEventRecordPlanDeviceRequest()
            : base("Linkvisual", "2018-01-20", "DeleteEventRecordPlanDevice", "Linkvisual", "openAPI")
        {
        ...
        public override DeleteEventRecordPlanDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEventRecordPlanDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
