...
{
    public class CreateImageProcessTaskRequest : RpcAcsRequest<CreateImageProcessTaskResponse>
    {
        public CreateImageProcessTaskRequest()
            : base("imm", "2017-09-06", "CreateImageProcessTask", "imm", "openAPI")
        {
        ...
        public override CreateImageProcessTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateImageProcessTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
