...
{
    public class CreateIndexFaceJobRequest : RpcAcsRequest<CreateIndexFaceJobResponse>
    {
        public CreateIndexFaceJobRequest()
            : base("imm", "2017-09-06", "CreateIndexFaceJob", "2017-09-06", "openAPI")
        {
        }
		...
		public string Chain
		{
			...
			{
				chain = value;
				DictionaryUtil.Add(QueryParameters, "Chain", value);
			}
		}
        ...
        public override CreateIndexFaceJobResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return CreateIndexFaceJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}