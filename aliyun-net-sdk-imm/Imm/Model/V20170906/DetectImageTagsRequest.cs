...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class DetectImageTagsRequest : RpcAcsRequest<DetectImageTagsResponse>
    {
        public DetectImageTagsRequest()
            : base("imm", "2017-09-06", "DetectImageTags", "2017-09-06", "openAPI")
        {
        }
        ...
        public override DetectImageTagsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
