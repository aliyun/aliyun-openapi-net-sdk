...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class CreateDocIndexTaskRequest : RpcAcsRequest<CreateDocIndexTaskResponse>
    {
        public CreateDocIndexTaskRequest()
            : base("imm", "2017-09-06", "CreateDocIndexTask", "2017-09-06", "openAPI")
        {
        }
        ...
        public override CreateDocIndexTaskResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
