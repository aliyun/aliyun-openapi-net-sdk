...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class IndexFaceRequest : RpcAcsRequest<IndexFaceResponse>
    {
        ...
        public override IndexFaceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return IndexFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}