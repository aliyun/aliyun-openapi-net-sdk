...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class ListFaceSearchGroupUsersRequest : RpcAcsRequest<ListFaceSearchGroupUsersResponse>
    {
        public ListFaceSearchGroupUsersRequest()
            : base("imm", "2017-09-06", "ListFaceSearchGroupUsers", "2017-09-06", "openAPI")
        {
        }
        ...
        public override ListFaceSearchGroupUsersResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
