...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class DetectImageTextsRequest : RpcAcsRequest<DetectImageTextsResponse>
    {
        public DetectImageTextsRequest()
            : base("imm", "2017-09-06", "DetectImageTexts", "2017-09-06", "openAPI")
        {
        }
        ...
        public override DetectImageTextsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
