...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class CreatePornBatchDetectJobRequest : RpcAcsRequest<CreatePornBatchDetectJobResponse>
    {
        public CreatePornBatchDetectJobRequest()
            : base("imm", "2017-09-06", "CreatePornBatchDetectJob", "2017-09-06", "openAPI")
        {
        }
        ...
        public override CreatePornBatchDetectJobResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
