...
{
	public class SearchImagesByTagNamesResponse : AcsResponse
	{
		...
		private List<SearchImagesByTagNames_Frames> images;
		...
		public List<SearchImagesByTagNames_Frames> Images
		{
			get
			{
				return images;
		...
		public class SearchImagesByTagNames_Frames
		{
			...
			private List<SearchImagesByTagNames_FacesItem> faces;

			private List<SearchImagesByTagNames_TagsItem> tags;

			private List<SearchImagesByTagNames_OCRItem> oCR;

			private List<SearchImagesByTagNames_CelebrityItem> celebrity;
			...
			public List<SearchImagesByTagNames_FacesItem> Faces
			{
				get
				{
					return faces;
			...
			public List<SearchImagesByTagNames_TagsItem> Tags
			{
				get
				{
					return tags;
			...
			public List<SearchImagesByTagNames_OCRItem> OCR
			{
				get
				{
					return oCR;
			...
			public List<SearchImagesByTagNames_CelebrityItem> Celebrity
			{
				get
				{
					return celebrity;
			...
			public class SearchImagesByTagNames_FacesItem
			{
				...
				private SearchImagesByTagNames_EmotionDetails emotionDetails;

				private SearchImagesByTagNames_FaceAttributes faceAttributes;
				...
				public SearchImagesByTagNames_EmotionDetails EmotionDetails
				{
					get
					{
				...
				public SearchImagesByTagNames_FaceAttributes FaceAttributes
				{
					get
					{
				...
				public class SearchImagesByTagNames_EmotionDetails
				{
				...
				public class SearchImagesByTagNames_FaceAttributes
				{
					...
					private SearchImagesByTagNames_FaceBoundary faceBoundary;
					...
					public SearchImagesByTagNames_FaceBoundary FaceBoundary
					{
						get
						{
							return faceBoundary;
					...
					public class SearchImagesByTagNames_FaceBoundary
					{
			...
			public class SearchImagesByTagNames_TagsItem
			{
			...
			public class SearchImagesByTagNames_OCRItem
			{
				...
				private SearchImagesByTagNames_OCRBoundary oCRBoundary;
				...
				public SearchImagesByTagNames_OCRBoundary OCRBoundary
				{
					get
					{
						return oCRBoundary;
				...
				public class SearchImagesByTagNames_OCRBoundary
				{
			...
			public class SearchImagesByTagNames_CelebrityItem
			{
				...
				private SearchImagesByTagNames_CelebrityBoundary celebrityBoundary;
				...
				public SearchImagesByTagNames_CelebrityBoundary CelebrityBoundary
				{
					get
					{
				...
				public class SearchImagesByTagNames_CelebrityBoundary
				{
