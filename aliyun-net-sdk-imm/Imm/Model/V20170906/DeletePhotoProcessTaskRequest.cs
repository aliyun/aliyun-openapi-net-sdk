...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class DeletePhotoProcessTaskRequest : RpcAcsRequest<DeletePhotoProcessTaskResponse>
    {
        public DeletePhotoProcessTaskRequest()
            : base("imm", "2017-09-06", "DeletePhotoProcessTask", "2017-09-06", "openAPI")
        {
        }
        ...
        public override DeletePhotoProcessTaskResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
