...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class DeleteFaceByIdRequest : RpcAcsRequest<DeleteFaceByIdResponse>
    {
        ...
        public override DeleteFaceByIdResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DeleteFaceByIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}