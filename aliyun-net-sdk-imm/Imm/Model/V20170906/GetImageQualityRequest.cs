...
{
    public class GetImageQualityRequest : RpcAcsRequest<GetImageQualityResponse>
    {
        public GetImageQualityRequest()
            : base("imm", "2017-09-06", "GetImageQuality", "imm", "openAPI")
        {
        ...
        public override GetImageQualityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetImageQualityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
