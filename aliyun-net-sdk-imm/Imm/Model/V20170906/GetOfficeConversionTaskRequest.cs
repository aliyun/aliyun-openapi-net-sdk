...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class GetOfficeConversionTaskRequest : RpcAcsRequest<GetOfficeConversionTaskResponse>
    {
        public GetOfficeConversionTaskRequest()
            : base("imm", "2017-09-06", "GetOfficeConversionTask", "2017-09-06", "openAPI")
        {
        }
        ...
        public override GetOfficeConversionTaskResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
