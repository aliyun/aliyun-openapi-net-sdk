...
namespace Aliyun.Acs.imm.Model.V20170906
{
    public class ListFaceGroupsRequest : RpcAcsRequest<ListFaceGroupsResponse>
    {
        public ListFaceGroupsRequest()
            : base("imm", "2017-09-06", "ListFaceGroups", "2017-09-06", "openAPI")
        {
        }
		...
		public int? Marker
		{
			...
			{
				marker = value;
				DictionaryUtil.Add(QueryParameters, "Marker", value.ToString());
			}
		}
        ...
        public override ListFaceGroupsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
