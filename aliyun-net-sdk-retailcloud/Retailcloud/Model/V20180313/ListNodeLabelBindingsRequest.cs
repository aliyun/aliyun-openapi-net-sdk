...
{
    public class ListNodeLabelBindingsRequest : RpcAcsRequest<ListNodeLabelBindingsResponse>
    {
        public ListNodeLabelBindingsRequest()
            : base("retailcloud", "2018-03-13", "ListNodeLabelBindings", "retailcloud", "openAPI")
        {
        ...
        public override ListNodeLabelBindingsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListNodeLabelBindingsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
