...
{
    public class DeleteSlbAPRequest : RpcAcsRequest<DeleteSlbAPResponse>
    {
        public DeleteSlbAPRequest()
            : base("retailcloud", "2018-03-13", "DeleteSlbAP", "retailcloud", "openAPI")
        {
        ...
        public override DeleteSlbAPResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSlbAPResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
