...
{
    public class CloseDeployOrderRequest : RpcAcsRequest<CloseDeployOrderResponse>
    {
        public CloseDeployOrderRequest()
            : base("retailcloud", "2018-03-13", "CloseDeployOrder", "retailcloud", "openAPI")
        {
        ...
        public override CloseDeployOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseDeployOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
