...
{
    public class QueryClusterDetailRequest : RpcAcsRequest<QueryClusterDetailResponse>
    {
        public QueryClusterDetailRequest()
            : base("retailcloud", "2018-03-13", "QueryClusterDetail", "retailcloud", "openAPI")
        {
        ...
        public override QueryClusterDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryClusterDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
