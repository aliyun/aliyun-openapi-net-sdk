...
{
    public class DescribeAppEnvironmentDetailRequest : RpcAcsRequest<DescribeAppEnvironmentDetailResponse>
    {
        public DescribeAppEnvironmentDetailRequest()
            : base("retailcloud", "2018-03-13", "DescribeAppEnvironmentDetail", "retailcloud", "openAPI")
        {
        ...
        public override DescribeAppEnvironmentDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAppEnvironmentDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
