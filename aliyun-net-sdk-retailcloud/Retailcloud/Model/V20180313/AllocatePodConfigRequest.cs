...
{
    public class AllocatePodConfigRequest : RpcAcsRequest<AllocatePodConfigResponse>
    {
        public AllocatePodConfigRequest()
            : base("retailcloud", "2018-03-13", "AllocatePodConfig", "retailcloud", "openAPI")
        {
        ...
        public override AllocatePodConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AllocatePodConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
