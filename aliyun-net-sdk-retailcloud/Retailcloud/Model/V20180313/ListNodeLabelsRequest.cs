...
{
    public class ListNodeLabelsRequest : RpcAcsRequest<ListNodeLabelsResponse>
    {
        public ListNodeLabelsRequest()
            : base("retailcloud", "2018-03-13", "ListNodeLabels", "retailcloud", "openAPI")
        {
        ...
        public override ListNodeLabelsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListNodeLabelsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
