...
{
    public class ListDeployConfigRequest : RpcAcsRequest<ListDeployConfigResponse>
    {
        public ListDeployConfigRequest()
            : base("retailcloud", "2018-03-13", "ListDeployConfig", "retailcloud", "openAPI")
        {
        ...
        public override ListDeployConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDeployConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
