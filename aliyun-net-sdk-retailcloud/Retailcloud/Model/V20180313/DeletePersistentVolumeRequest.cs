...
{
    public class DeletePersistentVolumeRequest : RpcAcsRequest<DeletePersistentVolumeResponse>
    {
        public DeletePersistentVolumeRequest()
            : base("retailcloud", "2018-03-13", "DeletePersistentVolume", "retailcloud", "openAPI")
        {
		...
		public string PersistentVolumeName
		{
			...
			set	
			{
				persistentVolumeName = value;
				DictionaryUtil.Add(BodyParameters, "PersistentVolumeName", value);
			}
		}
        ...
        public override DeletePersistentVolumeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePersistentVolumeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
