...
{
    public class DescribeSlbAPDetailRequest : RpcAcsRequest<DescribeSlbAPDetailResponse>
    {
        public DescribeSlbAPDetailRequest()
            : base("retailcloud", "2018-03-13", "DescribeSlbAPDetail", "retailcloud", "openAPI")
        {
        ...
        public override DescribeSlbAPDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSlbAPDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
