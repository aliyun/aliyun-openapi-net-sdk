...
{
    public class BindGroupRequest : RpcAcsRequest<BindGroupResponse>
    {
        public BindGroupRequest()
            : base("retailcloud", "2018-03-13", "BindGroup", "retailcloud", "openAPI")
        {
        ...
        public override BindGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
