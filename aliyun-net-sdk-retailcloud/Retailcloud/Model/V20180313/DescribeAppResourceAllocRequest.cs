...
{
    public class DescribeAppResourceAllocRequest : RpcAcsRequest<DescribeAppResourceAllocResponse>
    {
        public DescribeAppResourceAllocRequest()
            : base("retailcloud", "2018-03-13", "DescribeAppResourceAlloc", "retailcloud", "openAPI")
        {
        ...
        public override DescribeAppResourceAllocResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAppResourceAllocResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
