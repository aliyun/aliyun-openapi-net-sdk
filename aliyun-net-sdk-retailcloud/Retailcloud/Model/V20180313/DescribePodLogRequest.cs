...
{
    public class DescribePodLogRequest : RpcAcsRequest<DescribePodLogResponse>
    {
        public DescribePodLogRequest()
            : base("retailcloud", "2018-03-13", "DescribePodLog", "retailcloud", "openAPI")
        {
		...
		public long? DeployOrderId
		{
			...
			{
				deployOrderId = value;
				DictionaryUtil.Add(BodyParameters, "DeployOrderId", value.ToString());
			}
		}
		...
		public string AppInstId
		{
			...
			{
				appInstId = value;
				DictionaryUtil.Add(BodyParameters, "AppInstId", value);
			}
		}
        ...
        public override DescribePodLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePodLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
