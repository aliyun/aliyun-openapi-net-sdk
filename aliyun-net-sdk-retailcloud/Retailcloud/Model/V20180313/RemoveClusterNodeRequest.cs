...
{
    public class RemoveClusterNodeRequest : RpcAcsRequest<RemoveClusterNodeResponse>
    {
        public RemoveClusterNodeRequest()
            : base("retailcloud", "2018-03-13", "RemoveClusterNode", "retailcloud", "openAPI")
        {
        ...
        public override RemoveClusterNodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveClusterNodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
