...
{
    public class UnbindGroupRequest : RpcAcsRequest<UnbindGroupResponse>
    {
        public UnbindGroupRequest()
            : base("retailcloud", "2018-03-13", "UnbindGroup", "retailcloud", "openAPI")
        {
        ...
        public override UnbindGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
