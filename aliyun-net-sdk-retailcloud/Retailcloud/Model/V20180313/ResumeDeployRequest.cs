...
{
    public class ResumeDeployRequest : RpcAcsRequest<ResumeDeployResponse>
    {
        public ResumeDeployRequest()
            : base("retailcloud", "2018-03-13", "ResumeDeploy", "retailcloud", "openAPI")
        {
        ...
        public override ResumeDeployResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResumeDeployResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
