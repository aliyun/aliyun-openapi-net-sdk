...
{
	public class ListClusterNodeResponse : AcsResponse
	{
		...
		private List<ListClusterNode_ClusterNodeInfo> data;
		...
		public List<ListClusterNode_ClusterNodeInfo> Data
		{
			get
			{
				return data;
		...
		public class ListClusterNode_ClusterNodeInfo
		{
