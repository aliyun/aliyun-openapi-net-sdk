...
namespace Aliyun.Acs.retailcloud.Model.V20180313
{
    public class DescribeDeployOrderDetailRequest : RpcAcsRequest<DescribeDeployOrderDetailResponse>
    {
        ...
        public override DescribeDeployOrderDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDeployOrderDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
