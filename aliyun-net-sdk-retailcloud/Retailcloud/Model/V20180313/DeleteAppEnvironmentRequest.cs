...
{
    public class DeleteAppEnvironmentRequest : RpcAcsRequest<DeleteAppEnvironmentResponse>
    {
        public DeleteAppEnvironmentRequest()
            : base("retailcloud", "2018-03-13", "DeleteAppEnvironment", "retailcloud", "openAPI")
        {
        ...
        public override DeleteAppEnvironmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAppEnvironmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
