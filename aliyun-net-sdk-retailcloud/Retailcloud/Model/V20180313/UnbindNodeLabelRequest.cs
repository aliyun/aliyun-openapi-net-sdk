...
{
    public class UnbindNodeLabelRequest : RpcAcsRequest<UnbindNodeLabelResponse>
    {
        public UnbindNodeLabelRequest()
            : base("retailcloud", "2018-03-13", "UnbindNodeLabel", "retailcloud", "openAPI")
        {
        ...
        public override UnbindNodeLabelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindNodeLabelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
