...
{
    public class ListAppGroupMappingRequest : RpcAcsRequest<ListAppGroupMappingResponse>
    {
        public ListAppGroupMappingRequest()
            : base("retailcloud", "2018-03-13", "ListAppGroupMapping", "retailcloud", "openAPI")
        {
        ...
        public override ListAppGroupMappingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAppGroupMappingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
