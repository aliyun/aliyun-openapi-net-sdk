...
{
    public class ListAppGroupRequest : RpcAcsRequest<ListAppGroupResponse>
    {
        public ListAppGroupRequest()
            : base("retailcloud", "2018-03-13", "ListAppGroup", "retailcloud", "openAPI")
        {
        ...
        public override ListAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
