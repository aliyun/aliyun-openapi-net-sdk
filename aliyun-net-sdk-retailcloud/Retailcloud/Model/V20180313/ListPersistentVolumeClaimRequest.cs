...
{
    public class ListPersistentVolumeClaimRequest : RpcAcsRequest<ListPersistentVolumeClaimResponse>
    {
        public ListPersistentVolumeClaimRequest()
            : base("retailcloud", "2018-03-13", "ListPersistentVolumeClaim", "retailcloud", "openAPI")
        {
        ...
        public override ListPersistentVolumeClaimResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPersistentVolumeClaimResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
