...
{
    public class ListClusterNodeRequest : RpcAcsRequest<ListClusterNodeResponse>
    {
        public ListClusterNodeRequest()
            : base("retailcloud", "2018-03-13", "ListClusterNode", "retailcloud", "openAPI")
        {
        ...
        public override ListClusterNodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListClusterNodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
