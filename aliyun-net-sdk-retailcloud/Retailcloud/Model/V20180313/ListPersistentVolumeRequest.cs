...
{
    public class ListPersistentVolumeRequest : RpcAcsRequest<ListPersistentVolumeResponse>
    {
        public ListPersistentVolumeRequest()
            : base("retailcloud", "2018-03-13", "ListPersistentVolume", "retailcloud", "openAPI")
        {
        ...
        public override ListPersistentVolumeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPersistentVolumeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
