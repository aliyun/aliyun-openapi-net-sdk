...
{
    public class ListAppRequest : RpcAcsRequest<ListAppResponse>
    {
        public ListAppRequest()
            : base("retailcloud", "2018-03-13", "ListApp", "retailcloud", "openAPI")
        {
        ...
        public override ListAppResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAppResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
