...
{
    public class ListAppEnvironmentRequest : RpcAcsRequest<ListAppEnvironmentResponse>
    {
        public ListAppEnvironmentRequest()
            : base("retailcloud", "2018-03-13", "ListAppEnvironment", "retailcloud", "openAPI")
        {
        ...
        public override ListAppEnvironmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAppEnvironmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
