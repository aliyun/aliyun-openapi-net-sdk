...
namespace Aliyun.Acs.jarvis.Model.V20180206
{
    public class DescribeCpmcPunishListRequest : RpcAcsRequest<DescribeCpmcPunishListResponse>
    {
        public DescribeCpmcPunishListRequest()
            : base("jarvis", "2018-02-06", "DescribeCpmcPunishList")
        {
        }
        ...
        public override DescribeCpmcPunishListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
