...
namespace Aliyun.Acs.jarvis.Model.V20180206
{
    public class ModifyUidWhiteListAutoShareRequest : RpcAcsRequest<ModifyUidWhiteListAutoShareResponse>
    {
        public ModifyUidWhiteListAutoShareRequest()
            : base("jarvis", "2018-02-06", "ModifyUidWhiteListAutoShare")
        {
        }
        ...
        public override ModifyUidWhiteListAutoShareResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
