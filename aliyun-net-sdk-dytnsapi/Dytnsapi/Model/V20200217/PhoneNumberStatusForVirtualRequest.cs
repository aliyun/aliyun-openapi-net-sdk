...
{
    public class PhoneNumberStatusForVirtualRequest : RpcAcsRequest<PhoneNumberStatusForVirtualResponse>
    {
        public PhoneNumberStatusForVirtualRequest()
            : base("Dytnsapi", "2020-02-17", "PhoneNumberStatusForVirtual")
        {
        ...
        public override PhoneNumberStatusForVirtualResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PhoneNumberStatusForVirtualResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
