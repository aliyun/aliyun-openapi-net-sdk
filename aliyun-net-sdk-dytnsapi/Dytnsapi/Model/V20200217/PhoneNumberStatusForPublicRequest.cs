...
{
    public class PhoneNumberStatusForPublicRequest : RpcAcsRequest<PhoneNumberStatusForPublicResponse>
    {
        public PhoneNumberStatusForPublicRequest()
            : base("Dytnsapi", "2020-02-17", "PhoneNumberStatusForPublic")
        {
        ...
        public override PhoneNumberStatusForPublicResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PhoneNumberStatusForPublicResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
