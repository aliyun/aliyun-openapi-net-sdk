...
{
    public class DescribeEmptyNumberRequest : RpcAcsRequest<DescribeEmptyNumberResponse>
    {
        public DescribeEmptyNumberRequest()
            : base("Dytnsapi", "2020-02-17", "DescribeEmptyNumber")
        {
        ...
        public override DescribeEmptyNumberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeEmptyNumberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
