...
{
    public class PhoneNumberStatusForSmsRequest : RpcAcsRequest<PhoneNumberStatusForSmsResponse>
    {
        public PhoneNumberStatusForSmsRequest()
            : base("Dytnsapi", "2020-02-17", "PhoneNumberStatusForSms")
        {
        ...
        public override PhoneNumberStatusForSmsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PhoneNumberStatusForSmsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
