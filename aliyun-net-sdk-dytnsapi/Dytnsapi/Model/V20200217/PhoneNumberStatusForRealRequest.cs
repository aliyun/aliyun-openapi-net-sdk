...
{
    public class PhoneNumberStatusForRealRequest : RpcAcsRequest<PhoneNumberStatusForRealResponse>
    {
        public PhoneNumberStatusForRealRequest()
            : base("Dytnsapi", "2020-02-17", "PhoneNumberStatusForReal")
        {
        ...
        public override PhoneNumberStatusForRealResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PhoneNumberStatusForRealResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
