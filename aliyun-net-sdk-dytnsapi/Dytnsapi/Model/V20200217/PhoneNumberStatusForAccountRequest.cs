...
{
    public class PhoneNumberStatusForAccountRequest : RpcAcsRequest<PhoneNumberStatusForAccountResponse>
    {
        public PhoneNumberStatusForAccountRequest()
            : base("Dytnsapi", "2020-02-17", "PhoneNumberStatusForAccount")
        {
        ...
        public override PhoneNumberStatusForAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PhoneNumberStatusForAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
