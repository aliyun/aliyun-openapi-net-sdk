...
{
    public class ThreeElementsVerificationRequest : RpcAcsRequest<ThreeElementsVerificationResponse>
    {
        public ThreeElementsVerificationRequest()
            : base("Dytnsapi", "2020-02-17", "ThreeElementsVerification")
        {
        ...
        public override ThreeElementsVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ThreeElementsVerificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
