...
{
    public class DescribeEmptyNumberDetectRequest : RpcAcsRequest<DescribeEmptyNumberDetectResponse>
    {
        public DescribeEmptyNumberDetectRequest()
            : base("Dytnsapi", "2020-02-17", "DescribeEmptyNumberDetect")
        {
        ...
        public override DescribeEmptyNumberDetectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeEmptyNumberDetectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
