...
{
    public class TwoElementsVerificationRequest : RpcAcsRequest<TwoElementsVerificationResponse>
    {
        public TwoElementsVerificationRequest()
            : base("Dytnsapi", "2020-02-17", "TwoElementsVerification")
        {
        ...
        public override TwoElementsVerificationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TwoElementsVerificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
