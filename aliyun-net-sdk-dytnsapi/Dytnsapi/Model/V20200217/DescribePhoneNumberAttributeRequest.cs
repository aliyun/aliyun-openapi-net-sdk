...
{
    public class DescribePhoneNumberAttributeRequest : RpcAcsRequest<DescribePhoneNumberAttributeResponse>
    {
        public DescribePhoneNumberAttributeRequest()
            : base("Dytnsapi", "2020-02-17", "DescribePhoneNumberAttribute")
        {
        ...
        public override DescribePhoneNumberAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePhoneNumberAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
