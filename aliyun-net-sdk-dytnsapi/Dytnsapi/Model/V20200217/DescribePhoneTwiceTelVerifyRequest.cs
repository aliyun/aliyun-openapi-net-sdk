...
{
    public class DescribePhoneTwiceTelVerifyRequest : RpcAcsRequest<DescribePhoneTwiceTelVerifyResponse>
    {
        public DescribePhoneTwiceTelVerifyRequest()
            : base("Dytnsapi", "2020-02-17", "DescribePhoneTwiceTelVerify")
        {
        ...
        public override DescribePhoneTwiceTelVerifyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePhoneTwiceTelVerifyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
