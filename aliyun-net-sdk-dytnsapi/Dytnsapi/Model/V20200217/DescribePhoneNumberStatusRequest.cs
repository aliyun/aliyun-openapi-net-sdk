...
{
    public class DescribePhoneNumberStatusRequest : RpcAcsRequest<DescribePhoneNumberStatusResponse>
    {
        public DescribePhoneNumberStatusRequest()
            : base("Dytnsapi", "2020-02-17", "DescribePhoneNumberStatus")
        {
        ...
        public override DescribePhoneNumberStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePhoneNumberStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
