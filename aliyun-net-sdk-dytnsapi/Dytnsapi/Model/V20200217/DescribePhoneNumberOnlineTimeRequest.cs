...
{
    public class DescribePhoneNumberOnlineTimeRequest : RpcAcsRequest<DescribePhoneNumberOnlineTimeResponse>
    {
        public DescribePhoneNumberOnlineTimeRequest()
            : base("Dytnsapi", "2020-02-17", "DescribePhoneNumberOnlineTime")
        {
        ...
        public override DescribePhoneNumberOnlineTimeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePhoneNumberOnlineTimeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
