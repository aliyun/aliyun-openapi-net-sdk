...
{
    public class DescribePhoneNumberOperatorAttributeRequest : RpcAcsRequest<DescribePhoneNumberOperatorAttributeResponse>
    {
        public DescribePhoneNumberOperatorAttributeRequest()
            : base("Dytnsapi", "2020-02-17", "DescribePhoneNumberOperatorAttribute")
        {
        ...
        public override DescribePhoneNumberOperatorAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePhoneNumberOperatorAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
