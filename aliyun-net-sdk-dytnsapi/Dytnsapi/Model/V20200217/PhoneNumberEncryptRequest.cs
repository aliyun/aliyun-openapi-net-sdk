...
{
    public class PhoneNumberEncryptRequest : RpcAcsRequest<PhoneNumberEncryptResponse>
    {
        public PhoneNumberEncryptRequest()
            : base("Dytnsapi", "2020-02-17", "PhoneNumberEncrypt")
        {
        ...
        public override PhoneNumberEncryptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PhoneNumberEncryptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
