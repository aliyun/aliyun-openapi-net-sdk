...
{
    public class ModifyAsrVadConfigRequest : RpcAcsRequest<ModifyAsrVadConfigResponse>
    {
        public ModifyAsrVadConfigRequest()
            : base("VoiceNavigator", "2018-06-12", "ModifyAsrVadConfig", "voicebot", "openAPI")
        {
		...
		public string SpeechNoiseThreshold
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SpeechNoiseThreshold", value);
			}
		}
        ...
        public override ModifyAsrVadConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyAsrVadConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
