...
{
    public class CreateDownloadUrlRequest : RpcAcsRequest<CreateDownloadUrlResponse>
    {
        public CreateDownloadUrlRequest()
            : base("VoiceNavigator", "2018-06-12", "CreateDownloadUrl", "voicebot", "openAPI")
        {
		...
		public string DownloadTaskId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "DownloadTaskId", value);
			}
		}
        ...
        public override CreateDownloadUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDownloadUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
