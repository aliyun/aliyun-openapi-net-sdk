...
{
    public class EnableSandBoxWhileListRequest : RpcAcsRequest<EnableSandBoxWhileListResponse>
    {
        public EnableSandBoxWhileListRequest()
            : base("VoiceNavigator", "2018-06-12", "EnableSandBoxWhileList", "voicebot", "openAPI")
        {
        ...
        public override EnableSandBoxWhileListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableSandBoxWhileListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
