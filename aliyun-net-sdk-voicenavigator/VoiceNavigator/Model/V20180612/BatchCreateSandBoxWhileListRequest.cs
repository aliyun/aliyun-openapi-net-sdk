...
{
    public class BatchCreateSandBoxWhileListRequest : RpcAcsRequest<BatchCreateSandBoxWhileListResponse>
    {
        public BatchCreateSandBoxWhileListRequest()
            : base("VoiceNavigator", "2018-06-12", "BatchCreateSandBoxWhileList", "voicebot", "openAPI")
        {
		...
		public string WhiteListJson
		{
			...
			{
				whiteListJson = value;
				DictionaryUtil.Add(QueryParameters, "WhiteListJson", value);
			}
		}
        ...
        public override BatchCreateSandBoxWhileListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchCreateSandBoxWhileListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
