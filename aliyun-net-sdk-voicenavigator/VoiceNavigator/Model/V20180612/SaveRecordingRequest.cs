...
{
    public class SaveRecordingRequest : RpcAcsRequest<SaveRecordingResponse>
    {
        public SaveRecordingRequest()
            : base("VoiceNavigator", "2018-06-12", "SaveRecording", "voicebot", "openAPI")
        {
        ...
        public override SaveRecordingResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveRecordingResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
