...
{
    public class ExportStatisticalDataRequest : RpcAcsRequest<ExportStatisticalDataResponse>
    {
        public ExportStatisticalDataRequest()
            : base("VoiceNavigator", "2018-06-12", "ExportStatisticalData", "voicebot", "openAPI")
        {
        ...
        public override ExportStatisticalDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExportStatisticalDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
