...
{
    public class ModifyUnrecognizingConfigRequest : RpcAcsRequest<ModifyUnrecognizingConfigResponse>
    {
        public ModifyUnrecognizingConfigRequest()
            : base("VoiceNavigator", "2018-06-12", "ModifyUnrecognizingConfig", "voicebot", "openAPI")
        {
        ...
        public override ModifyUnrecognizingConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyUnrecognizingConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
