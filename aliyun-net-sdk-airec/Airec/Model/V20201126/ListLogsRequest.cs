...
{
    public class ListLogsRequest : RoaAcsRequest<ListLogsResponse>
    {
        public ListLogsRequest()
            : base("Airec", "2020-11-26", "ListLogs", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/logs";
		...
		public string QueryParams
		{
			...
			{
				queryParams = value;
				DictionaryUtil.Add(QueryParameters, "queryParams", value);
			}
		}
        ...
        public override ListLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
