...
{
    public class ListUserClustersRequest : RoaAcsRequest<ListUserClustersResponse>
    {
        public ListUserClustersRequest()
            : base("Airec", "2020-11-26", "ListUserClusters", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/user-clusters";
        ...
        public override ListUserClustersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserClustersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
