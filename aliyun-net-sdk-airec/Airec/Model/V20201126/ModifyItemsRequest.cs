...
{
    public class ModifyItemsRequest : RoaAcsRequest<ModifyItemsResponse>
    {
        public ModifyItemsRequest()
            : base("Airec", "2020-11-26", "ModifyItems", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/items";
        ...
        public override ModifyItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
