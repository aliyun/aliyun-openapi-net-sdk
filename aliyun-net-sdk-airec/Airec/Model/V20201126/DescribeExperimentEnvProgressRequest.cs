...
{
    public class DescribeExperimentEnvProgressRequest : RoaAcsRequest<DescribeExperimentEnvProgressResponse>
    {
        public DescribeExperimentEnvProgressRequest()
            : base("Airec", "2020-11-26", "DescribeExperimentEnvProgress", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/experiment-progress";
        ...
        public override DescribeExperimentEnvProgressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeExperimentEnvProgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
