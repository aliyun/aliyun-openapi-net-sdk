...
{
    public class ListRuleTasksRequest : RoaAcsRequest<ListRuleTasksResponse>
    {
        public ListRuleTasksRequest()
            : base("Airec", "2020-11-26", "ListRuleTasks", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/rule-tasks";
        ...
        public override ListRuleTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRuleTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
