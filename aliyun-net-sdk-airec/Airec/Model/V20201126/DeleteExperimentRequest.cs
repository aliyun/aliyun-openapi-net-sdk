...
{
    public class DeleteExperimentRequest : RoaAcsRequest<DeleteExperimentResponse>
    {
        public DeleteExperimentRequest()
            : base("Airec", "2020-11-26", "DeleteExperiment", "airec", "openAPI")
        {
        ...
        public override DeleteExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
