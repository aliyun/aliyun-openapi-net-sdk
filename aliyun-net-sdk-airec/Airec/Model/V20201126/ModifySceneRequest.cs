...
{
    public class ModifySceneRequest : RoaAcsRequest<ModifySceneResponse>
    {
        public ModifySceneRequest()
            : base("Airec", "2020-11-26", "ModifyScene", "airec", "openAPI")
        {
        ...
        public override ModifySceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
