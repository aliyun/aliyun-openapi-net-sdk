...
{
    public class DescribeFilteringAlgorithmRequest : RoaAcsRequest<DescribeFilteringAlgorithmResponse>
    {
        public DescribeFilteringAlgorithmRequest()
            : base("Airec", "2020-11-26", "DescribeFilteringAlgorithm", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/filtering-algorithms/[algorithmId]";
        ...
        public override DescribeFilteringAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeFilteringAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
