...
{
    public class DescribeExperimentRequest : RoaAcsRequest<DescribeExperimentResponse>
    {
        public DescribeExperimentRequest()
            : base("Airec", "2020-11-26", "DescribeExperiment", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/experiments/[experimentId]";
        ...
        public override DescribeExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
