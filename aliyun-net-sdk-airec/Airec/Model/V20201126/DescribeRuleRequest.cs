...
{
    public class DescribeRuleRequest : RoaAcsRequest<DescribeRuleResponse>
    {
        public DescribeRuleRequest()
            : base("Airec", "2020-11-26", "DescribeRule", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/rules/[ruleId]";
        ...
        public override DescribeRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
