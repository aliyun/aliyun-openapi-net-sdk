...
{
    public class CreateRankingModelRequest : RoaAcsRequest<CreateRankingModelResponse>
    {
        public CreateRankingModelRequest()
            : base("Airec", "2020-11-26", "CreateRankingModel", "airec", "openAPI")
        {
        ...
        public override CreateRankingModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRankingModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
