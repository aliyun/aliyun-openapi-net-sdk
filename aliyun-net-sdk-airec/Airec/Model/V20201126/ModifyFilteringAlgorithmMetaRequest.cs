...
{
    public class ModifyFilteringAlgorithmMetaRequest : RoaAcsRequest<ModifyFilteringAlgorithmMetaResponse>
    {
        public ModifyFilteringAlgorithmMetaRequest()
            : base("Airec", "2020-11-26", "ModifyFilteringAlgorithmMeta", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/filtering-algorithms/[algorithmId]/meta";
        ...
        public override ModifyFilteringAlgorithmMetaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFilteringAlgorithmMetaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
