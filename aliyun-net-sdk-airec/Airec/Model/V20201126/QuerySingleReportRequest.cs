...
{
    public class QuerySingleReportRequest : RoaAcsRequest<QuerySingleReportResponse>
    {
        public QuerySingleReportRequest()
            : base("Airec", "2020-11-26", "QuerySingleReport", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/sync-reports/single-report";
        ...
        public override QuerySingleReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySingleReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
