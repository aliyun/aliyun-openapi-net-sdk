...
{
    public class DescribeBaseExperimentRequest : RoaAcsRequest<DescribeBaseExperimentResponse>
    {
        public DescribeBaseExperimentRequest()
            : base("Airec", "2020-11-26", "DescribeBaseExperiment", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/base-experiment";
        ...
        public override DescribeBaseExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBaseExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
