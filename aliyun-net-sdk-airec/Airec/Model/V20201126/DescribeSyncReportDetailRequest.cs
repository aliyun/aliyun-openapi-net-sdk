...
{
    public class DescribeSyncReportDetailRequest : RoaAcsRequest<DescribeSyncReportDetailResponse>
    {
        public DescribeSyncReportDetailRequest()
            : base("Airec", "2020-11-26", "DescribeSyncReportDetail", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/sync-reports/detail";
        ...
        public override DescribeSyncReportDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSyncReportDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
