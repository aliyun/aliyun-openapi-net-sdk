...
{
    public class ListRankingModelsRequest : RoaAcsRequest<ListRankingModelsResponse>
    {
        public ListRankingModelsRequest()
            : base("Airec", "2020-11-26", "ListRankingModels", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/ranking-models";
		...
		public string RankingModelId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "rankingModelId", value);
			}
		}
        ...
        public override ListRankingModelsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRankingModelsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
