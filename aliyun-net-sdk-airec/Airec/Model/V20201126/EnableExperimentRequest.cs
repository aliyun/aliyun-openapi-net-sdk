...
{
    public class EnableExperimentRequest : RoaAcsRequest<EnableExperimentResponse>
    {
        public EnableExperimentRequest()
            : base("Airec", "2020-11-26", "EnableExperiment", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/actions/enable-experiment";
        ...
        public override EnableExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
