...
{
    public class ListDashboardDetailsFlowsRequest : RoaAcsRequest<ListDashboardDetailsFlowsResponse>
    {
        public ListDashboardDetailsFlowsRequest()
            : base("Airec", "2020-11-26", "ListDashboardDetailsFlows", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/dashboard/details/flows";
		...
		public string ExperimentIds
		{
			...
			{
				experimentIds = value;
				DictionaryUtil.Add(QueryParameters, "experimentIds", value);
			}
		}
		...
		public string TraceIds
		{
			...
			{
				traceIds = value;
				DictionaryUtil.Add(QueryParameters, "traceIds", value);
			}
		}
		...
		public string SceneIds
		{
			...
			{
				sceneIds = value;
				DictionaryUtil.Add(QueryParameters, "sceneIds", value);
			}
		}
        ...
        public override ListDashboardDetailsFlowsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDashboardDetailsFlowsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
