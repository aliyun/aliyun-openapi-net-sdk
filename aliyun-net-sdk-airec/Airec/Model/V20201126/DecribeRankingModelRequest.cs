...
{
    public class DecribeRankingModelRequest : RoaAcsRequest<DecribeRankingModelResponse>
    {
        public DecribeRankingModelRequest()
            : base("Airec", "2020-11-26", "DecribeRankingModel", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/ranking-models/[rankingModelId]";
        ...
        public override DecribeRankingModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DecribeRankingModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
