...
{
    public class DescribeSceneThroughputRequest : RoaAcsRequest<DescribeSceneThroughputResponse>
    {
        public DescribeSceneThroughputRequest()
            : base("Airec", "2020-11-26", "DescribeSceneThroughput", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/throughput";
        ...
        public override DescribeSceneThroughputResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSceneThroughputResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
