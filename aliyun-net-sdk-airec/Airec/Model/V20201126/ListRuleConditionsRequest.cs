...
{
    public class ListRuleConditionsRequest : RoaAcsRequest<ListRuleConditionsResponse>
    {
        public ListRuleConditionsRequest()
            : base("Airec", "2020-11-26", "ListRuleConditions", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/rule-conditions";
        ...
        public override ListRuleConditionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRuleConditionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
