...
{
    public class ListRulesRequest : RoaAcsRequest<ListRulesResponse>
    {
        public ListRulesRequest()
            : base("Airec", "2020-11-26", "ListRules", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/rules";
        ...
        public override ListRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
