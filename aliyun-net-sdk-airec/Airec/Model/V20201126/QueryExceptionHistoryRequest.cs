...
{
    public class QueryExceptionHistoryRequest : RoaAcsRequest<QueryExceptionHistoryResponse>
    {
        public QueryExceptionHistoryRequest()
            : base("Airec", "2020-11-26", "QueryExceptionHistory", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/sync-reports/exception-history";
        ...
        public override QueryExceptionHistoryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryExceptionHistoryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
