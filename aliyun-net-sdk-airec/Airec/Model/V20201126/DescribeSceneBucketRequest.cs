...
{
    public class DescribeSceneBucketRequest : RoaAcsRequest<DescribeSceneBucketResponse>
    {
        public DescribeSceneBucketRequest()
            : base("Airec", "2020-11-26", "DescribeSceneBucket", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/experiment-bucket";
        ...
        public override DescribeSceneBucketResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSceneBucketResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
