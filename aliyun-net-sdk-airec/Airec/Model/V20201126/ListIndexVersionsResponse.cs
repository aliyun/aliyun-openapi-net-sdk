...
{
	public class ListIndexVersionsResponse : AcsResponse
	{

		private string requestId;

		private List<ListIndexVersions_IndeVersion> result;
		...
		public List<ListIndexVersions_IndeVersion> Result
		{
			get
			{
				return result;
		...
		public class ListIndexVersions_IndeVersion
		{
