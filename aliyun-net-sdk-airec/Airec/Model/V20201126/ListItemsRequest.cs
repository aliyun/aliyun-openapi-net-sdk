...
{
    public class ListItemsRequest : RoaAcsRequest<ListItemsResponse>
    {
        public ListItemsRequest()
            : base("Airec", "2020-11-26", "ListItems", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/items/actions/list";
        ...
        public override ListItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
