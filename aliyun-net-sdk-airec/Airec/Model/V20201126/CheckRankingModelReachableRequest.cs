...
{
    public class CheckRankingModelReachableRequest : RoaAcsRequest<CheckRankingModelReachableResponse>
    {
        public CheckRankingModelReachableRequest()
            : base("Airec", "2020-11-26", "CheckRankingModelReachable", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/ranking-models/[rankingModelId]/actions/check-connectivity";
		...
		public string RankingModelId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(PathParameters, "rankingModelId", value);
			}
		}
        ...
        public override CheckRankingModelReachableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckRankingModelReachableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
