...
{
    public class DeleteSceneRequest : RoaAcsRequest<DeleteSceneResponse>
    {
        public DeleteSceneRequest()
            : base("Airec", "2020-11-26", "DeleteScene", "airec", "openAPI")
        {
        ...
        public override DeleteSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
