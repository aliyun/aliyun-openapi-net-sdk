...
{
    public class QuerySyncReportAggregationRequest : RoaAcsRequest<QuerySyncReportAggregationResponse>
    {
        public QuerySyncReportAggregationRequest()
            : base("Airec", "2020-11-26", "QuerySyncReportAggregation", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/sync-reports/aggregation";
        ...
        public override QuerySyncReportAggregationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySyncReportAggregationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
