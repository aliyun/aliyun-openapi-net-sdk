...
{
    public class ListExperimentsRequest : RoaAcsRequest<ListExperimentsResponse>
    {
        public ListExperimentsRequest()
            : base("Airec", "2020-11-26", "ListExperiments", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/experiments";
        ...
        public override ListExperimentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListExperimentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
