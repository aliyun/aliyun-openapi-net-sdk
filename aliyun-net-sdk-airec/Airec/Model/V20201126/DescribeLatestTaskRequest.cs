...
{
    public class DescribeLatestTaskRequest : RoaAcsRequest<DescribeLatestTaskResponse>
    {
        public DescribeLatestTaskRequest()
            : base("Airec", "2020-11-26", "DescribeLatestTask", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/filtering-algorithms/[algorithmId]/tasks/latest";
        ...
        public override DescribeLatestTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLatestTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
