...
{
	public class OfflineFilteringAlgorithmResponse : AcsResponse
	{

		private string requestId;

		private OfflineFilteringAlgorithm_Result result;
		...
		public OfflineFilteringAlgorithm_Result Result
		{
			get
			{
				return result;
		...
		public class OfflineFilteringAlgorithm_Result
		{
			...
			private OfflineFilteringAlgorithm_Meta meta;
			...
			public OfflineFilteringAlgorithm_Meta Meta
			{
				get
				{
					return meta;
			...
			public class OfflineFilteringAlgorithm_Meta
			{
				...
				private OfflineFilteringAlgorithm_ExtInfo extInfo;

				private OfflineFilteringAlgorithm_Threshold threshold;
				...
				public OfflineFilteringAlgorithm_ExtInfo ExtInfo
				{
					get
					{
						return extInfo;
				...
				public OfflineFilteringAlgorithm_Threshold Threshold
				{
					get
					{
						return threshold;
				...
				public class OfflineFilteringAlgorithm_ExtInfo
				{
				...
				public class OfflineFilteringAlgorithm_Threshold
				{
