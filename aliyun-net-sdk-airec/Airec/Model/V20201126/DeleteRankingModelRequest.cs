...
{
    public class DeleteRankingModelRequest : RoaAcsRequest<DeleteRankingModelResponse>
    {
        public DeleteRankingModelRequest()
            : base("Airec", "2020-11-26", "DeleteRankingModel", "airec", "openAPI")
        {
        ...
        public override DeleteRankingModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRankingModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
