...
{
    public class ModifyRankingModelRequest : RoaAcsRequest<ModifyRankingModelResponse>
    {
        public ModifyRankingModelRequest()
            : base("Airec", "2020-11-26", "ModifyRankingModel", "airec", "openAPI")
        {
        ...
        public override ModifyRankingModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyRankingModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
