...
{
    public class DeleteFilteringAlgorithmRequest : RoaAcsRequest<DeleteFilteringAlgorithmResponse>
    {
        public DeleteFilteringAlgorithmRequest()
            : base("Airec", "2020-11-26", "DeleteFilteringAlgorithm", "airec", "openAPI")
        {
        ...
        public override DeleteFilteringAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFilteringAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
