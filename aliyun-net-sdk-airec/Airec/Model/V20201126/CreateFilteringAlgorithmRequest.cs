...
{
    public class CreateFilteringAlgorithmRequest : RoaAcsRequest<CreateFilteringAlgorithmResponse>
    {
        public CreateFilteringAlgorithmRequest()
            : base("Airec", "2020-11-26", "CreateFilteringAlgorithm", "airec", "openAPI")
        {
        ...
        public override CreateFilteringAlgorithmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFilteringAlgorithmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
