...
{
    public class DescribeDefaultAlgorithmsRequest : RoaAcsRequest<DescribeDefaultAlgorithmsResponse>
    {
        public DescribeDefaultAlgorithmsRequest()
            : base("Airec", "2020-11-26", "DescribeDefaultAlgorithms", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/default-algorithms";
        ...
        public override DescribeDefaultAlgorithmsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDefaultAlgorithmsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
