...
{
    public class RebuildIndexRequest : RoaAcsRequest<RebuildIndexResponse>
    {
        public RebuildIndexRequest()
            : base("Airec", "2020-11-26", "RebuildIndex", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/filtering-algorithms/[algorithmId]/actions/rebuild";
        ...
        public override RebuildIndexResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RebuildIndexResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
