...
{
    public class ListUmengAppkeysRequest : RoaAcsRequest<ListUmengAppkeysResponse>
    {
        public ListUmengAppkeysRequest()
            : base("Airec", "2020-11-26", "ListUmengAppkeys", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/umeng/appkeys";
        ...
        public override ListUmengAppkeysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUmengAppkeysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
