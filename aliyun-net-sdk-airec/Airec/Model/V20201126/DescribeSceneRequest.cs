...
{
    public class DescribeSceneRequest : RoaAcsRequest<DescribeSceneResponse>
    {
        public DescribeSceneRequest()
            : base("Airec", "2020-11-26", "DescribeScene", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]";
        ...
        public override DescribeSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
