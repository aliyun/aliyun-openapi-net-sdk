...
{
    public class ListMixCategoriesRequest : RoaAcsRequest<ListMixCategoriesResponse>
    {
        public ListMixCategoriesRequest()
            : base("Airec", "2020-11-26", "ListMixCategories", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/configurations/mixCategories";
        ...
        public override ListMixCategoriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMixCategoriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
