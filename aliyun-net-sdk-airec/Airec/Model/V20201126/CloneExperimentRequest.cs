...
{
    public class CloneExperimentRequest : RoaAcsRequest<CloneExperimentResponse>
    {
        public CloneExperimentRequest()
            : base("Airec", "2020-11-26", "CloneExperiment", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/experiments/[experimentId]/actions/clone";
        ...
        public override CloneExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloneExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
