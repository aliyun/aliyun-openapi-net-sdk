...
{
    public class UnLockIndexVersionRequest : RoaAcsRequest<UnLockIndexVersionResponse>
    {
        public UnLockIndexVersionRequest()
            : base("Airec", "2020-11-26", "UnLockIndexVersion", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/filtering-algorithms/[algorithmId]/actions/unlock";
        ...
        public override UnLockIndexVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnLockIndexVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
