...
{
    public class DescribeExperimentEnvRequest : RoaAcsRequest<DescribeExperimentEnvResponse>
    {
        public DescribeExperimentEnvRequest()
            : base("Airec", "2020-11-26", "DescribeExperimentEnv", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes/[sceneId]/experiment-env";
        ...
        public override DescribeExperimentEnvResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeExperimentEnvResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
