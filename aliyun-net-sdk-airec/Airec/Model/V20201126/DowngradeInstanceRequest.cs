...
{
    public class DowngradeInstanceRequest : RoaAcsRequest<DowngradeInstanceResponse>
    {
        public DowngradeInstanceRequest()
            : base("Airec", "2020-11-26", "DowngradeInstance", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/actions/downgrade";
        ...
        public override DowngradeInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DowngradeInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
