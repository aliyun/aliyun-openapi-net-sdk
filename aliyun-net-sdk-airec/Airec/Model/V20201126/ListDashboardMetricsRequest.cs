...
{
    public class ListDashboardMetricsRequest : RoaAcsRequest<ListDashboardMetricsResponse>
    {
        public ListDashboardMetricsRequest()
            : base("Airec", "2020-11-26", "ListDashboardMetrics", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/dashboard/metrics";
        ...
        public override ListDashboardMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDashboardMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
