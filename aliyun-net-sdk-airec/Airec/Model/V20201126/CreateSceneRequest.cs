...
{
    public class CreateSceneRequest : RoaAcsRequest<CreateSceneResponse>
    {
        public CreateSceneRequest()
            : base("Airec", "2020-11-26", "CreateScene", "airec", "openAPI")
        {
			...
			UriPattern = "/v2/openapi/instances/[instanceId]/scenes";
        ...
        public override CreateSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
