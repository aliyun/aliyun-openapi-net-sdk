...
namespace Aliyun.Acs.Airec.Transform.V20201126
{
    public class DeleteDataSetResponseUnmarshaller
    {
        public static DeleteDataSetResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			result.GmtCreate = _ctx.LongValue("DeleteDataSet.Result.gmtCreate");
			result.GmtModified = _ctx.LongValue("DeleteDataSet.Result.gmtModified");
			result.InstanceId = _ctx.StringValue("DeleteDataSet.Result.instanceId");
			result.State = _ctx.StringValue("DeleteDataSet.Result.state");
			result.VersionId = _ctx.StringValue("DeleteDataSet.Result.versionId");
