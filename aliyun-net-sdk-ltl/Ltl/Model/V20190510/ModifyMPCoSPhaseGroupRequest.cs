...
{
    public class ModifyMPCoSPhaseGroupRequest : RpcAcsRequest<ModifyMPCoSPhaseGroupResponse>
    {
        public ModifyMPCoSPhaseGroupRequest()
            : base("ltl", "2019-05-10", "ModifyMPCoSPhaseGroup")
        {
        ...
        public override ModifyMPCoSPhaseGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMPCoSPhaseGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
