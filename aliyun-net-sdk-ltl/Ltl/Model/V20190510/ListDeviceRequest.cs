...
{
    public class ListDeviceRequest : RpcAcsRequest<ListDeviceResponse>
    {
        public ListDeviceRequest()
            : base("ltl", "2019-05-10", "ListDevice")
        {
        ...
        public override ListDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
