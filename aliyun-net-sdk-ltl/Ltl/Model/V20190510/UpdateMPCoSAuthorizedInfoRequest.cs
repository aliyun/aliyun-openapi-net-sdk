...
{
    public class UpdateMPCoSAuthorizedInfoRequest : RpcAcsRequest<UpdateMPCoSAuthorizedInfoResponse>
    {
        public UpdateMPCoSAuthorizedInfoRequest()
            : base("ltl", "2019-05-10", "UpdateMPCoSAuthorizedInfo")
        {
		...
		public List<object> AuthorizedPhaseList
		{
			get
			{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AuthorizedPhaseList", JsonConvert.SerializeObject(value));
			}
		}
        ...
        public override UpdateMPCoSAuthorizedInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateMPCoSAuthorizedInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
