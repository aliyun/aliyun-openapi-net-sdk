...
{
    public class DescribeResourceInfoRequest : RpcAcsRequest<DescribeResourceInfoResponse>
    {
        public DescribeResourceInfoRequest()
            : base("ltl", "2019-05-10", "DescribeResourceInfo")
        {
        ...
        public override DescribeResourceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeResourceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
