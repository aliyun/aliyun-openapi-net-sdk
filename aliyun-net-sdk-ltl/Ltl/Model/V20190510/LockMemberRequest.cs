...
{
    public class LockMemberRequest : RpcAcsRequest<LockMemberResponse>
    {
        public LockMemberRequest()
            : base("ltl", "2019-05-10", "LockMember")
        {
        ...
        public override LockMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LockMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
