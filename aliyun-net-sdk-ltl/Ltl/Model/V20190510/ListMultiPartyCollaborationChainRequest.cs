...
{
    public class ListMultiPartyCollaborationChainRequest : RpcAcsRequest<ListMultiPartyCollaborationChainResponse>
    {
        public ListMultiPartyCollaborationChainRequest()
            : base("ltl", "2019-05-10", "ListMultiPartyCollaborationChain")
        {
        ...
        public override ListMultiPartyCollaborationChainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMultiPartyCollaborationChainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
