...
{
    public class ListProofChainRequest : RpcAcsRequest<ListProofChainResponse>
    {
        public ListProofChainRequest()
            : base("ltl", "2019-05-10", "ListProofChain")
        {
        ...
        public override ListProofChainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProofChainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
