...
{
    public class CreateMemberRequest : RpcAcsRequest<CreateMemberResponse>
    {
        public CreateMemberRequest()
            : base("ltl", "2019-05-10", "CreateMember")
        {
		...
		public string MemberUid
		{
			...
			{
				memberUid = value;
				DictionaryUtil.Add(QueryParameters, "MemberUid", value);
			}
		}
		...
		public string MemberContact
		{
			...
			{
				memberContact = value;
				DictionaryUtil.Add(QueryParameters, "MemberContact", value);
			}
		}
		...
		public string MemberPhone
		{
			...
			{
				memberPhone = value;
				DictionaryUtil.Add(QueryParameters, "MemberPhone", value);
			}
		}
		...
		public string MemberName
		{
			...
			{
				memberName = value;
				DictionaryUtil.Add(QueryParameters, "MemberName", value);
			}
		}
        ...
        public override CreateMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
