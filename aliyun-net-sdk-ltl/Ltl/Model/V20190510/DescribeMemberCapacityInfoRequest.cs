...
{
    public class DescribeMemberCapacityInfoRequest : RpcAcsRequest<DescribeMemberCapacityInfoResponse>
    {
        public DescribeMemberCapacityInfoRequest()
            : base("ltl", "2019-05-10", "DescribeMemberCapacityInfo")
        {
        ...
        public override DescribeMemberCapacityInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMemberCapacityInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
