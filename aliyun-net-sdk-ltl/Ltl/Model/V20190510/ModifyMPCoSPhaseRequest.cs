...
{
    public class ModifyMPCoSPhaseRequest : RpcAcsRequest<ModifyMPCoSPhaseResponse>
    {
        public ModifyMPCoSPhaseRequest()
            : base("ltl", "2019-05-10", "ModifyMPCoSPhase")
        {
        ...
        public override ModifyMPCoSPhaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMPCoSPhaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
