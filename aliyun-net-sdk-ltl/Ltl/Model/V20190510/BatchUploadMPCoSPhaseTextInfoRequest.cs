...
{
    public class BatchUploadMPCoSPhaseTextInfoRequest : RpcAcsRequest<BatchUploadMPCoSPhaseTextInfoResponse>
    {
        public BatchUploadMPCoSPhaseTextInfoRequest()
            : base("ltl", "2019-05-10", "BatchUploadMPCoSPhaseTextInfo")
        {
        ...
        public override BatchUploadMPCoSPhaseTextInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchUploadMPCoSPhaseTextInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
