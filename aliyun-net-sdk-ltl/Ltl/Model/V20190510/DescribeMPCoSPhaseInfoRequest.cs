...
{
    public class DescribeMPCoSPhaseInfoRequest : RpcAcsRequest<DescribeMPCoSPhaseInfoResponse>
    {
        public DescribeMPCoSPhaseInfoRequest()
            : base("ltl", "2019-05-10", "DescribeMPCoSPhaseInfo")
        {
        ...
        public override DescribeMPCoSPhaseInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMPCoSPhaseInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
