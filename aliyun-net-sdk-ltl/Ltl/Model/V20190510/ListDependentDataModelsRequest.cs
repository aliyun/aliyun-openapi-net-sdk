...
{
    public class ListDependentDataModelsRequest : RpcAcsRequest<ListDependentDataModelsResponse>
    {
        public ListDependentDataModelsRequest()
            : base("ltl", "2019-05-10", "ListDependentDataModels")
        {
        ...
        public override ListDependentDataModelsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDependentDataModelsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
