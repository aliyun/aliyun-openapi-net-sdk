...
{
    public class UploadMPCoSPhaseTextInfoRequest : RpcAcsRequest<UploadMPCoSPhaseTextInfoResponse>
    {
        public UploadMPCoSPhaseTextInfoRequest()
            : base("ltl", "2019-05-10", "UploadMPCoSPhaseTextInfo")
        {
        ...
        public override UploadMPCoSPhaseTextInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadMPCoSPhaseTextInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
