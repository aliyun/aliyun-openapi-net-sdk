...
{
    public class CreateMPCoSPhaseRequest : RpcAcsRequest<CreateMPCoSPhaseResponse>
    {
        public CreateMPCoSPhaseRequest()
            : base("ltl", "2019-05-10", "CreateMPCoSPhase")
        {
        ...
        public override CreateMPCoSPhaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateMPCoSPhaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
