...
{
    public class UploadMPCoSPhaseDigestInfoByDeviceRequest : RpcAcsRequest<UploadMPCoSPhaseDigestInfoByDeviceResponse>
    {
        public UploadMPCoSPhaseDigestInfoByDeviceRequest()
            : base("ltl", "2019-05-10", "UploadMPCoSPhaseDigestInfoByDevice")
        {
        ...
        public override UploadMPCoSPhaseDigestInfoByDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadMPCoSPhaseDigestInfoByDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
