...
{
    public class GetDataRequest : RpcAcsRequest<GetDataResponse>
    {
        public GetDataRequest()
            : base("ltl", "2019-05-10", "GetData")
        {
        ...
        public override GetDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
