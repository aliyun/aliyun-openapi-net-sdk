...
{
	public class DescribeResourceInfoResponse : AcsResponse
	{
		...
		private DescribeResourceInfo_Data data;
		...
		public DescribeResourceInfo_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeResourceInfo_Data
		{
