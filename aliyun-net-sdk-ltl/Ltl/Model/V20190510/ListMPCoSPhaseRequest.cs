...
{
    public class ListMPCoSPhaseRequest : RpcAcsRequest<ListMPCoSPhaseResponse>
    {
        public ListMPCoSPhaseRequest()
            : base("ltl", "2019-05-10", "ListMPCoSPhase")
        {
        ...
        public override ListMPCoSPhaseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMPCoSPhaseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
