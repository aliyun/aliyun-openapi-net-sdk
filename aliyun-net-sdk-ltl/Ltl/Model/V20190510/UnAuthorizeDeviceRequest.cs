...
{
    public class UnAuthorizeDeviceRequest : RpcAcsRequest<UnAuthorizeDeviceResponse>
    {
        public UnAuthorizeDeviceRequest()
            : base("ltl", "2019-05-10", "UnAuthorizeDevice")
        {
        ...
        public override UnAuthorizeDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnAuthorizeDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
