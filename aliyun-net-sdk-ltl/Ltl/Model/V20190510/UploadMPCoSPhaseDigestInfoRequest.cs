...
{
    public class UploadMPCoSPhaseDigestInfoRequest : RpcAcsRequest<UploadMPCoSPhaseDigestInfoResponse>
    {
        public UploadMPCoSPhaseDigestInfoRequest()
            : base("ltl", "2019-05-10", "UploadMPCoSPhaseDigestInfo")
        {
        ...
        public override UploadMPCoSPhaseDigestInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadMPCoSPhaseDigestInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
