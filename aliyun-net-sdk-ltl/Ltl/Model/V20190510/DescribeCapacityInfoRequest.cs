...
{
    public class DescribeCapacityInfoRequest : RpcAcsRequest<DescribeCapacityInfoResponse>
    {
        public DescribeCapacityInfoRequest()
            : base("ltl", "2019-05-10", "DescribeCapacityInfo")
        {
        ...
        public override DescribeCapacityInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCapacityInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
