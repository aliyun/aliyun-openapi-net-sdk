...
{
    public class AuthorizeDeviceGroupRequest : RpcAcsRequest<AuthorizeDeviceGroupResponse>
    {
        public AuthorizeDeviceGroupRequest()
            : base("ltl", "2019-05-10", "AuthorizeDeviceGroup")
        {
        ...
        public override AuthorizeDeviceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AuthorizeDeviceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
