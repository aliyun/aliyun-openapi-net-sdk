...
{
    public class GetHistoryDataCountRequest : RpcAcsRequest<GetHistoryDataCountResponse>
    {
        public GetHistoryDataCountRequest()
            : base("ltl", "2019-05-10", "GetHistoryDataCount")
        {
        ...
        public override GetHistoryDataCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetHistoryDataCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
