...
{
    public class BatchUploadMPCoSPhaseDigestInfoRequest : RpcAcsRequest<BatchUploadMPCoSPhaseDigestInfoResponse>
    {
        public BatchUploadMPCoSPhaseDigestInfoRequest()
            : base("ltl", "2019-05-10", "BatchUploadMPCoSPhaseDigestInfo")
        {
        ...
        public override BatchUploadMPCoSPhaseDigestInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchUploadMPCoSPhaseDigestInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
