...
{
    public class GetDataModelConfigInfoRequest : RpcAcsRequest<GetDataModelConfigInfoResponse>
    {
        public GetDataModelConfigInfoRequest()
            : base("ltl", "2019-05-10", "GetDataModelConfigInfo")
        {
		...
		[JsonProperty(PropertyName = "DataModelCode")]
        ...
        public override GetDataModelConfigInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDataModelConfigInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
