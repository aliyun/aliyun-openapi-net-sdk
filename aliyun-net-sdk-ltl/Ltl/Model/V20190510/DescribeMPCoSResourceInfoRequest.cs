...
{
    public class DescribeMPCoSResourceInfoRequest : RpcAcsRequest<DescribeMPCoSResourceInfoResponse>
    {
        public DescribeMPCoSResourceInfoRequest()
            : base("ltl", "2019-05-10", "DescribeMPCoSResourceInfo")
        {
        ...
        public override DescribeMPCoSResourceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMPCoSResourceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
