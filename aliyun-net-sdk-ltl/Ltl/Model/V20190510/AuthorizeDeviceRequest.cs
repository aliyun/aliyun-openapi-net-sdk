...
{
    public class AuthorizeDeviceRequest : RpcAcsRequest<AuthorizeDeviceResponse>
    {
        public AuthorizeDeviceRequest()
            : base("ltl", "2019-05-10", "AuthorizeDevice")
        {
        ...
        public override AuthorizeDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AuthorizeDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
