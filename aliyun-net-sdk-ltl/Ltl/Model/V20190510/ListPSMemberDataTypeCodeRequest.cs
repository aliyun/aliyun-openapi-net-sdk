...
{
    public class ListPSMemberDataTypeCodeRequest : RpcAcsRequest<ListPSMemberDataTypeCodeResponse>
    {
        public ListPSMemberDataTypeCodeRequest()
            : base("ltl", "2019-05-10", "ListPSMemberDataTypeCode")
        {
        ...
        public override ListPSMemberDataTypeCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPSMemberDataTypeCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
