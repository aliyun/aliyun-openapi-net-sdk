...
{
    public class DescribeMPCoSAuthorizedInfoRequest : RpcAcsRequest<DescribeMPCoSAuthorizedInfoResponse>
    {
        public DescribeMPCoSAuthorizedInfoRequest()
            : base("ltl", "2019-05-10", "DescribeMPCoSAuthorizedInfo")
        {
        ...
        public override DescribeMPCoSAuthorizedInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMPCoSAuthorizedInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
