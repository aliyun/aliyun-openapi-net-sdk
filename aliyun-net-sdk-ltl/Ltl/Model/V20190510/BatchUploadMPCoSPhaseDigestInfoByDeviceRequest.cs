...
{
    public class BatchUploadMPCoSPhaseDigestInfoByDeviceRequest : RpcAcsRequest<BatchUploadMPCoSPhaseDigestInfoByDeviceResponse>
    {
        public BatchUploadMPCoSPhaseDigestInfoByDeviceRequest()
            : base("ltl", "2019-05-10", "BatchUploadMPCoSPhaseDigestInfoByDevice")
        {
        ...
        public override BatchUploadMPCoSPhaseDigestInfoByDeviceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchUploadMPCoSPhaseDigestInfoByDeviceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
