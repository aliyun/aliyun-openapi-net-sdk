...
{
    public class UnAuthorizeDeviceGroupRequest : RpcAcsRequest<UnAuthorizeDeviceGroupResponse>
    {
        public UnAuthorizeDeviceGroupRequest()
            : base("ltl", "2019-05-10", "UnAuthorizeDeviceGroup")
        {
        ...
        public override UnAuthorizeDeviceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnAuthorizeDeviceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
