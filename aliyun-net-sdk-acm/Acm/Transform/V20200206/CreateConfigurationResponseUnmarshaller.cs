...
namespace Aliyun.Acs.acm.Transform.V20200206
{
    public class CreateConfigurationResponseUnmarshaller
    {
        public static CreateConfigurationResponse Unmarshall(UnmarshallerContext context)
        {
			...
			createConfigurationResponse.Code = context.StringValue("CreateConfiguration.Code");
			createConfigurationResponse.Message = context.StringValue("CreateConfiguration.Message");
