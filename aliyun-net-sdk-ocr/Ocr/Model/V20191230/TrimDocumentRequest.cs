...
{
    public class TrimDocumentRequest : RpcAcsRequest<TrimDocumentResponse>
    {
        public TrimDocumentRequest()
            : base("ocr", "2019-12-30", "TrimDocument", "ocr", "openAPI")
        {
		...
		public string OutputType
		{
			...
			{
				outputType = value;
				DictionaryUtil.Add(BodyParameters, "OutputType", value);
			}
		}
        ...
        public override TrimDocumentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TrimDocumentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
