...
{
    public class RecognizeVerificationcodeRequest : RpcAcsRequest<RecognizeVerificationcodeResponse>
    {
        public RecognizeVerificationcodeRequest()
            : base("ocr", "2019-12-30", "RecognizeVerificationcode", "ocr", "openAPI")
        {
        ...
        public override RecognizeVerificationcodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeVerificationcodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
