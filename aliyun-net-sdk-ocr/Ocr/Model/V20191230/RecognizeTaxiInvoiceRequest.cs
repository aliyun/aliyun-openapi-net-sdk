...
{
    public class RecognizeTaxiInvoiceRequest : RpcAcsRequest<RecognizeTaxiInvoiceResponse>
    {
        public RecognizeTaxiInvoiceRequest()
            : base("ocr", "2019-12-30", "RecognizeTaxiInvoice", "ocr", "openAPI")
        {
        ...
        public override RecognizeTaxiInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeTaxiInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
