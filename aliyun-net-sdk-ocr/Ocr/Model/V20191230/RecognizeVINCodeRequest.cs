...
{
    public class RecognizeVINCodeRequest : RpcAcsRequest<RecognizeVINCodeResponse>
    {
        public RecognizeVINCodeRequest()
            : base("ocr", "2019-12-30", "RecognizeVINCode", "ocr", "openAPI")
        {
        ...
        public override RecognizeVINCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeVINCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
