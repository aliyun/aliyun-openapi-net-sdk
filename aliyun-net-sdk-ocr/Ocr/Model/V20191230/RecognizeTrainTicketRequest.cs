...
{
    public class RecognizeTrainTicketRequest : RpcAcsRequest<RecognizeTrainTicketResponse>
    {
        public RecognizeTrainTicketRequest()
            : base("ocr", "2019-12-30", "RecognizeTrainTicket", "ocr", "openAPI")
        {
        ...
        public override RecognizeTrainTicketResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeTrainTicketResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
