...
{
    public class RecognizeTakeoutOrderRequest : RpcAcsRequest<RecognizeTakeoutOrderResponse>
    {
        public RecognizeTakeoutOrderRequest()
            : base("ocr", "2019-12-30", "RecognizeTakeoutOrder", "ocr", "openAPI")
        {
        ...
        public override RecognizeTakeoutOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeTakeoutOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
