...
{
    public class RecognizeDriverLicenseRequest : RpcAcsRequest<RecognizeDriverLicenseResponse>
    {
        public RecognizeDriverLicenseRequest()
            : base("ocr", "2019-12-30", "RecognizeDriverLicense", "ocr", "openAPI")
        {
        ...
        public override RecognizeDriverLicenseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeDriverLicenseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
