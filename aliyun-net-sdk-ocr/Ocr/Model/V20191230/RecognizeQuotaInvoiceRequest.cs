...
{
    public class RecognizeQuotaInvoiceRequest : RpcAcsRequest<RecognizeQuotaInvoiceResponse>
    {
        public RecognizeQuotaInvoiceRequest()
            : base("ocr", "2019-12-30", "RecognizeQuotaInvoice", "ocr", "openAPI")
        {
        ...
        public override RecognizeQuotaInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeQuotaInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
