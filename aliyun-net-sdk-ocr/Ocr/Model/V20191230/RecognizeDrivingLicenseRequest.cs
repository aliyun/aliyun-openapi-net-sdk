...
{
    public class RecognizeDrivingLicenseRequest : RpcAcsRequest<RecognizeDrivingLicenseResponse>
    {
        public RecognizeDrivingLicenseRequest()
            : base("ocr", "2019-12-30", "RecognizeDrivingLicense", "ocr", "openAPI")
        {
        ...
        public override RecognizeDrivingLicenseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeDrivingLicenseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
