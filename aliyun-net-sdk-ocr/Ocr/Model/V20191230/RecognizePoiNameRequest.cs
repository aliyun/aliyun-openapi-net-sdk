...
{
    public class RecognizePoiNameRequest : RpcAcsRequest<RecognizePoiNameResponse>
    {
        public RecognizePoiNameRequest()
            : base("ocr", "2019-12-30", "RecognizePoiName", "ocr", "openAPI")
        {
        ...
        public override RecognizePoiNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizePoiNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
