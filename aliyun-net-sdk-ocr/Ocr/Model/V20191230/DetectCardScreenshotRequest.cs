...
{
    public class DetectCardScreenshotRequest : RpcAcsRequest<DetectCardScreenshotResponse>
    {
        public DetectCardScreenshotRequest()
            : base("ocr", "2019-12-30", "DetectCardScreenshot", "ocr", "openAPI")
        {
        ...
        public override DetectCardScreenshotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectCardScreenshotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
