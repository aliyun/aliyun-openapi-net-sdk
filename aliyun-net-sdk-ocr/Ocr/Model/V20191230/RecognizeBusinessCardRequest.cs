...
{
    public class RecognizeBusinessCardRequest : RpcAcsRequest<RecognizeBusinessCardResponse>
    {
        public RecognizeBusinessCardRequest()
            : base("ocr", "2019-12-30", "RecognizeBusinessCard", "ocr", "openAPI")
        {
        ...
        public override RecognizeBusinessCardResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeBusinessCardResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
