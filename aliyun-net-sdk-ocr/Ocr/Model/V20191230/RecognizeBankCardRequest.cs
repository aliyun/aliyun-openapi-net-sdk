...
{
    public class RecognizeBankCardRequest : RpcAcsRequest<RecognizeBankCardResponse>
    {
        public RecognizeBankCardRequest()
            : base("ocr", "2019-12-30", "RecognizeBankCard", "ocr", "openAPI")
        {
        ...
        public override RecognizeBankCardResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeBankCardResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
