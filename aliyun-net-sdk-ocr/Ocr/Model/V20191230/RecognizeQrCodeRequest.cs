...
{
    public class RecognizeQrCodeRequest : RpcAcsRequest<RecognizeQrCodeResponse>
    {
        public RecognizeQrCodeRequest()
            : base("ocr", "2019-12-30", "RecognizeQrCode", "ocr", "openAPI")
        {
        ...
        public override RecognizeQrCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeQrCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
