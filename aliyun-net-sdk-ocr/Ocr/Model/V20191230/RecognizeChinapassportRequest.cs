...
{
    public class RecognizeChinapassportRequest : RpcAcsRequest<RecognizeChinapassportResponse>
    {
        public RecognizeChinapassportRequest()
            : base("ocr", "2019-12-30", "RecognizeChinapassport", "ocr", "openAPI")
        {
        ...
        public override RecognizeChinapassportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeChinapassportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
