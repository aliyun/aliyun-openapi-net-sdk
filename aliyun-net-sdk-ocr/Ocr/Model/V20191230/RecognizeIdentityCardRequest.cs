...
{
    public class RecognizeIdentityCardRequest : RpcAcsRequest<RecognizeIdentityCardResponse>
    {
        public RecognizeIdentityCardRequest()
            : base("ocr", "2019-12-30", "RecognizeIdentityCard", "ocr", "openAPI")
        {
        ...
        public override RecognizeIdentityCardResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeIdentityCardResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
