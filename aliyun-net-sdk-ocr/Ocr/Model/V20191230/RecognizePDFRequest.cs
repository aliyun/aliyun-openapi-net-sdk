...
{
    public class RecognizePDFRequest : RpcAcsRequest<RecognizePDFResponse>
    {
        public RecognizePDFRequest()
            : base("ocr", "2019-12-30", "RecognizePDF", "ocr", "openAPI")
        {
        ...
        public override RecognizePDFResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizePDFResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
