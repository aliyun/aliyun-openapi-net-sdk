...
{
    public class RecognizeLicensePlateRequest : RpcAcsRequest<RecognizeLicensePlateResponse>
    {
        public RecognizeLicensePlateRequest()
            : base("ocr", "2019-12-30", "RecognizeLicensePlate", "ocr", "openAPI")
        {
        ...
        public override RecognizeLicensePlateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeLicensePlateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
