...
{
    public class RecognizeVATInvoiceRequest : RpcAcsRequest<RecognizeVATInvoiceResponse>
    {
        public RecognizeVATInvoiceRequest()
            : base("ocr", "2019-12-30", "RecognizeVATInvoice", "ocr", "openAPI")
        {
        ...
        public override RecognizeVATInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeVATInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
