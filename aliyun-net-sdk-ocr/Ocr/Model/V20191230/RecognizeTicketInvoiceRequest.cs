...
{
    public class RecognizeTicketInvoiceRequest : RpcAcsRequest<RecognizeTicketInvoiceResponse>
    {
        public RecognizeTicketInvoiceRequest()
            : base("ocr", "2019-12-30", "RecognizeTicketInvoice", "ocr", "openAPI")
        {
        ...
        public override RecognizeTicketInvoiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeTicketInvoiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
