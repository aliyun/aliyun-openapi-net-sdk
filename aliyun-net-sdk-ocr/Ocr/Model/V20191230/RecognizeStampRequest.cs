...
{
    public class RecognizeStampRequest : RpcAcsRequest<RecognizeStampResponse>
    {
        public RecognizeStampRequest()
            : base("ocr", "2019-12-30", "RecognizeStamp", "ocr", "openAPI")
        {
        ...
        public override RecognizeStampResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeStampResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
