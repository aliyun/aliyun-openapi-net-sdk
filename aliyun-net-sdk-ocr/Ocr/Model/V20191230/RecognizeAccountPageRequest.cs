...
{
    public class RecognizeAccountPageRequest : RpcAcsRequest<RecognizeAccountPageResponse>
    {
        public RecognizeAccountPageRequest()
            : base("ocr", "2019-12-30", "RecognizeAccountPage", "ocr", "openAPI")
        {
        ...
        public override RecognizeAccountPageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizeAccountPageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
