...
{
    public class RecognizePassportMRZRequest : RpcAcsRequest<RecognizePassportMRZResponse>
    {
        public RecognizePassportMRZRequest()
            : base("ocr", "2019-12-30", "RecognizePassportMRZ", "ocr", "openAPI")
        {
        ...
        public override RecognizePassportMRZResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RecognizePassportMRZResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
