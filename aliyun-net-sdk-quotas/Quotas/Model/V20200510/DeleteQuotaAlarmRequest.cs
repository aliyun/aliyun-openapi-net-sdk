...
{
    public class DeleteQuotaAlarmRequest : RpcAcsRequest<DeleteQuotaAlarmResponse>
    {
        public DeleteQuotaAlarmRequest()
            : base("quotas", "2020-05-10", "DeleteQuotaAlarm", "quotas", "openAPI")
        {
        ...
        public override DeleteQuotaAlarmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteQuotaAlarmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
