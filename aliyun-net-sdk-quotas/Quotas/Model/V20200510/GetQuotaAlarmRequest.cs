...
{
    public class GetQuotaAlarmRequest : RpcAcsRequest<GetQuotaAlarmResponse>
    {
        public GetQuotaAlarmRequest()
            : base("quotas", "2020-05-10", "GetQuotaAlarm", "quotas", "openAPI")
        {
        ...
        public override GetQuotaAlarmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQuotaAlarmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
