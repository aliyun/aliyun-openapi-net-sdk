...
{
    public class ListAlarmHistoriesRequest : RpcAcsRequest<ListAlarmHistoriesResponse>
    {
        public ListAlarmHistoriesRequest()
            : base("quotas", "2020-05-10", "ListAlarmHistories", "quotas", "openAPI")
        {
        ...
        public override ListAlarmHistoriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAlarmHistoriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
