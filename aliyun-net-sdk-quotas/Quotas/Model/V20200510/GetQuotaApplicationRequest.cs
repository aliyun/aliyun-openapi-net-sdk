...
{
    public class GetQuotaApplicationRequest : RpcAcsRequest<GetQuotaApplicationResponse>
    {
        public GetQuotaApplicationRequest()
            : base("quotas", "2020-05-10", "GetQuotaApplication", "quotas", "openAPI")
        {
        ...
        public override GetQuotaApplicationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQuotaApplicationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
