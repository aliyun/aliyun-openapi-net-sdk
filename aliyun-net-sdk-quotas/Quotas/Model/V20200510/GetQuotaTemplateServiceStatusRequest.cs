...
{
    public class GetQuotaTemplateServiceStatusRequest : RpcAcsRequest<GetQuotaTemplateServiceStatusResponse>
    {
        public GetQuotaTemplateServiceStatusRequest()
            : base("quotas", "2020-05-10", "GetQuotaTemplateServiceStatus", "quotas", "openAPI")
        {
		...
		public string ResourceDirectoryId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "ResourceDirectoryId", value);
			}
		}
        ...
        public override GetQuotaTemplateServiceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetQuotaTemplateServiceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
