...
namespace Aliyun.Acs.Ess.Model.V20140828
{
    public class DescribeNotificationConfigurationsRequest : RpcAcsRequest<DescribeNotificationConfigurationsResponse>
    {
        public DescribeNotificationConfigurationsRequest()
            : base("Ess", "2014-08-28", "DescribeNotificationConfigurations")
        {
        }
        ...
        public override DescribeNotificationConfigurationsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
