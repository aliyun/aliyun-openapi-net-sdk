...
namespace Aliyun.Acs.Ess.Model.V20140828
{
    public class CreateNotificationConfigurationRequest : RpcAcsRequest<CreateNotificationConfigurationResponse>
    {
        public CreateNotificationConfigurationRequest()
            : base("Ess", "2014-08-28", "CreateNotificationConfiguration")
        {
        }
        ...
        public override CreateNotificationConfigurationResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
