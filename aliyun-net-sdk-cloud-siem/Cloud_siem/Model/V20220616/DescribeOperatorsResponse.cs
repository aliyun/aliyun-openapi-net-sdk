...
{
	public class DescribeOperatorsResponse : AcsResponse
	{
		...
		private List<DescribeOperators_DataItem> data;
		...
		public List<DescribeOperators_DataItem> Data
		{
			get
			{
				return data;
		...
		public class DescribeOperators_DataItem
		{
