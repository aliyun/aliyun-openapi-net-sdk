...
{
	public class DescribeAlertsWithEntityResponse : AcsResponse
	{
		...
		private DescribeAlertsWithEntity_Data data;
		...
		public DescribeAlertsWithEntity_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeAlertsWithEntity_Data
		{

			private List<DescribeAlertsWithEntity_ResponseDataItem> responseData;

			private DescribeAlertsWithEntity_PageInfo pageInfo;

			public List<DescribeAlertsWithEntity_ResponseDataItem> ResponseData
			{
				get
				{
					return responseData;
			...
			public DescribeAlertsWithEntity_PageInfo PageInfo
			{
				get
				{
					return pageInfo;
			...
			public class DescribeAlertsWithEntity_ResponseDataItem
			{
				...
				public List<DescribeAlertsWithEntity_AlertInfoListItem> AlertInfoList
				{
					get
					{
				...
				public class DescribeAlertsWithEntity_AlertInfoListItem
				{
			...
			public class DescribeAlertsWithEntity_PageInfo
			{
