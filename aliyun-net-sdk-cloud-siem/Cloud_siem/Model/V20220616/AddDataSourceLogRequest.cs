...
{
    public class AddDataSourceLogRequest : RpcAcsRequest<AddDataSourceLogResponse>
    {
        public AddDataSourceLogRequest()
            : base("cloud-siem", "2022-06-16", "AddDataSourceLog", "cloud-siem", "openAPI")
        {
        ...
        public override AddDataSourceLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddDataSourceLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
