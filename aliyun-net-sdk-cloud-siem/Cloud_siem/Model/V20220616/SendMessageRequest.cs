...
namespace Aliyun.Acs.cloud_siem.Model.V20220616
{
    public class SendMessageRequest : RpcAcsRequest<SendMessageResponse>
    {
        public SendMessageRequest()
            : base("cloud-siem", "2022-06-16", "SendMessage", "cloud-siem", "openAPI")
        {
		...
		public int? ChannelType
		{
			...
			{
				channelType = value;
				DictionaryUtil.Add(BodyParameters, "ChannelType", value.ToString());
			}
		}
		...
		public long? ReceiveUid
		{
			...
			{
				receiveUid = value;
				DictionaryUtil.Add(BodyParameters, "ReceiveUid", value.ToString());
			}
		}
