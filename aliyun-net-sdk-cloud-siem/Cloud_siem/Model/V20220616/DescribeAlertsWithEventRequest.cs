...
{
    public class DescribeAlertsWithEventRequest : RpcAcsRequest<DescribeAlertsWithEventResponse>
    {
        public DescribeAlertsWithEventRequest()
            : base("cloud-siem", "2022-06-16", "DescribeAlertsWithEvent", "cloud-siem", "openAPI")
        {
        ...
        public override DescribeAlertsWithEventResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAlertsWithEventResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
