...
{
    public class OpenDeliveryRequest : RpcAcsRequest<OpenDeliveryResponse>
    {
        public OpenDeliveryRequest()
            : base("cloud-siem", "2022-06-16", "OpenDelivery", "cloud-siem", "openAPI")
        {
        ...
        public override OpenDeliveryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenDeliveryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
