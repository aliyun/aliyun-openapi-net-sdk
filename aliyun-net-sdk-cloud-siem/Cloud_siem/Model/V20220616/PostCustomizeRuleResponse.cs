...
{
	public class PostCustomizeRuleResponse : AcsResponse
	{
		...
		private PostCustomizeRule_Data data;
		...
		public PostCustomizeRule_Data Data
		{
			get
			{
				return data;
		...
		public class PostCustomizeRule_Data
		{
