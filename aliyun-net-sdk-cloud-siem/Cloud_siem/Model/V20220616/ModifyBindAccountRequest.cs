...
{
    public class ModifyBindAccountRequest : RpcAcsRequest<ModifyBindAccountResponse>
    {
        public ModifyBindAccountRequest()
            : base("cloud-siem", "2022-06-16", "ModifyBindAccount", "cloud-siem", "openAPI")
        {
        ...
        public override ModifyBindAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyBindAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
