...
{
    public class DescribeEventDisposeRequest : RpcAcsRequest<DescribeEventDisposeResponse>
    {
        public DescribeEventDisposeRequest()
            : base("cloud-siem", "2022-06-16", "DescribeEventDispose", "cloud-siem", "openAPI")
        {
        ...
        public override DescribeEventDisposeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeEventDisposeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
