...
{
    public class DescribeAlertSourceRequest : RpcAcsRequest<DescribeAlertSourceResponse>
    {
        public DescribeAlertSourceRequest()
            : base("cloud-siem", "2022-06-16", "DescribeAlertSource", "cloud-siem", "openAPI")
        {
        ...
        public override DescribeAlertSourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAlertSourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
