...
{
    public class DescribeAttackTimeLineRequest : RpcAcsRequest<DescribeAttackTimeLineResponse>
    {
        public DescribeAttackTimeLineRequest()
            : base("cloud-siem", "2022-06-16", "DescribeAttackTimeLine", "cloud-siem", "openAPI")
        {
        ...
        public override DescribeAttackTimeLineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAttackTimeLineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
