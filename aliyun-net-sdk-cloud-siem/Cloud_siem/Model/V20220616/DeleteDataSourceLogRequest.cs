...
{
    public class DeleteDataSourceLogRequest : RpcAcsRequest<DeleteDataSourceLogResponse>
    {
        public DeleteDataSourceLogRequest()
            : base("cloud-siem", "2022-06-16", "DeleteDataSourceLog", "cloud-siem", "openAPI")
        {
        ...
        public override DeleteDataSourceLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDataSourceLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
