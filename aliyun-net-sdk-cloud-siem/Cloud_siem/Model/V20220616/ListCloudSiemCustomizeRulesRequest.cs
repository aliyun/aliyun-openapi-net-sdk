...
{
    public class ListCloudSiemCustomizeRulesRequest : RpcAcsRequest<ListCloudSiemCustomizeRulesResponse>
    {
        public ListCloudSiemCustomizeRulesRequest()
            : base("cloud-siem", "2022-06-16", "ListCloudSiemCustomizeRules", "cloud-siem", "openAPI")
        {
        ...
        public override ListCloudSiemCustomizeRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCloudSiemCustomizeRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
