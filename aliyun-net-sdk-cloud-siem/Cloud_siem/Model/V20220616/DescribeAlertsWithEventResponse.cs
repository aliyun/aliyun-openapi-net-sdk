...
{
	public class DescribeAlertsWithEventResponse : AcsResponse
	{
		...
		private DescribeAlertsWithEvent_Data data;
		...
		public DescribeAlertsWithEvent_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeAlertsWithEvent_Data
		{

			private List<DescribeAlertsWithEvent_ResponseDataItem> responseData;

			private DescribeAlertsWithEvent_PageInfo pageInfo;

			public List<DescribeAlertsWithEvent_ResponseDataItem> ResponseData
			{
				get
				{
					return responseData;
			...
			public DescribeAlertsWithEvent_PageInfo PageInfo
			{
				get
				{
					return pageInfo;
			...
			public class DescribeAlertsWithEvent_ResponseDataItem
			{
				...
				public List<DescribeAlertsWithEvent_AlertInfoListItem> AlertInfoList
				{
					get
					{
				...
				public class DescribeAlertsWithEvent_AlertInfoListItem
				{
			...
			public class DescribeAlertsWithEvent_PageInfo
			{
