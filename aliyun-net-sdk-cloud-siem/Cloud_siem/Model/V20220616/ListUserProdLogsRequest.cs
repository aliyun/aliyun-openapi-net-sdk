...
{
    public class ListUserProdLogsRequest : RpcAcsRequest<ListUserProdLogsResponse>
    {
        public ListUserProdLogsRequest()
            : base("cloud-siem", "2022-06-16", "ListUserProdLogs", "cloud-siem", "openAPI")
        {
        ...
        public override ListUserProdLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserProdLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
