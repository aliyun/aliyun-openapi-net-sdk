...
namespace Aliyun.Acs.cloud_siem.Transform.V20220616
{
    public class ModifyDataSourceResponseUnmarshaller
    {
        public static ModifyDataSourceResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			ModifyDataSourceResponse.ModifyDataSource_Data data = new ModifyDataSourceResponse.ModifyDataSource_Data();
			data.Count = _ctx.IntegerValue("ModifyDataSource.Data.Count");
			data.DataSourceInstanceId = _ctx.StringValue("ModifyDataSource.Data.DataSourceInstanceId");
			modifyDataSourceResponse.Data = data;
