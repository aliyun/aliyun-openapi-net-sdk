...
{
    public class UpdateVpcEndpointConnectionAttributeRequest : RpcAcsRequest<UpdateVpcEndpointConnectionAttributeResponse>
    {
        public UpdateVpcEndpointConnectionAttributeRequest()
            : base("Privatelink", "2020-04-15", "UpdateVpcEndpointConnectionAttribute", "privatelink", "openAPI")
        {
        ...
        public override UpdateVpcEndpointConnectionAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateVpcEndpointConnectionAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
