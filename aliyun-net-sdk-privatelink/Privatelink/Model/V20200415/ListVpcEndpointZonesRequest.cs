...
{
    public class ListVpcEndpointZonesRequest : RpcAcsRequest<ListVpcEndpointZonesResponse>
    {
        public ListVpcEndpointZonesRequest()
            : base("Privatelink", "2020-04-15", "ListVpcEndpointZones", "privatelink", "openAPI")
        {
        ...
        public override ListVpcEndpointZonesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVpcEndpointZonesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
