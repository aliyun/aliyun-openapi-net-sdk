...
{
    public class UpdateVpcEndpointAttributeRequest : RpcAcsRequest<UpdateVpcEndpointAttributeResponse>
    {
        public UpdateVpcEndpointAttributeRequest()
            : base("Privatelink", "2020-04-15", "UpdateVpcEndpointAttribute", "privatelink", "openAPI")
        {
        ...
        public override UpdateVpcEndpointAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateVpcEndpointAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
