...
{
    public class DeleteVpcEndpointServiceRequest : RpcAcsRequest<DeleteVpcEndpointServiceResponse>
    {
        public DeleteVpcEndpointServiceRequest()
            : base("Privatelink", "2020-04-15", "DeleteVpcEndpointService", "privatelink", "openAPI")
        {
        ...
        public override DeleteVpcEndpointServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteVpcEndpointServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
