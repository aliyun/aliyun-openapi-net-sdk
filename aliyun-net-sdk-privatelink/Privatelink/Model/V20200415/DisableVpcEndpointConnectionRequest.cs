...
{
    public class DisableVpcEndpointConnectionRequest : RpcAcsRequest<DisableVpcEndpointConnectionResponse>
    {
        public DisableVpcEndpointConnectionRequest()
            : base("Privatelink", "2020-04-15", "DisableVpcEndpointConnection", "privatelink", "openAPI")
        {
        ...
        public override DisableVpcEndpointConnectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableVpcEndpointConnectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
