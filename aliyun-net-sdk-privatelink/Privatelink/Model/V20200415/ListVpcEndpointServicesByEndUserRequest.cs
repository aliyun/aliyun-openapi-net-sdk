...
{
    public class ListVpcEndpointServicesByEndUserRequest : RpcAcsRequest<ListVpcEndpointServicesByEndUserResponse>
    {
        public ListVpcEndpointServicesByEndUserRequest()
            : base("Privatelink", "2020-04-15", "ListVpcEndpointServicesByEndUser", "privatelink", "openAPI")
        {
        ...
        public override ListVpcEndpointServicesByEndUserResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVpcEndpointServicesByEndUserResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
