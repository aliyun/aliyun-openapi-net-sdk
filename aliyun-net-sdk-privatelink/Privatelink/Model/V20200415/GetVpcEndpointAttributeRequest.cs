...
{
    public class GetVpcEndpointAttributeRequest : RpcAcsRequest<GetVpcEndpointAttributeResponse>
    {
        public GetVpcEndpointAttributeRequest()
            : base("Privatelink", "2020-04-15", "GetVpcEndpointAttribute", "privatelink", "openAPI")
        {
        ...
        public override GetVpcEndpointAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVpcEndpointAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
