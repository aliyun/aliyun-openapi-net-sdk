...
{
    public class RemoveZoneFromVpcEndpointRequest : RpcAcsRequest<RemoveZoneFromVpcEndpointResponse>
    {
        public RemoveZoneFromVpcEndpointRequest()
            : base("Privatelink", "2020-04-15", "RemoveZoneFromVpcEndpoint", "privatelink", "openAPI")
        {
        ...
        public override RemoveZoneFromVpcEndpointResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveZoneFromVpcEndpointResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
