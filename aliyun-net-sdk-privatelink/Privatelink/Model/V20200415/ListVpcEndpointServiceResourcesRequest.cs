...
{
    public class ListVpcEndpointServiceResourcesRequest : RpcAcsRequest<ListVpcEndpointServiceResourcesResponse>
    {
        public ListVpcEndpointServiceResourcesRequest()
            : base("Privatelink", "2020-04-15", "ListVpcEndpointServiceResources", "privatelink", "openAPI")
        {
        ...
        public override ListVpcEndpointServiceResourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListVpcEndpointServiceResourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
