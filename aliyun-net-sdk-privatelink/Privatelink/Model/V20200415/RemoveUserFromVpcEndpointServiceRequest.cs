...
{
    public class RemoveUserFromVpcEndpointServiceRequest : RpcAcsRequest<RemoveUserFromVpcEndpointServiceResponse>
    {
        public RemoveUserFromVpcEndpointServiceRequest()
            : base("Privatelink", "2020-04-15", "RemoveUserFromVpcEndpointService", "privatelink", "openAPI")
        {
        ...
        public override RemoveUserFromVpcEndpointServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveUserFromVpcEndpointServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
