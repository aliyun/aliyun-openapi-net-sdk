...
{
    public class DetachResourceFromVpcEndpointServiceRequest : RpcAcsRequest<DetachResourceFromVpcEndpointServiceResponse>
    {
        public DetachResourceFromVpcEndpointServiceRequest()
            : base("Privatelink", "2020-04-15", "DetachResourceFromVpcEndpointService", "privatelink", "openAPI")
        {
        ...
        public override DetachResourceFromVpcEndpointServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetachResourceFromVpcEndpointServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
