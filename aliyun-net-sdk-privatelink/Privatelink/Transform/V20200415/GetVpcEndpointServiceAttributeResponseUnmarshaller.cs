...
namespace Aliyun.Acs.Privatelink.Transform.V20200415
{
    public class GetVpcEndpointServiceAttributeResponseUnmarshaller
    {
        public static GetVpcEndpointServiceAttributeResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			getVpcEndpointServiceAttributeResponse.ServiceType = _ctx.StringValue("GetVpcEndpointServiceAttribute.ServiceType");
			getVpcEndpointServiceAttributeResponse.ServiceResourceType = _ctx.StringValue("GetVpcEndpointServiceAttribute.ServiceResourceType");
			getVpcEndpointServiceAttributeResponse.PrivateServiceDomainEnabled = _ctx.BooleanValue("GetVpcEndpointServiceAttribute.PrivateServiceDomainEnabled");
			getVpcEndpointServiceAttributeResponse.PrivateServiceDomain = _ctx.StringValue("GetVpcEndpointServiceAttribute.PrivateServiceDomain");
			getVpcEndpointServiceAttributeResponse.PrivateServiceDomainVerifyStatus = _ctx.StringValue("GetVpcEndpointServiceAttribute.PrivateServiceDomainVerifyStatus");
			getVpcEndpointServiceAttributeResponse.PrivateServiceDomainBusinessStatus = _ctx.StringValue("GetVpcEndpointServiceAttribute.PrivateServiceDomainBusinessStatus");
			getVpcEndpointServiceAttributeResponse.PrivateServiceDomainVerifyName = _ctx.StringValue("GetVpcEndpointServiceAttribute.PrivateServiceDomainVerifyName");
			getVpcEndpointServiceAttributeResponse.PrivateServiceDomainVerifyValue = _ctx.StringValue("GetVpcEndpointServiceAttribute.PrivateServiceDomainVerifyValue");
			getVpcEndpointServiceAttributeResponse.PrivateServiceName = _ctx.StringValue("GetVpcEndpointServiceAttribute.PrivateServiceName");
