...
{
    public class GetPointSampleValueRequest : RpcAcsRequest<GetPointSampleValueResponse>
    {
        public GetPointSampleValueRequest()
            : base("industry-brain", "2019-06-30", "GetPointSampleValue")
        {
        ...
        public override GetPointSampleValueResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPointSampleValueResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
