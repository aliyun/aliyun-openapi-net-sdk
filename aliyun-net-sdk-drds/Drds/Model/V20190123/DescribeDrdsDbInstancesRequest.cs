...
{
    public class DescribeDrdsDbInstancesRequest : RpcAcsRequest<DescribeDrdsDbInstancesResponse>
    {
        public DescribeDrdsDbInstancesRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsDbInstances", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsDbInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsDbInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
