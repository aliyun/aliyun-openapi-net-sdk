...
{
    public class ReleaseInstanceInternetAddressRequest : RpcAcsRequest<ReleaseInstanceInternetAddressResponse>
    {
        public ReleaseInstanceInternetAddressRequest()
            : base("Drds", "2019-01-23", "ReleaseInstanceInternetAddress", "drds", "openAPI")
        {
        ...
        public override ReleaseInstanceInternetAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseInstanceInternetAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
