...
{
    public class DescribeHotDbListRequest : RpcAcsRequest<DescribeHotDbListResponse>
    {
        public DescribeHotDbListRequest()
            : base("Drds", "2019-01-23", "DescribeHotDbList", "drds", "openAPI")
        {
        ...
        public override DescribeHotDbListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeHotDbListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
