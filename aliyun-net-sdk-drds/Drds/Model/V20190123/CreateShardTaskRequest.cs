...
{
    public class CreateShardTaskRequest : RpcAcsRequest<CreateShardTaskResponse>
    {
        public CreateShardTaskRequest()
            : base("Drds", "2019-01-23", "CreateShardTask", "drds", "openAPI")
        {
        ...
        public override CreateShardTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateShardTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
