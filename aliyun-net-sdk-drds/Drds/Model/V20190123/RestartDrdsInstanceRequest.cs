...
{
    public class RestartDrdsInstanceRequest : RpcAcsRequest<RestartDrdsInstanceResponse>
    {
        public RestartDrdsInstanceRequest()
            : base("Drds", "2019-01-23", "RestartDrdsInstance", "drds", "openAPI")
        {
        ...
        public override RestartDrdsInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestartDrdsInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
