...
{
    public class UpgradeHiStoreInstanceRequest : RpcAcsRequest<UpgradeHiStoreInstanceResponse>
    {
        public UpgradeHiStoreInstanceRequest()
            : base("Drds", "2019-01-23", "UpgradeHiStoreInstance", "drds", "openAPI")
        {
        ...
        public override UpgradeHiStoreInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpgradeHiStoreInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
