...
{
    public class DescribeTableListByTypeRequest : RpcAcsRequest<DescribeTableListByTypeResponse>
    {
        public DescribeTableListByTypeRequest()
            : base("Drds", "2019-01-23", "DescribeTableListByType", "drds", "openAPI")
        {
		...
		public string TableType
		{
			...
			{
				tableType = value;
				DictionaryUtil.Add(QueryParameters, "TableType", value);
			}
		}
        ...
        public override DescribeTableListByTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTableListByTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
