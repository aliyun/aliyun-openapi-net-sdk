...
{
    public class SubmitCleanTaskRequest : RpcAcsRequest<SubmitCleanTaskResponse>
    {
        public SubmitCleanTaskRequest()
            : base("Drds", "2019-01-23", "SubmitCleanTask", "drds", "openAPI")
        {
        ...
        public override SubmitCleanTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitCleanTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
