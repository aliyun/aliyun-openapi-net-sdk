...
{
    public class DescribeDrdsTasksRequest : RpcAcsRequest<DescribeDrdsTasksResponse>
    {
        public DescribeDrdsTasksRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsTasks", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
