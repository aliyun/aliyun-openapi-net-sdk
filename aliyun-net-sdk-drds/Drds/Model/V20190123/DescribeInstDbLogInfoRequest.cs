...
{
    public class DescribeInstDbLogInfoRequest : RpcAcsRequest<DescribeInstDbLogInfoResponse>
    {
        public DescribeInstDbLogInfoRequest()
            : base("Drds", "2019-01-23", "DescribeInstDbLogInfo", "drds", "openAPI")
        {
        ...
        public override DescribeInstDbLogInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstDbLogInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
