...
{
    public class DescribeShardTaskInfoRequest : RpcAcsRequest<DescribeShardTaskInfoResponse>
    {
        public DescribeShardTaskInfoRequest()
            : base("Drds", "2019-01-23", "DescribeShardTaskInfo", "drds", "openAPI")
        {
        ...
        public override DescribeShardTaskInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeShardTaskInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
