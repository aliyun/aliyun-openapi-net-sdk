...
{
    public class DescribeInstanceSwitchNetworkRequest : RpcAcsRequest<DescribeInstanceSwitchNetworkResponse>
    {
        public DescribeInstanceSwitchNetworkRequest()
            : base("Drds", "2019-01-23", "DescribeInstanceSwitchNetwork", "drds", "openAPI")
        {
        ...
        public override DescribeInstanceSwitchNetworkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceSwitchNetworkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
