...
{
    public class RemoveDrdsDbFailedRecordRequest : RpcAcsRequest<RemoveDrdsDbFailedRecordResponse>
    {
        public RemoveDrdsDbFailedRecordRequest()
            : base("Drds", "2019-01-23", "RemoveDrdsDbFailedRecord", "drds", "openAPI")
        {
        ...
        public override RemoveDrdsDbFailedRecordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveDrdsDbFailedRecordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
