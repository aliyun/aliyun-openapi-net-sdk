...
{
    public class DescribeDrdsDBClusterRequest : RpcAcsRequest<DescribeDrdsDBClusterResponse>
    {
        public DescribeDrdsDBClusterRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsDBCluster", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsDBClusterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsDBClusterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
