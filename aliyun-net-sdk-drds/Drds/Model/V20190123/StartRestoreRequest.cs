...
{
    public class StartRestoreRequest : RpcAcsRequest<StartRestoreResponse>
    {
        public StartRestoreRequest()
            : base("Drds", "2019-01-23", "StartRestore", "drds", "openAPI")
        {
        ...
        public override StartRestoreResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartRestoreResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
