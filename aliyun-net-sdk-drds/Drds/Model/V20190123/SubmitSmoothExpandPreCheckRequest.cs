...
{
    public class SubmitSmoothExpandPreCheckRequest : RpcAcsRequest<SubmitSmoothExpandPreCheckResponse>
    {
        public SubmitSmoothExpandPreCheckRequest()
            : base("Drds", "2019-01-23", "SubmitSmoothExpandPreCheck", "drds", "openAPI")
        {
        ...
        public override SubmitSmoothExpandPreCheckResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitSmoothExpandPreCheckResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
