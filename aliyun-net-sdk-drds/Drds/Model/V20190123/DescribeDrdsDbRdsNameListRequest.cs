...
{
    public class DescribeDrdsDbRdsNameListRequest : RpcAcsRequest<DescribeDrdsDbRdsNameListResponse>
    {
        public DescribeDrdsDbRdsNameListRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsDbRdsNameList", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsDbRdsNameListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsDbRdsNameListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
