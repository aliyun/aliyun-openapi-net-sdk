...
{
    public class DescribeInstanceSwitchAzoneRequest : RpcAcsRequest<DescribeInstanceSwitchAzoneResponse>
    {
        public DescribeInstanceSwitchAzoneRequest()
            : base("Drds", "2019-01-23", "DescribeInstanceSwitchAzone", "drds", "openAPI")
        {
        ...
        public override DescribeInstanceSwitchAzoneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceSwitchAzoneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
