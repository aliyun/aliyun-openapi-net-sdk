...
{
    public class SwitchGlobalBroadcastTypeRequest : RpcAcsRequest<SwitchGlobalBroadcastTypeResponse>
    {
        public SwitchGlobalBroadcastTypeRequest()
            : base("Drds", "2019-01-23", "SwitchGlobalBroadcastType", "drds", "openAPI")
        {
        ...
        public override SwitchGlobalBroadcastTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwitchGlobalBroadcastTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
