...
{
    public class SubmitSmoothExpandPreCheckTaskRequest : RpcAcsRequest<SubmitSmoothExpandPreCheckTaskResponse>
    {
        public SubmitSmoothExpandPreCheckTaskRequest()
            : base("Drds", "2019-01-23", "SubmitSmoothExpandPreCheckTask", "drds", "openAPI")
        {
        ...
        public override SubmitSmoothExpandPreCheckTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitSmoothExpandPreCheckTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
