...
{
    public class DescribeDrdsSlowSqlsRequest : RpcAcsRequest<DescribeDrdsSlowSqlsResponse>
    {
        public DescribeDrdsSlowSqlsRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsSlowSqls", "drds", "openAPI")
        {
		...
		public long? ExeTime
		{
			...
			{
				exeTime = value;
				DictionaryUtil.Add(QueryParameters, "ExeTime", value.ToString());
			}
		}

        public override DescribeDrdsSlowSqlsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsSlowSqlsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
