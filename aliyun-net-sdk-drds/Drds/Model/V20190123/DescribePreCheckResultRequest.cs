...
{
    public class DescribePreCheckResultRequest : RpcAcsRequest<DescribePreCheckResultResponse>
    {
        public DescribePreCheckResultRequest()
            : base("Drds", "2019-01-23", "DescribePreCheckResult", "drds", "openAPI")
        {
        ...
        public override DescribePreCheckResultResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePreCheckResultResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
