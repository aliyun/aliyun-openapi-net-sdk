...
{
    public class FlashbackRecycleBinTableRequest : RpcAcsRequest<FlashbackRecycleBinTableResponse>
    {
        public FlashbackRecycleBinTableRequest()
            : base("Drds", "2019-01-23", "FlashbackRecycleBinTable", "drds", "openAPI")
        {
        ...
        public override FlashbackRecycleBinTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FlashbackRecycleBinTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
