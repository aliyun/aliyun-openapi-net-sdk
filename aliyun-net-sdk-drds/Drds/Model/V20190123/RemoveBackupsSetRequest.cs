...
{
    public class RemoveBackupsSetRequest : RpcAcsRequest<RemoveBackupsSetResponse>
    {
        public RemoveBackupsSetRequest()
            : base("Drds", "2019-01-23", "RemoveBackupsSet", "drds", "openAPI")
        {
        ...
        public override RemoveBackupsSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveBackupsSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
