...
{
    public class CheckDrdsDbNameRequest : RpcAcsRequest<CheckDrdsDbNameResponse>
    {
        public CheckDrdsDbNameRequest()
            : base("Drds", "2019-01-23", "CheckDrdsDbName", "drds", "openAPI")
        {
        ...
        public override CheckDrdsDbNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckDrdsDbNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
