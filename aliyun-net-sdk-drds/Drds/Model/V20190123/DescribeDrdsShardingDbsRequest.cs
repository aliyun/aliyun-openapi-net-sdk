...
{
    public class DescribeDrdsShardingDbsRequest : RpcAcsRequest<DescribeDrdsShardingDbsResponse>
    {
        public DescribeDrdsShardingDbsRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsShardingDbs", "drds", "openAPI")
        {
		...
		public string DbNamePattern
		{
			...
			{
				dbNamePattern = value;
				DictionaryUtil.Add(QueryParameters, "DbNamePattern", value);
			}
		}

        public override DescribeDrdsShardingDbsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsShardingDbsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
