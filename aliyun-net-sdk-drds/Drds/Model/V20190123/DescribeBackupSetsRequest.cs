...
{
    public class DescribeBackupSetsRequest : RpcAcsRequest<DescribeBackupSetsResponse>
    {
        public DescribeBackupSetsRequest()
            : base("Drds", "2019-01-23", "DescribeBackupSets", "drds", "openAPI")
        {
        ...
        public override DescribeBackupSetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupSetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
