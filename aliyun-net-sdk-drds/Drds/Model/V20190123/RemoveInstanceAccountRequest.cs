...
{
    public class RemoveInstanceAccountRequest : RpcAcsRequest<RemoveInstanceAccountResponse>
    {
        public RemoveInstanceAccountRequest()
            : base("Drds", "2019-01-23", "RemoveInstanceAccount", "drds", "openAPI")
        {
        ...
        public override RemoveInstanceAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveInstanceAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
