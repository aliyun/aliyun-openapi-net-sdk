...
{
    public class DescribeBroadcastTablesRequest : RpcAcsRequest<DescribeBroadcastTablesResponse>
    {
        public DescribeBroadcastTablesRequest()
            : base("Drds", "2019-01-23", "DescribeBroadcastTables", "drds", "openAPI")
        {
        ...
        public override DescribeBroadcastTablesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBroadcastTablesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
