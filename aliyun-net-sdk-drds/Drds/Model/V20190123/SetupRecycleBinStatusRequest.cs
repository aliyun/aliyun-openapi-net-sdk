...
{
    public class SetupRecycleBinStatusRequest : RpcAcsRequest<SetupRecycleBinStatusResponse>
    {
        public SetupRecycleBinStatusRequest()
            : base("Drds", "2019-01-23", "SetupRecycleBinStatus", "drds", "openAPI")
        {
		...
		public string StatusAction
		{
			...
			{
				statusAction = value;
				DictionaryUtil.Add(QueryParameters, "StatusAction", value);
			}
		}
        ...
        public override SetupRecycleBinStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetupRecycleBinStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
