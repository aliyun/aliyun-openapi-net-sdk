...
{
    public class DescribeDrdsParamsRequest : RpcAcsRequest<DescribeDrdsParamsResponse>
    {
        public DescribeDrdsParamsRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsParams", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsParamsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsParamsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
