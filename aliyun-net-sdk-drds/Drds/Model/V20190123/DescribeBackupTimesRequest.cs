...
{
    public class DescribeBackupTimesRequest : RpcAcsRequest<DescribeBackupTimesResponse>
    {
        public DescribeBackupTimesRequest()
            : base("Drds", "2019-01-23", "DescribeBackupTimes", "drds", "openAPI")
        {
        ...
        public override DescribeBackupTimesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupTimesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
