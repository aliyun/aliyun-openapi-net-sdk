...
{
    public class DescribeInstDbSlsInfoRequest : RpcAcsRequest<DescribeInstDbSlsInfoResponse>
    {
        public DescribeInstDbSlsInfoRequest()
            : base("Drds", "2019-01-23", "DescribeInstDbSlsInfo", "drds", "openAPI")
        {
        ...
        public override DescribeInstDbSlsInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstDbSlsInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
