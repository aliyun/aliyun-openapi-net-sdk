...
{
    public class UpdateResourceGroupAttributeRequest : RpcAcsRequest<UpdateResourceGroupAttributeResponse>
    {
        public UpdateResourceGroupAttributeRequest()
            : base("Drds", "2019-01-23", "UpdateResourceGroupAttribute", "drds", "openAPI")
        {
        ...
        public override UpdateResourceGroupAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateResourceGroupAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
