...
{
    public class DescribeRecycleBinStatusRequest : RpcAcsRequest<DescribeRecycleBinStatusResponse>
    {
        public DescribeRecycleBinStatusRequest()
            : base("Drds", "2019-01-23", "DescribeRecycleBinStatus", "drds", "openAPI")
        {
        ...
        public override DescribeRecycleBinStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRecycleBinStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
