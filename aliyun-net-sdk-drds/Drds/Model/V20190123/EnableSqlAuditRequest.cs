...
namespace Aliyun.Acs.Drds.Model.V20190123
{
    public class EnableSqlAuditRequest : RpcAcsRequest<EnableSqlAuditResponse>
    {
        public EnableSqlAuditRequest()
            : base("Drds", "2019-01-23", "EnableSqlAudit", "drds", "openAPI")
        {
		...
		public string RecallStartTimestamp
		{
			...
			set	
			{
				recallStartTimestamp = value;
				DictionaryUtil.Add(QueryParameters, "RecallStartTimestamp", value);
			}
		}
		...
		public bool? IsRecall
		{
			...
			{
				isRecall = value;
				DictionaryUtil.Add(QueryParameters, "IsRecall", value.ToString());
			}
		}
		...
		public string RecallEndTimestamp
		{
			...
			set	
			{
				recallEndTimestamp = value;
				DictionaryUtil.Add(QueryParameters, "RecallEndTimestamp", value);
			}
		}
