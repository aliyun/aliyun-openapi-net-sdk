...
{
    public class CheckExpandStatusRequest : RpcAcsRequest<CheckExpandStatusResponse>
    {
        public CheckExpandStatusRequest()
            : base("Drds", "2019-01-23", "CheckExpandStatus", "drds", "openAPI")
        {
        ...
        public override CheckExpandStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckExpandStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
