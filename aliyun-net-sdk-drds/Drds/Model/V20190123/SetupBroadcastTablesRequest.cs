...
{
    public class SetupBroadcastTablesRequest : RpcAcsRequest<SetupBroadcastTablesResponse>
    {
        public SetupBroadcastTablesRequest()
            : base("Drds", "2019-01-23", "SetupBroadcastTables", "drds", "openAPI")
        {
        ...
        public override SetupBroadcastTablesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetupBroadcastTablesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
