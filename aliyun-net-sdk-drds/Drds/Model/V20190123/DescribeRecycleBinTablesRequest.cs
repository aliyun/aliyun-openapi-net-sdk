...
{
    public class DescribeRecycleBinTablesRequest : RpcAcsRequest<DescribeRecycleBinTablesResponse>
    {
        public DescribeRecycleBinTablesRequest()
            : base("Drds", "2019-01-23", "DescribeRecycleBinTables", "drds", "openAPI")
        {
        ...
        public override DescribeRecycleBinTablesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRecycleBinTablesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
