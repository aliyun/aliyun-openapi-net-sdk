...
{
    public class CheckSqlAuditEnableStatusRequest : RpcAcsRequest<CheckSqlAuditEnableStatusResponse>
    {
        public CheckSqlAuditEnableStatusRequest()
            : base("Drds", "2019-01-23", "CheckSqlAuditEnableStatus", "drds", "openAPI")
        {
        ...
        public override CheckSqlAuditEnableStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckSqlAuditEnableStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
