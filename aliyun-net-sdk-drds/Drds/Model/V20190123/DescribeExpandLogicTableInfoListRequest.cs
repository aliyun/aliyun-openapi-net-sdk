...
{
    public class DescribeExpandLogicTableInfoListRequest : RpcAcsRequest<DescribeExpandLogicTableInfoListResponse>
    {
        public DescribeExpandLogicTableInfoListRequest()
            : base("Drds", "2019-01-23", "DescribeExpandLogicTableInfoList", "drds", "openAPI")
        {
        ...
        public override DescribeExpandLogicTableInfoListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeExpandLogicTableInfoListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
