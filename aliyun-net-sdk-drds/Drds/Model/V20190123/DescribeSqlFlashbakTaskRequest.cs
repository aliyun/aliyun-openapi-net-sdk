...
{
    public class DescribeSqlFlashbakTaskRequest : RpcAcsRequest<DescribeSqlFlashbakTaskResponse>
    {
        public DescribeSqlFlashbakTaskRequest()
            : base("Drds", "2019-01-23", "DescribeSqlFlashbakTask", "drds", "openAPI")
        {
        ...
        public override DescribeSqlFlashbakTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSqlFlashbakTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
