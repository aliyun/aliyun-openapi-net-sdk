...
{
    public class RemoveRecycleBinTableRequest : RpcAcsRequest<RemoveRecycleBinTableResponse>
    {
        public RemoveRecycleBinTableRequest()
            : base("Drds", "2019-01-23", "RemoveRecycleBinTable", "drds", "openAPI")
        {
        ...
        public override RemoveRecycleBinTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveRecycleBinTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
