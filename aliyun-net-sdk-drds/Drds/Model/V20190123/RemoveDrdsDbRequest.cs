...
{
    public class RemoveDrdsDbRequest : RpcAcsRequest<RemoveDrdsDbResponse>
    {
        public RemoveDrdsDbRequest()
            : base("Drds", "2019-01-23", "RemoveDrdsDb", "drds", "openAPI")
        {
        ...
        public override RemoveDrdsDbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveDrdsDbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
