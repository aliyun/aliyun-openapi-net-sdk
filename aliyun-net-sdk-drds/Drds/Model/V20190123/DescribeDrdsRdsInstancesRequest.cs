...
{
    public class DescribeDrdsRdsInstancesRequest : RpcAcsRequest<DescribeDrdsRdsInstancesResponse>
    {
        public DescribeDrdsRdsInstancesRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsRdsInstances", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsRdsInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsRdsInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
