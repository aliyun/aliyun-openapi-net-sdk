...
{
    public class EnableInstanceIpv6AddressRequest : RpcAcsRequest<EnableInstanceIpv6AddressResponse>
    {
        public EnableInstanceIpv6AddressRequest()
            : base("Drds", "2019-01-23", "EnableInstanceIpv6Address", "drds", "openAPI")
        {
        ...
        public override EnableInstanceIpv6AddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableInstanceIpv6AddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
