...
{
    public class CreateOrderForRdsRequest : RpcAcsRequest<CreateOrderForRdsResponse>
    {
        public CreateOrderForRdsRequest()
            : base("Drds", "2019-01-23", "CreateOrderForRds", "drds", "openAPI")
        {
        ...
        public override CreateOrderForRdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateOrderForRdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
