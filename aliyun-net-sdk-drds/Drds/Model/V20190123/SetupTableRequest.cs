...
{
    public class SetupTableRequest : RpcAcsRequest<SetupTableResponse>
    {
        public SetupTableRequest()
            : base("Drds", "2019-01-23", "SetupTable", "drds", "openAPI")
        {
		...
		public bool? AllowFullTableScan
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "AllowFullTableScan", value.ToString());
			}
		}
        ...
        public override SetupTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetupTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
