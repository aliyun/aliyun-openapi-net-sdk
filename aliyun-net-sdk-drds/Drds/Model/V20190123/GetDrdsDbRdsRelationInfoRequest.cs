...
{
    public class GetDrdsDbRdsRelationInfoRequest : RpcAcsRequest<GetDrdsDbRdsRelationInfoResponse>
    {
        public GetDrdsDbRdsRelationInfoRequest()
            : base("Drds", "2019-01-23", "GetDrdsDbRdsRelationInfo", "drds", "openAPI")
        {
        ...
        public override GetDrdsDbRdsRelationInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDrdsDbRdsRelationInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
