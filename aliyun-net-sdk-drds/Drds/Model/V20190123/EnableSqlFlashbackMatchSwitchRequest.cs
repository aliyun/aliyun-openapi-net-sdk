...
{
    public class EnableSqlFlashbackMatchSwitchRequest : RpcAcsRequest<EnableSqlFlashbackMatchSwitchResponse>
    {
        public EnableSqlFlashbackMatchSwitchRequest()
            : base("Drds", "2019-01-23", "EnableSqlFlashbackMatchSwitch", "drds", "openAPI")
        {
        ...
        public override EnableSqlFlashbackMatchSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableSqlFlashbackMatchSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
