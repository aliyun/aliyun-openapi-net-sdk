...
{
    public class DescribeDrdsSqlAuditStatusRequest : RpcAcsRequest<DescribeDrdsSqlAuditStatusResponse>
    {
        public DescribeDrdsSqlAuditStatusRequest()
            : base("Drds", "2019-01-23", "DescribeDrdsSqlAuditStatus", "drds", "openAPI")
        {
        ...
        public override DescribeDrdsSqlAuditStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDrdsSqlAuditStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
