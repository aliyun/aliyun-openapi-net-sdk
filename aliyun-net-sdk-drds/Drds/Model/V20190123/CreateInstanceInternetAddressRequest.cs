...
{
    public class CreateInstanceInternetAddressRequest : RpcAcsRequest<CreateInstanceInternetAddressResponse>
    {
        public CreateInstanceInternetAddressRequest()
            : base("Drds", "2019-01-23", "CreateInstanceInternetAddress", "drds", "openAPI")
        {
        ...
        public override CreateInstanceInternetAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateInstanceInternetAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
