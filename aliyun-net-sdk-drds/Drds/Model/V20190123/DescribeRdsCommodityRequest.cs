...
{
    public class DescribeRdsCommodityRequest : RpcAcsRequest<DescribeRdsCommodityResponse>
    {
        public DescribeRdsCommodityRequest()
            : base("Drds", "2019-01-23", "DescribeRdsCommodity", "drds", "openAPI")
        {
        ...
        public override DescribeRdsCommodityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRdsCommodityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
