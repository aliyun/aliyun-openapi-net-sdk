...
namespace Aliyun.Acs.Drds.Transform.V20190123
{
    ...
    {
        public static RemoveDrdsDbFailedRecordResponse Unmarshall(UnmarshallerContext _ctx)
        {
			RemoveDrdsDbFailedRecordResponse removeDrdsDbFailedRecordResponse = new RemoveDrdsDbFailedRecordResponse();
