...
{
    public class StartDtsJobRequest : RpcAcsRequest<StartDtsJobResponse>
    {
        public StartDtsJobRequest()
            : base("Dts", "2020-01-01", "StartDtsJob", "dts", "openAPI")
        {
        ...
        public override StartDtsJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartDtsJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
