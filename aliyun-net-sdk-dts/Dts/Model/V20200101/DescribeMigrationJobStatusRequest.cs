...
{
    public class DescribeMigrationJobStatusRequest : RpcAcsRequest<DescribeMigrationJobStatusResponse>
    {
        public DescribeMigrationJobStatusRequest()
            : base("Dts", "2020-01-01", "DescribeMigrationJobStatus", "dts", "openAPI")
        {
        ...
        public override DescribeMigrationJobStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMigrationJobStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
