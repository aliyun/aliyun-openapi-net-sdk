...
{
    public class SuspendMigrationJobRequest : RpcAcsRequest<SuspendMigrationJobResponse>
    {
        public SuspendMigrationJobRequest()
            : base("Dts", "2020-01-01", "SuspendMigrationJob", "dts", "openAPI")
        {
        ...
        public override SuspendMigrationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SuspendMigrationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
