...
{
    public class DescribeInitializationStatusRequest : RpcAcsRequest<DescribeInitializationStatusResponse>
    {
        public DescribeInitializationStatusRequest()
            : base("Dts", "2020-01-01", "DescribeInitializationStatus", "dts", "openAPI")
        {
