...
{
    public class ResetSynchronizationJobRequest : RpcAcsRequest<ResetSynchronizationJobResponse>
    {
        public ResetSynchronizationJobRequest()
            : base("Dts", "2020-01-01", "ResetSynchronizationJob", "dts", "openAPI")
        {
        ...
        public override ResetSynchronizationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetSynchronizationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
