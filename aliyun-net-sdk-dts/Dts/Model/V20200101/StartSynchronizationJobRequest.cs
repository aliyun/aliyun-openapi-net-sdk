...
{
    public class StartSynchronizationJobRequest : RpcAcsRequest<StartSynchronizationJobResponse>
    {
        public StartSynchronizationJobRequest()
            : base("Dts", "2020-01-01", "StartSynchronizationJob", "dts", "openAPI")
        {
        ...
        public override StartSynchronizationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartSynchronizationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
