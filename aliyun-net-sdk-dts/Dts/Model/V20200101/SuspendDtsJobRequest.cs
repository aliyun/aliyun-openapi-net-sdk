...
{
    public class SuspendDtsJobRequest : RpcAcsRequest<SuspendDtsJobResponse>
    {
        public SuspendDtsJobRequest()
            : base("Dts", "2020-01-01", "SuspendDtsJob", "dts", "openAPI")
        {
        ...
        public override SuspendDtsJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SuspendDtsJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
