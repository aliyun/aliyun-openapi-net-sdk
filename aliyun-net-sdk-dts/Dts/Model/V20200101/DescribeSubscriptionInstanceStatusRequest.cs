...
{
    public class DescribeSubscriptionInstanceStatusRequest : RpcAcsRequest<DescribeSubscriptionInstanceStatusResponse>
    {
        public DescribeSubscriptionInstanceStatusRequest()
            : base("Dts", "2020-01-01", "DescribeSubscriptionInstanceStatus", "dts", "openAPI")
        {
        ...
        public override DescribeSubscriptionInstanceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSubscriptionInstanceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
