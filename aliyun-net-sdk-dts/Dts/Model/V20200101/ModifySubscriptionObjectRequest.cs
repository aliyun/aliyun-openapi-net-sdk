...
{
    public class ModifySubscriptionObjectRequest : RpcAcsRequest<ModifySubscriptionObjectResponse>
    {
        public ModifySubscriptionObjectRequest()
            : base("Dts", "2020-01-01", "ModifySubscriptionObject", "dts", "openAPI")
        {
		...
		public string SubscriptionObject
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SubscriptionObject", value);
			}
		}

        public override ModifySubscriptionObjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySubscriptionObjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
