...
{
    public class ModifySynchronizationObjectRequest : RpcAcsRequest<ModifySynchronizationObjectResponse>
    {
        public ModifySynchronizationObjectRequest()
            : base("Dts", "2020-01-01", "ModifySynchronizationObject", "dts", "openAPI")
        {
		...
		public string SynchronizationObjects
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "SynchronizationObjects", value);
			}
		}
        ...
        public override ModifySynchronizationObjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySynchronizationObjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
