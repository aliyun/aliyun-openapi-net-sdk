...
{
    public class DescribeCenVpcRequest : RpcAcsRequest<DescribeCenVpcResponse>
    {
        public DescribeCenVpcRequest()
            : base("Dts", "2020-01-01", "DescribeCenVpc", "dts", "openAPI")
        {
        ...
        public override DescribeCenVpcResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCenVpcResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
