...
{
    public class DescribeSubscriptionObjectModifyStatusRequest : RpcAcsRequest<DescribeSubscriptionObjectModifyStatusResponse>
    {
        public DescribeSubscriptionObjectModifyStatusRequest()
            : base("Dts", "2020-01-01", "DescribeSubscriptionObjectModifyStatus", "dts", "openAPI")
        {
        ...
        public override DescribeSubscriptionObjectModifyStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSubscriptionObjectModifyStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
