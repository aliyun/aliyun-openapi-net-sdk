...
{
    public class DescribeDTSIPRequest : RpcAcsRequest<DescribeDTSIPResponse>
    {
        public DescribeDTSIPRequest()
            : base("Dts", "2020-01-01", "DescribeDTSIP", "dts", "openAPI")
        {
        ...
        public override DescribeDTSIPResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDTSIPResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
