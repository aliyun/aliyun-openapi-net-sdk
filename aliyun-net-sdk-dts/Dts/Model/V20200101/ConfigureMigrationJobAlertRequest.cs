...
{
    public class ConfigureMigrationJobAlertRequest : RpcAcsRequest<ConfigureMigrationJobAlertResponse>
    {
        public ConfigureMigrationJobAlertRequest()
            : base("Dts", "2020-01-01", "ConfigureMigrationJobAlert", "dts", "openAPI")
        {
        ...
        public override ConfigureMigrationJobAlertResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigureMigrationJobAlertResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
