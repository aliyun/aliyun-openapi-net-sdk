...
{
    public class ModifyDtsJobNameRequest : RpcAcsRequest<ModifyDtsJobNameResponse>
    {
        public ModifyDtsJobNameRequest()
            : base("Dts", "2020-01-01", "ModifyDtsJobName", "dts", "openAPI")
        {
        ...
        public override ModifyDtsJobNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDtsJobNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
