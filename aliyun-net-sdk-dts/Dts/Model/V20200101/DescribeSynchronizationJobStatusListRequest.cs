...
{
    public class DescribeSynchronizationJobStatusListRequest : RpcAcsRequest<DescribeSynchronizationJobStatusListResponse>
    {
        public DescribeSynchronizationJobStatusListRequest()
            : base("Dts", "2020-01-01", "DescribeSynchronizationJobStatusList", "dts", "openAPI")
        {
		...
		public string SynchronizationJobIdListJsonStr
		{
			...
			set	
			{
				synchronizationJobIdListJsonStr = value;
				DictionaryUtil.Add(QueryParameters, "SynchronizationJobIdListJsonStr", value);
			}
		}
        ...
        public override DescribeSynchronizationJobStatusListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSynchronizationJobStatusListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
