...
{
    public class ModifyConsumptionTimestampRequest : RpcAcsRequest<ModifyConsumptionTimestampResponse>
    {
        public ModifyConsumptionTimestampRequest()
            : base("Dts", "2020-01-01", "ModifyConsumptionTimestamp", "dts", "openAPI")
        {
		...
		public string ConsumptionTimestamp
		{
			...
			set	
			{
				consumptionTimestamp = value;
				DictionaryUtil.Add(QueryParameters, "ConsumptionTimestamp", value);
			}
		}
        ...
        public override ModifyConsumptionTimestampResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyConsumptionTimestampResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
