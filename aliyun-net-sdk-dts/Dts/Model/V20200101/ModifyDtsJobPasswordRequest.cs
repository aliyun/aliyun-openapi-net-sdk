...
{
    public class ModifyDtsJobPasswordRequest : RpcAcsRequest<ModifyDtsJobPasswordResponse>
    {
        public ModifyDtsJobPasswordRequest()
            : base("Dts", "2020-01-01", "ModifyDtsJobPassword", "dts", "openAPI")
        {
        ...
        public override ModifyDtsJobPasswordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDtsJobPasswordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
