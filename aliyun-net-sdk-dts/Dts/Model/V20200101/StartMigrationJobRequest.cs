...
{
    public class StartMigrationJobRequest : RpcAcsRequest<StartMigrationJobResponse>
    {
        public StartMigrationJobRequest()
            : base("Dts", "2020-01-01", "StartMigrationJob", "dts", "openAPI")
        {
        ...
        public override StartMigrationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartMigrationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
