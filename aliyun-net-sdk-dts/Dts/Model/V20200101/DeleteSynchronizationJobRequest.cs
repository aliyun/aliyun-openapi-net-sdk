...
{
    public class DeleteSynchronizationJobRequest : RpcAcsRequest<DeleteSynchronizationJobResponse>
    {
        public DeleteSynchronizationJobRequest()
            : base("Dts", "2020-01-01", "DeleteSynchronizationJob", "dts", "openAPI")
        {
        ...
        public override DeleteSynchronizationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSynchronizationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
