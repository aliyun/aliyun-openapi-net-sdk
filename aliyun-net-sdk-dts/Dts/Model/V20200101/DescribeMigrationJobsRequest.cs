...
{
    public class DescribeMigrationJobsRequest : RpcAcsRequest<DescribeMigrationJobsResponse>
    {
        public DescribeMigrationJobsRequest()
            : base("Dts", "2020-01-01", "DescribeMigrationJobs", "dts", "openAPI")
        {
        ...
        public override DescribeMigrationJobsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMigrationJobsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
