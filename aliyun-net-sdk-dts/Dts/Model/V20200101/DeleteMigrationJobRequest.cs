...
{
    public class DeleteMigrationJobRequest : RpcAcsRequest<DeleteMigrationJobResponse>
    {
        public DeleteMigrationJobRequest()
            : base("Dts", "2020-01-01", "DeleteMigrationJob", "dts", "openAPI")
        {
        ...
        public override DeleteMigrationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMigrationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
