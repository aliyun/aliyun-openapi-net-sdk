...
{
    public class ModifyMigrationObjectRequest : RpcAcsRequest<ModifyMigrationObjectResponse>
    {
        public ModifyMigrationObjectRequest()
            : base("Dts", "2020-01-01", "ModifyMigrationObject", "dts", "openAPI")
        {
		...
		public string MigrationObject
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MigrationObject", value);
			}
		}
        ...
        public override ModifyMigrationObjectResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMigrationObjectResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
