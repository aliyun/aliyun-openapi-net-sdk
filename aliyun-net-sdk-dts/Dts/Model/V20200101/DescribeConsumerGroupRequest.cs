...
{
    public class DescribeConsumerGroupRequest : RpcAcsRequest<DescribeConsumerGroupResponse>
    {
        public DescribeConsumerGroupRequest()
            : base("Dts", "2020-01-01", "DescribeConsumerGroup", "dts", "openAPI")
        {
        ...
        public override DescribeConsumerGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeConsumerGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
