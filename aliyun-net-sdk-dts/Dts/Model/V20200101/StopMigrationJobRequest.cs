...
{
    public class StopMigrationJobRequest : RpcAcsRequest<StopMigrationJobResponse>
    {
        public StopMigrationJobRequest()
            : base("Dts", "2020-01-01", "StopMigrationJob", "dts", "openAPI")
        {
        ...
        public override StopMigrationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopMigrationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
