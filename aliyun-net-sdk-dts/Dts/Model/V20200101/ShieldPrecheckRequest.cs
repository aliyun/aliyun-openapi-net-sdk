...
{
    public class ShieldPrecheckRequest : RpcAcsRequest<ShieldPrecheckResponse>
    {
        public ShieldPrecheckRequest()
            : base("Dts", "2020-01-01", "ShieldPrecheck", "dts", "openAPI")
        {
		...
		public string PrecheckItems
		{
			...
			{
				precheckItems = value;
				DictionaryUtil.Add(QueryParameters, "PrecheckItems", value);
			}
		}
        ...
        public override ShieldPrecheckResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ShieldPrecheckResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
