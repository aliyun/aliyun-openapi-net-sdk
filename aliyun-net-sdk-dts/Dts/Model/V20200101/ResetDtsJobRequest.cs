...
{
    public class ResetDtsJobRequest : RpcAcsRequest<ResetDtsJobResponse>
    {
        public ResetDtsJobRequest()
            : base("Dts", "2020-01-01", "ResetDtsJob", "dts", "openAPI")
        {
        ...
        public override ResetDtsJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetDtsJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
