...
{
    public class ConfigureSubscriptionInstanceAlertRequest : RpcAcsRequest<ConfigureSubscriptionInstanceAlertResponse>
    {
        public ConfigureSubscriptionInstanceAlertRequest()
            : base("Dts", "2020-01-01", "ConfigureSubscriptionInstanceAlert", "dts", "openAPI")
        {
        ...
        public override ConfigureSubscriptionInstanceAlertResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfigureSubscriptionInstanceAlertResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
