...
{
    public class DescribeSynchronizationJobStatusRequest : RpcAcsRequest<DescribeSynchronizationJobStatusResponse>
    {
        public DescribeSynchronizationJobStatusRequest()
            : base("Dts", "2020-01-01", "DescribeSynchronizationJobStatus", "dts", "openAPI")
        {
        ...
        public override DescribeSynchronizationJobStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSynchronizationJobStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
