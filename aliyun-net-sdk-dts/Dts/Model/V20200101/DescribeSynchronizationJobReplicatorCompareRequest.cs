...
{
    public class DescribeSynchronizationJobReplicatorCompareRequest : RpcAcsRequest<DescribeSynchronizationJobReplicatorCompareResponse>
    {
        public DescribeSynchronizationJobReplicatorCompareRequest()
            : base("Dts", "2020-01-01", "DescribeSynchronizationJobReplicatorCompare", "dts", "openAPI")
        {
        ...
        public override DescribeSynchronizationJobReplicatorCompareResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSynchronizationJobReplicatorCompareResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
