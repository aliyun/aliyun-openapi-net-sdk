...
{
    public class SuspendSynchronizationJobRequest : RpcAcsRequest<SuspendSynchronizationJobResponse>
    {
        public SuspendSynchronizationJobRequest()
            : base("Dts", "2020-01-01", "SuspendSynchronizationJob", "dts", "openAPI")
        {
        ...
        public override SuspendSynchronizationJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SuspendSynchronizationJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
