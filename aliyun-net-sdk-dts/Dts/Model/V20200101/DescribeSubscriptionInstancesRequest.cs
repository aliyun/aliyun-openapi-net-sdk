...
{
    public class DescribeSubscriptionInstancesRequest : RpcAcsRequest<DescribeSubscriptionInstancesResponse>
    {
        public DescribeSubscriptionInstancesRequest()
            : base("Dts", "2020-01-01", "DescribeSubscriptionInstances", "dts", "openAPI")
        {
        ...
        public override DescribeSubscriptionInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSubscriptionInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
