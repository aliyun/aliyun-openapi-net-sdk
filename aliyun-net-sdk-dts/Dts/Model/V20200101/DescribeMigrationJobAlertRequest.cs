...
{
    public class DescribeMigrationJobAlertRequest : RpcAcsRequest<DescribeMigrationJobAlertResponse>
    {
        public DescribeMigrationJobAlertRequest()
            : base("Dts", "2020-01-01", "DescribeMigrationJobAlert", "dts", "openAPI")
        {
        ...
        public override DescribeMigrationJobAlertResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMigrationJobAlertResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
