...
{
    public class StopDtsJobRequest : RpcAcsRequest<StopDtsJobResponse>
    {
        public StopDtsJobRequest()
            : base("Dts", "2020-01-01", "StopDtsJob", "dts", "openAPI")
        {
        ...
        public override StopDtsJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDtsJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
