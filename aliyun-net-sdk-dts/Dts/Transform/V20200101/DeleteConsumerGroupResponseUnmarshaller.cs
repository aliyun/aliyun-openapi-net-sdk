...
namespace Aliyun.Acs.Dts.Transform.V20200101
{
    public class DeleteConsumerGroupResponseUnmarshaller
    {
        public static DeleteConsumerGroupResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			deleteConsumerGroupResponse.ErrCode = _ctx.StringValue("DeleteConsumerGroup.ErrCode");
			deleteConsumerGroupResponse.ErrMessage = _ctx.StringValue("DeleteConsumerGroup.ErrMessage");
			deleteConsumerGroupResponse.RequestId = _ctx.StringValue("DeleteConsumerGroup.RequestId");
			deleteConsumerGroupResponse.Success = _ctx.StringValue("DeleteConsumerGroup.Success");
