...
namespace Aliyun.Acs.Dts.Transform.V20200101
{
    public class CreateConsumerGroupResponseUnmarshaller
    {
        public static CreateConsumerGroupResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			createConsumerGroupResponse.ConsumerGroupID = _ctx.StringValue("CreateConsumerGroup.ConsumerGroupID");
			createConsumerGroupResponse.ErrCode = _ctx.StringValue("CreateConsumerGroup.ErrCode");
			createConsumerGroupResponse.ErrMessage = _ctx.StringValue("CreateConsumerGroup.ErrMessage");
			createConsumerGroupResponse.RequestId = _ctx.StringValue("CreateConsumerGroup.RequestId");
			createConsumerGroupResponse.Success = _ctx.StringValue("CreateConsumerGroup.Success");
