...
namespace Aliyun.Acs.Cloudauth.Transform.V20201112
{
    public class CompareFacesResponseUnmarshaller
    {
        public static CompareFacesResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			CompareFacesResponse.CompareFaces_ResultObject resultObject = new CompareFacesResponse.CompareFaces_ResultObject();
			resultObject.SimilarityScore = _ctx.FloatValue("CompareFaces.ResultObject.SimilarityScore");
			resultObject.ConfidenceThresholds = _ctx.StringValue("CompareFaces.ResultObject.ConfidenceThresholds");
			compareFacesResponse.ResultObject = resultObject;
