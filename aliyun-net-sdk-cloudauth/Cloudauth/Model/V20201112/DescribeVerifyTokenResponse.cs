...
namespace Aliyun.Acs.Cloudauth.Model.V20201112
{
	public class DescribeVerifyTokenResponse : AcsResponse
	{
		...
		private DescribeVerifyToken_ResultObject resultObject;
		...
		public DescribeVerifyToken_ResultObject ResultObject
		{
			get
			{
				return resultObject;
		...
		public class DescribeVerifyToken_ResultObject
		{
