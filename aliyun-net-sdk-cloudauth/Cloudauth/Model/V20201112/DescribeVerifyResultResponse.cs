...
namespace Aliyun.Acs.Cloudauth.Model.V20201112
{
	public class DescribeVerifyResultResponse : AcsResponse
	{
		...
		private DescribeVerifyResult_ResultObject resultObject;
		...
		public DescribeVerifyResult_ResultObject ResultObject
		{
			get
			{
				return resultObject;
		...
		public class DescribeVerifyResult_ResultObject
		{
