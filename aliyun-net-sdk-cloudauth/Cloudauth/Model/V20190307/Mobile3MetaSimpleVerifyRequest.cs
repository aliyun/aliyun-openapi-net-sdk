...
{
    public class Mobile3MetaSimpleVerifyRequest : RpcAcsRequest<Mobile3MetaSimpleVerifyResponse>
    {
        public Mobile3MetaSimpleVerifyRequest()
            : base("Cloudauth", "2019-03-07", "Mobile3MetaSimpleVerify", "cloudauth", "openAPI")
        {
        ...
        public override Mobile3MetaSimpleVerifyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return Mobile3MetaSimpleVerifyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
