...
{
    public class CreateFaceConfigRequest : RpcAcsRequest<CreateFaceConfigResponse>
    {
        public CreateFaceConfigRequest()
            : base("Cloudauth", "2019-03-07", "CreateFaceConfig", "cloudauth", "openAPI")
        {
        ...
        public override CreateFaceConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFaceConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
