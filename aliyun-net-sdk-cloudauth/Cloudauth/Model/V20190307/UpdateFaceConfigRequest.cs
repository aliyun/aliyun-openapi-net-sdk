...
namespace Aliyun.Acs.Cloudauth.Model.V20190307
{
    public class UpdateFaceConfigRequest : RpcAcsRequest<UpdateFaceConfigResponse>
    {
        ...
        public override UpdateFaceConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateFaceConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
