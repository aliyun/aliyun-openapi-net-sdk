...
namespace Aliyun.Acs.quickbi_public.Model.V20200731
{
    public class ListByUserGroupIdRequest : RpcAcsRequest<ListByUserGroupIdResponse>
    {
        public ListByUserGroupIdRequest()
            : base("quickbi-public", "2020-07-31", "ListByUserGroupId", "quickbi", "openAPI")
        {
        ...
        public override ListByUserGroupIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListByUserGroupIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
