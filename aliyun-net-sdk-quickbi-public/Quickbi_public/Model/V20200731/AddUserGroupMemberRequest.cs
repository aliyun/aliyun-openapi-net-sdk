...
namespace Aliyun.Acs.quickbi_public.Model.V20200731
{
    public class AddUserGroupMemberRequest : RpcAcsRequest<AddUserGroupMemberResponse>
    {
        public AddUserGroupMemberRequest()
            : base("quickbi-public", "2020-07-31", "AddUserGroupMember", "quickbi", "openAPI")
        {
		...
		public string UserIdList
		{
			...
			{
				userIdList = value;
				DictionaryUtil.Add(QueryParameters, "UserIdList", value);
			}
		}
        ...
        public override AddUserGroupMemberResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddUserGroupMemberResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
