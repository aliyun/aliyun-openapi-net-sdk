...
namespace Aliyun.Acs.quickbi_public.Model.V20200731
{
    public class DeleteUserGroupRequest : RpcAcsRequest<DeleteUserGroupResponse>
    {
        public DeleteUserGroupRequest()
            : base("quickbi-public", "2020-07-31", "DeleteUserGroup", "quickbi", "openAPI")
        {
        ...
        public override DeleteUserGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteUserGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
