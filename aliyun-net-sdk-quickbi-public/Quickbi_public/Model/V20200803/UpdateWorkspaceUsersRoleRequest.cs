...
{
    public class UpdateWorkspaceUsersRoleRequest : RpcAcsRequest<UpdateWorkspaceUsersRoleResponse>
    {
        public UpdateWorkspaceUsersRoleRequest()
            : base("quickbi-public", "2020-08-03", "UpdateWorkspaceUsersRole", "quickbi", "openAPI")
        {
        ...
        public override UpdateWorkspaceUsersRoleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateWorkspaceUsersRoleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
