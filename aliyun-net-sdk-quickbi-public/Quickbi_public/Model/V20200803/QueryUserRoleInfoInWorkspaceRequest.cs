...
namespace Aliyun.Acs.quickbi_public.Model.V20200803
{
    public class QueryUserRoleInfoInWorkspaceRequest : RpcAcsRequest<QueryUserRoleInfoInWorkspaceResponse>
    {
        public QueryUserRoleInfoInWorkspaceRequest()
            : base("quickbi-public", "2020-08-03", "QueryUserRoleInfoInWorkspace", "quickbi", "openAPI")
        {
        ...
        public override QueryUserRoleInfoInWorkspaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUserRoleInfoInWorkspaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
