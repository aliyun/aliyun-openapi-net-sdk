...
using Aliyun.Acs.quickbi_public.Transform.V20200808;

namespace Aliyun.Acs.quickbi_public.Model.V20200808
{
    public class ListPortalMenuAuthorizationRequest : RpcAcsRequest<ListPortalMenuAuthorizationResponse>
    {
        public ListPortalMenuAuthorizationRequest()
            : base("quickbi-public", "2020-08-08", "ListPortalMenuAuthorization", "quickbi", "openAPI")
        {
        ...
        public override ListPortalMenuAuthorizationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPortalMenuAuthorizationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
