...
{
    public class ChangeVisibilityModelRequest : RpcAcsRequest<ChangeVisibilityModelResponse>
    {
        public ChangeVisibilityModelRequest()
            : base("quickbi-public", "2020-08-08", "ChangeVisibilityModel", "quickbi", "openAPI")
        {
        ...
        public override ChangeVisibilityModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ChangeVisibilityModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
