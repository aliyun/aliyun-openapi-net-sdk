...
{
    public class QueryDatasetDetailInfoRequest : RpcAcsRequest<QueryDatasetDetailInfoResponse>
    {
        public QueryDatasetDetailInfoRequest()
            : base("quickbi-public", "2020-08-06", "QueryDatasetDetailInfo", "quickbi", "openAPI")
        {
        ...
        public override QueryDatasetDetailInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDatasetDetailInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
