...
{
    public class QueryShareListRequest : RpcAcsRequest<QueryShareListResponse>
    {
        public QueryShareListRequest()
            : base("quickbi-public", "2020-08-04", "QueryShareList", "quickbi", "openAPI")
        {
        ...
        public override QueryShareListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryShareListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
