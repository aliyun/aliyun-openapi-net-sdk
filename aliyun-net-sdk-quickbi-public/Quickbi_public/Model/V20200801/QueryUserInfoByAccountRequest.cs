...
namespace Aliyun.Acs.quickbi_public.Model.V20200801
{
    public class QueryUserInfoByAccountRequest : RpcAcsRequest<QueryUserInfoByAccountResponse>
    {
        public QueryUserInfoByAccountRequest()
            : base("quickbi-public", "2020-08-01", "QueryUserInfoByAccount", "quickbi", "openAPI")
        {
        ...
        public override QueryUserInfoByAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryUserInfoByAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
