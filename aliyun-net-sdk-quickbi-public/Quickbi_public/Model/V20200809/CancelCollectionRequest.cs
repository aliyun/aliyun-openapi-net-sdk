...
{
    public class CancelCollectionRequest : RpcAcsRequest<CancelCollectionResponse>
    {
        public CancelCollectionRequest()
            : base("quickbi-public", "2020-08-09", "CancelCollection", "quickbi", "openAPI")
        {
        ...
        public override CancelCollectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelCollectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
