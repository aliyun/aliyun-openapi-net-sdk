...
namespace Aliyun.Acs.quickbi_public.Model.V20200809
{
    public class SaveFavoritesRequest : RpcAcsRequest<SaveFavoritesResponse>
    {
        public SaveFavoritesRequest()
            : base("quickbi-public", "2020-08-09", "SaveFavorites", "quickbi", "openAPI")
        {
        ...
        public override SaveFavoritesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveFavoritesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
