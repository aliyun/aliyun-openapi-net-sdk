...
{
    public class DelayEmbedTokenRequest : RpcAcsRequest<DelayEmbedTokenResponse>
    {
        public DelayEmbedTokenRequest()
            : base("quickbi-public", "2021-03-25", "DelayEmbedToken", "quickbi", "openAPI")
        {
        ...
        public override DelayEmbedTokenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DelayEmbedTokenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
