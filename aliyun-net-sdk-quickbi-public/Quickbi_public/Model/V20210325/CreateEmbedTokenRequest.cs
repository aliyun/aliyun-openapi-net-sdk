...
{
    public class CreateEmbedTokenRequest : RpcAcsRequest<CreateEmbedTokenResponse>
    {
        public CreateEmbedTokenRequest()
            : base("quickbi-public", "2021-03-25", "CreateEmbedToken", "quickbi", "openAPI")
        {
        ...
        public override CreateEmbedTokenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateEmbedTokenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
