...
{
    public class DeleteEmbedTokenRequest : RpcAcsRequest<DeleteEmbedTokenResponse>
    {
        public DeleteEmbedTokenRequest()
            : base("quickbi-public", "2021-03-25", "DeleteEmbedToken", "quickbi", "openAPI")
        {
        ...
        public override DeleteEmbedTokenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEmbedTokenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
