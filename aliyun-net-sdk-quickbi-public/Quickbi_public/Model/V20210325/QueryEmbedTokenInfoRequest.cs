...
{
    public class QueryEmbedTokenInfoRequest : RpcAcsRequest<QueryEmbedTokenInfoResponse>
    {
        public QueryEmbedTokenInfoRequest()
            : base("quickbi-public", "2021-03-25", "QueryEmbedTokenInfo", "quickbi", "openAPI")
        {
        ...
        public override QueryEmbedTokenInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryEmbedTokenInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
