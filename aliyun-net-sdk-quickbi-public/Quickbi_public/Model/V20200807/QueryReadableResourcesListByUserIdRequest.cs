...
namespace Aliyun.Acs.quickbi_public.Model.V20200807
{
    public class QueryReadableResourcesListByUserIdRequest : RpcAcsRequest<QueryReadableResourcesListByUserIdResponse>
    {
        public QueryReadableResourcesListByUserIdRequest()
            : base("quickbi-public", "2020-08-07", "QueryReadableResourcesListByUserId", "quickbi", "openAPI")
        {
        ...
        public override QueryReadableResourcesListByUserIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryReadableResourcesListByUserIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
