...
{
    public class QueryWorksByOrganizationRequest : RpcAcsRequest<QueryWorksByOrganizationResponse>
    {
        public QueryWorksByOrganizationRequest()
            : base("quickbi-public", "2020-08-07", "QueryWorksByOrganization", "quickbi", "openAPI")
        {
        ...
        public override QueryWorksByOrganizationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryWorksByOrganizationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
