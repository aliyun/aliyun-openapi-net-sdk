...
{
    public class CheckReadableRequest : RpcAcsRequest<CheckReadableResponse>
    {
        public CheckReadableRequest()
            : base("quickbi-public", "2020-08-07", "CheckReadable", "quickbi", "openAPI")
        {
        ...
        public override CheckReadableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckReadableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
