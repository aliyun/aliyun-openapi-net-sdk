...
namespace Aliyun.Acs.quickbi_public.Model.V20200807
{
    public class QueryEmbeddedInfoRequest : RpcAcsRequest<QueryEmbeddedInfoResponse>
    {
        public QueryEmbeddedInfoRequest()
            : base("quickbi-public", "2020-08-07", "QueryEmbeddedInfo", "quickbi", "openAPI")
        {
        ...
        public override QueryEmbeddedInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryEmbeddedInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
