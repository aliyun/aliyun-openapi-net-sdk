...
namespace Aliyun.Acs.quickbi_public.Model.V20201111
{
    public class QueryDatasetSwitchInfoRequest : RpcAcsRequest<QueryDatasetSwitchInfoResponse>
    {
        public QueryDatasetSwitchInfoRequest()
            : base("quickbi-public", "2020-11-11", "QueryDatasetSwitchInfo", "quickbi", "openAPI")
        {
        ...
        public override QueryDatasetSwitchInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryDatasetSwitchInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
