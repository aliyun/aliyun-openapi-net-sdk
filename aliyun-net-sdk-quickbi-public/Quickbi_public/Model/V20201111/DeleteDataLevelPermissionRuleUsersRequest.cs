...
namespace Aliyun.Acs.quickbi_public.Model.V20201111
{
    public class DeleteDataLevelPermissionRuleUsersRequest : RpcAcsRequest<DeleteDataLevelPermissionRuleUsersResponse>
    {
        public DeleteDataLevelPermissionRuleUsersRequest()
            : base("quickbi-public", "2020-11-11", "DeleteDataLevelPermissionRuleUsers", "quickbi", "openAPI")
        {
		...
		public string DeleteUserModel
		{
			...
			set	
			{
				deleteUserModel = value;
				DictionaryUtil.Add(QueryParameters, "DeleteUserModel", value);
			}
		}
        ...
        public override DeleteDataLevelPermissionRuleUsersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDataLevelPermissionRuleUsersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
