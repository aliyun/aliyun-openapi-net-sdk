...
namespace Aliyun.Acs.quickbi_public.Transform.V20200807
{
    ...
    {
        public static QueryEmbeddedStausResponse Unmarshall(UnmarshallerContext _ctx)
        {
			QueryEmbeddedStausResponse queryEmbeddedStausResponse = new QueryEmbeddedStausResponse();
