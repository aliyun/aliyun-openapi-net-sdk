...
{
    public class DisableNfsAclRequest : RpcAcsRequest<DisableNfsAclResponse>
    {
        public DisableNfsAclRequest()
            : base("NAS", "2017-06-26", "DisableNfsAcl", "nas", "openAPI")
        {
        ...
        public override DisableNfsAclResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableNfsAclResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
