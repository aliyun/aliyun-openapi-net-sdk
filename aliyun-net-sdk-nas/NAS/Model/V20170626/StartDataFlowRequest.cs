...
{
    public class StartDataFlowRequest : RpcAcsRequest<StartDataFlowResponse>
    {
        public StartDataFlowRequest()
            : base("NAS", "2017-06-26", "StartDataFlow", "NAS", "openAPI")
        {
        ...
        public override StartDataFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartDataFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
