...
{
    public class StopDataFlowRequest : RpcAcsRequest<StopDataFlowResponse>
    {
        public StopDataFlowRequest()
            : base("NAS", "2017-06-26", "StopDataFlow", "nas", "openAPI")
        {
        ...
        public override StopDataFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDataFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
