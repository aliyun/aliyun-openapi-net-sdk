...
{
    public class CreateRecycleBinDeleteJobRequest : RpcAcsRequest<CreateRecycleBinDeleteJobResponse>
    {
        public CreateRecycleBinDeleteJobRequest()
            : base("NAS", "2017-06-26", "CreateRecycleBinDeleteJob", "nas", "openAPI")
        {
        ...
        public override CreateRecycleBinDeleteJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRecycleBinDeleteJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
