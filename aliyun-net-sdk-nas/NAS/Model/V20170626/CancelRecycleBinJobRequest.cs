...
{
    public class CancelRecycleBinJobRequest : RpcAcsRequest<CancelRecycleBinJobResponse>
    {
        public CancelRecycleBinJobRequest()
            : base("NAS", "2017-06-26", "CancelRecycleBinJob", "nas", "openAPI")
        {
        ...
        public override CancelRecycleBinJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelRecycleBinJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
