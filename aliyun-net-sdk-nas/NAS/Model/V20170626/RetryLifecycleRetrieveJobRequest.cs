...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class RetryLifecycleRetrieveJobRequest : RpcAcsRequest<RetryLifecycleRetrieveJobResponse>
    {
        ...
        public override RetryLifecycleRetrieveJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RetryLifecycleRetrieveJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
