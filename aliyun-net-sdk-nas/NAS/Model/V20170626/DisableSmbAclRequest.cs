...
{
    public class DisableSmbAclRequest : RpcAcsRequest<DisableSmbAclResponse>
    {
        public DisableSmbAclRequest()
            : base("NAS", "2017-06-26", "DisableSmbAcl", "NAS", "openAPI")
        {
        ...
        public override DisableSmbAclResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableSmbAclResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
