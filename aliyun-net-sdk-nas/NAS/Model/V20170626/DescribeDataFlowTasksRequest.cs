...
{
    public class DescribeDataFlowTasksRequest : RpcAcsRequest<DescribeDataFlowTasksResponse>
    {
        public DescribeDataFlowTasksRequest()
            : base("NAS", "2017-06-26", "DescribeDataFlowTasks", "NAS", "openAPI")
        {
        ...
        public override DescribeDataFlowTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataFlowTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
