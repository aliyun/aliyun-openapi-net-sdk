...
{
    public class ListRecycledDirectoriesAndFilesRequest : RpcAcsRequest<ListRecycledDirectoriesAndFilesResponse>
    {
        public ListRecycledDirectoriesAndFilesRequest()
            : base("NAS", "2017-06-26", "ListRecycledDirectoriesAndFiles", "nas", "openAPI")
        {
        ...
        public override ListRecycledDirectoriesAndFilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRecycledDirectoriesAndFilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
