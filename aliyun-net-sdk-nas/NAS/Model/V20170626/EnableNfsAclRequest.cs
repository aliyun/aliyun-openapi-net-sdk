...
{
    public class EnableNfsAclRequest : RpcAcsRequest<EnableNfsAclResponse>
    {
        public EnableNfsAclRequest()
            : base("NAS", "2017-06-26", "EnableNfsAcl", "nas", "openAPI")
        {
        ...
        public override EnableNfsAclResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableNfsAclResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
