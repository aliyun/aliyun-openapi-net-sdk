...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class ModifyFilesetRequest : RpcAcsRequest<ModifyFilesetResponse>
    {
        ...
        public override ModifyFilesetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFilesetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
