...
{
    public class DescribeLogAnalysisRequest : RpcAcsRequest<DescribeLogAnalysisResponse>
    {
        public DescribeLogAnalysisRequest()
            : base("NAS", "2017-06-26", "DescribeLogAnalysis", "nas", "openAPI")
        {
        ...
        public override DescribeLogAnalysisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLogAnalysisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
