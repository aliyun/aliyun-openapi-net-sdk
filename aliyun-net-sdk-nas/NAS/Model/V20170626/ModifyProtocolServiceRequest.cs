...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class ModifyProtocolServiceRequest : RpcAcsRequest<ModifyProtocolServiceResponse>
    {
        ...
        public override ModifyProtocolServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyProtocolServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
