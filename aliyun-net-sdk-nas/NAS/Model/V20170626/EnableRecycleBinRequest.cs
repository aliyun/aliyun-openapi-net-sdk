...
{
    public class EnableRecycleBinRequest : RpcAcsRequest<EnableRecycleBinResponse>
    {
        public EnableRecycleBinRequest()
            : base("NAS", "2017-06-26", "EnableRecycleBin", "nas", "openAPI")
        {
		...
		public long? ReservedDays
		{
			...
			{
				reservedDays = value;
				DictionaryUtil.Add(QueryParameters, "ReservedDays", value.ToString());
			}
		}
        ...
        public override EnableRecycleBinResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableRecycleBinResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
