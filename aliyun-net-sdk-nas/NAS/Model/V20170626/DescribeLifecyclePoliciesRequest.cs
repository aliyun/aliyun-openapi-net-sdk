...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class DescribeLifecyclePoliciesRequest : RpcAcsRequest<DescribeLifecyclePoliciesResponse>
    {
        ...
        public override DescribeLifecyclePoliciesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLifecyclePoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
