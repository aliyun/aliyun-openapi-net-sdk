...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class CancelDataFlowAutoRefreshRequest : RpcAcsRequest<CancelDataFlowAutoRefreshResponse>
    {
		...
		public string RefreshPath
		{
			...
			{
				refreshPath = value;
				DictionaryUtil.Add(QueryParameters, "RefreshPath", value);
			}
		}
        ...
        public override CancelDataFlowAutoRefreshResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelDataFlowAutoRefreshResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
