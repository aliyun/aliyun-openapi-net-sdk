...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class EnableSmbAclRequest : RpcAcsRequest<EnableSmbAclResponse>
    {
        ...
        public override EnableSmbAclResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableSmbAclResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
