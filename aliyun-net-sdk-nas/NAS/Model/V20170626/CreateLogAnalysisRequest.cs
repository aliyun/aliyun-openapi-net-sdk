...
{
    public class CreateLogAnalysisRequest : RpcAcsRequest<CreateLogAnalysisResponse>
    {
        public CreateLogAnalysisRequest()
            : base("NAS", "2017-06-26", "CreateLogAnalysis", "nas", "openAPI")
        {
        ...
        public override CreateLogAnalysisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLogAnalysisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
