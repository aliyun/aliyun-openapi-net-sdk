...
{
    public class DescribeDirQuotasRequest : RpcAcsRequest<DescribeDirQuotasResponse>
    {
        public DescribeDirQuotasRequest()
            : base("NAS", "2017-06-26", "DescribeDirQuotas", "nas", "openAPI")
        {
        ...
        public override DescribeDirQuotasResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDirQuotasResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
