...
{
    public class DescribeProtocolServiceRequest : RpcAcsRequest<DescribeProtocolServiceResponse>
    {
        public DescribeProtocolServiceRequest()
            : base("NAS", "2017-06-26", "DescribeProtocolService", "nas", "openAPI")
        {
		...
		public string ProtocolServiceIds
		{
			...
			set	
			{
				protocolServiceIds = value;
				DictionaryUtil.Add(QueryParameters, "ProtocolServiceIds", value);
			}
		}
        ...
        public override DescribeProtocolServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProtocolServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
