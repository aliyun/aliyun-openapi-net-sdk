...
{
    public class DescribeSmbAclRequest : RpcAcsRequest<DescribeSmbAclResponse>
    {
        public DescribeSmbAclRequest()
            : base("NAS", "2017-06-26", "DescribeSmbAcl", "NAS", "openAPI")
        {
        ...
        public override DescribeSmbAclResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSmbAclResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
