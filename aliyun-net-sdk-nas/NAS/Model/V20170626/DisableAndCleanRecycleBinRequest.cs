...
{
    public class DisableAndCleanRecycleBinRequest : RpcAcsRequest<DisableAndCleanRecycleBinResponse>
    {
        public DisableAndCleanRecycleBinRequest()
            : base("NAS", "2017-06-26", "DisableAndCleanRecycleBin", "nas", "openAPI")
        {
        ...
        public override DisableAndCleanRecycleBinResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableAndCleanRecycleBinResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
