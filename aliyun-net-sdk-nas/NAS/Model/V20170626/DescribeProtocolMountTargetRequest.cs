...
{
    public class DescribeProtocolMountTargetRequest : RpcAcsRequest<DescribeProtocolMountTargetResponse>
    {
        public DescribeProtocolMountTargetRequest()
            : base("NAS", "2017-06-26", "DescribeProtocolMountTarget", "nas", "openAPI")
        {
        ...
        public override DescribeProtocolMountTargetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeProtocolMountTargetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
