...
{
    public class DeleteLifecyclePolicyRequest : RpcAcsRequest<DeleteLifecyclePolicyResponse>
    {
        public DeleteLifecyclePolicyRequest()
            : base("NAS", "2017-06-26", "DeleteLifecyclePolicy", "NAS", "openAPI")
        {
        ...
        public override DeleteLifecyclePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteLifecyclePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
