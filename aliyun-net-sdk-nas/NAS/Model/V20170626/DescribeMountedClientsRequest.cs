...
{
    public class DescribeMountedClientsRequest : RpcAcsRequest<DescribeMountedClientsResponse>
    {
        public DescribeMountedClientsRequest()
            : base("NAS", "2017-06-26", "DescribeMountedClients", "NAS", "openAPI")
        {
        ...
        public override DescribeMountedClientsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMountedClientsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
