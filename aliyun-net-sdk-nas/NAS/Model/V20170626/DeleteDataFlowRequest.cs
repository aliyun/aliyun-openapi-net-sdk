...
{
    public class DeleteDataFlowRequest : RpcAcsRequest<DeleteDataFlowResponse>
    {
        public DeleteDataFlowRequest()
            : base("NAS", "2017-06-26", "DeleteDataFlow", "NAS", "openAPI")
        {
        ...
        public override DeleteDataFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDataFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
