...
{
    public class DescribeDataFlowsRequest : RpcAcsRequest<DescribeDataFlowsResponse>
    {
        public DescribeDataFlowsRequest()
            : base("NAS", "2017-06-26", "DescribeDataFlows", "NAS", "openAPI")
        {
        ...
        public override DescribeDataFlowsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataFlowsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
