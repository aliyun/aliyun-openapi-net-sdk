...
{
    public class ModifyDataFlowRequest : RpcAcsRequest<ModifyDataFlowResponse>
    {
        public ModifyDataFlowRequest()
            : base("NAS", "2017-06-26", "ModifyDataFlow", "NAS", "openAPI")
        {
        ...
        public override ModifyDataFlowResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDataFlowResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
