...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class CreateLifecycleRetrieveJobRequest : RpcAcsRequest<CreateLifecycleRetrieveJobResponse>
    {
        ...
        public override CreateLifecycleRetrieveJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateLifecycleRetrieveJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
