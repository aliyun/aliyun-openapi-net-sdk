...
{
    public class GetRecycleBinAttributeRequest : RpcAcsRequest<GetRecycleBinAttributeResponse>
    {
        public GetRecycleBinAttributeRequest()
            : base("NAS", "2017-06-26", "GetRecycleBinAttribute", "nas", "openAPI")
        {
        ...
        public override GetRecycleBinAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetRecycleBinAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
