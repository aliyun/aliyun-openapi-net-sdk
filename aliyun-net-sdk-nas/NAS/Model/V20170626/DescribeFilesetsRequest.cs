...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class DescribeFilesetsRequest : RpcAcsRequest<DescribeFilesetsResponse>
    {
        ...
        public override DescribeFilesetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeFilesetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
