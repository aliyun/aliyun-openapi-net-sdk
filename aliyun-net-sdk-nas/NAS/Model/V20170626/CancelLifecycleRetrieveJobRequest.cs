...
{
    public class CancelLifecycleRetrieveJobRequest : RpcAcsRequest<CancelLifecycleRetrieveJobResponse>
    {
        public CancelLifecycleRetrieveJobRequest()
            : base("NAS", "2017-06-26", "CancelLifecycleRetrieveJob", "NAS", "openAPI")
        {
        ...
        public override CancelLifecycleRetrieveJobResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelLifecycleRetrieveJobResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
