...
{
    public class ListDirectoriesAndFilesRequest : RpcAcsRequest<ListDirectoriesAndFilesResponse>
    {
        public ListDirectoriesAndFilesRequest()
            : base("NAS", "2017-06-26", "ListDirectoriesAndFiles", "NAS", "openAPI")
        {
		...
		public bool? DirectoryOnly
		{
			...
			{
				directoryOnly = value;
				DictionaryUtil.Add(QueryParameters, "DirectoryOnly", value.ToString());
			}
		}
        ...
        public override ListDirectoriesAndFilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDirectoriesAndFilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
