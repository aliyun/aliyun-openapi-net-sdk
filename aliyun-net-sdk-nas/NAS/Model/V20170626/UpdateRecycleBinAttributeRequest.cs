...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class UpdateRecycleBinAttributeRequest : RpcAcsRequest<UpdateRecycleBinAttributeResponse>
    {
        ...
        public override UpdateRecycleBinAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateRecycleBinAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
