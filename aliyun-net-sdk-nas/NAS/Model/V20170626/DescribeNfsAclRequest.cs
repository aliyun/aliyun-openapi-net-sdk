...
{
    public class DescribeNfsAclRequest : RpcAcsRequest<DescribeNfsAclResponse>
    {
        public DescribeNfsAclRequest()
            : base("NAS", "2017-06-26", "DescribeNfsAcl", "nas", "openAPI")
        {
        ...
        public override DescribeNfsAclResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNfsAclResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
