...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class ApplyDataFlowAutoRefreshRequest : RpcAcsRequest<ApplyDataFlowAutoRefreshResponse>
    {
        ...
        public override ApplyDataFlowAutoRefreshResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ApplyDataFlowAutoRefreshResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
