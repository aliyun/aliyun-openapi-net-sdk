...
{
    public class DeleteAccessPointRequest : RpcAcsRequest<DeleteAccessPointResponse>
    {
        public DeleteAccessPointRequest()
            : base("NAS", "2017-06-26", "DeleteAccessPoint", "nas", "openAPI")
        {
        ...
        public override DeleteAccessPointResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAccessPointResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
