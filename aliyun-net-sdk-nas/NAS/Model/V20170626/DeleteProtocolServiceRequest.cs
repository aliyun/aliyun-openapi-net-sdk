...
{
    public class DeleteProtocolServiceRequest : RpcAcsRequest<DeleteProtocolServiceResponse>
    {
        public DeleteProtocolServiceRequest()
            : base("NAS", "2017-06-26", "DeleteProtocolService", "NAS", "openAPI")
        {
        ...
        public override DeleteProtocolServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteProtocolServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
