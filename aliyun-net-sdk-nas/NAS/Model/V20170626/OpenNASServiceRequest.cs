...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class OpenNASServiceRequest : RpcAcsRequest<OpenNASServiceResponse>
    {
        ...
        public override OpenNASServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenNASServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
