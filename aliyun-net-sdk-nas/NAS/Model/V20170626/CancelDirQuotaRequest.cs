...
namespace Aliyun.Acs.NAS.Model.V20170626
{
    public class CancelDirQuotaRequest : RpcAcsRequest<CancelDirQuotaResponse>
    {
        ...
        public override CancelDirQuotaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelDirQuotaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
