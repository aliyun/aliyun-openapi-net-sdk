...
{
    public class CreateProtocolServiceRequest : RpcAcsRequest<CreateProtocolServiceResponse>
    {
        public CreateProtocolServiceRequest()
            : base("NAS", "2017-06-26", "CreateProtocolService", "nas", "openAPI")
        {
		...
		public string ProtocolSpec
		{
			...
			{
				protocolSpec = value;
				DictionaryUtil.Add(QueryParameters, "ProtocolSpec", value);
			}
		}
        ...
        public override CreateProtocolServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateProtocolServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
