...
{
    public class DescribeAccessPointRequest : RpcAcsRequest<DescribeAccessPointResponse>
    {
        public DescribeAccessPointRequest()
            : base("NAS", "2017-06-26", "DescribeAccessPoint", "nas", "openAPI")
        {
        ...
        public override DescribeAccessPointResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAccessPointResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
