...
{
    public class DescribeDataFlowSubTasksRequest : RpcAcsRequest<DescribeDataFlowSubTasksResponse>
    {
        public DescribeDataFlowSubTasksRequest()
            : base("NAS", "2017-06-26", "DescribeDataFlowSubTasks", "nas", "openAPI")
        {
        ...
        public override DescribeDataFlowSubTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDataFlowSubTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
