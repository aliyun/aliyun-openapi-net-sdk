...
{
    public class DeleteFilesetRequest : RpcAcsRequest<DeleteFilesetResponse>
    {
        public DeleteFilesetRequest()
            : base("NAS", "2017-06-26", "DeleteFileset", "nas", "openAPI")
        {
        ...
        public override DeleteFilesetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteFilesetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
