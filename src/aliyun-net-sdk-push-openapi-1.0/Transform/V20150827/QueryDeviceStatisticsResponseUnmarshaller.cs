    ...
    public class QueryDeviceStatisticsResponseUnmarshaller
    {
        public static QueryDeviceStatisticsResponse Unmarshall(UnmarshallerContext context)
        {
            QueryDeviceStatisticsResponse queryDeviceStatisticsResponse = new QueryDeviceStatisticsResponse()
            {
                ...
                RequestId = context.StringValue("QueryDeviceStatistics.RequestId")
            };
			...
			for (int i = 0; i < context.Length("QueryDeviceStatistics.PushDeviceStatisticsInfos.Length"); i++) {
                ...
                {
                    Date = context.StringValue($"QueryDeviceStatistics.PushDeviceStatisticsInfos[{i}].Date"),
                    DeviceType = context.IntegerValue($"QueryDeviceStatistics.PushDeviceStatisticsInfos[{i}].DeviceType"),
                    Count = context.IntegerValue($"QueryDeviceStatistics.PushDeviceStatisticsInfos[{i}].Count")
                };
