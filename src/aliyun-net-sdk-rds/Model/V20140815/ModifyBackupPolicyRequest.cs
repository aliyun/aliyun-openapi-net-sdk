...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class ModifyBackupPolicyRequest : RpcAcsRequest<ModifyBackupPolicyResponse>
    {
        public ModifyBackupPolicyRequest()
            : base("Rds", "2014-08-15", "ModifyBackupPolicy")
        {
        }
		...
		private string _preferredBackupTime;

		private string _preferredBackupPeriod;

		private string _backupRetentionPeriod;

		private string _backupLog;
