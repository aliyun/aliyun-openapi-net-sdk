    ...
    public class StartDBInstanceDiagnoseResponseUnmarshaller
    {
        public static StartDBInstanceDiagnoseResponse Unmarshall(UnmarshallerContext context)
        {
            StartDBInstanceDiagnoseResponse startDBInstanceDiagnoseResponse = new StartDBInstanceDiagnoseResponse()
            {
                ...
                RequestId = context.StringValue("StartDBInstanceDiagnose.RequestId"),
                DBInstanceName = context.StringValue("StartDBInstanceDiagnose.DBInstanceName"),
                DBInstanceId = context.StringValue("StartDBInstanceDiagnose.DBInstanceId")
            };
