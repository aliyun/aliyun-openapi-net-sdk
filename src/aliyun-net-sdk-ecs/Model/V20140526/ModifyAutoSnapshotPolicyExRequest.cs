...
namespace Aliyun.Acs.Ecs.Model.V20140526
{
    public class ModifyAutoSnapshotPolicyExRequest : RpcAcsRequest<ModifyAutoSnapshotPolicyExResponse>
    {
		...
		private string _autoSnapshotPolicyId;

		private string _autoSnapshotPolicyName;

		private string _timePoints;
		...
		public string AutoSnapshotPolicyName
		{
			get
			{
				return _autoSnapshotPolicyName;
			}
			set	
			{
