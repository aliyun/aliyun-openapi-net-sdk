    ...
    public class DescribeResourceByTagsResponseUnmarshaller
    {
        public static DescribeResourceByTagsResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeResourceByTagsResponse describeResourceByTagsResponse = new DescribeResourceByTagsResponse()
            {
                ...
                RequestId = context.StringValue("DescribeResourceByTags.RequestId"),
                PageSize = context.IntegerValue("DescribeResourceByTags.PageSize"),
                PageNumber = context.IntegerValue("DescribeResourceByTags.PageNumber"),
                TotalCount = context.IntegerValue("DescribeResourceByTags.TotalCount")
            };
			...
			for (int i = 0; i < context.Length("DescribeResourceByTags.Resources.Length"); i++) {
                ...
                {
                    ResourceId = context.StringValue($"DescribeResourceByTags.Resources[{i}].ResourceId"),
                    ResourceType = context.StringValue($"DescribeResourceByTags.Resources[{i}].ResourceType"),
                    RegionId = context.StringValue($"DescribeResourceByTags.Resources[{i}].RegionId")
                };
