    ...
    public class DescribeTagKeysResponseUnmarshaller
    {
        public static DescribeTagKeysResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeTagKeysResponse describeTagKeysResponse = new DescribeTagKeysResponse()
            {
                ...
                RequestId = context.StringValue("DescribeTagKeys.RequestId"),
                PageSize = context.IntegerValue("DescribeTagKeys.PageSize"),
                PageNumber = context.IntegerValue("DescribeTagKeys.PageNumber"),
                TotalCount = context.IntegerValue("DescribeTagKeys.TotalCount")
            };
