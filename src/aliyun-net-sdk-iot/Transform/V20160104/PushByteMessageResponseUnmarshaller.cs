    ...
    public class PushByteMessageResponseUnmarshaller
    {
        public static PushByteMessageResponse Unmarshall(UnmarshallerContext context)
        {
            PushByteMessageResponse pushByteMessageResponse = new PushByteMessageResponse()
            {
                ...
                RequestId = context.StringValue("PushByteMessage.RequestId"),
                Success = context.BooleanValue("PushByteMessage.Success"),
                ErrorMessage = context.StringValue("PushByteMessage.ErrorMessage"),
                MessageId = context.StringValue("PushByteMessage.MessageId")
            };
