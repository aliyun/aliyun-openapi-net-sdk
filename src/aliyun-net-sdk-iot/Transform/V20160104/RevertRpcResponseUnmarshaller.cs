    ...
    public class RevertRpcResponseUnmarshaller
    {
        public static RevertRpcResponse Unmarshall(UnmarshallerContext context)
        {
            RevertRpcResponse revertRpcResponse = new RevertRpcResponse()
            {
                ...
                RequestId = context.StringValue("RevertRpc.RequestId"),
                Success = context.BooleanValue("RevertRpc.Success"),
                Rpccode = context.StringValue("RevertRpc.Rpccode"),
                ResponseContent = context.StringValue("RevertRpc.ResponseContent"),
                ErrorMessage = context.StringValue("RevertRpc.ErrorMessage")
            };
