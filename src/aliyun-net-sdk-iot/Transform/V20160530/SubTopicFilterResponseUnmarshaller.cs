    ...
    public class SubTopicFilterResponseUnmarshaller
    {
        public static SubTopicFilterResponse Unmarshall(UnmarshallerContext context)
        {
            SubTopicFilterResponse subTopicFilterResponse = new SubTopicFilterResponse()
            {
                ...
                RequestId = context.StringValue("SubTopicFilter.RequestId"),
                Success = context.BooleanValue("SubTopicFilter.Success"),
                ErrorMessage = context.StringValue("SubTopicFilter.ErrorMessage")
            };
