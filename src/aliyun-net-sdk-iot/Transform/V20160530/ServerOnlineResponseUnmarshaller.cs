    ...
    public class ServerOnlineResponseUnmarshaller
    {
        public static ServerOnlineResponse Unmarshall(UnmarshallerContext context)
        {
            ServerOnlineResponse serverOnlineResponse = new ServerOnlineResponse()
            {
                ...
                RequestId = context.StringValue("ServerOnline.RequestId"),
                Success = context.BooleanValue("ServerOnline.Success"),
                ErrorMessage = context.StringValue("ServerOnline.ErrorMessage")
            };
