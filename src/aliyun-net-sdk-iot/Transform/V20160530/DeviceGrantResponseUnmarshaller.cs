    ...
    public class DeviceGrantResponseUnmarshaller
    {
        public static DeviceGrantResponse Unmarshall(UnmarshallerContext context)
        {
            DeviceGrantResponse deviceGrantResponse = new DeviceGrantResponse()
            {
                ...
                RequestId = context.StringValue("DeviceGrant.RequestId"),
                Success = context.BooleanValue("DeviceGrant.Success"),
                Id = context.LongValue("DeviceGrant.Id"),
                ErrorMessage = context.StringValue("DeviceGrant.ErrorMessage")
            };
