    ...
    public class QueryApplyStatusResponseUnmarshaller
    {
        public static QueryApplyStatusResponse Unmarshall(UnmarshallerContext context)
        {
            QueryApplyStatusResponse queryApplyStatusResponse = new QueryApplyStatusResponse()
            {
                ...
                RequestId = context.StringValue("QueryApplyStatus.RequestId"),
                Success = context.BooleanValue("QueryApplyStatus.Success"),
                ErrorMessage = context.StringValue("QueryApplyStatus.ErrorMessage"),
                Finish = context.BooleanValue("QueryApplyStatus.Finish")
            };
