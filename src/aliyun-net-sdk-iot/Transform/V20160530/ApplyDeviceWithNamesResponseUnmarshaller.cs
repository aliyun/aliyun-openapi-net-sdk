    ...
    public class ApplyDeviceWithNamesResponseUnmarshaller
    {
        public static ApplyDeviceWithNamesResponse Unmarshall(UnmarshallerContext context)
        {
            ApplyDeviceWithNamesResponse applyDeviceWithNamesResponse = new ApplyDeviceWithNamesResponse()
            {
                ...
                RequestId = context.StringValue("ApplyDeviceWithNames.RequestId"),
                Success = context.BooleanValue("ApplyDeviceWithNames.Success"),
                ErrorMessage = context.StringValue("ApplyDeviceWithNames.ErrorMessage"),
                ApplyId = context.LongValue("ApplyDeviceWithNames.ApplyId")
            };
