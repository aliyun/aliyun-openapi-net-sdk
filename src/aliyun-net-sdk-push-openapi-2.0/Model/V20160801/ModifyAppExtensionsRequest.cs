...
namespace Aliyun.Acs.Push.Model.V20160801
{
    public class ModifyAppExtensionsRequest : RpcAcsRequest<ModifyAppExtensionsResponse>
    {
		...
		private string _xmAppSecretKey;

		private string _hwAppKey;

		private string _hwAppSecretKey;
		...
		public string XmAppSecretKey
		{
			get
			{
				return _xmAppSecretKey;
			}
			set	
			{
				_xmAppSecretKey = value;
		...
		public string HwAppSecretKey
		{
			get
			{
				return _hwAppSecretKey;
			}
			set	
			{
				_hwAppSecretKey = value;
