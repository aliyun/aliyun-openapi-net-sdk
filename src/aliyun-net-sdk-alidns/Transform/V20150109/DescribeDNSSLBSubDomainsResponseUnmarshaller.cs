    ...
    public class DescribeDNSSLBSubDomainsResponseUnmarshaller
    {
        public static DescribeDNSSLBSubDomainsResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeDNSSLBSubDomainsResponse describeDNSSLBSubDomainsResponse = new DescribeDNSSLBSubDomainsResponse
            {
                ...
                RequestId = context.StringValue("DescribeDNSSLBSubDomains.RequestId"),
                TotalCount = context.LongValue("DescribeDNSSLBSubDomains.TotalCount"),
                PageNumber = context.LongValue("DescribeDNSSLBSubDomains.PageNumber"),
                PageSize = context.LongValue("DescribeDNSSLBSubDomains.PageSize")
            };
			...
			for (int i = 0; i < context.Length("DescribeDNSSLBSubDomains.SlbSubDomains.Length"); i++) {
			    ...
			    {
			        SubDomain = context.StringValue($"DescribeDNSSLBSubDomains.SlbSubDomains[{i}].SubDomain"),
			        RecordCount = context.LongValue($"DescribeDNSSLBSubDomains.SlbSubDomains[{i}].RecordCount"),
			        Open = context.BooleanValue($"DescribeDNSSLBSubDomains.SlbSubDomains[{i}].Open")
			    };
