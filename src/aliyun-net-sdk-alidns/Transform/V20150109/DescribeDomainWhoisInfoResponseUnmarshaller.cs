    ...
    public class DescribeDomainWhoisInfoResponseUnmarshaller
    {
        public static DescribeDomainWhoisInfoResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeDomainWhoisInfoResponse describeDomainWhoisInfoResponse = new DescribeDomainWhoisInfoResponse
            {
                ...
                RequestId = context.StringValue("DescribeDomainWhoisInfo.RequestId"),
                RegistrantName = context.StringValue("DescribeDomainWhoisInfo.RegistrantName"),
                RegistrantEmail = context.StringValue("DescribeDomainWhoisInfo.RegistrantEmail"),
                Registrar = context.StringValue("DescribeDomainWhoisInfo.Registrar"),
                RegistrationDate = context.StringValue("DescribeDomainWhoisInfo.RegistrationDate"),
                ExpirationDate = context.StringValue("DescribeDomainWhoisInfo.ExpirationDate")
            };
