...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class AddListenerWhiteListItemRequest : RpcAcsRequest<AddListenerWhiteListItemResponse>
    {
        public AddListenerWhiteListItemRequest()
            : base("Slb", "2014-05-15", "AddListenerWhiteListItem")
        {
        }
        ...
        public override AddListenerWhiteListItemResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
