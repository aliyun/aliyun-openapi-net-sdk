...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class ModifyVServerGroupBackendServersRequest : RpcAcsRequest<ModifyVServerGroupBackendServersResponse>
    {
		...
		private string _oldBackendServers;

		private string _newBackendServers;
		...
		public string OldBackendServers
		{
			get
			{
				return _oldBackendServers;
			}
			set	
			{
				_oldBackendServers = value;
		...
		public string NewBackendServers
		{
			get
			{
				return _newBackendServers;
			}
			set	
			{
				_newBackendServers = value;
