    ...
    public class DescribeServerCertificatesResponseUnmarshaller
    {
        public static DescribeServerCertificatesResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeServerCertificatesResponse describeServerCertificatesResponse = new DescribeServerCertificatesResponse()
            {
                ...
                RequestId = context.StringValue("DescribeServerCertificates.RequestId")
            };
			...
			for (int i = 0; i < context.Length("DescribeServerCertificates.ServerCertificates.Length"); i++) {
                ...
                {
                    ServerCertificateId = context.StringValue($"DescribeServerCertificates.ServerCertificates[{i}].ServerCertificateId"),
                    Fingerprint = context.StringValue($"DescribeServerCertificates.ServerCertificates[{i}].Fingerprint"),
                    ServerCertificateName = context.StringValue($"DescribeServerCertificates.ServerCertificates[{i}].ServerCertificateName"),
                    RegionId = context.StringValue($"DescribeServerCertificates.ServerCertificates[{i}].RegionId"),
                    RegionIdAlias = context.StringValue($"DescribeServerCertificates.ServerCertificates[{i}].RegionIdAlias")
                };
