...
namespace Aliyun.Acs.Cdn.Model.V20141111
{
    public class SetRefererConfigRequest : RpcAcsRequest<SetRefererConfigResponse>
    {
		...
		private string _referList;

		private string _allowEmpty;
        ...
        public override SetRefererConfigResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
