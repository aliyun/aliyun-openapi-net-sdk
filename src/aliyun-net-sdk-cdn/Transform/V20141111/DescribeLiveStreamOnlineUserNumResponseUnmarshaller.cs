    ...
    public class DescribeLiveStreamOnlineUserNumResponseUnmarshaller
    {
        public static DescribeLiveStreamOnlineUserNumResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeLiveStreamOnlineUserNumResponse describeLiveStreamOnlineUserNumResponse = new DescribeLiveStreamOnlineUserNumResponse()
            {
                ...
                RequestId = context.StringValue("DescribeLiveStreamOnlineUserNum.RequestId"),
                TotalUserNumber = context.LongValue("DescribeLiveStreamOnlineUserNum.TotalUserNumber")
            };
			...
			for (int i = 0; i < context.Length("DescribeLiveStreamOnlineUserNum.OnlineUserInfo.Length"); i++) {
                ...
                {
                    StreamUrl = context.StringValue($"DescribeLiveStreamOnlineUserNum.OnlineUserInfo[{i}].StreamUrl"),
                    UserNumber = context.LongValue($"DescribeLiveStreamOnlineUserNum.OnlineUserInfo[{i}].UserNumber"),
                    Time = context.StringValue($"DescribeLiveStreamOnlineUserNum.OnlineUserInfo[{i}].Time")
                };
