    ...
    public class DescribeDomainTopReferVisitResponseUnmarshaller
    {
        public static DescribeDomainTopReferVisitResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeDomainTopReferVisitResponse describeDomainTopReferVisitResponse = new DescribeDomainTopReferVisitResponse()
            {
                ...
                RequestId = context.StringValue("DescribeDomainTopReferVisit.RequestId"),
                DomainName = context.StringValue("DescribeDomainTopReferVisit.DomainName"),
                StartTime = context.StringValue("DescribeDomainTopReferVisit.StartTime")
            };
			...
			for (int i = 0; i < context.Length("DescribeDomainTopReferVisit.TopReferList.Length"); i++) {
                ...
                {
                    ReferDetail = context.StringValue($"DescribeDomainTopReferVisit.TopReferList[{i}].ReferDetail"),
                    VisitData = context.StringValue($"DescribeDomainTopReferVisit.TopReferList[{i}].VisitData"),
                    VisitProportion = context.FloatValue($"DescribeDomainTopReferVisit.TopReferList[{i}].VisitProportion"),
                    Flow = context.StringValue($"DescribeDomainTopReferVisit.TopReferList[{i}].Flow"),
                    FlowProportion = context.FloatValue($"DescribeDomainTopReferVisit.TopReferList[{i}].FlowProportion")
                };
