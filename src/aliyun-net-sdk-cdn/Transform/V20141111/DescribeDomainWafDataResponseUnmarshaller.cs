    ...
    public class DescribeDomainWafDataResponseUnmarshaller
    {
        public static DescribeDomainWafDataResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeDomainWafDataResponse describeDomainWafDataResponse = new DescribeDomainWafDataResponse()
            {
                ...
                RequestId = context.StringValue("DescribeDomainWafData.RequestId"),
                DomainName = context.StringValue("DescribeDomainWafData.DomainName"),
                DataInterval = context.StringValue("DescribeDomainWafData.DataInterval"),
                StartTime = context.StringValue("DescribeDomainWafData.StartTime"),
                EndTime = context.StringValue("DescribeDomainWafData.EndTime")
            };
			...
			for (int i = 0; i < context.Length("DescribeDomainWafData.WafDataList.Length"); i++) {
                ...
                {
                    TimeStamp = context.StringValue($"DescribeDomainWafData.WafDataList[{i}].TimeStamp")
                };
