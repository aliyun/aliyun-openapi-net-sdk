    ...
    public class DescribeDomainFileSizeProportionDataResponseUnmarshaller
    {
        public static DescribeDomainFileSizeProportionDataResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeDomainFileSizeProportionDataResponse describeDomainFileSizeProportionDataResponse = new DescribeDomainFileSizeProportionDataResponse()
            {
                ...
                RequestId = context.StringValue("DescribeDomainFileSizeProportionData.RequestId"),
                DomainName = context.StringValue("DescribeDomainFileSizeProportionData.DomainName"),
                DataInterval = context.StringValue("DescribeDomainFileSizeProportionData.DataInterval"),
                StartTime = context.StringValue("DescribeDomainFileSizeProportionData.StartTime"),
                EndTime = context.StringValue("DescribeDomainFileSizeProportionData.EndTime")
            };
			...
			for (int i = 0; i < context.Length("DescribeDomainFileSizeProportionData.FileSizeProportionDataInterval.Length"); i++) {
                ...
                {
                    TimeStamp = context.StringValue($"DescribeDomainFileSizeProportionData.FileSizeProportionDataInterval[{i}].TimeStamp")
                };
				...
				for (int j = 0; j < context.Length($"DescribeDomainFileSizeProportionData.FileSizeProportionDataInterval[{i}].Value.Length"); j++) {
                    ...
                    {
                        FileSize = context.StringValue($"DescribeDomainFileSizeProportionData.FileSizeProportionDataInterval[{i}].Value[{j}].FileSize"),
                        Proportion = context.StringValue($"DescribeDomainFileSizeProportionData.FileSizeProportionDataInterval[{i}].Value[{j}].Proportion")
                    };
