    ...
    public class DescribeLiveStreamsFrameRateAndBitRateDataResponseUnmarshaller
    {
        public static DescribeLiveStreamsFrameRateAndBitRateDataResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeLiveStreamsFrameRateAndBitRateDataResponse describeLiveStreamsFrameRateAndBitRateDataResponse = new DescribeLiveStreamsFrameRateAndBitRateDataResponse()
            {
                ...
                RequestId = context.StringValue("DescribeLiveStreamsFrameRateAndBitRateData.RequestId")
            };
			...
			for (int i = 0; i < context.Length("DescribeLiveStreamsFrameRateAndBitRateData.FrameRateAndBitRateInfos.Length"); i++) {
                ...
                {
                    StreamUrl = context.StringValue($"DescribeLiveStreamsFrameRateAndBitRateData.FrameRateAndBitRateInfos[{i}].StreamUrl"),
                    VideoFrameRate = context.FloatValue($"DescribeLiveStreamsFrameRateAndBitRateData.FrameRateAndBitRateInfos[{i}].VideoFrameRate"),
                    AudioFrameRate = context.FloatValue($"DescribeLiveStreamsFrameRateAndBitRateData.FrameRateAndBitRateInfos[{i}].AudioFrameRate"),
                    BitRate = context.FloatValue($"DescribeLiveStreamsFrameRateAndBitRateData.FrameRateAndBitRateInfos[{i}].BitRate"),
                    Time = context.StringValue($"DescribeLiveStreamsFrameRateAndBitRateData.FrameRateAndBitRateInfos[{i}].Time")
                };
