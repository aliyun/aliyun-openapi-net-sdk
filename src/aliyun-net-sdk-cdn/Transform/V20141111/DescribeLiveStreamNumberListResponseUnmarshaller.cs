    ...
    public class DescribeLiveStreamNumberListResponseUnmarshaller
    {
        public static DescribeLiveStreamNumberListResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeLiveStreamNumberListResponse describeLiveStreamNumberListResponse = new DescribeLiveStreamNumberListResponse()
            {
                ...
                RequestId = context.StringValue("DescribeLiveStreamNumberList.RequestId"),
                DomainName = context.StringValue("DescribeLiveStreamNumberList.DomainName")
            };
			...
			for (int i = 0; i < context.Length("DescribeLiveStreamNumberList.StreamNumberInfos.Length"); i++) {
                ...
                {
                    Number = context.IntegerValue($"DescribeLiveStreamNumberList.StreamNumberInfos[{i}].Number"),
                    Time = context.StringValue($"DescribeLiveStreamNumberList.StreamNumberInfos[{i}].Time")
                };
