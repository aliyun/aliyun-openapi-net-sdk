    ...
    public class DescribeDomainTopFileTypeVisitResponseUnmarshaller
    {
        public static DescribeDomainTopFileTypeVisitResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeDomainTopFileTypeVisitResponse describeDomainTopFileTypeVisitResponse = new DescribeDomainTopFileTypeVisitResponse()
            {
                ...
                RequestId = context.StringValue("DescribeDomainTopFileTypeVisit.RequestId"),
                DomainName = context.StringValue("DescribeDomainTopFileTypeVisit.DomainName"),
                StartTime = context.StringValue("DescribeDomainTopFileTypeVisit.StartTime")
            };
			...
			for (int i = 0; i < context.Length("DescribeDomainTopFileTypeVisit.TopFileTypeList.Length"); i++) {
                ...
                {
                    FileTypeDetail = context.StringValue($"DescribeDomainTopFileTypeVisit.TopFileTypeList[{i}].FileTypeDetail"),
                    VisitData = context.StringValue($"DescribeDomainTopFileTypeVisit.TopFileTypeList[{i}].VisitData")
                };
