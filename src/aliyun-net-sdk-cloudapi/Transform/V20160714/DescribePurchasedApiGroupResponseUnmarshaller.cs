    ...
    public class DescribePurchasedApiGroupResponseUnmarshaller
    {
        public static DescribePurchasedApiGroupResponse Unmarshall(UnmarshallerContext context)
        {
            DescribePurchasedApiGroupResponse describePurchasedApiGroupResponse = new DescribePurchasedApiGroupResponse()
            {
                ...
                RequestId = context.StringValue("DescribePurchasedApiGroup.RequestId"),
                GroupId = context.StringValue("DescribePurchasedApiGroup.GroupId"),
                GroupName = context.StringValue("DescribePurchasedApiGroup.GroupName"),
                Description = context.StringValue("DescribePurchasedApiGroup.Description"),
                PurchasedTime = context.StringValue("DescribePurchasedApiGroup.PurchasedTime"),
                RegionId = context.StringValue("DescribePurchasedApiGroup.RegionId"),
                Status = context.StringValue("DescribePurchasedApiGroup.Status")
            };
			...
			for (int i = 0; i < context.Length("DescribePurchasedApiGroup.Domains.Length"); i++) {
                ...
                {
                    DomainName = context.StringValue($"DescribePurchasedApiGroup.Domains[{i}].DomainName")
                };
