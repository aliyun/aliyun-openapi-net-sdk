    ...
    public class DescribeTrafficControlsResponseUnmarshaller
    {
        public static DescribeTrafficControlsResponse Unmarshall(UnmarshallerContext context)
        {
            DescribeTrafficControlsResponse describeTrafficControlsResponse = new DescribeTrafficControlsResponse()
            {
                ...
                RequestId = context.StringValue("DescribeTrafficControls.RequestId"),
                TotalCount = context.IntegerValue("DescribeTrafficControls.TotalCount"),
                PageSize = context.IntegerValue("DescribeTrafficControls.PageSize"),
                PageNumber = context.IntegerValue("DescribeTrafficControls.PageNumber")
            };
			...
			for (int i = 0; i < context.Length("DescribeTrafficControls.TrafficControls.Length"); i++) {
                ...
                {
                    TrafficControlId = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].TrafficControlId"),
                    TrafficControlName = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].TrafficControlName"),
                    Description = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].Description"),
                    TrafficControlUnit = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].TrafficControlUnit"),
                    ApiDefault = context.IntegerValue($"DescribeTrafficControls.TrafficControls[{i}].ApiDefault"),
                    UserDefault = context.IntegerValue($"DescribeTrafficControls.TrafficControls[{i}].UserDefault"),
                    AppDefault = context.IntegerValue($"DescribeTrafficControls.TrafficControls[{i}].AppDefault"),
                    CreatedTime = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].CreatedTime"),
                    ModifiedTime = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].ModifiedTime")
                };
				...
				for (int j = 0; j < context.Length($"DescribeTrafficControls.TrafficControls[{i}].SpecialPolicies.Length"); j++) {
                    ...
                    {
                        SpecialType = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].SpecialPolicies[{j}].SpecialType")
                    };
					...
					for (int k = 0; k < context.Length($"DescribeTrafficControls.TrafficControls[{i}].SpecialPolicies[{j}].Specials.Length"); k++) {
                        ...
                        {
                            SpecialKey = context.StringValue($"DescribeTrafficControls.TrafficControls[{i}].SpecialPolicies[{j}].Specials[" + k + "].SpecialKey"),
                            TrafficValue = context.IntegerValue($"DescribeTrafficControls.TrafficControls[{i}].SpecialPolicies[{j}].Specials[" + k + "].TrafficValue")
                        };
