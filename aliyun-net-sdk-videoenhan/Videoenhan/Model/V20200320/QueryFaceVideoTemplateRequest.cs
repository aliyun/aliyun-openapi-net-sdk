...
{
    public class QueryFaceVideoTemplateRequest : RpcAcsRequest<QueryFaceVideoTemplateResponse>
    {
        public QueryFaceVideoTemplateRequest()
            : base("videoenhan", "2020-03-20", "QueryFaceVideoTemplate", "videoenhan", "openAPI")
        {
        ...
        public override QueryFaceVideoTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryFaceVideoTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
