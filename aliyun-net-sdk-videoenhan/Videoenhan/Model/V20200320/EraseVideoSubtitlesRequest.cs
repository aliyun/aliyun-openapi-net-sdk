...
{
    public class EraseVideoSubtitlesRequest : RpcAcsRequest<EraseVideoSubtitlesResponse>
    {
        public EraseVideoSubtitlesRequest()
            : base("videoenhan", "2020-03-20", "EraseVideoSubtitles", "videoenhan", "openAPI")
        {
        ...
        public override EraseVideoSubtitlesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EraseVideoSubtitlesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
