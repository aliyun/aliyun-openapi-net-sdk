...
{
    public class ConvertHdrVideoRequest : RpcAcsRequest<ConvertHdrVideoResponse>
    {
        public ConvertHdrVideoRequest()
            : base("videoenhan", "2020-03-20", "ConvertHdrVideo", "videoenhan", "openAPI")
        {
        ...
        public override ConvertHdrVideoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConvertHdrVideoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
