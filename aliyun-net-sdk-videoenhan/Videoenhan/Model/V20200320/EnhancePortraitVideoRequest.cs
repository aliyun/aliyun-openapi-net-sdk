...
{
    public class EnhancePortraitVideoRequest : RpcAcsRequest<EnhancePortraitVideoResponse>
    {
        public EnhancePortraitVideoRequest()
            : base("videoenhan", "2020-03-20", "EnhancePortraitVideo", "videoenhan", "openAPI")
        {
        ...
        public override EnhancePortraitVideoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnhancePortraitVideoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
