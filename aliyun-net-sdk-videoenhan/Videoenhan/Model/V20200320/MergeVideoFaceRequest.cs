...
{
    public class MergeVideoFaceRequest : RpcAcsRequest<MergeVideoFaceResponse>
    {
        public MergeVideoFaceRequest()
            : base("videoenhan", "2020-03-20", "MergeVideoFace", "videoenhan", "openAPI")
        {
        ...
        public override MergeVideoFaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MergeVideoFaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
