...
{
    public class InterpolateVideoFrameRequest : RpcAcsRequest<InterpolateVideoFrameResponse>
    {
        public InterpolateVideoFrameRequest()
            : base("videoenhan", "2020-03-20", "InterpolateVideoFrame", "videoenhan", "openAPI")
        {
        ...
        public override InterpolateVideoFrameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InterpolateVideoFrameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
