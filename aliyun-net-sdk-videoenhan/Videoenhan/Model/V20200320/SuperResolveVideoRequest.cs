...
{
    public class SuperResolveVideoRequest : RpcAcsRequest<SuperResolveVideoResponse>
    {
        public SuperResolveVideoRequest()
            : base("videoenhan", "2020-03-20", "SuperResolveVideo", "videoenhan", "openAPI")
        {
        ...
        public override SuperResolveVideoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SuperResolveVideoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
