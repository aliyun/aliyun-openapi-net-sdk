...
{
    public class ToneSdrVideoRequest : RpcAcsRequest<ToneSdrVideoResponse>
    {
        public ToneSdrVideoRequest()
            : base("videoenhan", "2020-03-20", "ToneSdrVideo", "videoenhan", "openAPI")
        {
        ...
        public override ToneSdrVideoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ToneSdrVideoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
