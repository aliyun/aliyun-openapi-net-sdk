...
{
    public class ReduceVideoNoiseRequest : RpcAcsRequest<ReduceVideoNoiseResponse>
    {
        public ReduceVideoNoiseRequest()
            : base("videoenhan", "2020-03-20", "ReduceVideoNoise", "videoenhan", "openAPI")
        {
        ...
        public override ReduceVideoNoiseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReduceVideoNoiseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
