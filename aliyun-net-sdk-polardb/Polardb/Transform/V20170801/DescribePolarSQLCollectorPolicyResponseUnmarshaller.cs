...
namespace Aliyun.Acs.polardb.Transform.V20170801
{
    ...
    {
        public static DescribePolarSQLCollectorPolicyResponse Unmarshall(UnmarshallerContext _ctx)
        {
			DescribePolarSQLCollectorPolicyResponse describePolarSQLCollectorPolicyResponse = new DescribePolarSQLCollectorPolicyResponse();
