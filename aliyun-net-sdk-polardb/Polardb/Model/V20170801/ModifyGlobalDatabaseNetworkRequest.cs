...
{
    public class ModifyGlobalDatabaseNetworkRequest : RpcAcsRequest<ModifyGlobalDatabaseNetworkResponse>
    {
        public ModifyGlobalDatabaseNetworkRequest()
            : base("polardb", "2017-08-01", "ModifyGlobalDatabaseNetwork", "polardb", "openAPI")
        {
        ...
        public override ModifyGlobalDatabaseNetworkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGlobalDatabaseNetworkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
