...
{
    public class ModifyDBNodeHotReplicaModeRequest : RpcAcsRequest<ModifyDBNodeHotReplicaModeResponse>
    {
        public ModifyDBNodeHotReplicaModeRequest()
            : base("polardb", "2017-08-01", "ModifyDBNodeHotReplicaMode", "polardb", "openAPI")
        {
		...
		public string HotReplicaMode
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "HotReplicaMode", value);
			}
		}

        public override ModifyDBNodeHotReplicaModeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBNodeHotReplicaModeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
