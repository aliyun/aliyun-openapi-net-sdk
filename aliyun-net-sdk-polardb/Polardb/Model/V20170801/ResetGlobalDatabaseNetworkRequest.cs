...
{
    public class ResetGlobalDatabaseNetworkRequest : RpcAcsRequest<ResetGlobalDatabaseNetworkResponse>
    {
        public ResetGlobalDatabaseNetworkRequest()
            : base("polardb", "2017-08-01", "ResetGlobalDatabaseNetwork", "polardb", "openAPI")
        {
        ...
        public override ResetGlobalDatabaseNetworkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResetGlobalDatabaseNetworkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
