...
{
    public class DescribeActivationCodeDetailsRequest : RpcAcsRequest<DescribeActivationCodeDetailsResponse>
    {
        public DescribeActivationCodeDetailsRequest()
            : base("polardb", "2017-08-01", "DescribeActivationCodeDetails", "polardb", "openAPI")
        {
		...
		public int? ActivationCodeId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ActivationCodeId", value.ToString());
			}
		}
        ...
        public override DescribeActivationCodeDetailsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeActivationCodeDetailsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
