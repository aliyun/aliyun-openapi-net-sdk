...
{
    public class ModifyDBClusterAndNodesParametersRequest : RpcAcsRequest<ModifyDBClusterAndNodesParametersResponse>
    {
        public ModifyDBClusterAndNodesParametersRequest()
            : base("polardb", "2017-08-01", "ModifyDBClusterAndNodesParameters", "polardb", "openAPI")
        {
        ...
        public override ModifyDBClusterAndNodesParametersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterAndNodesParametersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
