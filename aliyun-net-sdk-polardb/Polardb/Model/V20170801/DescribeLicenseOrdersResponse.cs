...
{
	public class DescribeLicenseOrdersResponse : AcsResponse
	{
		...
		private List<DescribeLicenseOrders_LicenseOrder> items;
		...
		public List<DescribeLicenseOrders_LicenseOrder> Items
		{
			get
			{
				return items;
		...
		public class DescribeLicenseOrders_LicenseOrder
		{
