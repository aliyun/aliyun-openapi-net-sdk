...
{
	public class DeleteGlobalSecurityIPGroupResponse : AcsResponse
	{

		private string requestId;

		private List<DeleteGlobalSecurityIPGroup_GlobalSecurityIPGroupItem> globalSecurityIPGroup;
		...
		public List<DeleteGlobalSecurityIPGroup_GlobalSecurityIPGroupItem> GlobalSecurityIPGroup
		{
			get
			{
		...
		public class DeleteGlobalSecurityIPGroup_GlobalSecurityIPGroupItem
		{
