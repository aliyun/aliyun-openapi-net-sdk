...
{
    public class DescribePendingMaintenanceActionsRequest : RpcAcsRequest<DescribePendingMaintenanceActionsResponse>
    {
        public DescribePendingMaintenanceActionsRequest()
            : base("polardb", "2017-08-01", "DescribePendingMaintenanceActions", "polardb", "openAPI")
        {
        ...
        public override DescribePendingMaintenanceActionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePendingMaintenanceActionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
