...
{
    public class DescribeDBLinksRequest : RpcAcsRequest<DescribeDBLinksResponse>
    {
        public DescribeDBLinksRequest()
            : base("polardb", "2017-08-01", "DescribeDBLinks", "polardb", "openAPI")
        {
        ...
        public override DescribeDBLinksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBLinksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
