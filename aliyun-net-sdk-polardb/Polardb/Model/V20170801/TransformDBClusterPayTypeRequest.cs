...
{
    public class TransformDBClusterPayTypeRequest : RpcAcsRequest<TransformDBClusterPayTypeResponse>
    {
        public TransformDBClusterPayTypeRequest()
            : base("polardb", "2017-08-01", "TransformDBClusterPayType", "polardb", "openAPI")
        {
        ...
        public override TransformDBClusterPayTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TransformDBClusterPayTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
