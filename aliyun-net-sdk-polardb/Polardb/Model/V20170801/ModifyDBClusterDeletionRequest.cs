...
{
    public class ModifyDBClusterDeletionRequest : RpcAcsRequest<ModifyDBClusterDeletionResponse>
    {
        public ModifyDBClusterDeletionRequest()
            : base("polardb", "2017-08-01", "ModifyDBClusterDeletion", "polardb", "openAPI")
        {
        ...
        public override ModifyDBClusterDeletionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterDeletionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
