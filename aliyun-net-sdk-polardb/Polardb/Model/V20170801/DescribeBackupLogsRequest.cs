...
{
    public class DescribeBackupLogsRequest : RpcAcsRequest<DescribeBackupLogsResponse>
    {
        public DescribeBackupLogsRequest()
            : base("polardb", "2017-08-01", "DescribeBackupLogs", "polardb", "openAPI")
        {
		...
		public string BackupRegion
		{
			...
			{
				backupRegion = value;
				DictionaryUtil.Add(QueryParameters, "BackupRegion", value);
			}
		}
        ...
        public override DescribeBackupLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
