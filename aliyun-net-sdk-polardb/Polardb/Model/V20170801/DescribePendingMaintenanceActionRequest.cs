...
namespace Aliyun.Acs.polardb.Model.V20170801
{
    public class DescribePendingMaintenanceActionRequest : RpcAcsRequest<DescribePendingMaintenanceActionResponse>
    {
        ...
        public override DescribePendingMaintenanceActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePendingMaintenanceActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
