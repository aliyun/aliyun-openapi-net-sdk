...
{
    public class OpenAITaskRequest : RpcAcsRequest<OpenAITaskResponse>
    {
        public OpenAITaskRequest()
            : base("polardb", "2017-08-01", "OpenAITask", "polardb", "openAPI")
        {
        ...
        public override OpenAITaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenAITaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
