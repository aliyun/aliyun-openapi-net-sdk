...
{
    public class DescribeLicenseOrdersRequest : RpcAcsRequest<DescribeLicenseOrdersResponse>
    {
        public DescribeLicenseOrdersRequest()
            : base("polardb", "2017-08-01", "DescribeLicenseOrders", "polardb", "openAPI")
        {
		...
		public bool? VirtualOrder
		{
			...
			{
				virtualOrder = value;
				DictionaryUtil.Add(QueryParameters, "VirtualOrder", value.ToString());
			}
		}
		...
		public string PurchaseChannel
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "PurchaseChannel", value);
			}
		}
        ...
        public override DescribeLicenseOrdersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLicenseOrdersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
