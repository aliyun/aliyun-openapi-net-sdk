...
{
    public class DescribeClassListRequest : RpcAcsRequest<DescribeClassListResponse>
    {
        public DescribeClassListRequest()
            : base("polardb", "2017-08-01", "DescribeClassList", "polardb", "openAPI")
        {
		...
		public string MasterHa
		{
			...
			{
				masterHa = value;
				DictionaryUtil.Add(QueryParameters, "MasterHa", value);
			}
		}
        ...
        public override DescribeClassListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeClassListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
