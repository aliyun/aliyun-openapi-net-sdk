...
{
	public class ModifyGlobalSecurityIPGroupResponse : AcsResponse
	{

		private string requestId;

		private List<ModifyGlobalSecurityIPGroup_GlobalSecurityIPGroupItem> globalSecurityIPGroup;
		...
		public List<ModifyGlobalSecurityIPGroup_GlobalSecurityIPGroupItem> GlobalSecurityIPGroup
		{
			get
			{
		...
		public class ModifyGlobalSecurityIPGroup_GlobalSecurityIPGroupItem
		{
