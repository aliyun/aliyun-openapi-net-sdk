...
{
    public class ModifyDBNodesParametersRequest : RpcAcsRequest<ModifyDBNodesParametersResponse>
    {
        public ModifyDBNodesParametersRequest()
            : base("polardb", "2017-08-01", "ModifyDBNodesParameters", "polardb", "openAPI")
        {
        ...
        public override ModifyDBNodesParametersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBNodesParametersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
