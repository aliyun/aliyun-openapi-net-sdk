...
{
    public class CheckAccountNameRequest : RpcAcsRequest<CheckAccountNameResponse>
    {
        public CheckAccountNameRequest()
            : base("polardb", "2017-08-01", "CheckAccountName", "polardb", "openAPI")
        {
        ...
        public override CheckAccountNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckAccountNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
