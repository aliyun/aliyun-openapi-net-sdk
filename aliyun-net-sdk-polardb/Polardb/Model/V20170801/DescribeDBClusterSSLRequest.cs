...
{
    public class DescribeDBClusterSSLRequest : RpcAcsRequest<DescribeDBClusterSSLResponse>
    {
        public DescribeDBClusterSSLRequest()
            : base("polardb", "2017-08-01", "DescribeDBClusterSSL", "polardb", "openAPI")
        {
        ...
        public override DescribeDBClusterSSLResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBClusterSSLResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
