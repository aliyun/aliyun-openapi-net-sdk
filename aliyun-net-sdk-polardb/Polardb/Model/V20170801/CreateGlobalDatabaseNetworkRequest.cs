...
{
    public class CreateGlobalDatabaseNetworkRequest : RpcAcsRequest<CreateGlobalDatabaseNetworkResponse>
    {
        public CreateGlobalDatabaseNetworkRequest()
            : base("polardb", "2017-08-01", "CreateGlobalDatabaseNetwork", "polardb", "openAPI")
        {
        ...
        public override CreateGlobalDatabaseNetworkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateGlobalDatabaseNetworkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
