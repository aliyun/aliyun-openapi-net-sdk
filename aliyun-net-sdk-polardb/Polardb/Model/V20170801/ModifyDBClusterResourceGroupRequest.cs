...
{
    public class ModifyDBClusterResourceGroupRequest : RpcAcsRequest<ModifyDBClusterResourceGroupResponse>
    {
        public ModifyDBClusterResourceGroupRequest()
            : base("polardb", "2017-08-01", "ModifyDBClusterResourceGroup", "polardb", "openAPI")
        {
        ...
        public override ModifyDBClusterResourceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterResourceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
