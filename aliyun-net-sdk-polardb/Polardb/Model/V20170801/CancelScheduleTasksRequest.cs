...
{
    public class CancelScheduleTasksRequest : RpcAcsRequest<CancelScheduleTasksResponse>
    {
        public CancelScheduleTasksRequest()
            : base("polardb", "2017-08-01", "CancelScheduleTasks", "polardb", "openAPI")
        {
        ...
        public override CancelScheduleTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelScheduleTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
