...
{
    public class DeleteDBLinkRequest : RpcAcsRequest<DeleteDBLinkResponse>
    {
        public DeleteDBLinkRequest()
            : base("polardb", "2017-08-01", "DeleteDBLink", "polardb", "openAPI")
        {
        ...
        public override DeleteDBLinkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDBLinkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
