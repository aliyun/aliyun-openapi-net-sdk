...
{
    public class ModifyPendingMaintenanceActionRequest : RpcAcsRequest<ModifyPendingMaintenanceActionResponse>
    {
        public ModifyPendingMaintenanceActionRequest()
            : base("polardb", "2017-08-01", "ModifyPendingMaintenanceAction", "polardb", "openAPI")
        {
        ...
        public override ModifyPendingMaintenanceActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyPendingMaintenanceActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
