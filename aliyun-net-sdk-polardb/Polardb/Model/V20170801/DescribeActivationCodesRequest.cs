...
{
    public class DescribeActivationCodesRequest : RpcAcsRequest<DescribeActivationCodesResponse>
    {
        public DescribeActivationCodesRequest()
            : base("polardb", "2017-08-01", "DescribeActivationCodes", "polardb", "openAPI")
        {
        ...
        public override DescribeActivationCodesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeActivationCodesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
