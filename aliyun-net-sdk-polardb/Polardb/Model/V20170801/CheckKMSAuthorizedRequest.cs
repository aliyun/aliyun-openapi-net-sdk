...
{
    public class CheckKMSAuthorizedRequest : RpcAcsRequest<CheckKMSAuthorizedResponse>
    {
        public CheckKMSAuthorizedRequest()
            : base("polardb", "2017-08-01", "CheckKMSAuthorized", "polardb", "openAPI")
        {
		...
		public string TDERegion
		{
			...
			{
				tDERegion = value;
				DictionaryUtil.Add(QueryParameters, "TDERegion", value);
			}
		}
        ...
        public override CheckKMSAuthorizedResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckKMSAuthorizedResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
