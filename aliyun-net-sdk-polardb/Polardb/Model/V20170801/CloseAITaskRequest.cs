...
{
    public class CloseAITaskRequest : RpcAcsRequest<CloseAITaskResponse>
    {
        public CloseAITaskRequest()
            : base("polardb", "2017-08-01", "CloseAITask", "polardb", "openAPI")
        {
        ...
        public override CloseAITaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseAITaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
