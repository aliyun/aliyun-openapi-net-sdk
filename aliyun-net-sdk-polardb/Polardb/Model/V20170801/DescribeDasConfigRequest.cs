...
{
    public class DescribeDasConfigRequest : RpcAcsRequest<DescribeDasConfigResponse>
    {
        public DescribeDasConfigRequest()
            : base("polardb", "2017-08-01", "DescribeDasConfig", "polardb", "openAPI")
        {
        ...
        public override DescribeDasConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDasConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
