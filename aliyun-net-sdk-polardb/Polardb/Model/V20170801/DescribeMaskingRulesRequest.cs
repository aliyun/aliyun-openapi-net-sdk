...
{
    public class DescribeMaskingRulesRequest : RpcAcsRequest<DescribeMaskingRulesResponse>
    {
        public DescribeMaskingRulesRequest()
            : base("polardb", "2017-08-01", "DescribeMaskingRules", "polardb", "openAPI")
        {
        ...
        public override DescribeMaskingRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMaskingRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
