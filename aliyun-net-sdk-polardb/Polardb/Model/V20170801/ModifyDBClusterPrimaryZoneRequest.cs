...
namespace Aliyun.Acs.polardb.Model.V20170801
{
    public class ModifyDBClusterPrimaryZoneRequest : RpcAcsRequest<ModifyDBClusterPrimaryZoneResponse>
    {
        ...
        public override ModifyDBClusterPrimaryZoneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterPrimaryZoneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
