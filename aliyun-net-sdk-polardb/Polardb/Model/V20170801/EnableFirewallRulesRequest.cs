...
{
    public class EnableFirewallRulesRequest : RpcAcsRequest<EnableFirewallRulesResponse>
    {
        public EnableFirewallRulesRequest()
            : base("polardb", "2017-08-01", "EnableFirewallRules", "polardb", "openAPI")
        {
        ...
        public override EnableFirewallRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableFirewallRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
