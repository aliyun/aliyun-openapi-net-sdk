...
namespace Aliyun.Acs.polardb.Model.V20170801
{
	public class ModifyGlobalSecurityIPGroupRelationResponse : AcsResponse
	{
		...
		private List<ModifyGlobalSecurityIPGroupRelation_GlobalSecurityIPGroupRelItem> globalSecurityIPGroupRel;
		...
		public List<ModifyGlobalSecurityIPGroupRelation_GlobalSecurityIPGroupRelItem> GlobalSecurityIPGroupRel
		{
			get
			{
		...
		public class ModifyGlobalSecurityIPGroupRelation_GlobalSecurityIPGroupRelItem
		{
