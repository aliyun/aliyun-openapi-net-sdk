...
{
    public class DescribeAITaskStatusRequest : RpcAcsRequest<DescribeAITaskStatusResponse>
    {
        public DescribeAITaskStatusRequest()
            : base("polardb", "2017-08-01", "DescribeAITaskStatus", "polardb", "openAPI")
        {
        ...
        public override DescribeAITaskStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAITaskStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
