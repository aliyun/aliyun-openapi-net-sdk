...
{
    public class ModifyInstanceMaintainTimeRequest : RoaAcsRequest<ModifyInstanceMaintainTimeResponse>
    {
        public ModifyInstanceMaintainTimeRequest()
            : base("elasticsearch", "2017-06-13", "ModifyInstanceMaintainTime", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/actions/modify-maintaintime";
