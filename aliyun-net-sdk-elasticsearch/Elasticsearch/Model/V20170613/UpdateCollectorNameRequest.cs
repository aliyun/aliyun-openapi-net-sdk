...
{
    public class UpdateCollectorNameRequest : RoaAcsRequest<UpdateCollectorNameResponse>
    {
        public UpdateCollectorNameRequest()
            : base("elasticsearch", "2017-06-13", "UpdateCollectorName", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/collectors/[ResId]/actions/rename";
        ...
        public override UpdateCollectorNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCollectorNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
