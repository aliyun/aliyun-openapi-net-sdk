...
{
    public class ListComponentIndicesRequest : RoaAcsRequest<ListComponentIndicesResponse>
    {
        public ListComponentIndicesRequest()
            : base("elasticsearch", "2017-06-13", "ListComponentIndices", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/component-index";
        ...
        public override ListComponentIndicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListComponentIndicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
