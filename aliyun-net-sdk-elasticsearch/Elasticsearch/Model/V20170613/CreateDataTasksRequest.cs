...
{
    public class CreateDataTasksRequest : RoaAcsRequest<CreateDataTasksResponse>
    {
        public CreateDataTasksRequest()
            : base("elasticsearch", "2017-06-13", "CreateDataTasks", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/data-task";
        ...
        public override CreateDataTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDataTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
