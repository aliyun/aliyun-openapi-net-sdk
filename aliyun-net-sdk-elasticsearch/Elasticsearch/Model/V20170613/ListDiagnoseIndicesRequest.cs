...
{
    public class ListDiagnoseIndicesRequest : RoaAcsRequest<ListDiagnoseIndicesResponse>
    {
        public ListDiagnoseIndicesRequest()
            : base("elasticsearch", "2017-06-13", "ListDiagnoseIndices", "elasticsearch", "openAPI")
        {
        ...
        public override ListDiagnoseIndicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDiagnoseIndicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
