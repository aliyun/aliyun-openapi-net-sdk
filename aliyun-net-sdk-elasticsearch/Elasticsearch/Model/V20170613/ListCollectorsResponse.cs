...
{
	public class ListCollectorsResponse : AcsResponse
	{

		private string requestId;

		private List<ListCollectors_ResultItem> result;

		private ListCollectors_Headers headers;
		...
		public List<ListCollectors_ResultItem> Result
		{
			get
			{
				return result;
		...
		public ListCollectors_Headers Headers
		{
			get
			{
				return headers;
		...
		public class ListCollectors_ResultItem
		{
			...
			private List<ListCollectors_ExtendConfigsItem> extendConfigs;
			...
			public List<ListCollectors_ConfigsItem> Configs
			{
				get
				{
					return configs;
			...
			public List<ListCollectors_ExtendConfigsItem> ExtendConfigs
			{
				get
				{
			...
			public class ListCollectors_ExtendConfigsItem
			{
				...
				public List<ListCollectors_MachinesItem> Machines
				{
					get
					{
						return machines;
		...
		public class ListCollectors_Headers
		{
