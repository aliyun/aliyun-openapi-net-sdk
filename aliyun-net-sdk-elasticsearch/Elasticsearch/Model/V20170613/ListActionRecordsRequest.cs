...
{
    public class ListActionRecordsRequest : RoaAcsRequest<ListActionRecordsResponse>
    {
        public ListActionRecordsRequest()
            : base("elasticsearch", "2017-06-13", "ListActionRecords", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/action-records";
		...
		public string ActionNames
		{
			...
			{
				actionNames = value;
				DictionaryUtil.Add(QueryParameters, "actionNames", value);
			}
		}
        ...
        public override ListActionRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListActionRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
