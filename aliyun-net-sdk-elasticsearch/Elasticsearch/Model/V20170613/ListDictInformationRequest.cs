...
{
    public class ListDictInformationRequest : RoaAcsRequest<ListDictInformationResponse>
    {
        public ListDictInformationRequest()
            : base("elasticsearch", "2017-06-13", "ListDictInformation", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/dict/_info";
        ...
        public override ListDictInformationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDictInformationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
