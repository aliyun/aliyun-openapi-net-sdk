...
{
    public class RemoveApmRequest : RoaAcsRequest<RemoveApmResponse>
    {
        public RemoveApmRequest()
            : base("elasticsearch", "2017-06-13", "RemoveApm", "elasticsearch", "openAPI")
        {
        ...
        public override RemoveApmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveApmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
