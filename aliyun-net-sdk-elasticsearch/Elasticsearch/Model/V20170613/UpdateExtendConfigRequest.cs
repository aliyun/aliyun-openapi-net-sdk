...
{
    public class UpdateExtendConfigRequest : RoaAcsRequest<UpdateExtendConfigResponse>
    {
        public UpdateExtendConfigRequest()
            : base("elasticsearch", "2017-06-13", "UpdateExtendConfig", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/extend-configs/actions/update";
        ...
        public override UpdateExtendConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateExtendConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
