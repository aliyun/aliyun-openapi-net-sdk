...
{
    public class MigrateToOtherZoneRequest : RoaAcsRequest<MigrateToOtherZoneResponse>
    {
        public MigrateToOtherZoneRequest()
            : base("elasticsearch", "2017-06-13", "MigrateToOtherZone", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/actions/migrate-zones";
