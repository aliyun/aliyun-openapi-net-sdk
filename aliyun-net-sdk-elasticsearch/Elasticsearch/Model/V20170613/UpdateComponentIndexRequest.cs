...
{
    public class UpdateComponentIndexRequest : RoaAcsRequest<UpdateComponentIndexResponse>
    {
        public UpdateComponentIndexRequest()
            : base("elasticsearch", "2017-06-13", "UpdateComponentIndex", "elasticsearch", "openAPI")
        {
        ...
        public override UpdateComponentIndexResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateComponentIndexResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
