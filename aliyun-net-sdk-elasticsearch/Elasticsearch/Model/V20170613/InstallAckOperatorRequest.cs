...
{
    public class InstallAckOperatorRequest : RoaAcsRequest<InstallAckOperatorResponse>
    {
        public InstallAckOperatorRequest()
            : base("elasticsearch", "2017-06-13", "InstallAckOperator", "elasticsearch", "openAPI")
        {
        ...
        public override InstallAckOperatorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InstallAckOperatorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
