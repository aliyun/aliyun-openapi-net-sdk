...
{
    public class ListTagsRequest : RoaAcsRequest<ListTagsResponse>
    {
        public ListTagsRequest()
            : base("elasticsearch", "2017-06-13", "ListTags", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/tags/all-tags";
