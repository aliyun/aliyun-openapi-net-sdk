...
{
    public class ListILMPoliciesRequest : RoaAcsRequest<ListILMPoliciesResponse>
    {
        public ListILMPoliciesRequest()
            : base("elasticsearch", "2017-06-13", "ListILMPolicies", "elasticsearch", "openAPI")
        {
        ...
        public override ListILMPoliciesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListILMPoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
