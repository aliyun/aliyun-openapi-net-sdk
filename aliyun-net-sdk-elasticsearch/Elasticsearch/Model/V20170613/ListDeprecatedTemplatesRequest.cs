...
{
    public class ListDeprecatedTemplatesRequest : RoaAcsRequest<ListDeprecatedTemplatesResponse>
    {
        public ListDeprecatedTemplatesRequest()
            : base("elasticsearch", "2017-06-13", "ListDeprecatedTemplates", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/deprecated-templates";
        ...
        public override ListDeprecatedTemplatesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDeprecatedTemplatesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
