...
{
    public class CloseDiagnosisRequest : RoaAcsRequest<CloseDiagnosisResponse>
    {
        public CloseDiagnosisRequest()
            : base("elasticsearch", "2017-06-13", "CloseDiagnosis", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/diagnosis/instances/[InstanceId]/actions/close-diagnosis";
        ...
        public override CloseDiagnosisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseDiagnosisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
