...
{
    public class DeleteIndexTemplateRequest : RoaAcsRequest<DeleteIndexTemplateResponse>
    {
        public DeleteIndexTemplateRequest()
            : base("elasticsearch", "2017-06-13", "DeleteIndexTemplate", "elasticsearch", "openAPI")
        {
        ...
        public override DeleteIndexTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteIndexTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
