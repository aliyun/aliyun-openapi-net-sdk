...
{
    public class GetEmonGrafanaAlertsRequest : RoaAcsRequest<GetEmonGrafanaAlertsResponse>
    {
        public GetEmonGrafanaAlertsRequest()
            : base("elasticsearch", "2017-06-13", "GetEmonGrafanaAlerts", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/emon/projects/[ProjectId]/grafana/proxy/api/alerts";
        ...
        public override GetEmonGrafanaAlertsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetEmonGrafanaAlertsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
