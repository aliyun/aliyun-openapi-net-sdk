...
{
    public class PostEmonTryAlarmRuleRequest : RoaAcsRequest<PostEmonTryAlarmRuleResponse>
    {
        public PostEmonTryAlarmRuleRequest()
            : base("elasticsearch", "2017-06-13", "PostEmonTryAlarmRule", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/emon/projects/[ProjectId]/alarm-groups/[AlarmGroupId]/alarm-rules/_test";
        ...
        public override PostEmonTryAlarmRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PostEmonTryAlarmRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
