...
{
    public class ReinstallCollectorRequest : RoaAcsRequest<ReinstallCollectorResponse>
    {
        public ReinstallCollectorRequest()
            : base("elasticsearch", "2017-06-13", "ReinstallCollector", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/collectors/[ResId]/actions/reinstall";
        ...
        public override ReinstallCollectorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReinstallCollectorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
