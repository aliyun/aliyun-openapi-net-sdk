...
{
    public class DescribeTemplatesRequest : RoaAcsRequest<DescribeTemplatesResponse>
    {
        public DescribeTemplatesRequest()
            : base("elasticsearch", "2017-06-13", "DescribeTemplates", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/templates";
        ...
        public override DescribeTemplatesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
