...
{
    public class ListPipelineIdsRequest : RoaAcsRequest<ListPipelineIdsResponse>
    {
        public ListPipelineIdsRequest()
            : base("elasticsearch", "2017-06-13", "ListPipelineIds", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/pipeline-ids";
        ...
        public override ListPipelineIdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPipelineIdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
