...
{
    public class StopPipelinesRequest : RoaAcsRequest<StopPipelinesResponse>
    {
        public StopPipelinesRequest()
            : base("elasticsearch", "2017-06-13", "StopPipelines", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/pipelines/action/stop";
        ...
        public override StopPipelinesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopPipelinesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
