...
{
    public class RunPipelinesRequest : RoaAcsRequest<RunPipelinesResponse>
    {
        public RunPipelinesRequest()
            : base("elasticsearch", "2017-06-13", "RunPipelines", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/pipelines/action/run";
        ...
        public override RunPipelinesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RunPipelinesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
