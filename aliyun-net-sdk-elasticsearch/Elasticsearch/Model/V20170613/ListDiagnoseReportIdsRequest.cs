...
{
    public class ListDiagnoseReportIdsRequest : RoaAcsRequest<ListDiagnoseReportIdsResponse>
    {
        public ListDiagnoseReportIdsRequest()
            : base("elasticsearch", "2017-06-13", "ListDiagnoseReportIds", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/diagnosis/instances/[InstanceId]/report-ids";
        ...
        public override ListDiagnoseReportIdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDiagnoseReportIdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
