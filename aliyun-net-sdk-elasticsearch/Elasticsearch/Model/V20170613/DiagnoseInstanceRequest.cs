...
{
    public class DiagnoseInstanceRequest : RoaAcsRequest<DiagnoseInstanceResponse>
    {
        public DiagnoseInstanceRequest()
            : base("elasticsearch", "2017-06-13", "DiagnoseInstance", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/diagnosis/instances/[InstanceId]/actions/diagnose";
        ...
        public override DiagnoseInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DiagnoseInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
