...
{
    public class DescribeIndexTemplateRequest : RoaAcsRequest<DescribeIndexTemplateResponse>
    {
        public DescribeIndexTemplateRequest()
            : base("elasticsearch", "2017-06-13", "DescribeIndexTemplate", "elasticsearch", "openAPI")
        {
        ...
        public override DescribeIndexTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeIndexTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
