...
{
    public class ListExtendfilesRequest : RoaAcsRequest<ListExtendfilesResponse>
    {
        public ListExtendfilesRequest()
            : base("elasticsearch", "2017-06-13", "ListExtendfiles", "elasticsearch", "openAPI")
        {
        ...
        public override ListExtendfilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListExtendfilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
