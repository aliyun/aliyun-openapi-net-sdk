...
{
    public class DeleteDeprecatedTemplateRequest : RoaAcsRequest<DeleteDeprecatedTemplateResponse>
    {
        public DeleteDeprecatedTemplateRequest()
            : base("elasticsearch", "2017-06-13", "DeleteDeprecatedTemplate", "elasticsearch", "openAPI")
        {
        ...
        public override DeleteDeprecatedTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDeprecatedTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
