...
{
    public class ModifyElastictaskRequest : RoaAcsRequest<ModifyElastictaskResponse>
    {
        public ModifyElastictaskRequest()
            : base("elasticsearch", "2017-06-13", "ModifyElastictask", "elasticsearch", "openAPI")
        {
        ...
        public override ModifyElastictaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyElastictaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
