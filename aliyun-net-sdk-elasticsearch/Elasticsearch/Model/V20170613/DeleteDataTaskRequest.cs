...
{
    public class DeleteDataTaskRequest : RoaAcsRequest<DeleteDataTaskResponse>
    {
        public DeleteDataTaskRequest()
            : base("elasticsearch", "2017-06-13", "DeleteDataTask", "elasticsearch", "openAPI")
        {
        ...
        public override DeleteDataTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDataTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
