...
{
    public class CreateSnapshotRequest : RoaAcsRequest<CreateSnapshotResponse>
    {
        public CreateSnapshotRequest()
            : base("elasticsearch", "2017-06-13", "CreateSnapshot", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/snapshots";
