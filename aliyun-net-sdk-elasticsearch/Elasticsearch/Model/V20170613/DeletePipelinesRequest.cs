...
{
    public class DeletePipelinesRequest : RoaAcsRequest<DeletePipelinesResponse>
    {
        public DeletePipelinesRequest()
            : base("elasticsearch", "2017-06-13", "DeletePipelines", "elasticsearch", "openAPI")
        {
        ...
        public override DeletePipelinesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePipelinesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
