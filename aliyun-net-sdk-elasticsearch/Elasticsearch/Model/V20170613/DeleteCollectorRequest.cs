...
{
    public class DeleteCollectorRequest : RoaAcsRequest<DeleteCollectorResponse>
    {
        public DeleteCollectorRequest()
            : base("elasticsearch", "2017-06-13", "DeleteCollector", "elasticsearch", "openAPI")
        {
        ...
        public override DeleteCollectorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCollectorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
