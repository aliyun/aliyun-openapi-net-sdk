...
{
    public class ValidateConnectionRequest : RoaAcsRequest<ValidateConnectionResponse>
    {
        public ValidateConnectionRequest()
            : base("elasticsearch", "2017-06-13", "ValidateConnection", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/validate-connection";
        ...
        public override ValidateConnectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ValidateConnectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
