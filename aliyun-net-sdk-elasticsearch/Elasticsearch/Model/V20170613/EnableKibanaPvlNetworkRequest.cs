...
{
    public class EnableKibanaPvlNetworkRequest : RoaAcsRequest<EnableKibanaPvlNetworkResponse>
    {
        public EnableKibanaPvlNetworkRequest()
            : base("elasticsearch", "2017-06-13", "EnableKibanaPvlNetwork", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/actions/enable-kibana-private";
        ...
        public override EnableKibanaPvlNetworkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableKibanaPvlNetworkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
