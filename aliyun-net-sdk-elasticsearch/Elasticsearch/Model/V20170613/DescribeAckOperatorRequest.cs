...
{
    public class DescribeAckOperatorRequest : RoaAcsRequest<DescribeAckOperatorResponse>
    {
        public DescribeAckOperatorRequest()
            : base("elasticsearch", "2017-06-13", "DescribeAckOperator", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/ack-clusters/[ClusterId]/operator";
        ...
        public override DescribeAckOperatorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAckOperatorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
