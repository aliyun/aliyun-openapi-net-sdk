...
{
    public class UpdateCollectorRequest : RoaAcsRequest<UpdateCollectorResponse>
    {
        public UpdateCollectorRequest()
            : base("elasticsearch", "2017-06-13", "UpdateCollector", "elasticsearch", "openAPI")
        {
        ...
        public override UpdateCollectorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateCollectorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
