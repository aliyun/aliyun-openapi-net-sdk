...
{
    public class CreateComponentIndexRequest : RoaAcsRequest<CreateComponentIndexResponse>
    {
        public CreateComponentIndexRequest()
            : base("elasticsearch", "2017-06-13", "CreateComponentIndex", "elasticsearch", "openAPI")
        {
        ...
        public override CreateComponentIndexResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateComponentIndexResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
