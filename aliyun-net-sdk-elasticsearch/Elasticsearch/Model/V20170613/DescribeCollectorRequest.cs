...
{
    public class DescribeCollectorRequest : RoaAcsRequest<DescribeCollectorResponse>
    {
        public DescribeCollectorRequest()
            : base("elasticsearch", "2017-06-13", "DescribeCollector", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/collectors/[ResId]";
        ...
        public override DescribeCollectorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCollectorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
