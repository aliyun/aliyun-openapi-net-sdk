...
{
    public class EstimatedLogstashRestartTimeRequest : RoaAcsRequest<EstimatedLogstashRestartTimeResponse>
    {
        public EstimatedLogstashRestartTimeRequest()
            : base("elasticsearch", "2017-06-13", "EstimatedLogstashRestartTime", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/estimated-time/restart-time";
        ...
        public override EstimatedLogstashRestartTimeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EstimatedLogstashRestartTimeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
