...
{
    public class ListPipelineRequest : RoaAcsRequest<ListPipelineResponse>
    {
        public ListPipelineRequest()
            : base("elasticsearch", "2017-06-13", "ListPipeline", "elasticsearch", "openAPI")
        {
        ...
        public override ListPipelineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPipelineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
