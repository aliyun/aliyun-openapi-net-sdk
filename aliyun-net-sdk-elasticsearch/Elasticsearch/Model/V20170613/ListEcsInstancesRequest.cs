...
{
    public class ListEcsInstancesRequest : RoaAcsRequest<ListEcsInstancesResponse>
    {
        public ListEcsInstancesRequest()
            : base("elasticsearch", "2017-06-13", "ListEcsInstances", "elasticsearch", "openAPI")
        {
        ...
        public override ListEcsInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListEcsInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
