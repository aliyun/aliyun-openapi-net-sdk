...
{
    public class ListDataTasksRequest : RoaAcsRequest<ListDataTasksResponse>
    {
        public ListDataTasksRequest()
            : base("elasticsearch", "2017-06-13", "ListDataTasks", "elasticsearch", "openAPI")
        {
        ...
        public override ListDataTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDataTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
