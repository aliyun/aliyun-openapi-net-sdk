...
{
    public class StopApmRequest : RoaAcsRequest<StopApmResponse>
    {
        public StopApmRequest()
            : base("elasticsearch", "2017-06-13", "StopApm", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/apm/[instanceId]/actions/stop";
        ...
        public override StopApmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopApmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
