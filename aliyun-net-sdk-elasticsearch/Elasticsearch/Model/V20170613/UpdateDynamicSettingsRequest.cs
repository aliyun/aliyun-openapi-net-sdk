...
{
    public class UpdateDynamicSettingsRequest : RoaAcsRequest<UpdateDynamicSettingsResponse>
    {
        public UpdateDynamicSettingsRequest()
            : base("elasticsearch", "2017-06-13", "UpdateDynamicSettings", "elasticsearch", "openAPI")
        {
        ...
        public override UpdateDynamicSettingsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDynamicSettingsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
