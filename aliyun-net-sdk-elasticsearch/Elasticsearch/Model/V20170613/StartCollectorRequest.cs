...
{
    public class StartCollectorRequest : RoaAcsRequest<StartCollectorResponse>
    {
        public StartCollectorRequest()
            : base("elasticsearch", "2017-06-13", "StartCollector", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/collectors/[ResId]/actions/start";
        ...
        public override StartCollectorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartCollectorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
