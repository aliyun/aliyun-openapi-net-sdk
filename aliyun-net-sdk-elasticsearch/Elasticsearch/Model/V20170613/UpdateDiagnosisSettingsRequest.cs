...
{
    public class UpdateDiagnosisSettingsRequest : RoaAcsRequest<UpdateDiagnosisSettingsResponse>
    {
        public UpdateDiagnosisSettingsRequest()
            : base("elasticsearch", "2017-06-13", "UpdateDiagnosisSettings", "elasticsearch", "openAPI")
        {
        ...
        public override UpdateDiagnosisSettingsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDiagnosisSettingsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
