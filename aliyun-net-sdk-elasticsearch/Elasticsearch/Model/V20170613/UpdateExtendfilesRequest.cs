...
{
    public class UpdateExtendfilesRequest : RoaAcsRequest<UpdateExtendfilesResponse>
    {
        public UpdateExtendfilesRequest()
            : base("elasticsearch", "2017-06-13", "UpdateExtendfiles", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/logstashes/[InstanceId]/extendfiles";
        ...
        public override UpdateExtendfilesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateExtendfilesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
