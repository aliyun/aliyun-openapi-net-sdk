...
{
    public class EstimatedRestartTimeRequest : RoaAcsRequest<EstimatedRestartTimeResponse>
    {
        public EstimatedRestartTimeRequest()
            : base("elasticsearch", "2017-06-13", "EstimatedRestartTime", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/estimated-time/restart-time";
        ...
        public override EstimatedRestartTimeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EstimatedRestartTimeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
