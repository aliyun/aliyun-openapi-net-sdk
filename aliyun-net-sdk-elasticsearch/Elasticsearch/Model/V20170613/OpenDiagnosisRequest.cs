...
{
    public class OpenDiagnosisRequest : RoaAcsRequest<OpenDiagnosisResponse>
    {
        public OpenDiagnosisRequest()
            : base("elasticsearch", "2017-06-13", "OpenDiagnosis", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/diagnosis/instances/[InstanceId]/actions/open-diagnosis";
        ...
        public override OpenDiagnosisResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenDiagnosisResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
