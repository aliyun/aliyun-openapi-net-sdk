...
{
    public class UpdateTemplateRequest : RoaAcsRequest<UpdateTemplateResponse>
    {
        public UpdateTemplateRequest()
            : base("elasticsearch", "2017-06-13", "UpdateTemplate", "elasticsearch", "openAPI")
        {
			...
			UriPattern = "/openapi/instances/[InstanceId]/templates/[TemplateName]";
		...
		public string TemplateName
		{
			...
			{
				templateName = value;
				DictionaryUtil.Add(PathParameters, "TemplateName", value);
			}
		}
