...
{
    public class ExecuteNodeToolRequest : RpcAcsRequest<ExecuteNodeToolResponse>
    {
        public ExecuteNodeToolRequest()
            : base("Cassandra", "2019-01-01", "ExecuteNodeTool", "Cassandra", "openAPI")
        {
        ...
        public override ExecuteNodeToolResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExecuteNodeToolResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
