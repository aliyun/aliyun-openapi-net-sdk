...
{
    public class CreateDataCenterRequest : RpcAcsRequest<CreateDataCenterResponse>
    {
        public CreateDataCenterRequest()
            : base("Cassandra", "2019-01-01", "CreateDataCenter", "Cassandra", "openAPI")
        {
        ...
        public override CreateDataCenterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDataCenterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
