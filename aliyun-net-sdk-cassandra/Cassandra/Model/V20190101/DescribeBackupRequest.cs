...
{
    public class DescribeBackupRequest : RpcAcsRequest<DescribeBackupResponse>
    {
        public DescribeBackupRequest()
            : base("Cassandra", "2019-01-01", "DescribeBackup", "Cassandra", "openAPI")
        {
        ...
        public override DescribeBackupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
