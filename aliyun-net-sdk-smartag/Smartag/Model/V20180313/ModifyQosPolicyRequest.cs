...
{
    public class ModifyQosPolicyRequest : RpcAcsRequest<ModifyQosPolicyResponse>
    {
        public ModifyQosPolicyRequest()
            : base("Smartag", "2018-03-13", "ModifyQosPolicy", "smartag", "openAPI")
        {
        ...
        public override ModifyQosPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyQosPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
