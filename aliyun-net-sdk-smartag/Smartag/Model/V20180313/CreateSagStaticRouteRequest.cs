...
{
    public class CreateSagStaticRouteRequest : RpcAcsRequest<CreateSagStaticRouteResponse>
    {
        public CreateSagStaticRouteRequest()
            : base("Smartag", "2018-03-13", "CreateSagStaticRoute", "smartag", "openAPI")
        {
        ...
        public override CreateSagStaticRouteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSagStaticRouteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
