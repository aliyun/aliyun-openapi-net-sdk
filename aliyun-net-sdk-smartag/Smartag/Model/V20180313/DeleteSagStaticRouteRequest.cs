...
{
    public class DeleteSagStaticRouteRequest : RpcAcsRequest<DeleteSagStaticRouteResponse>
    {
        public DeleteSagStaticRouteRequest()
            : base("Smartag", "2018-03-13", "DeleteSagStaticRoute", "smartag", "openAPI")
        {
        ...
        public override DeleteSagStaticRouteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSagStaticRouteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
