...
{
    public class CreateQosCarRequest : RpcAcsRequest<CreateQosCarResponse>
    {
        public CreateQosCarRequest()
            : base("Smartag", "2018-03-13", "CreateQosCar", "smartag", "openAPI")
        {
        ...
        public override CreateQosCarResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateQosCarResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
