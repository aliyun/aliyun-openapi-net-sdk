...
{
    public class ModifySagManagementPortRequest : RpcAcsRequest<ModifySagManagementPortResponse>
    {
        public ModifySagManagementPortRequest()
            : base("Smartag", "2018-03-13", "ModifySagManagementPort", "smartag", "openAPI")
        {
        ...
        public override ModifySagManagementPortResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySagManagementPortResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
