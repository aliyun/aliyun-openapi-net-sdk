...
{
    public class BindVbrRequest : RpcAcsRequest<BindVbrResponse>
    {
        public BindVbrRequest()
            : base("Smartag", "2018-03-13", "BindVbr", "smartag", "openAPI")
        {
        ...
        public override BindVbrResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindVbrResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
