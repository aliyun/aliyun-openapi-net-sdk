...
{
    public class AddDnatEntryRequest : RpcAcsRequest<AddDnatEntryResponse>
    {
        public AddDnatEntryRequest()
            : base("Smartag", "2018-03-13", "AddDnatEntry", "smartag", "openAPI")
        {
        ...
        public override AddDnatEntryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddDnatEntryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
