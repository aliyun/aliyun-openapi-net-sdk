...
{
    public class ModifyHealthCheckRequest : RpcAcsRequest<ModifyHealthCheckResponse>
    {
        public ModifyHealthCheckRequest()
            : base("Smartag", "2018-03-13", "ModifyHealthCheck", "smartag", "openAPI")
        {
        ...
        public override ModifyHealthCheckResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyHealthCheckResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
