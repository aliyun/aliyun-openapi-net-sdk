...
{
    public class ModifySagWifiRequest : RpcAcsRequest<ModifySagWifiResponse>
    {
        public ModifySagWifiRequest()
            : base("Smartag", "2018-03-13", "ModifySagWifi", "smartag", "openAPI")
        {
		...
		public string IsBroadcast
		{
			...
			{
				isBroadcast = value;
				DictionaryUtil.Add(QueryParameters, "IsBroadcast", value);
			}
		}
		...
		public string IsEnable
		{
			...
			{
				isEnable = value;
				DictionaryUtil.Add(QueryParameters, "IsEnable", value);
			}
		}
		...
		public string IsAuth
		{
			...
			{
				isAuth = value;
				DictionaryUtil.Add(QueryParameters, "IsAuth", value);
			}
		}
        ...
        public override ModifySagWifiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySagWifiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
