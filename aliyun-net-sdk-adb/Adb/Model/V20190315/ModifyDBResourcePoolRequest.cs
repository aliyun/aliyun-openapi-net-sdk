...
{
    public class ModifyDBResourcePoolRequest : RpcAcsRequest<ModifyDBResourcePoolResponse>
    {
        public ModifyDBResourcePoolRequest()
            : base("adb", "2019-03-15", "ModifyDBResourcePool", "ads", "openAPI")
        {
        ...
        public override ModifyDBResourcePoolResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBResourcePoolResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
