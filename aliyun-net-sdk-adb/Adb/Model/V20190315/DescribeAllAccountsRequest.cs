...
{
    public class DescribeAllAccountsRequest : RpcAcsRequest<DescribeAllAccountsResponse>
    {
        public DescribeAllAccountsRequest()
            : base("adb", "2019-03-15", "DescribeAllAccounts", "ads", "openAPI")
        {
        ...
        public override DescribeAllAccountsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAllAccountsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
