...
{
    public class BatchApplyAdviceByIdListRequest : RpcAcsRequest<BatchApplyAdviceByIdListResponse>
    {
        public BatchApplyAdviceByIdListRequest()
            : base("adb", "2019-03-15", "BatchApplyAdviceByIdList", "ads", "openAPI")
        {
		...
		public string AdviceIdList
		{
			...
			{
				adviceIdList = value;
				DictionaryUtil.Add(QueryParameters, "AdviceIdList", value);
			}
		}
        ...
        public override BatchApplyAdviceByIdListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchApplyAdviceByIdListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
