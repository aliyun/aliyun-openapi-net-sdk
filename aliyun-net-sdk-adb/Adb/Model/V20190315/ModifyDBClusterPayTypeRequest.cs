...
{
    public class ModifyDBClusterPayTypeRequest : RpcAcsRequest<ModifyDBClusterPayTypeResponse>
    {
        public ModifyDBClusterPayTypeRequest()
            : base("adb", "2019-03-15", "ModifyDBClusterPayType", "ads", "openAPI")
        {
        ...
        public override ModifyDBClusterPayTypeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBClusterPayTypeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
