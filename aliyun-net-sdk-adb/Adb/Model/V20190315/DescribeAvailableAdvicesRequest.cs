...
{
    public class DescribeAvailableAdvicesRequest : RpcAcsRequest<DescribeAvailableAdvicesResponse>
    {
        public DescribeAvailableAdvicesRequest()
            : base("adb", "2019-03-15", "DescribeAvailableAdvices", "ads", "openAPI")
        {
        ...
        public override DescribeAvailableAdvicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAvailableAdvicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
