...
{
    public class DescribeMaintenanceActionRequest : RpcAcsRequest<DescribeMaintenanceActionResponse>
    {
        public DescribeMaintenanceActionRequest()
            : base("adb", "2019-03-15", "DescribeMaintenanceAction", "ads", "openAPI")
        {
        ...
        public override DescribeMaintenanceActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeMaintenanceActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
