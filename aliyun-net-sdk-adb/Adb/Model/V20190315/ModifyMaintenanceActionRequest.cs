...
{
    public class ModifyMaintenanceActionRequest : RpcAcsRequest<ModifyMaintenanceActionResponse>
    {
        public ModifyMaintenanceActionRequest()
            : base("adb", "2019-03-15", "ModifyMaintenanceAction", "ads", "openAPI")
        {
        ...
        public override ModifyMaintenanceActionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMaintenanceActionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
