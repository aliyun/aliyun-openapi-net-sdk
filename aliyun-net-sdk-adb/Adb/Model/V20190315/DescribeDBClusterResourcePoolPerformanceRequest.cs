...
{
    public class DescribeDBClusterResourcePoolPerformanceRequest : RpcAcsRequest<DescribeDBClusterResourcePoolPerformanceResponse>
    {
        public DescribeDBClusterResourcePoolPerformanceRequest()
            : base("adb", "2019-03-15", "DescribeDBClusterResourcePoolPerformance", "ads", "openAPI")
        {
        ...
        public override DescribeDBClusterResourcePoolPerformanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBClusterResourcePoolPerformanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
