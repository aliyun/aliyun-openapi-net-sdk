...
{
    public class DescribeTableStatisticsRequest : RpcAcsRequest<DescribeTableStatisticsResponse>
    {
        public DescribeTableStatisticsRequest()
            : base("adb", "2019-03-15", "DescribeTableStatistics", "ads", "openAPI")
        {
        ...
        public override DescribeTableStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTableStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
