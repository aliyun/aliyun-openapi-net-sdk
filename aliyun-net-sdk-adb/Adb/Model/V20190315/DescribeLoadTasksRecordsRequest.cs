...
{
    public class DescribeLoadTasksRecordsRequest : RpcAcsRequest<DescribeLoadTasksRecordsResponse>
    {
        public DescribeLoadTasksRecordsRequest()
            : base("adb", "2019-03-15", "DescribeLoadTasksRecords", "ads", "openAPI")
        {
        ...
        public override DescribeLoadTasksRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeLoadTasksRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
