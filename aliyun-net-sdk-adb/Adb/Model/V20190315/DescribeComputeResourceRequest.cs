...
namespace Aliyun.Acs.adb.Model.V20190315
{
    public class DescribeComputeResourceRequest : RpcAcsRequest<DescribeComputeResourceResponse>
    {
        ...
        public override DescribeComputeResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeComputeResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
