...
{
    public class DescribeSqlPatternRequest : RpcAcsRequest<DescribeSqlPatternResponse>
    {
        public DescribeSqlPatternRequest()
            : base("adb", "2019-03-15", "DescribeSqlPattern", "ads", "openAPI")
        {
		...
		public string SqlPattern
		{
			...
			{
				sqlPattern = value;
				DictionaryUtil.Add(QueryParameters, "SqlPattern", value);
			}
		}
        ...
        public override DescribeSqlPatternResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSqlPatternResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
