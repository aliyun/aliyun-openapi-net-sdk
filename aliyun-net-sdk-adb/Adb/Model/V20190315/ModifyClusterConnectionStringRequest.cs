...
{
    public class ModifyClusterConnectionStringRequest : RpcAcsRequest<ModifyClusterConnectionStringResponse>
    {
        public ModifyClusterConnectionStringRequest()
            : base("adb", "2019-03-15", "ModifyClusterConnectionString", "ads", "openAPI")
        {
        ...
        public override ModifyClusterConnectionStringResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyClusterConnectionStringResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
