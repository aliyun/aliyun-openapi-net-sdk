...
{
    public class DescribeSQLPlanTaskRequest : RpcAcsRequest<DescribeSQLPlanTaskResponse>
    {
        public DescribeSQLPlanTaskRequest()
            : base("adb", "2019-03-15", "DescribeSQLPlanTask", "ads", "openAPI")
        {
        ...
        public override DescribeSQLPlanTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLPlanTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
