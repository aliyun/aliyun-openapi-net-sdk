...
{
    public class DescribeElasticDailyPlanRequest : RpcAcsRequest<DescribeElasticDailyPlanResponse>
    {
        public DescribeElasticDailyPlanRequest()
            : base("adb", "2019-03-15", "DescribeElasticDailyPlan", "ads", "openAPI")
        {
		...
		public string ElasticDailyPlanStatusList
		{
			...
			set	
			{
				elasticDailyPlanStatusList = value;
				DictionaryUtil.Add(QueryParameters, "ElasticDailyPlanStatusList", value);
			}
		}
		...
		public string ElasticDailyPlanDay
		{
			...
			set	
			{
				elasticDailyPlanDay = value;
				DictionaryUtil.Add(QueryParameters, "ElasticDailyPlanDay", value);
			}
		}
        ...
        public override DescribeElasticDailyPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeElasticDailyPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
