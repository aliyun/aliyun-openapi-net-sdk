...
{
    public class DescribeSQLPlanRequest : RpcAcsRequest<DescribeSQLPlanResponse>
    {
        public DescribeSQLPlanRequest()
            : base("adb", "2019-03-15", "DescribeSQLPlan", "ads", "openAPI")
        {
        ...
        public override DescribeSQLPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSQLPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
