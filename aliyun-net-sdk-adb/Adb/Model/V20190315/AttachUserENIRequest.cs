...
{
    public class AttachUserENIRequest : RpcAcsRequest<AttachUserENIResponse>
    {
        public AttachUserENIRequest()
            : base("adb", "2019-03-15", "AttachUserENI", "ads", "openAPI")
        {
        ...
        public override AttachUserENIResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AttachUserENIResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
