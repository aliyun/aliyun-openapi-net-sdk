...
{
    public class DeleteElasticPlanRequest : RpcAcsRequest<DeleteElasticPlanResponse>
    {
        public DeleteElasticPlanRequest()
            : base("adb", "2019-03-15", "DeleteElasticPlan", "ads", "openAPI")
        {
        ...
        public override DeleteElasticPlanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteElasticPlanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
