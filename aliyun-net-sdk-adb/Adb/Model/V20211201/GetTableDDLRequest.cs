...
{
    public class GetTableDDLRequest : RpcAcsRequest<GetTableDDLResponse>
    {
        public GetTableDDLRequest()
            : base("adb", "2021-12-01", "GetTableDDL", "ads", "openAPI")
        {
        ...
        public override GetTableDDLResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTableDDLResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
