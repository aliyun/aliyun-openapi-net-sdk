...
{
    public class UpdateSparkTemplateFileRequest : RpcAcsRequest<UpdateSparkTemplateFileResponse>
    {
        public UpdateSparkTemplateFileRequest()
            : base("adb", "2021-12-01", "UpdateSparkTemplateFile", "ads", "openAPI")
        {
        ...
        public override UpdateSparkTemplateFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateSparkTemplateFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
