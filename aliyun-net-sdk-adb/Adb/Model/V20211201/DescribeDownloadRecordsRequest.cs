...
{
    public class DescribeDownloadRecordsRequest : RpcAcsRequest<DescribeDownloadRecordsResponse>
    {
        public DescribeDownloadRecordsRequest()
            : base("adb", "2021-12-01", "DescribeDownloadRecords", "ads", "openAPI")
        {
        ...
        public override DescribeDownloadRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDownloadRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
