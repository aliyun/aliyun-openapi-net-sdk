...
{
    public class ModifyDBResourceGroupRequest : RpcAcsRequest<ModifyDBResourceGroupResponse>
    {
        public ModifyDBResourceGroupRequest()
            : base("adb", "2021-12-01", "ModifyDBResourceGroup", "ads", "openAPI")
        {
		...
		public string MinComputeResource
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MinComputeResource", value);
			}
		}
		...
		public string MaxComputeResource
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MaxComputeResource", value);
			}
		}
        ...
        public override ModifyDBResourceGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDBResourceGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
