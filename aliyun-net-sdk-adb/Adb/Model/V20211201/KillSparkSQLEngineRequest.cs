...
{
    public class KillSparkSQLEngineRequest : RpcAcsRequest<KillSparkSQLEngineResponse>
    {
        public KillSparkSQLEngineRequest()
            : base("adb", "2021-12-01", "KillSparkSQLEngine", "ads", "openAPI")
        {
        ...
        public override KillSparkSQLEngineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return KillSparkSQLEngineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
