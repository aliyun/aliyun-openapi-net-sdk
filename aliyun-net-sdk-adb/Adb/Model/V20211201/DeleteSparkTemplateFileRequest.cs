...
{
    public class DeleteSparkTemplateFileRequest : RpcAcsRequest<DeleteSparkTemplateFileResponse>
    {
        public DeleteSparkTemplateFileRequest()
            : base("adb", "2021-12-01", "DeleteSparkTemplateFile", "ads", "openAPI")
        {
        ...
        public override DeleteSparkTemplateFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSparkTemplateFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
