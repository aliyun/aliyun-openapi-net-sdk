...
{
    public class PreloadSparkAppMetricsRequest : RpcAcsRequest<PreloadSparkAppMetricsResponse>
    {
        public PreloadSparkAppMetricsRequest()
            : base("adb", "2021-12-01", "PreloadSparkAppMetrics", "ads", "openAPI")
        {
        ...
        public override PreloadSparkAppMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PreloadSparkAppMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
