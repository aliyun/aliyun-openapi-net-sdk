...
{
    public class GetSparkAppWebUiAddressRequest : RpcAcsRequest<GetSparkAppWebUiAddressResponse>
    {
        public GetSparkAppWebUiAddressRequest()
            : base("adb", "2021-12-01", "GetSparkAppWebUiAddress", "ads", "openAPI")
        {
        ...
        public override GetSparkAppWebUiAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkAppWebUiAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
