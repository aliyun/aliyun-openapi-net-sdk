...
{
	public class SubmitSparkLogAnalyzeTaskResponse : AcsResponse
	{

		private string requestId;

		private SubmitSparkLogAnalyzeTask_Data data;
		...
		public SubmitSparkLogAnalyzeTask_Data Data
		{
			get
			{
				return data;
		...
		public class SubmitSparkLogAnalyzeTask_Data
		{
			...
			private SubmitSparkLogAnalyzeTask_Result result;
			...
			public SubmitSparkLogAnalyzeTask_Result Result
			{
				get
				{
					return result;
			...
			public class SubmitSparkLogAnalyzeTask_Result
			{
