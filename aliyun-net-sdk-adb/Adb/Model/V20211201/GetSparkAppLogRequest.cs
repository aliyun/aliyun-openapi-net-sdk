...
{
    public class GetSparkAppLogRequest : RpcAcsRequest<GetSparkAppLogResponse>
    {
        public GetSparkAppLogRequest()
            : base("adb", "2021-12-01", "GetSparkAppLog", "ads", "openAPI")
        {
        ...
        public override GetSparkAppLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkAppLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
