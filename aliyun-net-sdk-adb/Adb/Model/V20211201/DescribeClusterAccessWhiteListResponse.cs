...
{
	public class DescribeClusterAccessWhiteListResponse : AcsResponse
	{

		private string requestId;

		private List<DescribeClusterAccessWhiteList_IPArray> items;
		...
		public List<DescribeClusterAccessWhiteList_IPArray> Items
		{
			get
			{
				return items;
		...
		public class DescribeClusterAccessWhiteList_IPArray
		{
