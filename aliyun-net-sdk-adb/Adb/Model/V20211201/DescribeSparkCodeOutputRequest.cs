...
{
    public class DescribeSparkCodeOutputRequest : RpcAcsRequest<DescribeSparkCodeOutputResponse>
    {
        public DescribeSparkCodeOutputRequest()
            : base("adb", "2021-12-01", "DescribeSparkCodeOutput", "ads", "openAPI")
        {
        ...
        public override DescribeSparkCodeOutputResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSparkCodeOutputResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
