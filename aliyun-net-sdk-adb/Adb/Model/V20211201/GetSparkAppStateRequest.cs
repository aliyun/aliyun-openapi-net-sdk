...
{
    public class GetSparkAppStateRequest : RpcAcsRequest<GetSparkAppStateResponse>
    {
        public GetSparkAppStateRequest()
            : base("adb", "2021-12-01", "GetSparkAppState", "ads", "openAPI")
        {
        ...
        public override GetSparkAppStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkAppStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
