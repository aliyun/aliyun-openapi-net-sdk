...
{
    public class DeleteSparkTemplateRequest : RpcAcsRequest<DeleteSparkTemplateResponse>
    {
        public DeleteSparkTemplateRequest()
            : base("adb", "2021-12-01", "DeleteSparkTemplate", "ads", "openAPI")
        {
        ...
        public override DeleteSparkTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSparkTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
