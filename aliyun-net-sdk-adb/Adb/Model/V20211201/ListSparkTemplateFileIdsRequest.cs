...
{
    public class ListSparkTemplateFileIdsRequest : RpcAcsRequest<ListSparkTemplateFileIdsResponse>
    {
        public ListSparkTemplateFileIdsRequest()
            : base("adb", "2021-12-01", "ListSparkTemplateFileIds", "ads", "openAPI")
        {
        ...
        public override ListSparkTemplateFileIdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSparkTemplateFileIdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
