...
{
    public class GetSparkTemplateFullTreeRequest : RpcAcsRequest<GetSparkTemplateFullTreeResponse>
    {
        public GetSparkTemplateFullTreeRequest()
            : base("adb", "2021-12-01", "GetSparkTemplateFullTree", "ads", "openAPI")
        {
        ...
        public override GetSparkTemplateFullTreeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkTemplateFullTreeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
