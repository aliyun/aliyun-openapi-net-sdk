...
{
    public class GetViewDDLRequest : RpcAcsRequest<GetViewDDLResponse>
    {
        public GetViewDDLRequest()
            : base("adb", "2021-12-01", "GetViewDDL", "ads", "openAPI")
        {
		...
		public string ViewName
		{
			...
			{
				viewName = value;
				DictionaryUtil.Add(QueryParameters, "ViewName", value);
			}
		}
        ...
        public override GetViewDDLResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetViewDDLResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
