...
{
    public class DescribeSparkCodeLogRequest : RpcAcsRequest<DescribeSparkCodeLogResponse>
    {
        public DescribeSparkCodeLogRequest()
            : base("adb", "2021-12-01", "DescribeSparkCodeLog", "ads", "openAPI")
        {
        ...
        public override DescribeSparkCodeLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSparkCodeLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
