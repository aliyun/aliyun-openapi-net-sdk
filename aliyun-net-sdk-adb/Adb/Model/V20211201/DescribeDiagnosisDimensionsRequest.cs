...
{
    public class DescribeDiagnosisDimensionsRequest : RpcAcsRequest<DescribeDiagnosisDimensionsResponse>
    {
        public DescribeDiagnosisDimensionsRequest()
            : base("adb", "2021-12-01", "DescribeDiagnosisDimensions", "ads", "openAPI")
        {
        ...
        public override DescribeDiagnosisDimensionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDiagnosisDimensionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
