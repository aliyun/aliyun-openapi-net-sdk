...
{
    public class GetSparkConfigLogPathRequest : RpcAcsRequest<GetSparkConfigLogPathResponse>
    {
        public GetSparkConfigLogPathRequest()
            : base("adb", "2021-12-01", "GetSparkConfigLogPath", "ads", "openAPI")
        {
        ...
        public override GetSparkConfigLogPathResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkConfigLogPathResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
