...
{
    public class GetSparkAppInfoRequest : RpcAcsRequest<GetSparkAppInfoResponse>
    {
        public GetSparkAppInfoRequest()
            : base("adb", "2021-12-01", "GetSparkAppInfo", "ads", "openAPI")
        {
        ...
        public override GetSparkAppInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkAppInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
