...
{
    public class GetDatabaseObjectsRequest : RpcAcsRequest<GetDatabaseObjectsResponse>
    {
        public GetDatabaseObjectsRequest()
            : base("adb", "2021-12-01", "GetDatabaseObjects", "ads", "openAPI")
        {
		...
		public string FilterSchemaName
		{
			...
			set	
			{
				filterSchemaName = value;
				DictionaryUtil.Add(QueryParameters, "FilterSchemaName", value);
			}
		}
        ...
        public override GetDatabaseObjectsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDatabaseObjectsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
