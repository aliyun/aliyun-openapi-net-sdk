...
{
    public class ListSparkLogAnalyzeTasksRequest : RpcAcsRequest<ListSparkLogAnalyzeTasksResponse>
    {
        public ListSparkLogAnalyzeTasksRequest()
            : base("adb", "2021-12-01", "ListSparkLogAnalyzeTasks", "ads", "openAPI")
        {
        ...
        public override ListSparkLogAnalyzeTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSparkLogAnalyzeTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
