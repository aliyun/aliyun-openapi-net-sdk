...
{
    public class GetSparkLogAnalyzeTaskRequest : RpcAcsRequest<GetSparkLogAnalyzeTaskResponse>
    {
        public GetSparkLogAnalyzeTaskRequest()
            : base("adb", "2021-12-01", "GetSparkLogAnalyzeTask", "ads", "openAPI")
        {
        ...
        public override GetSparkLogAnalyzeTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkLogAnalyzeTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
