...
{
    public class DescribePatternPerformanceRequest : RpcAcsRequest<DescribePatternPerformanceResponse>
    {
        public DescribePatternPerformanceRequest()
            : base("adb", "2021-12-01", "DescribePatternPerformance", "ads", "openAPI")
        {
        ...
        public override DescribePatternPerformanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePatternPerformanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
