...
{
    public class DescribeAuditLogRecordsRequest : RpcAcsRequest<DescribeAuditLogRecordsResponse>
    {
        public DescribeAuditLogRecordsRequest()
            : base("adb", "2021-12-01", "DescribeAuditLogRecords", "ads", "openAPI")
        {
		...
		public string Succeed
		{
			...
			{
				succeed = value;
				DictionaryUtil.Add(QueryParameters, "Succeed", value);
			}
		}
        ...
        public override DescribeAuditLogRecordsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAuditLogRecordsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
