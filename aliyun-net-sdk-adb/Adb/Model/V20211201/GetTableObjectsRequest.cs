...
{
    public class GetTableObjectsRequest : RpcAcsRequest<GetTableObjectsResponse>
    {
        public GetTableObjectsRequest()
            : base("adb", "2021-12-01", "GetTableObjects", "ads", "openAPI")
        {
		...
		public string FilterTblType
		{
			...
			{
				filterTblType = value;
				DictionaryUtil.Add(QueryParameters, "FilterTblType", value);
			}
		}
		...
		public string FilterDescription
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "FilterDescription", value);
			}
		}
		...
		public string FilterTblName
		{
			...
			{
				filterTblName = value;
				DictionaryUtil.Add(QueryParameters, "FilterTblName", value);
			}
		}
        ...
        public override GetTableObjectsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTableObjectsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
