...
{
    public class DescribeAdbMySqlTablesRequest : RpcAcsRequest<DescribeAdbMySqlTablesResponse>
    {
        public DescribeAdbMySqlTablesRequest()
            : base("adb", "2021-12-01", "DescribeAdbMySqlTables", "ads", "openAPI")
        {
        ...
        public override DescribeAdbMySqlTablesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAdbMySqlTablesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
