...
{
	public class KillSparkLogAnalyzeTaskResponse : AcsResponse
	{

		private string requestId;

		private KillSparkLogAnalyzeTask_Data data;
		...
		public KillSparkLogAnalyzeTask_Data Data
		{
			get
			{
				return data;
		...
		public class KillSparkLogAnalyzeTask_Data
		{
			...
			private KillSparkLogAnalyzeTask_Result result;
			...
			public KillSparkLogAnalyzeTask_Result Result
			{
				get
				{
					return result;
			...
			public class KillSparkLogAnalyzeTask_Result
			{
