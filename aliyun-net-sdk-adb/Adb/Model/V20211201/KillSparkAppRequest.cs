...
{
    public class KillSparkAppRequest : RpcAcsRequest<KillSparkAppResponse>
    {
        public KillSparkAppRequest()
            : base("adb", "2021-12-01", "KillSparkApp", "ads", "openAPI")
        {
        ...
        public override KillSparkAppResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return KillSparkAppResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
