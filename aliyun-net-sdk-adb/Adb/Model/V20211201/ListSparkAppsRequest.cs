...
{
    public class ListSparkAppsRequest : RpcAcsRequest<ListSparkAppsResponse>
    {
        public ListSparkAppsRequest()
            : base("adb", "2021-12-01", "ListSparkApps", "ads", "openAPI")
        {
        ...
        public override ListSparkAppsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSparkAppsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
