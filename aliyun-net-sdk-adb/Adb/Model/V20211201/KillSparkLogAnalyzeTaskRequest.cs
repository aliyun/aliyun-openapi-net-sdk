...
{
    public class KillSparkLogAnalyzeTaskRequest : RpcAcsRequest<KillSparkLogAnalyzeTaskResponse>
    {
        public KillSparkLogAnalyzeTaskRequest()
            : base("adb", "2021-12-01", "KillSparkLogAnalyzeTask", "ads", "openAPI")
        {
        ...
        public override KillSparkLogAnalyzeTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return KillSparkLogAnalyzeTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
