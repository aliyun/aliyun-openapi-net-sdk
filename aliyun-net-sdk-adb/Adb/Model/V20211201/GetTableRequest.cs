...
{
    public class GetTableRequest : RpcAcsRequest<GetTableResponse>
    {
        public GetTableRequest()
            : base("adb", "2021-12-01", "GetTable", "ads", "openAPI")
        {
        ...
        public override GetTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
