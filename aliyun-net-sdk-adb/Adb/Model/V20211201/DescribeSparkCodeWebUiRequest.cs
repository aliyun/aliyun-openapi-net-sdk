...
{
    public class DescribeSparkCodeWebUiRequest : RpcAcsRequest<DescribeSparkCodeWebUiResponse>
    {
        public DescribeSparkCodeWebUiRequest()
            : base("adb", "2021-12-01", "DescribeSparkCodeWebUi", "ads", "openAPI")
        {
        ...
        public override DescribeSparkCodeWebUiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSparkCodeWebUiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
