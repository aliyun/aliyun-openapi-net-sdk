...
{
	public class GetSparkConfigLogPathResponse : AcsResponse
	{

		private string requestId;

		private GetSparkConfigLogPath_Data data;
		...
		public GetSparkConfigLogPath_Data Data
		{
			get
			{
				return data;
		...
		public class GetSparkConfigLogPath_Data
		{
