...
{
    public class CreateSparkTemplateRequest : RpcAcsRequest<CreateSparkTemplateResponse>
    {
        public CreateSparkTemplateRequest()
            : base("adb", "2021-12-01", "CreateSparkTemplate", "ads", "openAPI")
        {
        ...
        public override CreateSparkTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSparkTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
