...
{
    public class DescribeDBClusterForecastRequest : RpcAcsRequest<DescribeDBClusterForecastResponse>
    {
        public DescribeDBClusterForecastRequest()
            : base("adb", "2021-12-01", "DescribeDBClusterForecast", "ads", "openAPI")
        {
        ...
        public override DescribeDBClusterForecastResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDBClusterForecastResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
