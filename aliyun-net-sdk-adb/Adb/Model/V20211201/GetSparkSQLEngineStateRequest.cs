...
{
    public class GetSparkSQLEngineStateRequest : RpcAcsRequest<GetSparkSQLEngineStateResponse>
    {
        public GetSparkSQLEngineStateRequest()
            : base("adb", "2021-12-01", "GetSparkSQLEngineState", "ads", "openAPI")
        {
        ...
        public override GetSparkSQLEngineStateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkSQLEngineStateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
