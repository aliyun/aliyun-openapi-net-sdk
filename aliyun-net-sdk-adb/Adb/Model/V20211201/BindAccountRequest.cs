...
{
    public class BindAccountRequest : RpcAcsRequest<BindAccountResponse>
    {
        public BindAccountRequest()
            : base("adb", "2021-12-01", "BindAccount", "ads", "openAPI")
        {
		...
		public string RamUser
		{
			...
			{
				ramUser = value;
				DictionaryUtil.Add(QueryParameters, "RamUser", value);
			}
		}
        ...
        public override BindAccountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindAccountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
