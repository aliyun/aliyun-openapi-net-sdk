...
{
    public class GetSparkAppMetricsRequest : RpcAcsRequest<GetSparkAppMetricsResponse>
    {
        public GetSparkAppMetricsRequest()
            : base("adb", "2021-12-01", "GetSparkAppMetrics", "ads", "openAPI")
        {
        ...
        public override GetSparkAppMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSparkAppMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
