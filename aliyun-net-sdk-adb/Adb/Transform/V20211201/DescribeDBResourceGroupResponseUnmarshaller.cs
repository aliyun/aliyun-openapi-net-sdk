    ...
    public class DescribeDBResourceGroupResponseUnmarshaller
    {
        public static DescribeDBResourceGroupResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			for (int i = 0; i < _ctx.Length("DescribeDBResourceGroup.GroupsInfo.Length"); i++) {
				...
				poolInfo.MinComputeResource = _ctx.StringValue("DescribeDBResourceGroup.GroupsInfo["+ i +"].MinComputeResource");
				poolInfo.MaxComputeResource = _ctx.StringValue("DescribeDBResourceGroup.GroupsInfo["+ i +"].MaxComputeResource");
				poolInfo.ElasticMinComputeResource = _ctx.StringValue("DescribeDBResourceGroup.GroupsInfo["+ i +"].ElasticMinComputeResource");
				...
				poolInfo.Status = _ctx.StringValue("DescribeDBResourceGroup.GroupsInfo["+ i +"].Status");
