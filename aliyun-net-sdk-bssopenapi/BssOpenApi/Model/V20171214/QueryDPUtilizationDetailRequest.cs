...
namespace Aliyun.Acs.BssOpenApi.Model.V20171214
{
    public class QueryDPUtilizationDetailRequest : RpcAcsRequest<QueryDPUtilizationDetailResponse>
    {
        public QueryDPUtilizationDetailRequest()
            : base("BssOpenApi", "2017-12-14", "QueryDPUtilizationDetail", "bssopenapi", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "LastToken")]
		...
		[JsonProperty(PropertyName = "ProdCode")]
		...
		[JsonProperty(PropertyName = "IncludeShare")]
