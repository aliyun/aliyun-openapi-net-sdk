...
{
    public class DescribeInstanceAmortizedCostByAmortizationPeriodRequest : RpcAcsRequest<DescribeInstanceAmortizedCostByAmortizationPeriodResponse>
    {
        public DescribeInstanceAmortizedCostByAmortizationPeriodRequest()
            : base("BssOpenApi", "2017-12-14", "DescribeInstanceAmortizedCostByAmortizationPeriod", "bssopenapi", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "ConsumePeriodFilter")]
        ...
        public override DescribeInstanceAmortizedCostByAmortizationPeriodResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceAmortizedCostByAmortizationPeriodResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
