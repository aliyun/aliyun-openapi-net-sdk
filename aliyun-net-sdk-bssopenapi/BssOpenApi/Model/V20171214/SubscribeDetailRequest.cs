...
{
    public class SubscribeDetailRequest : RpcAcsRequest<SubscribeDetailResponse>
    {
        public SubscribeDetailRequest()
            : base("BssOpenApi", "2017-12-14", "SubscribeDetail")
        {
        }
        ...
        public override SubscribeDetailResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return SubscribeDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}