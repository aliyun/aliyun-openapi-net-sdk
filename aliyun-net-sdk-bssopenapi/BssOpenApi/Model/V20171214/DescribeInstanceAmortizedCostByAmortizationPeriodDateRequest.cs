...
{
    public class DescribeInstanceAmortizedCostByAmortizationPeriodDateRequest : RpcAcsRequest<DescribeInstanceAmortizedCostByAmortizationPeriodDateResponse>
    {
        public DescribeInstanceAmortizedCostByAmortizationPeriodDateRequest()
            : base("BssOpenApi", "2017-12-14", "DescribeInstanceAmortizedCostByAmortizationPeriodDate", "bssopenapi", "openAPI")
        {
		...
		[JsonProperty(PropertyName = "AmortizationDateStart")]
		public string AmortizationDateStart
		{
			...
			set	
			{
				amortizationDateStart = value;
				DictionaryUtil.Add(BodyParameters, "AmortizationDateStart", value);
			}
		}
		...
		[JsonProperty(PropertyName = "AmortizationDateEnd")]
		public string AmortizationDateEnd
		{
			...
			set	
			{
				amortizationDateEnd = value;
				DictionaryUtil.Add(BodyParameters, "AmortizationDateEnd", value);
			}
		}
        ...
        public override DescribeInstanceAmortizedCostByAmortizationPeriodDateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
