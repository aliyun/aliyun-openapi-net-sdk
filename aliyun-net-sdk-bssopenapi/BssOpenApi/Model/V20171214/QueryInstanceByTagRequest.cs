...
namespace Aliyun.Acs.BssOpenApi.Model.V20171214
{
    public class QueryInstanceByTagRequest : RpcAcsRequest<QueryInstanceByTagResponse>
    {
        ...
        public override QueryInstanceByTagResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryInstanceByTagResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
