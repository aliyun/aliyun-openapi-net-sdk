...
{
    public class DescribeInstanceAmortizedCostByConsumePeriodRequest : RpcAcsRequest<DescribeInstanceAmortizedCostByConsumePeriodResponse>
    {
        public DescribeInstanceAmortizedCostByConsumePeriodRequest()
            : base("BssOpenApi", "2017-12-14", "DescribeInstanceAmortizedCostByConsumePeriod", "bssopenapi", "openAPI")
        {
        ...
        public override DescribeInstanceAmortizedCostByConsumePeriodResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeInstanceAmortizedCostByConsumePeriodResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
