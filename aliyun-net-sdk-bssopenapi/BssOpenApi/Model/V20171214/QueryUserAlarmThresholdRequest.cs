...
{
    public class QueryUserAlarmThresholdRequest : RpcAcsRequest<QueryUserAlarmThresholdResponse>
    {
        public QueryUserAlarmThresholdRequest()
            : base("BssOpenApi", "2017-12-14", "QueryUserAlarmThreshold")
        {
        }
        ...
        public override QueryUserAlarmThresholdResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return QueryUserAlarmThresholdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}