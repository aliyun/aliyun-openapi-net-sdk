...
{
	public class DescribeProductAmortizedCostByAmortizationPeriodResponse : AcsResponse
	{
		...
		private DescribeProductAmortizedCostByAmortizationPeriod_Data data;
		...
		public DescribeProductAmortizedCostByAmortizationPeriod_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeProductAmortizedCostByAmortizationPeriod_Data
		{
			...
			private List<DescribeProductAmortizedCostByAmortizationPeriod_Item> items;
			...
			public List<DescribeProductAmortizedCostByAmortizationPeriod_Item> Items
			{
				get
				{
					return items;
			...
			public class DescribeProductAmortizedCostByAmortizationPeriod_Item
			{
