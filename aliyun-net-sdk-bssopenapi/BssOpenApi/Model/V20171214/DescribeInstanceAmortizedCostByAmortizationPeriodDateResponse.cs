...
{
	public class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponse : AcsResponse
	{
		...
		private DescribeInstanceAmortizedCostByAmortizationPeriodDate_Data data;
		...
		public DescribeInstanceAmortizedCostByAmortizationPeriodDate_Data Data
		{
			get
			{
				return data;
		...
		public class DescribeInstanceAmortizedCostByAmortizationPeriodDate_Data
		{
			...
			private List<DescribeInstanceAmortizedCostByAmortizationPeriodDate_Item> items;
			...
			public List<DescribeInstanceAmortizedCostByAmortizationPeriodDate_Item> Items
			{
				get
				{
					return items;
			...
			public class DescribeInstanceAmortizedCostByAmortizationPeriodDate_Item
			{
				...
				[JsonProperty(PropertyName = "ConsumePeriodDay")]
				...
				[JsonProperty(PropertyName = "AmortizationPeriodDay")]
