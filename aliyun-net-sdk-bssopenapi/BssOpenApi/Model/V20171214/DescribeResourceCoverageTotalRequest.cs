...
namespace Aliyun.Acs.BssOpenApi.Model.V20171214
{
    public class DescribeResourceCoverageTotalRequest : RpcAcsRequest<DescribeResourceCoverageTotalResponse>
    {
        ...
        public override DescribeResourceCoverageTotalResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeResourceCoverageTotalResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
