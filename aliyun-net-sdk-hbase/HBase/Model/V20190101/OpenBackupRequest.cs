...
{
    public class OpenBackupRequest : RpcAcsRequest<OpenBackupResponse>
    {
        public OpenBackupRequest()
            : base("HBase", "2019-01-01", "OpenBackup", "hbase", "openAPI")
        {
        ...
        public override OpenBackupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return OpenBackupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
