...
{
    public class ResizeColdStorageSizeRequest : RpcAcsRequest<ResizeColdStorageSizeResponse>
    {
        public ResizeColdStorageSizeRequest()
            : base("HBase", "2019-01-01", "ResizeColdStorageSize", "hbase", "openAPI")
        {
        ...
        public override ResizeColdStorageSizeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ResizeColdStorageSizeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
