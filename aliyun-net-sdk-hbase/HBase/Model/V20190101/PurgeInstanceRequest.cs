...
{
    public class PurgeInstanceRequest : RpcAcsRequest<PurgeInstanceResponse>
    {
        public PurgeInstanceRequest()
            : base("HBase", "2019-01-01", "PurgeInstance", "hbase", "openAPI")
        {
        ...
        public override PurgeInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PurgeInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
