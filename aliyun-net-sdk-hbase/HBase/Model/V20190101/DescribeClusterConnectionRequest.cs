...
{
    public class DescribeClusterConnectionRequest : RpcAcsRequest<DescribeClusterConnectionResponse>
    {
        public DescribeClusterConnectionRequest()
            : base("HBase", "2019-01-01", "DescribeClusterConnection", "hbase", "openAPI")
        {
