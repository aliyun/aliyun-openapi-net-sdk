...
{
    public class CheckComponentsVersionRequest : RpcAcsRequest<CheckComponentsVersionResponse>
    {
        public CheckComponentsVersionRequest()
            : base("HBase", "2019-01-01", "CheckComponentsVersion", "hbase", "openAPI")
        {
        ...
        public override CheckComponentsVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckComponentsVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
