...
{
    public class GetMultimodeCmsUrlRequest : RpcAcsRequest<GetMultimodeCmsUrlResponse>
    {
        public GetMultimodeCmsUrlRequest()
            : base("HBase", "2019-01-01", "GetMultimodeCmsUrl", "hbase", "openAPI")
        {
        ...
        public override GetMultimodeCmsUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetMultimodeCmsUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
