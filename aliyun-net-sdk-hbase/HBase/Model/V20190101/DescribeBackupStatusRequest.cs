...
{
    public class DescribeBackupStatusRequest : RpcAcsRequest<DescribeBackupStatusResponse>
    {
        public DescribeBackupStatusRequest()
            : base("HBase", "2019-01-01", "DescribeBackupStatus", "hbase", "openAPI")
        {
        ...
        public override DescribeBackupStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
