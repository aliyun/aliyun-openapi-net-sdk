...
{
    public class DescribeColdStorageRequest : RpcAcsRequest<DescribeColdStorageResponse>
    {
        public DescribeColdStorageRequest()
            : base("HBase", "2019-01-01", "DescribeColdStorage", "hbase", "openAPI")
        {
        ...
        public override DescribeColdStorageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeColdStorageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
