...
{
    public class DescribeSubDomainRequest : RpcAcsRequest<DescribeSubDomainResponse>
    {
        public DescribeSubDomainRequest()
            : base("HBase", "2019-01-01", "DescribeSubDomain", "hbase", "openAPI")
        {
        ...
        public override DescribeSubDomainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSubDomainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
