...
{
    public class CreateHBaseSlbServerRequest : RpcAcsRequest<CreateHBaseSlbServerResponse>
    {
        public CreateHBaseSlbServerRequest()
            : base("HBase", "2019-01-01", "CreateHBaseSlbServer", "hbase", "openAPI")
        {
        ...
        public override CreateHBaseSlbServerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateHBaseSlbServerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
