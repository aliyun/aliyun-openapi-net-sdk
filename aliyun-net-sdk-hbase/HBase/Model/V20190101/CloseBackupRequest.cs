...
{
    public class CloseBackupRequest : RpcAcsRequest<CloseBackupResponse>
    {
        public CloseBackupRequest()
            : base("HBase", "2019-01-01", "CloseBackup", "hbase", "openAPI")
        {
        ...
        public override CloseBackupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CloseBackupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
