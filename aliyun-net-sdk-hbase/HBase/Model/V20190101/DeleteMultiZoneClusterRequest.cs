...
{
    public class DeleteMultiZoneClusterRequest : RpcAcsRequest<DeleteMultiZoneClusterResponse>
    {
        public DeleteMultiZoneClusterRequest()
            : base("HBase", "2019-01-01", "DeleteMultiZoneCluster", "hbase", "openAPI")
        {
        ...
        public override DeleteMultiZoneClusterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMultiZoneClusterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
