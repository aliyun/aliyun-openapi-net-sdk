...
{
    public class DeleteHBaseSlbServerRequest : RpcAcsRequest<DeleteHBaseSlbServerResponse>
    {
        public DeleteHBaseSlbServerRequest()
            : base("HBase", "2019-01-01", "DeleteHBaseSlbServer", "hbase", "openAPI")
        {
		...
		public string SlbServer
		{
			...
			{
				slbServer = value;
				DictionaryUtil.Add(QueryParameters, "SlbServer", value);
			}
		}

        public override DeleteHBaseSlbServerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteHBaseSlbServerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
