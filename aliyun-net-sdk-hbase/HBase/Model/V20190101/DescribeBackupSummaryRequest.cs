...
{
    public class DescribeBackupSummaryRequest : RpcAcsRequest<DescribeBackupSummaryResponse>
    {
        public DescribeBackupSummaryRequest()
            : base("HBase", "2019-01-01", "DescribeBackupSummary", "hbase", "openAPI")
        {
        ...
        public override DescribeBackupSummaryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupSummaryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
