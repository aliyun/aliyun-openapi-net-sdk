...
{
    public class ListHBaseInstancesRequest : RpcAcsRequest<ListHBaseInstancesResponse>
    {
        public ListHBaseInstancesRequest()
            : base("HBase", "2019-01-01", "ListHBaseInstances", "hbase", "openAPI")
        {
        ...
        public override ListHBaseInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListHBaseInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
