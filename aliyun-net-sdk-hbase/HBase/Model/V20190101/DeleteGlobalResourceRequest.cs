...
{
    public class DeleteGlobalResourceRequest : RpcAcsRequest<DeleteGlobalResourceResponse>
    {
        public DeleteGlobalResourceRequest()
            : base("HBase", "2019-01-01", "DeleteGlobalResource", "hbase", "openAPI")
        {
        ...
        public override DeleteGlobalResourceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGlobalResourceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
