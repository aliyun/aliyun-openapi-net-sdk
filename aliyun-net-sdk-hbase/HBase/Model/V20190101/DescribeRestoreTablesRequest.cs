...
{
    public class DescribeRestoreTablesRequest : RpcAcsRequest<DescribeRestoreTablesResponse>
    {
        public DescribeRestoreTablesRequest()
            : base("HBase", "2019-01-01", "DescribeRestoreTables", "hbase", "openAPI")
        {
        ...
        public override DescribeRestoreTablesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRestoreTablesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
