...
{
    public class ModifyBackupPlanConfigRequest : RpcAcsRequest<ModifyBackupPlanConfigResponse>
    {
        public ModifyBackupPlanConfigRequest()
            : base("HBase", "2019-01-01", "ModifyBackupPlanConfig", "hbase", "openAPI")
        {
		...
		public string FullBackupCycle
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "FullBackupCycle", value);
			}
		}
		...
		public string MinHFileBackupCount
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "MinHFileBackupCount", value);
			}
		}
		...
		public string NextFullBackupDate
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "NextFullBackupDate", value);
			}
		}

        public override ModifyBackupPlanConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyBackupPlanConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
