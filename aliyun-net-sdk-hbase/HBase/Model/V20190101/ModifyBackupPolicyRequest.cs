...
namespace Aliyun.Acs.HBase.Model.V20190101
{
    public class ModifyBackupPolicyRequest : RpcAcsRequest<ModifyBackupPolicyResponse>
    {
        public ModifyBackupPolicyRequest()
            : base("HBase", "2019-01-01", "ModifyBackupPolicy", "hbase", "openAPI")
        {
		...
		public string PreferredBackupEndTimeUTC
		{
			...
			set	
			{
				preferredBackupEndTimeUTC = value;
				DictionaryUtil.Add(QueryParameters, "PreferredBackupEndTimeUTC", value);
			}
		}
		...
		public string PreferredBackupStartTimeUTC
		{
			...
			set	
			{
				preferredBackupStartTimeUTC = value;
				DictionaryUtil.Add(QueryParameters, "PreferredBackupStartTimeUTC", value);
			}
		}
