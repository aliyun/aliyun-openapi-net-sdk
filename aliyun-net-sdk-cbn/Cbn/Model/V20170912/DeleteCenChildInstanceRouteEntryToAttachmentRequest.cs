...
{
    public class DeleteCenChildInstanceRouteEntryToAttachmentRequest : RpcAcsRequest<DeleteCenChildInstanceRouteEntryToAttachmentResponse>
    {
        public DeleteCenChildInstanceRouteEntryToAttachmentRequest()
            : base("Cbn", "2017-09-12", "DeleteCenChildInstanceRouteEntryToAttachment", "cbn", "openAPI")
        {
        ...
        public override DeleteCenChildInstanceRouteEntryToAttachmentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCenChildInstanceRouteEntryToAttachmentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
