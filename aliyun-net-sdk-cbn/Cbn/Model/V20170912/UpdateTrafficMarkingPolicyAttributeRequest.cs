...
{
    public class UpdateTrafficMarkingPolicyAttributeRequest : RpcAcsRequest<UpdateTrafficMarkingPolicyAttributeResponse>
    {
        public UpdateTrafficMarkingPolicyAttributeRequest()
            : base("Cbn", "2017-09-12", "UpdateTrafficMarkingPolicyAttribute", "cbn", "openAPI")
        {
        ...
        public override UpdateTrafficMarkingPolicyAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTrafficMarkingPolicyAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
