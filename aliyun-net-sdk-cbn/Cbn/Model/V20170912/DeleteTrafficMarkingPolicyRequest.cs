...
{
    public class DeleteTrafficMarkingPolicyRequest : RpcAcsRequest<DeleteTrafficMarkingPolicyResponse>
    {
        public DeleteTrafficMarkingPolicyRequest()
            : base("Cbn", "2017-09-12", "DeleteTrafficMarkingPolicy", "cbn", "openAPI")
        {
        ...
        public override DeleteTrafficMarkingPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTrafficMarkingPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
