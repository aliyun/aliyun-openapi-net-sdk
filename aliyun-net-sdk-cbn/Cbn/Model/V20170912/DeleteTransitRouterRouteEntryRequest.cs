...
{
    public class DeleteTransitRouterRouteEntryRequest : RpcAcsRequest<DeleteTransitRouterRouteEntryResponse>
    {
        public DeleteTransitRouterRouteEntryRequest()
            : base("Cbn", "2017-09-12", "DeleteTransitRouterRouteEntry", "cbn", "openAPI")
        {
        ...
        public override DeleteTransitRouterRouteEntryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTransitRouterRouteEntryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
