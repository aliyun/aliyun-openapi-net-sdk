...
{
    public class GrantInstanceToTransitRouterRequest : RpcAcsRequest<GrantInstanceToTransitRouterResponse>
    {
        public GrantInstanceToTransitRouterRequest()
            : base("Cbn", "2017-09-12", "GrantInstanceToTransitRouter", "cbn", "openAPI")
        {
        ...
        public override GrantInstanceToTransitRouterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GrantInstanceToTransitRouterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
