...
{
    public class DeleteCenRouteMapRequest : RpcAcsRequest<DeleteCenRouteMapResponse>
    {
        public DeleteCenRouteMapRequest()
            : base("Cbn", "2017-09-12", "DeleteCenRouteMap", "cbn", "openAPI")
        {
        ...
        public override DeleteCenRouteMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCenRouteMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
