...
{
    public class ListTransitRouterPeerAttachmentsRequest : RpcAcsRequest<ListTransitRouterPeerAttachmentsResponse>
    {
        public ListTransitRouterPeerAttachmentsRequest()
            : base("Cbn", "2017-09-12", "ListTransitRouterPeerAttachments", "cbn", "openAPI")
        {
        ...
        public override ListTransitRouterPeerAttachmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTransitRouterPeerAttachmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
