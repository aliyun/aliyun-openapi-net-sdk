...
{
    public class ListTransitRoutersRequest : RpcAcsRequest<ListTransitRoutersResponse>
    {
        public ListTransitRoutersRequest()
            : base("Cbn", "2017-09-12", "ListTransitRouters", "cbn", "openAPI")
        {
        ...
        public override ListTransitRoutersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTransitRoutersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
