...
{
    public class DissociateTransitRouterAttachmentFromRouteTableRequest : RpcAcsRequest<DissociateTransitRouterAttachmentFromRouteTableResponse>
    {
        public DissociateTransitRouterAttachmentFromRouteTableRequest()
            : base("Cbn", "2017-09-12", "DissociateTransitRouterAttachmentFromRouteTable", "cbn", "openAPI")
        {
        ...
        public override DissociateTransitRouterAttachmentFromRouteTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DissociateTransitRouterAttachmentFromRouteTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
