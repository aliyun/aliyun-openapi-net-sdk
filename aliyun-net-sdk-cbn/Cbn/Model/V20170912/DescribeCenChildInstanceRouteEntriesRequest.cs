...
{
    public class DescribeCenChildInstanceRouteEntriesRequest : RpcAcsRequest<DescribeCenChildInstanceRouteEntriesResponse>
    {
        public DescribeCenChildInstanceRouteEntriesRequest()
            : base("Cbn", "2017-09-12", "DescribeCenChildInstanceRouteEntries")
        {
        ...
        public override DescribeCenChildInstanceRouteEntriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeCenChildInstanceRouteEntriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
