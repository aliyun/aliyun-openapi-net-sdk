...
{
    public class TempUpgradeCenBandwidthPackageSpecRequest : RpcAcsRequest<TempUpgradeCenBandwidthPackageSpecResponse>
    {
        public TempUpgradeCenBandwidthPackageSpecRequest()
            : base("Cbn", "2017-09-12", "TempUpgradeCenBandwidthPackageSpec", "cbn", "openAPI")
        {
        ...
        public override TempUpgradeCenBandwidthPackageSpecResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TempUpgradeCenBandwidthPackageSpecResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
