...
{
    public class AssociateTransitRouterMulticastDomainRequest : RpcAcsRequest<AssociateTransitRouterMulticastDomainResponse>
    {
        public AssociateTransitRouterMulticastDomainRequest()
            : base("Cbn", "2017-09-12", "AssociateTransitRouterMulticastDomain", "cbn", "openAPI")
        {
        ...
        public override AssociateTransitRouterMulticastDomainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssociateTransitRouterMulticastDomainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
