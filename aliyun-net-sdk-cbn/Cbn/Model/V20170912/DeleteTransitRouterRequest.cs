...
{
    public class DeleteTransitRouterRequest : RpcAcsRequest<DeleteTransitRouterResponse>
    {
        public DeleteTransitRouterRequest()
            : base("Cbn", "2017-09-12", "DeleteTransitRouter", "cbn", "openAPI")
        {
        ...
        public override DeleteTransitRouterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteTransitRouterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
