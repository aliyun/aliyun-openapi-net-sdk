...
{
    public class ModifyCenRouteMapRequest : RpcAcsRequest<ModifyCenRouteMapResponse>
    {
        public ModifyCenRouteMapRequest()
            : base("Cbn", "2017-09-12", "ModifyCenRouteMap", "cbn", "openAPI")
        {
		...
		private List<int?> matchAsnss = new List<int?>(){ };
        ...
        public override ModifyCenRouteMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyCenRouteMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
