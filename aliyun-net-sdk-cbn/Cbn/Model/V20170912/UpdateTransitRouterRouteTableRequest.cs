...
{
    public class UpdateTransitRouterRouteTableRequest : RpcAcsRequest<UpdateTransitRouterRouteTableResponse>
    {
        public UpdateTransitRouterRouteTableRequest()
            : base("Cbn", "2017-09-12", "UpdateTransitRouterRouteTable", "cbn", "openAPI")
        {
		...
		public string TransitRouterRouteTableDescription
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "TransitRouterRouteTableDescription", value);
			}
		}
		...
		public string TransitRouterRouteTableName
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "TransitRouterRouteTableName", value);
			}
		}
        ...
        public override UpdateTransitRouterRouteTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTransitRouterRouteTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
