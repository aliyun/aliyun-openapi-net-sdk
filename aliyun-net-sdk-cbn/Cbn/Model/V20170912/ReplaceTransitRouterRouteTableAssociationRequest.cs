...
{
    public class ReplaceTransitRouterRouteTableAssociationRequest : RpcAcsRequest<ReplaceTransitRouterRouteTableAssociationResponse>
    {
        public ReplaceTransitRouterRouteTableAssociationRequest()
            : base("Cbn", "2017-09-12", "ReplaceTransitRouterRouteTableAssociation", "cbn", "openAPI")
        {
        ...
        public override ReplaceTransitRouterRouteTableAssociationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReplaceTransitRouterRouteTableAssociationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
