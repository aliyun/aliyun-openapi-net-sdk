...
{
    public class RegisterTransitRouterMulticastGroupSourcesRequest : RpcAcsRequest<RegisterTransitRouterMulticastGroupSourcesResponse>
    {
        public RegisterTransitRouterMulticastGroupSourcesRequest()
            : base("Cbn", "2017-09-12", "RegisterTransitRouterMulticastGroupSources", "cbn", "openAPI")
        {
        ...
        public override RegisterTransitRouterMulticastGroupSourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RegisterTransitRouterMulticastGroupSourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
