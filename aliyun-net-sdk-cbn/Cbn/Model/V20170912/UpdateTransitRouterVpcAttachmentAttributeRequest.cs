...
{
    public class UpdateTransitRouterVpcAttachmentAttributeRequest : RpcAcsRequest<UpdateTransitRouterVpcAttachmentAttributeResponse>
    {
        public UpdateTransitRouterVpcAttachmentAttributeRequest()
            : base("Cbn", "2017-09-12", "UpdateTransitRouterVpcAttachmentAttribute", "cbn", "openAPI")
        {
        ...
        public override UpdateTransitRouterVpcAttachmentAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTransitRouterVpcAttachmentAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
