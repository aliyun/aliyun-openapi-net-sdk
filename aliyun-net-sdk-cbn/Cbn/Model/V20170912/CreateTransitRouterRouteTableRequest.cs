...
{
    public class CreateTransitRouterRouteTableRequest : RpcAcsRequest<CreateTransitRouterRouteTableResponse>
    {
        public CreateTransitRouterRouteTableRequest()
            : base("Cbn", "2017-09-12", "CreateTransitRouterRouteTable", "cbn", "openAPI")
        {
        ...
        public override CreateTransitRouterRouteTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTransitRouterRouteTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
