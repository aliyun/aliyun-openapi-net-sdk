...
{
    public class UpdateTransitRouterRequest : RpcAcsRequest<UpdateTransitRouterResponse>
    {
        public UpdateTransitRouterRequest()
            : base("Cbn", "2017-09-12", "UpdateTransitRouter", "cbn", "openAPI")
        {
        ...
        public override UpdateTransitRouterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTransitRouterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
