...
{
    public class CreateCenChildInstanceRouteEntryToCenRequest : RpcAcsRequest<CreateCenChildInstanceRouteEntryToCenResponse>
    {
        public CreateCenChildInstanceRouteEntryToCenRequest()
            : base("Cbn", "2017-09-12", "CreateCenChildInstanceRouteEntryToCen", "cbn", "openAPI")
        {
        ...
        public override CreateCenChildInstanceRouteEntryToCenResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateCenChildInstanceRouteEntryToCenResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
