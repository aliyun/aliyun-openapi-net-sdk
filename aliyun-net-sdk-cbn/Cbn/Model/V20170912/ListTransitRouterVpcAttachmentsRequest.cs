...
{
    public class ListTransitRouterVpcAttachmentsRequest : RpcAcsRequest<ListTransitRouterVpcAttachmentsResponse>
    {
        public ListTransitRouterVpcAttachmentsRequest()
            : base("Cbn", "2017-09-12", "ListTransitRouterVpcAttachments", "cbn", "openAPI")
        {
        ...
        public override ListTransitRouterVpcAttachmentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTransitRouterVpcAttachmentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
