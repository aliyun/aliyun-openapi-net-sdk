...
{
    public class DeleteCenInterRegionTrafficQosPolicyRequest : RpcAcsRequest<DeleteCenInterRegionTrafficQosPolicyResponse>
    {
        public DeleteCenInterRegionTrafficQosPolicyRequest()
            : base("Cbn", "2017-09-12", "DeleteCenInterRegionTrafficQosPolicy", "cbn", "openAPI")
        {
        ...
        public override DeleteCenInterRegionTrafficQosPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteCenInterRegionTrafficQosPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
