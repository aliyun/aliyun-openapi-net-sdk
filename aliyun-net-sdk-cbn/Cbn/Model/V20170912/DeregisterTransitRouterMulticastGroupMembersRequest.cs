...
{
    public class DeregisterTransitRouterMulticastGroupMembersRequest : RpcAcsRequest<DeregisterTransitRouterMulticastGroupMembersResponse>
    {
        public DeregisterTransitRouterMulticastGroupMembersRequest()
            : base("Cbn", "2017-09-12", "DeregisterTransitRouterMulticastGroupMembers", "cbn", "openAPI")
        {
        ...
        public override DeregisterTransitRouterMulticastGroupMembersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeregisterTransitRouterMulticastGroupMembersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
