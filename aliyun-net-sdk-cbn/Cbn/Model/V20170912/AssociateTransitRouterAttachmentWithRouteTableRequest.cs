...
{
    public class AssociateTransitRouterAttachmentWithRouteTableRequest : RpcAcsRequest<AssociateTransitRouterAttachmentWithRouteTableResponse>
    {
        public AssociateTransitRouterAttachmentWithRouteTableRequest()
            : base("Cbn", "2017-09-12", "AssociateTransitRouterAttachmentWithRouteTable", "cbn", "openAPI")
        {
        ...
        public override AssociateTransitRouterAttachmentWithRouteTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AssociateTransitRouterAttachmentWithRouteTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
