...
{
    public class DisableTransitRouterRouteTablePropagationRequest : RpcAcsRequest<DisableTransitRouterRouteTablePropagationResponse>
    {
        public DisableTransitRouterRouteTablePropagationRequest()
            : base("Cbn", "2017-09-12", "DisableTransitRouterRouteTablePropagation", "cbn", "openAPI")
        {
        ...
        public override DisableTransitRouterRouteTablePropagationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableTransitRouterRouteTablePropagationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
