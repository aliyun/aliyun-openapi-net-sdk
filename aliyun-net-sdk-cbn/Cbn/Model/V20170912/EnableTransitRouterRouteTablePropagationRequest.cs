...
{
    public class EnableTransitRouterRouteTablePropagationRequest : RpcAcsRequest<EnableTransitRouterRouteTablePropagationResponse>
    {
        public EnableTransitRouterRouteTablePropagationRequest()
            : base("Cbn", "2017-09-12", "EnableTransitRouterRouteTablePropagation", "cbn", "openAPI")
        {
        ...
        public override EnableTransitRouterRouteTablePropagationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableTransitRouterRouteTablePropagationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
