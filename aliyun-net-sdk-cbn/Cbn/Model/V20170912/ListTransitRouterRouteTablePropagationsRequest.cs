...
{
    public class ListTransitRouterRouteTablePropagationsRequest : RpcAcsRequest<ListTransitRouterRouteTablePropagationsResponse>
    {
        public ListTransitRouterRouteTablePropagationsRequest()
            : base("Cbn", "2017-09-12", "ListTransitRouterRouteTablePropagations", "cbn", "openAPI")
        {
        ...
        public override ListTransitRouterRouteTablePropagationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListTransitRouterRouteTablePropagationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
