...
{
    public class ListCenInterRegionTrafficQosPoliciesRequest : RpcAcsRequest<ListCenInterRegionTrafficQosPoliciesResponse>
    {
        public ListCenInterRegionTrafficQosPoliciesRequest()
            : base("Cbn", "2017-09-12", "ListCenInterRegionTrafficQosPolicies", "cbn", "openAPI")
        {
        ...
        public override ListCenInterRegionTrafficQosPoliciesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListCenInterRegionTrafficQosPoliciesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
