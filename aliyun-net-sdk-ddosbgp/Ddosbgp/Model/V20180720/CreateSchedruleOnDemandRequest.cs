...
{
    public class CreateSchedruleOnDemandRequest : RpcAcsRequest<CreateSchedruleOnDemandResponse>
    {
        public CreateSchedruleOnDemandRequest()
            : base("ddosbgp", "2018-07-20", "CreateSchedruleOnDemand")
        {
        ...
        public override CreateSchedruleOnDemandResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSchedruleOnDemandResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
