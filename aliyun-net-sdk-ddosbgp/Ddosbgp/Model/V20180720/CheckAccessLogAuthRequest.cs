...
{
    public class CheckAccessLogAuthRequest : RpcAcsRequest<CheckAccessLogAuthResponse>
    {
        public CheckAccessLogAuthRequest()
            : base("ddosbgp", "2018-07-20", "CheckAccessLogAuth")
        {
        ...
        public override CheckAccessLogAuthResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckAccessLogAuthResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
