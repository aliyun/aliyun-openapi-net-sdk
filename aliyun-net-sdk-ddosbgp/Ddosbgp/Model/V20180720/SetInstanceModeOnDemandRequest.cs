...
{
    public class SetInstanceModeOnDemandRequest : RpcAcsRequest<SetInstanceModeOnDemandResponse>
    {
        public SetInstanceModeOnDemandRequest()
            : base("ddosbgp", "2018-07-20", "SetInstanceModeOnDemand")
        {
        ...
        public override SetInstanceModeOnDemandResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetInstanceModeOnDemandResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
