...
{
    public class AddIpRequest : RpcAcsRequest<AddIpResponse>
    {
        public AddIpRequest()
            : base("ddosbgp", "2018-07-20", "AddIp")
        {
        ...
        public override AddIpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddIpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
