...
{
    public class GetSlsOpenStatusRequest : RpcAcsRequest<GetSlsOpenStatusResponse>
    {
        public GetSlsOpenStatusRequest()
            : base("ddosbgp", "2018-07-20", "GetSlsOpenStatus")
        {
        ...
        public override GetSlsOpenStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSlsOpenStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
