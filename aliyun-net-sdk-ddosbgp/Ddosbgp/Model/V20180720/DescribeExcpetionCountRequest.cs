...
{
    public class DescribeExcpetionCountRequest : RpcAcsRequest<DescribeExcpetionCountResponse>
    {
        public DescribeExcpetionCountRequest()
            : base("ddosbgp", "2018-07-20", "DescribeExcpetionCount")
        {
        ...
        public override DescribeExcpetionCountResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeExcpetionCountResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
