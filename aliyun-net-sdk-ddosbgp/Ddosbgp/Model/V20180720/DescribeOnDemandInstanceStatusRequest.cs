...
{
    public class DescribeOnDemandInstanceStatusRequest : RpcAcsRequest<DescribeOnDemandInstanceStatusResponse>
    {
        public DescribeOnDemandInstanceStatusRequest()
            : base("ddosbgp", "2018-07-20", "DescribeOnDemandInstanceStatus")
        {
        ...
        public override DescribeOnDemandInstanceStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOnDemandInstanceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
