...
{
    public class DeleteBlackholeRequest : RpcAcsRequest<DeleteBlackholeResponse>
    {
        public DeleteBlackholeRequest()
            : base("ddosbgp", "2018-07-20", "DeleteBlackhole")
        {
        ...
        public override DeleteBlackholeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteBlackholeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
