...
{
    public class ModifyRemarkRequest : RpcAcsRequest<ModifyRemarkResponse>
    {
        public ModifyRemarkRequest()
            : base("ddosbgp", "2018-07-20", "ModifyRemark")
        {
        ...
        public override ModifyRemarkResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyRemarkResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
