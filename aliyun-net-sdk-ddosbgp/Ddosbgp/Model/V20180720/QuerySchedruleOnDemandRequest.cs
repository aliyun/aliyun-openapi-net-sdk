...
{
    public class QuerySchedruleOnDemandRequest : RpcAcsRequest<QuerySchedruleOnDemandResponse>
    {
        public QuerySchedruleOnDemandRequest()
            : base("ddosbgp", "2018-07-20", "QuerySchedruleOnDemand")
        {
        ...
        public override QuerySchedruleOnDemandResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QuerySchedruleOnDemandResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
