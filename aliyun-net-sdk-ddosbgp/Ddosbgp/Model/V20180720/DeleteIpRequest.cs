...
{
    public class DeleteIpRequest : RpcAcsRequest<DeleteIpResponse>
    {
        public DeleteIpRequest()
            : base("ddosbgp", "2018-07-20", "DeleteIp")
        {
        ...
        public override DeleteIpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteIpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
