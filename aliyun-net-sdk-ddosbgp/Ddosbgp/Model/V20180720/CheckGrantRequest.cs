...
{
    public class CheckGrantRequest : RpcAcsRequest<CheckGrantResponse>
    {
        public CheckGrantRequest()
            : base("ddosbgp", "2018-07-20", "CheckGrant")
        {
        ...
        public override CheckGrantResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CheckGrantResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
