...
{
    public class DescribePackIpListRequest : RpcAcsRequest<DescribePackIpListResponse>
    {
        public DescribePackIpListRequest()
            : base("ddosbgp", "2018-07-20", "DescribePackIpList")
        {
        ...
        public override DescribePackIpListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribePackIpListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
