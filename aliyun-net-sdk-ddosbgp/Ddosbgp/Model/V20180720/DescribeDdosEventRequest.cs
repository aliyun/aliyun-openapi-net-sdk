...
{
    public class DescribeDdosEventRequest : RpcAcsRequest<DescribeDdosEventResponse>
    {
        public DescribeDdosEventRequest()
            : base("ddosbgp", "2018-07-20", "DescribeDdosEvent")
        {
        ...
        public override DescribeDdosEventResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDdosEventResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
