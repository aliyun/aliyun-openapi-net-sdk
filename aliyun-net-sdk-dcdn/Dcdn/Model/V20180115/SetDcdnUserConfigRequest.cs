...
{
    public class SetDcdnUserConfigRequest : RpcAcsRequest<SetDcdnUserConfigResponse>
    {
        public SetDcdnUserConfigRequest()
            : base("dcdn", "2018-01-15", "SetDcdnUserConfig")
        {
		...
		public string Configs
		{
			...
			{
				configs = value;
				DictionaryUtil.Add(QueryParameters, "Configs", value);
			}
		}
        ...
        public override SetDcdnUserConfigResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SetDcdnUserConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
