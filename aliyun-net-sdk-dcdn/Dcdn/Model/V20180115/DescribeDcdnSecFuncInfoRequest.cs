...
{
    public class DescribeDcdnSecFuncInfoRequest : RpcAcsRequest<DescribeDcdnSecFuncInfoResponse>
    {
        public DescribeDcdnSecFuncInfoRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnSecFuncInfo")
        {
		...
		public string SecFuncType
		{
			...
			{
				secFuncType = value;
				DictionaryUtil.Add(QueryParameters, "SecFuncType", value);
			}
		}
        ...
        public override DescribeDcdnSecFuncInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnSecFuncInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
