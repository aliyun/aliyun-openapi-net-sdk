...
{
    public class PublishRoutineCodeRevisionRequest : RpcAcsRequest<PublishRoutineCodeRevisionResponse>
    {
        public PublishRoutineCodeRevisionRequest()
            : base("dcdn", "2018-01-15", "PublishRoutineCodeRevision")
        {
        ...
        public override PublishRoutineCodeRevisionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PublishRoutineCodeRevisionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
