...
namespace Aliyun.Acs.dcdn.Model.V20180115
{
    public class DescribeDcdnDomainBpsDataRequest : RpcAcsRequest<DescribeDcdnDomainBpsDataResponse>
    {
        public DescribeDcdnDomainBpsDataRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnDomainBpsData", "dcdn", "openAPI")
        {
        }
        ...
        public override DescribeDcdnDomainBpsDataResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
