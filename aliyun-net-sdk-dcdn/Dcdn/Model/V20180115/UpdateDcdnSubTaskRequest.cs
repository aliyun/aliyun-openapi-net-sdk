...
{
    public class UpdateDcdnSubTaskRequest : RpcAcsRequest<UpdateDcdnSubTaskResponse>
    {
        public UpdateDcdnSubTaskRequest()
            : base("dcdn", "2018-01-15", "UpdateDcdnSubTask")
        {
        ...
        public override UpdateDcdnSubTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDcdnSubTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
