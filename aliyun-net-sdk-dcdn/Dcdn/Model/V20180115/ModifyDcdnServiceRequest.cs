...
{
    public class ModifyDcdnServiceRequest : RpcAcsRequest<ModifyDcdnServiceResponse>
    {
        public ModifyDcdnServiceRequest()
            : base("dcdn", "2018-01-15", "ModifyDcdnService")
        {
		...
		public string WebsocketBillType
		{
			...
			set	
			{
				websocketBillType = value;
				DictionaryUtil.Add(QueryParameters, "WebsocketBillType", value);
			}
		}
		...
		public string BillType
		{
			...
			{
				billType = value;
				DictionaryUtil.Add(QueryParameters, "BillType", value);
			}
		}
        ...
        public override ModifyDcdnServiceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDcdnServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
