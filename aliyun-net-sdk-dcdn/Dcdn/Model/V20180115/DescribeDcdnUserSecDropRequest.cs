...
{
    public class DescribeDcdnUserSecDropRequest : RpcAcsRequest<DescribeDcdnUserSecDropResponse>
    {
        public DescribeDcdnUserSecDropRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnUserSecDrop")
        {
        ...
        public override DescribeDcdnUserSecDropResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnUserSecDropResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
