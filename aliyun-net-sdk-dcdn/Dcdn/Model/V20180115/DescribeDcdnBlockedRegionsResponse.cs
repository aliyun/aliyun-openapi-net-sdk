...
{
	public class DescribeDcdnBlockedRegionsResponse : AcsResponse
	{

		private string requestId;

		private List<DescribeDcdnBlockedRegions_InfoItem> infoList;
		...
		public List<DescribeDcdnBlockedRegions_InfoItem> InfoList
		{
			get
			{
				return infoList;
		...
		public class DescribeDcdnBlockedRegions_InfoItem
		{
