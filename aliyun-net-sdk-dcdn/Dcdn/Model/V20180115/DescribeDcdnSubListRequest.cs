...
{
    public class DescribeDcdnSubListRequest : RpcAcsRequest<DescribeDcdnSubListResponse>
    {
        public DescribeDcdnSubListRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnSubList")
        {
        ...
        public override DescribeDcdnSubListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnSubListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
