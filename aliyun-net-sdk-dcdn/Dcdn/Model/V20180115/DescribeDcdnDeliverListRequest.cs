...
{
    public class DescribeDcdnDeliverListRequest : RpcAcsRequest<DescribeDcdnDeliverListResponse>
    {
        public DescribeDcdnDeliverListRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnDeliverList")
        {
        ...
        public override DescribeDcdnDeliverListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnDeliverListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
