...
{
    public class DeleteRoutineCodeRevisionRequest : RpcAcsRequest<DeleteRoutineCodeRevisionResponse>
    {
        public DeleteRoutineCodeRevisionRequest()
            : base("dcdn", "2018-01-15", "DeleteRoutineCodeRevision")
        {
        ...
        public override DeleteRoutineCodeRevisionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRoutineCodeRevisionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
