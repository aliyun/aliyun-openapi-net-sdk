...
{
    public class EditRoutineConfRequest : RpcAcsRequest<EditRoutineConfResponse>
    {
        public EditRoutineConfRequest()
            : base("dcdn", "2018-01-15", "EditRoutineConf")
        {
        ...
        public override EditRoutineConfResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EditRoutineConfResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
