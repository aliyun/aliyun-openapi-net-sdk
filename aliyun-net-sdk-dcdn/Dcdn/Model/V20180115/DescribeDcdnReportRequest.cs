...
{
    public class DescribeDcdnReportRequest : RpcAcsRequest<DescribeDcdnReportResponse>
    {
        public DescribeDcdnReportRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnReport")
        {
        ...
        public override DescribeDcdnReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
