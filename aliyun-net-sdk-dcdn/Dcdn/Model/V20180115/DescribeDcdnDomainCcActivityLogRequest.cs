...
{
    public class DescribeDcdnDomainCcActivityLogRequest : RpcAcsRequest<DescribeDcdnDomainCcActivityLogResponse>
    {
        public DescribeDcdnDomainCcActivityLogRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnDomainCcActivityLog")
        {
        ...
        public override DescribeDcdnDomainCcActivityLogResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnDomainCcActivityLogResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
