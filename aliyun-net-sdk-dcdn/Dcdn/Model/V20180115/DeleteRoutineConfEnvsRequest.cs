...
{
    public class DeleteRoutineConfEnvsRequest : RpcAcsRequest<DeleteRoutineConfEnvsResponse>
    {
        public DeleteRoutineConfEnvsRequest()
            : base("dcdn", "2018-01-15", "DeleteRoutineConfEnvs")
        {
        ...
        public override DeleteRoutineConfEnvsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRoutineConfEnvsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
