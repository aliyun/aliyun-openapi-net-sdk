...
{
    public class UpdateDcdnDeliverTaskRequest : RpcAcsRequest<UpdateDcdnDeliverTaskResponse>
    {
        public UpdateDcdnDeliverTaskRequest()
            : base("dcdn", "2018-01-15", "UpdateDcdnDeliverTask")
        {
        ...
        public override UpdateDcdnDeliverTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateDcdnDeliverTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
