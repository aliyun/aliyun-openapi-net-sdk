...
{
    public class DeleteRoutineRequest : RpcAcsRequest<DeleteRoutineResponse>
    {
        public DeleteRoutineRequest()
            : base("dcdn", "2018-01-15", "DeleteRoutine")
        {
        ...
        public override DeleteRoutineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteRoutineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
