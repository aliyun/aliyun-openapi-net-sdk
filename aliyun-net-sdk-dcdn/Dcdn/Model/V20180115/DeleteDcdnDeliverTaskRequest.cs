...
{
    public class DeleteDcdnDeliverTaskRequest : RpcAcsRequest<DeleteDcdnDeliverTaskResponse>
    {
        public DeleteDcdnDeliverTaskRequest()
            : base("dcdn", "2018-01-15", "DeleteDcdnDeliverTask")
        {
        ...
        public override DeleteDcdnDeliverTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDcdnDeliverTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
