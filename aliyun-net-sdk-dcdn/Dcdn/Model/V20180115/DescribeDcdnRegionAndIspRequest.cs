...
{
    public class DescribeDcdnRegionAndIspRequest : RpcAcsRequest<DescribeDcdnRegionAndIspResponse>
    {
        public DescribeDcdnRegionAndIspRequest()
            : base("dcdn", "2018-01-15", "DescribeDcdnRegionAndIsp")
        {
        ...
        public override DescribeDcdnRegionAndIspResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeDcdnRegionAndIspResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
