...
{
    public class DeleteDcdnSubTaskRequest : RpcAcsRequest<DeleteDcdnSubTaskResponse>
    {
        public DeleteDcdnSubTaskRequest()
            : base("dcdn", "2018-01-15", "DeleteDcdnSubTask")
        {
        ...
        public override DeleteDcdnSubTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteDcdnSubTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
