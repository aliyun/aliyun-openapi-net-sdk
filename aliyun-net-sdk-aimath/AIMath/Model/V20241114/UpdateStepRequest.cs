...
{
    public class UpdateStepRequest : RpcAcsRequest<UpdateStepResponse>
    {
        public UpdateStepRequest()
            : base("AIMath", "2024-11-14", "UpdateStep")
        {
        ...
        public override UpdateStepResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateStepResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
