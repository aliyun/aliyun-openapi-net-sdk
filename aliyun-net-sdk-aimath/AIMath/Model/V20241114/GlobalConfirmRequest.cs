...
{
    public class GlobalConfirmRequest : RpcAcsRequest<GlobalConfirmResponse>
    {
        public GlobalConfirmRequest()
            : base("AIMath", "2024-11-14", "GlobalConfirm")
        {
        ...
        public override GlobalConfirmResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GlobalConfirmResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
