...
namespace Aliyun.Acs.sae.Transform.V20190506
{
    public class DeleteJobResponseUnmarshaller
    {
        public static DeleteJobResponse Unmarshall(UnmarshallerContext _ctx)
        {
			...
			deleteJobResponse.TraceId = _ctx.StringValue("DeleteJob.TraceId");
			deleteJobResponse.Data = _ctx.StringValue("DeleteJob.Data");
			deleteJobResponse.ErrorCode = _ctx.StringValue("DeleteJob.ErrorCode");
