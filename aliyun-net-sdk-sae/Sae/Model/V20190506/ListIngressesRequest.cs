...
{
    public class ListIngressesRequest : RoaAcsRequest<ListIngressesResponse>
    {
        public ListIngressesRequest()
            : base("sae", "2019-05-06", "ListIngresses", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/ingress/IngressList";
        ...
        public override ListIngressesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListIngressesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
