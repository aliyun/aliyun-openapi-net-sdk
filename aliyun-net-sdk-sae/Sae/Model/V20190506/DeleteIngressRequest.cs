...
{
    public class DeleteIngressRequest : RoaAcsRequest<DeleteIngressResponse>
    {
        public DeleteIngressRequest()
            : base("sae", "2019-05-06", "DeleteIngress", "serverless", "openAPI")
        {
        ...
        public override DeleteIngressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteIngressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
