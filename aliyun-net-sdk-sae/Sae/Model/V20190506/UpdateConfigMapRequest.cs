...
{
    public class UpdateConfigMapRequest : RoaAcsRequest<UpdateConfigMapResponse>
    {
        public UpdateConfigMapRequest()
            : base("sae", "2019-05-06", "UpdateConfigMap", "serverless", "openAPI")
        {
        ...
        public override UpdateConfigMapResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateConfigMapResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
