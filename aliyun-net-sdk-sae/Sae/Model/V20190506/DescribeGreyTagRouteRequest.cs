...
{
    public class DescribeGreyTagRouteRequest : RoaAcsRequest<DescribeGreyTagRouteResponse>
    {
        public DescribeGreyTagRouteRequest()
            : base("sae", "2019-05-06", "DescribeGreyTagRoute", "serverless", "openAPI")
        {
        ...
        public override DescribeGreyTagRouteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeGreyTagRouteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
