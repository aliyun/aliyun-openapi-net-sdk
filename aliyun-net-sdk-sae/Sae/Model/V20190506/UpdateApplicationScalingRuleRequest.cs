...
{
    public class UpdateApplicationScalingRuleRequest : RoaAcsRequest<UpdateApplicationScalingRuleResponse>
    {
        public UpdateApplicationScalingRuleRequest()
            : base("sae", "2019-05-06", "UpdateApplicationScalingRule", "serverless", "openAPI")
        {
        ...
        public override UpdateApplicationScalingRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateApplicationScalingRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
