...
{
    public class DeleteApplicationScalingRuleRequest : RoaAcsRequest<DeleteApplicationScalingRuleResponse>
    {
        public DeleteApplicationScalingRuleRequest()
            : base("sae", "2019-05-06", "DeleteApplicationScalingRule", "serverless", "openAPI")
        {
        ...
        public override DeleteApplicationScalingRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteApplicationScalingRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
