...
{
    public class RestartInstancesRequest : RoaAcsRequest<RestartInstancesResponse>
    {
        public RestartInstancesRequest()
            : base("sae", "2019-05-06", "RestartInstances", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/app/restartInstances";
        ...
        public override RestartInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RestartInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
