...
{
    public class DescribeApplicationInstancesRequest : RoaAcsRequest<DescribeApplicationInstancesResponse>
    {
        public DescribeApplicationInstancesRequest()
            : base("sae", "2019-05-06", "DescribeApplicationInstances", "serverless", "openAPI")
        {
        ...
        public override DescribeApplicationInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeApplicationInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
