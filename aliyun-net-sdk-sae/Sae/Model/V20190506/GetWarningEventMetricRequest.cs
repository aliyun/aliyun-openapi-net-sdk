...
{
    public class GetWarningEventMetricRequest : RoaAcsRequest<GetWarningEventMetricResponse>
    {
        public GetWarningEventMetricRequest()
            : base("sae", "2019-05-06", "GetWarningEventMetric", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/getWarningEventMetric";
        ...
        public override GetWarningEventMetricResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetWarningEventMetricResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
