...
{
    public class GetAvailabilityMetricRequest : RoaAcsRequest<GetAvailabilityMetricResponse>
    {
        public GetAvailabilityMetricRequest()
            : base("sae", "2019-05-06", "GetAvailabilityMetric", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/getAvailabilityMetric";
        ...
        public override GetAvailabilityMetricResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAvailabilityMetricResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
