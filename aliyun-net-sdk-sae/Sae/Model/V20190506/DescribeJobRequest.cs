...
{
    public class DescribeJobRequest : RoaAcsRequest<DescribeJobResponse>
    {
        public DescribeJobRequest()
            : base("sae", "2019-05-06", "DescribeJob", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/job/describeJob";
