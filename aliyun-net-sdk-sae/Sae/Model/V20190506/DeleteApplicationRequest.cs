...
{
    public class DeleteApplicationRequest : RoaAcsRequest<DeleteApplicationResponse>
    {
        public DeleteApplicationRequest()
            : base("sae", "2019-05-06", "DeleteApplication", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/app/deleteApplication";
