...
{
    public class DescribeIngressRequest : RoaAcsRequest<DescribeIngressResponse>
    {
        public DescribeIngressRequest()
            : base("sae", "2019-05-06", "DescribeIngress", "serverless", "openAPI")
        {
        ...
        public override DescribeIngressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeIngressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
