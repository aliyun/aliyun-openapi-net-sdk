...
{
    public class BatchStopApplicationsRequest : RoaAcsRequest<BatchStopApplicationsResponse>
    {
        public BatchStopApplicationsRequest()
            : base("sae", "2019-05-06", "BatchStopApplications", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/app/batchStopApplications";
        ...
        public override BatchStopApplicationsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchStopApplicationsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
