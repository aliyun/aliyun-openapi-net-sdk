...
{
    public class UpdateNamespaceVpcRequest : RoaAcsRequest<UpdateNamespaceVpcResponse>
    {
        public UpdateNamespaceVpcRequest()
            : base("sae", "2019-05-06", "UpdateNamespaceVpc", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/namespace/updateNamespaceVpc";
        ...
        public override UpdateNamespaceVpcResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateNamespaceVpcResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
