...
{
    public class BindSlbRequest : RoaAcsRequest<BindSlbResponse>
    {
        public BindSlbRequest()
            : base("sae", "2019-05-06", "BindSlb", "serverless", "openAPI")
        {
		...
		public string Intranet
		{
			...
			{
				intranet = value;
				DictionaryUtil.Add(QueryParameters, "Intranet", value);
			}
		}
		...
		public string Internet
		{
			...
			{
				internet = value;
				DictionaryUtil.Add(QueryParameters, "Internet", value);
			}
		}
        ...
        public override BindSlbResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindSlbResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
