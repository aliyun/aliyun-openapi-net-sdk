...
{
    public class ListApplicationsRequest : RoaAcsRequest<ListApplicationsResponse>
    {
        public ListApplicationsRequest()
            : base("sae", "2019-05-06", "ListApplications", "serverless", "openAPI")
        {
			...
			UriPattern = "/pop/v1/sam/app/listApplications";
