...
{
    public class TagResourcesRequest : RoaAcsRequest<TagResourcesResponse>
    {
        public TagResourcesRequest()
            : base("sae", "2019-05-06", "TagResources", "serverless", "openAPI")
        {
		...
		public string ResourceIds
		{
			...
			{
				resourceIds = value;
				DictionaryUtil.Add(BodyParameters, "ResourceIds", value);
			}
		}
