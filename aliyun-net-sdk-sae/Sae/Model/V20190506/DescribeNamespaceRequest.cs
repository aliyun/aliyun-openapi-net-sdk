...
{
    public class DescribeNamespaceRequest : RoaAcsRequest<DescribeNamespaceResponse>
    {
        public DescribeNamespaceRequest()
            : base("sae", "2019-05-06", "DescribeNamespace", "serverless", "openAPI")
        {
        ...
        public override DescribeNamespaceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeNamespaceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
