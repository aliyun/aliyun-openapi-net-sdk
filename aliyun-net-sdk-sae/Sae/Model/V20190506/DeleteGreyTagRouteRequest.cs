...
{
    public class DeleteGreyTagRouteRequest : RoaAcsRequest<DeleteGreyTagRouteResponse>
    {
        public DeleteGreyTagRouteRequest()
            : base("sae", "2019-05-06", "DeleteGreyTagRoute", "serverless", "openAPI")
        {
        ...
        public override DeleteGreyTagRouteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGreyTagRouteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
