...
{
    public class CertificatePrivateKeyDecryptRequest : RpcAcsRequest<CertificatePrivateKeyDecryptResponse>
    {
        public CertificatePrivateKeyDecryptRequest()
            : base("Kms", "2016-01-20", "CertificatePrivateKeyDecrypt", "kms-service", "openAPI")
        {
        ...
        public override CertificatePrivateKeyDecryptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CertificatePrivateKeyDecryptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
