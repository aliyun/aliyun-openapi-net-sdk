...
{
    public class GetSecretPolicyRequest : RpcAcsRequest<GetSecretPolicyResponse>
    {
        public GetSecretPolicyRequest()
            : base("Kms", "2016-01-20", "GetSecretPolicy", "kms", "openAPI")
        {
        ...
        public override GetSecretPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSecretPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
