...
{
    public class ConnectKmsInstanceRequest : RpcAcsRequest<ConnectKmsInstanceResponse>
    {
        public ConnectKmsInstanceRequest()
            : base("Kms", "2016-01-20", "ConnectKmsInstance", "kms", "openAPI")
        {
		...
		public string KmsInstanceId
		{
			...
			{
				kmsInstanceId = value;
				DictionaryUtil.Add(QueryParameters, "KmsInstanceId", value);
			}
		}
		...
		public string KMProvider
		{
			...
			{
				kMProvider = value;
				DictionaryUtil.Add(QueryParameters, "KMProvider", value);
			}
		}
		...
		public string ZoneIds
		{
			...
			{
				zoneIds = value;
				DictionaryUtil.Add(QueryParameters, "ZoneIds", value);
			}
		}
        ...
        public override ConnectKmsInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConnectKmsInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
