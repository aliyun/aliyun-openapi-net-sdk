...
{
    public class GetClientKeyRequest : RpcAcsRequest<GetClientKeyResponse>
    {
        public GetClientKeyRequest()
            : base("Kms", "2016-01-20", "GetClientKey", "kms", "openAPI")
        {
        ...
        public override GetClientKeyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetClientKeyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
