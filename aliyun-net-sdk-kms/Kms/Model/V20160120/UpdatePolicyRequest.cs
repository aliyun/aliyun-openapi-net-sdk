...
{
    public class UpdatePolicyRequest : RpcAcsRequest<UpdatePolicyResponse>
    {
        public UpdatePolicyRequest()
            : base("Kms", "2016-01-20", "UpdatePolicy", "kms", "openAPI")
        {
        ...
        public override UpdatePolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdatePolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
