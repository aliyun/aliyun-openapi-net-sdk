...
{
    public class CertificatePublicKeyEncryptRequest : RpcAcsRequest<CertificatePublicKeyEncryptResponse>
    {
        public CertificatePublicKeyEncryptRequest()
            : base("Kms", "2016-01-20", "CertificatePublicKeyEncrypt", "kms-service", "openAPI")
        {
        ...
        public override CertificatePublicKeyEncryptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CertificatePublicKeyEncryptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
