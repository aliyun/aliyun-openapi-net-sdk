...
namespace Aliyun.Acs.Kms.Model.V20160120
{
    public class UploadCertificateRequest : RpcAcsRequest<UploadCertificateResponse>
    {
        ...
        public override UploadCertificateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UploadCertificateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
