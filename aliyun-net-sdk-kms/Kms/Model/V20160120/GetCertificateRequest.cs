...
{
    public class GetCertificateRequest : RpcAcsRequest<GetCertificateResponse>
    {
        public GetCertificateRequest()
            : base("Kms", "2016-01-20", "GetCertificate", "kms-service", "openAPI")
        {
        ...
        public override GetCertificateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetCertificateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
