...
{
	public class ListClientKeysResponse : AcsResponse
	{

		private string requestId;

		private List<ListClientKeys_ClientKey> clientKeys;
		...
		public List<ListClientKeys_ClientKey> ClientKeys
		{
			get
			{
				return clientKeys;
		...
		public class ListClientKeys_ClientKey
		{
