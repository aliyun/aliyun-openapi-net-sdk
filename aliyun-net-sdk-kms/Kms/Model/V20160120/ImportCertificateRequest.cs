...
{
    public class ImportCertificateRequest : RpcAcsRequest<ImportCertificateResponse>
    {
        public ImportCertificateRequest()
            : base("Kms", "2016-01-20", "ImportCertificate", "kms-service", "openAPI")
        {
		...
		public string PKCS12Blob
		{
			...
			{
				pKCS12Blob = value;
				DictionaryUtil.Add(QueryParameters, "PKCS12Blob", value);
			}
		}
        ...
        public override ImportCertificateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ImportCertificateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
