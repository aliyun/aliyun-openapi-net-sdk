...
{
    public class GetKmsInstanceRequest : RpcAcsRequest<GetKmsInstanceResponse>
    {
        public GetKmsInstanceRequest()
            : base("Kms", "2016-01-20", "GetKmsInstance", "kms", "openAPI")
        {
        ...
        public override GetKmsInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetKmsInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
