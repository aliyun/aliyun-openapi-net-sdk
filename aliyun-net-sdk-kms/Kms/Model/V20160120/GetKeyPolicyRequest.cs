...
{
    public class GetKeyPolicyRequest : RpcAcsRequest<GetKeyPolicyResponse>
    {
        public GetKeyPolicyRequest()
            : base("Kms", "2016-01-20", "GetKeyPolicy", "kms", "openAPI")
        {
        ...
        public override GetKeyPolicyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetKeyPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
