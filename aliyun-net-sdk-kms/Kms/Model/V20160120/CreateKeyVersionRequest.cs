...
{
    public class CreateKeyVersionRequest : RpcAcsRequest<CreateKeyVersionResponse>
    {
        public CreateKeyVersionRequest()
            : base("Kms", "2016-01-20", "CreateKeyVersion", "kms-service", "openAPI")
        {
        ...
        public override CreateKeyVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateKeyVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
