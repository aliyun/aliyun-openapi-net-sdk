...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class TransferInReenterTransferAuthorizationCodeRequest : RpcAcsRequest<TransferInReenterTransferAuthorizationCodeResponse>
    {
        public TransferInReenterTransferAuthorizationCodeRequest()
            : base("Domain_intl", "2017-12-18", "TransferInReenterTransferAuthorizationCode", "domain", "openAPI")
        {
        }
        ...
        public override TransferInReenterTransferAuthorizationCodeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
