...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveSingleTaskForModifyingDSRecordRequest : RpcAcsRequest<SaveSingleTaskForModifyingDSRecordResponse>
    {
        public SaveSingleTaskForModifyingDSRecordRequest()
            : base("Domain_intl", "2017-12-18", "SaveSingleTaskForModifyingDSRecord", "domain", "openAPI")
        {
        }
        ...
        public override SaveSingleTaskForModifyingDSRecordResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
