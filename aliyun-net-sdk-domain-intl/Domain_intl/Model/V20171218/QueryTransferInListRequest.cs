...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class QueryTransferInListRequest : RpcAcsRequest<QueryTransferInListResponse>
    {
        public QueryTransferInListRequest()
            : base("Domain_intl", "2017-12-18", "QueryTransferInList", "domain", "openAPI")
        {
        }
        ...
        public override QueryTransferInListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
