...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class QueryTaskDetailHistoryRequest : RpcAcsRequest<QueryTaskDetailHistoryResponse>
    {
        public QueryTaskDetailHistoryRequest()
            : base("Domain_intl", "2017-12-18", "QueryTaskDetailHistory", "domain", "openAPI")
        {
        }
        ...
        public override QueryTaskDetailHistoryResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
