...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class CheckTransferInFeasibilityRequest : RpcAcsRequest<CheckTransferInFeasibilityResponse>
    {
        public CheckTransferInFeasibilityRequest()
            : base("Domain_intl", "2017-12-18", "CheckTransferInFeasibility", "domain", "openAPI")
        {
        }
        ...
        public override CheckTransferInFeasibilityResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
