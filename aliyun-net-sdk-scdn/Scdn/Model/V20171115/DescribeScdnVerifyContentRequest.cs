...
{
    public class DescribeScdnVerifyContentRequest : RpcAcsRequest<DescribeScdnVerifyContentResponse>
    {
        public DescribeScdnVerifyContentRequest()
            : base("scdn", "2017-11-15", "DescribeScdnVerifyContent")
        {
        ...
        public override DescribeScdnVerifyContentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeScdnVerifyContentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
