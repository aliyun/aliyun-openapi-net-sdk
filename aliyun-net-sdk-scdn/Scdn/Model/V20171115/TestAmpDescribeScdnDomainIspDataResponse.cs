...
{
	public class TestAmpDescribeScdnDomainIspDataResponse : AcsResponse
	{
		...
		private List<TestAmpDescribeScdnDomainIspData_ISPProportionData> _value;
		...
		public List<TestAmpDescribeScdnDomainIspData_ISPProportionData> _Value
		{
			get
			{
				return _value;
		...
		public class TestAmpDescribeScdnDomainIspData_ISPProportionData
		{
