...
namespace Aliyun.Acs.aliyuncvc.Transform.V20191030
{
    public class GetMeetingMemberResponseUnmarshaller
    {
        public static GetMeetingMemberResponse Unmarshall(UnmarshallerContext context)
        {
			...
			List<string> getMeetingMemberResponse_members = new List<string>();
			for (int i = 0; i < context.Length("GetMeetingMember.Members.Length"); i++) {
				getMeetingMemberResponse_members.Add(context.StringValue("GetMeetingMember.Members["+ i +"]"));
			}
			getMeetingMemberResponse.Members = getMeetingMemberResponse_members;
