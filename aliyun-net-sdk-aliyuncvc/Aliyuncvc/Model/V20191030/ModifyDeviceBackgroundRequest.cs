...
{
    public class ModifyDeviceBackgroundRequest : RpcAcsRequest<ModifyDeviceBackgroundResponse>
    {
        public ModifyDeviceBackgroundRequest()
            : base("aliyuncvc", "2019-10-30", "ModifyDeviceBackground", "aliyuncvc", "openAPI")
        {
        ...
        public override ModifyDeviceBackgroundResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyDeviceBackgroundResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
