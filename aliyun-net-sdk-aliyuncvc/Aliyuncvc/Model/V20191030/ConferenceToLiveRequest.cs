...
{
    public class ConferenceToLiveRequest : RpcAcsRequest<ConferenceToLiveResponse>
    {
        public ConferenceToLiveRequest()
            : base("aliyuncvc", "2019-10-30", "ConferenceToLive", "aliyuncvc", "openAPI")
        {
        ...
        public override ConferenceToLiveResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConferenceToLiveResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
