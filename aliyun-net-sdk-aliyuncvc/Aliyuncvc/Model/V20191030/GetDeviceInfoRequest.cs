...
{
    public class GetDeviceInfoRequest : RpcAcsRequest<GetDeviceInfoResponse>
    {
        public GetDeviceInfoRequest()
            : base("aliyuncvc", "2019-10-30", "GetDeviceInfo", "aliyuncvc", "openAPI")
        {
		...
		public string CastScreenCode
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(BodyParameters, "CastScreenCode", value);
			}
		}
        ...
        public override GetDeviceInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDeviceInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
