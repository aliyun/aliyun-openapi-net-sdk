...
{
    public class ListConferenceDevicesRequest : RpcAcsRequest<ListConferenceDevicesResponse>
    {
        public ListConferenceDevicesRequest()
            : base("aliyuncvc", "2019-10-30", "ListConferenceDevices", "aliyuncvc", "openAPI")
        {
        ...
        public override ListConferenceDevicesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListConferenceDevicesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
