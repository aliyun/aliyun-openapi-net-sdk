...
{
    public class GetStatisticRequest : RpcAcsRequest<GetStatisticResponse>
    {
        public GetStatisticRequest()
            : base("aliyuncvc", "2019-10-30", "GetStatistic", "aliyuncvc", "openAPI")
        {
        ...
        public override GetStatisticResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetStatisticResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
