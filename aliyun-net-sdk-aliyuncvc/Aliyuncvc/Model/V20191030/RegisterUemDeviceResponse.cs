...
{
	public class RegisterUemDeviceResponse : AcsResponse
	{
		...
		private RegisterUemDevice_DeviceInfo deviceInfo;
		...
		public RegisterUemDevice_DeviceInfo DeviceInfo
		{
			get
			{
				return deviceInfo;
		...
		public class RegisterUemDevice_DeviceInfo
		{
			...
			private RegisterUemDevice_MqttParam mqttParam;

			private RegisterUemDevice_AuthWsChannelConfig authWsChannelConfig;

			private RegisterUemDevice_SlsConfig slsConfig;
			...
			public RegisterUemDevice_MqttParam MqttParam
			{
				get
				{
					return mqttParam;
			...
			public RegisterUemDevice_AuthWsChannelConfig AuthWsChannelConfig
			{
				get
				{
			...
			public RegisterUemDevice_SlsConfig SlsConfig
			{
				get
				{
					return slsConfig;
			...
			public class RegisterUemDevice_MqttParam
			{
			...
			public class RegisterUemDevice_AuthWsChannelConfig
			{
			...
			public class RegisterUemDevice_SlsConfig
			{
