...
{
    public class SendMeetingCommandRequest : RpcAcsRequest<SendMeetingCommandResponse>
    {
        public SendMeetingCommandRequest()
            : base("aliyuncvc", "2019-10-30", "SendMeetingCommand", "aliyuncvc", "openAPI")
        {
		...
		public string OperatorMemberUUID
		{
			get
			{
				return operatorMemberUUID;
			}
			set	
			{
				operatorMemberUUID = value;
				DictionaryUtil.Add(BodyParameters, "OperatorMemberUUID", value);
			}
		}
		...
		public int? SendType
		{
			...
			{
				sendType = value;
				DictionaryUtil.Add(BodyParameters, "SendType", value.ToString());
			}
		}
        ...
        public override SendMeetingCommandResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SendMeetingCommandResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
