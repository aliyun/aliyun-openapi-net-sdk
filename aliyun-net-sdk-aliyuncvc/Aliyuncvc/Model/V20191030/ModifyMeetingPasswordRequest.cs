...
{
    public class ModifyMeetingPasswordRequest : RpcAcsRequest<ModifyMeetingPasswordResponse>
    {
        public ModifyMeetingPasswordRequest()
            : base("aliyuncvc", "2019-10-30", "ModifyMeetingPassword", "aliyuncvc", "openAPI")
        {
        ...
        public override ModifyMeetingPasswordResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMeetingPasswordResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
