...
{
    public class RefreshDeviceScreenCodeRequest : RpcAcsRequest<RefreshDeviceScreenCodeResponse>
    {
        public RefreshDeviceScreenCodeRequest()
            : base("aliyuncvc", "2019-10-30", "RefreshDeviceScreenCode", "aliyuncvc", "openAPI")
        {
        ...
        public override RefreshDeviceScreenCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RefreshDeviceScreenCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
