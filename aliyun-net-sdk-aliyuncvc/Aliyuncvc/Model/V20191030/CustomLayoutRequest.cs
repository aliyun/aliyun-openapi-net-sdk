...
{
    public class CustomLayoutRequest : RpcAcsRequest<CustomLayoutResponse>
    {
        public CustomLayoutRequest()
            : base("aliyuncvc", "2019-10-30", "CustomLayout", "aliyuncvc", "openAPI")
        {
        ...
        public override CustomLayoutResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CustomLayoutResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
