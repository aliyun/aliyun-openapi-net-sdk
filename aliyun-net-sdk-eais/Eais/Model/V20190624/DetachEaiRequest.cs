...
{
    public class DetachEaiRequest : RpcAcsRequest<DetachEaiResponse>
    {
        public DetachEaiRequest()
            : base("eais", "2019-06-24", "DetachEai", "eais", "openAPI")
        {
        ...
        public override DetachEaiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetachEaiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
