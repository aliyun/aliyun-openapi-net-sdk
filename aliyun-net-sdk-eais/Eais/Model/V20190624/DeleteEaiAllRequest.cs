...
{
    public class DeleteEaiAllRequest : RpcAcsRequest<DeleteEaiAllResponse>
    {
        public DeleteEaiAllRequest()
            : base("eais", "2019-06-24", "DeleteEaiAll", "eais", "openAPI")
        {
        ...
        public override DeleteEaiAllResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteEaiAllResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
