...
{
    public class GetPrivateIpRequest : RpcAcsRequest<GetPrivateIpResponse>
    {
        public GetPrivateIpRequest()
            : base("eais", "2019-06-24", "GetPrivateIp", "eais", "openAPI")
        {
		...
		public string ClientInstanceId
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "ClientInstanceId", value);
			}
		}
        ...
        public override GetPrivateIpResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPrivateIpResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
