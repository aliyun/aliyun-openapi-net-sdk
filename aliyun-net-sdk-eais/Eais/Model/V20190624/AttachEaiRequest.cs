...
{
    public class AttachEaiRequest : RpcAcsRequest<AttachEaiResponse>
    {
        public AttachEaiRequest()
            : base("eais", "2019-06-24", "AttachEai", "eais", "openAPI")
        {
        ...
        public override AttachEaiResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AttachEaiResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
