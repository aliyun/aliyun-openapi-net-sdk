...
{
    public class QueryOrderIdByPayIdRequest : RpcAcsRequest<QueryOrderIdByPayIdResponse>
    {
        public QueryOrderIdByPayIdRequest()
            : base("linkedmall", "2018-01-16", "QueryOrderIdByPayId", "linkedmall", "openAPI")
        {
        ...
        public override QueryOrderIdByPayIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryOrderIdByPayIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
