...
{
    public class SubmitReturnGoodLogisticsRequest : RpcAcsRequest<SubmitReturnGoodLogisticsResponse>
    {
        public SubmitReturnGoodLogisticsRequest()
            : base("linkedmall", "2018-01-16", "SubmitReturnGoodLogistics", "linkedmall", "openAPI")
        {
		...
		public string CpCode
		{
			...
			{
				cpCode = value;
				DictionaryUtil.Add(QueryParameters, "CpCode", value);
			}
		}
		...
		public long? DisputeId
		{
			...
			{
				disputeId = value;
				DictionaryUtil.Add(QueryParameters, "DisputeId", value.ToString());
			}
		}
		...
		public string LogisticsNo
		{
			...
			{
				logisticsNo = value;
				DictionaryUtil.Add(QueryParameters, "LogisticsNo", value);
			}
		}

        public override SubmitReturnGoodLogisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SubmitReturnGoodLogisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
