...
{
    public class QueryLogisticsRequest : RpcAcsRequest<QueryLogisticsResponse>
    {
        public QueryLogisticsRequest()
            : base("linkedmall", "2018-01-16", "QueryLogistics", "linkedmall", "openAPI")
        {
        ...
        public override QueryLogisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryLogisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
