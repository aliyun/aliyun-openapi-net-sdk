...
{
    public class CreateOrderV2Request : RpcAcsRequest<CreateOrderV2Response>
    {
        public CreateOrderV2Request()
            : base("linkedmall", "2018-01-16", "CreateOrderV2", "linkedmall", "openAPI")
        {
        ...
        public override CreateOrderV2Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateOrderV2ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
