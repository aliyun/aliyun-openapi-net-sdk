...
{
    public class QueryOrderLogisticsRequest : RpcAcsRequest<QueryOrderLogisticsResponse>
    {
        public QueryOrderLogisticsRequest()
            : base("linkedmall", "2018-01-16", "QueryOrderLogistics", "linkedmall", "openAPI")
        {
		...
		public long? LmOrderId
		{
			...
			{
				lmOrderId = value;
				DictionaryUtil.Add(QueryParameters, "LmOrderId", value.ToString());
			}
		}
        ...
        public override QueryOrderLogisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryOrderLogisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
