...
{
    public class CancelRefundRequest : RpcAcsRequest<CancelRefundResponse>
    {
        public CancelRefundRequest()
            : base("linkedmall", "2018-01-16", "CancelRefund", "linkedmall", "openAPI")
        {
        ...
        public override CancelRefundResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CancelRefundResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
