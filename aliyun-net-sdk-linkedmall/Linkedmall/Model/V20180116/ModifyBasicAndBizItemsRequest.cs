...
{
    public class ModifyBasicAndBizItemsRequest : RpcAcsRequest<ModifyBasicAndBizItemsResponse>
    {
        public ModifyBasicAndBizItemsRequest()
            : base("linkedmall", "2018-01-16", "ModifyBasicAndBizItems", "linkedmall", "openAPI")
        {
        ...
        public override ModifyBasicAndBizItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyBasicAndBizItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
