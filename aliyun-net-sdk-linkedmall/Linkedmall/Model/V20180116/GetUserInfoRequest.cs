...
namespace Aliyun.Acs.linkedmall.Model.V20180116
{
    public class GetUserInfoRequest : RpcAcsRequest<GetUserInfoResponse>
    {
        public GetUserInfoRequest()
            : base("linkedmall", "2018-01-16", "GetUserInfo", "linkedmall", "openAPI")
        {
		...
		public string UserFlag
		{
			...
			{
				userFlag = value;
				DictionaryUtil.Add(QueryParameters, "UserFlag", value);
			}
		}
		...
		public string QueryJson
		{
			...
			{
				queryJson = value;
				DictionaryUtil.Add(BodyParameters, "QueryJson", value);
			}
		}
