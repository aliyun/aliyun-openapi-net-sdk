...
{
    public class AddAddressRequest : RpcAcsRequest<AddAddressResponse>
    {
        public AddAddressRequest()
            : base("linkedmall", "2018-01-16", "AddAddress", "linkedmall", "openAPI")
        {
        ...
        public override AddAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
