...
{
    public class QueryRefundApplicationDetailRequest : RpcAcsRequest<QueryRefundApplicationDetailResponse>
    {
        public QueryRefundApplicationDetailRequest()
            : base("linkedmall", "2018-01-16", "QueryRefundApplicationDetail", "linkedmall", "openAPI")
        {
        ...
        public override QueryRefundApplicationDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryRefundApplicationDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
