...
{
    public class RepayOrderRequest : RpcAcsRequest<RepayOrderResponse>
    {
        public RepayOrderRequest()
            : base("linkedmall", "2018-01-16", "RepayOrder", "linkedmall", "openAPI")
        {
        ...
        public override RepayOrderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RepayOrderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
