...
namespace Aliyun.Acs.linkedmall.Model.V20180116
{
	public class CreateOrderResponse : AcsResponse
	{
		...
		private CreateOrder_Model model;
		...
		public CreateOrder_Model Model
		{
			get
			{
				return model;
		...
		public class CreateOrder_Model
		{
			...
			private List<CreateOrder_LmOrderListItem> lmOrderList;
			...
			public List<CreateOrder_LmOrderListItem> LmOrderList
			{
				get
				{
					return lmOrderList;
			...
			public class CreateOrder_LmOrderListItem
			{
