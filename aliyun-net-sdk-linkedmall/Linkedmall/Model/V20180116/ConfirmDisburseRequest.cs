...
{
    public class ConfirmDisburseRequest : RpcAcsRequest<ConfirmDisburseResponse>
    {
        public ConfirmDisburseRequest()
            : base("linkedmall", "2018-01-16", "ConfirmDisburse", "linkedmall", "openAPI")
        {
        ...
        public override ConfirmDisburseResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ConfirmDisburseResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
