...
{
    public class QueryAddressDetailRequest : RpcAcsRequest<QueryAddressDetailResponse>
    {
        public QueryAddressDetailRequest()
            : base("linkedmall", "2018-01-16", "QueryAddressDetail", "linkedmall", "openAPI")
        {
		...
		public string AddressInfo
		{
			...
			{
				addressInfo = value;
				DictionaryUtil.Add(QueryParameters, "AddressInfo", value);
			}
		}
        ...
        public override QueryAddressDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryAddressDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
