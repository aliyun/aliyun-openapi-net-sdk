...
{
    public class UpdateAddressRequest : RpcAcsRequest<UpdateAddressResponse>
    {
        public UpdateAddressRequest()
            : base("linkedmall", "2018-01-16", "UpdateAddress", "linkedmall", "openAPI")
        {
		...
		public string AddressInfo
		{
			...
			{
				addressInfo = value;
				DictionaryUtil.Add(BodyParameters, "AddressInfo", value);
			}
		}
        ...
        public override UpdateAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
