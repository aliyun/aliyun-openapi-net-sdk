...
{
    public class GetLoginPageRequest : RpcAcsRequest<GetLoginPageResponse>
    {
        public GetLoginPageRequest()
            : base("linkedmall", "2018-01-16", "GetLoginPage", "linkedmall", "openAPI")
        {
		...
		public string TargetUrl
		{
			...
			{
				targetUrl = value;
				DictionaryUtil.Add(BodyParameters, "TargetUrl", value);
			}
		}
		...
		public string FailUrl
		{
			...
			{
				failUrl = value;
				DictionaryUtil.Add(BodyParameters, "FailUrl", value);
			}
		}
        ...
        public override GetLoginPageResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetLoginPageResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
