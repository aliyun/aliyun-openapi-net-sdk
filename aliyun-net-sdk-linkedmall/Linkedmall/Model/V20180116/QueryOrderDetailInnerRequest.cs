...
{
    public class QueryOrderDetailInnerRequest : RpcAcsRequest<QueryOrderDetailInnerResponse>
    {
        public QueryOrderDetailInnerRequest()
            : base("linkedmall", "2018-01-16", "QueryOrderDetailInner", "linkedmall", "openAPI")
        {
        ...
        public override QueryOrderDetailInnerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryOrderDetailInnerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
