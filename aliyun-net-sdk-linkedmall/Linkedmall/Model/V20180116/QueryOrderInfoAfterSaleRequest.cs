...
{
    public class QueryOrderInfoAfterSaleRequest : RpcAcsRequest<QueryOrderInfoAfterSaleResponse>
    {
        public QueryOrderInfoAfterSaleRequest()
            : base("linkedmall", "2018-01-16", "QueryOrderInfoAfterSale", "linkedmall", "openAPI")
        {
		...
		public string ChannelUserId
		{
			...
			{
				channelUserId = value;
				DictionaryUtil.Add(QueryParameters, "ChannelUserId", value);
			}
		}

        public override QueryOrderInfoAfterSaleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryOrderInfoAfterSaleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
