...
{
    public class RepayForPayUrlRequest : RpcAcsRequest<RepayForPayUrlResponse>
    {
        public RepayForPayUrlRequest()
            : base("linkedmall", "2018-01-16", "RepayForPayUrl", "linkedmall", "openAPI")
        {
        ...
        public override RepayForPayUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RepayForPayUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
