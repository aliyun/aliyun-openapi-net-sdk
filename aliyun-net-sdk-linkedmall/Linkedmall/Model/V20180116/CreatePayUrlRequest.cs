...
{
    public class CreatePayUrlRequest : RpcAcsRequest<CreatePayUrlResponse>
    {
        public CreatePayUrlRequest()
            : base("linkedmall", "2018-01-16", "CreatePayUrl", "linkedmall", "openAPI")
        {
		...
		public string BuyInfo
		{
			...
			{
				buyInfo = value;
				DictionaryUtil.Add(BodyParameters, "BuyInfo", value);
			}
		}
        ...
        public override CreatePayUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePayUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
