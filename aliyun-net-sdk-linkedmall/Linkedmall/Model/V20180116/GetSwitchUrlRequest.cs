...
{
    public class GetSwitchUrlRequest : RpcAcsRequest<GetSwitchUrlResponse>
    {
        public GetSwitchUrlRequest()
            : base("linkedmall", "2018-01-16", "GetSwitchUrl", "linkedmall", "openAPI")
        {
        ...
        public override GetSwitchUrlResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSwitchUrlResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
