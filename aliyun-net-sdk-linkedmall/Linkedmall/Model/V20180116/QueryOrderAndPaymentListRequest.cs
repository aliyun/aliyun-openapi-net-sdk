...
{
    public class QueryOrderAndPaymentListRequest : RpcAcsRequest<QueryOrderAndPaymentListResponse>
    {
        public QueryOrderAndPaymentListRequest()
            : base("linkedmall", "2018-01-16", "QueryOrderAndPaymentList", "linkedmall", "openAPI")
        {
        ...
        public override QueryOrderAndPaymentListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryOrderAndPaymentListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
