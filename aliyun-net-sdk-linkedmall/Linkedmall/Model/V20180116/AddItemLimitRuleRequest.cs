...
{
    public class AddItemLimitRuleRequest : RpcAcsRequest<AddItemLimitRuleResponse>
    {
        public AddItemLimitRuleRequest()
            : base("linkedmall", "2018-01-16", "AddItemLimitRule", "linkedmall", "openAPI")
        {
        ...
        public override AddItemLimitRuleResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddItemLimitRuleResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
