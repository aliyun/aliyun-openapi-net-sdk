...
{
    public class QueryAddressListRequest : RpcAcsRequest<QueryAddressListResponse>
    {
        public QueryAddressListRequest()
            : base("linkedmall", "2018-01-16", "QueryAddressList", "linkedmall", "openAPI")
        {
        ...
        public override QueryAddressListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryAddressListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
