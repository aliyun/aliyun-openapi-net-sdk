...
{
    public class ReserveMovieSeatRequest : RpcAcsRequest<ReserveMovieSeatResponse>
    {
        public ReserveMovieSeatRequest()
            : base("linkedmall", "2018-01-16", "ReserveMovieSeat", "linkedmall", "openAPI")
        {
        ...
        public override ReserveMovieSeatResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReserveMovieSeatResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
