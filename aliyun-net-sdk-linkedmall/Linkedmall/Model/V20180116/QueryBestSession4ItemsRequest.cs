...
{
    public class QueryBestSession4ItemsRequest : RpcAcsRequest<QueryBestSession4ItemsResponse>
    {
        public QueryBestSession4ItemsRequest()
            : base("linkedmall", "2018-01-16", "QueryBestSession4Items", "linkedmall", "openAPI")
        {
        ...
        public override QueryBestSession4ItemsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return QueryBestSession4ItemsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
