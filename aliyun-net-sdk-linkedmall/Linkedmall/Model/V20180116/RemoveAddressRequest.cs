...
{
    public class RemoveAddressRequest : RpcAcsRequest<RemoveAddressResponse>
    {
        public RemoveAddressRequest()
            : base("linkedmall", "2018-01-16", "RemoveAddress", "linkedmall", "openAPI")
        {
        ...
        public override RemoveAddressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveAddressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
