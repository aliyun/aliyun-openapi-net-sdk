...
{
    public class GetCategoryChainRequest : RpcAcsRequest<GetCategoryChainResponse>
    {
        public GetCategoryChainRequest()
            : base("linkedmall", "2018-01-16", "GetCategoryChain", "linkedmall", "openAPI")
        {
        ...
        {
            return GetCategoryChainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
