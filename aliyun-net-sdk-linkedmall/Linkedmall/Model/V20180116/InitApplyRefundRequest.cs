...
{
    public class InitApplyRefundRequest : RpcAcsRequest<InitApplyRefundResponse>
    {
        public InitApplyRefundRequest()
            : base("linkedmall", "2018-01-16", "InitApplyRefund", "linkedmall", "openAPI")
        {
        ...
        public override InitApplyRefundResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return InitApplyRefundResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
