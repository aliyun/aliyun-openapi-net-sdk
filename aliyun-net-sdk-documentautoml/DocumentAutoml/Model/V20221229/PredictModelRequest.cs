...
{
    public class PredictModelRequest : RpcAcsRequest<PredictModelResponse>
    {
        public PredictModelRequest()
            : base("documentAutoml", "2022-12-29", "PredictModel", "documentAutoml", "openAPI")
        {
        ...
        public override PredictModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PredictModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
