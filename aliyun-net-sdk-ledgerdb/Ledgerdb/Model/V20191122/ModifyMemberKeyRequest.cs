...
{
    public class ModifyMemberKeyRequest : RpcAcsRequest<ModifyMemberKeyResponse>
    {
        public ModifyMemberKeyRequest()
            : base("ledgerdb", "2019-11-22", "ModifyMemberKey", "ledgerdb", "openAPI")
        {
        ...
        public override ModifyMemberKeyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyMemberKeyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
