...
{
	public class DescribeLedgersResponse : AcsResponse
	{
		...
		private List<DescribeLedgers_Ledger> ledgers;
		...
		public List<DescribeLedgers_Ledger> Ledgers
		{
			get
			{
				return ledgers;
		...
		public class DescribeLedgers_Ledger
		{
			...
			private DescribeLedgers_LastTimeAnchor lastTimeAnchor;
			...
			public DescribeLedgers_LastTimeAnchor LastTimeAnchor
			{
				get
				{
			...
			public class DescribeLedgers_LastTimeAnchor
			{
