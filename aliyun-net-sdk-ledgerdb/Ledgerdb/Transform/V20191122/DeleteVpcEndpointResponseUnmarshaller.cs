...
namespace Aliyun.Acs.ledgerdb.Transform.V20191122
{
    ...
    {
        public static DeleteVpcEndpointResponse Unmarshall(UnmarshallerContext context)
        {
			DeleteVpcEndpointResponse deleteVpcEndpointResponse = new DeleteVpcEndpointResponse();

			deleteVpcEndpointResponse.HttpResponse = context.HttpResponse;
			deleteVpcEndpointResponse.RequestId = context.StringValue("DeleteVpcEndpoint.RequestId");
