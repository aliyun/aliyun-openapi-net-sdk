...
namespace Aliyun.Acs.idaas_doraemon.Transform.V20210520
{
    ...
    {
        public static ServiceInvokeResponse Unmarshall(UnmarshallerContext _ctx)
        {
			ServiceInvokeResponse serviceInvokeResponse = new ServiceInvokeResponse();

			serviceInvokeResponse.HttpResponse = _ctx.HttpResponse;
			serviceInvokeResponse.RequestId = _ctx.StringValue("ServiceInvoke.RequestId");
			serviceInvokeResponse.Data = _ctx.StringValue("ServiceInvoke.Data");
			serviceInvokeResponse.Message = _ctx.StringValue("ServiceInvoke.Message");
