...
{
    public class CreateUserAuthenticateOptionsRequest : RpcAcsRequest<CreateUserAuthenticateOptionsResponse>
    {
        public CreateUserAuthenticateOptionsRequest()
            : base("idaas-doraemon", "2021-05-20", "CreateUserAuthenticateOptions", "idaasauth", "openAPI")
        {
		...
		public string BindHashBase64
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "BindHashBase64", value);
			}
		}
        ...
        public override CreateUserAuthenticateOptionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateUserAuthenticateOptionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
