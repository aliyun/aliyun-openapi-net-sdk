...
{
    public class CreateArtifactRequest : RpcAcsRequest<CreateArtifactResponse>
    {
        public CreateArtifactRequest()
            : base("ComputeNestSupplier", "2021-05-21", "CreateArtifact")
        {
        ...
        public override CreateArtifactResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateArtifactResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
