...
{
    public class ListServiceUsagesRequest : RpcAcsRequest<ListServiceUsagesResponse>
    {
        public ListServiceUsagesRequest()
            : base("ComputeNestSupplier", "2021-05-21", "ListServiceUsages")
        {
        ...
        public override ListServiceUsagesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListServiceUsagesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
