...
{
    public class ListArtifactVersionsRequest : RpcAcsRequest<ListArtifactVersionsResponse>
    {
        public ListArtifactVersionsRequest()
            : base("ComputeNestSupplier", "2021-05-21", "ListArtifactVersions")
        {
		...
		public string MaxResult
		{
			...
			{
				maxResult = value;
				DictionaryUtil.Add(QueryParameters, "MaxResult", value);
			}
		}
        ...
        public override ListArtifactVersionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListArtifactVersionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
