...
{
    public class GetArtifactRepositoryCredentialsRequest : RpcAcsRequest<GetArtifactRepositoryCredentialsResponse>
    {
        public GetArtifactRepositoryCredentialsRequest()
            : base("ComputeNestSupplier", "2021-05-21", "GetArtifactRepositoryCredentials")
        {
		...
		public string ArtifactType
		{
			...
			{
				artifactType = value;
				DictionaryUtil.Add(QueryParameters, "ArtifactType", value);
			}
		}
        ...
        public override GetArtifactRepositoryCredentialsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetArtifactRepositoryCredentialsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
