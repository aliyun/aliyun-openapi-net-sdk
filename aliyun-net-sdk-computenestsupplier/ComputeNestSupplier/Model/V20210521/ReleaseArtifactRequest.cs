...
{
    public class ReleaseArtifactRequest : RpcAcsRequest<ReleaseArtifactResponse>
    {
        public ReleaseArtifactRequest()
            : base("ComputeNestSupplier", "2021-05-21", "ReleaseArtifact")
        {
        ...
        public override ReleaseArtifactResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseArtifactResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
