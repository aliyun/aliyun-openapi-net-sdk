...
{
    public class UpdateSearchStrategyRequest : RoaAcsRequest<UpdateSearchStrategyResponse>
    {
        public UpdateSearchStrategyRequest()
            : base("OpenSearch", "2017-12-25", "UpdateSearchStrategy")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/search-strategies/[strategyName]";
		...
		public string StrategyName
		{
			...
			{
				strategyName = value;
				DictionaryUtil.Add(PathParameters, "strategyName", value);
			}
		}
        ...
        public override UpdateSearchStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateSearchStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
