...
{
    public class DescribeFirstRankRequest : RoaAcsRequest<DescribeFirstRankResponse>
    {
        public DescribeFirstRankRequest()
            : base("OpenSearch", "2017-12-25", "DescribeFirstRank", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/first-ranks/[name]";
        ...
        public override DescribeFirstRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeFirstRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
