...
{
    public class ListSearchStrategiesRequest : RoaAcsRequest<ListSearchStrategiesResponse>
    {
        public ListSearchStrategiesRequest()
            : base("OpenSearch", "2017-12-25", "ListSearchStrategies")
        {
        ...
        public override ListSearchStrategiesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSearchStrategiesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
