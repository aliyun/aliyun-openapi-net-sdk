...
{
    public class CreateABTestSceneRequest : RoaAcsRequest<CreateABTestSceneResponse>
    {
        public CreateABTestSceneRequest()
            : base("OpenSearch", "2017-12-25", "CreateABTestScene", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes";
        ...
        public override CreateABTestSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateABTestSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
