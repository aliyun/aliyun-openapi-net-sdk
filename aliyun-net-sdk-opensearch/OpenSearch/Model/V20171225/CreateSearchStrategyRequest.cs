...
{
    public class CreateSearchStrategyRequest : RoaAcsRequest<CreateSearchStrategyResponse>
    {
        public CreateSearchStrategyRequest()
            : base("OpenSearch", "2017-12-25", "CreateSearchStrategy")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/search-strategies";
        ...
        public override CreateSearchStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSearchStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
