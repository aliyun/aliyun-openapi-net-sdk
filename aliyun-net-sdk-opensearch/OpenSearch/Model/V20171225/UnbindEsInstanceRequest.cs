...
{
    public class UnbindEsInstanceRequest : RoaAcsRequest<UnbindEsInstanceResponse>
    {
        public UnbindEsInstanceRequest()
            : base("OpenSearch", "2017-12-25", "UnbindEsInstance")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/actions/unbind-es-instance";
        ...
        public override UnbindEsInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindEsInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
