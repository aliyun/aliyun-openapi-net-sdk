...
{
    public class ModifyQueryProcessorRequest : RoaAcsRequest<ModifyQueryProcessorResponse>
    {
        public ModifyQueryProcessorRequest()
            : base("OpenSearch", "2017-12-25", "ModifyQueryProcessor", "opensearch", "openAPI")
        {
        ...
        public override ModifyQueryProcessorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyQueryProcessorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
