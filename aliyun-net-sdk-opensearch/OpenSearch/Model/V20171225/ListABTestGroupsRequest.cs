...
namespace Aliyun.Acs.OpenSearch.Model.V20171225
{
    public class ListABTestGroupsRequest : RoaAcsRequest<ListABTestGroupsResponse>
    {
        ...
        public override ListABTestGroupsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListABTestGroupsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
