...
{
    public class CreateABTestGroupRequest : RoaAcsRequest<CreateABTestGroupResponse>
    {
        public CreateABTestGroupRequest()
            : base("OpenSearch", "2017-12-25", "CreateABTestGroup", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups";
        ...
        public override CreateABTestGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateABTestGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
