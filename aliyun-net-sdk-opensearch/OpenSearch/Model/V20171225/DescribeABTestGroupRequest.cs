...
{
    public class DescribeABTestGroupRequest : RoaAcsRequest<DescribeABTestGroupResponse>
    {
        public DescribeABTestGroupRequest()
            : base("OpenSearch", "2017-12-25", "DescribeABTestGroup", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups/[groupId]";
        ...
        public override DescribeABTestGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeABTestGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
