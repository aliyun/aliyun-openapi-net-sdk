...
{
    public class ListQueryProcessorsRequest : RoaAcsRequest<ListQueryProcessorsResponse>
    {
        public ListQueryProcessorsRequest()
            : base("OpenSearch", "2017-12-25", "ListQueryProcessors", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/query-processors";
		...
		public int? IsActive
		{
			...
			{
				isActive = value;
				DictionaryUtil.Add(QueryParameters, "isActive", value.ToString());
			}
		}
        ...
        public override ListQueryProcessorsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListQueryProcessorsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
