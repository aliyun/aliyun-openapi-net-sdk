...
{
    public class RenewAppGroupRequest : RoaAcsRequest<RenewAppGroupResponse>
    {
        public RenewAppGroupRequest()
            : base("OpenSearch", "2017-12-25", "RenewAppGroup", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/actions/renew";
        ...
        public override RenewAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RenewAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
