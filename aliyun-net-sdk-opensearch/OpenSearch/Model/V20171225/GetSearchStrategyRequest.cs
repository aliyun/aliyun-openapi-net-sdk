...
{
    public class GetSearchStrategyRequest : RoaAcsRequest<GetSearchStrategyResponse>
    {
        public GetSearchStrategyRequest()
            : base("OpenSearch", "2017-12-25", "GetSearchStrategy")
        {
        ...
        public override GetSearchStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSearchStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
