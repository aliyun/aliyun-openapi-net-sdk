...
{
    public class DescribeAppGroupRequest : RoaAcsRequest<DescribeAppGroupResponse>
    {
        public DescribeAppGroupRequest()
            : base("OpenSearch", "2017-12-25", "DescribeAppGroup", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]";
        ...
        public override DescribeAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
