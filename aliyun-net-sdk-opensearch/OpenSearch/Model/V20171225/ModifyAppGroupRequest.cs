...
{
    public class ModifyAppGroupRequest : RoaAcsRequest<ModifyAppGroupResponse>
    {
        public ModifyAppGroupRequest()
            : base("OpenSearch", "2017-12-25", "ModifyAppGroup", "opensearch", "openAPI")
        {
        ...
        public override ModifyAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
