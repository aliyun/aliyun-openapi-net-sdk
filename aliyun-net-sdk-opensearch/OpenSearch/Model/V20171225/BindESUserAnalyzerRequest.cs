...
{
    public class BindESUserAnalyzerRequest : RoaAcsRequest<BindESUserAnalyzerResponse>
    {
        public BindESUserAnalyzerRequest()
            : base("OpenSearch", "2017-12-25", "BindESUserAnalyzer")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/es/[esInstanceId]/actions/bind-analyzer";
        ...
        public override BindESUserAnalyzerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindESUserAnalyzerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
