...
{
    public class DescribeABTestExperimentRequest : RoaAcsRequest<DescribeABTestExperimentResponse>
    {
        public DescribeABTestExperimentRequest()
            : base("OpenSearch", "2017-12-25", "DescribeABTestExperiment", "opensearch", "openAPI")
        {
        ...
        public override DescribeABTestExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeABTestExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
