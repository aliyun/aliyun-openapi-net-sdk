...
{
    public class DescribeModelRequest : RoaAcsRequest<DescribeModelResponse>
    {
        public DescribeModelRequest()
            : base("OpenSearch", "2017-12-25", "DescribeModel", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/models/[modelName]";
        ...
        public override DescribeModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
