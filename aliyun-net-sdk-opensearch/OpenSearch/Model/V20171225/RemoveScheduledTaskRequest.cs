...
{
    public class RemoveScheduledTaskRequest : RoaAcsRequest<RemoveScheduledTaskResponse>
    {
        public RemoveScheduledTaskRequest()
            : base("OpenSearch", "2017-12-25", "RemoveScheduledTask", "opensearch", "openAPI")
        {
        ...
        public override RemoveScheduledTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveScheduledTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
