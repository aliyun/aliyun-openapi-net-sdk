...
{
    public class CreateSecondRankRequest : RoaAcsRequest<CreateSecondRankResponse>
    {
        public CreateSecondRankRequest()
            : base("OpenSearch", "2017-12-25", "CreateSecondRank", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/second-ranks";
        ...
        public override CreateSecondRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSecondRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
