...
{
    public class ModifyFirstRankRequest : RoaAcsRequest<ModifyFirstRankResponse>
    {
        public ModifyFirstRankRequest()
            : base("OpenSearch", "2017-12-25", "ModifyFirstRank", "opensearch", "openAPI")
        {
        ...
        public override ModifyFirstRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFirstRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
