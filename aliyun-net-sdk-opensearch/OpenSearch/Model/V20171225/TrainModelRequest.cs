...
{
    public class TrainModelRequest : RoaAcsRequest<TrainModelResponse>
    {
        public TrainModelRequest()
            : base("OpenSearch", "2017-12-25", "TrainModel", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/models/[modelName]/actions/train";
        ...
        public override TrainModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TrainModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
