...
{
    public class CreateSortScriptRequest : RoaAcsRequest<CreateSortScriptResponse>
    {
        public CreateSortScriptRequest()
            : base("OpenSearch", "2017-12-25", "CreateSortScript", "opensearch", "openAPI")
        {
        ...
        public override CreateSortScriptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateSortScriptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
