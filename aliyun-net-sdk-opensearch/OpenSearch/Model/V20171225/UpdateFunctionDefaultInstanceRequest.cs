...
{
    public class UpdateFunctionDefaultInstanceRequest : RoaAcsRequest<UpdateFunctionDefaultInstanceResponse>
    {
        public UpdateFunctionDefaultInstanceRequest()
            : base("OpenSearch", "2017-12-25", "UpdateFunctionDefaultInstance")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/functions/[functionName]/default-instance";
        ...
        public override UpdateFunctionDefaultInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateFunctionDefaultInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
