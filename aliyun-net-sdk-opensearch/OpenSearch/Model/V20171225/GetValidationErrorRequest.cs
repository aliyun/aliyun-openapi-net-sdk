...
{
    public class GetValidationErrorRequest : RoaAcsRequest<GetValidationErrorResponse>
    {
        public GetValidationErrorRequest()
            : base("OpenSearch", "2017-12-25", "GetValidationError", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/data/validation-error";
        ...
        public override GetValidationErrorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetValidationErrorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
