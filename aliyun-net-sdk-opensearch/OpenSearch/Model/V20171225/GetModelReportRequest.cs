...
{
    public class GetModelReportRequest : RoaAcsRequest<GetModelReportResponse>
    {
        public GetModelReportRequest()
            : base("OpenSearch", "2017-12-25", "GetModelReport", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/models/[modelName]/report";
        ...
        public override GetModelReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetModelReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
