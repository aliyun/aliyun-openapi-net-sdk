...
{
	public class ModifyAppGroupResponse : AcsResponse
	{

		private string requestId;

		private ModifyAppGroup_Result result;
		...
		public ModifyAppGroup_Result Result
		{
			get
			{
				return result;
		...
		public class ModifyAppGroup_Result
		{
			...
			private ModifyAppGroup_Quota quota;
			...
			public ModifyAppGroup_Quota Quota
			{
				get
				{
					return quota;
			...
			public class ModifyAppGroup_Quota
			{
