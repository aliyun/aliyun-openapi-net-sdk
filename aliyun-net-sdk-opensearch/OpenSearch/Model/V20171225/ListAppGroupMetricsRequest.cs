...
{
    public class ListAppGroupMetricsRequest : RoaAcsRequest<ListAppGroupMetricsResponse>
    {
        public ListAppGroupMetricsRequest()
            : base("OpenSearch", "2017-12-25", "ListAppGroupMetrics", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/metrics";
		...
		public string Indexes
		{
			...
			{
				indexes = value;
				DictionaryUtil.Add(QueryParameters, "indexes", value);
			}
		}
        ...
        public override ListAppGroupMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAppGroupMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
