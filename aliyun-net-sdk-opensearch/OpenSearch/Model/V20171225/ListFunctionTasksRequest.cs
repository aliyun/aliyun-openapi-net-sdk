...
{
    public class ListFunctionTasksRequest : RoaAcsRequest<ListFunctionTasksResponse>
    {
        public ListFunctionTasksRequest()
            : base("OpenSearch", "2017-12-25", "ListFunctionTasks")
        {
        ...
        public override ListFunctionTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFunctionTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
