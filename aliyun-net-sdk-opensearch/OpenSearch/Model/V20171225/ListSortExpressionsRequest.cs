...
{
    public class ListSortExpressionsRequest : RoaAcsRequest<ListSortExpressionsResponse>
    {
        public ListSortExpressionsRequest()
            : base("OpenSearch", "2017-12-25", "ListSortExpressions", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/sort-expressions";
        ...
        public override ListSortExpressionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSortExpressionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
