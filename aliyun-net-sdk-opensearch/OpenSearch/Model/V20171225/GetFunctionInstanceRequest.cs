...
{
    public class GetFunctionInstanceRequest : RoaAcsRequest<GetFunctionInstanceResponse>
    {
        public GetFunctionInstanceRequest()
            : base("OpenSearch", "2017-12-25", "GetFunctionInstance")
        {
        ...
        public override GetFunctionInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFunctionInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
