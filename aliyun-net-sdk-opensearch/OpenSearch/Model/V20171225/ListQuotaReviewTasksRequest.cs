...
{
    public class ListQuotaReviewTasksRequest : RoaAcsRequest<ListQuotaReviewTasksResponse>
    {
        public ListQuotaReviewTasksRequest()
            : base("OpenSearch", "2017-12-25", "ListQuotaReviewTasks", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/quota-review-tasks";
        ...
        public override ListQuotaReviewTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListQuotaReviewTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
