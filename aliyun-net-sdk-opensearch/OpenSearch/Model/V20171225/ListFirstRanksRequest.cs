...
{
    public class ListFirstRanksRequest : RoaAcsRequest<ListFirstRanksResponse>
    {
        public ListFirstRanksRequest()
            : base("OpenSearch", "2017-12-25", "ListFirstRanks", "opensearch", "openAPI")
        {
        ...
        public override ListFirstRanksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListFirstRanksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
