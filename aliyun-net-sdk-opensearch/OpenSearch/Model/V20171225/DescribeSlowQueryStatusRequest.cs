...
{
    public class DescribeSlowQueryStatusRequest : RoaAcsRequest<DescribeSlowQueryStatusResponse>
    {
        public DescribeSlowQueryStatusRequest()
            : base("OpenSearch", "2017-12-25", "DescribeSlowQueryStatus", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/optimizers/slow-query";
        ...
        public override DescribeSlowQueryStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSlowQueryStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
