...
{
    public class CreateDataCollectionRequest : RoaAcsRequest<CreateDataCollectionResponse>
    {
        public CreateDataCollectionRequest()
            : base("OpenSearch", "2017-12-25", "CreateDataCollection", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/data-collections";
        ...
        public override CreateDataCollectionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDataCollectionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
