...
{
    public class GetFunctionTaskRequest : RoaAcsRequest<GetFunctionTaskResponse>
    {
        public GetFunctionTaskRequest()
            : base("OpenSearch", "2017-12-25", "GetFunctionTask")
        {
        ...
        public override GetFunctionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFunctionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
