...
{
    public class ListStatisticReportRequest : RoaAcsRequest<ListStatisticReportResponse>
    {
        public ListStatisticReportRequest()
            : base("OpenSearch", "2017-12-25", "ListStatisticReport", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/statistic-report/[moduleName]";
        ...
        public override ListStatisticReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListStatisticReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
