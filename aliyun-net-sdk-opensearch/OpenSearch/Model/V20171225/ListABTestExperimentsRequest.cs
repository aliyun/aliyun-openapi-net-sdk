...
{
    public class ListABTestExperimentsRequest : RoaAcsRequest<ListABTestExperimentsResponse>
    {
        public ListABTestExperimentsRequest()
            : base("OpenSearch", "2017-12-25", "ListABTestExperiments", "opensearch", "openAPI")
        {
        ...
        public override ListABTestExperimentsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListABTestExperimentsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
