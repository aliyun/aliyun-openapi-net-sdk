...
{
    public class DescribeRegionRequest : RoaAcsRequest<DescribeRegionResponse>
    {
        public DescribeRegionRequest()
            : base("OpenSearch", "2017-12-25", "DescribeRegion", "opensearch", "openAPI")
        {
        ...
        public override DescribeRegionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRegionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
