...
{
    public class DescribeScheduledTaskRequest : RoaAcsRequest<DescribeScheduledTaskResponse>
    {
        public DescribeScheduledTaskRequest()
            : base("OpenSearch", "2017-12-25", "DescribeScheduledTask", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scheduled-tasks/[taskId]";
        ...
        public override DescribeScheduledTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeScheduledTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
