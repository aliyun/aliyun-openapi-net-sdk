...
{
    public class DisableSlowQueryRequest : RoaAcsRequest<DisableSlowQueryResponse>
    {
        public DisableSlowQueryRequest()
            : base("OpenSearch", "2017-12-25", "DisableSlowQuery", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/optimizers/slow-query/actions/disable";
        ...
        public override DisableSlowQueryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableSlowQueryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
