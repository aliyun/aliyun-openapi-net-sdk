...
{
    public class UpdateFetchFieldsRequest : RoaAcsRequest<UpdateFetchFieldsResponse>
    {
        public UpdateFetchFieldsRequest()
            : base("OpenSearch", "2017-12-25", "UpdateFetchFields", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/fetch-fields";
        ...
        public override UpdateFetchFieldsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateFetchFieldsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
