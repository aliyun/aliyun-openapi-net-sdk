...
{
    public class GetFunctionDefaultInstanceRequest : RoaAcsRequest<GetFunctionDefaultInstanceResponse>
    {
        public GetFunctionDefaultInstanceRequest()
            : base("OpenSearch", "2017-12-25", "GetFunctionDefaultInstance")
        {
        ...
        public override GetFunctionDefaultInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFunctionDefaultInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
