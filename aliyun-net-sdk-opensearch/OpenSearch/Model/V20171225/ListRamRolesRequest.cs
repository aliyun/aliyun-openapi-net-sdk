...
{
    public class ListRamRolesRequest : RoaAcsRequest<ListRamRolesResponse>
    {
        public ListRamRolesRequest()
            : base("OpenSearch", "2017-12-25", "ListRamRoles", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/assist/ram/roles";
        ...
        public override ListRamRolesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListRamRolesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
