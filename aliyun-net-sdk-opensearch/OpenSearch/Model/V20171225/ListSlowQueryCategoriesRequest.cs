...
{
    public class ListSlowQueryCategoriesRequest : RoaAcsRequest<ListSlowQueryCategoriesResponse>
    {
        public ListSlowQueryCategoriesRequest()
            : base("OpenSearch", "2017-12-25", "ListSlowQueryCategories", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/optimizers/slow-query/categories";
        ...
        public override ListSlowQueryCategoriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSlowQueryCategoriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
