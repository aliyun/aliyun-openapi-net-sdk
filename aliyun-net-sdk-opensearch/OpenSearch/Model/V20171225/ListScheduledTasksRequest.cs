...
{
    public class ListScheduledTasksRequest : RoaAcsRequest<ListScheduledTasksResponse>
    {
        public ListScheduledTasksRequest()
            : base("OpenSearch", "2017-12-25", "ListScheduledTasks", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scheduled-tasks";
        ...
        public override ListScheduledTasksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListScheduledTasksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
