...
{
    public class ListProceedingsRequest : RoaAcsRequest<ListProceedingsResponse>
    {
        public ListProceedingsRequest()
            : base("OpenSearch", "2017-12-25", "ListProceedings")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/proceedings";
			Method = MethodType.GET;
        }

		private bool? filterFinished;
		...
		public bool? FilterFinished
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "filterFinished", value.ToString());
			}
		}
        ...
        public override ListProceedingsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListProceedingsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
