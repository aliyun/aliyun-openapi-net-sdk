...
{
    public class ListSecondRanksRequest : RoaAcsRequest<ListSecondRanksResponse>
    {
        public ListSecondRanksRequest()
            : base("OpenSearch", "2017-12-25", "ListSecondRanks", "opensearch", "openAPI")
        {
        ...
        public override ListSecondRanksResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSecondRanksResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
