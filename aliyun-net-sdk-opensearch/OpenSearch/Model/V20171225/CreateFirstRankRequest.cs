...
{
    public class CreateFirstRankRequest : RoaAcsRequest<CreateFirstRankResponse>
    {
        public CreateFirstRankRequest()
            : base("OpenSearch", "2017-12-25", "CreateFirstRank", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/first-ranks";
        ...
        public override CreateFirstRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFirstRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
