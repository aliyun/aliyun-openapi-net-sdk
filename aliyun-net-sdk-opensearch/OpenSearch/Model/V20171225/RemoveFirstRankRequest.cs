...
{
    public class RemoveFirstRankRequest : RoaAcsRequest<RemoveFirstRankResponse>
    {
        public RemoveFirstRankRequest()
            : base("OpenSearch", "2017-12-25", "RemoveFirstRank", "opensearch", "openAPI")
        {
        ...
        public override RemoveFirstRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveFirstRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
