...
{
    public class DescribeABTestSceneRequest : RoaAcsRequest<DescribeABTestSceneResponse>
    {
        public DescribeABTestSceneRequest()
            : base("OpenSearch", "2017-12-25", "DescribeABTestScene", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]";
        ...
        public override DescribeABTestSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeABTestSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
