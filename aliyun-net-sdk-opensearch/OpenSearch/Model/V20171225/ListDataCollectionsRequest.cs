...
{
    public class ListDataCollectionsRequest : RoaAcsRequest<ListDataCollectionsResponse>
    {
        public ListDataCollectionsRequest()
            : base("OpenSearch", "2017-12-25", "ListDataCollections", "opensearch", "openAPI")
        {
        ...
        public override ListDataCollectionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDataCollectionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
