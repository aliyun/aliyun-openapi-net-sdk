...
{
    public class GetValidationReportRequest : RoaAcsRequest<GetValidationReportResponse>
    {
        public GetValidationReportRequest()
            : base("OpenSearch", "2017-12-25", "GetValidationReport", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/data/validation-report";
        ...
        public override GetValidationReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetValidationReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
