...
{
    public class BindEsInstanceRequest : RoaAcsRequest<BindEsInstanceResponse>
    {
        public BindEsInstanceRequest()
            : base("OpenSearch", "2017-12-25", "BindEsInstance")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/actions/bind-es-instance";
        ...
        public override BindEsInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BindEsInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
