...
{
    public class GenerateMergedTableRequest : RoaAcsRequest<GenerateMergedTableResponse>
    {
        public GenerateMergedTableRequest()
            : base("OpenSearch", "2017-12-25", "GenerateMergedTable", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/assist/schema/actions/merge";
        ...
        public override GenerateMergedTableResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateMergedTableResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
