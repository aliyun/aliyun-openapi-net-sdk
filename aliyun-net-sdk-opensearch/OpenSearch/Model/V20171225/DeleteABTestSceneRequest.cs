...
{
    public class DeleteABTestSceneRequest : RoaAcsRequest<DeleteABTestSceneResponse>
    {
        public DeleteABTestSceneRequest()
            : base("OpenSearch", "2017-12-25", "DeleteABTestScene", "opensearch", "openAPI")
        {
        ...
        public override DeleteABTestSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteABTestSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
