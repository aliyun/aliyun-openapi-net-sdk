...
{
    public class ModifySecondRankRequest : RoaAcsRequest<ModifySecondRankResponse>
    {
        public ModifySecondRankRequest()
            : base("OpenSearch", "2017-12-25", "ModifySecondRank", "opensearch", "openAPI")
        {
        ...
        public override ModifySecondRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifySecondRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
