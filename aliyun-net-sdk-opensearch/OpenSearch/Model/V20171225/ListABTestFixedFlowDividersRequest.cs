...
{
    public class ListABTestFixedFlowDividersRequest : RoaAcsRequest<ListABTestFixedFlowDividersResponse>
    {
        public ListABTestFixedFlowDividersRequest()
            : base("OpenSearch", "2017-12-25", "ListABTestFixedFlowDividers", "opensearch", "openAPI")
        {
        ...
        public override ListABTestFixedFlowDividersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListABTestFixedFlowDividersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
