...
{
    public class CreateABTestExperimentRequest : RoaAcsRequest<CreateABTestExperimentResponse>
    {
        public CreateABTestExperimentRequest()
            : base("OpenSearch", "2017-12-25", "CreateABTestExperiment", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups/[groupId]/experiments";
        ...
        public override CreateABTestExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateABTestExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
