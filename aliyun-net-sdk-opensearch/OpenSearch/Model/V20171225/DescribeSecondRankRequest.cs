...
{
    public class DescribeSecondRankRequest : RoaAcsRequest<DescribeSecondRankResponse>
    {
        public DescribeSecondRankRequest()
            : base("OpenSearch", "2017-12-25", "DescribeSecondRank", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/second-ranks/[name]";
        ...
        public override DescribeSecondRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeSecondRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
