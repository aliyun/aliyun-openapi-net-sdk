...
{
    public class GetScriptFileNamesRequest : RoaAcsRequest<GetScriptFileNamesResponse>
    {
        public GetScriptFileNamesRequest()
            : base("OpenSearch", "2017-12-25", "GetScriptFileNames", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appVersionId]/sort-scripts/[scriptName]/file-names";
        ...
        public override GetScriptFileNamesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetScriptFileNamesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
