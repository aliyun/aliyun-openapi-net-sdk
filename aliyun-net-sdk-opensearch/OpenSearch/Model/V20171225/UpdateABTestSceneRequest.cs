...
{
    public class UpdateABTestSceneRequest : RoaAcsRequest<UpdateABTestSceneResponse>
    {
        public UpdateABTestSceneRequest()
            : base("OpenSearch", "2017-12-25", "UpdateABTestScene", "opensearch", "openAPI")
        {
        ...
        public override UpdateABTestSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateABTestSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
