...
{
    public class ModifyAppGroupQuotaRequest : RoaAcsRequest<ModifyAppGroupQuotaResponse>
    {
        public ModifyAppGroupQuotaRequest()
            : base("OpenSearch", "2017-12-25", "ModifyAppGroupQuota", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/quota";
        ...
        public override ModifyAppGroupQuotaResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyAppGroupQuotaResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
