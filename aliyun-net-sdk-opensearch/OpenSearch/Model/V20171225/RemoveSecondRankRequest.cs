...
{
    public class RemoveSecondRankRequest : RoaAcsRequest<RemoveSecondRankResponse>
    {
        public RemoveSecondRankRequest()
            : base("OpenSearch", "2017-12-25", "RemoveSecondRank", "opensearch", "openAPI")
        {
        ...
        public override RemoveSecondRankResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveSecondRankResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
