...
{
    public class CompileSortScriptRequest : RoaAcsRequest<CompileSortScriptResponse>
    {
        public CompileSortScriptRequest()
            : base("OpenSearch", "2017-12-25", "CompileSortScript", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appVersionId]/sort-scripts/[scriptName]/actions/compiling";
		...
		public string ScriptName
		{
			...
			{
				scriptName = value;
				DictionaryUtil.Add(PathParameters, "scriptName", value);
			}
		}
        ...
        public override CompileSortScriptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CompileSortScriptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
