...
{
    public class UnbindESUserAnalyzerRequest : RoaAcsRequest<UnbindESUserAnalyzerResponse>
    {
        public UnbindESUserAnalyzerRequest()
            : base("OpenSearch", "2017-12-25", "UnbindESUserAnalyzer")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/es/[esInstanceId]/actions/unbind-analyzer";
		...
		public string EsInstanceId
		{
			...
			{
				esInstanceId = value;
				DictionaryUtil.Add(PathParameters, "esInstanceId", value);
			}
		}
        ...
        public override UnbindESUserAnalyzerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UnbindESUserAnalyzerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
