...
{
    public class DeleteABTestExperimentRequest : RoaAcsRequest<DeleteABTestExperimentResponse>
    {
        public DeleteABTestExperimentRequest()
            : base("OpenSearch", "2017-12-25", "DeleteABTestExperiment", "opensearch", "openAPI")
        {
        ...
        public override DeleteABTestExperimentResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteABTestExperimentResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
