...
{
    public class GetModelProgressRequest : RoaAcsRequest<GetModelProgressResponse>
    {
        public GetModelProgressRequest()
            : base("OpenSearch", "2017-12-25", "GetModelProgress", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/models/[modelName]/progress";
        ...
        public override GetModelProgressResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetModelProgressResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
