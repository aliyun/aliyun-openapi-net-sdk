...
{
    public class UpdateABTestFixedFlowDividersRequest : RoaAcsRequest<UpdateABTestFixedFlowDividersResponse>
    {
        public UpdateABTestFixedFlowDividersRequest()
            : base("OpenSearch", "2017-12-25", "UpdateABTestFixedFlowDividers", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups/[groupId]/experiments/[experimentId]/fixed-flow-dividers";
        ...
        public override UpdateABTestFixedFlowDividersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateABTestFixedFlowDividersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
