...
{
    public class ListABTestMetricsRequest : RoaAcsRequest<ListABTestMetricsResponse>
    {
        public ListABTestMetricsRequest()
            : base("OpenSearch", "2017-12-25", "ListABTestMetrics", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups/[groupId]/metrics";
        ...
        public override ListABTestMetricsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListABTestMetricsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
