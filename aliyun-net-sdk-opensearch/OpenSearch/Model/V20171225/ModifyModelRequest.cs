...
{
    public class ModifyModelRequest : RoaAcsRequest<ModifyModelResponse>
    {
        public ModifyModelRequest()
            : base("OpenSearch", "2017-12-25", "ModifyModel", "opensearch", "openAPI")
        {
        ...
        public override ModifyModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
