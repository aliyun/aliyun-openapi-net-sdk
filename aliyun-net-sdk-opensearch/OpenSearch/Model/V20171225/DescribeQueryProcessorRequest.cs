...
{
    public class DescribeQueryProcessorRequest : RoaAcsRequest<DescribeQueryProcessorResponse>
    {
        public DescribeQueryProcessorRequest()
            : base("OpenSearch", "2017-12-25", "DescribeQueryProcessor", "opensearch", "openAPI")
        {
        ...
        public override DescribeQueryProcessorResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeQueryProcessorResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
