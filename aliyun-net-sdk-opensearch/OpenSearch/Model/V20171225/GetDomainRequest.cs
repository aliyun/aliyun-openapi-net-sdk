...
{
    public class GetDomainRequest : RoaAcsRequest<GetDomainResponse>
    {
        public GetDomainRequest()
            : base("OpenSearch", "2017-12-25", "GetDomain", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/domains/[domainName]";
		...
		public string DomainName
		{
			...
			{
				domainName = value;
				DictionaryUtil.Add(PathParameters, "domainName", value);
			}
		}
		...
		public string AppGroupIdentity
		{
			...
			set	
			{
				...
				DictionaryUtil.Add(QueryParameters, "appGroupIdentity", value);
			}
		}
