...
{
    public class GetSortScriptFileRequest : RoaAcsRequest<GetSortScriptFileResponse>
    {
        public GetSortScriptFileRequest()
            : base("OpenSearch", "2017-12-25", "GetSortScriptFile", "opensearch", "openAPI")
        {
        ...
        public override GetSortScriptFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSortScriptFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
