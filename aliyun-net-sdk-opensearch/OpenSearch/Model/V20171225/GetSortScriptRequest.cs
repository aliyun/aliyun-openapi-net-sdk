...
{
    public class GetSortScriptRequest : RoaAcsRequest<GetSortScriptResponse>
    {
        public GetSortScriptRequest()
            : base("OpenSearch", "2017-12-25", "GetSortScript", "opensearch", "openAPI")
        {
        ...
        public override GetSortScriptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSortScriptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
