...
{
    public class ListUserAnalyzerEntriesRequest : RoaAcsRequest<ListUserAnalyzerEntriesResponse>
    {
        public ListUserAnalyzerEntriesRequest()
            : base("OpenSearch", "2017-12-25", "ListUserAnalyzerEntries", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/user-analyzers/[name]/entries";
        ...
        public override ListUserAnalyzerEntriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserAnalyzerEntriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
