...
{
    public class EnableSlowQueryRequest : RoaAcsRequest<EnableSlowQueryResponse>
    {
        public EnableSlowQueryRequest()
            : base("OpenSearch", "2017-12-25", "EnableSlowQuery", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/optimizers/slow-query/actions/enable";
        ...
        public override EnableSlowQueryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EnableSlowQueryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
