...
{
    public class ReplaceAppGroupCommodityCodeRequest : RoaAcsRequest<ReplaceAppGroupCommodityCodeResponse>
    {
        public ReplaceAppGroupCommodityCodeRequest()
            : base("OpenSearch", "2017-12-25", "ReplaceAppGroupCommodityCode", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/actions/to-instance-typed";
        ...
        public override ReplaceAppGroupCommodityCodeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReplaceAppGroupCommodityCodeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
