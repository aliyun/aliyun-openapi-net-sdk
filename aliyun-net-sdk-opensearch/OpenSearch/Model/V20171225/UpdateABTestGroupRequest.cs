...
{
    public class UpdateABTestGroupRequest : RoaAcsRequest<UpdateABTestGroupResponse>
    {
        public UpdateABTestGroupRequest()
            : base("OpenSearch", "2017-12-25", "UpdateABTestGroup", "opensearch", "openAPI")
        {
        ...
        public override UpdateABTestGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateABTestGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
