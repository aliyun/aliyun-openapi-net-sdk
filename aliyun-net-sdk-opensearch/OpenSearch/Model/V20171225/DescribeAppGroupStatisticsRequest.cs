...
{
    public class DescribeAppGroupStatisticsRequest : RoaAcsRequest<DescribeAppGroupStatisticsResponse>
    {
        public DescribeAppGroupStatisticsRequest()
            : base("OpenSearch", "2017-12-25", "DescribeAppGroupStatistics")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/statistics";
        ...
        public override DescribeAppGroupStatisticsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeAppGroupStatisticsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
