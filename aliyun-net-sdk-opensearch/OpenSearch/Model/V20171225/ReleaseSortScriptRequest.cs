...
{
    public class ReleaseSortScriptRequest : RoaAcsRequest<ReleaseSortScriptResponse>
    {
        public ReleaseSortScriptRequest()
            : base("OpenSearch", "2017-12-25", "ReleaseSortScript", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appVersionId]/sort-scripts/[scriptName]/actions/release";
        ...
        public override ReleaseSortScriptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ReleaseSortScriptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
