...
{
    public class ListQueryProcessorAnalyzerResultsRequest : RoaAcsRequest<ListQueryProcessorAnalyzerResultsResponse>
    {
        public ListQueryProcessorAnalyzerResultsRequest()
            : base("OpenSearch", "2017-12-25", "ListQueryProcessorAnalyzerResults")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/query-processors/[name]/analyze";
        ...
        public override ListQueryProcessorAnalyzerResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListQueryProcessorAnalyzerResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
