...
{
    public class RemoveUserAnalyzerRequest : RoaAcsRequest<RemoveUserAnalyzerResponse>
    {
        public RemoveUserAnalyzerRequest()
            : base("OpenSearch", "2017-12-25", "RemoveUserAnalyzer", "opensearch", "openAPI")
        {
        ...
        public override RemoveUserAnalyzerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveUserAnalyzerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
