...
{
    public class PreviewModelRequest : RoaAcsRequest<PreviewModelResponse>
    {
        public PreviewModelRequest()
            : base("OpenSearch", "2017-12-25", "PreviewModel", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/algorithm/models/[modelName]/actions/preview";
        ...
        public override PreviewModelResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return PreviewModelResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
