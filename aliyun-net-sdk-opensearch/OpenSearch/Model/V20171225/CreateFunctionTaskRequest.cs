...
{
    public class CreateFunctionTaskRequest : RoaAcsRequest<CreateFunctionTaskResponse>
    {
        public CreateFunctionTaskRequest()
            : base("OpenSearch", "2017-12-25", "CreateFunctionTask")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/functions/[functionName]/instances/[instanceName]/tasks";
        ...
        public override CreateFunctionTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFunctionTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
