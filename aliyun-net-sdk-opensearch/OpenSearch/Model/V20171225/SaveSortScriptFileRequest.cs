...
{
    public class SaveSortScriptFileRequest : RoaAcsRequest<SaveSortScriptFileResponse>
    {
        public SaveSortScriptFileRequest()
            : base("OpenSearch", "2017-12-25", "SaveSortScriptFile", "opensearch", "openAPI")
        {
        ...
        public override SaveSortScriptFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SaveSortScriptFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
