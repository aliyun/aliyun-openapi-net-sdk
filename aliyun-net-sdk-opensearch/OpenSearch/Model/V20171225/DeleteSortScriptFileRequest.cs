...
{
    public class DeleteSortScriptFileRequest : RoaAcsRequest<DeleteSortScriptFileResponse>
    {
        public DeleteSortScriptFileRequest()
            : base("OpenSearch", "2017-12-25", "DeleteSortScriptFile", "opensearch", "openAPI")
        {
        ...
        public override DeleteSortScriptFileResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSortScriptFileResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
