...
{
    public class GetFunctionVersionRequest : RoaAcsRequest<GetFunctionVersionResponse>
    {
        public GetFunctionVersionRequest()
            : base("OpenSearch", "2017-12-25", "GetFunctionVersion")
        {
			...
			UriPattern = "/v4/openapi/functions/[functionName]/versions/[versionId]";
		...
		public int? VersionId
		{
			...
			{
				versionId = value;
				DictionaryUtil.Add(PathParameters, "versionId", value.ToString());
			}
		}
        ...
        public override GetFunctionVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetFunctionVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
