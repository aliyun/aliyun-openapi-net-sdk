...
{
    public class RemoveSearchStrategyRequest : RoaAcsRequest<RemoveSearchStrategyResponse>
    {
        public RemoveSearchStrategyRequest()
            : base("OpenSearch", "2017-12-25", "RemoveSearchStrategy")
        {
        ...
        public override RemoveSearchStrategyResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveSearchStrategyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
