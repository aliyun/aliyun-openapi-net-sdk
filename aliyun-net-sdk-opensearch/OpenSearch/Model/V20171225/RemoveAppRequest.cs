...
{
    public class RemoveAppRequest : RoaAcsRequest<RemoveAppResponse>
    {
        public RemoveAppRequest()
            : base("OpenSearch", "2017-12-25", "RemoveApp", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]";
        ...
        public override RemoveAppResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveAppResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
