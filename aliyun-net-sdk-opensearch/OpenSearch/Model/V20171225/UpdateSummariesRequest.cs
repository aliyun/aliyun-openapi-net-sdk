...
{
    public class UpdateSummariesRequest : RoaAcsRequest<UpdateSummariesResponse>
    {
        public UpdateSummariesRequest()
            : base("OpenSearch", "2017-12-25", "UpdateSummaries", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/summaries";
        ...
        public override UpdateSummariesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateSummariesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
