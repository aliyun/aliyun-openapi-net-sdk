...
{
    public class DeleteABTestGroupRequest : RoaAcsRequest<DeleteABTestGroupResponse>
    {
        public DeleteABTestGroupRequest()
            : base("OpenSearch", "2017-12-25", "DeleteABTestGroup", "opensearch", "openAPI")
        {
        ...
        public override DeleteABTestGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteABTestGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
