...
{
    public class StartSlowQueryAnalyzerRequest : RoaAcsRequest<StartSlowQueryAnalyzerResponse>
    {
        public StartSlowQueryAnalyzerRequest()
            : base("OpenSearch", "2017-12-25", "StartSlowQueryAnalyzer", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/optimizers/slow-query/actions/run";
        ...
        public override StartSlowQueryAnalyzerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartSlowQueryAnalyzerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
