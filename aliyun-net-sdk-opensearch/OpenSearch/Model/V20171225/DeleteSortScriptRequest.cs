...
{
    public class DeleteSortScriptRequest : RoaAcsRequest<DeleteSortScriptResponse>
    {
        public DeleteSortScriptRequest()
            : base("OpenSearch", "2017-12-25", "DeleteSortScript", "opensearch", "openAPI")
        {
        ...
        public override DeleteSortScriptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSortScriptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
