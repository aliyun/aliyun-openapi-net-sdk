...
{
    public class DescribeAppsRequest : RoaAcsRequest<DescribeAppsResponse>
    {
        public DescribeAppsRequest()
            : base("OpenSearch", "2017-12-25", "DescribeApps", "opensearch", "openAPI")
        {
			...
			UriPattern = "/v4/openapi/app-groups/[appGroupIdentity]/apps";
