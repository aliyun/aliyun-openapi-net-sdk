...
{
    public class RemoveAppGroupRequest : RoaAcsRequest<RemoveAppGroupResponse>
    {
        public RemoveAppGroupRequest()
            : base("OpenSearch", "2017-12-25", "RemoveAppGroup", "opensearch", "openAPI")
        {
        ...
        public override RemoveAppGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveAppGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
