...
{
    public class CreateFunctionInstanceRequest : RoaAcsRequest<CreateFunctionInstanceResponse>
    {
        public CreateFunctionInstanceRequest()
            : base("OpenSearch", "2017-12-25", "CreateFunctionInstance")
        {
        ...
        public override CreateFunctionInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateFunctionInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
