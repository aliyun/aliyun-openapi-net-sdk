...
namespace Aliyun.Acs.OpenSearch.Transform.V20171225
{
    ...
    {
        public static ListSlowQueryCategoriesResponse Unmarshall(UnmarshallerContext _ctx)
        {
			ListSlowQueryCategoriesResponse listSlowQueryCategoriesResponse = new ListSlowQueryCategoriesResponse();

			listSlowQueryCategoriesResponse.HttpResponse = _ctx.HttpResponse;
