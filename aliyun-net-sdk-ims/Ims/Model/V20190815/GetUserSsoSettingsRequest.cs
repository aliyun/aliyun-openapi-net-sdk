...
{
    public class GetUserSsoSettingsRequest : RpcAcsRequest<GetUserSsoSettingsResponse>
    {
        public GetUserSsoSettingsRequest()
            : base("Ims", "2019-08-15", "GetUserSsoSettings", "ims", "openAPI")
        {
        ...
        public override GetUserSsoSettingsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserSsoSettingsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
