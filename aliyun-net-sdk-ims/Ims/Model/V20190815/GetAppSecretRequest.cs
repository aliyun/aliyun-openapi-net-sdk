...
{
    public class GetAppSecretRequest : RpcAcsRequest<GetAppSecretResponse>
    {
        public GetAppSecretRequest()
            : base("Ims", "2019-08-15", "GetAppSecret", "ims", "openAPI")
        {
        ...
        public override GetAppSecretResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAppSecretResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
