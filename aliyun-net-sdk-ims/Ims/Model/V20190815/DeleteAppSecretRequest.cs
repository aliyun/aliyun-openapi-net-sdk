...
{
    public class DeleteAppSecretRequest : RpcAcsRequest<DeleteAppSecretResponse>
    {
        public DeleteAppSecretRequest()
            : base("Ims", "2019-08-15", "DeleteAppSecret", "ims", "openAPI")
        {
		...
		public string AppSecretId
		{
			...
			{
				appSecretId = value;
				DictionaryUtil.Add(QueryParameters, "AppSecretId", value);
			}
		}
        ...
        public override DeleteAppSecretResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteAppSecretResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
