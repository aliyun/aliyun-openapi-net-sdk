...
{
    public class AddFingerprintToOIDCProviderRequest : RpcAcsRequest<AddFingerprintToOIDCProviderResponse>
    {
        public AddFingerprintToOIDCProviderRequest()
            : base("Ims", "2019-08-15", "AddFingerprintToOIDCProvider", "ims", "openAPI")
        {
        ...
        public override AddFingerprintToOIDCProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddFingerprintToOIDCProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
