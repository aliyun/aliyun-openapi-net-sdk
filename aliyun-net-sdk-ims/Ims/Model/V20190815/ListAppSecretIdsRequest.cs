...
{
    public class ListAppSecretIdsRequest : RpcAcsRequest<ListAppSecretIdsResponse>
    {
        public ListAppSecretIdsRequest()
            : base("Ims", "2019-08-15", "ListAppSecretIds", "ims", "openAPI")
        {
        ...
        public override ListAppSecretIdsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListAppSecretIdsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
