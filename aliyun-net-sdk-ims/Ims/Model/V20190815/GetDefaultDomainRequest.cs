...
{
    public class GetDefaultDomainRequest : RpcAcsRequest<GetDefaultDomainResponse>
    {
        public GetDefaultDomainRequest()
            : base("Ims", "2019-08-15", "GetDefaultDomain", "ims", "openAPI")
        {
        ...
        public override GetDefaultDomainResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetDefaultDomainResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
