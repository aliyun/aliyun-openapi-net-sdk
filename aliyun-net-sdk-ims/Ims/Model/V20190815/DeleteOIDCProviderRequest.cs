...
{
    public class DeleteOIDCProviderRequest : RpcAcsRequest<DeleteOIDCProviderResponse>
    {
        public DeleteOIDCProviderRequest()
            : base("Ims", "2019-08-15", "DeleteOIDCProvider", "ims", "openAPI")
        {
        ...
        public override DeleteOIDCProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteOIDCProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
