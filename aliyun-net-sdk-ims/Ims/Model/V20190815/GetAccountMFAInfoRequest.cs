...
{
    public class GetAccountMFAInfoRequest : RpcAcsRequest<GetAccountMFAInfoResponse>
    {
        public GetAccountMFAInfoRequest()
            : base("Ims", "2019-08-15", "GetAccountMFAInfo", "ims", "openAPI")
        {
        ...
        public override GetAccountMFAInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAccountMFAInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
