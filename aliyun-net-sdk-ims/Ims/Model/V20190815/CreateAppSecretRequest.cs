...
{
    public class CreateAppSecretRequest : RpcAcsRequest<CreateAppSecretResponse>
    {
        public CreateAppSecretRequest()
            : base("Ims", "2019-08-15", "CreateAppSecret", "ims", "openAPI")
        {
        ...
        public override CreateAppSecretResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateAppSecretResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
