...
{
    public class GetOIDCProviderRequest : RpcAcsRequest<GetOIDCProviderResponse>
    {
        public GetOIDCProviderRequest()
            : base("Ims", "2019-08-15", "GetOIDCProvider", "ims", "openAPI")
        {
        ...
        public override GetOIDCProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOIDCProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
