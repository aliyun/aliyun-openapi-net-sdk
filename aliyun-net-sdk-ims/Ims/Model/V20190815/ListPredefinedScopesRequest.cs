...
{
    public class ListPredefinedScopesRequest : RpcAcsRequest<ListPredefinedScopesResponse>
    {
        public ListPredefinedScopesRequest()
            : base("Ims", "2019-08-15", "ListPredefinedScopes", "ims", "openAPI")
        {
        ...
        public override ListPredefinedScopesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListPredefinedScopesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
