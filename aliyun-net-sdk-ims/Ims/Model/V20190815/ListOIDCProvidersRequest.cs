...
{
    public class ListOIDCProvidersRequest : RpcAcsRequest<ListOIDCProvidersResponse>
    {
        public ListOIDCProvidersRequest()
            : base("Ims", "2019-08-15", "ListOIDCProviders", "ims", "openAPI")
        {
        ...
        public override ListOIDCProvidersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOIDCProvidersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
