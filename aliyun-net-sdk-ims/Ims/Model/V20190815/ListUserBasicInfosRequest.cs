...
{
    public class ListUserBasicInfosRequest : RpcAcsRequest<ListUserBasicInfosResponse>
    {
        public ListUserBasicInfosRequest()
            : base("Ims", "2019-08-15", "ListUserBasicInfos", "ims", "openAPI")
        {
        ...
        public override ListUserBasicInfosResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListUserBasicInfosResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
