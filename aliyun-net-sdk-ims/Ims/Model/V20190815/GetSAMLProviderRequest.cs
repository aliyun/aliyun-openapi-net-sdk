...
{
    public class GetSAMLProviderRequest : RpcAcsRequest<GetSAMLProviderResponse>
    {
        public GetSAMLProviderRequest()
            : base("Ims", "2019-08-15", "GetSAMLProvider", "ims", "openAPI")
        {
        ...
        public override GetSAMLProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetSAMLProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
