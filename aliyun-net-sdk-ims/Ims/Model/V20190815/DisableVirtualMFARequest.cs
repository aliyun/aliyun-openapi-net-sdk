...
{
    public class DisableVirtualMFARequest : RpcAcsRequest<DisableVirtualMFAResponse>
    {
        public DisableVirtualMFARequest()
            : base("Ims", "2019-08-15", "DisableVirtualMFA", "ims", "openAPI")
        {
        ...
        public override DisableVirtualMFAResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DisableVirtualMFAResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
