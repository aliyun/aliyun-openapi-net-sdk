...
{
    public class ListSAMLProvidersRequest : RpcAcsRequest<ListSAMLProvidersResponse>
    {
        public ListSAMLProvidersRequest()
            : base("Ims", "2019-08-15", "ListSAMLProviders", "ims", "openAPI")
        {
        ...
        public override ListSAMLProvidersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListSAMLProvidersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
