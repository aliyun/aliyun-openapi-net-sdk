...
namespace Aliyun.Acs.Ims.Model.V20190815
{
    public class UntagResourcesRequest : RpcAcsRequest<UntagResourcesResponse>
    {
        public UntagResourcesRequest()
            : base("Ims", "2019-08-15", "UntagResources", "ims", "openAPI")
        {
		...
		private List<string> resourcePrincipalNames = new List<string>(){ };
		...
		[JsonProperty(PropertyName = "ResourcePrincipalName")]
		public List<string> ResourcePrincipalNames
		{
			get
			{
				return resourcePrincipalNames;
			}

			set
			{
				resourcePrincipalNames = value;
			}
		}
