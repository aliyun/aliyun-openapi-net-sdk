...
{
	public class GetOIDCProviderResponse : AcsResponse
	{

		private string requestId;

		private GetOIDCProvider_OIDCProvider oIDCProvider;
		...
		public GetOIDCProvider_OIDCProvider OIDCProvider
		{
			get
			{
				return oIDCProvider;
		...
		public class GetOIDCProvider_OIDCProvider
		{
