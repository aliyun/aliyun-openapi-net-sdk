...
{
    public class GetAccountSummaryRequest : RpcAcsRequest<GetAccountSummaryResponse>
    {
        public GetAccountSummaryRequest()
            : base("Ims", "2019-08-15", "GetAccountSummary", "ims", "openAPI")
        {
        ...
        public override GetAccountSummaryResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAccountSummaryResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
