...
{
    public class RemoveClientIdFromOIDCProviderRequest : RpcAcsRequest<RemoveClientIdFromOIDCProviderResponse>
    {
        public RemoveClientIdFromOIDCProviderRequest()
            : base("Ims", "2019-08-15", "RemoveClientIdFromOIDCProvider", "ims", "openAPI")
        {
        ...
        public override RemoveClientIdFromOIDCProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveClientIdFromOIDCProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
