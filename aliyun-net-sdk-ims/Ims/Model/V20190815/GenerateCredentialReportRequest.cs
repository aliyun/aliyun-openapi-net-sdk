...
{
    public class GenerateCredentialReportRequest : RpcAcsRequest<GenerateCredentialReportResponse>
    {
        public GenerateCredentialReportRequest()
            : base("Ims", "2019-08-15", "GenerateCredentialReport", "ims", "openAPI")
        {
        ...
        public override GenerateCredentialReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateCredentialReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
