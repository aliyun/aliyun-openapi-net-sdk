...
{
    public class UpdateOIDCProviderRequest : RpcAcsRequest<UpdateOIDCProviderResponse>
    {
        public UpdateOIDCProviderRequest()
            : base("Ims", "2019-08-15", "UpdateOIDCProvider", "ims", "openAPI")
        {
        ...
        public override UpdateOIDCProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateOIDCProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
