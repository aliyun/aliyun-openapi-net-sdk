...
namespace Aliyun.Acs.Ims.Model.V20190815
{
	public class CreateApplicationResponse : AcsResponse
	{
		...
		public class CreateApplication_Application
		{
			...
			private CreateApplication_DelegatedScope delegatedScope;
			...
			public CreateApplication_DelegatedScope DelegatedScope
			{
				get
				{
			...
			public class CreateApplication_DelegatedScope
			{

				private List<CreateApplication_PredefinedScope> predefinedScopes;

				public List<CreateApplication_PredefinedScope> PredefinedScopes
				{
					get
					{
				...
				public class CreateApplication_PredefinedScope
				{
