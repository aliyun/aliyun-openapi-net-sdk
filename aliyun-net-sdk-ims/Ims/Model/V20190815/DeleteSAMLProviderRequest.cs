...
{
    public class DeleteSAMLProviderRequest : RpcAcsRequest<DeleteSAMLProviderResponse>
    {
        public DeleteSAMLProviderRequest()
            : base("Ims", "2019-08-15", "DeleteSAMLProvider", "ims", "openAPI")
        {
        ...
        public override DeleteSAMLProviderResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteSAMLProviderResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
