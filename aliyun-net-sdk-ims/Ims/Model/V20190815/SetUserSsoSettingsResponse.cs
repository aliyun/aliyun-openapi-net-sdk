...
{
	public class SetUserSsoSettingsResponse : AcsResponse
	{

		private string requestId;

		private SetUserSsoSettings_UserSsoSettings userSsoSettings;
		...
		[JsonProperty(PropertyName = "UserSsoSettings")]
		public SetUserSsoSettings_UserSsoSettings UserSsoSettings
		{
			get
			{
		...
		public class SetUserSsoSettings_UserSsoSettings
		{
