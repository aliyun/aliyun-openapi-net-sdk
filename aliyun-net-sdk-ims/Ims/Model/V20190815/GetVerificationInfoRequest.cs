...
{
    public class GetVerificationInfoRequest : RpcAcsRequest<GetVerificationInfoResponse>
    {
        public GetVerificationInfoRequest()
            : base("Ims", "2019-08-15", "GetVerificationInfo", "ims", "openAPI")
        {
        ...
        public override GetVerificationInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetVerificationInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
