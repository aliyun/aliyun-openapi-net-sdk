...
{
	public class GetAppSecretResponse : AcsResponse
	{

		private string requestId;

		private GetAppSecret_AppSecret appSecret;
		...
		public GetAppSecret_AppSecret AppSecret
		{
			get
			{
				return appSecret;
		...
		public class GetAppSecret_AppSecret
		{
