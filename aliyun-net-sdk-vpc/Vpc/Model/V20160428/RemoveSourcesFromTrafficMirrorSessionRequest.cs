...
{
    public class RemoveSourcesFromTrafficMirrorSessionRequest : RpcAcsRequest<RemoveSourcesFromTrafficMirrorSessionResponse>
    {
        public RemoveSourcesFromTrafficMirrorSessionRequest()
            : base("Vpc", "2016-04-28", "RemoveSourcesFromTrafficMirrorSession", "vpc", "openAPI")
        {
        ...
        public override RemoveSourcesFromTrafficMirrorSessionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveSourcesFromTrafficMirrorSessionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
