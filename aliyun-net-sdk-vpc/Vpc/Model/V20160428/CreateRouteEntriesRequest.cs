...
{
    public class CreateRouteEntriesRequest : RpcAcsRequest<CreateRouteEntriesResponse>
    {
        public CreateRouteEntriesRequest()
            : base("Vpc", "2016-04-28", "CreateRouteEntries", "vpc", "openAPI")
        {
        ...
        public override CreateRouteEntriesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateRouteEntriesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
