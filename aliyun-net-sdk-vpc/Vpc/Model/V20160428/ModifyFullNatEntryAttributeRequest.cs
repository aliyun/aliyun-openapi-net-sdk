...
{
    public class ModifyFullNatEntryAttributeRequest : RpcAcsRequest<ModifyFullNatEntryAttributeResponse>
    {
        public ModifyFullNatEntryAttributeRequest()
            : base("Vpc", "2016-04-28", "ModifyFullNatEntryAttribute", "vpc", "openAPI")
        {
        ...
        public override ModifyFullNatEntryAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyFullNatEntryAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
