...
{
    public class CreateTrafficMirrorFilterRulesRequest : RpcAcsRequest<CreateTrafficMirrorFilterRulesResponse>
    {
        public CreateTrafficMirrorFilterRulesRequest()
            : base("Vpc", "2016-04-28", "CreateTrafficMirrorFilterRules", "vpc", "openAPI")
        {
        ...
        public override CreateTrafficMirrorFilterRulesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTrafficMirrorFilterRulesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
