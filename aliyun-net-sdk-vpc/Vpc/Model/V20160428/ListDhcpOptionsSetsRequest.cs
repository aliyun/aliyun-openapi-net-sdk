...
{
    public class ListDhcpOptionsSetsRequest : RpcAcsRequest<ListDhcpOptionsSetsResponse>
    {
        public ListDhcpOptionsSetsRequest()
            : base("Vpc", "2016-04-28", "ListDhcpOptionsSets", "vpc", "openAPI")
        {
		...
		private List<string> dhcpOptionsSetIds = new List<string>(){ };
        ...
        public override ListDhcpOptionsSetsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListDhcpOptionsSetsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
