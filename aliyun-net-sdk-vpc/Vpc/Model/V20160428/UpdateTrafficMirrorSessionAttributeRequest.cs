...
{
    public class UpdateTrafficMirrorSessionAttributeRequest : RpcAcsRequest<UpdateTrafficMirrorSessionAttributeResponse>
    {
        public UpdateTrafficMirrorSessionAttributeRequest()
            : base("Vpc", "2016-04-28", "UpdateTrafficMirrorSessionAttribute", "vpc", "openAPI")
        {
        ...
        public override UpdateTrafficMirrorSessionAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTrafficMirrorSessionAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
