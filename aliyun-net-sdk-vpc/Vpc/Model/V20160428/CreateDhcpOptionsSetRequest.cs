...
{
    public class CreateDhcpOptionsSetRequest : RpcAcsRequest<CreateDhcpOptionsSetResponse>
    {
        public CreateDhcpOptionsSetRequest()
            : base("Vpc", "2016-04-28", "CreateDhcpOptionsSet", "vpc", "openAPI")
        {
        ...
        public override CreateDhcpOptionsSetResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDhcpOptionsSetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
