...
{
    public class UpdateTrafficMirrorFilterAttributeRequest : RpcAcsRequest<UpdateTrafficMirrorFilterAttributeResponse>
    {
        public UpdateTrafficMirrorFilterAttributeRequest()
            : base("Vpc", "2016-04-28", "UpdateTrafficMirrorFilterAttribute", "vpc", "openAPI")
        {
        ...
        public override UpdateTrafficMirrorFilterAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateTrafficMirrorFilterAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
