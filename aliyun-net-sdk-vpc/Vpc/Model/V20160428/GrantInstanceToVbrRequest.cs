...
{
    public class GrantInstanceToVbrRequest : RpcAcsRequest<GrantInstanceToVbrResponse>
    {
        public GrantInstanceToVbrRequest()
            : base("Vpc", "2016-04-28", "GrantInstanceToVbr", "vpc", "openAPI")
        {
		...
		public long? VbrOwnerUid
		{
			...
			{
				vbrOwnerUid = value;
				DictionaryUtil.Add(QueryParameters, "VbrOwnerUid", value.ToString());
			}
		}
        ...
        public override GrantInstanceToVbrResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GrantInstanceToVbrResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
