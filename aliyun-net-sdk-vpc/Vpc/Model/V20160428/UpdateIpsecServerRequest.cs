...
{
    public class UpdateIpsecServerRequest : RpcAcsRequest<UpdateIpsecServerResponse>
    {
        public UpdateIpsecServerRequest()
            : base("Vpc", "2016-04-28", "UpdateIpsecServer", "vpc", "openAPI")
        {
        ...
        public override UpdateIpsecServerResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateIpsecServerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
