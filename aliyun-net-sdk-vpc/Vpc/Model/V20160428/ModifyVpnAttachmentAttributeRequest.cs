...
{
    public class ModifyVpnAttachmentAttributeRequest : RpcAcsRequest<ModifyVpnAttachmentAttributeResponse>
    {
        public ModifyVpnAttachmentAttributeRequest()
            : base("Vpc", "2016-04-28", "ModifyVpnAttachmentAttribute", "vpc", "openAPI")
        {
        ...
        public override ModifyVpnAttachmentAttributeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyVpnAttachmentAttributeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
