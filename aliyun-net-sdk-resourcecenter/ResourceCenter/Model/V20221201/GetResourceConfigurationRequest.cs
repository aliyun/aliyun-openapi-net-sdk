...
{
    public class GetResourceConfigurationRequest : RpcAcsRequest<GetResourceConfigurationResponse>
    {
        public GetResourceConfigurationRequest()
            : base("ResourceCenter", "2022-12-01", "GetResourceConfiguration")
        {
        ...
        public override GetResourceConfigurationResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetResourceConfigurationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
