...
{
    public class ListResourceRelationshipsRequest : RpcAcsRequest<ListResourceRelationshipsResponse>
    {
        public ListResourceRelationshipsRequest()
            : base("ResourceCenter", "2022-12-01", "ListResourceRelationships")
        {
        ...
        public override ListResourceRelationshipsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListResourceRelationshipsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
