...
{
    public class ListMultiAccountTagKeysRequest : RpcAcsRequest<ListMultiAccountTagKeysResponse>
    {
        public ListMultiAccountTagKeysRequest()
            : base("ResourceCenter", "2022-12-01", "ListMultiAccountTagKeys")
        {
        ...
        public override ListMultiAccountTagKeysResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListMultiAccountTagKeysResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
