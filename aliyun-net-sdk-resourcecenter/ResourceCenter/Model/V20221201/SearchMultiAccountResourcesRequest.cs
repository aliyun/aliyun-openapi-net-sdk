...
{
    public class SearchMultiAccountResourcesRequest : RpcAcsRequest<SearchMultiAccountResourcesResponse>
    {
        public SearchMultiAccountResourcesRequest()
            : base("ResourceCenter", "2022-12-01", "SearchMultiAccountResources")
        {
        ...
        public override SearchMultiAccountResourcesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SearchMultiAccountResourcesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
