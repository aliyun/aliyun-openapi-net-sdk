...
{
    public class GetAlgorithmDetailRequest : RpcAcsRequest<GetAlgorithmDetailResponse>
    {
        public GetAlgorithmDetailRequest()
            : base("ivision", "2019-03-08", "GetAlgorithmDetail")
        {
        ...
        public override GetAlgorithmDetailResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAlgorithmDetailResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
