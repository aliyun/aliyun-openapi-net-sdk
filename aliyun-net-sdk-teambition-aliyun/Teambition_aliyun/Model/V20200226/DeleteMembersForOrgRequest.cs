...
{
    public class DeleteMembersForOrgRequest : RpcAcsRequest<DeleteMembersForOrgResponse>
    {
        public DeleteMembersForOrgRequest()
            : base("teambition-aliyun", "2020-02-26", "DeleteMembersForOrg")
        {
        ...
        public override DeleteMembersForOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteMembersForOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
