...
{
    public class BactchInsertMembersRequest : RpcAcsRequest<BactchInsertMembersResponse>
    {
        public BactchInsertMembersRequest()
            : base("teambition-aliyun", "2020-02-26", "BactchInsertMembers")
        {
        ...
        public override BactchInsertMembersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BactchInsertMembersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
