...
{
    public class CreateDevopsOrgRequest : RpcAcsRequest<CreateDevopsOrgResponse>
    {
        public CreateDevopsOrgRequest()
            : base("teambition-aliyun", "2020-02-26", "CreateDevopsOrg")
        {
        ...
        public override CreateDevopsOrgResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateDevopsOrgResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
