...
{
    public class GetUserByUidRequest : RpcAcsRequest<GetUserByUidResponse>
    {
        public GetUserByUidRequest()
            : base("teambition-aliyun", "2020-02-26", "GetUserByUid")
        {
        ...
        public override GetUserByUidResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserByUidResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
