...
{
    public class UpdateProjectTaskRequest : RpcAcsRequest<UpdateProjectTaskResponse>
    {
        public UpdateProjectTaskRequest()
            : base("teambition-aliyun", "2020-02-26", "UpdateProjectTask")
        {
        ...
        public override UpdateProjectTaskResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateProjectTaskResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
