...
{
    public class UpdateProjectSprintRequest : RpcAcsRequest<UpdateProjectSprintResponse>
    {
        public UpdateProjectSprintRequest()
            : base("teambition-aliyun", "2020-02-26", "UpdateProjectSprint")
        {
        ...
        public override UpdateProjectSprintResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateProjectSprintResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
