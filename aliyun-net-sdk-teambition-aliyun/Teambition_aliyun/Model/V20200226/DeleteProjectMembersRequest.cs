...
{
    public class DeleteProjectMembersRequest : RpcAcsRequest<DeleteProjectMembersResponse>
    {
        public DeleteProjectMembersRequest()
            : base("teambition-aliyun", "2020-02-26", "DeleteProjectMembers")
        {
        ...
        public override DeleteProjectMembersResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteProjectMembersResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
