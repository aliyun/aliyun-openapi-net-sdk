...
namespace Aliyun.Acs.teambition_aliyun.Transform.V20200226
{
    public class DeleteProjectResponseUnmarshaller
    {
        public static DeleteProjectResponse Unmarshall(UnmarshallerContext context)
        {
			...
			deleteProjectResponse.ErrorCode = context.StringValue("DeleteProject.ErrorCode");
			deleteProjectResponse.ErrorMessage = context.StringValue("DeleteProject.ErrorMessage");
			deleteProjectResponse._Object = context.StringValue("DeleteProject.Object");
			deleteProjectResponse.RequestId = context.StringValue("DeleteProject.RequestId");
			deleteProjectResponse.Success = context.BooleanValue("DeleteProject.Success");
