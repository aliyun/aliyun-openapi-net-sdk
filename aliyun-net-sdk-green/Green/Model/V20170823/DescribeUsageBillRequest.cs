...
{
    public class DescribeUsageBillRequest : RpcAcsRequest<DescribeUsageBillResponse>
    {
        public DescribeUsageBillRequest()
            : base("Green", "2017-08-23", "DescribeUsageBill", "green", "openAPI")
        {
		...
		public string Day
		{
			...
			{
				day = value;
				DictionaryUtil.Add(QueryParameters, "Day", value);
			}
		}
        ...
        public override DescribeUsageBillResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeUsageBillResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
