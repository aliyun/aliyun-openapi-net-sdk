...
{
    public class ExportOpenApiRcpStatsRequest : RpcAcsRequest<ExportOpenApiRcpStatsResponse>
    {
        public ExportOpenApiRcpStatsRequest()
            : base("Green", "2017-08-23", "ExportOpenApiRcpStats", "green", "openAPI")
        {
        ...
        public override ExportOpenApiRcpStatsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ExportOpenApiRcpStatsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
