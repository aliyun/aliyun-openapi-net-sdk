...
{
    public class DescribeOpenApiRcpStatsRequest : RpcAcsRequest<DescribeOpenApiRcpStatsResponse>
    {
        public DescribeOpenApiRcpStatsRequest()
            : base("Green", "2017-08-23", "DescribeOpenApiRcpStats", "green", "openAPI")
        {
        ...
        public override DescribeOpenApiRcpStatsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeOpenApiRcpStatsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
