...
{
    public class UpdateBizTypeImageLibRequest : RpcAcsRequest<UpdateBizTypeImageLibResponse>
    {
        public UpdateBizTypeImageLibRequest()
            : base("Green", "2017-08-23", "UpdateBizTypeImageLib", "green", "openAPI")
        {
        ...
        public override UpdateBizTypeImageLibResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return UpdateBizTypeImageLibResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
