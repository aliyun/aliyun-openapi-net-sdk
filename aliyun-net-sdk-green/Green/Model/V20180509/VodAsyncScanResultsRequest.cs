...
{
    public class VodAsyncScanResultsRequest : RoaAcsRequest<VodAsyncScanResultsResponse>
    {
        public VodAsyncScanResultsRequest()
            : base("Green", "2018-05-09", "VodAsyncScanResults", "green", "openAPI")
        {
        ...
        public override VodAsyncScanResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VodAsyncScanResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
