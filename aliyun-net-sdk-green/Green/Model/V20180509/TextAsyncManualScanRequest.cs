...
{
    public class TextAsyncManualScanRequest : RoaAcsRequest<TextAsyncManualScanResponse>
    {
        public TextAsyncManualScanRequest()
            : base("Green", "2018-05-09", "TextAsyncManualScan", "green", "openAPI")
        {
			...
			UriPattern = "/green/text/manual/asyncScan";
        ...
        public override TextAsyncManualScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TextAsyncManualScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
