...
{
    public class TextAsyncManualScanResultsRequest : RoaAcsRequest<TextAsyncManualScanResultsResponse>
    {
        public TextAsyncManualScanResultsRequest()
            : base("Green", "2018-05-09", "TextAsyncManualScanResults", "green", "openAPI")
        {
			...
			UriPattern = "/green/text/manual/scan/results";
        ...
        public override TextAsyncManualScanResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return TextAsyncManualScanResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
