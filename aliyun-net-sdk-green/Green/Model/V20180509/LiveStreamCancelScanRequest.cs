...
{
    public class LiveStreamCancelScanRequest : RoaAcsRequest<LiveStreamCancelScanResponse>
    {
        public LiveStreamCancelScanRequest()
            : base("Green", "2018-05-09", "LiveStreamCancelScan", "green", "openAPI")
        {
			...
			UriPattern = "/green/livestream/cancelscan";
        ...
        public override LiveStreamCancelScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LiveStreamCancelScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
