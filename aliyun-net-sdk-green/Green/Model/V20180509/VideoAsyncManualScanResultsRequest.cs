...
{
    public class VideoAsyncManualScanResultsRequest : RoaAcsRequest<VideoAsyncManualScanResultsResponse>
    {
        public VideoAsyncManualScanResultsRequest()
            : base("Green", "2018-05-09", "VideoAsyncManualScanResults", "green", "openAPI")
        {
			...
			UriPattern = "/green/video/manual/scan/results";
        ...
        public override VideoAsyncManualScanResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VideoAsyncManualScanResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
