...
{
    public class VoiceSyncScanRequest : RoaAcsRequest<VoiceSyncScanResponse>
    {
        public VoiceSyncScanRequest()
            : base("Green", "2018-05-09", "VoiceSyncScan", "green", "openAPI")
        {
			...
			UriPattern = "/green/voice/syncscan";
        ...
        public override VoiceSyncScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VoiceSyncScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
