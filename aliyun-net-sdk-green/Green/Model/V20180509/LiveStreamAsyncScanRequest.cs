...
{
    public class LiveStreamAsyncScanRequest : RoaAcsRequest<LiveStreamAsyncScanResponse>
    {
        public LiveStreamAsyncScanRequest()
            : base("Green", "2018-05-09", "LiveStreamAsyncScan", "green", "openAPI")
        {
			...
			UriPattern = "/green/livestream/asyncscan";
        ...
        public override LiveStreamAsyncScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LiveStreamAsyncScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
