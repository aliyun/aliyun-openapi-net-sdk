...
{
    public class VoiceAsyncManualScanResultsRequest : RoaAcsRequest<VoiceAsyncManualScanResultsResponse>
    {
        public VoiceAsyncManualScanResultsRequest()
            : base("Green", "2018-05-09", "VoiceAsyncManualScanResults", "green", "openAPI")
        {
			...
			UriPattern = "/green/voice/manual/scan/results";
        ...
        public override VoiceAsyncManualScanResultsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VoiceAsyncManualScanResultsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
