...
{
    public class VodAsyncScanRequest : RoaAcsRequest<VodAsyncScanResponse>
    {
        public VodAsyncScanRequest()
            : base("Green", "2018-05-09", "VodAsyncScan", "green", "openAPI")
        {
			...
			UriPattern = "/green/vod/asyncscan";
        ...
        public override VodAsyncScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return VodAsyncScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
