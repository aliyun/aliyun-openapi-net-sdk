...
{
    public class WebpageSyncScanRequest : RoaAcsRequest<WebpageSyncScanResponse>
    {
        public WebpageSyncScanRequest()
            : base("Green", "2018-05-09", "WebpageSyncScan", "green", "openAPI")
        {
        ...
        public override WebpageSyncScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return WebpageSyncScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
