...
{
    public class WebpageAsyncScanRequest : RoaAcsRequest<WebpageAsyncScanResponse>
    {
        public WebpageAsyncScanRequest()
            : base("Green", "2018-05-09", "WebpageAsyncScan", "green", "openAPI")
        {
			...
			UriPattern = "/green/webpage/asyncscan";
        ...
        public override WebpageAsyncScanResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return WebpageAsyncScanResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
