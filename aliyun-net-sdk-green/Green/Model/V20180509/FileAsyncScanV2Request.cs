...
{
    public class FileAsyncScanV2Request : RoaAcsRequest<FileAsyncScanV2Response>
    {
        public FileAsyncScanV2Request()
            : base("Green", "2018-05-09", "FileAsyncScanV2")
        {
			...
			UriPattern = "/green/file/asyncscanv2";
        ...
        public override FileAsyncScanV2Response GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return FileAsyncScanV2ResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
