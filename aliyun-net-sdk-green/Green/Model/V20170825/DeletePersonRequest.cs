...
namespace Aliyun.Acs.Green.Model.V20170825
{
    public class DeletePersonRequest : RoaAcsRequest<DeletePersonResponse>
    {
        public DeletePersonRequest()
            : base("Green", "2017-08-25", "DeletePerson", "green", "openAPI")
        {
			UriPattern = "/green/sface/deletePerson";
        ...
        public override DeletePersonResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
