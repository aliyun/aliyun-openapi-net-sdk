...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class ModifyReplicaModeRequest : RpcAcsRequest<ModifyReplicaModeResponse>
    {
        public ModifyReplicaModeRequest()
            : base("R_kvstore", "2015-01-01", "ModifyReplicaMode", "redisa", "openAPI")
        {
        }
        ...
        public override ModifyReplicaModeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
