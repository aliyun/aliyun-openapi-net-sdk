...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeCacheAnalysisReportListRequest : RpcAcsRequest<DescribeCacheAnalysisReportListResponse>
    {
        public DescribeCacheAnalysisReportListRequest()
            : base("R_kvstore", "2015-01-01", "DescribeCacheAnalysisReportList", "redisa", "openAPI")
        {
        }
        ...
        public override DescribeCacheAnalysisReportListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
