...
{
    public class ModifyInstanceParameterRequest : RpcAcsRequest<ModifyInstanceParameterResponse>
    {
        public ModifyInstanceParameterRequest()
            : base("R-kvstore", "2015-01-01", "ModifyInstanceParameter", "redisa", "openAPI")
        {
        ...
        public override ModifyInstanceParameterResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyInstanceParameterResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
