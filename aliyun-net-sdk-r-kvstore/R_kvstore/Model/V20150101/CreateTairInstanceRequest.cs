...
{
    public class CreateTairInstanceRequest : RpcAcsRequest<CreateTairInstanceResponse>
    {
        public CreateTairInstanceRequest()
            : base("R-kvstore", "2015-01-01", "CreateTairInstance", "redisa", "openAPI")
        {
		...
		public string ShardType
		{
			...
			{
				shardType = value;
				DictionaryUtil.Add(QueryParameters, "ShardType", value);
			}
		}
        ...
        public override CreateTairInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTairInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
