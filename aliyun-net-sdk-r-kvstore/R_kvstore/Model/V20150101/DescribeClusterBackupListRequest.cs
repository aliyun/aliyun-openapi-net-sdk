...
{
    public class DescribeClusterBackupListRequest : RpcAcsRequest<DescribeClusterBackupListResponse>
    {
        public DescribeClusterBackupListRequest()
            : base("R-kvstore", "2015-01-01", "DescribeClusterBackupList", "redisa", "openAPI")
        {
        ...
        public override DescribeClusterBackupListResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeClusterBackupListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
