...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeErrorLogRecordsRequest : RpcAcsRequest<DescribeErrorLogRecordsResponse>
    {
        public DescribeErrorLogRecordsRequest()
            : base("R_kvstore", "2015-01-01", "DescribeErrorLogRecords", "redisa", "openAPI")
        {
        }
        ...
        public override DescribeErrorLogRecordsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
