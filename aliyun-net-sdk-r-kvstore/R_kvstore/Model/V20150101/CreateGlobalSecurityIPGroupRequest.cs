...
{
    public class CreateGlobalSecurityIPGroupRequest : RpcAcsRequest<CreateGlobalSecurityIPGroupResponse>
    {
        public CreateGlobalSecurityIPGroupRequest()
            : base("R-kvstore", "2015-01-01", "CreateGlobalSecurityIPGroup", "redisa", "openAPI")
        {
        ...
        public override CreateGlobalSecurityIPGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateGlobalSecurityIPGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
