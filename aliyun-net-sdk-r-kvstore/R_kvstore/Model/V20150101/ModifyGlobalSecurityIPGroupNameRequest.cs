...
{
    public class ModifyGlobalSecurityIPGroupNameRequest : RpcAcsRequest<ModifyGlobalSecurityIPGroupNameResponse>
    {
        public ModifyGlobalSecurityIPGroupNameRequest()
            : base("R-kvstore", "2015-01-01", "ModifyGlobalSecurityIPGroupName", "redisa", "openAPI")
        {
        ...
        public override ModifyGlobalSecurityIPGroupNameResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyGlobalSecurityIPGroupNameResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
