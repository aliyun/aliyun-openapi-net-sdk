...
{
    public class DescribeTairKVCacheInferInstancesRequest : RpcAcsRequest<DescribeTairKVCacheInferInstancesResponse>
    {
        public DescribeTairKVCacheInferInstancesRequest()
            : base("R-kvstore", "2015-01-01", "DescribeTairKVCacheInferInstances", "redisa", "openAPI")
        {
        ...
        public override DescribeTairKVCacheInferInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTairKVCacheInferInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
