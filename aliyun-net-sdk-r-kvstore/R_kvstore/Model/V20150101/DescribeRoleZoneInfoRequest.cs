...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeRoleZoneInfoRequest : RpcAcsRequest<DescribeRoleZoneInfoResponse>
    {
        public DescribeRoleZoneInfoRequest()
            : base("R-kvstore", "2015-01-01", "DescribeRoleZoneInfo", "redisa", "openAPI")
        {
        ...
        public override DescribeRoleZoneInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeRoleZoneInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
