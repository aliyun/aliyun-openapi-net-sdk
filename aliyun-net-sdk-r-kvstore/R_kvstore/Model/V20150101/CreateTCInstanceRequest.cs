...
{
    public class CreateTCInstanceRequest : RpcAcsRequest<CreateTCInstanceResponse>
    {
        public CreateTCInstanceRequest()
            : base("R-kvstore", "2015-01-01", "CreateTCInstance", "redisa", "openAPI")
        {
		...
		private List<int?> dataDisks = new List<int?>(){ };
		...
		public bool? NeedEni
		{
			...
			{
				needEni = value;
				DictionaryUtil.Add(QueryParameters, "NeedEni", value.ToString());
			}
		}
        ...
        public override CreateTCInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreateTCInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
