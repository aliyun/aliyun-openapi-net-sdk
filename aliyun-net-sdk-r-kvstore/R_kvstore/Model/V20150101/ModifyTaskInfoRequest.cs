...
{
    public class ModifyTaskInfoRequest : RpcAcsRequest<ModifyTaskInfoResponse>
    {
        public ModifyTaskInfoRequest()
            : base("R-kvstore", "2015-01-01", "ModifyTaskInfo", "redisa", "openAPI")
        {
		...
		public string StepName
		{
			...
			{
				stepName = value;
				DictionaryUtil.Add(QueryParameters, "StepName", value);
			}
		}
        ...
        public override ModifyTaskInfoResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyTaskInfoResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
