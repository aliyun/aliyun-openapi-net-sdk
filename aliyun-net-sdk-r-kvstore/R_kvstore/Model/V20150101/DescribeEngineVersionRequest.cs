...
{
    public class DescribeEngineVersionRequest : RpcAcsRequest<DescribeEngineVersionResponse>
    {
        public DescribeEngineVersionRequest()
            : base("R-kvstore", "2015-01-01", "DescribeEngineVersion", "redisa", "openAPI")
        {
        ...
        public override DescribeEngineVersionResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeEngineVersionResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
