...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeCacheAnalysisReportRequest : RpcAcsRequest<DescribeCacheAnalysisReportResponse>
    {
        public DescribeCacheAnalysisReportRequest()
            : base("R_kvstore", "2015-01-01", "DescribeCacheAnalysisReport", "redisa", "openAPI")
        {
        }
        ...
        public override DescribeCacheAnalysisReportResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
