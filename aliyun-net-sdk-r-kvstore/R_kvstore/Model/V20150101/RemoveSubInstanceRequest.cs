...
{
    public class RemoveSubInstanceRequest : RpcAcsRequest<RemoveSubInstanceResponse>
    {
        public RemoveSubInstanceRequest()
            : base("R-kvstore", "2015-01-01", "RemoveSubInstance", "redisa", "openAPI")
        {
        ...
        public override RemoveSubInstanceResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveSubInstanceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
