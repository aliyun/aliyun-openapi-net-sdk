...
{
    public class DescribeTairKVCacheCustomInstancesRequest : RpcAcsRequest<DescribeTairKVCacheCustomInstancesResponse>
    {
        public DescribeTairKVCacheCustomInstancesRequest()
            : base("R-kvstore", "2015-01-01", "DescribeTairKVCacheCustomInstances", "redisa", "openAPI")
        {
        ...
        public override DescribeTairKVCacheCustomInstancesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DescribeTairKVCacheCustomInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
