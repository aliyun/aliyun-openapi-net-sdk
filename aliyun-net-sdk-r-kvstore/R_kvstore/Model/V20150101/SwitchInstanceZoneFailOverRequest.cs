...
{
    public class SwitchInstanceZoneFailOverRequest : RpcAcsRequest<SwitchInstanceZoneFailOverResponse>
    {
        public SwitchInstanceZoneFailOverRequest()
            : base("R-kvstore", "2015-01-01", "SwitchInstanceZoneFailOver", "redisa", "openAPI")
        {
		...
		public string SiteFaultTime
		{
			...
			{
				siteFaultTime = value;
				DictionaryUtil.Add(QueryParameters, "SiteFaultTime", value);
			}
		}
        ...
        public override SwitchInstanceZoneFailOverResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return SwitchInstanceZoneFailOverResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
