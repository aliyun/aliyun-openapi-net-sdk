...
{
    public class LockDBInstanceWriteRequest : RpcAcsRequest<LockDBInstanceWriteResponse>
    {
        public LockDBInstanceWriteRequest()
            : base("R-kvstore", "2015-01-01", "LockDBInstanceWrite", "redisa", "openAPI")
        {
        ...
        public override LockDBInstanceWriteResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return LockDBInstanceWriteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
