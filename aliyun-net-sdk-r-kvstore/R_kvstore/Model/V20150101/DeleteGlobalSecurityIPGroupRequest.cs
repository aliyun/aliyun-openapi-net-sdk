...
{
    public class DeleteGlobalSecurityIPGroupRequest : RpcAcsRequest<DeleteGlobalSecurityIPGroupResponse>
    {
        public DeleteGlobalSecurityIPGroupRequest()
            : base("R-kvstore", "2015-01-01", "DeleteGlobalSecurityIPGroup", "redisa", "openAPI")
        {
        ...
        public override DeleteGlobalSecurityIPGroupResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeleteGlobalSecurityIPGroupResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
