...
{
    public class DetectVideoShotRequest : RpcAcsRequest<DetectVideoShotResponse>
    {
        public DetectVideoShotRequest()
            : base("videorecog", "2020-03-20", "DetectVideoShot", "videorecog", "openAPI")
        {
        ...
        public override DetectVideoShotResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DetectVideoShotResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
