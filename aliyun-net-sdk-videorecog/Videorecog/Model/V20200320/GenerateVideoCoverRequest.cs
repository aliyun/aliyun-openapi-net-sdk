...
{
    public class GenerateVideoCoverRequest : RpcAcsRequest<GenerateVideoCoverResponse>
    {
        public GenerateVideoCoverRequest()
            : base("videorecog", "2020-03-20", "GenerateVideoCover", "videorecog", "openAPI")
        {
		...
		public bool? IsGif
		{
			...
			{
				isGif = value;
				DictionaryUtil.Add(BodyParameters, "IsGif", value.ToString());
			}
		}
        ...
        public override GenerateVideoCoverResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GenerateVideoCoverResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
