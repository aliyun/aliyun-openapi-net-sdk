...
{
    public class EvaluateVideoQualityRequest : RpcAcsRequest<EvaluateVideoQualityResponse>
    {
        public EvaluateVideoQualityRequest()
            : base("videorecog", "2020-03-20", "EvaluateVideoQuality", "videorecog", "openAPI")
        {
        ...
        public override EvaluateVideoQualityResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return EvaluateVideoQualityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
