...
{
    public class DeletePtsSceneRequest : RpcAcsRequest<DeletePtsSceneResponse>
    {
        public DeletePtsSceneRequest()
            : base("PTS", "2020-10-20", "DeletePtsScene")
        {
        ...
        public override DeletePtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
