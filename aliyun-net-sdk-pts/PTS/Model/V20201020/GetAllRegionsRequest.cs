...
{
    public class GetAllRegionsRequest : RpcAcsRequest<GetAllRegionsResponse>
    {
        public GetAllRegionsRequest()
            : base("PTS", "2020-10-20", "GetAllRegions")
        {
        ...
        public override GetAllRegionsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetAllRegionsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
