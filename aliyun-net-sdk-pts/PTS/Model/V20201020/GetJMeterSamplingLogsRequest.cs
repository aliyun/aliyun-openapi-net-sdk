...
{
    public class GetJMeterSamplingLogsRequest : RpcAcsRequest<GetJMeterSamplingLogsResponse>
    {
        public GetJMeterSamplingLogsRequest()
            : base("PTS", "2020-10-20", "GetJMeterSamplingLogs")
        {
		...
		public string ResponseCode
		{
			...
			{
				responseCode = value;
				DictionaryUtil.Add(QueryParameters, "ResponseCode", value);
			}
		}
		...
		public int? MinRT
		{
			...
			{
				minRT = value;
				DictionaryUtil.Add(QueryParameters, "MinRT", value.ToString());
			}
		}
		...
		public int? MaxRT
		{
			...
			{
				maxRT = value;
				DictionaryUtil.Add(QueryParameters, "MaxRT", value.ToString());
			}
		}
        ...
        public override GetJMeterSamplingLogsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetJMeterSamplingLogsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
