...
{
    public class StopDebuggingJMeterSceneRequest : RpcAcsRequest<StopDebuggingJMeterSceneResponse>
    {
        public StopDebuggingJMeterSceneRequest()
            : base("PTS", "2020-10-20", "StopDebuggingJMeterScene")
        {
        ...
        public override StopDebuggingJMeterSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDebuggingJMeterSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
