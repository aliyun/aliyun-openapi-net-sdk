...
{
    public class RemoveOpenJMeterSceneRequest : RpcAcsRequest<RemoveOpenJMeterSceneResponse>
    {
        public RemoveOpenJMeterSceneRequest()
            : base("PTS", "2020-10-20", "RemoveOpenJMeterScene")
        {
        ...
        public override RemoveOpenJMeterSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveOpenJMeterSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
