...
{
    public class StopTestingJMeterSceneRequest : RpcAcsRequest<StopTestingJMeterSceneResponse>
    {
        public StopTestingJMeterSceneRequest()
            : base("PTS", "2020-10-20", "StopTestingJMeterScene")
        {
        ...
        public override StopTestingJMeterSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopTestingJMeterSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
