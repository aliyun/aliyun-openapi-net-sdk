...
{
    public class GetPtsReportsBySceneIdRequest : RpcAcsRequest<GetPtsReportsBySceneIdResponse>
    {
        public GetPtsReportsBySceneIdRequest()
            : base("PTS", "2020-10-20", "GetPtsReportsBySceneId")
        {
        ...
        public override GetPtsReportsBySceneIdResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPtsReportsBySceneIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
