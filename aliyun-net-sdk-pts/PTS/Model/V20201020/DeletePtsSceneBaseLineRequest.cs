...
{
    public class DeletePtsSceneBaseLineRequest : RpcAcsRequest<DeletePtsSceneBaseLineResponse>
    {
        public DeletePtsSceneBaseLineRequest()
            : base("PTS", "2020-10-20", "DeletePtsSceneBaseLine")
        {
        ...
        public override DeletePtsSceneBaseLineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePtsSceneBaseLineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
