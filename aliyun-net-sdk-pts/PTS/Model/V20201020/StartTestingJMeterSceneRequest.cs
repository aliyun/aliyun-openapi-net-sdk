...
{
    public class StartTestingJMeterSceneRequest : RpcAcsRequest<StartTestingJMeterSceneResponse>
    {
        public StartTestingJMeterSceneRequest()
            : base("PTS", "2020-10-20", "StartTestingJMeterScene")
        {
        ...
        public override StartTestingJMeterSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartTestingJMeterSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
