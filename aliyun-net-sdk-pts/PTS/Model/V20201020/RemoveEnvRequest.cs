...
{
    public class RemoveEnvRequest : RpcAcsRequest<RemoveEnvResponse>
    {
        public RemoveEnvRequest()
            : base("PTS", "2020-10-20", "RemoveEnv")
        {
        ...
        public override RemoveEnvResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return RemoveEnvResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
