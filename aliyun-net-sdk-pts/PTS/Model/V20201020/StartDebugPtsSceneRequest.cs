...
{
    public class StartDebugPtsSceneRequest : RpcAcsRequest<StartDebugPtsSceneResponse>
    {
        public StartDebugPtsSceneRequest()
            : base("PTS", "2020-10-20", "StartDebugPtsScene")
        {
        ...
        public override StartDebugPtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartDebugPtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
