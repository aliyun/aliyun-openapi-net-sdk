...
{
    public class GetPtsSceneBaseLineRequest : RpcAcsRequest<GetPtsSceneBaseLineResponse>
    {
        public GetPtsSceneBaseLineRequest()
            : base("PTS", "2020-10-20", "GetPtsSceneBaseLine")
        {
        ...
        public override GetPtsSceneBaseLineResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPtsSceneBaseLineResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
