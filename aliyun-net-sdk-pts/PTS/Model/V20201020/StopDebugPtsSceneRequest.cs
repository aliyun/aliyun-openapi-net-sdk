...
{
    public class StopDebugPtsSceneRequest : RpcAcsRequest<StopDebugPtsSceneResponse>
    {
        public StopDebugPtsSceneRequest()
            : base("PTS", "2020-10-20", "StopDebugPtsScene")
        {
        ...
        public override StopDebugPtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopDebugPtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
