...
{
    public class GetPtsSceneRunningStatusRequest : RpcAcsRequest<GetPtsSceneRunningStatusResponse>
    {
        public GetPtsSceneRunningStatusRequest()
            : base("PTS", "2020-10-20", "GetPtsSceneRunningStatus")
        {
        ...
        public override GetPtsSceneRunningStatusResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPtsSceneRunningStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
