...
{
    public class StopPtsSceneRequest : RpcAcsRequest<StopPtsSceneResponse>
    {
        public StopPtsSceneRequest()
            : base("PTS", "2020-10-20", "StopPtsScene")
        {
        ...
        public override StopPtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StopPtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
