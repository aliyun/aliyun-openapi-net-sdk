...
{
    public class ModifyPtsSceneRequest : RpcAcsRequest<ModifyPtsSceneResponse>
    {
        public ModifyPtsSceneRequest()
            : base("PTS", "2020-10-20", "ModifyPtsScene")
        {
        ...
        public override ModifyPtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyPtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
