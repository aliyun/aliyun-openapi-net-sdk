...
{
    public class GetOpenJMeterSceneRequest : RpcAcsRequest<GetOpenJMeterSceneResponse>
    {
        public GetOpenJMeterSceneRequest()
            : base("PTS", "2020-10-20", "GetOpenJMeterScene")
        {
        ...
        public override GetOpenJMeterSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetOpenJMeterSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
