...
{
    public class ListOpenJMeterScenesRequest : RpcAcsRequest<ListOpenJMeterScenesResponse>
    {
        public ListOpenJMeterScenesRequest()
            : base("PTS", "2020-10-20", "ListOpenJMeterScenes")
        {
		...
		public string SceneName
		{
			...
			{
				sceneName = value;
				DictionaryUtil.Add(QueryParameters, "SceneName", value);
			}
		}
        ...
        public override ListOpenJMeterScenesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ListOpenJMeterScenesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
