...
{
    public class GetUserVpcVSwitchRequest : RpcAcsRequest<GetUserVpcVSwitchResponse>
    {
        public GetUserVpcVSwitchRequest()
            : base("PTS", "2020-10-20", "GetUserVpcVSwitch")
        {
        ...
        public override GetUserVpcVSwitchResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetUserVpcVSwitchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
