...
{
    public class GetPtsReportDetailsRequest : RpcAcsRequest<GetPtsReportDetailsResponse>
    {
        public GetPtsReportDetailsRequest()
            : base("PTS", "2020-10-20", "GetPtsReportDetails")
        {
        ...
        public override GetPtsReportDetailsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPtsReportDetailsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
