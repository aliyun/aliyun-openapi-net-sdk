...
{
    public class StartPtsSceneRequest : RpcAcsRequest<StartPtsSceneResponse>
    {
        public StartPtsSceneRequest()
            : base("PTS", "2020-10-20", "StartPtsScene")
        {
        ...
        public override StartPtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartPtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
