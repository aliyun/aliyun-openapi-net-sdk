...
{
    public class CreatePtsSceneBaseLineFromReportRequest : RpcAcsRequest<CreatePtsSceneBaseLineFromReportResponse>
    {
        public CreatePtsSceneBaseLineFromReportRequest()
            : base("PTS", "2020-10-20", "CreatePtsSceneBaseLineFromReport")
        {
        ...
        public override CreatePtsSceneBaseLineFromReportResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePtsSceneBaseLineFromReportResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
