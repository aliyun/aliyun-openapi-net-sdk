...
{
    public class GetJMeterSceneRunningDataRequest : RpcAcsRequest<GetJMeterSceneRunningDataResponse>
    {
        public GetJMeterSceneRunningDataRequest()
            : base("PTS", "2020-10-20", "GetJMeterSceneRunningData")
        {
        ...
        public override GetJMeterSceneRunningDataResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetJMeterSceneRunningDataResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
