...
{
    public class StartDebuggingJMeterSceneRequest : RpcAcsRequest<StartDebuggingJMeterSceneResponse>
    {
        public StartDebuggingJMeterSceneRequest()
            : base("PTS", "2020-10-20", "StartDebuggingJMeterScene")
        {
        ...
        public override StartDebuggingJMeterSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return StartDebuggingJMeterSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
