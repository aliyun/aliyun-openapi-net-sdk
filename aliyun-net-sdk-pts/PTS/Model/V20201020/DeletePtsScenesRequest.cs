...
{
    public class DeletePtsScenesRequest : RpcAcsRequest<DeletePtsScenesResponse>
    {
        public DeletePtsScenesRequest()
            : base("PTS", "2020-10-20", "DeletePtsScenes")
        {
        ...
        public override DeletePtsScenesResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return DeletePtsScenesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
