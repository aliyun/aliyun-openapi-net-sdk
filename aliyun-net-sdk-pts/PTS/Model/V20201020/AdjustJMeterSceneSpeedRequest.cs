...
{
    public class AdjustJMeterSceneSpeedRequest : RpcAcsRequest<AdjustJMeterSceneSpeedResponse>
    {
        public AdjustJMeterSceneSpeedRequest()
            : base("PTS", "2020-10-20", "AdjustJMeterSceneSpeed")
        {
        ...
        public override AdjustJMeterSceneSpeedResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AdjustJMeterSceneSpeedResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
