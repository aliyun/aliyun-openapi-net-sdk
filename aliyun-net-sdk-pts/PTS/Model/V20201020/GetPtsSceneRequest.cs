...
{
    public class GetPtsSceneRequest : RpcAcsRequest<GetPtsSceneResponse>
    {
        public GetPtsSceneRequest()
            : base("PTS", "2020-10-20", "GetPtsScene")
        {
        ...
        public override GetPtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return GetPtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
