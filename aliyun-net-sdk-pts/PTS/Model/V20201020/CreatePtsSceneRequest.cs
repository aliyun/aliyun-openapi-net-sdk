...
{
    public class CreatePtsSceneRequest : RpcAcsRequest<CreatePtsSceneResponse>
    {
        public CreatePtsSceneRequest()
            : base("PTS", "2020-10-20", "CreatePtsScene")
        {
        ...
        public override CreatePtsSceneResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return CreatePtsSceneResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
